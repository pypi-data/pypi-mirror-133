...
Welcome to ``vyze`` contributor's guide.
...
If you experience bugs or general issues with ``vyze``, please have a look
...
You can help improve ``vyze`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``vyze`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``vyze``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n vyze python=3 six virtualenv pytest pytest-cov
    conda activate vyze
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/vyze.git
    cd vyze
...
#. Install |pre-commit|_::
   ...
   ``vyze`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/vyze
.. _issue tracker: https://github.com/<USERNAME>/vyze/issues
.. <-- end -->
