...
class CytomineSlide(Image):
    ...
    @property
    def channels(self):
        # TODO: self._img_instance.channels always contains 1 on research whatever the actual number of channels. Bug?
        return 3
...
class CytomineTile(Tile):
    ...
    def np_image(self):
        ...
        rebuilt = np.zeros([height, width, self.base_image.channels], dtype=np.uint8).squeeze()
