...
class AlertChannel(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: (Required) The type of channel. One of: (email, opsgenie, pagerduty, slack, user, victorops, webhook). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/alert_channel.html#type AlertChannel#type}
...
class AlertCondition(
    ...
    def __init__(
        ...
        *,
        ...
        :param type: The type of condition. One of: (apm_app_metric, apm_jvm_metric, apm_kt_metric, browser_metric, mobile_metric, servers_metric). Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/alert_condition.html#type AlertCondition#type}
...
class SyntheticsMonitorScriptLocation:
    def __init__(
        ...
        *,
        ...
        :param hmac: The HMAC for the monitor script location. Use only one of ``hmac`` or ``vse_password.``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/synthetics_monitor_script.html#hmac SyntheticsMonitorScript#hmac}
        :param vse_password: The password for the monitor script location used to calculate HMAC. Use only one of ``vse_password`` or ``hmac.``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/newrelic/r/synthetics_monitor_script.html#vse_password SyntheticsMonitorScript#vse_password}
        '''
        self._values: typing.Dict[str, typing.Any] = {
            "name": name,
        }
