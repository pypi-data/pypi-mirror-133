...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        utils.addActions(self.menus.autoseg, (autoseg,))
        utils.addActions(
            self.menus.view,
            (
    ...
    def autosegmentation(self):
        ...
        if self.imagePath != None:
            ...
            if not self.filename.endswith((".png", ".tiff")):
                ...
                elif self.filename.endswith(".tiff"):
        ...
        if self.imagePath != None:
            ...
            if self.filename.endswith((".png", ".tiff")):

                im_path = self.imagePath.replace("\\", "/")
                print("before func call", self.imagePath.replace("\\", "/"))
                pred_main(self.imagePath.replace("\\", "/"))
                self.loadPolygons()
                self.setClean()
