...
class SimpledbDomain(
    ...
    jsii_type="@cdktf/provider-aws.simpledb.SimpledbDomain",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/simpledb_domain.html#name SimpledbDomain#name}.
        :param count: 
        :param depends_on: 
        :param lifecycle: 
        :param provider: 
...
@jsii.data_type(
    jsii_type="@cdktf/provider-aws.simpledb.SimpledbDomainConfig",
...
class SimpledbDomainConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        count: typing.Optional[typing.Union[jsii.Number, cdktf.IResolvable]] = None,
