...
VersionFitz = "1.19.0"
VersionBind = "1.19.4"
VersionDate = "2022-01-01 00:00:01"
version = (VersionBind, VersionFitz, "20220101000001")
...
class Tools(object):
    ...
    def _make_rect(self, a: AnyType) -> AnyType:
        return _fitz.Tools__make_rect(self, a)

    def _make_irect(self, a: AnyType) -> AnyType:
        return _fitz.Tools__make_irect(self, a)

    def _round_rect(self, rect: AnyType) -> AnyType:
    ...
    def _is_point_in_rect(self, p: AnyType, r: AnyType) -> AnyType:
