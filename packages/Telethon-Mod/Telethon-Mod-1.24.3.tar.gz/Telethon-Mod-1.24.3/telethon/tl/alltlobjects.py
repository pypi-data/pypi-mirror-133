...
tlobjects = {
    ...
    0x087b6e36: types.MessageReactions,
    0x932844fa: types.MessageUserReaction,
    0xa366923c: types.messages.MessageReactionsList,
