...
if TYPE_CHECKING:
    from ...tl.types import TypeAvailableReaction, TypeBotInlineResult, TypeChat, TypeChatAdminWithInvites, TypeChatFull, TypeChatInviteImporter, TypeDialog, TypeDocument, TypeEncryptedFile, TypeExportedChatInvite, TypeHighScore, TypeInlineBotSwitchPM, TypeMessage, TypeMessageUserReaction, TypeMessageUserVote, TypeMessageViews, TypeMessagesFilter, TypePeerSettings, TypeSearchResultsCalendarPeriod, TypeSearchResultsPosition, TypeSponsoredMessage, TypeStickerPack, TypeStickerSet, TypeStickerSetCovered, TypeUser
...
class MessageReactionsList(TLObject):
    CONSTRUCTOR_ID = 0xa366923c
    SUBCLASS_OF_ID = 0x60fce5e6

    def __init__(self, count: int, reactions: List['TypeMessageUserReaction'], users: List['TypeUser'], next_offset: Optional[str]=None):
        """
    ...
    def from_reader(cls, reader):
        ...
        if flags & 1:
            ...
            _next_offset = None
        return cls(count=_count, reactions=_reactions, users=_users, next_offset=_next_offset)
