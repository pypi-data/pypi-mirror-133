...
setup(
	...
	install_requires=['pandas','numpy','openpyxl','XlsxWriter','UliPlot'],
	url = 'https://github.com/EFFICIENTCORPORATES/efffcorp-gst',
	description = 'A python module to simlify multiple GST related tasks in your day to day office work',
