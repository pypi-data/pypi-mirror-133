...
class TestDrbZip(unittest.TestCase):
    ...
    def test_get_attribute(self):
        ...
        self.assertIsNotNone(node[SENTINEL_1_ROOT].get_attribute(
            DrbZipAttributeNames.DIRECTORY.value))
        self.assertEqual(node[SENTINEL_1_ROOT].
        ...
        self.assertEqual(node[SENTINEL_1_ROOT]
                         ...
                         14945)
        self.assertAlmostEqual(node[SENTINEL_1_ROOT][
            "manifest.safe"].get_attribute(
            DrbZipAttributeNames.RATIO.value, None), 4.9, delta=0.1)
        self.assertAlmostEqual(node[SENTINEL_1_ROOT]
                               ["manifest.safe"]
