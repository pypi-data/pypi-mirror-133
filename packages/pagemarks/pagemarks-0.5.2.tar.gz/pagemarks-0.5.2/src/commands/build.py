...
class CmdBuild(PagemarksCommand):
    ...
    def execute(self):
        ...
        for coll_name in colls:
            ...
            html = self.build_collection(colls[coll_name])
            click.echo(
                    'Read ' + str(
    ...
    def build_collection(self, coll_data: PagemarksCollection) -> str:
        ...
        genshi_context = GenshiCollectionContext(self.base_url, coll_data).to_context()
