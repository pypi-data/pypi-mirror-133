...
try:
    ...
    logger.warning('Track similarity computations can be made much faster ' \
                   'by running "pip install python-Levenshtein" or "pip ' \
                   'install dj-beatcloud[with_levenshtein]"')
