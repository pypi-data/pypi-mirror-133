...
* calibrationOLD - deprecated function for calculating the best configuration of given transport 
    distances and corresponding flows. MCMC simulation. Only here for reasons of nostalgia.
...
class SCgraph(DiGraph):
    ...
    * calibrationOLD - deprecated function for calculating the best configuration of given transport 
    ...
    def __init__(self, actors: list, locations: list, products: list, *args, **kwargs):
        '''
        ...
        '''
        nodes = zip(range(len(self.actors)*len(self.locations)*len(self.products)),\
    ...
    def combineActorBrand(self, actor: str, brand: list) -> list:
        '''
