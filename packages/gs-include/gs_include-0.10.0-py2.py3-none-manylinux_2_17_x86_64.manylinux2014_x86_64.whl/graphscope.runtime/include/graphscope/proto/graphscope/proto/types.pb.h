...
PROTOBUF_NAMESPACE_OPEN
template<> ::gs::rpc::PlaceHolder* Arena::CreateMaybeMessage<::gs::rpc::PlaceHolder>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace gs {
namespace rpc {
...
enum ClusterType : int {
  ...
  K8S = 1,
  UNDEFINED = 100,
  ClusterType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ClusterType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum OutputType : int {
  ...
  LEARNING_GRAPH = 10,
  NULL_OUTPUT = 101,
  OutputType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  OutputType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum ParamKey : int {
  ...
  ParamKey_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ParamKey_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ParamKey_IsValid(int value);
constexpr ParamKey ParamKey_MIN = GRAPH_NAME;
constexpr ParamKey ParamKey_MAX = GRAPH_LIBRARY_PATH;
...
enum ModifyType : int {
  ...
  NX_UPDATE_NODES = 4,
  NX_UPDATE_EDGES = 5,
  ModifyType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ModifyType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum ReportType : int {
  ...
  NODES_BY_LOC = 18,
  SELFLOOPS_NUM = 19,
  ReportType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ReportType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ReportType_IsValid(int value);
constexpr ReportType ReportType_MIN = NODE_NUM;
constexpr ReportType ReportType_MAX = SELFLOOPS_NUM;
...
class PlaceHolder PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:gs.rpc.PlaceHolder) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_graphscope_2fproto_2ftypes_2eproto);
    return ::descriptor_table_graphscope_2fproto_2ftypes_2eproto.file_level_metadata[kIndexInFileMessages];
  }
