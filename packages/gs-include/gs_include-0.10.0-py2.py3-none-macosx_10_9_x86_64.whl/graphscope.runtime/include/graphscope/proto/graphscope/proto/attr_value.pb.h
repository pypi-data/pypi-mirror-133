...
class AttrValue final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::gs::rpc::PlaceHolder* release_place_holder();
...
inline bool AttrValue::has_graph_type() const {
...
inline bool AttrValue::has_modify_type() const {
  return _internal_has_modify_type();
}
...
inline bool AttrValue::has_report_type() const {
...
inline ::gs::rpc::PlaceHolder* AttrValue::_internal_mutable_place_holder() {
  if (!_internal_has_place_holder()) {
    clear_value();
    set_has_place_holder();
    value_.place_holder_ = CreateMaybeMessage< ::gs::rpc::PlaceHolder >(GetArenaForAllocation());
  }
  return value_.place_holder_;
}
inline ::gs::rpc::PlaceHolder* AttrValue::mutable_place_holder() {
  ::gs::rpc::PlaceHolder* _msg = _internal_mutable_place_holder();
