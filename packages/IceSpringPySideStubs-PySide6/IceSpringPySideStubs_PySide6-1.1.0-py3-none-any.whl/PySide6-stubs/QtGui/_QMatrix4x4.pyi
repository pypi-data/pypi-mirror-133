...
from typing import Iterable, Iterable, List, Sequence, Tuple, Union, overload
...
class QMatrix4x4(object):
    ...
    **See also** **QVector3D**  and **QGenericMatrix** .
    ...
    def __add__(
        self, m2: Union[(PySide6.QtGui.QMatrix4x4, PySide6.QtGui.QTransform)]
    ...
    def __iadd__(
        self, other: Union[(PySide6.QtGui.QMatrix4x4, PySide6.QtGui.QTransform)]
    ) -> PySide6.QtGui.QMatrix4x4:
        ...
