...
class QStandardItem(object):
    ...
    **See also** **QStandardItemModel** , **Item View Convenience Classes** ,
    ...
    @overload
    def insertRows(
        self, row: int, items: Sequence[PySide6.QtGui.QStandardItem]
    ) -> None:
        """
    ...
    @overload
    def setChild(
        self, row: int, column: int, item: PySide6.QtGui.QStandardItem
    ) -> None:
        """
    ...
    def sortChildren(
        self, column: int, order: PySide6.QtCore.Qt.SortOrder = ...
    ) -> None:
        """
