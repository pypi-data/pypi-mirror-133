...
class QNetworkProxyQuery(object):
    ...
    **QNetworkAccessManager** , and **QAbstractSocket::setProxy** ().
    ...
    def __init__(
        self,
        other: Union[(PySide6.QtNetwork.QNetworkProxyQuery, PySide6.QtCore.QUrl, int)],
    ) -> None:
        """
    ...
    def __init__(
        self,
        requestUrl: Union[(PySide6.QtCore.QUrl, str)],
        queryType: PySide6.QtNetwork.QNetworkProxyQuery.QueryType = ...,
    ) -> None:
        """
    ...
    def setQueryType(
        self, type: PySide6.QtNetwork.QNetworkProxyQuery.QueryType
    ) -> None:
        """
