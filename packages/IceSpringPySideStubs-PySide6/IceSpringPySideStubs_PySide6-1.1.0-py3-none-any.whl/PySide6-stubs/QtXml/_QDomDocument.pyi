...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    **See also** **DOM Bookmarks Example**  and **Simple DOM Model Example** .
    ...
    @overload
    def setContent(
        self, dev: PySide6.QtCore.QIODevice
    ...
    @overload
    def setContent(
        self, text: Union[(PySide6.QtCore.QByteArray, bytes)]
    ) -> Tuple[(Tuple, str, int, int)]:
        """
    ...
    @overload
    def setContent(
        self, text: Union[(PySide6.QtCore.QByteArray, bytes)], namespaceProcessing: bool
    ) -> Tuple[(Tuple, str, int, int)]:
        """
        https://doc.qt.io/qt-6/qdomdocument.html#setContent
