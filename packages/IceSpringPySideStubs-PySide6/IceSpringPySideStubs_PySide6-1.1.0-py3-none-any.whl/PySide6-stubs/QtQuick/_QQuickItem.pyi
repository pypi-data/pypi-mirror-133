...
class QQuickItem(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    **See also** **QQuickWindow**  and **QQuickPaintedItem** .
    ...
    def geometryChange(
        self,
        newGeometry: Union[(PySide6.QtCore.QRectF, PySide6.QtCore.QRect)],
        oldGeometry: Union[(PySide6.QtCore.QRectF, PySide6.QtCore.QRect)],
    ) -> None:
        """
    ...
    def setFlag(
        self, flag: PySide6.QtQuick.QQuickItem.Flag, enabled: bool = ...
    ) -> None:
        """
