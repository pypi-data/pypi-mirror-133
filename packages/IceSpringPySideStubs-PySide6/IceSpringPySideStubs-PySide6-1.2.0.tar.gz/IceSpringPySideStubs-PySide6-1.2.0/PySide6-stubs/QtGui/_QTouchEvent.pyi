...
class QTouchEvent(PySide6.QtGui.QPointerEvent):
    ...
    **QEvent::TouchCancel**  event so they can update their state accordingly.
    ...
    The **pointCount** () and **point** () functions can be used to access and
    iterate individual touch points.

    The **points** () function returns a list of all touch points contained in
    the event. Note that this list may be empty, for example in case of a
    **QEvent::TouchCancel**  event. Each point is an instance of the
    **QEventPoint**  class. The **QEventPoint::State**  enum describes the
    different states that a touch point may have.

    **Note:** The list of **points** () will never be partial: A touch event
    will always contain a touch point for each existing physical touch contacts
    targeting the window or widget to which the event is sent. For instance,
    assuming that all touches target the same window or widget, an event with a
    condition of **points** ().count()==2 is guaranteed to imply that the number
    of fingers touching the touchscreen or touchpad is exactly two.
    ...
    **See also** **QEventPoint** , **QEventPoint::State** ,
    **Qt::WA_AcceptTouchEvents** , and **QGraphicsItem::acceptTouchEvents** ().
    ...
    def __init__(
        self,
        eventType: PySide6.QtCore.QEvent.Type,
        device: Optional[PySide6.QtGui.QPointingDevice] = ...,
        modifiers: PySide6.QtCore.Qt.KeyboardModifiers = ...,
        touchPoints: Sequence[PySide6.QtGui.QEventPoint] = ...,
    ) -> None:
        ...
    ...
    def isBeginEvent(self) -> bool:
        """
        https://doc.qt.io/qt-6/qtouchevent.html#isBeginEvent

        **[override virtual] bool QTouchEvent::isBeginEvent() const**

        Returns true if this event includes at least one newly-pressed
        touchpoint.
        """
        ...
    ...
    def isEndEvent(self) -> bool:
        """
        https://doc.qt.io/qt-6/qtouchevent.html#isEndEvent

        **[override virtual] bool QTouchEvent::isEndEvent() const**

        Returns true if this event includes at least one newly-released
        touchpoint.
        """
        ...
    ...
    def isUpdateEvent(self) -> bool:
        """
        https://doc.qt.io/qt-6/qtouchevent.html#isUpdateEvent

        **[override virtual] bool QTouchEvent::isUpdateEvent() const**

        Returns true if this event does not include newly-pressed or newly-
    ...
    def target(self) -> PySide6.QtCore.QObject:
        """
        https://doc.qt.io/qt-6/qtouchevent.html#target
