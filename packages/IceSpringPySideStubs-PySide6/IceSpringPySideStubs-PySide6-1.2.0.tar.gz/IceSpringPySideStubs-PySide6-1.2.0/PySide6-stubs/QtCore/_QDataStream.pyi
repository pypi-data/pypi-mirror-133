...
class QDataStream(PySide6.QtCore.QIODeviceBase):
    ...
    **See also** **QTextStream**  and **QVariant** .
    ...
    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QBitArray, int]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QByteArray, bytes]
    ) -> PySide6.QtCore.QDataStream:
        ...
    ...
    def __lshift__(
        self,
        arg__2: Union[PySide6.QtCore.QEasingCurve, PySide6.QtCore.QEasingCurve.Type],
    ) -> PySide6.QtCore.QDataStream:
        ...
    ...
    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QLineF, PySide6.QtCore.QLine]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QLocale, PySide6.QtCore.QLocale.Language]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QMarginsF, PySide6.QtCore.QMargins]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QSizeF, PySide6.QtCore.QSize]
    ) -> PySide6.QtCore.QDataStream:
        ...

    @overload
    def __lshift__(
        self, arg__2: Union[PySide6.QtCore.QUrl, str]
    ) -> PySide6.QtCore.QDataStream:
        ...
    ...
    @overload
    def __lshift__(
        self, re: Union[PySide6.QtCore.QRegularExpression, str]
    ) -> PySide6.QtCore.QDataStream:
        ...
