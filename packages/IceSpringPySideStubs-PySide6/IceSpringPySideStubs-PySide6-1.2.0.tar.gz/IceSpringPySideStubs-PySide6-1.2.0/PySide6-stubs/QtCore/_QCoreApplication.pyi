...
class QCoreApplication(PySide6.QtCore.QObject):
    ...
    **QEventLoop** , **Semaphores Example** , and **Wait Conditions Example** .
    ...
    @staticmethod
    def sendEvent(
        receiver: PySide6.QtCore.QObject, event: PySide6.QtCore.QEvent
    ) -> bool:
        """
    ...
    def sendPostedEvents(
        receiver: Optional[PySide6.QtCore.QObject] = ..., event_type: int = ...
    ) -> None:
        """
    ...
    @staticmethod
    def translate(
        context: bytes, key: bytes, disambiguation: Optional[bytes] = ..., n: int = ...
    ) -> str:
        """
