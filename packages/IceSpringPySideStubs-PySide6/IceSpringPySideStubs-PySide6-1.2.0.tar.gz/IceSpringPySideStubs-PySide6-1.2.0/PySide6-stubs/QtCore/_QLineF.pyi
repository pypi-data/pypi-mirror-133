...
class QLineF(object):
    ...
    **See also** **QLine** , **QPolygonF** , and **QRectF** .
    ...
    @overload
    def __init__(
        self, QLineF: Union[PySide6.QtCore.QLineF, PySide6.QtCore.QLine]
    ) -> None:
        """
    ...
    def __init__(
        self,
        pt1: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
        pt2: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
    ) -> None:
        """
    ...
    def intersects(
        self,
        l: Union[PySide6.QtCore.QLineF, PySide6.QtCore.QLine],
        intersectionPoint: Union[
