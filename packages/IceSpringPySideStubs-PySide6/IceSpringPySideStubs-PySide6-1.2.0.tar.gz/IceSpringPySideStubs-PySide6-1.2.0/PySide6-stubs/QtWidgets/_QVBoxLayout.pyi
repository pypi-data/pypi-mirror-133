...
class QVBoxLayout(PySide6.QtWidgets.QBoxLayout):
    ...
    **QVBoxLayout** (window);
    ...
    the QVBoxLayout object, setting `window` as parent by passing it in the
    ...
    point use **QWidget::setLayout** () to install the QVBoxLayout object onto
    ...
    **Layout Management** , and **Basic Layouts Example** .
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-6/qvboxlayout.html#QVBoxLayout
    ...
    def __init__(self, parent: PySide6.QtWidgets.QWidget) -> None:
        """
        https://doc.qt.io/qt-6/qvboxlayout.html#QVBoxLayout-1
