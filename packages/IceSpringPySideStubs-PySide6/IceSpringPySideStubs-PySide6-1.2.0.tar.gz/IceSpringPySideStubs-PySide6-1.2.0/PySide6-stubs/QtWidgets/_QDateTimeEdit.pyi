...
class QDateTimeEdit(PySide6.QtWidgets.QAbstractSpinBox):
    ...
    **See also** **QDateEdit** , **QTimeEdit** , **QDate** , and **QTime** .
    ...
    @overload
    def __init__(
        self, d: PySide6.QtCore.QDate, parent: Optional[PySide6.QtWidgets.QWidget] = ...
    ) -> None:
        """
    ...
    @overload
    def __init__(
        self, t: PySide6.QtCore.QTime, parent: Optional[PySide6.QtWidgets.QWidget] = ...
    ) -> None:
        """
    ...
    def setTimeRange(
        self, min: PySide6.QtCore.QTime, max: PySide6.QtCore.QTime
    ) -> None:
        """
