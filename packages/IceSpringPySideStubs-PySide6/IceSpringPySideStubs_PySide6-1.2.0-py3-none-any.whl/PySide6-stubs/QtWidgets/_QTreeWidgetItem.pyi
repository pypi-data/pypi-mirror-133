...
class QTreeWidgetItem(object):
    ...
    **See also** **QTreeWidget** , **QTreeWidgetItemIterator** , **Model/View
    ...
    @overload
    def __init__(
        self, treeview: PySide6.QtWidgets.QTreeWidget, type: int = ...
    ) -> None:
        """
    ...
    def addChildren(
        self, children: Sequence[PySide6.QtWidgets.QTreeWidgetItem]
    ) -> None:
        """
    ...
    def setFont(
        self, column: int, font: Union[PySide6.QtGui.QFont, str, Sequence[str]]
    ) -> None:
        """
    ...
    def setIcon(
        self, column: int, icon: Union[PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap]
    ) -> None:
        """
