...
class QOpenGLFunctions_4_5_Compatibility(PySide6.QtOpenGL.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-6/qopenglfunctions-4-5-compatibility.html
    ...
    **See also** **QAbstractOpenGLFunctions** .
    ...
    def glMultiTexCoordP1uiv(
        self, texture: int, type: int, coords: Sequence[int]
    ) -> None:
        ...
    ...
    def glPrioritizeTextures(
        self, n: int, textures: Sequence[int], priorities: Sequence[float]
    ) -> None:
        ...
