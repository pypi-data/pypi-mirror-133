...
class QEasingCurve(object):
    ...
    **QPropertyAnimation**  animation;
    ...
    def __init__(
        self,
        other: Union[PySide6.QtCore.QEasingCurve, PySide6.QtCore.QEasingCurve.Type],
    ) -> None:
        """
    ...
    def addCubicBezierSegment(
        self,
        c1: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
        c2: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
        endPoint: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
    ) -> None:
        """
    ...
    def addTCBSegment(
        self,
        nextPoint: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint],
        t: float,
        c: float,
        b: float,
    ) -> None:
