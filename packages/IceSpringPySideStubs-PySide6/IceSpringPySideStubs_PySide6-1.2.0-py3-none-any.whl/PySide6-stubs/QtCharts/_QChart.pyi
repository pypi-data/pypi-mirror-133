...
class QChart(PySide6.QtWidgets.QGraphicsWidget):
    ...
    **See also** **QChartView**  and **QPolarChart** .
    ...
    def axes(
        ...
        series: Optional[PySide6.QtCharts.QAbstractSeries] = ...,
    ...
    def axisX(
        self, series: Optional[PySide6.QtCharts.QAbstractSeries] = ...
    ...
    def setAnimationEasingCurve(
        self,
        curve: Union[PySide6.QtCore.QEasingCurve, PySide6.QtCore.QEasingCurve.Type],
    ) -> None:
        """
        https://doc.qt.io/qt-6/qchart.html#animationEasingCurve-prop
