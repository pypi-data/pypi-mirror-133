...
class QMenu(PySide6.QtWidgets.QWidget):
    ...
    **See also** **QMenuBar** , **GUI Design Handbook: Menu, Drop-Down and Pop-
    ...
    def addAction(
        self,
        arg__1: Union[(PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap)],
        arg__2: str,
        arg__3: object,
        arg__4: Union[
            (
    ...
    def exec(
        ...
        at: Optional[PySide6.QtGui.QAction] = ...,
    ...
    @overload
    def exec(
        self, pos: PySide6.QtCore.QPoint, at: Optional[PySide6.QtGui.QAction] = ...
    ) -> PySide6.QtGui.QAction:
        """
    ...
    def exec_(
        ...
        action: Optional[PySide6.QtGui.QAction] = ...,
    ) -> PySide6.QtGui.QAction:
        """
        https://doc.qt.io/qt-6/qmenu.html#exec
    ...
    def setIcon(
        self, icon: Union[(PySide6.QtGui.QIcon, PySide6.QtGui.QPixmap)]
    ) -> None:
        """
        https://doc.qt.io/qt-6/qmenu.html#icon-prop
