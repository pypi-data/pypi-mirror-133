...
"""Setup.py for the apache-airflow-providers-yandex package."""
...
def do_setup():
    """Perform the package apache-airflow-providers-yandex setup."""
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'yandexcloud>=0.122.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-yandex/2.2.0/',
