...
class ScexClient:
    def __init__(self, host: str, api_key: str):
        self.__request_url = f"http://{host}/scex/api/v1/request"
    ...
    def __initialize_defaults(self, options: dict):
        ...
        options.setdefault("AccuralCode", AccuralCode.ACTUAL_360_SIMPLE.value)
    ...
    def process_equal_payment_loan(self, options: dict):
        ...
        return self._api_handler.send_request("POST", payload=equal_payment_input)

    def process_balloon_payment_loan_regular(self, options: dict):
        options = self.__initialize_defaults(options)
        ...
        return self._api_handler.send_request("POST", payload=balloon_regular_payment_input)

    def process_balloon_payment_loan_final(self, options: dict):
        options = self.__initialize_defaults(options)
        ...
        return self._api_handler.send_request("POST", payload=balloon_final_payment_input)
