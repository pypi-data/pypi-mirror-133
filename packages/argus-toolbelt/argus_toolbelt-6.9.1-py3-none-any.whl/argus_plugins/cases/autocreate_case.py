...
def customer_language(customer: dict) -> str:
    ...
    try:
        ...
        return get_customer(idOrShortname=customer["shortName"])["data"]["language"]
...
def autocreate(
    ...
    :param silent_update: if set, do not add a comment upon adding new events to an existing case.
