...
from meili_sdk.websockets.models.task import Task
...
class MeiliWebsocketClient:
    ...
    __vehicles = []
    __connection: websocket.WebSocketApp
    ...
    def on_message(self, _, message):
        ...
        try:
            ...
            if not vehicle and self.__fleet:
                raise WebsocketException(
                    "Malformed message received. No vehicle in a fleet connection"
                )
    ...
    def send(self, message: t.Union[dict, list, Message]):
        """
    ...
    def process_message(
        ...
        if processor and callable(processor):
            processor(message, message, vehicle)
