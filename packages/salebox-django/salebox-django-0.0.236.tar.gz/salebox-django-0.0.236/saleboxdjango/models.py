...
class Member(models.Model):
    ...
    group_when_created = models.ForeignKey(
        MemberGroup,
        blank=True,
        null=True,
        related_name="group_when_created",
...
class Product(models.Model):
    ...
    string_5 = models.CharField(max_length=150, blank=True, null=True)
    string_6 = models.CharField(max_length=150, blank=True, null=True)
    string_7 = models.CharField(max_length=150, blank=True, null=True)
    string_8 = models.CharField(max_length=150, blank=True, null=True)
    string_9 = models.CharField(max_length=150, blank=True, null=True)
    string_10 = models.CharField(max_length=150, blank=True, null=True)
    boolean_1 = models.BooleanField(default=False)
    boolean_2 = models.BooleanField(default=False)
    boolean_3 = models.BooleanField(default=False)
    boolean_4 = models.BooleanField(default=False)
...
class ProductVariant(models.Model):
    ...
    int_5 = models.IntegerField(blank=True, null=True)
