...
class Client(Callbacks, SocketHandler):
    ...
    def parse_headers(self, data = None,deviceId:str=device.device_id):
        if data:
            #print(data)
    ...
    def request_verify_code(self, dev: str,email: str, resetPassword: bool = False):
        """
    ...
    def devicee(self):
        dev=requests.get("https://devgen17.herokuapp.com/dev")
        return dev.json()["dev"]
