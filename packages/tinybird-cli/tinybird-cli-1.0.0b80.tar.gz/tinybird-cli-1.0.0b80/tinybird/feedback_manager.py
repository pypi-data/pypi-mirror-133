...
**    $ tb datasource rm {datasource}""")
    ...
    warning_confirm_delete_rows_datasource = warning_message("Do you want to delete {datasource}'s rows matching condition \"{delete_condition}\"? Once deleted, they can't be recovered")
