...
install_requires = \
['aiohttp>=3.7.3,<4.0.0',
 'ampel-alerts>=0.8.3-alpha.2,<0.9.0',
 'ampel-core>=0.8.3-alpha.1,<0.9.0',
 'ampel-interface>=0.8.3-alpha.3,<0.9.0',
 'ampel-photometry>=0.8.3-alpha.1,<0.9.0',
 'astropy>=5.0,<6.0',
...
{'archive': ['ampel-ztf-archive>=0.8.0-alpha.0,<0.9.0'],
 'light-curve': ['light-curve>=0.2.5,<0.6']}
