...
class AgoraDesk:
    ...
    def contact_create(
        ...
        buyer_settlement_address: Optional[str] = None,
    ) -> Dict[str, Any]:
        """See Agoradesk API.
        ...
        if msg:
            payload["msg"] = msg
        if buyer_settlement_address:
            payload["buyer_settlement_address"] = buyer_settlement_address
        return self._api_call(
    ...
    def ad_create(
        ...
        if buyer_settlement_address:
            params["buyer_settlement_address"] = buyer_settlement_address
        if online_provider:
