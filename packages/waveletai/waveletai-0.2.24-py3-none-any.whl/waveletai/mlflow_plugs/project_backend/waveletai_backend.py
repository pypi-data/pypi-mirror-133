...
from mlflow.projects import _wait_for
    ...
    def run(self, project_uri, entry_point, params, version, backend_config, tracking_uri, experiment_id):
        ...
        if project.docker_env:
            ...
            if isinstance(user_env_vars, list):
                ...
                user_env_vars = [user_env_vars, envs.API_TOKEN, envs.API_MODEL, envs.API_PROJ]
...
def _build_docker_image(work_dir, repository_uri, base_image, run_id, dependence):
    """
...
def _run_entry_point(command, work_dir, experiment_id, run_id):
    ...
    _logger.info("=== Running command '%s' in run with ID '%s' === ", pure_command, run_id)
