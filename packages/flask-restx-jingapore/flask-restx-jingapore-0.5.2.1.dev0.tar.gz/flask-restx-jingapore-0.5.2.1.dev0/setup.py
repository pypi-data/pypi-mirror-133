...
exec(
    compile(open("flask_restx_jingapore/__about__.py").read(), "flask_restx_jingapore/__about__.py", "exec")
)
...
setup(
    name="flask-restx-jingapore",
    version=__version__,
    description=__description__,
    long_description=long_description,
    url="https://github.com/jingapore/flask-restx",
