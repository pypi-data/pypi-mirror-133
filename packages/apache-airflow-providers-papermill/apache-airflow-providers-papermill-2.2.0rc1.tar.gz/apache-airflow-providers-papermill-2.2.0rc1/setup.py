...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'papermill[all]>=1.2.1', 'scrapbook[all]'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-papermill/2.2.0/',
