"use strict";(self.webpackChunksas_frontend=self.webpackChunksas_frontend||[]).push([[81999],{21560:(e,t,s)=>{s.d(t,{ZH:()=>d,MT:()=>i,U2:()=>l,RV:()=>a,t8:()=>c});const o=function(){if(!(!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent))||!indexedDB.databases)return Promise.resolve();let e;return new Promise((t=>{const s=()=>indexedDB.databases().finally(t);e=setInterval(s,100),s()})).finally((()=>clearInterval(e)))};function a(e){return new Promise(((t,s)=>{e.oncomplete=e.onsuccess=()=>t(e.result),e.onabort=e.onerror=()=>s(e.error)}))}function i(e,t){const s=o().then((()=>{const s=indexedDB.open(e);return s.onupgradeneeded=()=>s.result.createObjectStore(t),a(s)}));return(e,o)=>s.then((s=>o(s.transaction(t,e).objectStore(t))))}let n;function r(){return n||(n=i("keyval-store","keyval")),n}function l(e,t=r()){return t("readonly",(t=>a(t.get(e))))}function c(e,t,s=r()){return s("readwrite",(s=>(s.put(t,e),a(s.transaction))))}function d(e=r()){return e("readwrite",(e=>(e.clear(),a(e.transaction))))}},22179:(e,t,s)=>{s.r(t);s(53918);var o=s(50856),a=s(28426),i=(s(34821),s(31206),s(28007),s(10983),s(1265));s(36436);class n extends((0,i.Z)(a.H3)){static get template(){return o.d`
...
//# sourceMappingURL=4e5ccb91.js.map