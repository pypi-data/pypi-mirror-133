...
`;!function(e,t,r,i){var n=s();if(i)for(var o=0;o<i.length;o++)n=i[o](n);var a=t((function(e){n.initializeInstanceElements(e,f.elements)}),r),f=n.decorateClass(function(e){for(var t=[],r=function(e){return"method"===e.kind&&e.key===o.key&&e.placement===o.placement},i=0;i<e.length;i++){var n,o=e[i];if("method"===o.kind&&(n=t.find(r)))if(p(o.descriptor)||p(n.descriptor)){if(d(o)||d(n))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");n.descriptor=o.descriptor}else{if(d(o)){if(d(n))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");n.decorators=o.decorators}c(o,n)}else t.push(o)}return t}(a.d.map(l)),e);n.initializeClassElements(a.F,f.elements),n.runClassFinishers(a.F,f.finishers)}([(0,o.M)("ha-dialog")],(function(e,t){class r extends t{constructor(...t){super(...t),e(this)}}return{F:r,d:[{kind:"method",key:"scrollToPos",value:function(e,t){var r;null===(r=this.contentElement)||void 0===r||r.scrollTo(e,t)}},{kind:"method",key:"renderHeading",value:function(){return n.dy`<slot name="heading"> ${m(y(r.prototype),"renderHeading",this).call(this)} </slot>`}},{kind:"get",static:!0,key:"styles",value:function(){return[i.V.styles,n.iv`
      ...
      <ha-dialog
        ...
        escapeKeyAction
        hideActions
        .heading=${(0,s.i)(this.hass,this.hass.localize("ui.dialogs.domain_toggler.title"))}
      >
        <div>
          ${e.map((e=>i.dy`
    ...
    `}},{kind:"method",key:"_handleSwitch",value:function(e){this._params.toggleDomain(e.currentTarget.domain,e.target.checked),e.currentTarget.blur()}},{kind:"method",key:"_handleReset",value:function(e){this._params.resetDomain(e.currentTarget.domain),e.currentTarget.blur()}},{kind:"get",static:!0,key:"styles",value:function(){return[c.yu,i.iv`
      ...
      `]}}]}}),i.oi)}}]);
//# sourceMappingURL=f02fb4b3.js.map