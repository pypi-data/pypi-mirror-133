...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.merging', 'pm4py.algo.merging.case_relations',
              ...
              'pm4py.algo.discovery.inductive.variants', 'pm4py.algo.discovery.inductive.variants.im',
              ...
              'pm4py.algo.discovery.performance_spectrum', 'pm4py.algo.discovery.performance_spectrum.variants',
              ...
              'pm4py.algo.filtering.log.attr_value_repetition', 'pm4py.algo.filtering.ocel',
              ...
              'pm4py.algo.simulation.tree_playout', 'pm4py.algo.simulation.tree_generator',
              'pm4py.algo.simulation.tree_generator.variants', 'pm4py.algo.conformance',
              'pm4py.algo.conformance.alignments', 'pm4py.algo.conformance.alignments.dfg',
              'pm4py.algo.conformance.alignments.dfg.variants', 'pm4py.algo.conformance.alignments.variants',
              'pm4py.algo.conformance.alignments.petri_net', 'pm4py.algo.conformance.alignments.petri_net.utils',
              ...
              'pm4py.algo.conformance.antialignments.variants', 'pm4py.algo.conformance.logs_alignments',
              'pm4py.algo.conformance.multialignments', 'pm4py.algo.conformance.multialignments.variants',
              'pm4py.algo.conformance.tree_alignments', 'pm4py.algo.conformance.temporal_profile',
              ...
              'pm4py.algo.enhancement.resource_profiles', 'pm4py.algo.enhancement.resource_profiles.variants',
              'pm4py.algo.enhancement.organizational_mining',
              'pm4py.algo.enhancement.organizational_mining.local_diagnostics', 'pm4py.algo.transformation',
              ...
              'pm4py.algo.transformation.ocel.features.objects', 'pm4py.algo.transformation.ocel.split_ocel',
              ...
              'pm4py.objects.petri.exporter.variants', 'pm4py.objects.petri.importer',
              'pm4py.objects.petri.importer.variants', 'pm4py.objects.petri_net', 'pm4py.objects.petri_net.utils',
              'pm4py.objects.petri_net.exporter', 'pm4py.objects.petri_net.exporter.variants',
              'pm4py.objects.petri_net.importer', 'pm4py.objects.petri_net.importer.variants',
              'pm4py.objects.petri_net.data_petri_nets', 'pm4py.objects.petri_net.inhibitor_reset',
              'pm4py.objects.conversion', 'pm4py.objects.conversion.dfg', 'pm4py.objects.conversion.dfg.variants',
              'pm4py.objects.conversion.log', 'pm4py.objects.conversion.log.variants', 'pm4py.objects.conversion.bpmn',
              ...
              'pm4py.simulation.tree_generator.variants', 'pm4py.statistics', 'pm4py.statistics.ocel',
              'pm4py.statistics.util', 'pm4py.statistics.rework', 'pm4py.statistics.rework.log',
              'pm4py.statistics.rework.cases', 'pm4py.statistics.rework.cases.log',
              ...
              'pm4py.statistics.concurrent_activities', 'pm4py.statistics.concurrent_activities.log',
              'pm4py.statistics.concurrent_activities.pandas', 'pm4py.visualization', 'pm4py.visualization.dfg',
              'pm4py.visualization.dfg.variants', 'pm4py.visualization.sna', 'pm4py.visualization.sna.variants',
              'pm4py.visualization.bpmn', 'pm4py.visualization.bpmn.variants', 'pm4py.visualization.ocel',
              'pm4py.visualization.ocel.ocpn', 'pm4py.visualization.ocel.ocpn.variants',
              'pm4py.visualization.ocel.ocdfg', 'pm4py.visualization.ocel.ocdfg.variants',
              'pm4py.visualization.ocel.interleavings', 'pm4py.visualization.ocel.interleavings.variants',
              'pm4py.visualization.trie', 'pm4py.visualization.trie.variants', 'pm4py.visualization.common',
              'pm4py.visualization.graphs', 'pm4py.visualization.graphs.util', 'pm4py.visualization.graphs.variants',
              'pm4py.visualization.petrinet', 'pm4py.visualization.petrinet.util',
              'pm4py.visualization.petrinet.common', 'pm4py.visualization.petrinet.variants',
              'pm4py.visualization.petri_net', 'pm4py.visualization.petri_net.util',
              'pm4py.visualization.petri_net.common', 'pm4py.visualization.petri_net.variants',
              'pm4py.visualization.footprints', 'pm4py.visualization.footprints.variants',
              'pm4py.visualization.align_table', 'pm4py.visualization.align_table.variants',
              'pm4py.visualization.decisiontree', 'pm4py.visualization.decisiontree.util',
              'pm4py.visualization.decisiontree.variants', 'pm4py.visualization.dotted_chart',
              'pm4py.visualization.dotted_chart.variants', 'pm4py.visualization.process_tree',
              'pm4py.visualization.process_tree.variants', 'pm4py.visualization.heuristics_net',
              'pm4py.visualization.heuristics_net.variants', 'pm4py.visualization.network_analysis',
