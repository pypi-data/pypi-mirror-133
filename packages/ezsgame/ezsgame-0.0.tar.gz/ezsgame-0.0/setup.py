...
PACKAGE_NAME = 'ezsgame' #Debe coincidir con el nombre de la carpeta 
...
DESCRIPTION = 'En general ezgame Trata de hacer mas simple el proceso de Creacion y manipulacion de graficos 2D.' #Descripción corta
