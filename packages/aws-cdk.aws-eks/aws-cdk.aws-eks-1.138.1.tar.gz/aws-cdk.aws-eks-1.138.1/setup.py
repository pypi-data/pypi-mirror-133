    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-s3-assets==1.138.1",
        "aws-cdk.aws-ssm==1.138.1",
        "aws-cdk.core==1.138.1",
        "aws-cdk.custom-resources==1.138.1",
        "aws-cdk.lambda-layer-awscli==1.138.1",
        "aws-cdk.lambda-layer-kubectl==1.138.1",
        "aws-cdk.lambda-layer-node-proxy-agent==1.138.1",
