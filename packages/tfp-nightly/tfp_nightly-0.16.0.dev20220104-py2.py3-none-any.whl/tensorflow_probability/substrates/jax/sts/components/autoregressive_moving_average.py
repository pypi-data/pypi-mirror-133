...
from tensorflow_probability.substrates.jax.sts.components.autoregressive import make_ar_transition_matrix
...
#   `tensorflow_probability/substrates/jax/sts/components/autoregressive_moving_average.py`
