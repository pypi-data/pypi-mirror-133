...
from tensorflow_probability.substrates.numpy.distributions import joint_distribution_auto_batched
from tensorflow_probability.substrates.numpy.distributions import sample
from tensorflow_probability.substrates.numpy.experimental import util as tfe_util
...
from tensorflow_probability.substrates.numpy.sts.internal import util as sts_util
...
class StructuralTimeSeries(object):
  ...
  def __add__(self, other):
    ...
    from tensorflow_probability.substrates.numpy.sts.components import sum as sts_sum  # pylint: disable=g-import-not-at-top
...
#   `tensorflow_probability/substrates/numpy/sts/structural_time_series.py`
