...
def as_stateful_builder(generator):
  ...
  # TF-specific imports.
  from tensorflow_probability.substrates.numpy.experimental.util import deferred_module  # pylint: disable=g-import-not-at-top
...
#   `tensorflow_probability/substrates/numpy/internal/trainable_state_util.py`
