import SubFoldersProject
import pygame
window=pygame.display.set_mode((700, 640))

b1=SubFoldersProject.TileTool('desert.tmx',0,0,layer=1)
"""
...
f1=SubFoldersProject.platforms_objects(100,20,filename)
"""
...
camera_obj=SubFoldersProject.camera(1000,1000,f1)
"""
