            ...
            for family in self.updated_family_objects:
                ...
                with open(writable_file_path, 'w') as f:
                    try:
                        ...
                        elif 'extraction_time' in fam_dict['groups'][list(fam_dict.keys())[0]]:
                            json.dump({'fatal_json_dump_exception': str(e), 'extraction_time': fam_dict['groups'][list(fam_dict.keys())[0]]['extraction_time']}, f)
                        else:
