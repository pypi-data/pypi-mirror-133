    ...
    def flush_metadata_to_files(self, writer='json'):
        ...
        if writer == 'json':
            for family in self.updated_family_objects:
                ...
                group_keys = all_groups.keys()
                list_keys = list(group_keys)
                first_group_key = list_keys[0]
                first_group = all_groups[first_group_key]
                first_group_ext_time = first_group['extraction_time']
