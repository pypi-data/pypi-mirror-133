...
setup(
    ...
    version='1.0.0-dev20220104194741',
    description='Renderer implementation for RGB Matrix Displays',
    ...
    license='MIT',
    url='https://gitlab.com/aurora-display-lib/aurora-renderer-rgbmatrix',
