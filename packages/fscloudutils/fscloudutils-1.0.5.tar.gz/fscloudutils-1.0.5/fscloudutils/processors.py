...
class TaskProcessor:
    def __init__(self, region_name, bucket_name, service_name, queue_name, local=False):
        """
    ...
    def __pull_task__(self, path=None):
        """
    ...
    def __download_data__(self, data):
        """
    ...
    def __input_validation__(self, data, localpath, universal_model_input_requirement):
