...
class FileSystem(object):
    ...
    def _get_access_token(self):
        if (self._access_token is not None and
            (self._access_token_expire is None or self._access_token_expire < time.time())):
            return
        ...
        self._access_token_expire = time.time() + int(md['expires_in'])
