...
def get_provider_info():
    return {
        ...
        'versions': ['2.2.0', '2.1.0', '2.0.2', '2.0.1', '2.0.0', '1.0.1', '1.0.0'],
        'additional-dependencies': ['apache-airflow>=2.1.0'],
        'integrations': [
            {
                'integration-name': 'Databricks',
                'external-doc-url': 'https://databricks.com/',
                'how-to-guide': ['/docs/apache-airflow-providers-databricks/operators.rst'],
        ...
        'hooks': [
            {
                'integration-name': 'Databricks',
                'python-modules': ['airflow.providers.databricks.hooks.databricks'],
            }
        ],
