        ...
        req.done(function (data) {
            ...
            if (data.table_ident) {
                ...
                if (current_station !== 'Null') {
                    ...
                    /* document.getElementById('lbl_div_audio').style.color = "#db6f34"; */
                    /* document.getElementById('lbl_div_audio').style.fontSize = "115%"; */
    ...
    req.done(function (data) {
        ...
        if (data.play_station !== null) {
            if (data.play_station !== ',') {
                ...
                document.getElementById('lbl_div_audio').innerText = " ► " + station;
