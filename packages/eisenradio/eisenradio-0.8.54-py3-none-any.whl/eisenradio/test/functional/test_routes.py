...
class TestRouteHome(unittest.TestCase):
    ...
    def test_route_home(self):
        ...
        print(""" test Blueprint HOME - default folders """)
        ...
        rv = web.post('/index_posts_combo',
                      data=dict(time_record_select_all=timer),
                      follow_redirects=True,
        ...
        eisen_radio.active_displays = {2: 'OVAN 오반 - I Need You 어떻게 지내',
        ...
        data = json.loads(rv.get_data(as_text=True))
        assert rv.status_code == 200
        assert data['result'] == "2=OVAN 오반 - I Need You 어떻게 지내,3=Henrik Freischlader Band - Take The Blame,6=Yoko " \
                                 "Kanno and The Seatbelts - Waltz for Zizi,"
