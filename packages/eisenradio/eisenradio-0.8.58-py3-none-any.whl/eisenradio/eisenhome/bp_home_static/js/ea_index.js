        ...
        req.done(function (data) {
            ...
            if (data.table_ident) {
                ...
                if (current_station !== 'Null') {
                    ...
                    document.getElementById('lbl_div_audio').innerText = " ► " + current_station.substring(0, 20);
    ...
    req.done(function (data) {
        ...
        if (data.play_station !== null) {
            if (data.play_station !== ',') {
                ...
                document.getElementById('lbl_div_audio').innerText = " ► " + station.substring(0, 20);
    ...
    req.done(function (data) {
        ...
        if (request_time !== 'Null') {
            if (request_time !== "---") {
                ...
                document.getElementById('request_icy_br').innerText = "" + request_icy_br + " k";
            }
            if (request_time === "---") {
                document.getElementById('request_time').innerText = "";
