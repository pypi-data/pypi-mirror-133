var global_last_icy_name_and_id = ""
$(document).ready(function () {

    cookieStuff();
    var timer_console_info = setInterval(console_info, 5003);
        ...
        req.done(function (data) {
            ...
            if (data.table_ident) {
                ...
                if (current_station !== 'Null') {
                    ...
                    document.getElementById('lbl_div_audio').innerText = " ► " + current_station.substring(0, 12);
    ...
    req.done(function (data) {
        ...
        if (data.play_station !== null) {
            if (data.play_station !== ',') {
                ...
                document.getElementById('lbl_div_audio').innerText = " ► " + station.substring(0, 12);
...
function cookie_set_streamer() {
    ...
    /* console.log('########### cookie_set_streamer #########'); */
}
;
        ...
        if (data.str_streamer) {
            ...
            $.each(streamer, function (idx, val) {
                ...
                if (stream.length !== 0) {
                    ...
                    /* console.log('--> data.str_streamer stream.length  '+data.str_streamer) */
                }
...
function console_info() {
    ...
    req.done(function (data) {
        document.getElementById('request_time').innerText = "";
        let request_time = data.request_time;
        let request_suffix = data.request_suffix;
        let request_icy_genre = data.request_icy_genre;
        let request_icy_name = data.request_icy_name;
        let request_icy_view_id = data.request_icy_view_id;
        let request_icy_br = data.request_icy_br;

        let color = "#ffa600";

        if (request_time !== 'Null') {
            if (request_time !== "---") {
                document.getElementById('request_time').innerText = "    " + request_time + " ms";
                document.getElementById('request_suffix').innerText = "" + request_suffix;
                document.getElementById('request_icy_genre').innerText = "" + request_icy_genre;
                document.getElementById('request_icy_br').innerText = "" + request_icy_br + " b";
            }
            if (request_time === "---") {
                document.getElementById('request_time').innerText = "";
                document.getElementById('request_suffix').innerText = "";
                document.getElementById('request_icy_genre').innerText = "";
                document.getElementById('request_icy_br').innerText = "";
            }

            if (request_icy_name !== "") {

                if (global_last_icy_name_and_id !== "") {
                document.getElementById(global_last_icy_name_and_id).innerText = "";
                }

                global_last_icy_name_and_id = 'icy_name_' + request_icy_view_id
                document.getElementById('icy_name_' + request_icy_view_id).innerText = request_icy_name;
            }
            /*
            console.log("##### request_icy_name  " + request_icy_name)
            */
        }
