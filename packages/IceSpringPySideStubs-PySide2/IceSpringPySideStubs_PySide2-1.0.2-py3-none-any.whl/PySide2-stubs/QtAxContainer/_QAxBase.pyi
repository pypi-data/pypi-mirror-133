...
class QAxBase(object):
    ...
    **Detailed Description**
    ...
    Properties exposed by the object\'s IDispatch implementation can be read and written through the property system provided by the Qt Object Model (both subclasses are **QObject** s, so you can use **QObject::setProperty** () and **QObject::property** ()). Properties with multiple parameters are not supported.
    ...
    **QAxObject**  object("<CLSID>");
    ...
    Note that the **QList**  the object should fill has to be provided as an element in the parameter list of **QVariant** s.
