...
class QNetworkDatagram(object):
    ...
    **FreeBSD** SupportedSupportedOnly for IPv6
    ...
    Windows (desktop)SupportedSupportedSupported
    ...
    **See also** **QUdpSocket**  and **QNetworkInterface** .
    ...
    def __init__(
        ...
        destinationAddress: PySide2.QtNetwork.QHostAddress = ...,
        port: int = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkdatagram.html#QNetworkDatagram
    ...
    def makeReply(
        self, payload: PySide2.QtCore.QByteArray
