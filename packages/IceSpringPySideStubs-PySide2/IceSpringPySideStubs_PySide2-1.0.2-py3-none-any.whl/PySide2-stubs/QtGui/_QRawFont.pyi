...
class QRawFont(object):
    ...
    **Note:** For the requirement of caching glyph indexes and font selections for static text to avoid reshaping and relayouting in the inner loop of an application, a better choice is the **QStaticText**  class, since it optimizes the memory cost of the cache and also provides the possibility of paint engine specific caches for an additional speed-up.
    ...
    def __init__(
        ...
        fileName: str,
        pixelSize: float,
        hintingPreference: PySide2.QtGui.QFont.HintingPreference = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qrawfont.html#QRawFont
    ...
    def __init__(
        self,
        fontData: PySide2.QtCore.QByteArray,
        pixelSize: float,
        hintingPreference: PySide2.QtGui.QFont.HintingPreference = ...,
    ) -> None:
        """
    ...
    def advancesForGlyphIndexes(self, glyphIndexes: typing.List) -> typing.List:
        ...
        **QVector<QPointF> QRawFont::advancesForGlyphIndexes(const QVector<quint32> & glyphIndexes , QRawFont::LayoutFlags layoutFlags ) const**
    ...
    def advancesForGlyphIndexes(
        self, glyphIndexes: typing.List, layoutFlags: PySide2.QtGui.QRawFont.LayoutFlags
    ) -> typing.List:
        """
        https://doc.qt.io/qt-5/qrawfont.html#advancesForGlyphIndexes
    ...
    def alphaMapForGlyph(
        self,
        glyphIndex: int,
        antialiasingType: PySide2.QtGui.QRawFont.AntialiasingType = ...,
        transform: PySide2.QtGui.QTransform = ...,
