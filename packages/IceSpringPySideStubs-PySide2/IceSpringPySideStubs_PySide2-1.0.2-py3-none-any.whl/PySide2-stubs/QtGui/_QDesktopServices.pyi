...
class QDesktopServices(object):
    ...
    **See also** **QSystemTrayIcon** , **QProcess** , and **QStandardPaths** .
    ...
    @staticmethod
    def setUrlHandler(
        scheme: str, receiver: PySide2.QtCore.QObject, method: bytes
    ) -> None:
        """
        ...
        **Warning:** It is not possible to claim support for some well known URL schemes, including http and https. This is only allowed for Universal Links.
        ...
        For more information, see the Apple Developer Documentation for <https://developer.apple.com/documentation/safariservices/supporting_associated_domains_in_your_app>[Supporting Associated Domains}.
