...
class QStandardItem(object):
    ...
    **See also** **QStandardItemModel** , **Item View Convenience Classes** , and **Model/View Programming** .
    ...
    def parent(self) -> PySide2.QtGui.QStandardItem:
        ...
        **Note:** For toplevel items parent() returns `nullptr`. To receive toplevel item's parent use **QStandardItemModel::invisibleRootItem** () instead.
    ...
    @typing.overload
    def setChild(
        self, row: int, column: int, item: PySide2.QtGui.QStandardItem
    ) -> None:
        """
    ...
    def sortChildren(
        self, column: int, order: PySide2.QtCore.Qt.SortOrder = ...
    ) -> None:
        """
