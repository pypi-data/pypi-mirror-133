...
class QLineF(object):
    ...
    **See also** **QLine** , **QPolygonF** , and **QRectF** .
    ...
    class IntersectType(object):
        NoIntersection: QLineF.IntersectType = ...
        BoundedIntersection: QLineF.IntersectType = ...
        UnboundedIntersection: QLineF.IntersectType = ...
    ...
    def setLength(self, len: float) -> None:
        ...
        **void QLineF::setLength(qreal length )**
        ...
        A null line will not be rescaled. For non-null lines with very short lengths (represented by denormal floating-point values), results may be imprecise.
