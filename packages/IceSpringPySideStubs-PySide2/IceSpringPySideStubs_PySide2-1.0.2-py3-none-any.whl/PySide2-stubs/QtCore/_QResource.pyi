    ...
    **See also** **The Qt Resource System** , **QFile** , **QDir** , and **QFileInfo** .
    ...
    def compressionAlgorithm(self) -> PySide2.QtCore.QResource.Compression:
        ...
        **QResource::Compression QResource::compressionAlgorithm() const**
        ...
        If this function returns **QResource::ZstdCompression** , you need to use the Zstandard library functios (`<zstd.h> header). Qt does not provide a wrapper. See \\l{http://facebook.github.io/zstd/zstd_manual.html}{Zstandard manual}. \\sa data(), isFile()`
    ...
    def uncompressedData(self) -> PySide2.QtCore.QByteArray:
        ...
        **See also** **uncompressedSize** (), **size** (), **isCompressed** (), and **isFile** ().
        """
        ...
