...
class QCborValue(object):
    ...
    **See also** **QCborArray** , **QCborMap** , **QCborStreamReader** , and **QCborStreamWriter** .
    ...
    def fromVariant(variant: typing.Any) -> PySide2.QtCore.QCborValue:
        ...
        **quint64** Integer, but they are cast to `qint64` first so values higher than 263-1 (`INT64_MAX`) will be wrapped to negative
        `float`, `double`Double
    ...
    def toCbor(
        ...
        **QByteArray QCborValue::toCbor(QCborValue::EncodingOptions opt = NoTransformation)**
    ...
    def toJsonValue(self) -> PySide2.QtCore.QJsonValue:
        ...
        **ExpectedBase64url** Byte arrayEncodes the byte array as Base64url
        **ExpectedBase64** Byte arrayEncodes the byte array as Base64
        **ExpectedBase16** Byte arrayEncodes the byte array as hex
