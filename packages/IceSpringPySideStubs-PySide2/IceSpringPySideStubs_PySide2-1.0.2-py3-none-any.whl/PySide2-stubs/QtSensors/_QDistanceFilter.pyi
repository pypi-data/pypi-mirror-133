...
class QDistanceFilter(PySide2.QtSensors.QSensorFilter):
    """
    https://doc.qt.io/qt-5/qdistancefilter.html

    **Detailed Description**

    The only difference is that the **filter** () method features a pointer to **QDistanceReading**  instead of **QSensorReading** .
    """
    ...
    def filter(self, reading: PySide2.QtSensors.QDistanceReading) -> bool:
        """
        https://doc.qt.io/qt-5/qdistancefilter.html#filter

        **[pure virtual] bool QDistanceFilter::filter(QDistanceReading * reading )**
