...
class QHumidityFilter(PySide2.QtSensors.QSensorFilter):
    """
    https://doc.qt.io/qt-5/qhumidityfilter.html

    **Detailed Description**

    The only difference is that the **filter** () method features a pointer to **QHumidityReading**  instead of **QSensorReading** .
    """
    ...
    def filter(self, reading: PySide2.QtSensors.QHumidityReading) -> bool:
        """
        https://doc.qt.io/qt-5/qhumidityfilter.html#filter

        **[pure virtual] bool QHumidityFilter::filter(QHumidityReading * reading )**
