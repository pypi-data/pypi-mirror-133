...
class QTiltFilter(PySide2.QtSensors.QSensorFilter):
    """
    https://doc.qt.io/qt-5/qtiltfilter.html

    **Detailed Description**

    The only difference is that the **filter** () method features a pointer to **QTiltReading**  instead of **QSensorReading** .
    """
    ...
    def filter(self, reading: PySide2.QtSensors.QSensorReading) -> bool:
        """
        https://doc.qt.io/qt-5/qtiltfilter.html#filter

        **[pure virtual] bool QTiltFilter::filter(QTiltReading * reading )**
