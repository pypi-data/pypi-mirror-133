...
class QOpenGLFunctions_4_2_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-4-2-compatibility.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 4.2 compatibility profile. See reference pages on **opengl.org**  for function documentation.
