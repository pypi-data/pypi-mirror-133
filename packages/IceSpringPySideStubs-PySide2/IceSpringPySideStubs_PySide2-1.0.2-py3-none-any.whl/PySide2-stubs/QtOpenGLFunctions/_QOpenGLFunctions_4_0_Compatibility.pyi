...
class QOpenGLFunctions_4_0_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-4-0-compatibility.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 4.0 compatibility profile. See reference pages on **opengl.org**  for function documentation.
