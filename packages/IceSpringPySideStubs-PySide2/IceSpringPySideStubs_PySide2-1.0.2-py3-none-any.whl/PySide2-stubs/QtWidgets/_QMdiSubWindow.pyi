...
class QMdiSubWindow(PySide2.QtWidgets.QWidget):
    ...
    **See also** **QMdiArea** .
    ...
    AllowOutsideAreaHorizontally: QMdiSubWindow = ...
    AllowOutsideAreaVertically: QMdiSubWindow = ...
    ...
    def contextMenuEvent(
        self, contextMenuEvent: PySide2.QtGui.QContextMenuEvent
    ) -> None:
        """
    ...
    def setOption(
        self, option: PySide2.QtWidgets.QMdiSubWindow.SubWindowOption, on: bool = ...
    ) -> None:
        """
    ...
    def testOption(
        self, arg__1: PySide2.QtWidgets.QMdiSubWindow.SubWindowOption
    ) -> bool:
        """
    ...
    @property
    def aboutToActivate(self) -> PySide2.QtCore.SignalInstance:
        """
