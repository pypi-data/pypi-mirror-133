...
class QGraphicsScene(PySide2.QtCore.QObject):
    ...
    **See also** **QGraphicsItem**  and **QGraphicsView** .
    ...
    def __init__(
        self,
        sceneRect: PySide2.QtCore.QRectF,
    ...
    def activePanel(self) -> PySide2.QtWidgets.QGraphicsItem:
        ...
        **QGraphicsItem *QGraphicsScene::activePanel() const**
        ...
        Returns the current active panel, or `nullptr` if no panel is currently active.
    ...
    @typing.overload
    def addLine(
        self, line: PySide2.QtCore.QLineF, pen: PySide2.QtGui.QPen = ...
    ...
    @typing.overload
    def addLine(
        self, x1: float, y1: float, x2: float, y2: float, pen: PySide2.QtGui.QPen = ...
    ) -> PySide2.QtWidgets.QGraphicsLineItem:
        """
        https://doc.qt.io/qt-5/qgraphicsscene.html#addLine
    ...
    def addSimpleText(
        self, text: str, font: PySide2.QtGui.QFont = ...
    ...
    @typing.overload
    def itemAt(
        self, pos: PySide2.QtCore.QPointF, deviceTransform: PySide2.QtGui.QTransform
    ...
    @typing.overload
    def itemAt(
        self, x: float, y: float, deviceTransform: PySide2.QtGui.QTransform
    ) -> PySide2.QtWidgets.QGraphicsItem:
        """
        https://doc.qt.io/qt-5/qgraphicsscene.html#itemAt
    ...
    def items(
        ...
        path: PySide2.QtGui.QPainterPath,
        mode: PySide2.QtCore.Qt.ItemSelectionMode = ...,
        order: PySide2.QtCore.Qt.SortOrder = ...,
        deviceTransform: PySide2.QtGui.QTransform = ...,
    ) -> typing.List:
        """
        https://doc.qt.io/qt-5/qgraphicsscene.html#items
    ...
    def sendEvent(
        self, item: PySide2.QtWidgets.QGraphicsItem, event: PySide2.QtCore.QEvent
    ) -> bool:
        """
    ...
    def setFocusItem(
        self,
        item: PySide2.QtWidgets.QGraphicsItem,
        focusReason: PySide2.QtCore.Qt.FocusReason = ...,
    ) -> None:
        """
        ...
        **void QGraphicsScene::setFocusItem(QGraphicsItem * item , Qt::FocusReason focusReason = Qt::OtherFocusReason)**
        ...
        If **item** is `nullptr`, or if it either does not accept focus (i.e., it does not have the **QGraphicsItem::ItemIsFocusable**  flag enabled), or is not visible or not enabled, this function only removes focus from any previous focusitem.

        If item is not `nullptr`, and the scene does not currently have focus (i.e., **hasFocus** () returns `false`), this function will call **setFocus** () automatically.
    ...
    def setItemIndexMethod(
        self, method: PySide2.QtWidgets.QGraphicsScene.ItemIndexMethod
    ) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsscene.html#itemIndexMethod-prop
    ...
    def setSelectionArea(
        self,
        path: PySide2.QtGui.QPainterPath,
        selectionOperation: PySide2.QtCore.Qt.ItemSelectionOperation,
        mode: PySide2.QtCore.Qt.ItemSelectionMode = ...,
        deviceTransform: PySide2.QtGui.QTransform = ...,
    ) -> None:
        """
    ...
    def setStyle(self, style: PySide2.QtWidgets.QStyle) -> None:
        ...
        **void QGraphicsScene::setStyle(QStyle * style )**
        ...
        If **style** is `nullptr`, **QGraphicsScene**  will revert to **QApplication::style** ().
    ...
    @property
    def focusItemChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        ...
        **oldFocusItem** is a pointer to the item that previously had focus, or 0 if no item had focus before the signal was emitted. **newFocusItem** is a pointer to the item that gained input focus, or `nullptr` if focus was lost. **reason** is the reason for the focus change (e.g., if the scene was deactivated while an input field had focus, **oldFocusItem** would point to the input field item, **newFocusItem** would be `nullptr`, and **reason** would be **Qt::ActiveWindowFocusReason** .
        """
        ...

    @property
    def sceneRectChanged(self) -> PySide2.QtCore.SignalInstance:
        """
