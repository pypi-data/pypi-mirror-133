...
class QGraphicsEffect(PySide2.QtCore.QObject):
    ...
    **See also** **QGraphicsItem::setGraphicsEffect** () and **QWidget::setGraphicsEffect** ().
    ...
    def boundingRectFor(
        self, sourceRect: PySide2.QtCore.QRectF
    ...
    def sourceBoundingRect(
        self, system: PySide2.QtCore.Qt.CoordinateSystem = ...
    ) -> PySide2.QtCore.QRectF:
        """
    ...
    def sourceChanged(
        self, flags: PySide2.QtWidgets.QGraphicsEffect.ChangeFlags
    ) -> None:
        """
    ...
    def sourcePixmap(
        self,
        system: PySide2.QtCore.Qt.CoordinateSystem = ...,
        offset: typing.Optional[PySide2.QtCore.QPoint] = ...,
        mode: PySide2.QtWidgets.QGraphicsEffect.PixmapPadMode = ...,
