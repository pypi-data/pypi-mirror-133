...
class QQmlListReference(object):
    ...
    **canAppend** (), **canAt** (), **canClear** () and **canCount** () allow
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qqmllistreference.html#QQmlListReference-1
        ...
        **property** is not a list property, an invalid QQmlListReference is
        ...
        Passing **engine** is required to access some QML created list
        properties. If in doubt, and an engine is available, pass it.
        """
        ...
    ...
    def listElementType(self) -> PySide2.QtCore.QMetaObject:
        ...
        **const QMetaObject *QQmlListReference::listElementType() const**
        ...
        given instance can be added to a list.
        """
        ...
