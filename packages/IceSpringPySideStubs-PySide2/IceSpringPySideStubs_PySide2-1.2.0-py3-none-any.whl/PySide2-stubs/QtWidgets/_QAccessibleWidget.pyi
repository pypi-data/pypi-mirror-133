...
class QAccessibleWidget(PySide2.QtGui.QAccessibleObject):
    """
    https://doc.qt.io/qt-5/qaccessiblewidget.html
    ...
    **See also** **QAccessible**  and **QAccessibleObject** .
    ...
    def __init__(
        self,
        o: PySide2.QtWidgets.QWidget,
        r: PySide2.QtGui.QAccessible.Role = ...,
        name: str = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#QAccessibleWidget
    ...
    def actionNames(self) -> typing.List:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#actionNames
    ...
    def addControllingSignal(self, signal: str) -> None:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#addControllingSignal
    ...
    def backgroundColor(self) -> PySide2.QtGui.QColor:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#backgroundColor
    ...
    def child(self, index: int) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#child
    ...
    def childCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#childCount
    ...
    def doAction(self, actionName: str) -> None:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#doAction
    ...
    def focusChild(self) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#focusChild
    ...
    def foregroundColor(self) -> PySide2.QtGui.QColor:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#foregroundColor
    ...
    def indexOfChild(self, child: PySide2.QtGui.QAccessibleInterface) -> int:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#indexOfChild
    ...
    def interface_cast(self, t: PySide2.QtGui.QAccessible.InterfaceType) -> int:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#interface_cast
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#isValid
    ...
    def keyBindingsForAction(self, actionName: str) -> typing.List:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#keyBindingsForAction

        **[override virtual] QStringList
        QAccessibleWidget::keyBindingsForAction(const QString & actionName )
        const**

        Reimplements: **QAccessibleActionInterface::keyBindingsForAction**
    ...
    def parent(self) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#parent
    ...
    def parentObject(self) -> PySide2.QtCore.QObject:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#parentObject
    ...
    def rect(self) -> PySide2.QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#rect
    ...
    def relations(self, match: PySide2.QtGui.QAccessible.Relation = ...) -> typing.List:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#relations

        **[override virtual] QVector<QPair<QAccessibleInterface *,
    ...
    def role(self) -> PySide2.QtGui.QAccessible.Role:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#role
    ...
    def state(self) -> PySide2.QtGui.QAccessible.State:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#state
    ...
    def text(self, t: PySide2.QtGui.QAccessible.Text) -> str:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#text

        **[override virtual] QString QAccessibleWidget::text(QAccessible::Text t
        ) const**

        Reimplements: **QAccessibleInterface::text** (QAccessible::Text t)
        const.
        """
        ...
    ...
    def widget(self) -> PySide2.QtWidgets.QWidget:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#widget
    ...
    def window(self) -> PySide2.QtGui.QWindow:
        """
        https://doc.qt.io/qt-5/qaccessiblewidget.html#window
