...
class QRubberBand(PySide2.QtWidgets.QWidget):
    ...
    **QRubberBand** (**QRubberBand** ::Rectangle, this);
    ...
    def initStyleOption(self, option: PySide2.QtWidgets.QStyleOptionRubberBand) -> None:
        ...
        **[protected] void QRubberBand::initStyleOption(QStyleOptionRubberBand *
        option ) const**
    ...
    def move(self, x: int, y: int) -> None:
        """
        https://doc.qt.io/qt-5/qrubberband.html#move-1
    ...
    def resize(self, w: int, h: int) -> None:
        """
        https://doc.qt.io/qt-5/qrubberband.html#resize-1
    ...
    def resizeEvent(self, arg__1: PySide2.QtGui.QResizeEvent) -> None:
        ...
        **[override virtual protected] void QRubberBand::resizeEvent(
        QResizeEvent * )**
    ...
    def setGeometry(self, x: int, y: int, w: int, h: int) -> None:
        """
        https://doc.qt.io/qt-5/qrubberband.html#setGeometry-1
