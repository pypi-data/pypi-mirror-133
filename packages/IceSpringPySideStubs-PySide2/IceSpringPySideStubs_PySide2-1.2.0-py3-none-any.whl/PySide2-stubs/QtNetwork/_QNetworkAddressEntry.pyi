...
class QNetworkAddressEntry(object):
    ...
    **Detailed Description**
    ...
    def __init__(self, other: PySide2.QtNetwork.QNetworkAddressEntry) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkaddressentry.html#QNetworkAddressEntry-1
    ...
    def isPermanent(self) -> bool:
        ...
        **bool QNetworkAddressEntry::isPermanent() const**
        ...
        if it's temporary. A permenant address is one which has no expiration
    ...
    def setDnsEligibility(
        ...
        **void QNetworkAddressEntry::setDnsEligibility(QNetworkAddressEntry::Dns
