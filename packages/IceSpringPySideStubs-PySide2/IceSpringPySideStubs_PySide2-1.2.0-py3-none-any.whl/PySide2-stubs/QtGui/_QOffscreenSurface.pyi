...
class QOffscreenSurface(PySide2.QtCore.QObject, PySide2.QtGui.QSurface):
    ...
    **Note:** Some platforms may utilize a surfaceless context extension (for
    ...
    def __init__(
        ...
        **QOffscreenSurface::QOffscreenSurface(QScreen * targetScreen , QObject
        * parent )**
    ...
    def __init__(self, screen: typing.Optional[PySide2.QtGui.QScreen] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qoffscreensurface.html#QOffscreenSurface-1
    ...
    def nativeHandle(self) -> int:
        ...
        **void *QOffscreenSurface::nativeHandle() const**
        ...
        Returns an optional native handle to which the offscreen surface is
        connected.
    ...
    def setNativeHandle(self, handle: int) -> None:
        ...
        **handle**.
        ...
        The native handle will be resolved in the **create** () function.
        Calling this function after **create** () will not re-create a native
        surface.

        **Note:** The interpretation of the native handle is platform specific.
        Only some platforms will support adopting native handles of offscreen
        surfaces and platforms that do not implement this support will ignore
        the handle.
