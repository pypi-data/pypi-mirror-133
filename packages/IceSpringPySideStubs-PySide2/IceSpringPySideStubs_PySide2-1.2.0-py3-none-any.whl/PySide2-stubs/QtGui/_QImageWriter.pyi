...
class QImageWriter(object):
    ...
    **See also** **QImageReader** , **QImageIOHandler** , **QImageIOPlugin** ,
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimagewriter.html#QImageWriter-1
    ...
    def __init__(self, fileName: str, format: PySide2.QtCore.QByteArray = ...) -> None:
        """
        https://doc.qt.io/qt-5/qimagewriter.html#QImageWriter-2
    ...
    def imageFormatsForMimeType(mimeType: PySide2.QtCore.QByteArray) -> typing.List:
        ...
        **[static] QList<QByteArray> QImageWriter::imageFormatsForMimeType(const
        QByteArray & mimeType )**
    ...
    def setTransformation(
        ...
        **void QImageWriter::setTransformation(QImageIOHandler::Transformations
        transform )**
