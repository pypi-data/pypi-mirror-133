...
class QPen(object):
    ...
    **setDashPattern** () function which implicitly converts the style of the
    pen to **Qt::CustomDashLine** . The pattern argument, a **QVector** , must
    be specified as an even number of **qreal**  entries where the entries 1, 3,
    ...
    **Scribble Example** .
    ...
    def __init__(self, arg__1: PySide2.QtCore.Qt.PenStyle) -> None:
        """
        https://doc.qt.io/qt-5/qpen.html#QPen-1
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qpen.html#QPen-2
    ...
    def __init__(self, pen: PySide2.QtGui.QPen) -> None:
        """
        https://doc.qt.io/qt-5/qpen.html#QPen-4
