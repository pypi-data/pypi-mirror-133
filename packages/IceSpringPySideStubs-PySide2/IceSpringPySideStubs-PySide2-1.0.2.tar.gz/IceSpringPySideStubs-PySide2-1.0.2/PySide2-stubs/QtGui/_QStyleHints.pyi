...
class QStyleHints(PySide2.QtCore.QObject):
    ...
    **See also** **QGuiApplication::styleHints** ().
    ...
    def mouseQuickSelectionThreshold(self) -> int:
        """
        https://doc.qt.io/qt-5/qstylehints.html#mouseQuickSelectionThreshold-prop
    ...
    def setTabFocusBehavior(
        self, tabFocusBehavior: PySide2.QtCore.Qt.TabFocusBehavior
    ) -> None:
        """
    ...
    @property
    def cursorFlashTimeChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def keyboardInputIntervalChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def mouseDoubleClickIntervalChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def mousePressAndHoldIntervalChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def mouseQuickSelectionThresholdChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def showShortcutsInContextMenusChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def startDragDistanceChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def startDragTimeChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def tabFocusBehaviorChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def useHoverEffectsChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def wheelScrollLinesChanged(self) -> PySide2.QtCore.SignalInstance:
        ...
