...
class QStackedWidget(PySide2.QtWidgets.QFrame):
    ...
    **See also** **QStackedLayout**  and **QTabWidget** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#QStackedWidget
    ...
    def count(self) -> int:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#count-prop
    ...
    def event(self, e: PySide2.QtCore.QEvent) -> bool:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#event
    ...
    def indexOf(self, arg__1: PySide2.QtWidgets.QWidget) -> int:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#indexOf
    ...
    def insertWidget(self, index: int, w: PySide2.QtWidgets.QWidget) -> int:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#insertWidget
    ...
    def removeWidget(self, w: PySide2.QtWidgets.QWidget) -> None:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#removeWidget
    ...
    def widget(self, arg__1: int) -> PySide2.QtWidgets.QWidget:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#widget
    ...
    def widgetRemoved(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qstackedwidget.html#widgetRemoved
