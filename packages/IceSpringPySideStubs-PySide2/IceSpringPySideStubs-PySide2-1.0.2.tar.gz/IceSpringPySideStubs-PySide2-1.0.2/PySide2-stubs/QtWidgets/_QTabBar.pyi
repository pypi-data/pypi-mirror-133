...
class QTabBar(PySide2.QtWidgets.QWidget):
    ...
    * **tabSizeHint** () calcuates the size of a tab.
    ...
    ![Screenshot of a Fusion style tab bar](images/fusion-tabbar.png)A tab bar shown in the **Fusion widget style** .
    ![Screenshot of a truncated Fusion tab bar](images/fusion-tabbar-truncated.png)A truncated tab bar shown in the Fusion widget style.
    ...
    **See also** **QTabWidget** .
    ...
    def initStyleOption(
        self, option: PySide2.QtWidgets.QStyleOptionTab, tabIndex: int
    ) -> None:
        """
    ...
    def setSelectionBehaviorOnRemove(
        self, behavior: PySide2.QtWidgets.QTabBar.SelectionBehavior
    ) -> None:
        """
        https://doc.qt.io/qt-5/qtabbar.html#selectionBehaviorOnRemove-prop
    ...
    def setTabButton(
        self,
        index: int,
        position: PySide2.QtWidgets.QTabBar.ButtonPosition,
    ...
    def tabButton(
        self, index: int, position: PySide2.QtWidgets.QTabBar.ButtonPosition
    ...
    @property
    def tabMoved(self) -> PySide2.QtCore.SignalInstance:
        """
