...
class QMdiArea(PySide2.QtWidgets.QAbstractScrollArea):
    ...
    **See also** **QMdiSubWindow** .
    ...
    def setOption(
        self, option: PySide2.QtWidgets.QMdiArea.AreaOption, on: bool = ...
    ) -> None:
        """
    ...
    def subWindowList(
        self, order: PySide2.QtWidgets.QMdiArea.WindowOrder = ...
    ) -> typing.List:
        """
    ...
    @property
    def subWindowActivated(self) -> PySide2.QtCore.SignalInstance:
        """
