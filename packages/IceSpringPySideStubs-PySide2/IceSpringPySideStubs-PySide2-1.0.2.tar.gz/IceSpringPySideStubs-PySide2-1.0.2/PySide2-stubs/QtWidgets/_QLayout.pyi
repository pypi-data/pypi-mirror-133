    ...
    **See also** **QLayoutItem** , **Layout Management** , **Basic Layouts Example** , **Border Layout Example** , and **Flow Layout Example** .
    ...
    def __init__(self) -> None:
        ...
        **QLayout::QLayout(QWidget * parent )**
        ...
        Constructs a new top-level QLayout, with parent **parent**. **parent** may not be `nullptr`.
    ...
    def closestAcceptableSize(
        w: PySide2.QtWidgets.QWidget, s: PySide2.QtCore.QSize
    ...
    def replaceWidget(
        self,
        from_: PySide2.QtWidgets.QWidget,
        to: PySide2.QtWidgets.QWidget,
        options: PySide2.QtCore.Qt.FindChildOptions = ...,
    ...
    @typing.overload
    def setAlignment(
        self, l: PySide2.QtWidgets.QLayout, alignment: PySide2.QtCore.Qt.Alignment
    ) -> bool:
        """
        https://doc.qt.io/qt-5/qlayout.html#setAlignment
    ...
    @typing.overload
    def setAlignment(
        self, w: PySide2.QtWidgets.QWidget, alignment: PySide2.QtCore.Qt.Alignment
    ) -> bool:
        """
        https://doc.qt.io/qt-5/qlayout.html#setAlignment
