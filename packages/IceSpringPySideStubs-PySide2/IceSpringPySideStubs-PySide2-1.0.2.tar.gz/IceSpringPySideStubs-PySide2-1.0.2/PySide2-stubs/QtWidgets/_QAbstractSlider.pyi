...
class QAbstractSlider(PySide2.QtWidgets.QWidget):
    ...
    **See also** **QAbstractSpinBox** , **QSlider** , **QDial** , **QScrollBar** , and **Sliders Example** .
    ...
    def setRepeatAction(
        self,
        action: PySide2.QtWidgets.QAbstractSlider.SliderAction,
        thresholdTime: int = ...,
        repeatTime: int = ...,
    ) -> None:
        """
    ...
    def triggerAction(
        self, action: PySide2.QtWidgets.QAbstractSlider.SliderAction
    ) -> None:
        """
    ...
    @property
    def rangeChanged(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def sliderMoved(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def sliderPressed(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def sliderReleased(self) -> PySide2.QtCore.SignalInstance:
        """
