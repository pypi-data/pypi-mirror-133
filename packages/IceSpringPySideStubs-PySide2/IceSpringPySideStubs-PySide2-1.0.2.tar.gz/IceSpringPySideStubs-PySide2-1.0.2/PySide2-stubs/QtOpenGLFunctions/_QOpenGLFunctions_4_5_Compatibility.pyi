...
class QOpenGLFunctions_4_5_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-4-5-compatibility.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 4.5 compatibility profile. See reference pages on **opengl.org**  for function documentation.
    ...
    **See also** **QAbstractOpenGLFunctions** .
    ...
    def glBindBuffersBase(
        self, target: int, first: int, count: int, buffers: typing.Sequence
    ) -> None:
        ...
    ...
    def glBindImageTextures(
        self, first: int, count: int, textures: typing.Sequence
    ) -> None:
        ...
    ...
    def glClearNamedFramebufferfv(
        self, framebuffer: int, buffer: int, drawbuffer: int, value: typing.Sequence
    ) -> None:
        ...
    ...
    def glGetConvolutionFilter(
        self, target: int, format: int, type: int, image: int
    ) -> None:
        ...
    ...
    def glGetHistogram(
        self, target: int, reset: int, format: int, type: int, values: int
    ) -> None:
        ...
    ...
    def glGetSeparableFilter(
        self, target: int, format: int, type: int, row: int, column: int, span: int
    ) -> None:
        ...
    ...
    def glGetnColorTable(
        self, target: int, format: int, type: int, bufSize: int, table: int
    ) -> None:
        ...
    ...
    def glGetnConvolutionFilter(
        self, target: int, format: int, type: int, bufSize: int, image: int
    ) -> None:
        ...

    def glGetnHistogram(
        self, target: int, reset: int, format: int, type: int, bufSize: int, values: int
    ) -> None:
        ...
    ...
    def glInvalidateNamedFramebufferData(
        self, framebuffer: int, numAttachments: int, attachments: typing.Sequence
    ) -> None:
        ...
    ...
    def glNamedFramebufferDrawBuffers(
        self, framebuffer: int, n: int, bufs: typing.Sequence
    ) -> None:
        ...
    ...
    def glTextureParameterIiv(
        self, texture: int, pname: int, params: typing.Sequence
    ) -> None:
        ...
    ...
    def glTextureParameterfv(
        self, texture: int, pname: int, param: typing.Sequence
    ) -> None:
        ...
