...
class QOpenGLFunctions_4_2_Core(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-4-2-core.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 4.2 core profile. See reference pages on **opengl.org**  for function documentation.
