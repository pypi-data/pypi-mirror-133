...
class QOpenGLFunctions_4_1_Compatibility(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-4-1-compatibility.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 4.1 compatibility profile. See reference pages on **opengl.org**  for function documentation.
