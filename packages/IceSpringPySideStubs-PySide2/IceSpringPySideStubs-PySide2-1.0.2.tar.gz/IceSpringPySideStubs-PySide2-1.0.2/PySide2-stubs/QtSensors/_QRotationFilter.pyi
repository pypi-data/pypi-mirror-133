...
class QRotationFilter(PySide2.QtSensors.QSensorFilter):
    """
    https://doc.qt.io/qt-5/qrotationfilter.html

    **Detailed Description**

    The only difference is that the **filter** () method features a pointer to **QRotationReading**  instead of **QSensorReading** .
    """
    ...
    def filter(self, reading: PySide2.QtSensors.QRotationReading) -> bool:
        """
        https://doc.qt.io/qt-5/qrotationfilter.html#filter

        **[pure virtual] bool QRotationFilter::filter(QRotationReading * reading )**
