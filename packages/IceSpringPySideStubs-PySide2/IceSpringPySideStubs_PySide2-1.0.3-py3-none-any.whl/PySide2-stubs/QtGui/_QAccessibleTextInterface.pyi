...
class QAccessibleTextInterface(object):
    """
    https://doc.qt.io/qt-5/qaccessibletextinterface.html
    ...
    **IAccessible2 Specification**
    ...
    def addSelection(self, startOffset: int, endOffset: int) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#addSelection
    ...
    def attributes(self, offset: int) -> typing.Tuple:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#attributes
    ...
    def characterCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#characterCount
    ...
    def characterRect(self, offset: int) -> PySide2.QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#characterRect
    ...
    def cursorPosition(self) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#cursorPosition
    ...
    def offsetAtPoint(self, point: PySide2.QtCore.QPoint) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#offsetAtPoint
    ...
    def removeSelection(self, selectionIndex: int) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#removeSelection
    ...
    def scrollToSubstring(self, startIndex: int, endIndex: int) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#scrollToSubstring
    ...
    def selection(self, selectionIndex: int) -> typing.Tuple:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#selection
    ...
    def selectionCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#selectionCount
    ...
    def setCursorPosition(self, position: int) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#setCursorPosition
    ...
    def setSelection(
        self, selectionIndex: int, startOffset: int, endOffset: int
    ) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#setSelection
    ...
    def text(self, startOffset: int, endOffset: int) -> str:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#text
    ...
    def textAfterOffset(
        self, offset: int, boundaryType: PySide2.QtGui.QAccessible.TextBoundaryType
    ) -> typing.Tuple:
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#textAfterOffset
    ...
    def textAtOffset(
        ...
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#textAtOffset
    ...
    def textBeforeOffset(
        ...
        """
        https://doc.qt.io/qt-5/qaccessibletextinterface.html#textBeforeOffset
