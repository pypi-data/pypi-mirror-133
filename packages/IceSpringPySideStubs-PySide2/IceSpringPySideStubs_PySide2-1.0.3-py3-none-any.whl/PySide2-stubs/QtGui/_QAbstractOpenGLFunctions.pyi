...
class QAbstractOpenGLFunctions(object):
    """
    https://doc.qt.io/qt-5/qabstractopenglfunctions.html
    ...
    * **QOpenGLFunctions_1_0**
    ...
    Please note that some vendors, notably Apple, do not implement the Compatibility profile. Therefore if you wish to target new OpenGL features on macOS then you should ensure that you request a Core profile context via **QSurfaceFormat::setProfile** ().
    ...
    **See also** **QOpenGLContext::versionFunctions** ().
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qabstractopenglfunctions.html#QAbstractOpenGLFunctions-1
