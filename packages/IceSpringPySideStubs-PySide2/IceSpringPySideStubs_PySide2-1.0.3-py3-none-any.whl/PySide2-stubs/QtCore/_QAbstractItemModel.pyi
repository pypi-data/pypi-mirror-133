    ...
    **See also** **Model Classes** , **Model Subclassing Reference** , **QModelIndex** , **QAbstractItemView** , **Using drag and drop with item views** , **Simple DOM Model Example** , **Simple Tree Model Example** , **Editable Tree Model Example** , and **Fetch More Example** .
    ...
    def beginInsertColumns(
        ...
        **[protected] void QAbstractItemModel::beginInsertColumns(const QModelIndex & parent , int first , int last )**
        ...
        ![Inserting columns](images/modelview-begin-insert-columns.png)Specify the first and last column numbers for the span of columns you want to insert into an item in a model.
        ...
        ![Appending columns](images/modelview-begin-append-columns.png)To append columns, insert them after the last column.
    ...
    def beginInsertRows(
        ...
        **[protected] void QAbstractItemModel::beginInsertRows(const QModelIndex & parent , int first , int last )**
        ...
        ![Inserting rows](images/modelview-begin-insert-rows.png)Specify the first and last row numbers for the span of rows you want to insert into an item in a model.
        ...
        ![Appending rows](images/modelview-begin-append-rows.png)To append rows, insert them after the last row.
    ...
    def beginMoveRows(
        ...
        **[protected] bool QAbstractItemModel::beginMoveRows(const QModelIndex & sourceParent , int sourceFirst , int sourceLast , const QModelIndex & destinationParent , int destinationChild )**
        ...
        ![Moving rows to another parent](images/modelview-move-rows-1.png)Specify the first and last row numbers for the span of rows in the source parent you want to move in the model. Also specify the row in the destination parent to move the span to.
        ...
        ![Moving rows to append to another parent](images/modelview-move-rows-2.png)To append rows to another parent, move them to after the last row.
        ...
        ![Moving rows in the same parent up](images/modelview-move-rows-3.png)To move rows within the same parent, specify the row to move them to.
        ...
        ![Moving rows in the same parent down](images/modelview-move-rows-4.png)To move rows within the same parent, specify the row to move them to.
    ...
    def beginRemoveColumns(
        ...
        **[protected] void QAbstractItemModel::beginRemoveColumns(const QModelIndex & parent , int first , int last )**
        ...
        ![Removing columns](images/modelview-begin-remove-columns.png)Specify the first and last column numbers for the span of columns you want to remove from an item in a model.
    ...
    def beginRemoveRows(
        ...
        **[protected] void QAbstractItemModel::beginRemoveRows(const QModelIndex & parent , int first , int last )**
        ...
        ![Removing rows](images/modelview-begin-remove-rows.png)Specify the first and last row numbers for the span of rows you want to remove from an item in a model.
    ...
    def insertColumns(
        ...
        **[virtual] bool QAbstractItemModel::insertColumns(int column , int count , const QModelIndex & parent = QModelIndex())**
    ...
    def parent(self) -> PySide2.QtCore.QObject:
        ...
        **[pure virtual] QModelIndex QAbstractItemModel::parent(const QModelIndex & index ) const**
    ...
    def rowsMoved(self) -> PySide2.QtCore.SignalInstance:
        ...
        **[signal] void QAbstractItemModel::rowsMoved(const QModelIndex & parent , int start , int end , const QModelIndex & destination , int row )**
