...
class QNetworkAccessManager(PySide2.QtCore.QObject):
    ...
    **See also** **QNetworkRequest** , **QNetworkReply** , and **QNetworkProxy** .
    ...
    UnknownOperation: QNetworkAccessManager = ...
    ...
    class NetworkAccessibility(object):
        UnknownAccessibility: QNetworkAccessManager.NetworkAccessibility = ...
        NotAccessible: QNetworkAccessManager.NetworkAccessibility = ...
        Accessible: QNetworkAccessManager.NetworkAccessibility = ...
    ...
    def addStrictTransportSecurityHosts(self, knownHosts: typing.List) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#addStrictTransportSecurityHosts
    ...
    def connectToHostEncrypted(
        ...
        hostName: str,
        port: int,
        sslConfiguration: PySide2.QtNetwork.QSslConfiguration,
        peerName: str,
    ) -> None:
        """
    ...
    def createRequest(
        self,
        op: PySide2.QtNetwork.QNetworkAccessManager.Operation,
        request: PySide2.QtNetwork.QNetworkRequest,
        outgoingData: typing.Optional[PySide2.QtCore.QIODevice] = ...,
    ...
    def deleteResource(
        self, request: PySide2.QtNetwork.QNetworkRequest
    ) -> PySide2.QtNetwork.QNetworkReply:
        """
    ...
    def enableStrictTransportSecurityStore(
        ...
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#enableStrictTransportSecurityStore
    ...
    def isStrictTransportSecurityEnabled(self) -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#isStrictTransportSecurityEnabled
    ...
    def isStrictTransportSecurityStoreEnabled(self) -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#isStrictTransportSecurityStoreEnabled
    ...
    @typing.overload
    def post(
        self, request: PySide2.QtNetwork.QNetworkRequest, data: PySide2.QtCore.QIODevice
    ) -> PySide2.QtNetwork.QNetworkReply:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#post
    ...
    def post(
        self,
        request: PySide2.QtNetwork.QNetworkRequest,
        multiPart: PySide2.QtNetwork.QHttpMultiPart,
    ) -> PySide2.QtNetwork.QNetworkReply:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#post
    ...
    def sendCustomRequest(
        self,
        request: PySide2.QtNetwork.QNetworkRequest,
        verb: PySide2.QtCore.QByteArray,
        data: PySide2.QtCore.QByteArray,
    ) -> PySide2.QtNetwork.QNetworkReply:
        """
    ...
    def sendCustomRequest(
        ...
        request: PySide2.QtNetwork.QNetworkRequest,
        verb: PySide2.QtCore.QByteArray,
        data: typing.Optional[PySide2.QtCore.QIODevice] = ...,
    ) -> PySide2.QtNetwork.QNetworkReply:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#sendCustomRequest
    ...
    def setNetworkAccessible(
        self, accessible: PySide2.QtNetwork.QNetworkAccessManager.NetworkAccessibility
    ) -> None:
        ...
    ...
    def setRedirectPolicy(
        self, policy: PySide2.QtNetwork.QNetworkRequest.RedirectPolicy
    ) -> None:
        """
    ...
    def setStrictTransportSecurityEnabled(self, enabled: bool) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#setStrictTransportSecurityEnabled
    ...
    def strictTransportSecurityHosts(self) -> typing.List:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#strictTransportSecurityHosts
    ...
    def supportedSchemesImplementation(self) -> typing.List:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#supportedSchemesImplementation
    ...
    def proxyAuthenticationRequired(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qnetworkaccessmanager.html#proxyAuthenticationRequired
