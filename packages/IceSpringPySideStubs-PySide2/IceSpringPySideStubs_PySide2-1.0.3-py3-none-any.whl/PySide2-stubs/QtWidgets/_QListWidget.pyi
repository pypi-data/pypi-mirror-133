...
class QListWidget(PySide2.QtWidgets.QListView):
    ...
    **See also** **QListWidgetItem** , **QListView** , **QTreeView** , **Model/View Programming** , and **Tab Dialog Example** .
    ...
    @typing.overload
    def setCurrentRow(
        self, row: int, command: PySide2.QtCore.QItemSelectionModel.SelectionFlags
    ) -> None:
        """
        https://doc.qt.io/qt-5/qlistwidget.html#setCurrentRow-1
    ...
    def setItemHidden(
        self, item: PySide2.QtWidgets.QListWidgetItem, hide: bool
    ) -> None:
        ...

    def setItemSelected(
        self, item: PySide2.QtWidgets.QListWidgetItem, select: bool
    ) -> None:
        ...

    def setItemWidget(
        self, item: PySide2.QtWidgets.QListWidgetItem, widget: PySide2.QtWidgets.QWidget
    ) -> None:
        """
