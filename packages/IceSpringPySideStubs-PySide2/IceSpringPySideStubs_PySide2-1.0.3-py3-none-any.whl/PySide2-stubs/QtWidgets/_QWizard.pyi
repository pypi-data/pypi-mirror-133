...
class QWizard(PySide2.QtWidgets.QDialog):
    ...
    **ClassicStyle** **ModernStyle** **MacStyle** **AeroStyle**
    ![](images/qtwizard-classic1.png)![](images/qtwizard-modern1.png)![](images/qtwizard-mac1.png)![](images/qtwizard-aero1.png)
    ![](images/qtwizard-classic2.png)![](images/qtwizard-modern2.png)![](images/qtwizard-mac2.png)![](images/qtwizard-aero2.png)
    ...
    **See also** **QWizardPage** , **Class Wizard Example** , and **License Wizard Example** .
    ...
    def button(
        self, which: PySide2.QtWidgets.QWizard.WizardButton
    ...
    def nativeEvent(
        ...
        """
        https://doc.qt.io/qt-5/qwizard.html#nativeEvent

        **[override virtual protected] bool QWizard::nativeEvent(const QByteArray & eventType , void * message , long * result )**

        Reimplements: **QWidget::nativeEvent** (const QByteArray &eventType, void *message, long *result).
        """
        ...
    ...
    def setButton(
        self,
        which: PySide2.QtWidgets.QWizard.WizardButton,
    ...
    def setOption(
        self, option: PySide2.QtWidgets.QWizard.WizardOption, on: bool = ...
    ) -> None:
        """
    ...
    @property
    def currentIdChanged(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def customButtonClicked(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def pageAdded(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def pageRemoved(self) -> PySide2.QtCore.SignalInstance:
        """
