...
class QGraphicsAnchorLayout(PySide2.QtWidgets.QGraphicsLayout):
    """
    https://doc.qt.io/qt-5/qgraphicsanchorlayout.html
    ...
    **Detailed Description**
    ...
    ![Using an anchor layout to align simple colored widgets.](images/simpleanchorlayout-example.png)
    ...
    **See also** **QGraphicsLinearLayout** , **QGraphicsGridLayout** , and **QGraphicsLayout** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#QGraphicsAnchorLayout
    ...
    def addAnchor(
        self,
        firstItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        firstEdge: PySide2.QtCore.Qt.AnchorPoint,
        secondItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        secondEdge: PySide2.QtCore.Qt.AnchorPoint,
    ) -> PySide2.QtWidgets.QGraphicsAnchor:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#addAnchor
    ...
    def addAnchors(
        ...
        firstItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        secondItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        orientations: PySide2.QtCore.Qt.Orientations = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#addAnchors
    ...
    def addCornerAnchors(
        self,
        firstItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        firstCorner: PySide2.QtCore.Qt.Corner,
        secondItem: PySide2.QtWidgets.QGraphicsLayoutItem,
        secondCorner: PySide2.QtCore.Qt.Corner,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#addCornerAnchors
    ...
    def anchor(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#anchor
    ...
    def count(self) -> int:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#count
    ...
    def horizontalSpacing(self) -> float:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#horizontalSpacing
    ...
    def invalidate(self) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#invalidate
    ...
    def itemAt(self, index: int) -> PySide2.QtWidgets.QGraphicsLayoutItem:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#itemAt
    ...
    def removeAt(self, index: int) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#removeAt
    ...
    def setGeometry(self, rect: PySide2.QtCore.QRectF) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#setGeometry
    ...
    def setHorizontalSpacing(self, spacing: float) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#setHorizontalSpacing
    ...
    def setSpacing(self, spacing: float) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#setSpacing
    ...
    def setVerticalSpacing(self, spacing: float) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#setVerticalSpacing
    ...
    def sizeHint(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#sizeHint
    ...
    def verticalSpacing(self) -> float:
        """
        https://doc.qt.io/qt-5/qgraphicsanchorlayout.html#verticalSpacing
