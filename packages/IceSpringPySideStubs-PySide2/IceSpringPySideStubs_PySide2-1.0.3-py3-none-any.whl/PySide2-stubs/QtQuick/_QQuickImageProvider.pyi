...
class QQuickImageProvider(PySide2.QtQml.QQmlImageProviderBase):
    ...
    **See also** **QQmlEngine::addImageProvider** ().
    ...
    def __init__(
        self,
        type: PySide2.QtQml.QQmlImageProviderBase.ImageType,
        flags: PySide2.QtQml.QQmlImageProviderBase.Flags = ...,
    ) -> None:
        """
    ...
    def requestImage(
        self, id: str, size: PySide2.QtCore.QSize, requestedSize: PySide2.QtCore.QSize
