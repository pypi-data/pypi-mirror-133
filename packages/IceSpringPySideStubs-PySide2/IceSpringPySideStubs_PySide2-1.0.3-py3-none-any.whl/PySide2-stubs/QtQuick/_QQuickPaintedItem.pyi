...
class QQuickPaintedItem(PySide2.QtQuick.QQuickItem):
    ...
    **Note:** It important to understand the performance implications such items can incur. See **QQuickPaintedItem::RenderTarget**  and **QQuickPaintedItem::renderTarget** .
    ...
    def setPerformanceHint(
        self,
        hint: PySide2.QtQuick.QQuickPaintedItem.PerformanceHint,
        enabled: bool = ...,
    ) -> None:
        """
    ...
    def setPerformanceHints(
        self, hints: PySide2.QtQuick.QQuickPaintedItem.PerformanceHints
    ) -> None:
        """
    ...
    def setRenderTarget(
        self, target: PySide2.QtQuick.QQuickPaintedItem.RenderTarget
    ) -> None:
        """
        https://doc.qt.io/qt-5/qquickpainteditem.html#renderTarget-prop
    ...
    @property
    def fillColorChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def renderTargetChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def textureSizeChanged(self) -> PySide2.QtCore.SignalInstance:
        ...
