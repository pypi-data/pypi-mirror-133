...
class QQmlContext(PySide2.QtCore.QObject):
    ...
    **QQmlComponent**  component(&engine);
    ...
    constructs. If the `context` object in the example is no longer needed when
    the `window` component instance is destroyed, the `context` must be
    ...
    **See also** **Exposing Attributes of C++ Types to QML** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qqmlcontext.html#QQmlContext-1
    ...
    def engine(self) -> PySide2.QtQml.QQmlEngine:
        ...
        **QQmlEngine *QQmlContext::engine() const**
        ...
        Return the context's **QQmlEngine** , or 0 if the context has no
    ...
    def nameForObject(self, arg__1: PySide2.QtCore.QObject) -> str:
        ...
        **setContextProperty** (), or by ids in the case of QML created
        contexts.
    ...
    def parentContext(self) -> PySide2.QtQml.QQmlContext:
        ...
        **QQmlContext *QQmlContext::parentContext() const**
        ...
        Return the context's parent **QQmlContext** , or 0 if this context has
        no parent or if the parent has been destroyed.
        """
        ...
    ...
    def setContextProperty(self, arg__1: str, arg__2: typing.Any) -> None:
        """
        https://doc.qt.io/qt-5/qqmlcontext.html#setContextProperty-1
