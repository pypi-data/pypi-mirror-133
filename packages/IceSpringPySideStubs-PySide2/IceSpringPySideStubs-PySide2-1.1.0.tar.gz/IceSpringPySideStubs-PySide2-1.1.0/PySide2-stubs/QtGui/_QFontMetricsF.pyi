...
class QFontMetricsF(object):
    ...
    **See also** **QFont** , **QFontInfo** , and **QFontDatabase** .
    ...
    def horizontalAdvance(self, string: str, length: int = ...) -> float:
        """
        https://doc.qt.io/qt-5/qfontmetricsf.html#horizontalAdvance-1
        ...
        **qreal QFontMetricsF::horizontalAdvance(QChar ch ) const**
        ...
        Some of the metrics are described in the image to the right. The central
        dark rectangles cover the logical horizontalAdvance() of each character.
        The outer pale rectangles cover the **leftBearing** () and
        **rightBearing** () of each character. Notice that the bearings of "f"
        in this particular font are both negative, while the bearings of "o" are
        both positive.
        ...
        **Warning:** This function will produce incorrect results for Arabic
        ...
        control, use **QTextLayout**  instead.
