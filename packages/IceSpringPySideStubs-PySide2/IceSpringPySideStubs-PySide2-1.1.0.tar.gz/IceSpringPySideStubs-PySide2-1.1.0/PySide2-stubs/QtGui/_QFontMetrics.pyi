    ...
    **See also** **QFont** , **QFontInfo** , **QFontDatabase** , and **Character
    ...
    def horizontalAdvance(self, arg__1: str, len: int = ...) -> int:
        ...
        **int QFontMetrics::horizontalAdvance(QChar ch ) const**
        ...
        Some of the metrics are described in the image. The central dark
        rectangles cover the logical horizontalAdvance() of each character. The
        outer pale rectangles cover the **leftBearing** () and **rightBearing**
        () of each character. Notice that the bearings of "f" in this particular
