...
class QImage(PySide2.QtGui.QPaintDevice):
    ...
    **setOffset** () function.
    ...
    function returns the color as a **QRgb**  value indepedent of the image's
    format.
    ...
    **Image Formats**
    ...
    have a single byte per pixel. The color table is a **QVector** <**QRgb** >,
    ...
    **createHeuristicMask** () function creates and returns a 1-bpp heuristic
    ...
    The transformed() function returns a copy of the image that is transformed
    with the given transformation matrix and transformation mode: Internally,
    ...
    transformed points of the original image. The static trueMatrix() function
    returns the actual matrix used for transforming the image.
    ...
    **QSvgRenderer** , **Image Composition Example** , **Image Viewer Example**
    ...
    def __init__(self, arg__1: PySide2.QtGui.QImage) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-1
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-2
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-3
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-5

        **QImage::QImage(uchar * data , int width , int height , int
    ...
    def __init__(self, fileName: str, format: typing.Optional[bytes] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-6

        **QImage::QImage(const uchar * data , int width , int height , int
        bytesPerLine , QImage::Format format , QImageCleanupFunction
        cleanupFunction = nullptr, void * cleanupInfo = nullptr)**
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-7
    ...
    def __init__(self, xpm: typing.Sequence) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-9
    ...
    def color(self, i: int) -> int:
        ...
        **QRgb QImage::color(int i ) const**
        ...
        (**QRgb** ). Use the **qAlpha** (), **qRed** (), **qGreen** (), and
    ...
    def convertTo(
        ...
        **void QImage::convertTo(QImage::Format format ,
    ...
    def convertToFormat(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#convertToFormat-2

        **QImage QImage::convertToFormat(QImage::Format format , const
        QVector<QRgb> & colorTable , Qt::ImageConversionFlags flags =
        Qt::AutoColor) const**
    ...
    def copy(self, x: int, y: int, w: int, h: int) -> PySide2.QtGui.QImage:
        """
        https://doc.qt.io/qt-5/qimage.html#copy-1
    ...
    def fill(self, color: PySide2.QtCore.Qt.GlobalColor) -> None:
        ...
        **void QImage::fill(uint pixelValue )**
        ...
        underlying window system (essentially an index value), so normally you
        will want to use **QImage::pixel** () to use a color from an existing
        image or **QColor::rgb** () to use a specific color.
    ...
    def fill(self, pixel: int) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#fill-2
    ...
    def fromData(
        ...
        **[static] QImage QImage::fromData(const uchar * data , int size , const
        char * format = nullptr)**

        Constructs a **QImage**  from the first **size** bytes of the given
        binary **data**. The loader attempts to read the image using the
        specified **format**. If **format** is not specified (which is the
        default), the loader probes the data for a header to guess the file
        format.
    ...
    def load(self, fileName: str, format: typing.Optional[bytes] = ...) -> bool:
        """
        https://doc.qt.io/qt-5/qimage.html#load-1
    ...
    def loadFromData(
        ...
        **bool QImage::loadFromData(const uchar * data , int len , const char *
        format = nullptr)**

        Loads an image from the first **len** bytes of the given binary
    ...
    def pixelIndex(self, x: int, y: int) -> int:
        """
        https://doc.qt.io/qt-5/qimage.html#pixelIndex-1
    ...
    def save(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#save-1
        ...
        **QBuffer**  buffer(&ba);
        ...
        ::WriteOnly);
                    image.save(&buffer, "PNG"); // writes image
        into ba in PNG format
        """
        ...
    ...
    def scaled(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#scaled-1
    ...
    def scanLine(self, arg__1: int) -> bytes:
        ...
        **Warning:** If you are accessing 32-bpp image data, cast the returned
        ...
        underlying platform. Use **qRed** (), **qGreen** (), **qBlue** (), and
    ...
    def setAlphaChannel(self, alphaChannel: PySide2.QtGui.QImage) -> None:
        ...
        **See also** **hasAlphaChannel** (), **alphaChannel** (), **Image
        Transformations** , and **Image Formats** .
        """
        ...
    ...
    def setPixelColor(self, pt: PySide2.QtCore.QPoint, c: PySide2.QtGui.QColor) -> None:
        ...
        **void QImage::setPixelColor(const QPoint & position , const QColor &
        color )**
    ...
    def setPixelColor(self, x: int, y: int, c: PySide2.QtGui.QColor) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#setPixelColor-1
    ...
    def sizeInBytes(self) -> int:
        ...
        **See also** **byteCount** (), **bytesPerLine** (), **bits** (), and
        **Image Information** .
        """
        ...
    ...
    def smoothScaled(self, w: int, h: int) -> PySide2.QtGui.QImage:
        ...
        **[protected] QImage QImage::smoothScaled(int w , int h ) const**
        ...
        size of width **w** by height **h** pixels.
        """
        ...
    ...
    def transformed(
        ...
        **QImage QImage::transformed(const QTransform & matrix ,
        ...
        given a format with an alpha channel, even if the orginal image did not
        have that.
    ...
    def trueMatrix(
        ...
        **width** , **height** and **matrix**.
        ...
        all transformed points of the original image. This function returns the
        modified matrix, which maps points correctly from the original image
        into the new image.
    ...
    def valid(self, x: int, y: int) -> bool:
        """
        https://doc.qt.io/qt-5/qimage.html#valid-1
