    ...
    **IAccessible2 Specification**
    ...
    def minimumStepSize(self) -> typing.Any:
        ...
        **[pure virtual] QVariant QAccessibleValueInterface::minimumStepSize()
        ...
        Returns the minimum step size for the accessible. This is the smalles
        increment that makes sense when changing the value. When programatically
        changing the value it should always be a multiple of the minimum step
        size.
