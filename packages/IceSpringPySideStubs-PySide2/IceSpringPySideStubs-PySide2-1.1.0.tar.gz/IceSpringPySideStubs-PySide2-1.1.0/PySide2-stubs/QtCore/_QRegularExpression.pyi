...
class QRegularExpression(object):
    ...
    **QRegularExpressionMatchIterator** .
    ...
    def globalMatch(
        ...
        """
        https://doc.qt.io/qt-5/qregularexpression.html#globalMatch-1

        **QRegularExpressionMatchIterator QRegularExpression::globalMatch(const
        QStringRef & subjectRef , int offset = 0, QRegularExpression::MatchType
        matchType = NormalMatch, QRegularExpression::MatchOptions matchOptions =
        NoMatchOption) const**
        ...
        Attempts to perform a global match of the regular expression against the
        given **subjectRef** string reference, starting at the position
        **offset** inside the subject, using a match of type **matchType** and
    ...
    def match(
        ...
        """
        https://doc.qt.io/qt-5/qregularexpression.html#match-1

        **QRegularExpressionMatch QRegularExpression::match(const QStringRef &
        subjectRef , int offset = 0, QRegularExpression::MatchType matchType =
        NormalMatch, QRegularExpression::MatchOptions matchOptions =
        NoMatchOption) const**
        ...
        **subjectRef** string reference, starting at the position **offset**
