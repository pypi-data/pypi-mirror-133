...
class QSize(object):
    ...
    **See also** **QSizeF** , **QPoint** , and **QRect** .
    ...
    def __init__(self, QSize: PySide2.QtCore.QSize) -> None:
        """
        https://doc.qt.io/qt-5/qsize.html#QSize-1
    ...
    def scale(self, w: int, h: int, mode: PySide2.QtCore.Qt.AspectRatioMode) -> None:
        """
        https://doc.qt.io/qt-5/qsize.html#scale-1
    ...
    def scaled(
        ...
        **QSize QSize::scaled(int width , int height , Qt::AspectRatioMode mode
        ) const**
    ...
    def scaled(
        ...
        """
        https://doc.qt.io/qt-5/qsize.html#scaled-1
