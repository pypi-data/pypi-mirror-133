...
class QGeoPositionInfoSource(PySide2.QtCore.QObject):
    ...
    **setUpdateInterval** () with a value of 0.
    ...
    def __init__(self, parent: PySide2.QtCore.QObject) -> None:
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#QGeoPositionInfoSourc
        e
    ...
    def backendProperty(self, name: str) -> typing.Any:
        ...
        **QVariant QGeoPositionInfoSource::backendProperty(const QString & name
        ) const**
    ...
    def createDefaultSource(
        ...
        *QGeoPositionInfoSource::createDefaultSource(QObject * parent )**
        ...
        could be found or the user does not have the permission to access the
        current position.
        """
        ...
    ...
    def createDefaultSource(
        ...
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#createDefaultSource-1
    ...
    def createSource(
        ...
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#createSource-1
    ...
    def minimumUpdateInterval(self) -> int:
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#minimumUpdateInterval
        -prop
    ...
    def preferredPositioningMethods(
        ...
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#preferredPositioningM
        ethods

        **QGeoPositionInfoSource::PositioningMethods
        QGeoPositionInfoSource::preferredPositioningMethods() const**
    ...
    def requestUpdate(self, timeout: int = ...) -> None:
        ...
        **[pure virtual slot] void QGeoPositionInfoSource::requestUpdate(int
        ...
        the value returned by **minimumUpdateInterval** (), **updateTimeout** ()
        is emitted.
    ...
    def setBackendProperty(self, name: str, value: typing.Any) -> bool:
        ...
        **bool QGeoPositionInfoSource::setBackendProperty(const QString & name ,
    ...
    def setPreferredPositioningMethods(
        ...
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#setPreferredPositioni
        ngMethods

        **[virtual] void QGeoPositionInfoSource::setPreferredPositioningMethods(
        QGeoPositionInfoSource::PositioningMethods methods )**

        Sets the preferred positioning methods for this source to **methods**.

        If **methods** includes a method that is not supported by the source,
        the unsupported method will be ignored.

        If **methods** does not include a single method available/supported by
        the source, the preferred methods will be set to the set of methods
        which the source has available. If the source has no method availabe
        (e.g. because its Location service is turned off or it does not offer a
        Location service), the passed **methods** are accepted as they are.

        **Note:** When reimplementing this method, subclasses must call the base
        method implementation to ensure **preferredPositioningMethods** ()
        returns the correct value.

        **See also** **preferredPositioningMethods** () and
    ...
    def startUpdates(self) -> None:
        ...
        **setUpdateInterval** ().
        ...
        An **updateTimeout** () signal will be emitted if this
        **QGeoPositionInfoSource**  subclass determines that it will not be able
        to provide regular updates. This could happen if a satellite fix is lost
        or if a hardware error is detected. Position updates will recommence if
        the data becomes available later on. The **updateTimeout** () signal
        will not be emitted again until after the periodic updates resume.
    ...
    def supportedPositioningMethods(
        ...
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#supportedPositioningM
        ethods
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qgeopositioninfosource.html#error-1

        **[signal] void
        QGeoPositionInfoSource::error(QGeoPositionInfoSource::Error
        positioningError )**
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(geoPositionInfoSource, QOverload<**QGeoPositionInfoSource**
        ::Error>::of(&**QGeoPositionInfoSource** ::error),
    ...
    def updateTimeout(self) -> PySide2.QtCore.SignalInstance:
        ...
        **[signal] void QGeoPositionInfoSource::updateTimeout()**
        ...
        If **requestUpdate** () was called, this signal will be emitted if the
        current position could not be retrieved within the specified timeout.

        If **startUpdates** () has been called, this signal will be emitted if
        this **QGeoPositionInfoSource**  subclass determines that it will not be
        able to provide further regular updates. This signal will not be emitted
        again until after the regular updates resume.
        ...
        the emission of `updateTimeout()` is required to indicate a timeout.
        """
        ...
