...
class QAbstractAudioOutput(PySide2.QtCore.QObject):
    ...
    **Detailed Description**
    ...
    QAbstractAudioOutput implements audio functionality for **QAudioOutput** ,
    i.e., **QAudioOutput**  routes function calls to QAbstractAudioOutput. For a
    description of the functionality that is implemented, see the
    **QAudioOutput**  class and function descriptions.
    ...
    **See also** **QAudioOutput** .
    ...
    def setFormat(self, fmt: PySide2.QtMultimedia.QAudioFormat) -> None:
        ...
        **[pure virtual] void QAbstractAudioOutput::setFormat(const QAudioFormat
        & fmt )**
    ...
    def start(self, device: PySide2.QtCore.QIODevice) -> None:
        """
        https://doc.qt.io/qt-5/qabstractaudiooutput.html#start-1
