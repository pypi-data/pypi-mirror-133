...
class QCameraImageCapture(
    ...
    **See also** **QCamera** .
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qcameraimagecapture.html#error-1

        **[signal] void QCameraImageCapture::error(int id ,
        QCameraImageCapture::Error error , const QString & errorString )**
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(cameraImageCapture, QOverload<int, **QCameraImageCapture**
        ::Error, const **QString**  &>::of(&**QCameraImageCapture** ::error),
        [=](int id, **QCameraImageCapture** ::Error error, const **QString**
        &errorString){ /* ... */ });
        """
        ...
