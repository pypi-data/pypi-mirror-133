...
class QSurfaceFormat(object):
    ...
    **Note:** When troubleshooting context or window format issues, it can be
    ...
    def __init__(self, options: PySide2.QtGui.QSurfaceFormat.FormatOptions) -> None:
        """
        https://doc.qt.io/qt-5/qsurfaceformat.html#QSurfaceFormat-1
    ...
    def __init__(self, other: PySide2.QtGui.QSurfaceFormat) -> None:
        """
        https://doc.qt.io/qt-5/qsurfaceformat.html#QSurfaceFormat-2
    ...
    def setColorSpace(
        ...
        **void QSurfaceFormat::setColorSpace(QSurfaceFormat::ColorSpace
        colorSpace )**
    ...
    def setDefaultFormat(format: PySide2.QtGui.QSurfaceFormat) -> None:
        ...
        **[static] void QSurfaceFormat::setDefaultFormat(const QSurfaceFormat &
        format )**
    ...
    def version(self) -> typing.Tuple:
        ...
        **QPair<int, int> QSurfaceFormat::version() const**
        ...
        Useful for version checks, for example format.version() >= **qMakePair**
        (3, 2)
