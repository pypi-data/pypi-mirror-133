...
class QOpenGLFunctions(object):
    ...
    **See also** **QOpenGLContext**  and **QSurfaceFormat** .
    ...
    def __init__(self, context: PySide2.QtGui.QOpenGLContext) -> None:
        """
        https://doc.qt.io/qt-5/qopenglfunctions.html#QOpenGLFunctions-1
    ...
    def glClearColor(self, red: float, green: float, blue: float, alpha: float) -> None:
        ...
        **void QOpenGLFunctions::glClearColor(GLclampf red , GLclampf green ,
        GLclampf blue , GLclampf alpha )**
    ...
    def glColorMask(self, red: int, green: int, blue: int, alpha: int) -> None:
        ...
        **void QOpenGLFunctions::glColorMask(GLboolean red , GLboolean green ,
    ...
    def glCopyTexImage2D(
        ...
        **void QOpenGLFunctions::glCopyTexImage2D(GLenum target , GLint level ,
        GLenum internalformat , GLint x , GLint y , GLsizei width , GLsizei
        height , GLint border )**
    ...
    def glCopyTexSubImage2D(
        ...
        **void QOpenGLFunctions::glCopyTexSubImage2D(GLenum target , GLint level
    ...
    def glDeleteTextures(self, n: int, textures: typing.Sequence) -> None:
        ...
        **void QOpenGLFunctions::glDeleteTextures(GLsizei n , const GLuint *
        textures )**
    ...
    def glDrawArrays(self, mode: int, first: int, count: int) -> None:
        ...
        **void QOpenGLFunctions::glDrawArrays(GLenum mode , GLint first ,
        GLsizei count )**
    ...
    def glDrawElements(self, mode: int, count: int, type: int, indices: int) -> None:
        ...
        **void QOpenGLFunctions::glDrawElements(GLenum mode , GLsizei count ,
    ...
    def glGetFramebufferAttachmentParameteriv(
        ...
        """
        https://doc.qt.io/qt-5/qopenglfunctions.html#glGetFramebufferAttachmentP
        arameteriv
    ...
    def glGetRenderbufferParameteriv(
        ...
        """
        https://doc.qt.io/qt-5/qopenglfunctions.html#glGetRenderbufferParameteri
        v
    ...
    def glGetTexParameterfv(
        ...
        **void QOpenGLFunctions::glGetTexParameterfv(GLenum target , GLenum
    ...
    def glGetTexParameteriv(
        ...
        **void QOpenGLFunctions::glGetTexParameteriv(GLenum target , GLenum
        pname , GLint * params )**
    ...
    def glReadPixels(
        ...
        **void QOpenGLFunctions::glReadPixels(GLint x , GLint y , GLsizei width
    ...
    def glScissor(self, x: int, y: int, width: int, height: int) -> None:
        ...
        **void QOpenGLFunctions::glScissor(GLint x , GLint y , GLsizei width ,
        GLsizei height )**
    ...
    def glStencilFunc(self, func: int, ref: int, mask: int) -> None:
        ...
        **void QOpenGLFunctions::glStencilFunc(GLenum func , GLint ref , GLuint
        mask )**
    ...
    def glStencilOp(self, fail: int, zfail: int, zpass: int) -> None:
        ...
        **void QOpenGLFunctions::glStencilOp(GLenum fail , GLenum zfail , GLenum
        zpass )**
    ...
    def glTexImage2D(
        ...
        **void QOpenGLFunctions::glTexImage2D(GLenum target , GLint level ,
    ...
    def glTexParameterf(self, target: int, pname: int, param: float) -> None:
        ...
        **void QOpenGLFunctions::glTexParameterf(GLenum target , GLenum pname ,
        GLfloat param )**
    ...
    def glTexParameterfv(
        ...
        **void QOpenGLFunctions::glTexParameterfv(GLenum target , GLenum pname ,
    ...
    def glTexParameteri(self, target: int, pname: int, param: int) -> None:
        ...
        **void QOpenGLFunctions::glTexParameteri(GLenum target , GLenum pname ,
        GLint param )**
    ...
    def glTexParameteriv(
        ...
        **void QOpenGLFunctions::glTexParameteriv(GLenum target , GLenum pname ,
        const GLint * params )**
    ...
    def glTexSubImage2D(
        ...
        **void QOpenGLFunctions::glTexSubImage2D(GLenum target , GLint level ,
    ...
    def glViewport(self, x: int, y: int, width: int, height: int) -> None:
        ...
        **void QOpenGLFunctions::glViewport(GLint x , GLint y , GLsizei width ,
        GLsizei height )**
