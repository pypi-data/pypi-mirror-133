...
class QXmlStreamWriter(object):
    ...
    **QXmlStreamReader** .
    ...
    def __init__(self, array: PySide2.QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#QXmlStreamWriter-1
    ...
    def __init__(self, device: PySide2.QtCore.QIODevice) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#QXmlStreamWriter-2
    ...
    def setCodec(self, codec: PySide2.QtCore.QTextCodec) -> None:
        ...
        **void QXmlStreamWriter::setCodec(QTextCodec * codec )**
        ...
        written when you call **writeStartDocument** (). Call this function
        before calling **writeStartDocument** ().

        **Note:** When writing the XML to a **QString** , the codec information
        is ignored and the XML header will not include any encoding information,
        since all QStrings are UTF-16. If you later convert the **QString**  to
        an 8-bit format, you must arrange for the encoding information to be
    ...
    def setCodec(self, codecName: bytes) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#setCodec-1
    ...
    def writeAttribute(self, namespaceUri: str, name: str, value: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeAttribute-1
    ...
    def writeAttribute(self, qualifiedName: str, value: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeAttribute-2
    ...
    def writeEmptyElement(self, qualifiedName: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeEmptyElement-1
    ...
    def writeStartDocument(self, version: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeStartDocument-1

        **void QXmlStreamWriter::writeStartDocument()**

        This is an overloaded function.

        Writes a document start with XML version number "1.0". This also writes
    ...
    def writeStartDocument(self, version: str, standalone: bool) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeStartDocument-2
    ...
    def writeStartElement(self, qualifiedName: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeStartElement-1
    ...
    def writeTextElement(self, qualifiedName: str, text: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamwriter.html#writeTextElement-1
