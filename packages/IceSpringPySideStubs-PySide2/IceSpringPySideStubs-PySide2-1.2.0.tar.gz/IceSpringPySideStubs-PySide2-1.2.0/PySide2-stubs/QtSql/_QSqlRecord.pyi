...
class QSqlRecord(object):
    ...
    **See also** **QSqlField**  and **QSqlQuery::record** ().
    ...
    def __init__(self, other: PySide2.QtSql.QSqlRecord) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#QSqlRecord-1
    ...
    def field(self, name: str) -> PySide2.QtSql.QSqlField:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#field-1
    ...
    def isGenerated(self, name: str) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#isGenerated-1
    ...
    def isNull(self, name: str) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#isNull-1
    ...
    def keyValues(
        ...
        **QSqlRecord QSqlRecord::keyValues(const QSqlRecord & keyFields )
        const**
    ...
    def setGenerated(self, name: str, generated: bool) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#setGenerated-1
    ...
    def setNull(self, name: str) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#setNull-1
    ...
    def setValue(self, name: str, val: typing.Any) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#setValue-1
    ...
    def value(self, name: str) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qsqlrecord.html#value-1
