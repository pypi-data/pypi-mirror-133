...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    **Note:** The QScxmlStateMachine needs a **QEventLoop**  to work correctly.
    ...
    def activeStateNames(self, compress: bool = ...) -> typing.List:
        ...
        **QStringList QScxmlStateMachine::activeStateNames(bool compress = true)
        const**
    ...
    def invokedServices(self) -> typing.List:
        ...
        **Notifier signal:**
        ...
        void **invokedServicesChanged** (const QVector<QScxmlInvokableService
        \\*> & **invokedServices** )
        """
        ...
    ...
    def isActive(self, scxmlStateName: str) -> bool:
        ...
        **bool QScxmlStateMachine::isActive(const QString & scxmlStateName )
        const**
    ...
    def isActive(self, stateIndex: int) -> bool:
        """
        https://doc.qt.io/qt-5/qscxmlstatemachine.html#isActive-1
    ...
    def isDispatchableTarget(self, target: str) -> bool:
        ...
        **bool QScxmlStateMachine::isDispatchableTarget(const QString & target )
        const**
    ...
    def stateNames(self, compress: bool = ...) -> typing.List:
        ...
        **QStringList QScxmlStateMachine::stateNames(bool compress = true)
        const**
    ...
    def submitEvent(self, eventName: str) -> None:
        """
        https://doc.qt.io/qt-5/qscxmlstatemachine.html#submitEvent-1
    ...
    def submitEvent(self, eventName: str, data: typing.Any) -> None:
        """
        https://doc.qt.io/qt-5/qscxmlstatemachine.html#submitEvent-2

        **void QScxmlStateMachine::submitEvent(const QString & eventName , const
        QVariant & data )**
