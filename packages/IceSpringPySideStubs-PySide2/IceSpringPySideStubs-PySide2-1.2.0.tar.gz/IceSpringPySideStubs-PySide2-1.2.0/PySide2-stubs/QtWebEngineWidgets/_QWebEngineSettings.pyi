    ...
    **QWebEngineView::settings** ().
    ...
    def defaultSettings() -> PySide2.QtWebEngineWidgets.QWebEngineSettings:
        ...
        **[static] QWebEngineSettings *QWebEngineSettings::defaultSettings()**
        ...
        profile. All web pages not specifically created with another profile
    ...
    def resetUnknownUrlSchemePolicy(self) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginesettings.html#resetUnknownUrlSchemePoli
        cy
    ...
    def setFontFamily(
        ...
        **void QWebEngineSettings::setFontFamily(QWebEngineSettings::FontFamily
        which , const QString & family )**

        Sets the actual font family to **family** for the specified generic
        family, **which**.
    ...
    def setUnknownUrlSchemePolicy(
        ...
        **void QWebEngineSettings::setUnknownUrlSchemePolicy(QWebEngineSettings:
        :UnknownUrlSchemePolicy policy )**
