...
class QAbstractItemDelegate(PySide2.QtCore.QObject):
    ...
    **Pixelator Example** , **QStyledItemDelegate** , and **QStyle** .
    ...
    def destroyEditor(
        ...
        **[virtual] void QAbstractItemDelegate::destroyEditor(QWidget * editor ,
        ...
        is a call to **deleteLater**  on the editor. It is possible e.g. to
        avoid this delete by reimplementing this function.
