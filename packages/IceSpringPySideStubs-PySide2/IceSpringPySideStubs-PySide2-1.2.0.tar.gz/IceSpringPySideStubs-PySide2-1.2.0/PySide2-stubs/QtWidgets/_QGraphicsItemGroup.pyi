...
class QGraphicsItemGroup(PySide2.QtWidgets.QGraphicsItem):
    ...
    **ItemIgnoresTransformations**  flag on its children (i.e., with respect to
    the geometry of the group item, the children are treated as if they were
    transformable).
    ...
    **See also** **QGraphicsItem**  and **Graphics View Framework** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#QGraphicsItemGroup
    ...
    def addToGroup(self, item: PySide2.QtWidgets.QGraphicsItem) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#addToGroup
    ...
    def boundingRect(self) -> PySide2.QtCore.QRectF:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#boundingRect
    ...
    def isObscuredBy(self, item: PySide2.QtWidgets.QGraphicsItem) -> bool:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#isObscuredBy
    ...
    def opaqueArea(self) -> PySide2.QtGui.QPainterPath:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#opaqueArea
    ...
    def paint(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#paint
    ...
    def removeFromGroup(self, item: PySide2.QtWidgets.QGraphicsItem) -> None:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#removeFromGroup
    ...
    def type(self) -> int:
        """
        https://doc.qt.io/qt-5/qgraphicsitemgroup.html#type
