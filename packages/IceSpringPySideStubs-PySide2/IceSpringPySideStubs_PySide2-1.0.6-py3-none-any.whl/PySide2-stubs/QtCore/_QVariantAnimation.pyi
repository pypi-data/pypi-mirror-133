...
class QVariantAnimation(PySide2.QtCore.QAbstractAnimation):
    ...
    **See also** **QPropertyAnimation** , **QAbstractAnimation** , and **The
    ...
    def easingCurve(self) -> PySide2.QtCore.QEasingCurve:
        ...
        **totalDuration** ) of the animation into the effective progress
        actually used by the animation. It is this effective progress that will
        be the progress when **interpolated** () is called. Also, the steps in
        the **keyValues**  are referring to this effective progress.
