...
class QRemoteObjectHostBase(PySide2.QtRemoteObjects.QRemoteObjectNode):
    ...
    **Detailed Description**
    ...
    def enableRemoting(self, object: PySide2.QtCore.QObject, name: str = ...) -> bool:
        """
        https://doc.qt.io/qt-5/qremoteobjecthostbase.html#enableRemoting-1

        **bool QRemoteObjectHostBase::enableRemoting(QObject * object , const
    ...
    def proxy(
        ...
        **bool QRemoteObjectHostBase::proxy(const QUrl & registryUrl , const
        QUrl & hostUrl = {}, QRemoteObjectHostBase::RemoteObjectNameFilter
        filter = [](const QString &, const QString &) {return true; })**
    ...
    def reverseProxy(self) -> bool:
        ...
        **bool QRemoteObjectHostBase::reverseProxy(QRemoteObjectHostBase::Remote
        ObjectNameFilter filter = [](const QString &, const QString &) {return
        true; })**
        ...
        **Source**  objects on proxyNode and acquire them on the internal node
        if they pass the reverseFilter.
