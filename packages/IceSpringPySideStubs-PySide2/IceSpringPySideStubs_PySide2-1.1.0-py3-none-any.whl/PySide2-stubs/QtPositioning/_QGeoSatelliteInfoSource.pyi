...
class QGeoSatelliteInfoSource(PySide2.QtCore.QObject):
    ...
    **setUpdateInterval** () with a value of 0.
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qgeosatelliteinfosource.html#error-1

        **[signal] void
        QGeoSatelliteInfoSource::error(QGeoSatelliteInfoSource::Error
        satelliteError )**
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(geoSatelliteInfoSource, QOverload<QGeoSatelliteInfoSource::Error
