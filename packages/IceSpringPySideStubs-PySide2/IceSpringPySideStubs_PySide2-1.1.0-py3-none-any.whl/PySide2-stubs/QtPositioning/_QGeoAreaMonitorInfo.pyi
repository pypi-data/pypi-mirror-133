...
class QGeoAreaMonitorInfo(object):
    ...
    **See also** **QGeoAreaMonitorSource** .
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoAreaMonitorInfo) -> None:
        """
        https://doc.qt.io/qt-5/qgeoareamonitorinfo.html#QGeoAreaMonitorInfo-1
    ...
    def name(self) -> str:
        ...
        **QString QGeoAreaMonitorInfo::name() const**
        ...
        be used to for user-visibility purposes.
    ...
    def setNotificationParameters(self, parameters: typing.Dict) -> None:
        """
        https://doc.qt.io/qt-5/qgeoareamonitorinfo.html#setNotificationParameter
        s
    ...
    def setPersistent(self, isPersistent: bool) -> None:
        ...
        **void QGeoAreaMonitorInfo::setPersistent(bool isPersistent )**
        ...
        Sets the **QGeoAreaMonitorInfo**  objects persistence to
        **isPersistent**.

        Note that setting this flag does not imply that
        QGeoAreaMonitorInfoSource supports persistent monitoring.
