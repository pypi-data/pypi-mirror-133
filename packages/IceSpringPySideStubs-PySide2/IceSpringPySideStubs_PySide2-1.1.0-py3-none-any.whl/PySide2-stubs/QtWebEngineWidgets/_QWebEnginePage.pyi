...
class QWebEnginePage(PySide2.QtCore.QObject):
    ...
    **loadFinished** () signal is emitted when the page contents have been
    ...
    NoWebAction: QWebEnginePage = ...
    Back: QWebEnginePage = ...
    FileSelectOpen: QWebEnginePage = ...
    InfoMessageLevel: QWebEnginePage = ...
    NavigationTypeLinkClicked: QWebEnginePage = ...
    NormalTerminationStatus: QWebEnginePage = ...
    Notifications: QWebEnginePage = ...
    PermissionUnknown: QWebEnginePage = ...
    WebBrowserWindow: QWebEnginePage = ...
    AbnormalTerminationStatus: QWebEnginePage = ...
    FileSelectOpenMultiple: QWebEnginePage = ...
    FindBackward: QWebEnginePage = ...
    Forward: QWebEnginePage = ...
    Geolocation: QWebEnginePage = ...
    NavigationTypeTyped: QWebEnginePage = ...
    PermissionGrantedByUser: QWebEnginePage = ...
    WarningMessageLevel: QWebEnginePage = ...
    WebBrowserTab: QWebEnginePage = ...
    CrashedTerminationStatus: QWebEnginePage = ...
    ErrorMessageLevel: QWebEnginePage = ...
    FindCaseSensitively: QWebEnginePage = ...
    MediaAudioCapture: QWebEnginePage = ...
    NavigationTypeFormSubmitted: QWebEnginePage = ...
    PermissionDeniedByUser: QWebEnginePage = ...
    Stop: QWebEnginePage = ...
    WebDialog: QWebEnginePage = ...
    KilledTerminationStatus: QWebEnginePage = ...
    MediaVideoCapture: QWebEnginePage = ...
    NavigationTypeBackForward: QWebEnginePage = ...
    Reload: QWebEnginePage = ...
    WebBrowserBackgroundTab: QWebEnginePage = ...
    Cut: QWebEnginePage = ...
    MediaAudioVideoCapture: QWebEnginePage = ...
    NavigationTypeReload: QWebEnginePage = ...
    Copy: QWebEnginePage = ...
    MouseLock: QWebEnginePage = ...
    NavigationTypeOther: QWebEnginePage = ...
    DesktopVideoCapture: QWebEnginePage = ...
    NavigationTypeRedirect: QWebEnginePage = ...
    Paste: QWebEnginePage = ...
    DesktopAudioVideoCapture: QWebEnginePage = ...
    Undo: QWebEnginePage = ...
    Redo: QWebEnginePage = ...
    SelectAll: QWebEnginePage = ...
    ReloadAndBypassCache: QWebEnginePage = ...
    PasteAndMatchStyle: QWebEnginePage = ...
    OpenLinkInThisWindow: QWebEnginePage = ...
    OpenLinkInNewWindow: QWebEnginePage = ...
    OpenLinkInNewTab: QWebEnginePage = ...
    CopyLinkToClipboard: QWebEnginePage = ...
    DownloadLinkToDisk: QWebEnginePage = ...
    CopyImageToClipboard: QWebEnginePage = ...
    CopyImageUrlToClipboard: QWebEnginePage = ...
    DownloadImageToDisk: QWebEnginePage = ...
    CopyMediaUrlToClipboard: QWebEnginePage = ...
    ToggleMediaControls: QWebEnginePage = ...
    ToggleMediaLoop: QWebEnginePage = ...
    ToggleMediaPlayPause: QWebEnginePage = ...
    ToggleMediaMute: QWebEnginePage = ...
    DownloadMediaToDisk: QWebEnginePage = ...
    InspectElement: QWebEnginePage = ...
    ExitFullScreen: QWebEnginePage = ...
    RequestClose: QWebEnginePage = ...
    Unselect: QWebEnginePage = ...
    SavePage: QWebEnginePage = ...
    OpenLinkInNewBackgroundTab: QWebEnginePage = ...
    ViewSource: QWebEnginePage = ...
    ToggleBold: QWebEnginePage = ...
    ToggleItalic: QWebEnginePage = ...
    ToggleUnderline: QWebEnginePage = ...
    ToggleStrikethrough: QWebEnginePage = ...
    AlignLeft: QWebEnginePage = ...
    AlignCenter: QWebEnginePage = ...
    AlignRight: QWebEnginePage = ...
    AlignJustified: QWebEnginePage = ...
    Indent: QWebEnginePage = ...
    Outdent: QWebEnginePage = ...
    InsertOrderedList: QWebEnginePage = ...
    InsertUnorderedList: QWebEnginePage = ...
    WebActionCount: QWebEnginePage = ...
    ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#QWebEnginePage
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#QWebEnginePage-1
    ...
    def acceptNavigationRequest(
        ...
        **[virtual protected] bool QWebEnginePage::acceptNavigationRequest(const
        QUrl & url , QWebEnginePage::NavigationType type , bool isMainFrame )**
    ...
    def action(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#action
    ...
    def backgroundColor(self) -> PySide2.QtGui.QColor:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#backgroundColor-prop
    ...
    def certificateError(
        ...
        **[virtual protected] bool QWebEnginePage::certificateError(const
        QWebEngineCertificateError & certificateError )**

        This function is called when an invalid certificate error is raised
        while loading a given request.

        The **certificateError** parameter contains information about the
        certificate and details of the error.

        Return `true` to ignore the error and complete the request. Return
        `false` to stop loading the request.

        **Note:** If the error was successfully deferred then the returned value
        will be ignored.
    ...
    def chooseFiles(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#chooseFiles
    ...
    def contentsSize(self) -> PySide2.QtCore.QSizeF:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#contentsSize-prop
    ...
    def contextMenuData(self) -> PySide2.QtWebEngineWidgets.QWebEngineContextMenuData:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#contextMenuData

        **const QWebEngineContextMenuData &QWebEnginePage::contextMenuData()
        const**

        Returns additional data about the current context menu. It is only
        guaranteed to be valid during the call to the
        **QWebEngineView::contextMenuEvent** () handler of the associated
        **QWebEngineView** .
    ...
    def createStandardContextMenu(self) -> PySide2.QtWidgets.QMenu:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#createStandardContextMenu

        **QMenu *QWebEnginePage::createStandardContextMenu()**

        Creates the standard context menu which is shown when the user clicks on
        the web page with the right mouse button. It is called from the default
        **contextMenuEvent()**  handler. The popup menu's ownership is
        transferred to the caller.

        Returns `nullptr` if the context menu data is not initialized, for
        example when it is called when there is actually no context menu
        requested.
        """
        ...
    ...
    def devToolsPage(self) -> PySide2.QtWebEngineWidgets.QWebEnginePage:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#devToolsPage
    ...
    def download(self, url: PySide2.QtCore.QUrl, filename: str = ...) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#download

        **void QWebEnginePage::download(const QUrl & url , const QString &
        filename = QString())**
    ...
    def event(self, arg__1: PySide2.QtCore.QEvent) -> bool:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#event
    ...
    def findText(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#findText

        **void QWebEnginePage::findText(const QString & subString ,
        QWebEnginePage::FindFlags options = FindFlags(), const
        QWebEngineCallback<bool> & resultCallback =
        ...
        **options**. The **findTextFinished** () signal is emitted when a string
        ...
        The **resultCallback** must take a boolean parameter. It will be called
        with a value of `true` if the **subString** was found; otherwise the
        callback value will be `false`.
    ...
    def hasSelection(self) -> bool:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#hasSelection-prop
    ...
    def history(self) -> PySide2.QtWebEngineWidgets.QWebEngineHistory:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#history
    ...
    def icon(self) -> PySide2.QtGui.QIcon:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#icon-prop

        **icon : const QIcon**

        This property holds the icon associated with the page currently viewed.

        By default, this property contains a null icon. If the web page
        specifies more than one icon, the `icon` property encapsulates the
        available candidate icons in a single, scalable `QIcon`.
    ...
    def iconUrl(self) -> PySide2.QtCore.QUrl:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#iconUrl-prop
    ...
    def inspectedPage(self) -> PySide2.QtWebEngineWidgets.QWebEnginePage:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#inspectedPage
    ...
    def javaScriptAlert(self, securityOrigin: PySide2.QtCore.QUrl, msg: str) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#javaScriptAlert
    ...
    def javaScriptConfirm(self, securityOrigin: PySide2.QtCore.QUrl, msg: str) -> bool:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#javaScriptConfirm
    ...
    def javaScriptConsoleMessage(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#javaScriptConsoleMessage
    ...
    def javaScriptPrompt(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#javaScriptPrompt
    ...
    def lifecycleState(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#lifecycleState-prop
    ...
    def load(self, request: PySide2.QtWebEngineCore.QWebEngineHttpRequest) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#load
    ...
    def load(self, url: PySide2.QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#load-1
    ...
    def print(self, arg__1: PySide2.QtPrintSupport.QPrinter, arg__2: object) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#print

        **void QWebEnginePage::print(QPrinter * printer , const
        QWebEngineCallback<bool> & resultCallback )**
        ...
        retrieved from the **printer** object. It is the users responsibility to
        ensure the **printer** remains valid until **resultCallback** has been
        called.

        **Note:** Printing runs on the browser process, which is by default not
        sandboxed.

        The **resultCallback** must take a boolean as parameter. If printing was
        successful, this boolean will have the value `true`, otherwise, its
        value will be `false`.
    ...
    def printToPdf(self, arg__1: object, arg__2: PySide2.QtGui.QPageLayout) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#printToPdf
    ...
    def printToPdf(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#printToPdf-1

        **void QWebEnginePage::printToPdf(const QWebEngineCallback<const
        QByteArray &> & resultCallback , const QPageLayout & pageLayout =
        QPageLayout(QPageSize(QPageSize::A4), QPageLayout::Portrait,
        QMarginsF()))**

        Renders the current content of the page into a PDF document and returns
        a byte array containing the PDF data as parameter to **resultCallback**.
        The page size and orientation of the produced PDF document are taken
        from the values specified in **pageLayout**.

        The **resultCallback** must take a const reference to a **QByteArray**
        as parameter. If printing was successful, this byte array will contain
        the PDF data, otherwise, the byte array will be empty.
    ...
    def profile(self) -> PySide2.QtWebEngineWidgets.QWebEngineProfile:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#profile
    ...
    def recentlyAudible(self) -> bool:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#recentlyAudible-prop
    ...
    def recommendedState(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#recommendedState-prop
    ...
    def renderProcessPid(self) -> int:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#renderProcessPid-prop
    ...
    def replaceMisspelledWord(self, replacement: str) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#replaceMisspelledWord
        ...
        **QWebEngineContextMenuData::misspelledWord** (), and suggested
        replacements in **QWebEngineContextMenuData::spellCheckerSuggestions**
        ().
    ...
    def requestedUrl(self) -> PySide2.QtCore.QUrl:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#requestedUrl-prop
    ...
    def save(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#save
    ...
    def scripts(self) -> PySide2.QtWebEngineWidgets.QWebEngineScriptCollection:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#scripts
    ...
    def scrollPosition(self) -> PySide2.QtCore.QPointF:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#scrollPosition-prop
    ...
    def selectedText(self) -> str:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#selectedText-prop
    ...
    def setAudioMuted(self, muted: bool) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#audioMuted-prop
    ...
    def setContent(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setContent
    ...
    def setFeaturePermission(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setFeaturePermission
    ...
    def setHtml(self, html: str, baseUrl: PySide2.QtCore.QUrl = ...) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setHtml
    ...
    def setUrl(self, url: PySide2.QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#url-prop
    ...
    def setUrlRequestInterceptor(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setUrlRequestInterceptor
    ...
    def setView(self, view: PySide2.QtWidgets.QWidget) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setView
    ...
    def setVisible(self, visible: bool) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#visible-prop
    ...
    def setWebChannel(self, arg__1: PySide2.QtWebChannel.QWebChannel) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setWebChannel

        **void QWebEnginePage::setWebChannel(QWebChannel * channel , uint
        worldId )**
    ...
    def setWebChannel(
        ...
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#setWebChannel-1
        ...
        **void QWebEnginePage::setWebChannel(QWebChannel * channel )**
        ...
        Sets the web channel instance to be used by this page to **channel** and
        installs it in the main JavaScript world.

        With this method the web channel can be accessed by web page content. If
        the content is not under your control and might be hostile, this could
        be a security issue and you should consider installing it in a private
        JavaScript world.
    ...
    def setZoomFactor(self, factor: float) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#zoomFactor-prop
        ...
        **void QWebEnginePage::runJavaScript(const **QString**  &
        **scriptSource** )****void QWebEnginePage::runJavaScript(const
        **QString**  & **scriptSource** , const QWebEngineCallback<const
        **QVariant**  &> & **resultCallback** )****void
        QWebEnginePage::runJavaScript(const **QString**  & **scriptSource** ,
        **quint32**  **worldId** )****void QWebEnginePage::runJavaScript(const
        **QString**  & **scriptSource** , **quint32**  **worldId** , const
    ...
    def settings(self) -> PySide2.QtWebEngineWidgets.QWebEngineSettings:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#settings
    ...
    def title(self) -> str:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#title-prop
    ...
    def toHtml(self, arg__1: object) -> None:
        ...
        **void QWebEnginePage::toHtml(const QWebEngineCallback<const QString &>
    ...
    def toPlainText(self, arg__1: object) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#toPlainText

        **void QWebEnginePage::toPlainText(const QWebEngineCallback<const
    ...
    def view(self) -> PySide2.QtWidgets.QWidget:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#view
    ...
    def webChannel(self) -> PySide2.QtWebChannel.QWebChannel:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#webChannel
    ...
    @property
    def audioMutedChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#audioMutedChanged
    ...
    @property
    def authenticationRequired(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#authenticationRequired
    ...
    @property
    def contentsSizeChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def featurePermissionRequestCanceled(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#featurePermissionRequestCance
        led
    ...
    @property
    def featurePermissionRequested(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#featurePermissionRequested
    ...
    @property
    def findTextFinished(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#findTextFinished

        **[signal] void QWebEnginePage::findTextFinished(const
    ...
    @property
    def fullScreenRequested(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def geometryChangeRequested(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#geometryChangeRequested
    ...
    def iconChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#iconChanged
    ...
    def iconUrlChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#iconUrlChanged
    ...
    @property
    def lifecycleStateChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def linkHovered(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#linkHovered
    ...
    def loadProgress(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#loadProgress
    ...
    def loadStarted(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#loadStarted
    ...
    @property
    def pdfPrintingFinished(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#pdfPrintingFinished
    ...
    @property
    def printRequested(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#printRequested

        **[signal] void QWebEnginePage::printRequested()**

        This signal is emitted when the JavaScript `window.print()` method is
        called. Typically, the signal handler can simply call **printToPdf** ().
    ...
    def proxyAuthenticationRequired(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#proxyAuthenticationRequired
    ...
    @property
    def quotaRequested(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#quotaRequested

        **[signal] void QWebEnginePage::quotaRequested(QWebEngineQuotaRequest
        quotaRequest )**
    ...
    @property
    def recentlyAudibleChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#recentlyAudibleChanged

        **[signal] void QWebEnginePage::recentlyAudibleChanged(bool
        recentlyAudible )**
    ...
    @property
    def recommendedStateChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def registerProtocolHandlerRequested(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#registerProtocolHandlerReques
        ted

        **[signal] void QWebEnginePage::registerProtocolHandlerRequested(QWebEng
        ineRegisterProtocolHandlerRequest request )**
        ...
        void WebPage::handleRegisterProtocolHandlerRequested(**QWebEngineRegiste
        rProtocolHandlerRequest**  request)
            {
                auto answer =
        **QMessageBox** ::question(
                    view()->window(),
        tr("Permission Request"),
                    tr("Allow %1 to open all %2
        links?")
    ...
    @property
    def renderProcessPidChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#renderProcessPidChanged

        **[signal] void QWebEnginePage::renderProcessPidChanged(qint64 pid )**

        This signal is emitted when the underlying render process PID,
        **renderProcessPid** , changes.
    ...
    def renderProcessTerminated(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#renderProcessTerminated

        **[signal] void QWebEnginePage::renderProcessTerminated(QWebEnginePage::
    ...
    @property
    def scrollPositionChanged(self) -> PySide2.QtCore.SignalInstance:
        ...

    @property
    def selectClientCertificate(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qwebenginepage.html#selectClientCertificate

        **[signal] void QWebEnginePage::selectClientCertificate(QWebEngineClient
        CertificateSelection clientCertificateSelection )**
    ...
    @property
    def windowCloseRequested(self) -> PySide2.QtCore.SignalInstance:
        """
