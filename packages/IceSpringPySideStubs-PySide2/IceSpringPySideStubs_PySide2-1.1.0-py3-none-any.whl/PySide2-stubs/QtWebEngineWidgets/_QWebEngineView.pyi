...
class QWebEngineView(PySide2.QtWidgets.QWidget):
    ...
    **See also** **WebEngine Widgets Simple Browser Example** , **WebEngine
    ...
    def findText(
        ...
        **resultCallback** must take a boolean parameter. It will be called with
        a value of `true` if **subString** was found; otherwise the callback
        value will be `false`.
    ...
    def load(self, url: PySide2.QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qwebengineview.html#load-1
    ...
    def renderProcessTerminated(self) -> PySide2.QtCore.SignalInstance:
        ...
        **[signal] void QWebEngineView::renderProcessTerminated(QWebEnginePage::
