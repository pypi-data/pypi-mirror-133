...
class QMenu(PySide2.QtWidgets.QWidget):
    ...
    **See also** **QMenuBar** , **GUI Design Handbook: Menu, Drop-Down and Pop-
    ...
    def addAction(self, text: str) -> PySide2.QtWidgets.QAction:
        """
        https://doc.qt.io/qt-5/qmenu.html#addAction-5

        **template <typename Functor> QAction *QMenu::addAction(const QString &
        text , const QObject * context , Functor functor , const QKeySequence &
        shortcut = 0)**
    ...
    def addAction(
        ...
        """
        https://doc.qt.io/qt-5/qmenu.html#addAction-6

        **template <typename Functor> QAction *QMenu::addAction(const QIcon &
        icon , const QString & text , Functor functor , const QKeySequence &
        shortcut = 0)**
