...
class QSqlDatabase(object):
    ...
    **See also** **QSqlDriver** , **QSqlQuery** , **Qt SQL** , and **Threads and
    ...
    def __init__(self, driver: PySide2.QtSql.QSqlDriver) -> None:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#QSqlDatabase-1
    ...
    def __init__(self, other: PySide2.QtSql.QSqlDatabase) -> None:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#QSqlDatabase-2
    ...
    def __init__(self, type: str) -> None:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#QSqlDatabase-3
    ...
    def addDatabase(type: str, connectionName: str = ...) -> PySide2.QtSql.QSqlDatabase:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#addDatabase-1
        ...
        *serviceContext`qsql_oci.cpp`
        ...
        QTDSQTDSDriverLOGINREC
        *loginRecord, DBPROCESS *dbProcess, const **QString**  &**hostName**
        `qsql_tds.cpp`
        ...
        QTDSDriver for creating new connections for internal queries. This is to
        prevent blocking when several **QSqlQuery**  objects are used
        simultaneously.
    ...
    def cloneDatabase(other: str, connectionName: str) -> PySide2.QtSql.QSqlDatabase:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#cloneDatabase-1

        **[static] QSqlDatabase QSqlDatabase::cloneDatabase(const QString &
        other , const QString & connectionName )**
    ...
    def exec_(self, query: str = ...) -> PySide2.QtSql.QSqlQuery:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#exec
    ...
    def open(self, user: str, password: str) -> bool:
        """
        https://doc.qt.io/qt-5/qsqldatabase.html#open-1
