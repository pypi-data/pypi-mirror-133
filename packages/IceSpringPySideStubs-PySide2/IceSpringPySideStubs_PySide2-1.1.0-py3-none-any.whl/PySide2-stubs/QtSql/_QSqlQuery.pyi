...
class QSqlQuery(object):
    ...
    **See also** **QSqlDatabase** , **QSqlQueryModel** , **QSqlTableModel** ,
    ...
    ValuesAsRows: QSqlQuery = ...
    ValuesAsColumns: QSqlQuery = ...
    ...
    def __init__(self, db: PySide2.QtSql.QSqlDatabase) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#QSqlQuery
    ...
    def __init__(self, other: PySide2.QtSql.QSqlQuery) -> None:
        ...
        **QSqlQuery::QSqlQuery(const QString & query = QString(), QSqlDatabase
        db = QSqlDatabase())**
    ...
    def __init__(self, query: str = ..., db: PySide2.QtSql.QSqlDatabase = ...) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#QSqlQuery-2
    ...
    def __init__(self, r: PySide2.QtSql.QSqlResult) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#QSqlQuery-3
    ...
    def addBindValue(
        self, val: typing.Any, type: PySide2.QtSql.QSql.ParamType = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#addBindValue
    ...
    def at(self) -> int:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#at
    ...
    def bindValue(
        ...
        placeholder: str,
        val: typing.Any,
        type: PySide2.QtSql.QSql.ParamType = ...,
    ) -> None:
        """
    ...
    @typing.overload
    def bindValue(
        self, pos: int, val: typing.Any, type: PySide2.QtSql.QSql.ParamType = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#bindValue-1
    ...
    def boundValue(self, placeholder: str) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#boundValue
    ...
    def boundValue(self, pos: int) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#boundValue-1
    ...
    def boundValues(self) -> typing.Dict:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#boundValues
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#clear
    ...
    def driver(self) -> PySide2.QtSql.QSqlDriver:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#driver
    ...
    def execBatch(self, mode: PySide2.QtSql.QSqlQuery.BatchExecutionMode = ...) -> bool:
        ...
        **QVariantList**  ints;
        ...
        q.addBindValue(ints);
            ...
            **QVariantList**  names;
            names <<
        "Harald" << "Boris" << "Trond" << **QVariant** (**QVariant** ::String);
        ...
        `QVariant(QVariant::String)` should be used if you are using strings.
        ...
        **QVariantList**  will be interpreted as a value for a new row.
        ...
        every entry within a **QVariantList**  will be interpreted as array-
        value for an IN or OUT value within a stored procedure. Note that this
        will only work if the IN or OUT value is a table-type consisting of only
        one column of a basic type, for example `TYPE myType IS TABLE OF
        VARCHAR(64) INDEX BY BINARY_INTEGER;`
    ...
    def exec_(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#exec
        ...
        **bool QSqlQuery::exec(const QString & query )**
        ...
        For **SQLite** , the query string can contain only one statement at a
        time. If more than one statement is given, the function returns `false`.
    ...
    def exec_(self, query: str) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#exec-1
    ...
    def finish(self) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#finish
    ...
    def isActive(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isActive
        ...
        **Note:** Of particular interest is an active query that is a `SELECT`
        ...
        that is a `SELECT` statement can cause a **commit()**  or a
        **rollback()**  to fail, so before committing or rolling back, you
        should make your active `SELECT` statement query inactive using one of
    ...
    def isForwardOnly(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isForwardOnly
    ...
    def isNull(self, field: int) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isNull
    ...
    def isNull(self, name: str) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isNull-1
    ...
    def isSelect(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isSelect
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#isValid
    ...
    def last(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#last
    ...
    def lastQuery(self) -> str:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#lastQuery
    ...
    def next(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#next
    ...
    def nextResult(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#nextResult
    ...
    def numRowsAffected(self) -> int:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#numRowsAffected
    ...
    def numericalPrecisionPolicy(self) -> PySide2.QtSql.QSql.NumericalPrecisionPolicy:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#numericalPrecisionPolicy
    ...
    def previous(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#previous
    ...
    def record(self) -> PySide2.QtSql.QSqlRecord:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#record
    ...
    def result(self) -> PySide2.QtSql.QSqlResult:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#result
    ...
    def seek(self, i: int, relative: bool = ...) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#seek
    ...
    def setForwardOnly(self, forward: bool) -> None:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#setForwardOnly
    ...
    def setNumericalPrecisionPolicy(
        ...
        """
        https://doc.qt.io/qt-5/qsqlquery.html#setNumericalPrecisionPolicy
        ...
        **QSqlDriver::hasFeature** () to find out whether a driver supports this
        ...
        query. Call **exec** (**QString** ) or **prepare** () in order to
        activate the policy.
    ...
    def size(self) -> int:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#size
    ...
    def value(self, name: str) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qsqlquery.html#value-1
