...
class QCborValue(object):
    ...
    **QCborStreamWriter** .
    ...
    Compact: QCborValue = ...
    Integer: QCborValue = ...
    NoTransformation: QCborValue = ...
    LineWrapped: QCborValue = ...
    SortKeysInMaps: QCborValue = ...
    ExtendedFormat: QCborValue = ...
    UseFloat: QCborValue = ...
    UseFloat16: QCborValue = ...
    UseIntegers: QCborValue = ...
    ByteArray: QCborValue = ...
    String: QCborValue = ...
    Array: QCborValue = ...
    Map: QCborValue = ...
    Tag: QCborValue = ...
    SimpleType: QCborValue = ...
    False_: QCborValue = ...
    True_: QCborValue = ...
    Null: QCborValue = ...
    Undefined: QCborValue = ...
    Double: QCborValue = ...
    DateTime: QCborValue = ...
    Url: QCborValue = ...
    RegularExpression: QCborValue = ...
    Uuid: QCborValue = ...
    ...
    def __init__(self, a: PySide2.QtCore.QCborArray) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-1
    ...
    def __init__(self, b_: bool) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-2
    ...
    def __init__(self, ba: PySide2.QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-3
    ...
    def __init__(self, dt: PySide2.QtCore.QDateTime) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-4
    ...
    def __init__(self, i: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-5
    ...
    def __init__(self, i: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-6
    ...
    def __init__(self, m: PySide2.QtCore.QCborMap) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-7
    ...
    def __init__(self, other: PySide2.QtCore.QCborValue) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-8
    ...
    def __init__(self, rx: PySide2.QtCore.QRegularExpression) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-9
    ...
    def __init__(self, s: str) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#QCborValue-10
    ...
    def compare(self, other: PySide2.QtCore.QCborValue) -> int:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#compare
    ...
    def fromCbor(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#fromCbor
    ...
    def fromCbor(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#fromCbor-1
    ...
    def fromJsonValue(v: PySide2.QtCore.QJsonValue) -> PySide2.QtCore.QCborValue:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#fromJsonValue
    ...
    def fromVariant(variant: typing.Any) -> PySide2.QtCore.QCborValue:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#fromVariant
        ...
        **[static] QCborValue QCborValue::fromVariant(const QVariant & variant
        ...
        Integer
        **quint64** Integer, but they are cast to `qint64` first so
        values higher than 263-1 (`INT64_MAX`) will be wrapped to negative
        `float`, `double`Double
    ...
    def isArray(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isArray
    ...
    def isBool(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isBool
    ...
    def isByteArray(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isByteArray
    ...
    def isContainer(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isContainer
    ...
    def isDateTime(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isDateTime
    ...
    def isDouble(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isDouble
    ...
    def isFalse(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isFalse
    ...
    def isInteger(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isInteger
    ...
    def isInvalid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isInvalid
    ...
    def isMap(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isMap
    ...
    def isNull(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isNull
    ...
    def isRegularExpression(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isRegularExpression
    ...
    def isSimpleType(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isSimpleType
    ...
    def isSimpleType(self, st: PySide2.QtCore.QCborSimpleType) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isSimpleType-1
    ...
    def isString(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isString
    ...
    def isTag(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isTag
    ...
    def isTrue(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isTrue
    ...
    def isUndefined(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isUndefined
    ...
    def isUrl(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isUrl
    ...
    def isUuid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#isUuid
    ...
    def swap(self, other: PySide2.QtCore.QCborValue) -> None:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#swap
    ...
    def taggedValue(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#taggedValue
    ...
    def toBool(self, defaultValue: bool = ...) -> bool:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toBool
    ...
    def toByteArray(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toByteArray
    ...
    def toCbor(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toCbor
    ...
    def toCbor(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toCbor-1

        **void QCborValue::toCbor(QCborStreamWriter & writer ,
        QCborValue::EncodingOptions opt = NoTransformation)**
    ...
    def toDateTime(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toDateTime
    ...
    def toDiagnosticNotation(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toDiagnosticNotation
    ...
    def toDouble(self, defaultValue: float = ...) -> float:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toDouble
    ...
    def toInteger(self, defaultValue: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toInteger
    ...
    def toJsonValue(self) -> PySide2.QtCore.QJsonValue:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toJsonValue
    ...
    def toRegularExpression(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toRegularExpression
    ...
    def toSimpleType(
        ...
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toSimpleType
    ...
    def toString(self, defaultValue: str = ...) -> str:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toString
    ...
    def toUrl(self, defaultValue: PySide2.QtCore.QUrl = ...) -> PySide2.QtCore.QUrl:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toUrl
    ...
    def toUuid(self, defaultValue: PySide2.QtCore.QUuid = ...) -> PySide2.QtCore.QUuid:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toUuid
    ...
    def toVariant(self) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#toVariant
        ...
        **QRegularExpression**
        ...
        using this function too and placed in **QVariantMap**  and
        **QVariantList**  instead. You will not find **QCborMap**  and
        **QCborArray**  stored inside the QVariants.

        QVariantMaps have string keys, unlike CBOR, so the conversion of a
        **QCborMap**  to **QVariantMap**  will imply a step of "stringification"
        of the key values. See **QCborMap::toJsonObject** () for details.
    ...
    def type(self) -> PySide2.QtCore.QCborValue.Type:
        """
        https://doc.qt.io/qt-5/qcborvalue.html#type
