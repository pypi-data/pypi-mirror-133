...
class QRegularExpressionMatch(object):
    ...
    **See also** **QRegularExpression** .
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#QRegularExpressionMa
        tch
    ...
    def captured(self, name: str) -> str:
        ...
        **See also** **capturedRef** (), **capturedView** (),
        **lastCapturedIndex** (), **capturedStart** (), **capturedEnd** (),
    ...
    def captured(self, nth: int = ...) -> str:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#captured-1
        ...
        **See also** **capturedRef** (), **capturedView** (), **capturedStart**
        (), **capturedEnd** (), **capturedLength** (), and **QString::isNull**
        ().
        """
        ...
    ...
    def capturedEnd(self, nth: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#capturedEnd-1
    ...
    def capturedLength(self, nth: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#capturedLength-1
    ...
    def capturedRef(self, name: str) -> str:
        ...
        **QStringRef QRegularExpressionMatch::capturedRef(int nth = 0) const**
        ...
        Returns a reference to the substring captured by the **nth** capturing
        group.

        If the **nth** capturing group did not capture a string, or if there is
        no such capturing group, returns a null **QStringRef** .

        **Note:** The implicit capturing group number 0 captures the substring
        matched by the entire pattern.

        **See also** **captured** (), **capturedView** (), **lastCapturedIndex**
    ...
    def capturedRef(self, nth: int = ...) -> str:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#capturedRef-1

        **QStringRef QRegularExpressionMatch::capturedRef(const QString & name )
        const**

        Returns a reference to the string captured by the capturing group named
        **name**.
        ...
        **See also** **captured** (), **capturedView** (), **capturedStart** (),
        **capturedEnd** (), **capturedLength** (), and **QStringRef::isNull**
        ().
        """
        ...
    ...
    def capturedStart(self, nth: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qregularexpressionmatch.html#capturedStart-1
