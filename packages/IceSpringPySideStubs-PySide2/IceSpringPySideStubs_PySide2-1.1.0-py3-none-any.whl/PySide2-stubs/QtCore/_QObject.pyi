...
class QObject(object):
    ...
    **Q_DISABLE_COPY** (), and **Object Trees & Ownership** .
    ...
    def connect(
        ...
        """
        https://doc.qt.io/qt-5/qobject.html#connect-1
    ...
    def connect(
        ...
        **[static] template <typename PointerToMemberFunction, typename Functor>
        ...
        the signal. A function can be connected to a given signal if the signal
        has at least as many argument as the slot. A functor can be connected to
        a signal if they have exactly the same number of arguments. There must
    ...
    def connect(
        ...
        **[static] template <typename PointerToMemberFunction, typename Functor>
        QMetaObject::Connection QObject::connect(const QObject * sender ,
        PointerToMemberFunction signal , const QObject * context , Functor
        functor , Qt::ConnectionType type = Qt::AutoConnection)**
    ...
    def disconnect(
        ...
        """
        https://doc.qt.io/qt-5/qobject.html#disconnect-3
    ...
    def disconnect(
        ...
        """
        https://doc.qt.io/qt-5/qobject.html#disconnect-4
    ...
    @typing.overload
    def findChildren(
        self, arg__1: type, arg__2: PySide2.QtCore.QRegularExpression
    ) -> typing.Iterable:
        """
    ...
    @property
    def destroyed(self) -> PySide2.QtCore.SignalInstance:
        """
