...
class QUrl(object):
    ...
    **Detailed Description**
    ...
    example, the unencoded URL "http://bühler.example.com/List of
    ...
    * When creating a **QString**  to contain a URL from a **QByteArray**  or a
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#QUrl
    ...
    def __init__(self, copy: PySide2.QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#QUrl-1
    ...
    def __init__(self, url: str, mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#QUrl-2
        ...
        **QUrl::QUrl(const QString & url , QUrl::ParsingMode parsingMode =
        ...
        (letters, digits, hyphens, undercores, dots and tildes). All other
    ...
    def adjusted(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#adjusted
    ...
    def authority(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#authority
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#clear
    ...
    def errorString(self) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#errorString
    ...
    def fileName(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#fileName

        **QString QUrl::fileName(QUrl::ComponentFormattingOptions options =
        FullyDecoded) const**
    ...
    def fragment(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#fragment
    ...
    def fromAce(arg__1: PySide2.QtCore.QByteArray) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#fromAce
    ...
    def fromEncoded(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#fromEncoded
    ...
    def fromPercentEncoding(arg__1: PySide2.QtCore.QByteArray) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#fromPercentEncoding
    ...
    def fromStringList(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#fromStringList

        **[static] QList<QUrl> QUrl::fromStringList(const QStringList & urls ,
        QUrl::ParsingMode mode = TolerantMode)**
    ...
    def fromUserInput(userInput: str) -> PySide2.QtCore.QUrl:
        """
        https://doc.qt.io/qt-5/qurl.html#fromUserInput
        ...
        **[static] QUrl QUrl::fromUserInput(const QString & userInput )**
        ...
        be deducted. In the case that is not possible, an invalid **QUrl** () is
        returned.

        Most applications that can browse the web, allow the user to input a URL
        in the form of a plain string. This string can be manually typed into a
        location bar, obtained from the clipboard, or passed in via command line
        arguments.
    ...
    def fromUserInput(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#fromUserInput-1

        **[static] QUrl QUrl::fromUserInput(const QString & userInput , const
        QString & workingDirectory , QUrl::UserInputResolutionOptions options =
        DefaultResolution)**
        ...
        line arguments. If **workingDirectory** is empty, no handling of
        relative paths will be done, so this method will behave like its one
        argument overload.
        ...
        If the application can handle files that don't exist yet, it should pass
        the flag **AssumeLocalFile**  in **options**.
    ...
    def hasFragment(self) -> bool:
        """
        https://doc.qt.io/qt-5/qurl.html#hasFragment
    ...
    def hasQuery(self) -> bool:
        """
        https://doc.qt.io/qt-5/qurl.html#hasQuery
    ...
    def host(self, arg__1: PySide2.QtCore.QUrl.ComponentFormattingOption = ...) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#host
    ...
    def idnWhitelist() -> typing.List:
        """
        https://doc.qt.io/qt-5/qurl.html#idnWhitelist
    ...
    def isEmpty(self) -> bool:
        """
        https://doc.qt.io/qt-5/qurl.html#isEmpty
    ...
    def isLocalFile(self) -> bool:
        """
        https://doc.qt.io/qt-5/qurl.html#isLocalFile
    ...
    def isRelative(self) -> bool:
        """
        https://doc.qt.io/qt-5/qurl.html#isRelative
    ...
    def matches(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#matches

        **bool QUrl::matches(const QUrl & url , QUrl::FormattingOptions options
        ) const**
    ...
    def password(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#password
    ...
    def path(self, options: PySide2.QtCore.QUrl.ComponentFormattingOption = ...) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#path
    ...
    def port(self, defaultPort: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qurl.html#port
    ...
    def query(self, arg__1: PySide2.QtCore.QUrl.ComponentFormattingOption = ...) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#query
    ...
    def resolved(self, relative: PySide2.QtCore.QUrl) -> PySide2.QtCore.QUrl:
        """
        https://doc.qt.io/qt-5/qurl.html#resolved
    ...
    def scheme(self) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#scheme
    ...
    def setAuthority(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#setAuthority
    ...
    def setFragment(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#setFragment
    ...
    def setHost(self, host: str, mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setHost
    ...
    def setIdnWhitelist(arg__1: typing.Sequence) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setIdnWhitelist
    ...
    def setPassword(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#setPassword
    ...
    def setPath(self, path: str, mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setPath
    ...
    def setPort(self, port: int) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setPort
    ...
    def setQuery(self, query: PySide2.QtCore.QUrlQuery) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setQuery
    ...
    def setQuery(self, query: str, mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setQuery-1
    ...
    def setScheme(self, scheme: str) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setScheme
    ...
    def setUrl(self, url: str, mode: PySide2.QtCore.QUrl.ParsingMode = ...) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#setUrl
        ...
        **void QUrl::setUrl(const QString & url , QUrl::ParsingMode parsingMode
        ...
        unreserved character (letters, digits, hyphens, undercores, dots and
    ...
    def setUserName(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#setUserName
    ...
    def swap(self, other: PySide2.QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qurl.html#swap
    ...
    def toAce(arg__1: str) -> PySide2.QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qurl.html#toAce
    ...
    def toDisplayString(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#toDisplayString

        **QString QUrl::toDisplayString(QUrl::FormattingOptions options =
    ...
    def toEncoded(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#toEncoded
    ...
    def toLocalFile(self) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#toLocalFile
    ...
    def toString(self, options: PySide2.QtCore.QUrl.FormattingOptions = ...) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#toString
    ...
    def toStringList(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#toStringList

        **[static] QStringList QUrl::toStringList(const QList<QUrl> & urls ,
        QUrl::FormattingOptions options = FormattingOptions(PrettyDecoded))**
    ...
    def url(self, options: PySide2.QtCore.QUrl.FormattingOptions = ...) -> str:
        """
        https://doc.qt.io/qt-5/qurl.html#url
    ...
    def userInfo(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#userInfo
    ...
    def userName(
        ...
        """
        https://doc.qt.io/qt-5/qurl.html#userName
