...
class QGeoCodingManager(PySide2.QtCore.QObject):
    ...
    **QGeoCodeReply**  objects, which manage these operations and report on the
    ...
    The **geocode** () and **reverseGeocode** () functions can be used to
    convert **QGeoAddress**  instances to **QGeoCoordinate**  instances and
    vice-versa.

    The **geocode** () function is also overloaded to allow a user to perform a
    free text geocoding operation, if the string provided can be interpreted as
    ...
    **QGeoServiceProvider::geocodingManager** ().
    ...
    def geocode(
        ...
        **QGeoCodeReply *QGeoCodingManager::geocode(const QGeoAddress & address
        ...
        This manager and the returned **QGeoCodeReply**  object will emit
        ...
        **address**. This will usually occur if the geocoding service backend
        ...
        If **bounds** is non-null and is a valid **QGeoShape**  it will be used
        to limit the results to those that are contained within **bounds**. This
        is particularly useful if **address** is only partially filled out, as
        the service will attempt to geocode all matches for the specified data.

        The user is responsible for deleting the returned reply object, although
        this can be done in the slot connected to
        **QGeoCodingManager::finished** (), **QGeoCodingManager::error** (),
        **QGeoCodeReply::finished** () or **QGeoCodeReply::error** () with
        **deleteLater** ().
        """
        ...
    ...
    def geocode(
        ...
        """
        https://doc.qt.io/qt-5/qgeocodingmanager.html#geocode-1

        **QGeoCodeReply *QGeoCodingManager::geocode(const QString & address ,
        int limit = -1, int offset = 0, const QGeoShape & bounds =
        QGeoShape())**
        ...
        **QGeoLocation**  objects. These objects represent a combination of
        ...
        limit the results to those that are contained within **bounds**.
    ...
    def reverseGeocode(
        ...
        **QGeoCodeReply *QGeoCodingManager::reverseGeocode(const QGeoCoordinate
        & coordinate , const QGeoShape & bounds = QGeoShape())**
        ...
        **coordinate**. This will usually occur if the reverse geocoding service
        ...
        If **bounds** is non-null and a valid **QGeoRectangle**  it will be used
        to limit the results to those that are contained within **bounds**.
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        ...
        **[signal] void QGeoCodingManager::error(QGeoCodeReply * reply ,
        ...
        of **reply**. The **QGeoCodingManager::finished** () signal will
        probably follow.
