...
class QHelpFilterSettingsWidget(PySide2.QtWidgets.QWidget):
    ...
    **setAvailableVersions** () should be called, otherwise the filter settings
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qhelpfiltersettingswidget.html#QHelpFilterSetting
        sWidget
    ...
    def setAvailableComponents(self, components: typing.Sequence) -> None:
        """
        https://doc.qt.io/qt-5/qhelpfiltersettingswidget.html#setAvailableCompon
        ents
    ...
    def setAvailableVersions(self, versions: typing.Sequence) -> None:
        """
        https://doc.qt.io/qt-5/qhelpfiltersettingswidget.html#setAvailableVersio
        ns
