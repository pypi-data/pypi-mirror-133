...
class QKeySequence(object):
    ...
    **See also** **QShortcut** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qkeysequence.html#QKeySequence-3
    ...
    def __init__(self, ks: PySide2.QtGui.QKeySequence) -> None:
        """
        https://doc.qt.io/qt-5/qkeysequence.html#QKeySequence-4
    ...
    def listFromString(
        ...
        **[static] QList<QKeySequence> QKeySequence::listFromString(const
        QString & str , QKeySequence::SequenceFormat format = PortableText)**
    ...
    def listToString(
        ...
        **[static] QString QKeySequence::listToString(const QList<QKeySequence>
        & list , QKeySequence::SequenceFormat format = PortableText)**
