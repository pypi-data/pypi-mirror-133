...
class QFontInfo(object):
    ...
    **fixedPitch** (), **styleHint** () etc. But whilst the **QFont**  access
    ...
    QFontInfo(widget->**font** ()). If the widget's font is changed later, the
    font info object is **not** updated.
      3. **QPainter::fontInfo** () returns
    the font info for a painter's current font. If the painter's font is changed
    ...
    **See also** **QFont** , **QFontMetrics** , and **QFontDatabase** .
    ...
    def __init__(self, arg__1: PySide2.QtGui.QFontInfo) -> None:
        """
        https://doc.qt.io/qt-5/qfontinfo.html#QFontInfo-1
