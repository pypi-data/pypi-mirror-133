...
class QPointingDeviceUniqueId(object):
    ...
    **Detailed Description**
    ...
    This type actively prevents you from holding it in a **QList** , because
    doing so would be very inefficient. Use a **QVector**  instead, which has
    the same API as **QList** , but more efficient storage.
    ...
    **See also** **QTouchEvent::TouchPoint** .
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qpointingdeviceuniqueid.html#QPointingDeviceUniqu
        eId
