...
class QMatrix(object):
    ...
    **Detailed Description**
    ...
    system, and is typically used when rendering graphics. QMatrix, in contrast
    to **QTransform** , does not allow perspective transformations.
    ...
    **rotate** (), **translate** () and **shear** () functions. Alternatively,
    ...
    The QMatrix class supports mapping of graphic primitives: A given point,
    ...
    **mapToPolygon** () function.
    ...
    QMatrix provides the **isIdentity** () function which returns `true` if the
    matrix is the identity matrix, and the **isInvertible** () function which
    ...
    **inverted** () function returns an inverted copy of **this** matrix if it
    is invertible (otherwise it returns the identity matrix). In addition,
    QMatrix provides the **determinant** () function returning the matrix\'s
    determinant.

    Finally, the QMatrix class supports matrix multiplication, and objects of
    the class can be streamed as well as compared.
    ...
    **QPainter**  painter(this);
    ...
    build a QMatrix and call **QPainter::setMatrix** () if you want to perform
    more than a single transform operation. For example:
    ...
    **Basic Matrix Operations**
    ...
    A QMatrix object contains a 3 x 3 matrix. The `dx` and `dy` elements specify
    horizontal and vertical translation. The `m11` and `m22` elements specify
    horizontal and vertical scaling. And finally, the `m21` and `m12` elements
    specify horizontal and vertical **shearing**.

    QMatrix transforms a point in the plane to another point using the following
    formulas:
    ...
    **m11** (), **m12** (), **m21** (), **m22** (), **dx** () and **dy** ()
    ...
    50%. The identity matrix has `m11` and `m22` set to 1 (all others are set to
    0) mapping a point to itself. Shearing is controlled by `m12` and `m21`.
    ...
    shearing factors and the scaling factors.
    ...
    sin(a);
            ...
            QMatrix
    translationMatrix(1, 0, 0, 1, 50.0, 50.0);
            QMatrix
    rotationMatrix(cosa, sina, -sina, cosa, 0, 0);
            QMatrix
    scalingMatrix(0.5, 0, 0, 1.0, 0, 0);
    ...
    **See also** **QPainter** , **QTransform** , **Coordinate System** ,
    **Affine Transformations Example** , and **Transformations Example** .
    """
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qmatrix.html#QMatrix-2

        **QMatrix::QMatrix(qreal m11 , qreal m12 , qreal m21 , qreal m22 , qreal
        dx , qreal dy )**
    ...
    def __init__(self, other: PySide2.QtGui.QMatrix) -> None:
        """
        https://doc.qt.io/qt-5/qmatrix.html#QMatrix-4
    ...
    def map(self, a: PySide2.QtGui.QPolygon) -> PySide2.QtGui.QPolygon:
        ...
        **void QMatrix::map(qreal x , qreal y , qreal * tx , qreal * ty )
        const**
    ...
    def map(self, a: PySide2.QtGui.QPolygonF) -> PySide2.QtGui.QPolygonF:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-1
    ...
    def map(self, l: PySide2.QtCore.QLine) -> PySide2.QtCore.QLine:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-2
    ...
    def map(self, l: PySide2.QtCore.QLineF) -> PySide2.QtCore.QLineF:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-3
    ...
    def map(self, p: PySide2.QtCore.QPoint) -> PySide2.QtCore.QPoint:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-4
    ...
    def map(self, p: PySide2.QtCore.QPointF) -> PySide2.QtCore.QPointF:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-5
    ...
    def map(self, p: PySide2.QtGui.QPainterPath) -> PySide2.QtGui.QPainterPath:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-6
    ...
    def map(self, r: PySide2.QtGui.QRegion) -> PySide2.QtGui.QRegion:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-7
    ...
    def map(self, x: int, y: int) -> typing.Tuple:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-8
    ...
    def map(self, x: float, y: float) -> typing.Tuple:
        """
        https://doc.qt.io/qt-5/qmatrix.html#map-9
    ...
    def mapRect(self, arg__1: PySide2.QtCore.QRectF) -> PySide2.QtCore.QRectF:
        """
        https://doc.qt.io/qt-5/qmatrix.html#mapRect-1
    ...
    def reset(self) -> None:
        ...
        **void QMatrix::reset()**
        ...
        zero, except `m11` and `m22` (specifying the scale) which are set to 1.

        **See also** **QMatrix** (), **isIdentity** (), and **Basic Matrix
        Operations** .
        """
        ...
    ...
    def setMatrix(
        ...
        **m21** , **m22** , **dx** and **dy**.
        ...
        provide the **translate** (), **rotate** (), **scale** () and **shear**
