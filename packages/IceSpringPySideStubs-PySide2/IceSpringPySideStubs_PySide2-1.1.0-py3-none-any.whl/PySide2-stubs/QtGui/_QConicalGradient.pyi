...
class QConicalGradient(PySide2.QtGui.QGradient):
    ...
    **See also** **QLinearGradient** , **QRadialGradient** , and **The Gradients
    ...
    def __init__(self, QConicalGradient: PySide2.QtGui.QConicalGradient) -> None:
        """
        https://doc.qt.io/qt-5/qconicalgradient.html#QConicalGradient-1
    ...
    def __init__(self, center: PySide2.QtCore.QPointF, startAngle: float) -> None:
        """
        https://doc.qt.io/qt-5/qconicalgradient.html#QConicalGradient-2
    ...
    def setCenter(self, x: float, y: float) -> None:
        """
        https://doc.qt.io/qt-5/qconicalgradient.html#setCenter-1
