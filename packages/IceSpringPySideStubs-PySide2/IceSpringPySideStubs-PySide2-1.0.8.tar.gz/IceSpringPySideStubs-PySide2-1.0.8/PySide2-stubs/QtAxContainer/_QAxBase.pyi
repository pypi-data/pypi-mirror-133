...
class QAxBase(object):
    """
    https://doc.qt.io/qt-5/qaxbase.html
    ...
    **See also** **QAxObject** , **QAxWidget** , **QAxScript** , and **ActiveQt
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#QAxBase

        **QAxBase::QAxBase(IUnknown * iface = nullptr)**

        Creates a QAxBase object that wraps the COM object **iface**. If
    ...
    def asVariant(self) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qaxbase.html#asVariant
    ...
    def classContext(self) -> int:
        """
        https://doc.qt.io/qt-5/qaxbase.html#classContext
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#clear
    ...
    def control(self) -> str:
        """
        https://doc.qt.io/qt-5/qaxbase.html#control-prop

        **control : QString**

        This property holds the name of the COM object wrapped by this
        **QAxBase**  object.
        ...
        * To initialize the control on a different machine use the following
        pattern:
                ...
                <domain/username>:<password>@server/{8E27C92B-1264
        -101C-8A2F-040224009C02}

          * To initialize a licensed control use the
        following pattern:
        {8E27C92B-1264-101C-8A2F-040224009C02}:<LicenseKey>

          * To connect to
        an already running object use the following pattern:
        {8E27C92B-1264-101C-8A2F-040224009C02}&

        The first two patterns can be combined, e.g. to initialize a licensed
        control on a remote machine:

        ctrl->setControl("DOMAIN/user:password@server/{8E27C92B-1264-101C-8A2F-0
        40224009C02}:LicenseKey");
    ...
    def disableClassInfo(self) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#disableClassInfo
    ...
    def disableEventSink(self) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#disableEventSink
    ...
    def disableMetaObject(self) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#disableMetaObject
    ...
    def dynamicCall(
        ...
        """
        https://doc.qt.io/qt-5/qaxbase.html#dynamicCall
        ...
        **QObject::property** () and **QObject::setProperty** ().
        ...
        automation process. **ActiveQt**  will then however not validate
        parameters.
    ...
    def generateDocumentation(self) -> str:
        """
        https://doc.qt.io/qt-5/qaxbase.html#generateDocumentation
    ...
    def isNull(self) -> bool:
        """
        https://doc.qt.io/qt-5/qaxbase.html#isNull
    ...
    def propertyBag(self) -> typing.Dict:
        """
        https://doc.qt.io/qt-5/qaxbase.html#propertyBag
    ...
    def propertyWritable(self, arg__1: bytes) -> bool:
        """
        https://doc.qt.io/qt-5/qaxbase.html#propertyWritable
    ...
    def querySubObject(
        ...
        """
        https://doc.qt.io/qt-5/qaxbase.html#querySubObject
    ...
    def querySubObject(
        ...
        """
        https://doc.qt.io/qt-5/qaxbase.html#querySubObject-1
    ...
    def setClassContext(self, classContext: int) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#setClassContext
    ...
    def setPropertyBag(self, arg__1: typing.Dict) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#setPropertyBag
    ...
    def setPropertyWritable(self, arg__1: bytes, arg__2: bool) -> None:
        """
        https://doc.qt.io/qt-5/qaxbase.html#setPropertyWritable
    ...
    def verbs(self) -> typing.List:
        """
        https://doc.qt.io/qt-5/qaxbase.html#verbs
    ...
    @property
    def exception(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qaxbase.html#exception

        **[signal] void QAxBase::exception(int code , const QString & source ,
    ...
    @property
    def propertyChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qaxbase.html#propertyChanged
    ...
    def signal(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qaxbase.html#signal

        **[signal] void QAxBase::signal(const QString & name , int argc , void *
        argv )**
