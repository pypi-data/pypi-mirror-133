...
class QSoundEffect(PySide2.QtCore.QObject):
    ...
    **QSoundEffect**  effect;
    ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qsoundeffect.html#QSoundEffect-1

        **QSoundEffect::QSoundEffect(const QAudioDeviceInfo & audioDevice ,
    ...
    def setCategory(self, category: str) -> None:
        ...
        **void QSoundEffect::setCategory(const QString & category )**
        ...
        If this setting is changed while a sound effect is playing it will only
        take effect when the sound effect has stopped playing.
