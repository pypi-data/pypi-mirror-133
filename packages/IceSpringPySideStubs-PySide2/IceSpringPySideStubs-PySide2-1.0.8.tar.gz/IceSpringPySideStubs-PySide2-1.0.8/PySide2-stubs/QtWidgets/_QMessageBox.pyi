...
class QMessageBox(PySide2.QtWidgets.QDialog):
    ...
    **Standard Dialogs Example** , and **Application Example** .
    ...
    def addButton(
        ...
        role: PySide2.QtWidgets.QMessageBox.ButtonRole,
    ) -> None:
        """
    ...
    @typing.overload
    def addButton(
        self, button: PySide2.QtWidgets.QMessageBox.StandardButton
    ...
    @typing.overload
    def addButton(
        self, text: str, role: PySide2.QtWidgets.QMessageBox.ButtonRole
    ) -> PySide2.QtWidgets.QPushButton:
        """
    ...
    def button(
        self, which: PySide2.QtWidgets.QMessageBox.StandardButton
    ...
    def critical(
        ...
        title: str,
        text: str,
        button0: PySide2.QtWidgets.QMessageBox.StandardButton,
        button1: PySide2.QtWidgets.QMessageBox.StandardButton,
    ) -> int:
        """
    ...
    def critical(
        ...
        text: str,
        buttons: PySide2.QtWidgets.QMessageBox.StandardButtons = ...,
        defaultButton: PySide2.QtWidgets.QMessageBox.StandardButton = ...,
