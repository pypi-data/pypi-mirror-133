...
class QOpenGLWindow(PySide2.QtGui.QPaintDeviceWindow):
    ...
    **QOpenGLWidget**  and is similar to the legacy QGLWidget. Unlike
    **QOpenGLWidget** , QOpenGLWindow has no dependency on the widgets module
    ...
    **resizeGL** () to set up the transformation matrices and other window size
    ...
    `NoPartialUpdate` is equivalent to a regular, OpenGL-based **QWindow**  or
    the legacy QGLWidget. In contrast, `PartialUpdateBlit` and
    `PartialUpdateBlend` are more in line with **QOpenGLWidget** 's way of
    working, where there is always an extra, dedicated framebuffer object
    present. These modes allow, by sacrificing some performance, redrawing only
    a smaller area on each paint and having the rest of the content preserved
    from of the previous frame. This is useful for applications than render
    incrementally using **QPainter** , because this way they do not have to
    redraw the entire window content on each **paintGL** () call.
    ...
    **Qt::AA_ShareOpenGLContexts**  attribute. When enabled, the OpenGL contexts
    ...
    def __init__(
        self,
        shareContext: PySide2.QtGui.QOpenGLContext,
        updateBehavior: PySide2.QtGui.QOpenGLWindow.UpdateBehavior = ...,
        parent: typing.Optional[PySide2.QtGui.QWindow] = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#QOpenGLWindow
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#QOpenGLWindow-1
    ...
    def context(self) -> PySide2.QtGui.QOpenGLContext:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#context
    ...
    def defaultFramebufferObject(self) -> int:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#defaultFramebufferObject
    ...
    def doneCurrent(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#doneCurrent
    ...
    def grabFramebuffer(self) -> PySide2.QtGui.QImage:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#grabFramebuffer
    ...
    def initializeGL(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#initializeGL
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#isValid
    ...
    def makeCurrent(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#makeCurrent
    ...
    def paintEvent(self, event: PySide2.QtGui.QPaintEvent) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#paintEvent
    ...
    def paintGL(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#paintGL
    ...
    def paintOverGL(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#paintOverGL
    ...
    def paintUnderGL(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#paintUnderGL
    ...
    def resizeEvent(self, event: PySide2.QtGui.QResizeEvent) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#resizeEvent
    ...
    def resizeGL(self, w: int, h: int) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#resizeGL
    ...
    def shareContext(self) -> PySide2.QtGui.QOpenGLContext:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#shareContext
    ...
    def updateBehavior(self) -> PySide2.QtGui.QOpenGLWindow.UpdateBehavior:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#updateBehavior
    ...
    def frameSwapped(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qopenglwindow.html#frameSwapped
