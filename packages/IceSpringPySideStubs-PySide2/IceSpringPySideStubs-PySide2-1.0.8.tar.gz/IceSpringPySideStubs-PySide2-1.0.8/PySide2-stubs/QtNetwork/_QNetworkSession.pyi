...
class QNetworkSession(PySide2.QtCore.QObject):
    ...
    **See also** **QNetworkConfiguration**  and **QNetworkConfigurationManager**
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qnetworksession.html#error-1

        **[signal] void QNetworkSession::error(QNetworkSession::SessionError
        error )**
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(networkSession, QOverload<**QNetworkSession**
        ::SessionError>::of(&**QNetworkSession** ::error),
