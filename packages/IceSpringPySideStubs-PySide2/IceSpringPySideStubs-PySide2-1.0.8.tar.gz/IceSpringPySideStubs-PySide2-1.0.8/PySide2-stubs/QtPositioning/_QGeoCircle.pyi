...
class QGeoCircle(PySide2.QtPositioning.QGeoShape):
    ...
    **Detailed Description**
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qgeocircle.html#QGeoCircle-1
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoCircle) -> None:
        """
        https://doc.qt.io/qt-5/qgeocircle.html#QGeoCircle-2
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoShape) -> None:
        """
        https://doc.qt.io/qt-5/qgeocircle.html#QGeoCircle-3
    ...
    def translate(self, degreesLatitude: float, degreesLongitude: float) -> None:
        ...
        **void QGeoCircle::translate(double degreesLatitude , double
        degreesLongitude )**
    ...
    def translated(
        ...
        **QGeoCircle QGeoCircle::translated(double degreesLatitude , double
