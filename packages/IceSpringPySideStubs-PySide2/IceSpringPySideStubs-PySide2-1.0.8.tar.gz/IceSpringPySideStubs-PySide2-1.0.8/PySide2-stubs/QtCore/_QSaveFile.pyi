...
class QSaveFile(PySide2.QtCore.QFileDevice):
    ...
    **QFile** , and **QTemporaryFile** .
    ...
    def __init__(self, name: str) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#QSaveFile
    ...
    def __init__(self, name: str, parent: PySide2.QtCore.QObject) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#QSaveFile-1
    ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#QSaveFile-2
    ...
    def cancelWriting(self) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#cancelWriting
    ...
    def commit(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsavefile.html#commit
    ...
    def directWriteFallback(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsavefile.html#directWriteFallback
    ...
    def fileName(self) -> str:
        """
        https://doc.qt.io/qt-5/qsavefile.html#fileName
    ...
    def open(self, flags: PySide2.QtCore.QIODevice.OpenMode) -> bool:
        """
        https://doc.qt.io/qt-5/qsavefile.html#open
        ...
        **[override virtual] bool QSaveFile::open(QIODevice::OpenMode mode )**
        ...
        Important: the **mode** must include **QIODevice::WriteOnly** . It may
        also have additional flags, such as **QIODevice::Text**  and
        **QIODevice::Unbuffered** .

        **QIODevice::ReadWrite** , **QIODevice::Append** ,
        **QIODevice::NewOnly**  and **QIODevice::ExistingOnly**  are not
    ...
    def setDirectWriteFallback(self, enabled: bool) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#setDirectWriteFallback
    ...
    def setFileName(self, name: str) -> None:
        """
        https://doc.qt.io/qt-5/qsavefile.html#setFileName
    ...
    def writeData(self, data: bytes, len: int) -> int:
        """
        https://doc.qt.io/qt-5/qsavefile.html#writeData
