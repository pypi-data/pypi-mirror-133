...
class QXmlStreamReader(object):
    ...
    **QStringRef**  rather than real **QString**  objects. **QStringRef**  is a
    thin wrapper around **QString**  substrings that provides a subset of the
    **QString**  API without the memory allocation and reference-counting
    overhead. Calling **toString()**  on any of those objects returns an
    equivalent real **QString**  object.
    """
    ...
    def __init__(self, data: PySide2.QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#QXmlStreamReader-1
    ...
    def __init__(self, data: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#QXmlStreamReader-2
    ...
    def __init__(self, data: bytes) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#QXmlStreamReader-3

        **QXmlStreamReader::QXmlStreamReader(const QString & data )**

        Creates a new stream reader that reads from **data**.

        This function should only be used if the XML header either says the
        encoding is "UTF-8" or lacks any encoding information (the latter is the
        case of **QXmlStreamWriter**  writing to a **QString** ). Any other
        encoding is likely going to cause data corruption ("mojibake").
    ...
    def __init__(self, device: PySide2.QtCore.QIODevice) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#QXmlStreamReader-4
    ...
    def addData(self, data: str) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#addData-1
    ...
    def addData(self, data: bytes) -> None:
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#addData-2
    ...
    def addExtraNamespaceDeclaration(
        ...
        """
        https://doc.qt.io/qt-5/qxmlstreamreader.html#addExtraNamespaceDeclaratio
        n
    ...
    def entityDeclarations(self) -> typing.List:
        ...
        **QXmlStreamEntityDeclarations QXmlStreamReader::entityDeclarations()
        ...
        The **QXmlStreamEntityDeclarations**  class is defined to be a
        **QVector**  of **QXmlStreamEntityDeclaration** .
        """
        ...
    ...
    def namespaceDeclarations(self) -> typing.List:
        ...
        **QVector**  of **QXmlStreamNamespaceDeclaration** .
    ...
    def notationDeclarations(self) -> typing.List:
        ...
        **QVector**  of **QXmlStreamNotationDeclaration** .
        """
        ...
