...
class QCalendarWidget(PySide2.QtWidgets.QWidget):
    ...
    **See also** **QDate** , **QDateEdit** , and **QTextCharFormat** .
    ...
    NoHorizontalHeader: QCalendarWidget = ...
    NoSelection: QCalendarWidget = ...
    NoVerticalHeader: QCalendarWidget = ...
    ISOWeekNumbers: QCalendarWidget = ...
    SingleLetterDayNames: QCalendarWidget = ...
    SingleSelection: QCalendarWidget = ...
    ShortDayNames: QCalendarWidget = ...
    LongDayNames: QCalendarWidget = ...
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#QCalendarWidget
    ...
    def dateEditAcceptDelay(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#dateEditAcceptDelay-prop
        ...
        **dateEditAcceptDelay : int**
        ...
        open after the most recent user input. Once this time has elapsed, the
        date specified in the date edit is accepted and the popup is closed.
    ...
    def dateTextFormat(self) -> typing.Dict:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#dateTextFormat
    ...
    def dateTextFormat(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#dateTextFormat-1
    ...
    def event(self, event: PySide2.QtCore.QEvent) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#event
    ...
    def eventFilter(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#eventFilter
    ...
    def firstDayOfWeek(self) -> PySide2.QtCore.Qt.DayOfWeek:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#firstDayOfWeek-prop
    ...
    def headerTextFormat(self) -> PySide2.QtGui.QTextCharFormat:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#headerTextFormat
    ...
    def horizontalHeaderFormat(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#horizontalHeaderFormat-prop
    ...
    def keyPressEvent(self, event: PySide2.QtGui.QKeyEvent) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#keyPressEvent
    ...
    def maximumDate(self) -> PySide2.QtCore.QDate:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#maximumDate-prop
    ...
    def minimumDate(self) -> PySide2.QtCore.QDate:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#minimumDate-prop
    ...
    def minimumSizeHint(self) -> PySide2.QtCore.QSize:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#minimumSizeHint
    ...
    def monthShown(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#monthShown
    ...
    def mousePressEvent(self, event: PySide2.QtGui.QMouseEvent) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#mousePressEvent
    ...
    def paintCell(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#paintCell
    ...
    def resizeEvent(self, event: PySide2.QtGui.QResizeEvent) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#resizeEvent
    ...
    def selectedDate(self) -> PySide2.QtCore.QDate:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#selectedDate-prop
    ...
    def selectionMode(self) -> PySide2.QtWidgets.QCalendarWidget.SelectionMode:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#selectionMode-prop
    ...
    def setCurrentPage(self, year: int, month: int) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#setCurrentPage
    ...
    def setDateEditEnabled(self, enable: bool) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#dateEditEnabled-prop
    ...
    def setDateRange(
        ...
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#setDateRange

        **[slot] void QCalendarWidget::setDateRange(const QDate & min , const
        QDate & max )**
    ...
    def setDateTextFormat(
        self, date: PySide2.QtCore.QDate, format: PySide2.QtGui.QTextCharFormat
    ) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#setDateTextFormat

        **void QCalendarWidget::setDateTextFormat(const QDate & date , const
    ...
    def setGridVisible(self, show: bool) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#gridVisible-prop
    ...
    def setHorizontalHeaderFormat(
        self, format: PySide2.QtWidgets.QCalendarWidget.HorizontalHeaderFormat
    ) -> None:
        ...
    ...
    def setNavigationBarVisible(self, visible: bool) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#navigationBarVisible-prop
    ...
    def setSelectionMode(
        self, mode: PySide2.QtWidgets.QCalendarWidget.SelectionMode
    ) -> None:
        ...

    def setVerticalHeaderFormat(
        self, format: PySide2.QtWidgets.QCalendarWidget.VerticalHeaderFormat
    ) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#verticalHeaderFormat-prop
    ...
    def setWeekdayTextFormat(
        self,
        dayOfWeek: PySide2.QtCore.Qt.DayOfWeek,
        format: PySide2.QtGui.QTextCharFormat,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#setWeekdayTextFormat
    ...
    def showNextMonth(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showNextMonth
    ...
    def showNextYear(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showNextYear
    ...
    def showPreviousMonth(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showPreviousMonth
    ...
    def showPreviousYear(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showPreviousYear
    ...
    def showSelectedDate(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showSelectedDate
    ...
    def showToday(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#showToday
    ...
    def sizeHint(self) -> PySide2.QtCore.QSize:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#sizeHint
    ...
    def updateCell(self, date: PySide2.QtCore.QDate) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#updateCell
    ...
    def updateCells(self) -> None:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#updateCells
    ...
    def weekdayTextFormat(
        self, dayOfWeek: PySide2.QtCore.Qt.DayOfWeek
    ) -> PySide2.QtGui.QTextCharFormat:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#weekdayTextFormat
    ...
    def yearShown(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#yearShown
    ...
    def clicked(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#clicked
    ...
    @property
    def currentPageChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#currentPageChanged
    ...
    def selectionChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qcalendarwidget.html#selectionChanged
