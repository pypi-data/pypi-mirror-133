...
class QOpenGLWidget(PySide2.QtWidgets.QWidget):
    ...
    **Relation to QGLWidget**
    ...
    two: QOpenGLWidget always renders offscreen, using framebuffer objects.
    QGLWidget on the other hand uses a native window and surface. The latter
    causes issues when using it in complex user interfaces since, depending on
    the platform, such native child widgets may have various limitations,
    ...
    leaves the back buffer with undefined contents.

    **Note:** Most applications do not need incremental rendering because they
    will render everything in the view on every paint call. In this case it is
    important to call glClear() as early as possible in **paintGL** (). This
    ...
    **Note:** Avoid calling **winId** () on a QOpenGLWidget. This function
    triggers the creation of a native window, resulting in reduced performance
    and possibly rendering glitches.

    **Differences to QGLWidget**

    Besides the main conceptual difference of being backed by a framebuffer
    object, there are a number of smaller, internal differences between
    QOpenGLWidget and the older QGLWidget:

    * OpenGL state when invoking **paintGL** (). QOpenGLWidget sets up the
    viewport via glViewport(). It does not perform any clearing.
      * Clearing
    when starting to paint via **QPainter** . Unlike regular widgets, QGLWidget
    defaulted to a value of `true` for **autoFillBackground** . It then
    performed clearing to the palette\'s background color every time
    **QPainter::begin** () was used. QOpenGLWidget does not follow this:
    **autoFillBackground**  defaults to false, like for any other widget. The
    only exception is when being used as a viewport for other widgets like
    **QGraphicsView** . In such a case **autoFillBackground**  will be
    automatically set to true to ensure compatibility with QGLWidget-based
    viewports.
    ...
    **Threading**
    ...
    thread. When a thread is done updating the framebuffer, call **update** ()
    **on the GUI/main thread** to schedule composition.
    ...
    **Context Sharing**
    ...
    "global share" context, as was the case with QGLWidget.
    ...
    **Qt::AA_ShareOpenGLContexts** , and **UpdateBehavior** .
    ...
    NoPartialUpdate: QOpenGLWidget = ...
    PartialUpdate: QOpenGLWidget = ...
    ...
    def context(self) -> PySide2.QtGui.QOpenGLContext:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#context
    ...
    def defaultFramebufferObject(self) -> int:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#defaultFramebufferObject
    ...
    def doneCurrent(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#doneCurrent
    ...
    def event(self, e: PySide2.QtCore.QEvent) -> bool:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#event
    ...
    def format(self) -> PySide2.QtGui.QSurfaceFormat:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#format
    ...
    def grabFramebuffer(self) -> PySide2.QtGui.QImage:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#grabFramebuffer
    ...
    def initializeGL(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#initializeGL
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#isValid
    ...
    def makeCurrent(self) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#makeCurrent
    ...
    def metric(self, metric: PySide2.QtGui.QPaintDevice.PaintDeviceMetric) -> int:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#metric
    ...
    def paintEngine(self) -> PySide2.QtGui.QPaintEngine:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#paintEngine
    ...
    def paintEvent(self, e: PySide2.QtGui.QPaintEvent) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#paintEvent
    ...
    def redirected(self, p: PySide2.QtCore.QPoint) -> PySide2.QtGui.QPaintDevice:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#redirected
    ...
    def resizeGL(self, w: int, h: int) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#resizeGL
    ...
    def setTextureFormat(self, texFormat: int) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#setTextureFormat
    ...
    def setUpdateBehavior(
        self, updateBehavior: PySide2.QtWidgets.QOpenGLWidget.UpdateBehavior
    ) -> None:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#setUpdateBehavior

        **void QOpenGLWidget::setUpdateBehavior(QOpenGLWidget::UpdateBehavior
        updateBehavior )**
    ...
    def textureFormat(self) -> int:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#textureFormat
    ...
    def updateBehavior(self) -> PySide2.QtWidgets.QOpenGLWidget.UpdateBehavior:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#updateBehavior
    ...
    @property
    def aboutToCompose(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#aboutToCompose
    ...
    @property
    def aboutToResize(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#aboutToResize
    ...
    def frameSwapped(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#frameSwapped
    ...
    def resized(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qopenglwidget.html#resized
