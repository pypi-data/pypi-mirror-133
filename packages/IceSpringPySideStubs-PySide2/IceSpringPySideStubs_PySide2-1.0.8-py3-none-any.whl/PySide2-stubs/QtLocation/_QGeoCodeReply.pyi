...
class QGeoCodeReply(PySide2.QtCore.QObject):
    ...
    **isFinished** () before making the connections to the signals. The
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qgeocodereply.html#error-1

        **[signal] void QGeoCodeReply::error(QGeoCodeReply::Error error , const
        ...
        **errorString** is not empty it will contain a textual description of
        ...
        This signal and **QGeoCodingManager::error** () will be emitted at the
        same time.
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(geoCodeReply, QOverload<**QGeoCodeReply** ::Error, const
        **QString**  &>::of(&**QGeoCodeReply** ::error),
