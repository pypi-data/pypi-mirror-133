    ...
    **QGeoAreaMonitorSource** ::createSource("blah", this);
    ...
    def activeMonitors(self) -> typing.List:
        ...
        **QGeoAreaMonitorSource**  object.
        ...
        An active monitor was started via **startMonitoring** () the source
        object will emit the required signals such as **areaEntered** () or
        **areaExited** (). Multiple **QGeoAreaMonitorSource**  instances within
        the same application share the same active monitor objects.
    ...
    def activeMonitors(
        ...
        """
        https://doc.qt.io/qt-5/qgeoareamonitorsource.html#activeMonitors-1
        ...
        **lookupArea**. If **lookupArea** is empty the returned list will be
        ...
        An active monitor was started via **startMonitoring** () and the source
        object will emit the required signals such as **areaEntered** () or
        **areaExited** (). Multiple **QGeoAreaMonitorSource**  instances within
        the same application share the same monitor objects.
    ...
    def createDefaultSource(
        ...
        *QGeoAreaMonitorSource::createDefaultSource(QObject * parent )**
        ...
        Creates and returns a monitor with the given **parent** that monitors
        areas using resources on the underlying system.
    ...
    def createSource(
        ...
        *QGeoAreaMonitorSource::createSource(const QString & sourceName ,
        ...
        Creates and returns a monitor with the given **parent** , by loading the
    ...
    def positionInfoSource(self) -> PySide2.QtPositioning.QGeoPositionInfoSource:
        ...
        **QGeoPositionInfoSource::createDefaultSource** () if no other object
        ...
        The function returns 0 if not even a default **QGeoPositionInfoSource**
        exists.
    ...
    def supportedAreaMonitorFeatures(
        ...
        """
        https://doc.qt.io/qt-5/qgeoareamonitorsource.html#supportedAreaMonitorFe
        atures
    ...
    def error(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qgeoareamonitorsource.html#error-1

        **[signal] void
        QGeoAreaMonitorSource::error(QGeoAreaMonitorSource::Error
        areaMonitoringError )**
        ...
        **Note:** Signal **error** is overloaded in this class. To connect to
        ...
        connect(geoAreaMonitorSource, QOverload<**QGeoAreaMonitorSource**
        ::Error>::of(&**QGeoAreaMonitorSource** ::error),
