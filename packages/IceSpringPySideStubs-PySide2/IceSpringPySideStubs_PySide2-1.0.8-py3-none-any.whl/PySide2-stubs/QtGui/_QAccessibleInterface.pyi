    ...
    **QAccessibleTableInterface** .
    ...
    def childAt(self, x: int, y: int) -> PySide2.QtGui.QAccessibleInterface:
        ...
        **[pure virtual] QAccessibleInterface *QAccessibleInterface::childAt(int
        ...
        This function is only relyable for visible objects (invisible object
    ...
    def relations(self, match: PySide2.QtGui.QAccessible.Relation = ...) -> typing.List:
        ...
        **[virtual] QVector<QPair<QAccessibleInterface *, QAccessible::Relation>
        ...
        It is possible to filter the relations by using **match**. It should
        never return itself.
