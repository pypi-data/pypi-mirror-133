...
class QAccessible(object):
    ...
    * **AT Servers** notify the clients about events through calls to the
    updateAccessibility() function.
      * **AT Clients** request information about
    the objects in the server. The **QAccessibleInterface**  class is the core
    interface, and encapsulates this information in a pure virtual API.
