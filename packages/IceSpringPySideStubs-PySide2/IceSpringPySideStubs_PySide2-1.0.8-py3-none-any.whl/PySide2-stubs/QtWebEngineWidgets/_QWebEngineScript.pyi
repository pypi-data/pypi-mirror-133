...
class QWebEngineScript(object):
    ...
    **See also** **Script Injection** .
    ...
    def __init__(self, other: PySide2.QtWebEngineWidgets.QWebEngineScript) -> None:
        """
        https://doc.qt.io/qt-5/qwebenginescript.html#QWebEngineScript-1
    ...
    def name(self) -> str:
        ...
        **See also** **setName** (), **QWebEngineScriptCollection::findScript**
        (), and **QWebEngineScriptCollection::findScripts** ().
        """
        ...
