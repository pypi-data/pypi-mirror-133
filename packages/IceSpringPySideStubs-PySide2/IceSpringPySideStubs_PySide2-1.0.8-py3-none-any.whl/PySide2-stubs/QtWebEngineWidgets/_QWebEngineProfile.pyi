...
class QWebEngineProfile(PySide2.QtCore.QObject):
    ...
    **setSpellCheckEnabled** () method and the current languages used for
    ...
    def __init__(self, parent: typing.Optional[PySide2.QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qwebengineprofile.html#QWebEngineProfile-1
    ...
    def installUrlSchemeHandler(
        ...
        **void QWebEngineProfile::installUrlSchemeHandler(const QByteArray &
    ...
    def isUsedForGlobalCertificateVerification(self) -> bool:
        """
        https://doc.qt.io/qt-5/qwebengineprofile.html#isUsedForGlobalCertificate
        Verification

        **bool QWebEngineProfile::isUsedForGlobalCertificateVerification()
        const**

        Returns `true` if this profile is currently being used for global
    ...
    def setHttpAcceptLanguage(self, httpAcceptLanguage: str) -> None:
        ...
        **void QWebEngineProfile::setHttpAcceptLanguage(const QString &
        httpAcceptLanguage )**
    ...
    def setSpellCheckLanguages(self, languages: typing.Sequence) -> None:
        ...
        **void QWebEngineProfile::setSpellCheckLanguages(const QStringList &
        languages )**
    ...
    def setUrlRequestInterceptor(
        ...
        **void QWebEngineProfile::setUrlRequestInterceptor(QWebEngineUrlRequestI
    ...
    def setUseForGlobalCertificateVerification(self, enabled: bool = ...) -> None:
        """
        https://doc.qt.io/qt-5/qwebengineprofile.html#setUseForGlobalCertificate
        Verification

        **void QWebEngineProfile::setUseForGlobalCertificateVerification(bool
        enabled = true)**

        Sets if this profile is to be used for downloading and caching when
        needed during certificate verification, for instance for OCSP, CRLs, and
        AIA.

        Only one **QWebEngineProfile**  can do this at a time, and it is
        recommended that the profile fullfilling this role has a disk HTTP cache
        to avoid needlessly re-downloading. If you set the option on a second
        profile, it will be disabled on the profile it is currently set.

        Currently only affects Linux/NSS installations where it enables OCSP.

        As long as one profile has **enabled** set to `true`, all other profiles
        will be able to use it for their certificate verification.

        This function was introduced in Qt 5.13.

        **See also** **isUsedForGlobalCertificateVerification** () and
        **httpCacheType** ().
        """
        ...
    ...
    def urlSchemeHandler(
        ...
        **const QWebEngineUrlSchemeHandler
    ...
    def downloadRequested(self) -> PySide2.QtCore.SignalInstance:
        ...
        **download** argument holds the state of the download. The download has
        to be explicitly accepted with **QWebEngineDownloadItem::accept** () or
        ...
        **See also** **QWebEngineDownloadItem**  and
