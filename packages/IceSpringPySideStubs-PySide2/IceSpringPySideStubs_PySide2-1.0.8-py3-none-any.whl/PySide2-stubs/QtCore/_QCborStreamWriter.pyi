...
class QCborStreamWriter(object):
    """
    ...
    **QXmlStreamWriter** .
    ...
    def append(self, str: bytes, size: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#append-7
    ...
    def append(self, tag: PySide2.QtCore.QCborKnownTags) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#append-8
    ...
    def append(self, u: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#append-9
    ...
    def append(self, u: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#append-10
    ...
    def appendByteString(self, data: bytes, len: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#appendByteString
    ...
    def appendTextString(self, utf8: bytes, len: int) -> None:
        """
        https://doc.qt.io/qt-5/qcborstreamwriter.html#appendTextString
