...
class QSortFilterProxyModel(PySide2.QtCore.QAbstractProxyModel):
    ...
    **See also** **QAbstractProxyModel** , **QAbstractItemModel** , **Model/View Programming** , **Basic Sort/Filter Model Example** , **Custom Sort/Filter Model Example** , and **QIdentityProxyModel** .
    ...
    def filterRegularExpression(self) -> PySide2.QtCore.QRegularExpression:
        """
        https://doc.qt.io/qt-5/qsortfilterproxymodel.html#filterRegularExpression-prop
    ...
    def lessThan(
        ...
        * **QMetaType::Int**
        ...
        By default, the **Qt::DisplayRole**  associated with the **QModelIndex** es is used for comparisons. This can be changed by setting the **sortRole**  property.
    ...
    def setFilterRegExp(self, pattern: str) -> None:
        ...
        **See also** **setFilterCaseSensitivity** (), **setFilterWildcard** (), **setFilterFixedString** (), and **filterRegExp** ().
        """
        ...
    ...
    def setSortCaseSensitivity(self, cs: PySide2.QtCore.Qt.CaseSensitivity) -> None:
        """
        https://doc.qt.io/qt-5/qsortfilterproxymodel.html#sortCaseSensitivity-prop
    ...
    @property
    def filterCaseSensitivityChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qsortfilterproxymodel.html#filterCaseSensitivityChanged
    ...
    @property
    def filterRoleChanged(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def recursiveFilteringEnabledChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qsortfilterproxymodel.html#recursiveFilteringEnabledChanged
    ...
    @property
    def sortCaseSensitivityChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qsortfilterproxymodel.html#sortCaseSensitivityChanged
    ...
    @property
    def sortLocaleAwareChanged(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def sortRoleChanged(self) -> PySide2.QtCore.SignalInstance:
        """
