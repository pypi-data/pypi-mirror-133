...
class QDir(object):
    ...
    **See also** **QFileInfo** , **QFile** , **QFileDialog** , **QCoreApplication::applicationDirPath** (), and **Find Files Example** .
    ...
    def isAbsolutePath(path: str) -> bool:
        ...
        **Note:** If **path** starts with ':', this function will return `true` because paths starting with ':' are treated specially as they denote a **QResource** .

        **See also** **isAbsolute** (), **isRelativePath** (), **makeAbsolute** (), **cleanPath** (), and **QResource** .
        """
        ...
