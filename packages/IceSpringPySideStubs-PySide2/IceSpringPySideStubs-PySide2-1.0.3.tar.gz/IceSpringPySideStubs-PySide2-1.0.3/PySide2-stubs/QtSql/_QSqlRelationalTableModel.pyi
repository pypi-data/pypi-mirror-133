...
class QSqlRelationalTableModel(PySide2.QtSql.QSqlTableModel):
    ...
    **See also** **QSqlRelation** , **QSqlRelationalDelegate** , and **Relational Table Model Example** .
    ...
    InnerJoin: QSqlRelationalTableModel = ...
    LeftJoin: QSqlRelationalTableModel = ...
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#QSqlRelationalTableModel

        **QSqlRelationalTableModel::QSqlRelationalTableModel(QObject * parent = nullptr, QSqlDatabase db = QSqlDatabase())**
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#clear
    ...
    def data(self, item: PySide2.QtCore.QModelIndex, role: int = ...) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#data
    ...
    def insertRowIntoTable(self, values: PySide2.QtSql.QSqlRecord) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#insertRowIntoTable
    ...
    def orderByClause(self) -> str:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#orderByClause
    ...
    def relation(self, column: int) -> PySide2.QtSql.QSqlRelation:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#relation
    ...
    def relationModel(self, column: int) -> PySide2.QtSql.QSqlTableModel:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#relationModel
    ...
    def removeColumns(
        ...
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#removeColumns
    ...
    def revertRow(self, row: int) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#revertRow
    ...
    def select(self) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#select
    ...
    def selectStatement(self) -> str:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#selectStatement
    ...
    def setData(
        self, item: PySide2.QtCore.QModelIndex, value: typing.Any, role: int = ...
    ) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#setData
    ...
    def setJoinMode(
        self, joinMode: PySide2.QtSql.QSqlRelationalTableModel.JoinMode
    ) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#setJoinMode
    ...
    def setRelation(self, column: int, relation: PySide2.QtSql.QSqlRelation) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#setRelation
    ...
    def setTable(self, tableName: str) -> None:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#setTable
    ...
    def updateRowInTable(self, row: int, values: PySide2.QtSql.QSqlRecord) -> bool:
        """
        https://doc.qt.io/qt-5/qsqlrelationaltablemodel.html#updateRowInTable
