...
class QOpenGLFunctions_1_3(PySide2.QtGui.QAbstractOpenGLFunctions):
    """
    https://doc.qt.io/qt-5/qopenglfunctions-1-3.html

    **Detailed Description**

    This class is a wrapper for functions from OpenGL 1.3 specification. See reference pages on **opengl.org**  for function documentation.
