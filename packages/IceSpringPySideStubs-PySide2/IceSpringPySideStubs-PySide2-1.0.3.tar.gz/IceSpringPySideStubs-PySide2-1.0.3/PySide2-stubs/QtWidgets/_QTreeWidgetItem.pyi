...
class QTreeWidgetItem(object):
    ...
    **See also** **QTreeWidget** , **QTreeWidgetItemIterator** , **Model/View Programming** , **QListWidgetItem** , and **QTableWidgetItem** .
    ...
    @typing.overload
    def __init__(
        self, parent: PySide2.QtWidgets.QTreeWidgetItem, type: int = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qtreewidgetitem.html#QTreeWidgetItem
    ...
    def __init__(
        self,
        treeview: PySide2.QtWidgets.QTreeWidget,
        after: PySide2.QtWidgets.QTreeWidgetItem,
        type: int = ...,
    ) -> None:
        """
    ...
    @typing.overload
    def __init__(
        self, treeview: PySide2.QtWidgets.QTreeWidget, type: int = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qtreewidgetitem.html#QTreeWidgetItem
    ...
    def setChildIndicatorPolicy(
        self, policy: PySide2.QtWidgets.QTreeWidgetItem.ChildIndicatorPolicy
    ) -> None:
        """
