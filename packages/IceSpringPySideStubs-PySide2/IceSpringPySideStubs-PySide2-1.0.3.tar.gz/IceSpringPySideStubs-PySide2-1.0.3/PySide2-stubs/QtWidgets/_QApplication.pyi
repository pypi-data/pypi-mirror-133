...
class QApplication(PySide2.QtGui.QGuiApplication):
    ...
    **See also** **QCoreApplication** , **QAbstractEventDispatcher** , **QEventLoop** , and **QSettings** .
    ...
    class ColorSpec(object):
        NormalColor: QApplication.ColorSpec = ...
        CustomColor: QApplication.ColorSpec = ...
        ManyColor: QApplication.ColorSpec = ...
    ...
    def activeWindow() -> PySide2.QtWidgets.QWidget:
        ...
        **[static] QWidget *QApplication::activeWindow()**
        ...
        Returns the application top-level window that has the keyboard input focus, or `nullptr` if no application window has the focus. There might be an activeWindow() even if there is no **focusWidget** (), for example if no widget in that window accepts key events.
    ...
    def setEffectEnabled(
        arg__1: PySide2.QtCore.Qt.UIEffect, enable: bool = ...
    ) -> None:
        """
    ...
    @staticmethod
    def setFont(
        arg__1: PySide2.QtGui.QFont, className: typing.Optional[bytes] = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qapplication.html#setFont
    ...
    @staticmethod
    def setPalette(
        arg__1: PySide2.QtGui.QPalette, className: typing.Optional[bytes] = ...
    ) -> None:
        """
    ...
    def topLevelAt(p: PySide2.QtCore.QPoint) -> PySide2.QtWidgets.QWidget:
        ...
        **[static] QWidget *QApplication::topLevelAt(const QPoint & point )**
        ...
        Returns the top-level widget at the given **point** ; returns `nullptr` if there is no such widget.
        """
        ...
