...
class QStatusBar(PySide2.QtWidgets.QWidget):
    ...
    **Normal** and **Permanent** messages are displayed by creating a small widget (**QLabel** , **QProgressBar**  or even **QToolButton** ) and then adding it to the status bar using the **addWidget** () or the **addPermanentWidget** () function. Use the **removeWidget** () function to remove such messages from the status bar.
    ...
    ![A status bar shown in the Fusion widget style](images/fusion-statusbar-sizegrip.png)
    ...
    **See also** **QMainWindow** , **QStatusTipEvent** , **GUI Design Handbook: Status Bar** , and **Application Example** .
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qstatusbar.html#QStatusBar
    ...
    def addPermanentWidget(
        self, widget: PySide2.QtWidgets.QWidget, stretch: int = ...
    ) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#addPermanentWidget
    ...
    def clearMessage(self) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#clearMessage
    ...
    def currentMessage(self) -> str:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#currentMessage
    ...
    def event(self, arg__1: PySide2.QtCore.QEvent) -> bool:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#event
    ...
    def hideOrShow(self) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#hideOrShow
    ...
    def insertPermanentWidget(
        self, index: int, widget: PySide2.QtWidgets.QWidget, stretch: int = ...
    ) -> int:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#insertPermanentWidget
    ...
    def insertWidget(
        ...
        """
        https://doc.qt.io/qt-5/qstatusbar.html#insertWidget
    ...
    def paintEvent(self, arg__1: PySide2.QtGui.QPaintEvent) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#paintEvent
    ...
    def reformat(self) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#reformat
    ...
    def removeWidget(self, widget: PySide2.QtWidgets.QWidget) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#removeWidget
    ...
    def resizeEvent(self, arg__1: PySide2.QtGui.QResizeEvent) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#resizeEvent
    ...
    def setSizeGripEnabled(self, arg__1: bool) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#sizeGripEnabled-prop
    ...
    def showEvent(self, arg__1: PySide2.QtGui.QShowEvent) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#showEvent
    ...
    def showMessage(self, text: str, timeout: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#showMessage
    ...
    def messageChanged(self) -> PySide2.QtCore.SignalInstance:
        """
        https://doc.qt.io/qt-5/qstatusbar.html#messageChanged
