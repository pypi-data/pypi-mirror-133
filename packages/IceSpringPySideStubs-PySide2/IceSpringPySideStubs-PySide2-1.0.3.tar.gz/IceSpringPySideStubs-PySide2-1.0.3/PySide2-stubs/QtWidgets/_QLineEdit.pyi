...
class QLineEdit(PySide2.QtWidgets.QWidget):
    ...
    **See also** **QTextEdit** , **QLabel** , **QComboBox** , **GUI Design Handbook: Field, Entry** , and **Line Edits Example** .
    ...
    @typing.overload
    def __init__(
        self, arg__1: str, parent: typing.Optional[PySide2.QtWidgets.QWidget] = ...
    ) -> None:
        """
    ...
    def addAction(
        ...
        position: PySide2.QtWidgets.QLineEdit.ActionPosition,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qlineedit.html#addAction
    ...
    @typing.overload
    def inputMethodQuery(
        self, property: PySide2.QtCore.Qt.InputMethodQuery, argument: typing.Any
    ) -> typing.Any:
        """
        https://doc.qt.io/qt-5/qlineedit.html#inputMethodQuery
    ...
    @property
    def inputRejected(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def returnPressed(self) -> PySide2.QtCore.SignalInstance:
        """
    ...
    @property
    def textEdited(self) -> PySide2.QtCore.SignalInstance:
        """
