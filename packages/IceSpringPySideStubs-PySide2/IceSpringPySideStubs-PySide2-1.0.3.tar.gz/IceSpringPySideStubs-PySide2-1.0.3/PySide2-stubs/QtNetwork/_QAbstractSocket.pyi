...
class QAbstractSocket(PySide2.QtCore.QIODevice):
    ...
    **See also** **QNetworkAccessManager**  and **QTcpServer** .
    ...
    def __init__(
        self,
        socketType: PySide2.QtNetwork.QAbstractSocket.SocketType,
    ...
    def bind(
        ...
        port: int = ...,
        mode: PySide2.QtNetwork.QAbstractSocket.BindMode = ...,
    ) -> bool:
        """
    ...
    @typing.overload
    def bind(
        self, port: int = ..., mode: PySide2.QtNetwork.QAbstractSocket.BindMode = ...
    ) -> bool:
        """
        https://doc.qt.io/qt-5/qabstractsocket.html#bind
    ...
    def setSocketError(
        self, socketError: PySide2.QtNetwork.QAbstractSocket.SocketError
    ) -> None:
        """
    ...
    def setSocketState(
        self, state: PySide2.QtNetwork.QAbstractSocket.SocketState
    ) -> None:
        """
    ...
    @property
    def hostFound(self) -> PySide2.QtCore.SignalInstance:
        """
