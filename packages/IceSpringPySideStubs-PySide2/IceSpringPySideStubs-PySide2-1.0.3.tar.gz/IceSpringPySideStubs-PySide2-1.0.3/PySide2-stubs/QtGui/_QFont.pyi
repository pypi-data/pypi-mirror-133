...
class QFont(object):
    ...
    **See also** **QFontMetrics** , **QFontInfo** , **QFontDatabase** , and **Character Map Example** .
    ...
    class StyleStrategy(object):
        ...
        OpenGLCompatible: QFont.StyleStrategy = ...
        ForceIntegerMetrics: QFont.StyleStrategy = ...
    ...
    def setLetterSpacing(
        self, type: PySide2.QtGui.QFont.SpacingType, spacing: float
    ) -> None:
        """
    ...
    def setStyleHint(
        self,
        arg__1: PySide2.QtGui.QFont.StyleHint,
