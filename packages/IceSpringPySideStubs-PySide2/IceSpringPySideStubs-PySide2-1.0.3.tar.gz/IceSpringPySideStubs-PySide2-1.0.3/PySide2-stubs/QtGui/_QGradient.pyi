...
class QGradient(object):
    ...
    **QLinearGradient** **QRadialGradient** **QConicalGradient**
    ![](images/qgradient-linear.png)![](images/qgradient-radial.png)![](images/qgradient-conical.png)
    ...
    **QRadialGradient**  radialGrad(**QPointF** (100, 100), 100);
    ...
    ![](images/qradialgradient-pad.png)![](images/qradialgradient-repeat.png)![](images/qradialgradient-reflect.png)
    ...
    **See also** **The Gradients Example**  and **QBrush** .
    ...
    ColorInterpolation: QGradient = ...
    LinearGradient: QGradient = ...
    LogicalMode: QGradient = ...
    PadSpread: QGradient = ...
    ComponentInterpolation: QGradient = ...
    ...
    def setInterpolationMode(
        self, mode: PySide2.QtGui.QGradient.InterpolationMode
    ) -> None:
        ...
