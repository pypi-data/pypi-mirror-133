...
class QAccessibleInterface(object):
    """
    https://doc.qt.io/qt-5/qaccessibleinterface.html
    ...
    **See also** **QAccessible** , **QAccessibleActionInterface** , **QAccessibleTextInterface** , **QAccessibleValueInterface** , and **QAccessibleTableInterface** .
    ...
    def backgroundColor(self) -> PySide2.QtGui.QColor:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#backgroundColor
    ...
    def child(self, index: int) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#child
        ...
        **[pure virtual] QAccessibleInterface *QAccessibleInterface::child(int index ) const**
        ...
        Returns `nullptr` when asking for an invalid child (e.g. when the child became invalid in the meantime).
    ...
    def childAt(self, x: int, y: int) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#childAt

        **[pure virtual] QAccessibleInterface *QAccessibleInterface::childAt(int x , int y ) const**

        Returns the **QAccessibleInterface**  of a child that contains the screen coordinates ( **x** , **y** ). If there are no children at this position this function returns `nullptr`. The returned accessible must be a child, but not necessarily a direct child.
    ...
    def childCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#childCount
    ...
    def focusChild(self) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#focusChild
    ...
    def foregroundColor(self) -> PySide2.QtGui.QColor:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#foregroundColor
    ...
    def indexOfChild(self, arg__1: PySide2.QtGui.QAccessibleInterface) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#indexOfChild
    ...
    def interface_cast(self, arg__1: PySide2.QtGui.QAccessible.InterfaceType) -> int:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#interface_cast
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#isValid
    ...
    def object(self) -> PySide2.QtCore.QObject:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#object
    ...
    def parent(self) -> PySide2.QtGui.QAccessibleInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#parent
        ...
        **[pure virtual] QAccessibleInterface *QAccessibleInterface::parent() const**
        ...
        Returns `nullptr` if no parent exists (e.g. for the top level application object).
    ...
    def rect(self) -> PySide2.QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#rect
    ...
    def relations(self, match: PySide2.QtGui.QAccessible.Relation = ...) -> typing.List:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#relations
    ...
    def setText(self, t: PySide2.QtGui.QAccessible.Text, text: str) -> None:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#setText
    ...
    def state(self) -> PySide2.QtGui.QAccessible.State:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#state
    ...
    def tableCellInterface(self) -> PySide2.QtGui.QAccessibleTableCellInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#tableCellInterface
    ...
    def text(self, t: PySide2.QtGui.QAccessible.Text) -> str:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#text
    ...
    def textInterface(self) -> PySide2.QtGui.QAccessibleTextInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#textInterface
    ...
    def valueInterface(self) -> PySide2.QtGui.QAccessibleValueInterface:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#valueInterface
    ...
    def window(self) -> PySide2.QtGui.QWindow:
        """
        https://doc.qt.io/qt-5/qaccessibleinterface.html#window
