...
class QAmbientLightFilter(PySide2.QtSensors.QSensorFilter):
    """
    https://doc.qt.io/qt-5/qambientlightfilter.html

    **Detailed Description**

    The only difference is that the **filter** () method features a pointer to **QAmbientLightReading**  instead of **QSensorReading** .
    """
    ...
    def filter(self, reading: PySide2.QtSensors.QAmbientLightReading) -> bool:
        """
        https://doc.qt.io/qt-5/qambientlightfilter.html#filter

        **[pure virtual] bool QAmbientLightFilter::filter(QAmbientLightReading * reading )**
