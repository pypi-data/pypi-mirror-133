...
class QtDataVisualization(object):
    ...
    **Q3DObject**
    ...
    Simple base class for all the objects
    in a 3D scene
    ...
    **QAbstract3DInputHandler**
    ...
    Base class for implementations of input
    handlers
    ...
    **QCustom3DVolume**
    ...
    Adds a volume rendered object to a
    graph
    ...
    **QItemModelBarDataProxy**
    ...
    Proxy class for presenting data in item models
    with Q3DBars

    **QItemModelScatterDataProxy**

    Proxy class for presenting
    data in item models with Q3DScatter
    ...
    **QScatterDataItem**
    ...
    Container for resolved data to be added to scatter
    graphs
    ...
    **QSurfaceDataItem**
    ...
    Container for resolved data to be added to surface
    graphs
    ...
    **QValue3DAxisFormatter**
    ...
    def qDefaultSurfaceFormat(antialias: bool) -> PySide2.QtGui.QSurfaceFormat:
        ...
        **QSurfaceFormat qDefaultSurfaceFormat(bool antialias )**
        ...
        This convenience function can be used to create a custom surface format
        suitable for use by Qt Data Visualization graphs.

        The **antialias** parameter specifies whether or not antialiasing is
        activated.

        Give the surface format returned by this function to the graph
        constructor (C++) or set it as the window format for **QQuickView**
        (QML) before calling `show()` on it.
        ...
        **Q3DBars**  *graph = new **Q3DBars**
        (QtDataVisualization::qDefaultSurfaceFormat(false));

        For example, enable antialiasing for direct rendering modes on QML
        application:
