...
class QGraphicsProxyWidget(PySide2.QtWidgets.QGraphicsWidget):
    ...
    **QWidget::visible**
    **QGraphicsProxyWidget::visible** The explicit state is also symmetric.
    **QWidget::geometry** **QGraphicsProxyWidget::geometry** Geometry is only
    ...
    **QWidget::cursor**
    **QGraphicsProxyWidget::cursor** The embedded widget overrides the proxy
    widget cursor. The proxy cursor changes depending on which embedded
    subwidget is currently under the mouse.
    **QWidget::sizeHint**
    ()**QGraphicsProxyWidget::sizeHint** ()All size hint functionality from the
    embedded widget is forwarded by the proxy.
    QWidget::getContentsMargins()**QGraphicsProxyWidget::getContentsMargins**
    ()Updated once by **setWidget** ().
    **QWidget::windowTitle**
    **QGraphicsProxyWidget::windowTitle** Updated once by **setWidget** ().
    ...
    **See also** **QGraphicsScene::addWidget** () and **QGraphicsWidget** .
    ...
    def createProxyForChildWidget(
        ...
        """
        https://doc.qt.io/qt-5/qgraphicsproxywidget.html#createProxyForChildWidg
        et
