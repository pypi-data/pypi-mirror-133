...
def main():
    ...
    logger.debug(f'pybiolib version {utils.BIOLIB_PACKAGE_VERSION}')
    ...
    if len(sys.argv) > 2 and sys.argv[1] == 'run':
        ...
        # Write stdout and stderr if it has not been streamed (Not rendered as text)
        if app.version.get('stdout_render_type') != 'text':
