...
general_location_set_dict = [
    ...
    {"locationSetId": ["OPVLWATER_WATERSTANDEN_AUTO", "OPVLWATER_PEILSCHALEN"], "id": "OPVLWATER_WATERSTANDEN",},
    {"locationSetId": ["OPVLWATER_WATERSTANDEN", "GRONDWATERMEETPUNTEN"], "id": "OPVL_GROND_WATER_WATERSTANDEN",},
    {
    ...
    },
    {
        ...
        "constraints": {
            "anyValid": {
                ...
                "attributeTextContains": {"id": "LOC_NAME", "contains": "-totaal_aanvoer",},
            }
        },
    ...
    },
    {
        ...
        "constraints": {
            "anyValid": {
                ...
                "attributeTextContains": {"id": "LOC_NAME", "contains": "-totaal_afvoer",},
            }
        },
    ...
    {"chainageLocationAttributeId": "Langsprofiel_Grecht", "id": "Langsprofiel_Grecht", "name": "Set_Grecht",},
    {
    ...
    {
        "locationId": ["KW102512", "KW102812", "KW102912", "KW103012", "KW103812", "KW104313", "KW215412", "KW216225",],
        "id": "STROOMSNELHEID",
    },
    {
    ...
    },
    {
        ...
        "csvFile": {
            ...
            "attribute": [{"boolean": "%SWM%", "id": "SWM"}, {"text": "%LOC_ID%", "id": "SWM_ID"},],
        },
        "id": "SWMGEBIEDEN",
    },
    {
    ...
    {"locationSetId": "SWMGEBIEDEN", "constraints": {"idContains": {"contains": "netto"}}, "id": "SWMGEBIEDEN_NETTO",},
    {
        "locationSetId": "OPVLWATER_SUBLOC",
    ...
    {"locationSetId": ["OPVLWATER_SUBLOC_SWM_AANVOER", "OPVLWATER_SUBLOC_SWM_AFVOER",], "id": "OPVLWATER_SUBLOC_SWM",},
    {
        "locationSetId": "OPVLWATER_WATERSTANDEN_AUTO",
...
def test_general_location_set_dict(loc_sets):
    assert loc_sets.hoofdloc.general_location_sets_dict == general_location_set_dict
    assert loc_sets.subloc.general_location_sets_dict == general_location_set_dict
    assert loc_sets.waterstandloc.general_location_sets_dict == general_location_set_dict
    assert loc_sets.psloc.general_location_sets_dict == general_location_set_dict
    assert loc_sets.mswloc.general_location_sets_dict == general_location_set_dict
...
def test_unique_validation_attributes(loc_sets):
    ...
    assert _attribs(loc_sets.hoofdloc) and _attribs(loc_sets.subloc) and _attribs(loc_sets.waterstandloc)
    assert _attribs(loc_sets.mswloc) == [] and _attribs(loc_sets.psloc) == []
    assert _attribs(loc_sets.hoofdloc) != _attribs(loc_sets.subloc) != _attribs(loc_sets.mswloc)
...
def test_unique_csvfile_meta(loc_sets):
    ...
    assert (
        loc_sets.hoofdloc.csv_file_meta
        and loc_sets.subloc.csv_file_meta  # noqa
        and loc_sets.waterstandloc.csv_file_meta  # noqa
        and loc_sets.mswloc.csv_file_meta  # noqa
        and loc_sets.psloc.csv_file_meta  # noqa
    )
    assert (
        loc_sets.hoofdloc.csv_file_meta  # noqa
        != loc_sets.subloc.csv_file_meta  # noqa
        != loc_sets.waterstandloc.csv_file_meta  # noqa
        != loc_sets.mswloc.csv_file_meta  # noqa
        != loc_sets.psloc.csv_file_meta  # noqa
    )
    assert loc_sets.hoofdloc.csv_file_meta == _meta(
        _loc_set=loc_sets.hoofdloc, general_location_set_dict=general_location_set_dict
    )
    assert loc_sets.subloc.csv_file_meta == _meta(
        _loc_set=loc_sets.subloc, general_location_set_dict=general_location_set_dict
    )
    assert loc_sets.waterstandloc.csv_file_meta == _meta(
        _loc_set=loc_sets.waterstandloc, general_location_set_dict=general_location_set_dict
    )
    assert loc_sets.psloc.csv_file_meta == _meta(
        _loc_set=loc_sets.psloc, general_location_set_dict=general_location_set_dict
    )
    assert loc_sets.mswloc.csv_file_meta == _meta(
        _loc_set=loc_sets.mswloc, general_location_set_dict=general_location_set_dict
    )


def test_unique_attribute_files(loc_sets):
    assert loc_sets.hoofdloc.attrib_files and loc_sets.subloc.attrib_files and loc_sets.waterstandloc.attrib_files
    assert loc_sets.mswloc.attrib_files == [] and loc_sets.psloc.attrib_files == []
    assert loc_sets.hoofdloc.attrib_files != loc_sets.subloc.attrib_files != loc_sets.waterstandloc.attrib_files
