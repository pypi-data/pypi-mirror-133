...
from esg.server import Server, ServerState  # noqa: F401  # Used to be defined here.
...
@click.command(context_settings={"auto_envvar_prefix": "ESG"})
@click.argument("app")
@click.option(
    "--host",
    type=str,
...
@click.option(
    ...
    expose_value=False,
    is_eager=True,
    help="Display the esg version and exit.",
)
@click.option(
    "--app-dir",
    default=".",
