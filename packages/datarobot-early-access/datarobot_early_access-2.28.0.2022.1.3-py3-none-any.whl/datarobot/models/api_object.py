...
class APIObject(object):
    ...
    def to_dict(self):
        """
        A function wrapper around the object __dict__ method, allowing for neater calls
        when required during API client generation.
        Returns
        -------
        A dict representation of the class instance.
        """
        return self.__dict__

    def to_json(self):
        """
        A helper function to automatically generate a JSON encoded string representation
        of the class instance. This was added to support the API client generator.
        Returns
        -------
        JSON encoded string representation of the class instance.
        """
