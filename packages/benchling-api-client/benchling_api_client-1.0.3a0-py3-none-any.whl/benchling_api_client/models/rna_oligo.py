...
class RnaOligo:
    ...
    _api_url: Union[Unset, None] = UNSET
    _bases: Union[Unset, None] = UNSET
    _nucleotide_type: Union[Unset, None] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _registration_origin = d.pop("registrationOrigin", UNSET)
    ...
    @api_url.setter
    def api_url(self, value: None) -> None:
        self._api_url = value
    ...
    @bases.setter
    def bases(self, value: None) -> None:
        self._bases = value
    ...
    def nucleotide_type(self, value: None) -> None:
