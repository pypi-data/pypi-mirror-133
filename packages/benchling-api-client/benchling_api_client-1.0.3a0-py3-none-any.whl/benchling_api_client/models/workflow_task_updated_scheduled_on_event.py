...
from ..models.workflow_task_updated_scheduled_on_event_event_type import (
    WorkflowTaskUpdatedScheduledOnEventEventType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedScheduledOnEvent")
...
class WorkflowTaskUpdatedScheduledOnEvent:
    ...
    _event_type: Union[Unset, WorkflowTaskUpdatedScheduledOnEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedScheduledOnEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = WorkflowTaskUpdatedScheduledOnEventEventType(_event_type)
            except ValueError:
                event_type = WorkflowTaskUpdatedScheduledOnEventEventType.of_unknown(_event_type)
        ...
        workflow_task_updated_scheduled_on_event = cls(
        ...
        workflow_task_updated_scheduled_on_event.additional_properties = d
        return workflow_task_updated_scheduled_on_event
    ...
    @property
    def event_type(self) -> WorkflowTaskUpdatedScheduledOnEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskUpdatedScheduledOnEventEventType) -> None:
