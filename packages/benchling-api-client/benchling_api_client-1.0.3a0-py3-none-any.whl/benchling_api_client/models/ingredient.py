...
class Ingredient:
    ...
    _amount: Union[Unset, IngredientAmount] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._amount, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        amount: Union[Unset, IngredientAmount] = UNSET
        _amount = d.pop("amount", UNSET)
        if not isinstance(_amount, Unset):
            amount = IngredientAmount.from_dict(_amount)

        catalog_identifier = d.pop("catalogIdentifier", UNSET)

        component_entity: Union[Unset, IngredientComponentEntity] = UNSET
        _component_entity = d.pop("componentEntity", UNSET)
        ...
        _component_lot_container = d.pop("componentLotContainer", UNSET)
        ...
        _component_lot_entity = d.pop("componentLotEntity", UNSET)
        ...
        component_lot_text = d.pop("componentLotText", UNSET)

        has_parent = d.pop("hasParent", UNSET)
