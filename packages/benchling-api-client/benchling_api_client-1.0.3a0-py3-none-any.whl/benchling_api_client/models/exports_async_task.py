...
from ..models.exports_async_task_response import ExportsAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="ExportsAsyncTask")
...
class ExportsAsyncTask:
    ...
    _response: Union[Unset, ExportsAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "ExportsAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, ExportsAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = ExportsAsyncTaskResponse.from_dict(_response)
        ...
        exports_async_task.additional_properties = d
        return exports_async_task
    ...
    @property
    def response(self) -> ExportsAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: ExportsAsyncTaskResponse) -> None:
