...
class Mixture:
    ...
    def __repr__(self):
        ...
        return "Mixture({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        allow_measured_ingredients = d.pop("allowMeasuredIngredients", UNSET)
        ...
        creator: Union[Unset, MixtureCreator] = UNSET
        ...
        mixture.additional_properties = d
        return mixture
