...
T = TypeVar("T", bound="WorkflowTaskGroupSummary")
...
class WorkflowTaskGroupSummary:
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupSummary({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_task_group_summary = cls(
            display_id=display_id,
            id=id,
            name=name,
        )

        workflow_task_group_summary.additional_properties = d
        return workflow_task_group_summary
