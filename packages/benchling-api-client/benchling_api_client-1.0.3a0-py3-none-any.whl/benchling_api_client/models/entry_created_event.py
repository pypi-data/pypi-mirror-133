...
from ..models.entry_created_event_event_type import EntryCreatedEventEventType
from ..models.event_base_schema import EventBaseSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryCreatedEvent")
...
class EntryCreatedEvent:
    ...
    _event_type: Union[Unset, EntryCreatedEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "EntryCreatedEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = EntryCreatedEventEventType(_event_type)
            except ValueError:
                event_type = EntryCreatedEventEventType.of_unknown(_event_type)
        ...
        entry_created_event.additional_properties = d
        return entry_created_event
    ...
    @property
    def event_type(self) -> EntryCreatedEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: EntryCreatedEventEventType) -> None:
