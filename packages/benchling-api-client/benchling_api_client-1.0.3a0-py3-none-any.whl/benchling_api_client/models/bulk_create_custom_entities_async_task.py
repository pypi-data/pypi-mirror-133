...
from ..models.bulk_create_custom_entities_async_task_response import BulkCreateCustomEntitiesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateCustomEntitiesAsyncTask")
...
class BulkCreateCustomEntitiesAsyncTask:
    ...
    _response: Union[Unset, BulkCreateCustomEntitiesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateCustomEntitiesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkCreateCustomEntitiesAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkCreateCustomEntitiesAsyncTaskResponse.from_dict(_response)
        ...
        bulk_create_custom_entities_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_custom_entities_async_task.additional_properties = d
        return bulk_create_custom_entities_async_task
    ...
    @property
    def response(self) -> BulkCreateCustomEntitiesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateCustomEntitiesAsyncTaskResponse) -> None:
