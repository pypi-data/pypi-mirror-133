...
from ..models.bulk_create_dna_sequences_async_task_response import BulkCreateDnaSequencesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateDnaSequencesAsyncTask")
...
class BulkCreateDnaSequencesAsyncTask:
    ...
    _response: Union[Unset, BulkCreateDnaSequencesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateDnaSequencesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkCreateDnaSequencesAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkCreateDnaSequencesAsyncTaskResponse.from_dict(_response)
        ...
        bulk_create_dna_sequences_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_dna_sequences_async_task.additional_properties = d
        return bulk_create_dna_sequences_async_task
    ...
    @property
    def response(self) -> BulkCreateDnaSequencesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateDnaSequencesAsyncTaskResponse) -> None:
