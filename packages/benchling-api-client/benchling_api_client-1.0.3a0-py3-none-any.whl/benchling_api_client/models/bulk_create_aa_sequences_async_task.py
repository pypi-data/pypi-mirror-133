...
from ..models.bulk_create_aa_sequences_async_task_response import BulkCreateAaSequencesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateAaSequencesAsyncTask")
...
class BulkCreateAaSequencesAsyncTask:
    ...
    _response: Union[Unset, BulkCreateAaSequencesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateAaSequencesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkCreateAaSequencesAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkCreateAaSequencesAsyncTaskResponse.from_dict(_response)
        ...
        bulk_create_aa_sequences_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_aa_sequences_async_task.additional_properties = d
        return bulk_create_aa_sequences_async_task
    ...
    @property
    def response(self) -> BulkCreateAaSequencesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateAaSequencesAsyncTaskResponse) -> None:
