...
from ..models.location_schema_type import LocationSchemaType
...
T = TypeVar("T", bound="LocationSchema")
...
class LocationSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _type is not None and _type is not UNSET:
            try:
                type = LocationSchemaType(_type)
            except ValueError:
                type = LocationSchemaType.of_unknown(_type)
        ...
        location_schema.additional_properties = d
    ...
    @type.setter
    def type(self, value: LocationSchemaType) -> None:
        self._type = value
