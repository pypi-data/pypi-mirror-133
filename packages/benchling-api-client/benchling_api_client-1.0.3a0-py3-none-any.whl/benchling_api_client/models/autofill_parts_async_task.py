...
T = TypeVar("T", bound="AutofillPartsAsyncTask")
...
class AutofillPartsAsyncTask:
    ...
    def __repr__(self):
        ...
        return "AutofillPartsAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        autofill_parts_async_task.additional_properties = d
        return autofill_parts_async_task
