...
T = TypeVar("T", bound="CreateConsensusAlignmentAsyncTask")
...
class CreateConsensusAlignmentAsyncTask:
    ...
    def __repr__(self):
        ...
        return "CreateConsensusAlignmentAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, DnaAlignment] = UNSET
        ...
        create_consensus_alignment_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        create_consensus_alignment_async_task.additional_properties = d
        return create_consensus_alignment_async_task
