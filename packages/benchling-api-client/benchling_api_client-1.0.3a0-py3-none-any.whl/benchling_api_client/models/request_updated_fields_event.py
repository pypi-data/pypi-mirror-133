...
class RequestUpdatedFieldsEvent:
    ...
    _event_type: Union[Unset, RequestUpdatedFieldsEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "RequestUpdatedFieldsEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                ...
                event_type = RequestUpdatedFieldsEventEventType.of_unknown(_event_type)
    ...
    @property
    def event_type(self) -> RequestUpdatedFieldsEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: RequestUpdatedFieldsEventEventType) -> None:
