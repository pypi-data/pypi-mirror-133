...
T = TypeVar("T", bound="BulkCreateCustomEntitiesAsyncTaskResponse")
...
class BulkCreateCustomEntitiesAsyncTaskResponse:
    ...
    def __repr__(self):
        ...
        return "BulkCreateCustomEntitiesAsyncTaskResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulk_create_custom_entities_async_task_response = cls(
            custom_entities=custom_entities,
        )

        bulk_create_custom_entities_async_task_response.additional_properties = d
        return bulk_create_custom_entities_async_task_response
