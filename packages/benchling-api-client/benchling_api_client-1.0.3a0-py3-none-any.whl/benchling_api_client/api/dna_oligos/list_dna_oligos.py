...
from ...models.dna_oligos_paginated_list import DnaOligosPaginatedList
from ...models.list_dna_oligos_sort import ListDNAOligosSort
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, ListDNAOligosSort] = ListDNAOligosSort.MODIFIEDATDESC,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DnaOligosPaginatedList, BadRequestError]]:
    if response.status_code == 200:
        response_200 = DnaOligosPaginatedList.from_dict(response.json())
...
def _build_response(*, response: httpx.Response) -> Response[Union[DnaOligosPaginatedList, BadRequestError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
    creator_ids: Union[Unset, str] = UNSET,
) -> Response[Union[DnaOligosPaginatedList, BadRequestError]]:
    kwargs = _get_kwargs(
        client=client,
        page_size=page_size,
...
def sync(
    *,
    ...
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
    creator_ids: Union[Unset, str] = UNSET,
) -> Optional[Union[DnaOligosPaginatedList, BadRequestError]]:
    """ List DNA Oligos """
