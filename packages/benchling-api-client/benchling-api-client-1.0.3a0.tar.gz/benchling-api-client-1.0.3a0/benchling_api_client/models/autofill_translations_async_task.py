...
T = TypeVar("T", bound="AutofillTranslationsAsyncTask")
...
class AutofillTranslationsAsyncTask:
    ...
    def __repr__(self):
        ...
        return "AutofillTranslationsAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        autofill_translations_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        autofill_translations_async_task.additional_properties = d
        return autofill_translations_async_task
