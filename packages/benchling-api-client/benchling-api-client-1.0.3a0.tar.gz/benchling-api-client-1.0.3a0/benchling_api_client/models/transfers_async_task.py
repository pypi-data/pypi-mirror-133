...
from ..models.transfers_async_task_response import TransfersAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="TransfersAsyncTask")
...
class TransfersAsyncTask:
    ...
    _response: Union[Unset, TransfersAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "TransfersAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, TransfersAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = TransfersAsyncTaskResponse.from_dict(_response)
        ...
        transfers_async_task.additional_properties = d
        return transfers_async_task
    ...
    @property
    def response(self) -> TransfersAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: TransfersAsyncTaskResponse) -> None:
