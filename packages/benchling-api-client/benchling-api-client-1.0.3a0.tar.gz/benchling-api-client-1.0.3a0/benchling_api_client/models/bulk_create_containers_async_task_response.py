...
T = TypeVar("T", bound="BulkCreateContainersAsyncTaskResponse")
...
class BulkCreateContainersAsyncTaskResponse:
    ...
    def __repr__(self):
        ...
        return "BulkCreateContainersAsyncTaskResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulk_create_containers_async_task_response = cls(
            containers=containers,
        )

        bulk_create_containers_async_task_response.additional_properties = d
        return bulk_create_containers_async_task_response
