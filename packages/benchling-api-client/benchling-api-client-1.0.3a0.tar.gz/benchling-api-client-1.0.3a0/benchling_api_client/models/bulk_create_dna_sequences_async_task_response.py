...
T = TypeVar("T", bound="BulkCreateDnaSequencesAsyncTaskResponse")
...
class BulkCreateDnaSequencesAsyncTaskResponse:
    ...
    def __repr__(self):
        ...
        return "BulkCreateDnaSequencesAsyncTaskResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulk_create_dna_sequences_async_task_response = cls(
            dna_sequences=dna_sequences,
        )

        bulk_create_dna_sequences_async_task_response.additional_properties = d
        return bulk_create_dna_sequences_async_task_response
