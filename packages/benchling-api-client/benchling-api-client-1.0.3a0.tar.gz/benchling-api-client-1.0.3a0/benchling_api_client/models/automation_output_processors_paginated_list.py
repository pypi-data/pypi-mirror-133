...
class AutomationOutputProcessorsPaginatedList:
    ...
    def __repr__(self):
        ...
        return "AutomationOutputProcessorsPaginatedList({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        automation_output_processors = []
        _automation_output_processors = d.pop("automationOutputProcessors", UNSET)
        ...
        automation_output_processors_paginated_list.additional_properties = d
