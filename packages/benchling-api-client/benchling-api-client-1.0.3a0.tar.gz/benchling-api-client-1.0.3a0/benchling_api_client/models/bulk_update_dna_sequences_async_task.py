...
from ..models.bulk_update_dna_sequences_async_task_response import BulkUpdateDnaSequencesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateDnaSequencesAsyncTask")
...
class BulkUpdateDnaSequencesAsyncTask:
    ...
    _response: Union[Unset, BulkUpdateDnaSequencesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkUpdateDnaSequencesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkUpdateDnaSequencesAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkUpdateDnaSequencesAsyncTaskResponse.from_dict(_response)
        ...
        bulk_update_dna_sequences_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_update_dna_sequences_async_task.additional_properties = d
        return bulk_update_dna_sequences_async_task
    ...
    @property
    def response(self) -> BulkUpdateDnaSequencesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkUpdateDnaSequencesAsyncTaskResponse) -> None:
