...
T = TypeVar("T", bound="RequestRequestor")
...
class RequestRequestor:
    ...
    def __repr__(self):
        ...
        return "RequestRequestor({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_requestor = cls(
            handle=handle,
            id=id,
            name=name,
        )

        request_requestor.additional_properties = d
        return request_requestor
