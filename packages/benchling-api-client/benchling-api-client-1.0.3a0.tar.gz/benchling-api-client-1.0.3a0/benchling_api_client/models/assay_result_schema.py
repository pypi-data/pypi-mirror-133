...
class AssayResultSchema:
    ...
    _type: Union[Unset, AssayResultSchemaType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AssayResultSchema({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _type is not None and _type is not UNSET:
            try:
                ...
                type = AssayResultSchemaType.of_unknown(_type)
    ...
    @property
    def type(self) -> AssayResultSchemaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AssayResultSchemaType) -> None:
        self._type = value
