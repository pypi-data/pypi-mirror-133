...
from ..models.bulk_create_rna_oligos_async_task_response import BulkCreateRnaOligosAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateRnaOligosAsyncTask")
...
class BulkCreateRnaOligosAsyncTask:
    ...
    _response: Union[Unset, BulkCreateRnaOligosAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateRnaOligosAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkCreateRnaOligosAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkCreateRnaOligosAsyncTaskResponse.from_dict(_response)
        ...
        bulk_create_rna_oligos_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_rna_oligos_async_task.additional_properties = d
        return bulk_create_rna_oligos_async_task
    ...
    @property
    def response(self) -> BulkCreateRnaOligosAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateRnaOligosAsyncTaskResponse) -> None:
