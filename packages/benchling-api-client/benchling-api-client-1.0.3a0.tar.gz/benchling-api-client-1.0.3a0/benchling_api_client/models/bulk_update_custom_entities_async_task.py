...
from ..models.bulk_update_custom_entities_async_task_response import BulkUpdateCustomEntitiesAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateCustomEntitiesAsyncTask")
...
class BulkUpdateCustomEntitiesAsyncTask:
    ...
    _response: Union[Unset, BulkUpdateCustomEntitiesAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkUpdateCustomEntitiesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkUpdateCustomEntitiesAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkUpdateCustomEntitiesAsyncTaskResponse.from_dict(_response)
        ...
        bulk_update_custom_entities_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_update_custom_entities_async_task.additional_properties = d
        return bulk_update_custom_entities_async_task
    ...
    @property
    def response(self) -> BulkUpdateCustomEntitiesAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkUpdateCustomEntitiesAsyncTaskResponse) -> None:
