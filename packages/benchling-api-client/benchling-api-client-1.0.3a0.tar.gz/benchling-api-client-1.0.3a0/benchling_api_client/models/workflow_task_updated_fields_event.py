...
from ..models.workflow_task_updated_fields_event_event_type import WorkflowTaskUpdatedFieldsEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedFieldsEvent")
...
class WorkflowTaskUpdatedFieldsEvent:
    ...
    _event_type: Union[Unset, WorkflowTaskUpdatedFieldsEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedFieldsEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = WorkflowTaskUpdatedFieldsEventEventType(_event_type)
            except ValueError:
                event_type = WorkflowTaskUpdatedFieldsEventEventType.of_unknown(_event_type)
        ...
        workflow_task_updated_fields_event = cls(
        ...
        workflow_task_updated_fields_event.additional_properties = d
        return workflow_task_updated_fields_event
    ...
    @property
    def event_type(self) -> WorkflowTaskUpdatedFieldsEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskUpdatedFieldsEventEventType) -> None:
