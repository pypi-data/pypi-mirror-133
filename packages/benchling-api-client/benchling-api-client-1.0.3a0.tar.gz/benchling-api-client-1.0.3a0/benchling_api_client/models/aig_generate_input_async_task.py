...
T = TypeVar("T", bound="AIGGenerateInputAsyncTask")
...
class AIGGenerateInputAsyncTask:
    ...
    _response: Union[Unset, AutomationInputGenerator] = UNSET
    ...
    def __repr__(self):
        ...
        return "AIGGenerateInputAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, AutomationInputGenerator] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = AutomationInputGenerator.from_dict(_response)
        ...
        aig_generate_input_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        aig_generate_input_async_task.additional_properties = d
        return aig_generate_input_async_task
    ...
    @property
    def response(self) -> AutomationInputGenerator:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: AutomationInputGenerator) -> None:
