...
T = TypeVar("T", bound="BulkRegisterEntitiesAsyncTask")
...
class BulkRegisterEntitiesAsyncTask:
    ...
    _response: Union[Unset, None] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkRegisterEntitiesAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bulk_register_entities_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_register_entities_async_task.additional_properties = d
        return bulk_register_entities_async_task
    ...
    @response.setter
    def response(self, value: None) -> None:
