...
T = TypeVar("T", bound="DnaSequenceBaseRequest")
...
class DnaSequenceBaseRequest:
    ...
    def __repr__(self):
        ...
        return "DnaSequenceBaseRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for annotations_item_data in _annotations or []:
            annotations_item = DnaAnnotation.from_dict(annotations_item_data)
        ...
        dna_sequence_base_request.additional_properties = d
        return dna_sequence_base_request
