...
T = TypeVar("T", bound="IngredientComponentEntity")
...
class IngredientComponentEntity:
    ...
    def __repr__(self):
        ...
        return "IngredientComponentEntity({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ingredient_component_entity = cls(
            entity_registry_id=entity_registry_id,
            id=id,
            name=name,
        )

        ingredient_component_entity.additional_properties = d
        return ingredient_component_entity
