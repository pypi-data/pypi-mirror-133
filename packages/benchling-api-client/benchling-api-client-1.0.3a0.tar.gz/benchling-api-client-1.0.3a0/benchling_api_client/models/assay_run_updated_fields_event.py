...
class AssayRunUpdatedFieldsEvent:
    ...
    _event_type: Union[Unset, AssayRunUpdatedFieldsEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AssayRunUpdatedFieldsEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                ...
                event_type = AssayRunUpdatedFieldsEventEventType.of_unknown(_event_type)
    ...
    @property
    def event_type(self) -> AssayRunUpdatedFieldsEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AssayRunUpdatedFieldsEventEventType) -> None:
