...
T = TypeVar("T", bound="CustomEntityBaseRequest")
...
class CustomEntityBaseRequest:
    ...
    def __repr__(self):
        ...
        return "CustomEntityBaseRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_entity_base_request = cls(
            aliases=aliases,
        ...
        custom_entity_base_request.additional_properties = d
        return custom_entity_base_request
