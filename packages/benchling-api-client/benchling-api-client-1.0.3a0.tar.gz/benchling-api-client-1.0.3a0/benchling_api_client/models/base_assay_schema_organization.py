...
T = TypeVar("T", bound="BaseAssaySchemaOrganization")
...
class BaseAssaySchemaOrganization:
    ...
    def __repr__(self):
        ...
        return "BaseAssaySchemaOrganization({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        base_assay_schema_organization = cls(
            handle=handle,
            id=id,
            name=name,
        )

        base_assay_schema_organization.additional_properties = d
        return base_assay_schema_organization
