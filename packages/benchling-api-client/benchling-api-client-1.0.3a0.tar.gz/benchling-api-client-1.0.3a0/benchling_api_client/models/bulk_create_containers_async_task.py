...
from ..models.bulk_create_containers_async_task_response import BulkCreateContainersAsyncTaskResponse
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkCreateContainersAsyncTask")
...
class BulkCreateContainersAsyncTask:
    ...
    _response: Union[Unset, BulkCreateContainersAsyncTaskResponse] = UNSET
    ...
    def __repr__(self):
        ...
        return "BulkCreateContainersAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, BulkCreateContainersAsyncTaskResponse] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = BulkCreateContainersAsyncTaskResponse.from_dict(_response)
        ...
        bulk_create_containers_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        bulk_create_containers_async_task.additional_properties = d
        return bulk_create_containers_async_task
    ...
    @property
    def response(self) -> BulkCreateContainersAsyncTaskResponse:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: BulkCreateContainersAsyncTaskResponse) -> None:
