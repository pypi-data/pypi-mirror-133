...
T = TypeVar("T", bound="AOPProcessOutputAsyncTask")
...
class AOPProcessOutputAsyncTask:
    ...
    _response: Union[Unset, AutomationOutputProcessor] = UNSET
    ...
    def __repr__(self):
        ...
        return "AOPProcessOutputAsyncTask({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        response: Union[Unset, AutomationOutputProcessor] = UNSET
        _response = d.pop("response", UNSET)
        if not isinstance(_response, Unset):
            response = AutomationOutputProcessor.from_dict(_response)
        ...
        aop_process_output_async_task = cls(
            status=status,
            response=response,
            errors=errors,
            message=message,
        ...
        aop_process_output_async_task.additional_properties = d
        return aop_process_output_async_task
    ...
    @property
    def response(self) -> AutomationOutputProcessor:
        if isinstance(self._response, Unset):
            raise NotPresentError(self, "response")
        return self._response

    @response.setter
    def response(self, value: AutomationOutputProcessor) -> None:
