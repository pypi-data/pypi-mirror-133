...
from ..models.workflow_task_updated_assignee_event_event_type import WorkflowTaskUpdatedAssigneeEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedAssigneeEvent")
...
class WorkflowTaskUpdatedAssigneeEvent:
    ...
    _event_type: Union[Unset, WorkflowTaskUpdatedAssigneeEventEventType] = UNSET
    _workflow_task: Union[Unset, WorkflowTask] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedAssigneeEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = WorkflowTaskUpdatedAssigneeEventEventType(_event_type)
            except ValueError:
                event_type = WorkflowTaskUpdatedAssigneeEventEventType.of_unknown(_event_type)

        workflow_task: Union[Unset, WorkflowTask] = UNSET
        _workflow_task = d.pop("workflowTask", UNSET)
        if not isinstance(_workflow_task, Unset):
            workflow_task = WorkflowTask.from_dict(_workflow_task)
        ...
        workflow_task_updated_assignee_event = cls(
        ...
        workflow_task_updated_assignee_event.additional_properties = d
        return workflow_task_updated_assignee_event
    ...
    @property
    def event_type(self) -> WorkflowTaskUpdatedAssigneeEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskUpdatedAssigneeEventEventType) -> None:
    ...
    def workflow_task(self, value: WorkflowTask) -> None:
