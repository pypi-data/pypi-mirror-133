...
class AutomationOutputProcessor:
    ...
    _transforms: Union[Unset, List[Transform]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        error_file = None
        _error_file = d.pop("errorFile", UNSET)
        ...
        progress_stats: Union[Unset, AutomationProgressStats] = UNSET
        _progress_stats = d.pop("progressStats", UNSET)
