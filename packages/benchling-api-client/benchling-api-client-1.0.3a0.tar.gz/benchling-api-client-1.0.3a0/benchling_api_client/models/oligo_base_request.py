...
T = TypeVar("T", bound="OligoBaseRequest")
...
class OligoBaseRequest:
    ...
    def __repr__(self):
        ...
        return "OligoBaseRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        oligo_base_request.additional_properties = d
        return oligo_base_request
