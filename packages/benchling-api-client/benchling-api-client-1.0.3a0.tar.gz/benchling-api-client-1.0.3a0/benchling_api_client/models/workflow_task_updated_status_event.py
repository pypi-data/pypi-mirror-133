...
from ..models.workflow_task_updated_status_event_event_type import WorkflowTaskUpdatedStatusEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedStatusEvent")
...
class WorkflowTaskUpdatedStatusEvent:
    ...
    _event_type: Union[Unset, WorkflowTaskUpdatedStatusEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedStatusEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = WorkflowTaskUpdatedStatusEventEventType(_event_type)
            except ValueError:
                event_type = WorkflowTaskUpdatedStatusEventEventType.of_unknown(_event_type)
        ...
        workflow_task_updated_status_event = cls(
        ...
        workflow_task_updated_status_event.additional_properties = d
        return workflow_task_updated_status_event
    ...
    @property
    def event_type(self) -> WorkflowTaskUpdatedStatusEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskUpdatedStatusEventEventType) -> None:
