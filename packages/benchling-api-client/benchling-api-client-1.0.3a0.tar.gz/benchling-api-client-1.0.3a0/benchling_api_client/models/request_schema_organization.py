...
T = TypeVar("T", bound="RequestSchemaOrganization")
...
class RequestSchemaOrganization:
    ...
    def __repr__(self):
        ...
        return "RequestSchemaOrganization({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_schema_organization = cls(
            handle=handle,
            id=id,
            name=name,
        )

        request_schema_organization.additional_properties = d
        return request_schema_organization
