...
from ..models.workflow_task_created_event_event_type import WorkflowTaskCreatedEventEventType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskCreatedEvent")
...
class WorkflowTaskCreatedEvent:
    ...
    _event_type: Union[Unset, WorkflowTaskCreatedEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskCreatedEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _event_type is not None and _event_type is not UNSET:
            try:
                event_type = WorkflowTaskCreatedEventEventType(_event_type)
            except ValueError:
                event_type = WorkflowTaskCreatedEventEventType.of_unknown(_event_type)
        ...
        workflow_task_created_event = cls(
        ...
        workflow_task_created_event.additional_properties = d
        return workflow_task_created_event
    ...
    @property
    def event_type(self) -> WorkflowTaskCreatedEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskCreatedEventEventType) -> None:
