...
) -> Optional[Union[RnaOligo, BadRequestError, ConflictError, None]]:
    if response.status_code == 201:
        response_201 = RnaOligo.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[RnaOligo, BadRequestError, ConflictError, None]]:
    return Response(
