...
class WorkflowTask:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_relationships_from() -> Union[Unset, List[WorkflowTaskRelationship]]:
            relationships_from = []
            _relationships_from = d.pop("relationshipsFrom")
            ...
            return relationships_from

        relationships_from = (
            get_relationships_from()
            if "relationshipsFrom" in d
            else cast(Union[Unset, List[WorkflowTaskRelationship]], UNSET)
        )

        def get_relationships_to() -> Union[Unset, List[WorkflowTaskRelationship]]:
            relationships_to = []
            _relationships_to = d.pop("relationshipsTo")
