...
from ...models.list_rna_oligos_sort import ListRNAOligosSort
from ...models.rna_oligos_paginated_list import RnaOligosPaginatedList
...
def _get_kwargs(
    *,
    ...
    sort: Union[Unset, ListRNAOligosSort] = ListRNAOligosSort.MODIFIEDATDESC,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[RnaOligosPaginatedList, BadRequestError]]:
    if response.status_code == 200:
        response_200 = RnaOligosPaginatedList.from_dict(response.json())
...
def _build_response(*, response: httpx.Response) -> Response[Union[RnaOligosPaginatedList, BadRequestError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
    creator_ids: Union[Unset, str] = UNSET,
) -> Response[Union[RnaOligosPaginatedList, BadRequestError]]:
    kwargs = _get_kwargs(
        client=client,
        page_size=page_size,
...
def sync(
    *,
    ...
    namesany_ofcase_sensitive: Union[Unset, str] = UNSET,
    creator_ids: Union[Unset, str] = UNSET,
) -> Optional[Union[RnaOligosPaginatedList, BadRequestError]]:
    """ List RNA Oligos """
