...
) -> Optional[Union[Mixture, BadRequestError, ConflictError, None]]:
    if response.status_code == 201:
        response_201 = Mixture.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[Mixture, BadRequestError, ConflictError, None]]:
    return Response(
