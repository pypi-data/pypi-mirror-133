...
download_url = 'https://gitlab.com/m9s/account_batch.git'
local_version = []
...
setup(name=name,
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/account_batch.git',
        },
    keywords='',
    package_dir={'trytond.modules.account_batch': '.'},
    packages=(
        ['trytond.modules.account_batch'] +
        ['trytond.modules.account_batch.%s' % p for p in find_packages()]
        ),
    package_data={
        'trytond.modules.account_batch': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    account_batch = trytond.modules.account_batch
    """,
    test_suite='tests',
