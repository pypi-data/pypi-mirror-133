...
class soea_DE_currentToBest_1_bin_templet(ea.SoeaAlgorithm):
    """
soea_DE_currentToBest_1_bin_templet : class - 差分进化DE/current-to-best/1/bin算法算法类

算法描述:
    本算法类实现的是经典的DE/current-to-best/1/bin单目标差分进化算法。算法流程如下：
    1) 初始化候选解种群。
    2) 若满足停止条件则停止，否则继续执行。
