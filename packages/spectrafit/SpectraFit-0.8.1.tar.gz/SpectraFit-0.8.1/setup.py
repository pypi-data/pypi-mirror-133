...
extras_require = \
{'all': ['ray[tune]>=1.9.1,<2.0.0',
         'tune>=0.0.9,<0.0.10',
         'hyperopt>=0.2.7,<0.3.0',
         'optuna>=2.10.0,<3.0.0'],
 'hyperopt': ['hyperopt>=0.2.7,<0.3.0'],
 'optuna': ['optuna>=2.10.0,<3.0.0'],
 'ray': ['ray[tune]>=1.9.1,<2.0.0'],
 'tune': ['tune>=0.0.9,<0.0.10']}
