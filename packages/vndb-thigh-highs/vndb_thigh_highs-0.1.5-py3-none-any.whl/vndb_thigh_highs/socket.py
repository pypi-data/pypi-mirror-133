import socket
import ssl
from .error import CertificateError, SocketError
...
class Socket:
    ...
    def connect(self):
        ...
        if ssl.match_hostname(certificate, self.config.hostname) is not None:
            raise CertificateError("Wrong certificate!")
