...
class IApplyRule(typing_extensions.Protocol):
    ...
    def rule(self, node: monocdk.CfnResource) -> "NagRuleCompliance":
...
class _IApplyRuleProxy:
    ...
    def rule(self, node: monocdk.CfnResource) -> "NagRuleCompliance":
        ...
        :param node: The CfnResource to check.
        '''
        return typing.cast("NagRuleCompliance", jsii.invoke(self, "rule", [node]))
...
class NagPack(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-nag.NagPack"):
    ...
    def _ignore_rule(
        ...
        '''
        return typing.cast(builtins.str, jsii.invoke(self, "ignoreRule", [ignores, rule_id]))
...
@jsii.enum(jsii_type="monocdk-nag.NagRuleCompliance")
...
class NagRules(metaclass=jsii.JSIIMeta, jsii_type="monocdk-nag.NagRules"):
