...
class PathSeparator(betterproto.Enum):
...
class DecisionTreeRequest(betterproto.Message):
    policy_context: "___api_v1__.PolicyContext" = betterproto.message_field(1)
    identity_context: "___api_v1__.IdentityContext" = betterproto.message_field(2)
    options: "DecisionTreeOptions" = betterproto.message_field(3)
    resource_context: "betterproto_lib_google_protobuf.Struct" = (
        betterproto.message_field(4)
    )


@dataclass(eq=False, repr=False)
class DecisionTreeOptions(betterproto.Message):
    path_separator: "PathSeparator" = betterproto.enum_field(1)


@dataclass(eq=False, repr=False)
class DecisionTreeResponse(betterproto.Message):
    path_root: str = betterproto.string_field(1)
    path: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(3)


@dataclass(eq=False, repr=False)
class IsRequest(betterproto.Message):
    policy_context: "___api_v1__.PolicyContext" = betterproto.message_field(1)
    identity_context: "___api_v1__.IdentityContext" = betterproto.message_field(2)
    resource_context: "betterproto_lib_google_protobuf.Struct" = (
...
@dataclass(eq=False, repr=False)
class Decision(betterproto.Message):
    decision: str = betterproto.string_field(1)
    is_: bool = betterproto.bool_field(2)


@dataclass(eq=False, repr=False)
class IsResponse(betterproto.Message):
    decisions: List["Decision"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class QueryOptions(betterproto.Message):
    metrics: bool = betterproto.bool_field(1)
    instrument: bool = betterproto.bool_field(2)
    trace: "TraceLevel" = betterproto.enum_field(3)
    trace_summary: bool = betterproto.bool_field(4)


@dataclass(eq=False, repr=False)
class QueryRequest(betterproto.Message):
    identity_context: "___api_v1__.IdentityContext" = betterproto.message_field(1)
    query: str = betterproto.string_field(2)
    input: str = betterproto.string_field(3)
    options: "QueryOptions" = betterproto.message_field(4)
    policy_context: "___api_v1__.PolicyContext" = betterproto.message_field(5)
    resource_context: "betterproto_lib_google_protobuf.Struct" = (
...
class QueryResponse(betterproto.Message):
    results: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(
        1
    )
    metrics: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(2)
    trace: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(3)
    trace_summary: List[str] = betterproto.string_field(4)


class AuthorizerStub(betterproto.ServiceStub):
    async def decision_tree(
        ...
        *,
        ...
        resource_context: "betterproto_lib_google_protobuf.Struct" = None
