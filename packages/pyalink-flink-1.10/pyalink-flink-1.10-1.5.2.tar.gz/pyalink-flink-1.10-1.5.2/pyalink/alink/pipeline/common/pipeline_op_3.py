...
class KerasSequentialClassificationModel(Model, LocalPredictable):
...
class KerasSequentialClassifier(Estimator):
...
class KerasSequentialRegressionModel(Model, LocalPredictable):
...
class KerasSequentialRegressor(Estimator):
...
class MultiHotEncoder(Estimator, HasLazyPrintModelInfo):
