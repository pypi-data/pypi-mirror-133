...
def create_keys_table():
   # database = r"navi.db"
    ...
    key_conn = new_db_connection()
    key_table = """CREATE TABLE IF NOT EXISTS keyssss (
                            access_key VARCHAR(85),
                            secret_key VARCHAR(85)
                            );"""
...
def create_compliance_table():
    ...
    compliance_conn = new_db_connection()
