...
def asset_export(days, ex_uuid, threads):
    start = time.time()
    print('this is asset_export start time')
    print(start)
   ...
   # drop_conn = new_db_connection()
    drop_tables('assets')
    drop_tables('tags')
    print('recreate asset table')
    create_assets_table()
    print('recreate tag table')
    create_tag_table()
    ...
    try:
        ...
        if ex_uuid == '0':
            ...
            print('printing ex_uuid for assets')
            print(ex_uuid)
        ...
        print('priting request data - assets')
        print(status)
