...
from mozilla_django_oidc_hta import views
from mozilla_django_oidc_hta.utils import import_from_settings

DEFAULT_CALLBACK_CLASS = 'mozilla_django_oidc_hta.views.OIDCAuthenticationCallbackView'
...
DEFAULT_AUTHENTICATE_CLASS = 'mozilla_django_oidc_hta.views.OIDCAuthenticationRequestView'
