...
_useAwsRequestId: bool = False
_wrapPayloadKey: Optional[str] = None
_useStatusFields: bool = False


def setup_reponse_builder(
...
def update_error_reponse(response: dict) -> dict:
    return response
