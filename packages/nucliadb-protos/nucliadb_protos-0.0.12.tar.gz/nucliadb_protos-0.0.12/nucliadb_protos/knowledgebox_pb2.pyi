...
class KnowledgeBox(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config",b"config","slug",b"slug","status",b"status","title",b"title","uuid",b"uuid"]) -> None: ...
...
class UpdateKnowledgeBoxResponse(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Status.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        OK = UpdateKnowledgeBoxResponse.Status.V(0)
        NOTFOUND = UpdateKnowledgeBoxResponse.Status.V(1)
        ERROR = UpdateKnowledgeBoxResponse.Status.V(2)
    ...
    STATUS_FIELD_NUMBER: builtins.int
    UUID_FIELD_NUMBER: builtins.int
    status: global___UpdateKnowledgeBoxResponse.Status.V = ...
    uuid: typing.Text = ...
    def __init__(self,
        *,
        status : global___UpdateKnowledgeBoxResponse.Status.V = ...,
