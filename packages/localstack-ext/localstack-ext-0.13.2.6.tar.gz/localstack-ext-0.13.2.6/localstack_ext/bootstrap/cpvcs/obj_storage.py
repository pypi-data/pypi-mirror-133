...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=Bjlxp
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:Bjlxd)->Bjlxd:
  pass
 @BjlxE
 def get(cls,requested_file_locator:Bjlxd):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=Bjlxp
 @BjlxE
 def get(cls,state_file_locator:Bjlxd,requested_storage:Bjlxd,serializers:Dict[Bjlxd,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[Bjlxd,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:Bjlxd)->Bjlxd:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:Bjlxd)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:Bjlxd)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:Bjlxd)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:Bjlxd)->Bjlxd:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[Bjlxd]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:Bjlxd,new_key:Bjlxd,referenced_by_version:Bjlxd=Bjlxp):
  pass
 @abc.abstractmethod
 def version_exists(self,key:Bjlxd)->Bjlxc:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:Bjlxd,key:Bjlxd):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:Bjlxd,new_key:Bjlxd,base_path:Bjlxd)->Bjlxc:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[Bjlxd]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[Bjlxd,Bjlxd],remote_location:Bjlxd=Bjlxp)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[Bjlxd]:
  ...
  for cpvcs_obj in args:
   if Bjlxm(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif Bjlxm(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[Bjlxd,Bjlxd],remote_location:Bjlxd=Bjlxp)->List[Union[Revision,Version]]:
