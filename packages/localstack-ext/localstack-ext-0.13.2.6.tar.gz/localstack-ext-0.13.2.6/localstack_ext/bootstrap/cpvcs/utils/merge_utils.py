...
class CPVCSMergeManager(SubtypesInstanceManager):
 @alybc
 def _is_special_case(obj)->alybN:
  return alybJ(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:alybe,to_state_files):
  raise alybW("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:alybe,from_state_files:alybe,to_state_files:alybe):
  raise alybW("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:alybe)->Dict[alybe,alybe]:
