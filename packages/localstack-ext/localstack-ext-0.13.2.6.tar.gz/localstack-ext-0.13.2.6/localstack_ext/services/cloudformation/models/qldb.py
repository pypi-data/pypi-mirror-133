...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=CHqhf,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @CHqhO
 def add_defaults(resource:Dict,stack_name:CHqhG):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=CHqhP)
