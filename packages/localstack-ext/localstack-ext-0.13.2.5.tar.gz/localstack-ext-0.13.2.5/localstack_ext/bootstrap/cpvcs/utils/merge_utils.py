...
class CPVCSMergeManager(SubtypesInstanceManager):
 @DryFJ
 def _is_special_case(obj)->DryFk:
  return DryFB(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:DryFN,to_state_files):
  raise DryFG("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:DryFN,from_state_files:DryFN,to_state_files:DryFN):
  raise DryFG("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:DryFN)->Dict[DryFN,DryFN]:
