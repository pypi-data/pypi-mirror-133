...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=DjNzJ
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:DjNzd)->DjNzd:
  pass
 @DjNzp
 def get(cls,requested_file_locator:DjNzd):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=DjNzJ
 @DjNzp
 def get(cls,state_file_locator:DjNzd,requested_storage:DjNzd,serializers:Dict[DjNzd,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[DjNzd,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:DjNzd)->DjNzd:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:DjNzd)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:DjNzd)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:DjNzd)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:DjNzd)->DjNzd:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[DjNzd]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:DjNzd,new_key:DjNzd,referenced_by_version:DjNzd=DjNzJ):
  pass
 @abc.abstractmethod
 def version_exists(self,key:DjNzd)->DjNzF:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:DjNzd,key:DjNzd):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:DjNzd,new_key:DjNzd,base_path:DjNzd)->DjNzF:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[DjNzd]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[DjNzd,DjNzd],remote_location:DjNzd=DjNzJ)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[DjNzd]:
  ...
  for cpvcs_obj in args:
   if DjNzO(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif DjNzO(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[DjNzd,DjNzd],remote_location:DjNzd=DjNzJ)->List[Union[Revision,Version]]:
