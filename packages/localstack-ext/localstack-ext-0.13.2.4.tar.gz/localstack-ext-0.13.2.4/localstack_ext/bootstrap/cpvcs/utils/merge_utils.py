...
class CPVCSMergeManager(SubtypesInstanceManager):
 @XrWdI
 def _is_special_case(obj)->XrWdK:
  return XrWdY(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:XrWdD,to_state_files):
  raise XrWdG("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:XrWdD,from_state_files:XrWdD,to_state_files:XrWdD):
  raise XrWdG("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:XrWdD)->Dict[XrWdD,XrWdD]:
