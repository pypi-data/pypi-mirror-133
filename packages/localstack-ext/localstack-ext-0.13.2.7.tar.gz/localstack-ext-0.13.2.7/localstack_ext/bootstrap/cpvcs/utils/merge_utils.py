...
class CPVCSMergeManager(SubtypesInstanceManager):
 @OztEV
 def _is_special_case(obj)->OztEC:
  return OztEG(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:OztES,to_state_files):
  raise OztEJ("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:OztES,from_state_files:OztES,to_state_files:OztES):
  raise OztEJ("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:OztES)->Dict[OztES,OztES]:
