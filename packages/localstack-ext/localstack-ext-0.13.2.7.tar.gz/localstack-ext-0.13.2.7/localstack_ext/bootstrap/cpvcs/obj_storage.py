...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=mKblG
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:mKblt)->mKblt:
  pass
 @mKbld
 def get(cls,requested_file_locator:mKblt):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=mKblG
 @mKbld
 def get(cls,state_file_locator:mKblt,requested_storage:mKblt,serializers:Dict[mKblt,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[mKblt,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:mKblt)->mKblt:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:mKblt)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:mKblt)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:mKblt)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:mKblt)->mKblt:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[mKblt]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:mKblt,new_key:mKblt,referenced_by_version:mKblt=mKblG):
  pass
 @abc.abstractmethod
 def version_exists(self,key:mKblt)->mKblr:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:mKblt,key:mKblt):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:mKblt,new_key:mKblt,base_path:mKblt)->mKblr:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[mKblt]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[mKblt,mKblt],remote_location:mKblt=mKblG)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[mKblt]:
  ...
  for cpvcs_obj in args:
   if mKblu(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif mKblu(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[mKblt,mKblt],remote_location:mKblt=mKblG)->List[Union[Revision,Version]]:
