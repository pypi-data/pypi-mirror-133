...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=MmhRx,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @MmhRX
 def add_defaults(resource:Dict,stack_name:MmhRT):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=MmhRy)
