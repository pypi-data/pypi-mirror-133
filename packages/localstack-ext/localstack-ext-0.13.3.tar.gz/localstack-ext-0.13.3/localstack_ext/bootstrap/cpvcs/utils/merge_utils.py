...
class CPVCSMergeManager(SubtypesInstanceManager):
 @NUJnl
 def _is_special_case(obj)->NUJno:
  return NUJnD(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:NUJnW,to_state_files):
  raise NUJna("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:NUJnW,from_state_files:NUJnW,to_state_files:NUJnW):
  raise NUJna("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:NUJnW)->Dict[NUJnW,NUJnW]:
