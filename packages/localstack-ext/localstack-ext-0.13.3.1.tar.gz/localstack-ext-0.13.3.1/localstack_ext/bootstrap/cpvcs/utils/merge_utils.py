...
class CPVCSMergeManager(SubtypesInstanceManager):
 @iNvTg
 def _is_special_case(obj)->iNvTD:
  return iNvTV(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:iNvTL,to_state_files):
  raise iNvTo("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:iNvTL,from_state_files:iNvTL,to_state_files:iNvTL):
  raise iNvTo("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:iNvTL)->Dict[iNvTL,iNvTL]:
