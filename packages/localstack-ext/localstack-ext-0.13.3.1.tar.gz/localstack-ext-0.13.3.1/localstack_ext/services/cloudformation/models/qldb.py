...
class QLDBLedger(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=bQGHr,**kwargs):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return result
 @bQGHe
 def add_defaults(resource:Dict,stack_name:bQGHo):
 ...
 def get_deploy_templates():
  def _delete_ledger(resource_id,resources,*args,**kwargs):
   ...
   qldb.update_ledger(Name=ledger_name,DeletionProtection=bQGHF)
