        ...
        if self.test_case_creation_mode:
            ...
            try:
                ...
                if response.get('success', False):
                    ...
                    real_elem = self._match_bounding_box_to_web_element(pred_elem,
                                                                             multiplier=self.multiplier)
                    element = testai_elem(real_elem.parent, real_elem._id, pred_elem, self.driver, self.multiplier)
                else:
    ...
    def _upload_screenshot_if_necessary(self, element_name):
        ...
        try:
            ...
            if response['success'] == True:
                ...
                if r.status_code != 200:
                    raise Exception('Error uploading screenshot to remote')
                else:
                    pass
                return key
        except Exception:
