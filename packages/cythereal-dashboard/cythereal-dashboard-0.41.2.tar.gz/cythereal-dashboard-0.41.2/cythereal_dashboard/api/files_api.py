...
class FilesApi(object):
    ...
    def download_file(self, file_hash, **kwargs):  # noqa: E501
        ...
        :param bool zipped: Should the download come in a zip file? 
        :return: file
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def download_file_with_http_info(self, file_hash, **kwargs):  # noqa: E501
        ...
        all_params = ['file_hash', 'zipped']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json', 'application/octet-stream', 'application/zip'])  # noqa: E501
    ...
    def get_owned_files(self, **kwargs):  # noqa: E501
        ...
        :param str sha1: A cryptographic sha1 hash of a file.
    ...
    def get_owned_files_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['_date', 'start_date', 'end_date', 'sha1', 'public', 'only_top_level', 'page', 'limit', 'file_type', 'children_file_type', 'children_only', 'group_by_parents', 'include_descendants', 'all_keys', 'keys']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'sha1' in params and not re.search(r'^[a-fA-F0-9]{40}$', params['sha1']):  # noqa: E501
            raise ValueError("Invalid value for parameter `sha1` when calling `get_owned_files`, must conform to the pattern `/^[a-fA-F0-9]{40}$/`")  # noqa: E501
        collection_formats = {}
    ...
    def list_av_data(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their avdata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_av_data(files, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] files: A list of file hashes (required)
        :return: FileAVDataListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_av_data_with_http_info(files, **kwargs)  # noqa: E501
        else:
            (data) = self.list_av_data_with_http_info(files, **kwargs)  # noqa: E501
            return data

    def list_av_data_with_http_info(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their avdata  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_av_data_with_http_info(files, async_req=True)
        >>> result = thread.get()
        ...
        if ('files' not in params or
            ...
            raise ValueError("Missing the required parameter `files` when calling `list_av_data`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FileAVDataListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_binary_data(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their match and label data  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_binary_data(files, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] files: A list of file hashes (required)
        :return: FileBinaryDataListResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_binary_data_with_http_info(files, **kwargs)  # noqa: E501
        else:
            (data) = self.list_binary_data_with_http_info(files, **kwargs)  # noqa: E501
            return data

    def list_binary_data_with_http_info(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their match and label data  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_binary_data_with_http_info(files, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_binary_data" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'files' is set
        if ('files' not in params or
                params['files'] is None):
            raise ValueError("Missing the required parameter `files` when calling `list_binary_data`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FileBinaryDataListResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
