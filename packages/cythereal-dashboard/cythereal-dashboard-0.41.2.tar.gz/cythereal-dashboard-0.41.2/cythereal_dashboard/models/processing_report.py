...
class ProcessingReport(object):
    ...
    def __init__(self, report_date=None, new_file_count=None, bin_count=None, est_success_bin_count=None, binhash_count=None, proc_count=None, prochash_count=None, sims_nodes_count=None, sims_rel_count=None, binhash_compression=None, prochash_compression=None, obj_counts=None, processed_counts=None, time_stats=None):  # noqa: E501
        """ProcessingReport - a model defined in Swagger"""  # noqa: E501

        self._report_date = None
        self._new_file_count = None
        ...
        if new_file_count is not None:
            self.new_file_count = new_file_count
    ...
    @property
    def new_file_count(self):
        """Gets the new_file_count of this ProcessingReport.  # noqa: E501


        :return: The new_file_count of this ProcessingReport.  # noqa: E501
        :rtype: int
        """
        return self._new_file_count

    @new_file_count.setter
    def new_file_count(self, new_file_count):
        """Sets the new_file_count of this ProcessingReport.


        :param new_file_count: The new_file_count of this ProcessingReport.  # noqa: E501
        :type: int
        """

        self._new_file_count = new_file_count
