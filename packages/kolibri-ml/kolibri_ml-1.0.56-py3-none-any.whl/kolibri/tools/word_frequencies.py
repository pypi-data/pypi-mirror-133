...
from kolibri.tokenizers.regex_tokenizer import tokenize
CACHE_SIZE = 100000
...
patterns_directory=resources.list_directory_content(str(Path('modules', 'statistics', 'wordfrequencies')))
...
def read_cBpack(filename):
    ...
    filename = resources.get(str(Path('modules', 'statistics', 'wordfrequencies',filename))).path
