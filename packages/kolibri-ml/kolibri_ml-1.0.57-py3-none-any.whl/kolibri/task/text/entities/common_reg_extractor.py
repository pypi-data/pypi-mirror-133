...
from kolibri.core.entity import Entity, Entities
from kolibri.data.resources import resources
from pathlib import Path
from kdmt.file import read_json_file

deafault_patterns_file=resources.get(str(Path('modules', 'regexes', 'defaults.json'))).path
default_regexes=read_json_file(deafault_patterns_file)

entity_patterns_file=resources.get(str(Path('modules', 'regexes', 'entities.json'))).path
entity_regexes=read_json_file(entity_patterns_file)
