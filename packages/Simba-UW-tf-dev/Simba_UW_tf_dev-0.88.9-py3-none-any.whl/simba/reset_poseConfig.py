...
def reset_DiagramSettings(master):
    ...
    oripiclist = ['Picture1.png',
                     ...
                     'Picture7.png',
                     'Picture8.png',
                    'Picture9.png','Picture10.png','Picture11.png','Picture12.png', 'Picture13.png']
    ...
    print('Pose-estimation configurations reset: All user-defined poses removed.')
    master.destroy()
