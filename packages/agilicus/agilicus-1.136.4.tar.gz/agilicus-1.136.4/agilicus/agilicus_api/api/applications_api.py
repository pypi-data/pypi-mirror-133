"""
    ...
    The version of the OpenAPI document: 2021.12.13
...
class ApplicationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        if self.create_agent is None:
            self.create_agent = _Endpoint(
                settings={
                    'response_type': (SecureAgent,),
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v2/secure_agents',
        ...
        if self.delete_agent is None:
            self.delete_agent = _Endpoint(
                settings={
                    'response_type': None,
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v2/secure_agents/{agent_id}',
        ...
        if self.get_agent is None:
            self.get_agent = _Endpoint(
                settings={
                    'response_type': (SecureAgent,),
                    'auth': [
                        'token-valid'
        ...
        if self.list_agents is None:
            self.list_agents = _Endpoint(
                settings={
                    'response_type': (ListSecureAgentResponse,),
                    'auth': [
                        'token-valid'
                    ],
                    'endpoint_path': '/v2/secure_agents',
        ...
        def __replace_agent(
            ...
            **kwargs
            ...
            Keyword Args:
                org_id (str): Organisation Unique identifier. [optional]
                secure_agent (SecureAgent): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        if self.replace_agent is None:
            self.replace_agent = _Endpoint(
                settings={
                    'response_type': (SecureAgent,),
                    'auth': [
                        'token-valid'
