...
class cshoreio(base):
    ...
    def _replaceDefaultParams(self):
        ...
        self.infile = {
            ...
            'iwtran': self.newModelParams.pop('iwtran', 0),
            ...
            'veg_extent': self.newModelParams.pop('veg_extend', np.array([.7, 1])),
            ...
            'rwh': self.newModelParams.pop('rwh', 0.01),  # numerical rununp wire height
