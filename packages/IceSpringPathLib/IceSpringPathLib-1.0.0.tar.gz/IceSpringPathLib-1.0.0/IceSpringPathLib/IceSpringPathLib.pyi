...
class Path(PurePath):
    ...
    def read_text(self, encoding: Optional[str] = ..., errors: Optional[str] = ..., newline: Optional[str] = ...) -> str: ...
    def samefile(self, other_path: Union[str, bytes, int, Path]) -> bool: ...
    def write_bytes(self, data: bytes) -> int: ...
    def write_text(self, data: str, encoding: Optional[str] = ..., errors: Optional[str] = ..., newline: Optional[str] = ...) -> int: ...
