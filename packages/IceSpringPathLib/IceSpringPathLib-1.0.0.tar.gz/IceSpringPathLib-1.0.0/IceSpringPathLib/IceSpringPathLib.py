...
class Path(PurePath):
    ...
    def open(self, mode='r', buffering=-1, encoding='utf8',
    ...
    def read_text(self, encoding='utf8', errors=None, newline = '\n'):
        """
    ...
    def write_text(self, data, encoding='utf8', errors=None, newline = '\n'):
        """
