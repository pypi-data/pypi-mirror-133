...
class Application(Sanic):
    ...
    async def boot(self, _application: Application, _loop: AbstractEventLoop) -> None:
        pass

    async def shutdown(self, _application: Application, _loop: AbstractEventLoop) -> None:
        pass
