...
class BaseScene(Drawable, metaclass=ABCMeta):
    """
    A base class for :py:class:`~Scene` and :py:class:`~SceneSequence`
    that provides a little bit of shared base functionality.
...
class Scene(BaseScene):
    ...
    def at(self, time: float) -> '_SceneAt':
        return _SceneAt(self, time)
