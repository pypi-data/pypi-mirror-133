...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'pydruid>=0.4.1'],
        setup_requires=['setuptools', 'wheel'],
        extras_require={'apache.hive': ['apache-airflow-providers-apache-hive']},
        classifiers=[
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-apache-druid/2.2.0/',
