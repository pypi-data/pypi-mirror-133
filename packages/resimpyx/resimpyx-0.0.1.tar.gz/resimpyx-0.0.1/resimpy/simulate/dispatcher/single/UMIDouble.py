...
class umiDouble(object):
    ...
    def ondemandSeqErrs(self, ):
        ...
        pcr_params = {
            ...
            'transloc_rate': self.args['transloc_rate'],
...
if __name__ == "__main__":
    ...
    simu_params = {
        'init_seq_setting': {
            ...
            'umi_lib_fp': to('data/simu/transloc/trimer/'),
        ...
        'seed': None,
        'write': {
            'fastq_fp': to('data/simu/transloc/trimer/'),
            'fastq_fn': '',
        }
    }
    p = umiDouble(simu_params)
