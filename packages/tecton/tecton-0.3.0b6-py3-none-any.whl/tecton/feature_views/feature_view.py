...
class OnDemandFeatureView(FeatureDefinition):
    ...
    **Do not instantiate this class directly.** Use :class:`tecton.on_demand_feature_view` instead.
    ...
    def run(self, **mock_inputs: pandas.DataFrame):
        ...
        :param mock_inputs: Required. Keywork args with the same expected keys
            as the OnDemandFeatureView's inputs parameter. Each input should map
...
def batch_feature_view(
    *,
    ...
    :param family: Family of this Feature View, used to group Tecton Objects.
    :param tags: Tags associated with this Tecton Object (key-value pairs of arbitrary metadata).
    :param timestamp_key: The column name that refers to the the timestamp for records that are produced by the feature view. (Default: will infer if one column is a Timestamp type.)
    ...
    :return: An object of type :class:`tecton.feature_views.MaterializedFeatureView`.
