...
class Request():
    ...
    def patch(self, url, params={}, timeout=5, header=None, **kwargs):
        return requests.patch(url, data=params, headers=header, timeout=timeout, **kwargs)

    def delete(self, url, params={}, timeout=5, header=None, **kwargs):
        return requests.delete(url, data=params, headers=header, timeout=timeout, **kwargs)
