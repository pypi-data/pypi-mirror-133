...
from codefs.core import Str, Int, Bool
...
class Opener(BaseOpener):
    ...
    def open_fs(self, fs_url: str, parse_result: ParseResult, writeable: bool, create: bool, cwd: str) -> Union[UserFS, OrgFS]:
        ...
        try:
            ...
            kwargs["login_or_token"] = kwargs.pop("login", None) if kwargs.pop("password", None) else kwargs.pop("token", None)
