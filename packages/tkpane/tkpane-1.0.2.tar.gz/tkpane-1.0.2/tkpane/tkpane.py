...
class PaneDataHandler(CbHandler):
    """Define a callback function that takes a single argument consisting of
    a dictionary of a pane's own data values."""
...
class PaneKeyHandler(CbHandler):
    """Define a callback function that takes a single argument consisting of
    a list of a pane's own data keys."""
...
class AllDataHandler(CbHandler):
    """Define a callback function that takes a single argument consisting of
    a dictionary of all of a pane's data values."""
...
class PaneAllDataHandler(CbHandler):
    """Define a callback function that takes a single argument consisting of
    the calling pane object and a dictionary of all of that pane's data values."""
