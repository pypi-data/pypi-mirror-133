...
class WebDriverElement(ElementAPI):
    ...
    def screenshot(self, name='', suffix='.png', full=False, unique_file=True, deviationX=0, deviationY=0):
        ...
        target = self.screenshot_as_png(deviationX, deviationY)
    ...
    def screenshot_as_png(self, deviationX=0, deviationY=0):
        try:
        ...
        x, y = location['x']+deviationX, location['y']+deviationY
