...
#   timestamp: 2022-01-05T21:16:31+00:00
...
class IsccProperties(BaseModel):
    ...
    properties: Optional[Dict[str, Any]] = Field(
        None,
        description=(
            "Descriptive, industry-sector or use-case specific metadata in JSON or JSON-LD format."
            " If properties are provided they are the sole inpute for `metahash` calculation. Also"
