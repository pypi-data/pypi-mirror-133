...
!!! tip
    ...
    So, you would be able to, for example, share the same data from a Django application in a database with a Squall application. Or gradually migrate a Django application using the same database.

    And your users would be able to login from your Django app or from your **Squall** app, at the same time.
...
You can learn how to use them and how they are integrated into **Squall** later in the **Advanced User Guide**.

## Recap

With what you have seen up to now, you can set up a secure **Squall** application using standards like OAuth2 and JWT.
...
**Squall** doesn't make any compromise with any database, data model or tool.

It gives you all the flexibility to choose the ones that fit your project the best.

And you can use directly many well maintained and widely used packages like `passlib` and `python-jose`, because **Squall** doesn't require any complex mechanisms to integrate external packages.
