...
An origin is the combination of protocol (`http`, `https`), domain (`myapp.com`, `localhost`, `localhost.mtag.dev`), and port (`80`, `443`, `8080`).
...
You can configure it in your **Squall** application using the `CORSMiddleware`.

* Import `CORSMiddleware`.
* Create a list of allowed origins (as strings).
* Add it as a "middleware" to your **Squall** application.
