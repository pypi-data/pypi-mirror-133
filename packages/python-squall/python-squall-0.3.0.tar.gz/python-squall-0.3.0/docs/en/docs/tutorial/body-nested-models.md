...
With **Squall**, you can define, validate, document, and use arbitrarily deeply nested models (thanks to Pydantic).
...
This would mean that **Squall** would expect a body similar to:
...
Again, doing just that declaration, with **Squall** you get:
...
With **Squall** you have the maximum flexibility provided by Pydantic models, while keeping your code simple, short and elegant.
