...
But, you already know how to easily create automatic documentation for an API with **Squall**.
...
It should look just like a normal Squall *path operation*:
