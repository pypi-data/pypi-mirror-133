...
This is just a **quick tutorial / refresher** about Python type hints. It covers only the minimum necessary to use them with **Squall**... which is actually very little.

**Squall** is all based on these type hints, they give it many advantages and benefits.

But even if you never use **Squall**, you would benefit from learning a bit about them.
...
This is also the main place you would use them with **Squall**.
...
**Squall** is all based on Pydantic.

You will see a lot more of all this in practice in the [Tutorial - User Guide](tutorial/index.md){.internal-link target=_blank}.

## Type hints in **Squall**

**Squall** takes advantage of these type hints to do several things.

With **Squall** you declare parameters with type hints and you get:

* **Editor support**.
* **Type checks**.

...and **Squall** uses the same declarations to:
...
The important thing is that by using standard Python types, in a single place (instead of adding more classes, decorators, etc), **Squall** will do a lot of the work for you.
