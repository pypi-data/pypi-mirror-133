...
class Checkers(commands.Cog):
    ...
    async def checkers(self, ctx, member: discord.Member):
        """To win a game of checkers, your goal is to capture all your opponent's pieces. You can move faster by jumping your opponent's pieces."""
        ...
        while True:
            ...
            inp = await self.bot.wait_for(
                "message",
                check=lambda m: m.author == (ctx.author if turn == "r" else member)
