...
class Hangman(commands.Cog):
    ...
    async def command(self, ctx: commands.Context):
        """The bot chooses secret word, the player tries to guess the word by asking what letters it contains. However, every wrong guess brings them one step closer to losing."""
