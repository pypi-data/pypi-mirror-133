...
class SNL(commands.Cog):
	...
	async def snl(self, ctx, players: commands.Greedy[discord.Member]=[]):
		"""The object of the game is to be the first player to reach the end by moving across the board from square one to the final square. you move left to right across the first row, then move up to the second and move right to left, and so on."""
