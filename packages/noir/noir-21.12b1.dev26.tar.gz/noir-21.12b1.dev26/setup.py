...
setup(
    ...
    url="https://github.com/venthur/noir",
    project_urls={"Changelog": "https://github.com/venthur/noir/blob/master/CHANGES.md"},
    license="MIT",
