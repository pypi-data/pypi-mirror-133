...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'dnspython>=1.13.0,<3.0.0', 'pymongo>=3.6.0,<4.0.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-mongo/2.3.0/',
