...
class PythonEnvironments(object):
    ...
    def __init__(self, environment=None):  # noqa: E501
        """PythonEnvironments - a model defined in Swagger"""  # noqa: E501
    ...
    def environment(self, environment):
        """Sets the environment of this PythonEnvironments.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PythonEnvironments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PythonEnvironments):
            return False
