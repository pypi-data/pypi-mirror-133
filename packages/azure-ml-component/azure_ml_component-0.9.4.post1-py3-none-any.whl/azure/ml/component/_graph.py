...
class _GraphEntityBuilder(object):
    ...
    def build_graph_entity(self, for_registration: bool = False, enable_subpipeline_registration: bool = False,
        ...
        for module in self._modules:
            ...
            pipeline_parameters = _flatten_pipeline_parameters(self._context.pipeline_parameters)
            module_node_run_settings.append(
                self._produce_module_runsettings(
                    graph_entity, module, module_node, pipeline_parameters, self._context.workspace))
    ...
    def _append_pipeline_parameter_to_interface(
        ...
        if not exist:
            ...
            annotation = param_in_definition._annotation if param_in_definition else None
            if annotation:
                parameter = Parameter(
