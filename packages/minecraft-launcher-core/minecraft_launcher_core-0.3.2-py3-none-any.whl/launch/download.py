...
class Download:
    ...
    def main(self,name,minecraft_dir):
        test.download_version_json(name,minecraft_dir)
        test.download_core_jar(name,minecraft_dir)
        test.download_assets(name,minecraft_dir)
        test.download_lib(name,minecraft_dir)
