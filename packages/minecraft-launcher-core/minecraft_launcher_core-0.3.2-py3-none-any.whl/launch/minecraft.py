...
class Minecraft:
    ...
    def launch(self,uuid='0000000000',access_token='0000000',size=[854,480],memorym=128,memoryx=1024,username='test',java=r'java',launcher=['unknow_launcher','001'],is_ent=False):
