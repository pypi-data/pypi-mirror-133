...
class Minecraft:
    ...
    def launch(self,size=[854,480],memorym=128,memoryx=1024,username='test',java=r'java',launcher=['unknow_launcher','001'],is_ent=False):
        ...
        arguments = arguments.replace('${assets_index_name}',f'{a[0]}.{a[1]}')
