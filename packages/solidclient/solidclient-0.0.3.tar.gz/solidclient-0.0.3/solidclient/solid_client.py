...
_OID_CALLBACK_PATH = '/casemanagement/oauth/callback'


class SolidSession:

    def __init__(self, keypair=None, access_token=None, state_storage=None):
        """
    ...
    def get_callback_url():
        return f"http://{_HOST}:{_PORT}{_OID_CALLBACK_PATH}"
    ...
    def get_authorization_endpoint_uri(self, redirect_url=None):
        ...
        self.state_storage[state] = {
            ...
            'solid_redirect_url': redirect_url
        }
