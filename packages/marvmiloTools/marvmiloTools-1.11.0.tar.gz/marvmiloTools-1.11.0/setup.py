...
setup(
  ...
  version = '1.11.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/marvmilo/marvmiloTools/archive/refs/tags/v1.11.0.tar.gz',    # I explain this later on
