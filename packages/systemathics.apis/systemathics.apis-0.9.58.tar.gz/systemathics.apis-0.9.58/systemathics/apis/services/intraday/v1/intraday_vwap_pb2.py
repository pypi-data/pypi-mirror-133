...
_INTRADAYVWAPSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='constraints', full_name='systemathics.apis.services.intraday.v1.IntradayVwapsRequest.constraints', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='adjustment', full_name='systemathics.apis.services.intraday.v1.IntradayVwapsRequest.adjustment', index=2,
...
_INTRADAYVWAP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='date', full_name='systemathics.apis.services.intraday.v1.IntradayVwap.date', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INTRADAYVWAP.fields_by_name['date'].message_type = google_dot_type_dot_date__pb2._DATE
