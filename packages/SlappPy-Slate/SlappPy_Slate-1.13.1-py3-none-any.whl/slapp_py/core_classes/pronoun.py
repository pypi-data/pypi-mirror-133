...
class Pronoun:
    ...
    def __init__(self, value: Union[str, int, PronounFlags] = PronounFlags.NONE, source: Optional[UUID] = None):
        ...
        if not source:
            from slapp_py.core_classes import builtins
            self.source = builtins.BuiltinSource.guid
    ...
    def to_dict(self) -> dict:
        ...
        if self.source and self.source != BuiltinSource.guid:
            result["S"] = self.source
        return result
...
if __name__ == '__main__':
    test = Pronoun("they/them or she/her")
    print(test.__str__())
