...
class Team:
    ...
    def div_history(self) -> str:
        ...
        if self.current_div.is_unknown:
            ...
            return ' ⬅ '.join([d.__str__() for d in self.division_information.get_divs_unordered()[:3]])
    ...
    def from_dict(obj: dict) -> 'Team':
        ...
        return Team(
            ...
            division_information=DivisionsHandler.from_dict(obj.get("Divisions")),
    ...
    def get_best_div(self, last_n_divisions: int = 3) -> Division:
        ...
        if self.current_div.is_unknown:
            ...
            for div in self.division_information.get_divs_unordered()[:last_n_divisions]:
                if div < best_div:
                    best_div = div
            return best_div
