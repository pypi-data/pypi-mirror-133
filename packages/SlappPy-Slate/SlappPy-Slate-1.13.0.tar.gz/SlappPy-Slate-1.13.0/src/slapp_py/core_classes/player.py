...
class Player:
    ...
    def filter_to_source(self, source_id: Union[str, UUID]) -> 'Player':
        ...
        return Player(
            ...
            teams_information=self.teams_information.filter_to_source(search_uuid),
            battlefy=self.battlefy.filter_to_source(search_uuid),
            discord=self.discord.filter_to_source(search_uuid),
            fc_information=self.fc_information.filter_to_source(search_uuid),
            skill=None,
            ...
            top500=self.top500,
            pronoun=self.pronoun if self.pronoun.source == search_uuid else None,
            guid=self.guid)
    ...
    def from_dict(obj: dict) -> 'Player':
        ...
        return Player(
            ...
            pronoun=Pronoun.from_dict(obj.get("Pro")),
