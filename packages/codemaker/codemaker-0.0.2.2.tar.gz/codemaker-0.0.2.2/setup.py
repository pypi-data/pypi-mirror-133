...
setuptools.setup(
    executable=True,
    name="codemaker",  # Replace with your own username
    version=version,
    author="Wang Pei",
    author_email="1535376447@qq.com",
    description="Utils to easily generate code, speed up your workflow.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://gitee.com/peiiii/codemaker",
    packages=packages,
    package_dir={'codemaker': 'codemaker'},
    install_requires=[
        'jinja2',
        'pyyaml',
        'fire'
    ...
    entry_points={
        'console_scripts': [
            'codemaker = codemaker.clitools.cli:main',
        ]
    },
