 ...
 configs={
    "app":
        ...
        "models":
            [],
        "requirements":
            ["flask","sanitizy","flask-limiter","flask-admin","flask-debugtoolbar","firebase_admin","google-cloud-storage","Flask-reCaptcha","Flask-Mail","werkzeug","gunicorn","itsdangerous","Jinja2","psycopg2","pyodbc","cx_Oracle"],
        "pip":
