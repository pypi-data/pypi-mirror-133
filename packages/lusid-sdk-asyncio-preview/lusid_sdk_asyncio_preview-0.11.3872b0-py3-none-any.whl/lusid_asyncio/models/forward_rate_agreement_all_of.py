...
class ForwardRateAgreementAllOf(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, dom_ccy=None, fixing_date=None, fra_rate=None, notional=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        """ForwardRateAgreementAllOf - a model defined in OpenAPI"
    ...
    @property
    def start_date(self):
        """Gets the start_date of this ForwardRateAgreementAllOf.  # noqa: E501

        The start date of the instrument. This is normally synonymous with the trade-date.  # noqa: E501

        :return: The start_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this ForwardRateAgreementAllOf.

        The start date of the instrument. This is normally synonymous with the trade-date.  # noqa: E501

        :param start_date: The start_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :type start_date: datetime
        """
    ...
    def maturity_date(self):
        """Gets the maturity_date of this ForwardRateAgreementAllOf.  # noqa: E501
        ...
        :return: The maturity_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def maturity_date(self, maturity_date):
        """Sets the maturity_date of this ForwardRateAgreementAllOf.

        The final maturity date of the instrument. This means the last date on which the instruments makes a payment of any amount.  For the avoidance of doubt, that is not necessarily prior to its last sensitivity date for the purposes of risk; e.g. instruments such as  Constant Maturity Swaps (CMS) often have sensitivities to rates beyond their last payment date.  # noqa: E501

        :param maturity_date: The maturity_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :type maturity_date: datetime
        """
    ...
    @property
    def dom_ccy(self):
        """Gets the dom_ccy of this ForwardRateAgreementAllOf.  # noqa: E501

        The domestic currency of the instrument.  # noqa: E501

        :return: The dom_ccy of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def dom_ccy(self, dom_ccy):
        """Sets the dom_ccy of this ForwardRateAgreementAllOf.

        The domestic currency of the instrument.  # noqa: E501

        :param dom_ccy: The dom_ccy of this ForwardRateAgreementAllOf.  # noqa: E501
        :type dom_ccy: str
        """
    ...
    def fixing_date(self):
        """Gets the fixing_date of this ForwardRateAgreementAllOf.  # noqa: E501

        The date at which the rate to be paid, the reference rate, is confirmed/observed.  # noqa: E501

        :return: The fixing_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: datetime
        """
    ...
    def fixing_date(self, fixing_date):
        """Sets the fixing_date of this ForwardRateAgreementAllOf.

        The date at which the rate to be paid, the reference rate, is confirmed/observed.  # noqa: E501

        :param fixing_date: The fixing_date of this ForwardRateAgreementAllOf.  # noqa: E501
        :type fixing_date: datetime
        """
    ...
    @property
    def fra_rate(self):
        """Gets the fra_rate of this ForwardRateAgreementAllOf.  # noqa: E501

        The rate at which the FRA is traded.  # noqa: E501

        :return: The fra_rate of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def fra_rate(self, fra_rate):
        """Sets the fra_rate of this ForwardRateAgreementAllOf.

        The rate at which the FRA is traded.  # noqa: E501

        :param fra_rate: The fra_rate of this ForwardRateAgreementAllOf.  # noqa: E501
        :type fra_rate: float
        """
    ...
    @property
    def notional(self):
        """Gets the notional of this ForwardRateAgreementAllOf.  # noqa: E501

        The amount for which the FRA is traded.  # noqa: E501

        :return: The notional of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def notional(self, notional):
        """Sets the notional of this ForwardRateAgreementAllOf.

        The amount for which the FRA is traded.  # noqa: E501

        :param notional: The notional of this ForwardRateAgreementAllOf.  # noqa: E501
        :type notional: float
        """
    ...
    def instrument_type(self):
        """Gets the instrument_type of this ForwardRateAgreementAllOf.  # noqa: E501

        The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption  # noqa: E501

        :return: The instrument_type of this ForwardRateAgreementAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_type(self, instrument_type):
        """Sets the instrument_type of this ForwardRateAgreementAllOf.

        The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption  # noqa: E501

        :param instrument_type: The instrument_type of this ForwardRateAgreementAllOf.  # noqa: E501
        :type instrument_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ForwardRateAgreementAllOf):
            return False
