...
class InstrumentDefinition(object):
    ...
    def __init__(self, name=None, identifiers=None, properties=None, look_through_portfolio_id=None, definition=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type identifiers: dict[str, lusid_asyncio.InstrumentIdValue]
        ...
        :type look_through_portfolio_id: lusid_asyncio.ResourceId
        :param definition: 
        :type definition: lusid_asyncio.LusidInstrument
    ...
    def identifiers(self):
        ...
        :rtype: dict[str, lusid_asyncio.InstrumentIdValue]
        """
