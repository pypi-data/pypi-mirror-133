...
class TypedResourceId(object):
    ...
    def __init__(self, id_type_scope=None, id_type_code=None, code=None, local_vars_configuration=None):  # noqa: E501
