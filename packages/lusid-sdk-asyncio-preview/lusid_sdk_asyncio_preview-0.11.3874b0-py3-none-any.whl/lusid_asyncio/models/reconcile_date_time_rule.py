...
class ReconcileDateTimeRule(object):
    ...
    def __init__(self, comparison_type=None, tolerance=None, applies_to=None, rule_type=None, local_vars_configuration=None):  # noqa: E501
        """ReconcileDateTimeRule - a model defined in OpenAPI"
    ...
    def comparison_type(self):
        """Gets the comparison_type of this ReconcileDateTimeRule.  # noqa: E501

        The available values are: Exact, AbsoluteDifference  # noqa: E501

        :return: The comparison_type of this ReconcileDateTimeRule.  # noqa: E501
        :rtype: str
        """
    ...
    def comparison_type(self, comparison_type):
        """Sets the comparison_type of this ReconcileDateTimeRule.

        The available values are: Exact, AbsoluteDifference  # noqa: E501

        :param comparison_type: The comparison_type of this ReconcileDateTimeRule.  # noqa: E501
        :type comparison_type: str
        """
    ...
    @property
    def tolerance(self):
        """Gets the tolerance of this ReconcileDateTimeRule.  # noqa: E501

        For a numeric type only (i.e. decimal, integer, date or datetime offset possibly controversially), this is the quantity used in the comparison.  The units of the tolerance must be set appropriately for the item being compared.  For a number such as a currency or amount that will be a simple quantity, for a DateTime or DateTimeOffset it should be days. If fewer than a single day then this should be  passed as a fraction.  # noqa: E501

        :return: The tolerance of this ReconcileDateTimeRule.  # noqa: E501
        :rtype: float
        """
    ...
    def tolerance(self, tolerance):
        """Sets the tolerance of this ReconcileDateTimeRule.

        For a numeric type only (i.e. decimal, integer, date or datetime offset possibly controversially), this is the quantity used in the comparison.  The units of the tolerance must be set appropriately for the item being compared.  For a number such as a currency or amount that will be a simple quantity, for a DateTime or DateTimeOffset it should be days. If fewer than a single day then this should be  passed as a fraction.  # noqa: E501

        :param tolerance: The tolerance of this ReconcileDateTimeRule.  # noqa: E501
        :type tolerance: float
        """
    ...
    @property
    def applies_to(self):
        """Gets the applies_to of this ReconcileDateTimeRule.  # noqa: E501


        :return: The applies_to of this ReconcileDateTimeRule.  # noqa: E501
    ...
    def applies_to(self, applies_to):
        """Sets the applies_to of this ReconcileDateTimeRule.


        :param applies_to: The applies_to of this ReconcileDateTimeRule.  # noqa: E501
        :type applies_to: lusid_asyncio.AggregateSpec
        """
    ...
    @property
    def rule_type(self):
        """Gets the rule_type of this ReconcileDateTimeRule.  # noqa: E501

        The available values are: ReconcileNumericRule, ReconcileDateTimeRule, ReconcileStringRule, ReconcileExact  # noqa: E501

        :return: The rule_type of this ReconcileDateTimeRule.  # noqa: E501
        :rtype: str
        """
    ...
    def rule_type(self, rule_type):
        """Sets the rule_type of this ReconcileDateTimeRule.

        The available values are: ReconcileNumericRule, ReconcileDateTimeRule, ReconcileStringRule, ReconcileExact  # noqa: E501

        :param rule_type: The rule_type of this ReconcileDateTimeRule.  # noqa: E501
        :type rule_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReconcileDateTimeRule):
            return False
