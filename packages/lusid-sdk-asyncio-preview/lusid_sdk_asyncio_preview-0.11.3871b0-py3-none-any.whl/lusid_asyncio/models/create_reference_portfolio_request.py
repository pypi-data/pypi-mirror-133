...
class CreateReferencePortfolioRequest(object):
    ...
    def __init__(self, display_name=None, description=None, code=None, created=None, properties=None, instrument_scopes=None, local_vars_configuration=None):  # noqa: E501
