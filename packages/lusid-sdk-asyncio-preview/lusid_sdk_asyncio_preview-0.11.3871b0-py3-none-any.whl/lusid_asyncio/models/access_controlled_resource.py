...
class AccessControlledResource(object):
    ...
    def __init__(self, application=None, name=None, description=None, actions=None, identifier_parts=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type actions: list[lusid_asyncio.AccessControlledAction]
        :param identifier_parts:  The constituent parts of a valid identifier for this resource
        :type identifier_parts: list[lusid_asyncio.IdentifierPartSchema]
    ...
    def actions(self):
        ...
        :rtype: list[lusid_asyncio.AccessControlledAction]
        """
    ...
    def identifier_parts(self):
        ...
        :rtype: list[lusid_asyncio.IdentifierPartSchema]
        """
