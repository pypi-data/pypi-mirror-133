...
class CrossCurrencySwap(object):
    ...
    def __init__(self, start_date=None, maturity_date=None, legs=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
        """CrossCurrencySwap - a model defined in OpenAPI"
    ...
    @property
    def start_date(self):
        """Gets the start_date of this CrossCurrencySwap.  # noqa: E501

        The start date of the instrument. This is normally synonymous with the trade-date.  # noqa: E501

        :return: The start_date of this CrossCurrencySwap.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this CrossCurrencySwap.

        The start date of the instrument. This is normally synonymous with the trade-date.  # noqa: E501

        :param start_date: The start_date of this CrossCurrencySwap.  # noqa: E501
        :type start_date: datetime
        """
    ...
    def maturity_date(self):
        """Gets the maturity_date of this CrossCurrencySwap.  # noqa: E501
        ...
        :return: The maturity_date of this CrossCurrencySwap.  # noqa: E501
        :rtype: datetime
        """
    ...
    def maturity_date(self, maturity_date):
        """Sets the maturity_date of this CrossCurrencySwap.

        The final maturity date of the instrument. This means the last date on which the instruments makes a payment of any amount.  For the avoidance of doubt, that is not necessarily prior to its last sensitivity date for the purposes of risk; e.g. instruments such as  Constant Maturity Swaps (CMS) often have sensitivities to rates beyond their last payment date.  # noqa: E501

        :param maturity_date: The maturity_date of this CrossCurrencySwap.  # noqa: E501
        :type maturity_date: datetime
        """
    ...
    @property
    def legs(self):
        """Gets the legs of this CrossCurrencySwap.  # noqa: E501

        The set of instrument legs that define the swap instrument.  # noqa: E501

        :return: The legs of this CrossCurrencySwap.  # noqa: E501
    ...
    @legs.setter
    def legs(self, legs):
        """Sets the legs of this CrossCurrencySwap.

        The set of instrument legs that define the swap instrument.  # noqa: E501

        :param legs: The legs of this CrossCurrencySwap.  # noqa: E501
        :type legs: list[lusid_asyncio.InstrumentLeg]
        """
    ...
    def instrument_type(self):
        """Gets the instrument_type of this CrossCurrencySwap.  # noqa: E501

        The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption  # noqa: E501

        :return: The instrument_type of this CrossCurrencySwap.  # noqa: E501
        :rtype: str
        """
    ...
    def instrument_type(self, instrument_type):
        """Sets the instrument_type of this CrossCurrencySwap.

        The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, CrossCurrencySwap, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption  # noqa: E501

        :param instrument_type: The instrument_type of this CrossCurrencySwap.  # noqa: E501
        :type instrument_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CrossCurrencySwap):
            return False
