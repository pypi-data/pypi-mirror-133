...
class OrderGraphBlock(object):
    ...
    def __init__(self, block=None, order_ids=None, placement_ids=None, allocation_ids=None, execution_ids=None, ordered=None, placed=None, executed=None, allocated=None, derived_state=None, local_vars_configuration=None):  # noqa: E501
        """OrderGraphBlock - a model defined in OpenAPI"
        
        :param block:  (required)
        :type block: lusid_asyncio.Block
        ...
        :type ordered: lusid_asyncio.OrderGraphSynopsis
