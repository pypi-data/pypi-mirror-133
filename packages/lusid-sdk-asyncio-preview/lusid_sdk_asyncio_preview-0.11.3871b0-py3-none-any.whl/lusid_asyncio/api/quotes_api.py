...
class QuotesApi(object):
    ...
    def delete_quote_accces_metadata_rule(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteQuoteAcccesMetadataRule: Delete a Quote Access Metadata Rule  # noqa: E501
        ...
        >>> thread = api.delete_quote_accces_metadata_rule(scope, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_quote_accces_metadata_rule_with_http_info(scope, **kwargs)  # noqa: E501

    def delete_quote_accces_metadata_rule_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteQuoteAcccesMetadataRule: Delete a Quote Access Metadata Rule  # noqa: E501
        ...
        >>> thread = api.delete_quote_accces_metadata_rule_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_quote_accces_metadata_rule" % key
                )
        ...
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_quote_accces_metadata_rule`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_quote_accces_metadata_rule`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_quote_accces_metadata_rule`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('provider' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `provider` when calling `delete_quote_accces_metadata_rule`, length must be less than or equal to `256`")  # noqa: E501
        if self.api_client.client_side_validation and ('provider' in local_var_params and  # noqa: E501
                                                        len(local_var_params['provider']) < 0):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `provider` when calling `delete_quote_accces_metadata_rule`, length must be greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
