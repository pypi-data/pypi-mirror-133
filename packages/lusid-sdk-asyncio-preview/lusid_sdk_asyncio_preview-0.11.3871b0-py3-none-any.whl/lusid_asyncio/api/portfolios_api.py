...
class PortfoliosApi(object):
    ...
    def get_portfolio_aggregated_returns_with_http_info(self, scope, code, return_scope, return_code, aggregated_returns_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('return_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['return_scope']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_scope` when calling `get_portfolio_aggregated_returns`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('return_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['return_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_scope` when calling `get_portfolio_aggregated_returns`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'return_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['return_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_scope` when calling `get_portfolio_aggregated_returns`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('return_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['return_code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_code` when calling `get_portfolio_aggregated_returns`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('return_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['return_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_code` when calling `get_portfolio_aggregated_returns`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'return_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['return_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `return_code` when calling `get_portfolio_aggregated_returns`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
