...
class PlacementRequest(object):
    ...
    def __init__(self, id=None, block_ids=None, properties=None, instrument_identifiers=None, quantity=None, state=None, side=None, time_in_force=None, type=None, created_date=None, limit_price=None, stop_price=None, counterparty=None, local_vars_configuration=None):  # noqa: E501
