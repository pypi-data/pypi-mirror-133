...
setuptools.setup(
    executable=True,
    name="codetmpl",  # Replace with your own username
    version=version,
    author="Wang Pei",
    ...
    url="https://gitee.com/peiiii/codetmpl",
    packages=packages,
    package_dir={'codetmpl': 'codetmpl'},
    install_requires=['jinja2','fire','freehub>=0.1.2.7'],
    entry_points={
        'console_scripts': [
            'codetmpl = codetmpl.clitools.cli:main',
        ]
    },
