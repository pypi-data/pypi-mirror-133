...
{':sys_platform == "darwin"': ['darkdetect>=0,<1'],
 ...
 'addons': ['docutils>=0.17,<0.18'],
 'addons:python_version < "3.10"': ['orjson>=3,<4'],
 'pyqt5': ['PyQt5>=5.15.0,<6.0.0',
           'PyQtWebEngine>=5.15.0,<6.0.0',
           'QScintilla>=2.11.5,<3.0.0'],
 'pyqt5:python_version != "3.10" or sys_platform != "win32"': ['PyQtChart>=5.15.0,<6.0.0'],
 'pyqt6': ['PyQt6>=6.2.0,<7.0.0',
           'PyQt6-Charts>=6.2.0,<7.0.0',
           'PyQt6-WebEngine>=6.2.0,<7.0.0',
           'PyQt6-QScintilla>=2.0.0,<3.0.0'],
 'pyside2:python_version < "3.10"': ['pyside2>=5.15.0,<6.0.0'],
 'pyside6:python_version < "3.11"': ['pyside6>=6.0.0,<7.0.0']}
