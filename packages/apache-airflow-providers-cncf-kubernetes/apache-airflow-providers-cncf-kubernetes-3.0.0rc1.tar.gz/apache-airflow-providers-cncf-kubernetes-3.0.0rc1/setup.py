...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'cryptography>=2.0.0', 'kubernetes>=3.0.0, <12.0.0'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-cncf-kubernetes/3.0.0/',
