...
def validity_nondecreasing_smoothness(series):
...
def apply_to_updates(func):
    ...
    def over_updates(data_df, truth_df, expected_df, *args, **kwargs):
        rot_func = apply_to_observations(func)
        return rot_func(data_df.T, truth_df.T, expected_df.T, *args, **kwargs)
...
def validity(data_df, truth_df, expected_df):
    func = apply_to_updates(validity_nondecreasing_smoothness)
    df = func(data_df, truth_df, expected_df)
    func = apply_to_updates(validity_nondecreasing)
    df2 = func(data_df, truth_df, expected_df)
...
#     func1 = apply_to_observations(accuracy_metrics)
#     func2 = apply_to_updates(accuracy_metrics)
#     return func(data_df, truth_df, expected_df)
