...
class GaussianRV:
    ...
    # @property
    # def var(self):   # NOT NEEDED: Use self.predictive.var instead
    ...
    def predictive(self):
        ...
        Arne Leijon, 2018-07-07, re-checked 2022-01-01
        """
...
class PrecisionRV:
    ...
    The probability density function is
    p(Lambda) = prod_d C_d Lambda_d^(a - 1) exp(- b_d Lambda_d), i.e., gamma density,
        where
    ...
    def logpdf(self, x):  # ******* not needed in Ema ?  ********
        """ln pdf(x | self)
...
class StudentRV:
    ...
    def rvs(self, size=None):
        ...
        z = RNG.standard_t(df=self.df, size=s)
