...
setuptools.setup(
    name="PyTTFontToScratch", # Put your username here!
    version="0.0.1", # The version of your package!
    author="Ancoder", # Your name here!
    author_email="main@ancoder.ml", # Your e-mail here!
    description="Converts ttf to scratch formats", # A short description here!
