...
class ServiceDependency(Dependency):
    ...
    def __init__(self, name: str, parent_host: str, child_host: str, parent_service: str, child_service: str):
        super().__init__(name=name, parent_host=parent_host, child_host=child_host)
        self.parent_service_name = parent_service
        self.child_service_name = child_service
