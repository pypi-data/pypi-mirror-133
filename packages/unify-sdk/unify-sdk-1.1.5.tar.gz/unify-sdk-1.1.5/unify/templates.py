...
class Templates(ApiRequestManager):
    ...
    def get_attributes(self, org_id, template_id):
        """
    ...
    def download_template(self, org_id, list_templates=None):
        """
    ...
    def download_all_template_config(self, org_id):
        """
    ...
    def download_given_templates(self, org_id, template_list=None, format="csv"):
        """
