...
class Sources(ApiRequestManager):
    ...
    @single_org
    def static_file_upload(self, name, content, org_id=None):
        """
    ...
    def get_sources(self, org_id=None):
        ...
        if self.evergreen_enabled:
            ...
            query_strings = {
                "ean.orgs": org_id,
                "_fields": "schema,ean.ready,ean.source_type,ean.facets,ean.table,ean.description,ean.dataArchiveServerName"
            }
    ...
    def delete_source(self, org_id=None, *, source_id):
        ...
        if delete_request.status_code in [200, 201]:
