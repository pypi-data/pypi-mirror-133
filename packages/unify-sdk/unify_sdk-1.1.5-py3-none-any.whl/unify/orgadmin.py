...
class OrgAdmin(ApiRequestManager):
    ...
    def submit_sensor_diagnostics(self, org_id, content):
        """
    ...
    def rename_organization(self, org, new_name):
        ...
        organization_url = self.org_api_url.format(org)

        payload = {"id": org, "name": new_name}
