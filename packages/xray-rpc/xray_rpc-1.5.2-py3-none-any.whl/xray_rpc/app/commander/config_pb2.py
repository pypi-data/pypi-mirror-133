...
_CONFIG = _descriptor.Descriptor(
  name='Config',
  full_name='xray.app.commander.Config',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='xray.app.commander.Config.tag', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='service', full_name='xray.app.commander.Config.service', index=1,
...
_REFLECTIONCONFIG = _descriptor.Descriptor(
  ...
  full_name='xray.app.commander.ReflectionConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
