...
def scrape_pbp(game_ids, _print = True):
    ...
    for game_id_idx, game_id in enumerate(game_ids):
        ...
        game_info = scrape_api_game_info(game_id, response_data = live_response, _print = False, session = live_response_session)
...
def scrape_api_rosters(game_ids, response_data = None, session = None, _print = True):
    ...
    for game_id_idx, game_id in enumerate(game_ids):
        ...
        game_info = scrape_api_game_info(game_id, response_data = response, session = s, _print = False)
