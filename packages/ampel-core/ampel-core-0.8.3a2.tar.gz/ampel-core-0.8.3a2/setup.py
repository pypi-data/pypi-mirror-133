...
install_requires = \
['ampel-interface>=0.8.3-alpha.2,<0.9.0',
...
entry_points = \
{'cli': ['buffer Match and view or save ampel buffers = '
         'ampel.cli.BufferCommand',
         'config Build or update config. Fetch or append config elements = '
         'ampel.cli.ConfigCommand',
         'db Initialize, dump, delete specific databases or collections = '
         'ampel.cli.DBCommand',
         'job Run provided job file = ampel.cli.JobCommand',
         'log Select, format and either view or save logs. Tail mode availabe '
         '= ampel.cli.LogCommand',
         'run Run selected process(es) from config = ampel.cli.RunCommand',
         'start Run ampel continuously. Processes are scheduled according to '
         'config = ampel.cli.StartCommand',
         't2 Match and either reset or view raw t2 documents = '
         'ampel.cli.T2Command',
         'view Select, load and save fresh "ampel views" = '
