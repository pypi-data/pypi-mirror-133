...
/* Return type for ProviderGetPluginInfo */
struct ProviderGetPluginInfo_return {
	GoInt r0; /* statusCode */
	char* r1; /* errString */
};
extern struct ProviderGetPluginInfo_return ProviderGetPluginInfo(char* ctx, char* provider);

/* Return type for ProviderInvoke */
...
extern struct ProviderInvoke_return ProviderInvoke(char* ctx, char* provider, char* member, char* args);

/* Return type for ProviderSignalCancellation */
struct ProviderSignalCancellation_return {
	GoInt r0; /* statusCode */
	char* r1; /* errString */
};
extern struct ProviderSignalCancellation_return ProviderSignalCancellation(char* ctx, char* provider);
