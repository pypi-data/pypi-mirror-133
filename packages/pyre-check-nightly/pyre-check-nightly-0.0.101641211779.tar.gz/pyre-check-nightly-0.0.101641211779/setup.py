...
def main() -> None:
    ...
    run(
        ...
        package_version="0.0.101641211779",
        module_name="pyre_check",
        runtime_dependencies=json.loads("""["dataclasses; python_version < \"3.7\"", "async-generator", "click", "dataclasses-json", "intervaltree", "libcst", "psutil", "pyre-extensions", "tabulate", "testslide>=2.7.0", "typing_extensions", ""]"""),
        long_description=long_description,
    )
