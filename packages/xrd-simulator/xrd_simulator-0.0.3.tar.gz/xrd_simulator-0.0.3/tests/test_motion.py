...
class TestPhase(unittest.TestCase):
    ...
    def test_rotate(self):
        ...
        self.assertAlmostEqual( np.linalg.norm(x-np.array([1.,0,0])), 0, msg='Error in rotator' )
        self.assertAlmostEqual( np.linalg.norm(y-np.array([0,1,0])), 0, msg='Error in rotator' )
        self.assertAlmostEqual( np.linalg.norm(z-np.array([0,0,1])), 0, msg='Error in rotator' )
    ...
    def test_translate(self):
        ...
        self.assertAlmostEqual( np.linalg.norm(v-translation*0.4323-v0), 0, msg='Error in translation' )
