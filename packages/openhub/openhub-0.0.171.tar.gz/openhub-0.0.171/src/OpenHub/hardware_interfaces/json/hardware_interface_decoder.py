...
from OpenHub.hardware_interfaces.PMSA0031_AirQuality import PMSA0031AirQuality
...
class HardwareDecoder(json.JSONDecoder):
    ...
    def object_hook(self, dct):
        ...
        if type == PiPicoAnalog.__name__:
            ...
            elif type == 'PMSA0031AirQuality':
                hardware = PMSA0031AirQuality(serial_no=dct['id'])
            elif type == 'VEML7700':
