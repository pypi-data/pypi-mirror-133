...
class PysonConnect:
    ...
    def updateScanDestination(self, data, access_token=None, subject_id=None):
        if access_token == None:
            access_token = self.access_token
    ...
    def deleteScanDestination(self, access_token, subject_id, scanDestID):
        req_uri = f"{self.base_uri}/api/1/scanning/scanners/{subject_id}/destinations"
        headers = {
                "Authorization":f"Bearer {access_token}",
                "Content-Type":"application/json"
