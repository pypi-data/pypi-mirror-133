...
class Jss:
    ...
    def _encode_post_data(self, js_data):
        ...
        for values in js_data.values():
            if isinstance(values, dict):
                ...
                encode_data.append(str(values))
        return encode_data    

    def save_data(self, post_data, resp, bucket_name="pfinder-data-bucket"):
        file_name = self._encode_post_data(post_data)
    ...
    def get_data(self, post_data, bucket_name="pfinder-data-bucket"):
