...
arg_parser.add_argument('--disable-wmf', help='keep wmf formatted image untouched(avoid exceptions under linux)', action="store_true")
...
arg_parser.add_argument('--min-block-size', help='the minimum character number of a text block to be converted', type=int, default=15)
