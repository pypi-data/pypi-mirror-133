    ...
    def _where_spell_out(self, where):
        ...
        for where_condition in where:
            if isinstance(where_condition, Condition):
                ...
                if isinstance(where_condition.operator, str):
                ...
                elif isinstance(where_condition.operator, SQLOperator) or isinstance(where_condition.operator, TimeOperator):
                    ...
                    operator = None
                formatted_cond = '"' + where_condition.field.column + " (" + where_condition.field.internalDataType + ") " \
