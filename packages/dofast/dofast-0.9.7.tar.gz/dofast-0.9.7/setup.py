...
setuptools.setup(
    ...
    install_requires=[
        'codefast', 'hashids', 'colorlog>=4.6.1', 'tqdm', 'joblib', 'PyGithub',
        ...
        "cairosvg >= 2.3.0", 'jinja2 >= 2.9.3', 'waitress'
    ],
    entry_points={
        'console_scripts': [
            'sli=dofast.sli_entry:main', 'hint=dofast.sli_entry:_hint_wubi',
            'websurf=dofast.nsq.websurf:run',
            'weather=dofast.weather:entry', 'jsy=dofast.sli_entry:jsonify',
