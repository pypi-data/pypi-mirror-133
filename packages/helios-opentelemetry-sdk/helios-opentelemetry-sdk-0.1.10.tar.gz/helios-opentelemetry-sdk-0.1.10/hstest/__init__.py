    ...
    if result.when == 'call':
        if active_span:
            ...
            active_span.set_attributes({
                ...
                PytestSpanAttributes.ERROR_MESSAGE: result.longrepr.reprcrash.message if not test_successful else ''
            })
...
def get_action_trace_string(trace_id, success):
    ...
    return f'{icon} https://app.gethelios.dev?actionTraceId={encode_id_as_hex_string(trace_id)}'
