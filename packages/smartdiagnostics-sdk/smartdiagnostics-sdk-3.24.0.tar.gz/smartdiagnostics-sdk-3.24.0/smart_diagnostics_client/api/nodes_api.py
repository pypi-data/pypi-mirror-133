...
class NodesApi(object):
    ...
    def export_long_burst(self, long_burst_id, node_id, **kwargs):  # noqa: E501
        """Get a node longburst.  # noqa: E501
    ...
    def export_nodes(self, **kwargs):  # noqa: E501
        ...
        :param str name_search: Provide search terms to narrow result.  Searchable properties: `Nickname`, `SerialNumber`.
    ...
    def get_nodes(self, **kwargs):  # noqa: E501
        ...
        :param bool is_slim: If set to true, only a small subset of information on the node(s) will be included in the response
    ...
    def get_nodes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['include_state', 'is_slim', 'group_ids', 'filter', 'page', 'page_limit', 'order_by', 'name_search']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
