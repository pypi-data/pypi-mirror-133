...
class RepeatersApi(object):
    ...
    def export_repeaters(self, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `Id` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `RadioMacAddress` | String | `eq, neq, like, in` | | `SerialNumber` | String | `eq, neq, like, in` |
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `Active` | Boolean | | `CorporationName` | String | | `Id` | Int64 | | `LastStatusUpdate` | DateTime? | | `LocationName` | String | | `Name` | String | | `NodeCount` | Int32 | | `RadioMacAddress` | String | | `SerialNumber` | String | | `SoftwareVersion` | String |
    ...
    def get_repeater(self, **kwargs):  # noqa: E501
        """Get receivers subject to query options  # noqa: E501

        This route supports the repeaters being used in sd3.  The RepeaterModelV3 is being used as request and a response and  any changes to this model may effect other routes as well as the Sd3 front end.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_repeater(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `CorporationName` | String | `eq, neq, like, in` | | `Id` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `LastStatusUpdate` | DateTime? | `eq, neq, in, lt, gt, leq, geq` | | `LocationId` | Guid? | `eq, neq, in, lt, gt, leq, geq` | | `LocationName` | String | `eq, neq, like, in` | | `RadioMacAddress` | String | `eq, neq, like, in` | | `SerialNumber` | String | `eq, neq, like, in` | | `Type` | ReceiverLocationTypeCodes | `eq, neq, in` |
        ...
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `Active` | Boolean | | `CorporationId` | Guid? | | `CorporationName` | String | | `Id` | Int64 | | `LastStatusUpdate` | DateTime? | | `LocationId` | Guid? | | `LocationName` | String | | `RadioMacAddress` | String | | `SerialNumber` | String | | `Type` | ReceiverLocationTypeCodes |
        :param str name_search: Provide search terms to narrow result.  Searchable properties: `CorporationName`, `LocationName`, `RadioMacAddress`, `SerialNumber`.
        :return: PagedResultsModelRepeaterModelV3
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_repeater_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_repeater_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_repeater_with_http_info(self, **kwargs):  # noqa: E501
        """Get receivers subject to query options  # noqa: E501

        This route supports the repeaters being used in sd3.  The RepeaterModelV3 is being used as request and a response and  any changes to this model may effect other routes as well as the Sd3 front end.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_repeater_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PagedResultsModelRepeaterModelV3',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
