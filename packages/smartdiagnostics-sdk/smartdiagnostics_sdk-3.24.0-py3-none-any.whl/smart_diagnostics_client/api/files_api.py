...
class FilesApi(object):
    ...
    def get_corporation_files(self, corporation_id, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `FileType` | ContentType | `eq, neq, in` | | `IsRootFolder` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `ParentFolderId` | Guid? | `eq, neq, in, lt, gt, leq, geq` | | `TagId` | Guid | `eq, neq, in` | | `TagName` | String | `eq, neq, like, in` |
    ...
    def get_corporation_files_with_http_info(self, corporation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['corporation_id', 'filter', 'page', 'page_limit', 'order_by', 'name_search']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_file(self, file_id, **kwargs):  # noqa: E501
        ...
        :param FilesUpdateRequest body: File object to update
        :return: PictureFileMetadataResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
