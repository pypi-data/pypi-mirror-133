...
class CommandRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"evac_start",b"evac_start",u"evac_stop",b"evac_stop",u"harvester_close",b"harvester_close",u"harvester_open",b"harvester_open",u"header",b"header",u"payload",b"payload"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"evac_start",b"evac_start",u"evac_stop",b"evac_stop",u"harvester_close",b"harvester_close",u"harvester_open",b"harvester_open",u"header",b"header",u"payload",b"payload"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"payload",b"payload"]) -> typing_extensions.Literal["evac_start","evac_stop","harvester_open","harvester_close"]: ...
...
class EvacuationStart(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MAX_FLOW_FIELD_NUMBER: builtins.int
    max_flow: builtins.float = ...

    def __init__(self,
        *,
        max_flow : builtins.float = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"max_flow",b"max_flow"]) -> None: ...
