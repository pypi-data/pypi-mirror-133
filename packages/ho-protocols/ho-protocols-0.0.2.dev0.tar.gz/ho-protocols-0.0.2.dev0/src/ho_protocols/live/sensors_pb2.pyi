...
class SensorLiveItem(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"broodnest",b"broodnest",u"hive_scales",b"hive_scales",u"msg",b"msg",u"power_supply",b"power_supply",u"traffic_flow",b"traffic_flow"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"broodnest",b"broodnest",u"hive_scales",b"hive_scales",u"msg",b"msg",u"power_supply",b"power_supply",u"traffic_flow",b"traffic_flow"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"msg",b"msg"]) -> typing_extensions.Literal["broodnest","traffic_flow","hive_scales","power_supply"]: ...
