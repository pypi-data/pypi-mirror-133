# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/PluginManager/PluginDetailsDialog.ui'
#
...
class Ui_PluginDetailsDialog(object):
    def setupUi(self, PluginDetailsDialog):
        ...
        self.autoactivateCheckBox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.activeCheckBox.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.buttonBox.accepted.connect(PluginDetailsDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(PluginDetailsDialog.reject) # type: ignore
