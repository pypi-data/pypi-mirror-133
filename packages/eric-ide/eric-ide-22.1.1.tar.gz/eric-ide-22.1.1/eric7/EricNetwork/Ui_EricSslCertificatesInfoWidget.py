# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/EricNetwork/EricSslCertificatesInfoWidget.ui'
#
...
class Ui_EricSslCertificatesInfoWidget(object):
    def setupUi(self, EricSslCertificatesInfoWidget):
        ...
        EricSslCertificatesInfoWidget.resize(500, 455)
        self.verticalLayout = QtWidgets.QVBoxLayout(EricSslCertificatesInfoWidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_17 = QtWidgets.QLabel(EricSslCertificatesInfoWidget)
        ...
        self.chainLabel = QtWidgets.QLabel(EricSslCertificatesInfoWidget)
        self.chainLabel.setObjectName("chainLabel")
        self.horizontalLayout.addWidget(self.chainLabel)
        self.chainComboBox = QtWidgets.QComboBox(EricSslCertificatesInfoWidget)
        ...
        self.blacklistedLabel = QtWidgets.QLabel(EricSslCertificatesInfoWidget)
        self.blacklistedLabel.setObjectName("blacklistedLabel")
        self.verticalLayout.addWidget(self.blacklistedLabel)
        self.groupBox = QtWidgets.QGroupBox(EricSslCertificatesInfoWidget)
    ...
    def retranslateUi(self, EricSslCertificatesInfoWidget):
        ...
        self.blacklistedLabel.setText(_translate("EricSslCertificatesInfoWidget", "This certificated has been blacklisted."))
