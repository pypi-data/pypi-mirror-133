# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/UI/CompareDialog.ui'
#
...
class Ui_CompareDialog(object):
    def setupUi(self, CompareDialog):
        ...
        self.file1Picker = EricPathPicker(self.filesGroup)
        ...
        self.file2Picker = EricPathPicker(self.filesGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
