# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/UI/ClearPrivateDataDialog.ui'
#
...
class Ui_ClearPrivateDataDialog(object):
    def setupUi(self, ClearPrivateDataDialog):
        ...
        ClearPrivateDataDialog.resize(400, 263)
        ...
        self.unittestCheckBox = QtWidgets.QCheckBox(ClearPrivateDataDialog)
        self.unittestCheckBox.setChecked(True)
        self.unittestCheckBox.setObjectName("unittestCheckBox")
        self.verticalLayout.addWidget(self.unittestCheckBox)
        ...
        ClearPrivateDataDialog.setTabOrder(self.shellCheckBox, self.unittestCheckBox)
        ClearPrivateDataDialog.setTabOrder(self.unittestCheckBox, self.vcsCheckBox)
    ...
    def retranslateUi(self, ClearPrivateDataDialog):
        ...
        self.unittestCheckBox.setToolTip(_translate("ClearPrivateDataDialog", "Select to clear the unittest histories"))
        self.unittestCheckBox.setText(_translate("ClearPrivateDataDialog", "Unittest histories"))
