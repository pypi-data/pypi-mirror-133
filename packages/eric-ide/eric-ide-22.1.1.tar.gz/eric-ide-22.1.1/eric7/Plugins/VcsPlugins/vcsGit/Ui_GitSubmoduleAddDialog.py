# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/VcsPlugins/vcsGit/GitSubmoduleAddDialog.ui'
#
...
class Ui_GitSubmoduleAddDialog(object):
    def setupUi(self, GitSubmoduleAddDialog):
        ...
        self.submoduleUrlCombo.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.InsertAtTop)
        self.submoduleUrlCombo.setSizeAdjustPolicy(QtWidgets.QComboBox.SizeAdjustPolicy.AdjustToContents)
        ...
        self.buttonBox.accepted.connect(GitSubmoduleAddDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(GitSubmoduleAddDialog.reject) # type: ignore
