# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/VcsPlugins/vcsMercurial/HisteditExtension/HgHisteditConfigDialog.ui'
#
...
class Ui_HgHisteditConfigDialog(object):
    def setupUi(self, HgHisteditConfigDialog):
        ...
        self.buttonBox.accepted.connect(HgHisteditConfigDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(HgHisteditConfigDialog.reject) # type: ignore
        self.revisionButton.toggled['bool'].connect(self.revisionGroupBox.setEnabled) # type: ignore
        ...
        self.outgoingButton.toggled['bool'].connect(self.forceCheckBox.setEnabled) # type: ignore
