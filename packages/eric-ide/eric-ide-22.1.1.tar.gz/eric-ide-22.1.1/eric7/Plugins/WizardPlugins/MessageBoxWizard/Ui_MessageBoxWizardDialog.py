# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/WizardPlugins/MessageBoxWizard/MessageBoxWizardDialog.ui'
#
...
class Ui_MessageBoxWizardDialog(object):
    def setupUi(self, MessageBoxWizardDialog):
        ...
        self.eMessage = EricSpellCheckedTextEdit(MessageBoxWizardDialog)
        ...
        self.buttonBox.accepted.connect(MessageBoxWizardDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(MessageBoxWizardDialog.reject) # type: ignore
