# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/WizardPlugins/EricMessageBoxWizard/EricMessageBoxWizardDialog.ui'
#
...
class Ui_EricMessageBoxWizardDialog(object):
    def setupUi(self, EricMessageBoxWizardDialog):
        ...
        EricMessageBoxWizardDialog.resize(535, 681)
        ...
        self.typeBox = QtWidgets.QGroupBox(EricMessageBoxWizardDialog)
        ...
        self.standardButtons = QtWidgets.QGroupBox(EricMessageBoxWizardDialog)
        ...
        self.defaultButton = QtWidgets.QGroupBox(EricMessageBoxWizardDialog)
        ...
        self.iconBox = QtWidgets.QGroupBox(EricMessageBoxWizardDialog)
        ...
        self.modalCheck = QtWidgets.QCheckBox(EricMessageBoxWizardDialog)
        self.modalCheck.setEnabled(False)
        self.modalCheck.setObjectName("modalCheck")
        self.horizontalLayout.addWidget(self.modalCheck)
        self.yesDefaultCheck = QtWidgets.QCheckBox(EricMessageBoxWizardDialog)
        ...
        self.label = QtWidgets.QLabel(EricMessageBoxWizardDialog)
        self.label.setEnabled(False)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.saveFuncEdit = QtWidgets.QLineEdit(EricMessageBoxWizardDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(EricMessageBoxWizardDialog)
