# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/WebBrowser/Bookmarks/BookmarkPropertiesDialog.ui'
#
...
class Ui_BookmarkPropertiesDialog(object):
    def setupUi(self, BookmarkPropertiesDialog):
        ...
        BookmarkPropertiesDialog.resize(500, 250)
        ...
        self.nameEdit = QtWidgets.QLineEdit(BookmarkPropertiesDialog)
        ...
        self.addressEdit = QtWidgets.QLineEdit(BookmarkPropertiesDialog)
        ...
        self.descriptionEdit = EricSpellCheckedPlainTextEdit(BookmarkPropertiesDialog)
        self.descriptionEdit.setObjectName("descriptionEdit")
        self.gridLayout.addWidget(self.descriptionEdit, 2, 1, 1, 1)
        self.visitedLabel = QtWidgets.QLabel(BookmarkPropertiesDialog)
        self.visitedLabel.setText("")
        self.visitedLabel.setObjectName("visitedLabel")
        self.gridLayout.addWidget(self.visitedLabel, 3, 1, 1, 1)
        ...
        self.buttonBox.accepted.connect(BookmarkPropertiesDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(BookmarkPropertiesDialog.reject) # type: ignore
