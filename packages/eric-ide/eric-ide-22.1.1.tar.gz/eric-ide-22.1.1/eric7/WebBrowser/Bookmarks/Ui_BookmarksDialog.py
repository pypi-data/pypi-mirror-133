# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/WebBrowser/Bookmarks/BookmarksDialog.ui'
#
...
class Ui_BookmarksDialog(object):
    def setupUi(self, BookmarksDialog):
        ...
        self.searchEdit = QtWidgets.QLineEdit(BookmarksDialog)
        self.searchEdit.setClearButtonEnabled(True)
        self.searchEdit.setObjectName("searchEdit")
        self.horizontalLayout.addWidget(self.searchEdit)
        self.horizontalLayout_2.addLayout(self.horizontalLayout)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.bookmarksTree = EricTreeView(BookmarksDialog)
