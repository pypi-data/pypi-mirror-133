# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/WebBrowser/AdBlock/AdBlockDialog.ui'
#
...
class Ui_AdBlockDialog(object):
    def setupUi(self, AdBlockDialog):
        ...
        self.searchEdit = QtWidgets.QLineEdit(self.adBlockGroup)
        ...
        self.updateSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.useLimitedEasyListCheckBox = QtWidgets.QCheckBox(self.adBlockGroup)
        self.useLimitedEasyListCheckBox.setToolTip("")
        self.useLimitedEasyListCheckBox.setObjectName("useLimitedEasyListCheckBox")
        self.verticalLayout.addWidget(self.useLimitedEasyListCheckBox)
        ...
        self.buttonBox.accepted.connect(AdBlockDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(AdBlockDialog.reject) # type: ignore
    ...
    def retranslateUi(self, AdBlockDialog):
        ...
        self.searchEdit.setPlaceholderText(_translate("AdBlockDialog", "Search..."))
        ...
        self.useLimitedEasyListCheckBox.setText(_translate("AdBlockDialog", "Use only essential part of EasyList (for performance reasons)"))
