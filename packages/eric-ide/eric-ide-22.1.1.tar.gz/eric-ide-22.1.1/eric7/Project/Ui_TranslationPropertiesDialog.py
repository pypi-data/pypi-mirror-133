# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Project/TranslationPropertiesDialog.ui'
#
...
class Ui_TranslationPropertiesDialog(object):
    def setupUi(self, TranslationPropertiesDialog):
        ...
        self.transPatternPicker = EricPathPicker(TranslationPropertiesDialog)
        ...
        self.transBinPathPicker = EricPathPicker(TranslationPropertiesDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"(Use \'%language%\' where the language code should be inserted, e.g. i18n/eric7_%language%.ts)"))
