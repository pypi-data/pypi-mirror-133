# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Project/RccCompilerOptionsDialog.ui'
#
...
class Ui_RccCompilerOptionsDialog(object):
    def setupUi(self, RccCompilerOptionsDialog):
        ...
        self.thresholdSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        spacerItem = QtWidgets.QSpacerItem(253, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem, 0, 2, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 1, 0, 1, 1)
        self.compressionSpinBox = QtWidgets.QSpinBox(self.groupBox)
        self.compressionSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.rootEdit = QtWidgets.QLineEdit(RccCompilerOptionsDialog)
        self.rootEdit.setClearButtonEnabled(True)
        ...
        self.buttonBox.accepted.connect(RccCompilerOptionsDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(RccCompilerOptionsDialog.reject) # type: ignore
