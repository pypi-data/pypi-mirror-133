# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Tasks/TaskPropertiesDialog.ui'
#
...
class Ui_TaskPropertiesDialog(object):
    def setupUi(self, TaskPropertiesDialog):
        ...
        self.descriptionLabel = QtWidgets.QLabel(TaskPropertiesDialog)
        ...
        self.descriptionEdit = EricSpellCheckedTextEdit(TaskPropertiesDialog)
        self.descriptionEdit.setObjectName("descriptionEdit")
        self.gridLayout_2.addWidget(self.descriptionEdit, 1, 1, 1, 1)
        self.manualTaskFrame = QtWidgets.QFrame(TaskPropertiesDialog)
        ...
        self.textLabel2 = QtWidgets.QLabel(self.manualTaskFrame)
        self.textLabel2.setObjectName("textLabel2")
        self.horizontalLayout_2.addWidget(self.textLabel2)
        self.creationLabel = QtWidgets.QLabel(self.manualTaskFrame)
        ...
        self.textLabel4 = QtWidgets.QLabel(self.manualTaskFrame)
        self.textLabel4.setObjectName("textLabel4")
        self.horizontalLayout.addWidget(self.textLabel4)
        self.priorityCombo = QtWidgets.QComboBox(self.manualTaskFrame)
        ...
        self.label_2 = QtWidgets.QLabel(self.manualTaskFrame)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self.typeCombo = QtWidgets.QComboBox(self.manualTaskFrame)
        ...
        self.completedCheckBox = QtWidgets.QCheckBox(self.manualTaskFrame)
        ...
        self.fileTaskFrame = QtWidgets.QFrame(TaskPropertiesDialog)
        ...
        self.linenoEdit = QtWidgets.QLineEdit(self.fileTaskFrame)
        ...
        self.linenoLabel = QtWidgets.QLabel(self.fileTaskFrame)
        self.linenoLabel.setObjectName("linenoLabel")
        self.gridLayout.addWidget(self.linenoLabel, 1, 0, 1, 1)
        self.filenameLabel = QtWidgets.QLabel(self.fileTaskFrame)
        self.filenameLabel.setObjectName("filenameLabel")
        self.gridLayout.addWidget(self.filenameLabel, 0, 0, 1, 1)
        self.filenameEdit = QtWidgets.QLineEdit(self.fileTaskFrame)
