# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Debugger/StartRunDialog.ui'
#
...
class Ui_StartRunDialog(object):
    def setupUi(self, StartRunDialog):
        ...
        self.TextLabel1_2 = QtWidgets.QLabel(StartRunDialog)
        self.TextLabel1_2.setObjectName("TextLabel1_2")
        self.gridLayout_2.addWidget(self.TextLabel1_2, 1, 0, 1, 1)
        self.scriptnamePicker = EricComboPathPicker(StartRunDialog)
        ...
        self.workdirPicker = EricComboPathPicker(StartRunDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.buttonBox.accepted.connect(StartRunDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(StartRunDialog.reject) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(StartRunDialog)
        StartRunDialog.setTabOrder(self.venvComboBox, self.scriptnamePicker)
        StartRunDialog.setTabOrder(self.scriptnamePicker, self.cmdlineCombo)
...
"<p>Enter the virtual environment to be used. Leave it empty to use the default environment, i.e. the one configured globally or per project.</p>"))
        self.TextLabel1_2.setText(_translate("StartRunDialog", "Script Name:"))
        self.scriptnamePicker.setToolTip(_translate("StartRunDialog", "Enter the script file name"))
        self.scriptnamePicker.setWhatsThis(_translate("StartRunDialog", "<b>Script Name</b>\n"
...
"<p>Enter the working directory of the application to be debugged. Leave it empty to set the working directory to the executable directory.</p>"))
        ...
        self.environmentCombo.setToolTip(_translate("StartRunDialog", "Enter the environment variables to be set separated by whitespace."))
