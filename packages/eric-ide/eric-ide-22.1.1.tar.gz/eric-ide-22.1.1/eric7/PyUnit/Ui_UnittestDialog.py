# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/PyUnit/UnittestDialog.ui'
#
...
class Ui_UnittestDialog(object):
    def setupUi(self, UnittestDialog):
        ...
        self.clearHistoriesButton = QtWidgets.QToolButton(self.groupBox)
        ...
        self.discoveryPicker = EricComboPathPicker(self.groupBox)
        ...
        self.testsuitePicker = EricComboPathPicker(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        spacerItem = QtWidgets.QSpacerItem(371, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self._8.addItem(spacerItem)
        self.progressLed = EricLed(self.progressGroupBox)
        ...
        self.buttonBox.accepted.connect(UnittestDialog.close) # type: ignore
        self.buttonBox.rejected.connect(UnittestDialog.close) # type: ignore
        ...
        UnittestDialog.setTabOrder(self.discoverCheckBox, self.clearHistoriesButton)
        UnittestDialog.setTabOrder(self.clearHistoriesButton, self.discoveryPicker)
        UnittestDialog.setTabOrder(self.discoveryPicker, self.testsuitePicker)
    ...
    def retranslateUi(self, UnittestDialog):
        ...
        self.clearHistoriesButton.setToolTip(_translate("UnittestDialog", "Press to clear the various histories"))
