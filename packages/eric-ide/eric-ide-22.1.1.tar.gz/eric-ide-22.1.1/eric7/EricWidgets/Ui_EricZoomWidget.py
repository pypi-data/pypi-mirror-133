# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/EricWidgets/EricZoomWidget.ui'
#
...
class Ui_EricZoomWidget(object):
    def setupUi(self, EricZoomWidget):
        ...
        self.valueLabel = QtWidgets.QLabel(EricZoomWidget)
        ...
        self.zoomOutLabel = EricClickableLabel(EricZoomWidget)
        ...
        self.slider = QtWidgets.QSlider(EricZoomWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.zoomInLabel = EricClickableLabel(EricZoomWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.zoomResetLabel = EricClickableLabel(EricZoomWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
