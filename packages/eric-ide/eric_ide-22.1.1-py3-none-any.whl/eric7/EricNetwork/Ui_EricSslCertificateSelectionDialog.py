# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/EricNetwork/EricSslCertificateSelectionDialog.ui'
#
...
class Ui_EricSslCertificateSelectionDialog(object):
    def setupUi(self, EricSslCertificateSelectionDialog):
        ...
        self.label = QtWidgets.QLabel(EricSslCertificateSelectionDialog)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.certificatesTree = QtWidgets.QTreeWidget(EricSslCertificateSelectionDialog)
        ...
        self.viewButton = QtWidgets.QPushButton(EricSslCertificateSelectionDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(EricSslCertificateSelectionDialog)
