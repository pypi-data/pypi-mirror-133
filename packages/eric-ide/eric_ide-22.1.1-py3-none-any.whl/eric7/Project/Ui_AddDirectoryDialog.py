# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Project/AddDirectoryDialog.ui'
#
...
class Ui_AddDirectoryDialog(object):
    def setupUi(self, AddDirectoryDialog):
        ...
        self.sourceDirPicker = EricPathPicker(AddDirectoryDialog)
        ...
        self.sourceDirPicker.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.targetDirPicker = EricPathPicker(AddDirectoryDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.buttonBox.accepted.connect(AddDirectoryDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(AddDirectoryDialog.reject) # type: ignore
