# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Preferences/ConfigurationPages/QtPage.ui'
#
...
class Ui_QtPage(object):
    def setupUi(self, QtPage):
        ...
        self.qtTransPicker = EricPathPicker(self.groupBox_3)
        ...
        self.qtToolsDirPicker = EricPathPicker(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pyqt5VenvRefreshButton = QtWidgets.QToolButton(self.groupBox_5)
        ...
        self.pyqtToolsDirPicker = EricPathPicker(self.groupBox_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pyqt6VenvRefreshButton = QtWidgets.QToolButton(self.groupBox_8)
        ...
        self.pyqt6ToolsDirPicker = EricPathPicker(self.groupBox_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pyside2VenvRefreshButton = QtWidgets.QToolButton(self.pyside2Group)
        ...
        self.pyside2ToolsDirPicker = EricPathPicker(self.pyside2Group)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pyside6VenvRefreshButton = QtWidgets.QToolButton(self.pyside2Group_2)
        ...
        self.pyside6ToolsDirPicker = EricPathPicker(self.pyside2Group_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
