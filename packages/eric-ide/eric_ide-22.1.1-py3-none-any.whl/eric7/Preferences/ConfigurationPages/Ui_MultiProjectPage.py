# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Preferences/ConfigurationPages/MultiProjectPage.ui'
#
...
class Ui_MultiProjectPage(object):
    def setupUi(self, MultiProjectPage):
        ...
        self.workspacePicker = EricPathPicker(self.groupBox_2)
        ...
        self.multiProjectRecentSpinBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, MultiProjectPage):
        ...
        self.groupBox_6.setTitle(_translate("MultiProjectPage", "Files"))
        self.multiProjectTimestampCheckBox.setToolTip(_translate("MultiProjectPage", "Select, if a timestamp should be written to all Multi Project files"))
        self.multiProjectTimestampCheckBox.setText(_translate("MultiProjectPage", "Include timestamp in Multi Project files"))
