# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Preferences/ConfigurationPages/MasterPasswordEntryDialog.ui'
#
...
class Ui_MasterPasswordEntryDialog(object):
    def setupUi(self, MasterPasswordEntryDialog):
        ...
        self.passwordMeter = EricPasswordMeter(MasterPasswordEntryDialog)
        ...
        self.buttonBox.accepted.connect(MasterPasswordEntryDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(MasterPasswordEntryDialog.reject) # type: ignore
