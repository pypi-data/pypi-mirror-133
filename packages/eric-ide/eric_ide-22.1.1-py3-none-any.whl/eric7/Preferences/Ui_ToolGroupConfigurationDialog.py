# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Preferences/ToolGroupConfigurationDialog.ui'
#
...
class Ui_ToolGroupConfigurationDialog(object):
    def setupUi(self, ToolGroupConfigurationDialog):
        ...
        spacerItem = QtWidgets.QSpacerItem(87, 20, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.buttonBox.accepted.connect(ToolGroupConfigurationDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(ToolGroupConfigurationDialog.reject) # type: ignore
