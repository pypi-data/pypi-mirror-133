# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/WebBrowser/UserAgent/UserAgentsDialog.ui'
#
...
class Ui_UserAgentsDialog(object):
    def setupUi(self, UserAgentsDialog):
        ...
        self.searchEdit = QtWidgets.QLineEdit(UserAgentsDialog)
        self.searchEdit.setClearButtonEnabled(True)
        self.searchEdit.setObjectName("searchEdit")
        self.horizontalLayout.addWidget(self.searchEdit)
        self.horizontalLayout_2.addLayout(self.horizontalLayout)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.userAgentsTable = EricTableView(UserAgentsDialog)
