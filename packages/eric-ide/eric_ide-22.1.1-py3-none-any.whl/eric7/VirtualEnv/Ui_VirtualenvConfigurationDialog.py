# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/VirtualEnv/VirtualenvConfigurationDialog.ui'
#
...
class Ui_VirtualenvConfigurationDialog(object):
    def setupUi(self, VirtualenvConfigurationDialog):
        ...
        self.nameEdit = QtWidgets.QLineEdit(VirtualenvConfigurationDialog)
        ...
        self.targetDirectoryPicker = EricPathPicker(self.groupBox)
        ...
        self.extraSearchPathPicker = EricPathPicker(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.promptPrefixEdit = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.pythonExecPicker = EricPathPicker(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.condaNameEdit = QtWidgets.QLineEdit(self.groupBox_4)
        ...
        self.condaTargetDirectoryPicker = EricPathPicker(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.condaCloneNameEdit = QtWidgets.QLineEdit(self.condaCloneFrame)
        ...
        self.condaCloneDirectoryPicker = EricPathPicker(self.condaCloneFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.condaRequirementsFilePicker = EricPathPicker(self.condaRequirementsFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.condaPackagesEdit = QtWidgets.QLineEdit(self.condaPage)
        ...
        self.condaPythonEdit = QtWidgets.QLineEdit(self.groupBox_5)
