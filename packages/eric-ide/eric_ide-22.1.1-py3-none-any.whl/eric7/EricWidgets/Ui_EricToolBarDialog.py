# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/EricWidgets/EricToolBarDialog.ui'
#
...
class Ui_EricToolBarDialog(object):
    def setupUi(self, EricToolBarDialog):
        ...
        self.label = QtWidgets.QLabel(EricToolBarDialog)
        self.label.setObjectName("label")
        self.hboxlayout.addWidget(self.label)
        self.toolbarComboBox = QtWidgets.QComboBox(EricToolBarDialog)
        ...
        self.newButton = QtWidgets.QPushButton(EricToolBarDialog)
        self.newButton.setObjectName("newButton")
        self.hboxlayout.addWidget(self.newButton)
        self.removeButton = QtWidgets.QPushButton(EricToolBarDialog)
        self.removeButton.setObjectName("removeButton")
        self.hboxlayout.addWidget(self.removeButton)
        self.renameButton = QtWidgets.QPushButton(EricToolBarDialog)
        self.renameButton.setObjectName("renameButton")
        self.hboxlayout.addWidget(self.renameButton)
        self.vboxlayout.addLayout(self.hboxlayout)
        self.line = QtWidgets.QFrame(EricToolBarDialog)
        ...
        self.label_2 = QtWidgets.QLabel(EricToolBarDialog)
        self.label_2.setObjectName("label_2")
        self.gridlayout.addWidget(self.label_2, 0, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(EricToolBarDialog)
        self.label_3.setObjectName("label_3")
        self.gridlayout.addWidget(self.label_3, 0, 2, 1, 1)
        self.actionsTree = QtWidgets.QTreeWidget(EricToolBarDialog)
        ...
        self.toolbarActionsList = QtWidgets.QListWidget(EricToolBarDialog)
        ...
        self.upButton = QtWidgets.QToolButton(EricToolBarDialog)
        self.upButton.setText("")
        self.upButton.setObjectName("upButton")
        self.gridlayout1.addWidget(self.upButton, 0, 1, 1, 1)
        self.leftButton = QtWidgets.QToolButton(EricToolBarDialog)
        self.leftButton.setText("")
        self.leftButton.setObjectName("leftButton")
        self.gridlayout1.addWidget(self.leftButton, 1, 0, 1, 1)
        self.rightButton = QtWidgets.QToolButton(EricToolBarDialog)
        self.rightButton.setText("")
        self.rightButton.setObjectName("rightButton")
        self.gridlayout1.addWidget(self.rightButton, 1, 2, 1, 1)
        self.downButton = QtWidgets.QToolButton(EricToolBarDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(EricToolBarDialog)
