# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/UI/DiffDialog.ui'
#
...
class Ui_DiffDialog(object):
    def setupUi(self, DiffDialog):
        ...
        self.file1Picker = EricPathPicker(DiffDialog)
        ...
        self.file2Picker = EricPathPicker(DiffDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
