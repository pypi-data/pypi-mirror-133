# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/UI/FindFileWidget.ui'
#
...
class Ui_FindFileWidget(object):
    def setupUi(self, FindFileWidget):
        ...
        self.TextLabel1 = QtWidgets.QLabel(FindFileWidget)
        self.TextLabel1.setObjectName("TextLabel1")
        self.gridLayout_3.addWidget(self.TextLabel1, 0, 0, 1, 1)
        self.findtextCombo = QtWidgets.QComboBox(FindFileWidget)
        ...
        self.caseToolButton = QtWidgets.QToolButton(FindFileWidget)
        ...
        self.wordToolButton = QtWidgets.QToolButton(FindFileWidget)
        ...
        self.regexpToolButton = QtWidgets.QToolButton(FindFileWidget)
        ...
        self.fileOptionsWidget = QtWidgets.QTabWidget(FindFileWidget)
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.fileTypeTab)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.sourcesCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.sourcesCheckBox.setChecked(True)
        self.sourcesCheckBox.setObjectName("sourcesCheckBox")
        self.gridLayout_4.addWidget(self.sourcesCheckBox, 0, 0, 1, 1)
        self.interfacesCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.interfacesCheckBox.setObjectName("interfacesCheckBox")
        self.gridLayout_4.addWidget(self.interfacesCheckBox, 0, 1, 1, 1)
        self.formsCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.formsCheckBox.setObjectName("formsCheckBox")
        self.gridLayout_4.addWidget(self.formsCheckBox, 1, 0, 1, 1)
        self.protocolsCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.protocolsCheckBox.setObjectName("protocolsCheckBox")
        self.gridLayout_4.addWidget(self.protocolsCheckBox, 1, 1, 1, 1)
        self.resourcesCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.resourcesCheckBox.setObjectName("resourcesCheckBox")
        self.gridLayout_4.addWidget(self.resourcesCheckBox, 2, 0, 1, 1)
        self.line = QtWidgets.QFrame(self.fileTypeTab)
        ...
        self.filterCheckBox = QtWidgets.QCheckBox(self.fileTypeTab)
        self.filterCheckBox.setObjectName("filterCheckBox")
        self.horizontalLayout.addWidget(self.filterCheckBox)
        self.filterEdit = QtWidgets.QLineEdit(self.fileTypeTab)
        ...
        self.projectButton = QtWidgets.QRadioButton(self.findInTab)
        ...
        self.dirButton = QtWidgets.QRadioButton(self.findInTab)
        self.dirButton.setObjectName("dirButton")
        self.verticalLayout_2.addWidget(self.dirButton)
        self.dirPicker = EricComboPathPicker(self.findInTab)
        ...
        self.openFilesButton = QtWidgets.QRadioButton(self.findInTab)
        ...
        self.excludeHiddenCheckBox = QtWidgets.QCheckBox(FindFileWidget)
        ...
        self.findProgressLabel = EricSqueezeLabelPath(FindFileWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.clearButton = QtWidgets.QPushButton(FindFileWidget)
        self.clearButton.setObjectName("clearButton")
        self.horizontalLayout_4.addWidget(self.clearButton)
        self.verticalLayout.addLayout(self.horizontalLayout_4)
        self.findProgress = QtWidgets.QProgressBar(FindFileWidget)
        ...
        self.findList = QtWidgets.QTreeWidget(FindFileWidget)
        ...
        self.replaceButton = QtWidgets.QPushButton(FindFileWidget)
        ...
        FindFileWidget.setTabOrder(self.wordToolButton, self.regexpToolButton)
        FindFileWidget.setTabOrder(self.regexpToolButton, self.fileOptionsWidget)
        FindFileWidget.setTabOrder(self.fileOptionsWidget, self.sourcesCheckBox)
        FindFileWidget.setTabOrder(self.sourcesCheckBox, self.formsCheckBox)
        FindFileWidget.setTabOrder(self.formsCheckBox, self.resourcesCheckBox)
        FindFileWidget.setTabOrder(self.resourcesCheckBox, self.interfacesCheckBox)
        FindFileWidget.setTabOrder(self.interfacesCheckBox, self.protocolsCheckBox)
        FindFileWidget.setTabOrder(self.protocolsCheckBox, self.filterCheckBox)
        FindFileWidget.setTabOrder(self.filterCheckBox, self.filterEdit)
        FindFileWidget.setTabOrder(self.filterEdit, self.projectButton)
    ...
    def retranslateUi(self, FindFileWidget):
        ...
        self.sourcesCheckBox.setToolTip(_translate("FindFileWidget", "Search in source files"))
        self.sourcesCheckBox.setText(_translate("FindFileWidget", "&Sources"))
        self.interfacesCheckBox.setToolTip(_translate("FindFileWidget", "Search in interfaces"))
        self.interfacesCheckBox.setText(_translate("FindFileWidget", "&Interfaces"))
        self.formsCheckBox.setToolTip(_translate("FindFileWidget", "Search in forms"))
        self.formsCheckBox.setText(_translate("FindFileWidget", "&Forms"))
        self.protocolsCheckBox.setToolTip(_translate("FindFileWidget", "Search in protocols"))
        self.protocolsCheckBox.setText(_translate("FindFileWidget", "&Protocols"))
        self.resourcesCheckBox.setToolTip(_translate("FindFileWidget", "Search in resources"))
        self.resourcesCheckBox.setText(_translate("FindFileWidget", "&Resources"))
        ...
        self.filterEdit.setToolTip(_translate("FindFileWidget", "Enter the filename wildcards separated by \';\'"))
        ...
        self.excludeHiddenCheckBox.setText(_translate("FindFileWidget", "Exclude hidden files and directories"))
