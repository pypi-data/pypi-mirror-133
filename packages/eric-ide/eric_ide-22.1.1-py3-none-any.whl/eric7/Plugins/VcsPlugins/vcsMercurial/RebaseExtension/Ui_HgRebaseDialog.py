# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/VcsPlugins/vcsMercurial/RebaseExtension/HgRebaseDialog.ui'
#
...
class Ui_HgRebaseDialog(object):
    def setupUi(self, HgRebaseDialog):
        ...
        self.dryRunOnlyButton = QtWidgets.QRadioButton(self.dryRunGroup)
        self.dryRunOnlyButton.setObjectName("dryRunOnlyButton")
        self.horizontalLayout.addWidget(self.dryRunOnlyButton)
        self.dryRunConfirmButton = QtWidgets.QRadioButton(self.dryRunGroup)
