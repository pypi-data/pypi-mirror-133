# Form implementation generated from reading ui file '/home/detlev/Development/Python/Eric/eric7-22.1.1/eric/eric7/Plugins/VcsPlugins/vcsMercurial/HisteditExtension/HgHisteditPlanEditor.ui'
#
...
class Ui_HgHisteditPlanEditor(object):
    def setupUi(self, HgHisteditPlanEditor):
        ...
        self.planTreeWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.buttonBox.accepted.connect(HgHisteditPlanEditor.accept) # type: ignore
        self.buttonBox.rejected.connect(HgHisteditPlanEditor.reject) # type: ignore
