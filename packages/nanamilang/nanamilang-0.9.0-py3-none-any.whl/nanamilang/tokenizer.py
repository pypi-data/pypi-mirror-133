...
class Tokenizer:
    ...
    def _increment_line_no_and_reset_char_no(self) -> None:
        """
        NanamiLang Tokenizer
        increment self._line_no and reset self._char_no
        """
    ...
    def _hash_sym_started_literal_or_an_invalid_token(self,
        ...
        position = (self._line_no, self._char_no)
    ...
    def _invalid_token_with_current_symbol(self, reason: str) -> Token:
        ...
        return Token(Token.Invalid,
                     _valid=False,
                     _reason=reason,
                     _position=(self._line_no, self._char_no), _raw_symbol=self._curr_symbol())
