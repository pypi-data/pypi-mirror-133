...
from nanamilang import datatypes, module, loader
...
def main():
    ...
    loader.Loader.initialize(module.Module,
                             loader.LocalIOLoader, base=os.path.dirname(args.program))

    res = module.Module(source=inp).evaluate().results()[-1][0]  # -1: last res, 0: actual res
