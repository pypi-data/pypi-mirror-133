...
class BuiltinMacros:
    ...
    def require_macro(token_cls,
        ...
        :param _: unused argument, but i need to mention it here
        :param __: unused argument, but i need to mention it here
        :param tree_slice: slice of encountered tree
        :param token_cls: nanamilang.token.Token class
        ...
        global_env.update(loaded_module_qualified_globals if loaded_module_qualified_globals else {})
    ...
    def for_macro(token_cls,
        ...
        identifier_coll_vector_form, using_token_or_form = tree_slice
        ...
        evaluated_coll_or_nexc = eval_function(env, coll_token_or_form)
        ...
        for an_item in evaluated_coll_or_nexc.items():
            env[identifier_token.dt().origin()] = an_item
            evaluated_or_a_nexc = eval_function(env, using_token_or_form)
