...
class MaterialsSettings(_1382.PerMachineSettings):
    '''MaterialsSettings
    ...
    @property
    def available_material_standards(self) -> 'List[_1605.EnumWithBool[_242.MaterialStandards]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AvailableMaterialStandards, constructor.new(_1605.EnumWithBool)[_242.MaterialStandards])
        return value
