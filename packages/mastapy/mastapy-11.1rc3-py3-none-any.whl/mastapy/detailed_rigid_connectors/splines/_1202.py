...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1217
from mastapy.detailed_rigid_connectors.splines import _1214
...
class SAESplineHalfDesign(_1214.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1217.SAESplineTolerances':
        ...
        return constructor.new(_1217.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance is not None else None
