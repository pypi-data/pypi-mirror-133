...
from mastapy.detailed_rigid_connectors.splines import (
    _1189, _1200, _1212, _1204,
    _1201, _1208, _1209, _1184,
    _1187, _1191, _1194, _1202,
    _1214
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors import _1182
...
class SplineJointDesign(_1182.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    def dudley_maximum_effective_length_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.DudleyMaximumEffectiveLengthOption, value) if self.wrapped.DudleyMaximumEffectiveLengthOption is not None else None
    ...
    @property
    def root_type(self) -> '_1200.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1200.RootTypes)(value) if value is not None else None

    @root_type.setter
    def root_type(self, value: '_1200.RootTypes'):
    ...
    def number_of_teeth_in_contact(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.NumberOfTeethInContact) if self.wrapped.NumberOfTeethInContact is not None else None
    ...
    def spline_rating_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_SplineRatingTypes':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.SplineRatingType, value) if self.wrapped.SplineRatingType is not None else None
    ...
    @property
    def torque_cycles(self) -> '_1204.SAETorqueCycles':
        ...
        return constructor.new(_1204.SAETorqueCycles)(value) if value is not None else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1204.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1201.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1201.SAEFatigueLifeFactorTypes)(value) if value is not None else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1201.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1208.SplineFixtureTypes':
        ...
        return constructor.new(_1208.SplineFixtureTypes)(value) if value is not None else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1208.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1209.SplineHalfDesign':
        ...
        if _1209.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ExternalHalf.__class__)(self.wrapped.ExternalHalf) if self.wrapped.ExternalHalf is not None else None

    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1184.CustomSplineHalfDesign':
        ...
        if _1184.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1187.DIN5480SplineHalfDesign':
        ...
        if _1187.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1191.GBT3478SplineHalfDesign':
        ...
        if _1191.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1194.ISO4156SplineHalfDesign':
        ...
        if _1194.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1202.SAESplineHalfDesign':
        ...
        if _1202.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1214.StandardSplineHalfDesign':
        ...
        if _1214.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1209.SplineHalfDesign':
        ...
        if _1209.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.InternalHalf.__class__)(self.wrapped.InternalHalf) if self.wrapped.InternalHalf is not None else None

    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1184.CustomSplineHalfDesign':
        ...
        if _1184.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1187.DIN5480SplineHalfDesign':
        ...
        if _1187.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1191.GBT3478SplineHalfDesign':
        ...
        if _1191.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1194.ISO4156SplineHalfDesign':
        ...
        if _1194.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1202.SAESplineHalfDesign':
        ...
        if _1202.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1214.StandardSplineHalfDesign':
        ...
        if _1214.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
