...
from mastapy.detailed_rigid_connectors.splines import (
    _1193, _1210, _1185, _1188,
    _1192, _1195, _1196, _1203,
    _1215
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1216
from mastapy.detailed_rigid_connectors import _1183
...
class SplineHalfDesign(_1183.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    def ball_or_pin_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.BallOrPinDiameter) if self.wrapped.BallOrPinDiameter is not None else None
    ...
    def number_of_teeth_for_chordal_span_test(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.NumberOfTeethForChordalSpanTest) if self.wrapped.NumberOfTeethForChordalSpanTest is not None else None
    ...
    @property
    def heat_treatment(self) -> '_1193.HeatTreatmentTypes':
        ...
        return constructor.new(_1193.HeatTreatmentTypes)(value) if value is not None else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1193.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1216.FitAndTolerance':
        ...
        return constructor.new(_1216.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance is not None else None
