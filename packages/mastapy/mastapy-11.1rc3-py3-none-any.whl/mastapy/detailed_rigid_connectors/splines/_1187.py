...
from mastapy.detailed_rigid_connectors.splines import _1197, _1206, _1214
...
class DIN5480SplineHalfDesign(_1214.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1197.ManufacturingTypes':
        ...
        return constructor.new(_1197.ManufacturingTypes)(value) if value is not None else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1197.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1206.FinishingMethods':
        ...
        return constructor.new(_1206.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1206.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
