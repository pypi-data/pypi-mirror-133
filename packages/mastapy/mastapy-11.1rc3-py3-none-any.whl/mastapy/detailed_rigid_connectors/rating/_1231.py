...
from mastapy.detailed_rigid_connectors.splines import (
    _1185, _1188, _1192, _1195,
    _1196, _1203, _1210, _1215
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1182.DetailedRigidConnectorDesign':
        ...
        if _1182.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1185.CustomSplineJointDesign':
        ...
        if _1185.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1188.DIN5480SplineJointDesign':
        ...
        if _1188.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1192.GBT3478SplineJointDesign':
        ...
        if _1192.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1195.ISO4156SplineJointDesign':
        ...
        if _1195.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1196.JISB1603SplineJointDesign':
        ...
        if _1196.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1203.SAESplineJointDesign':
        ...
        if _1203.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1210.SplineJointDesign':
        ...
        if _1210.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1215.StandardSplineJointDesign':
        ...
        if _1215.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1232.KeyedJointDesign':
        ...
        if _1232.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1240.InterferenceFitDesign':
        ...
        if _1240.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
