...
from mastapy.detailed_rigid_connectors.interference_fits import _1242
from mastapy.bearings.tolerances import _1672, _1658, _1664
...
class InterferenceFitHalfDesign(_1183.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    def nominal_joint_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.NominalJointDiameter) if self.wrapped.NominalJointDiameter is not None else None
    ...
    def required_safety_against_plastic_strain(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.RequiredSafetyAgainstPlasticStrain) if self.wrapped.RequiredSafetyAgainstPlasticStrain is not None else None
    ...
    @property
    def stress_region(self) -> '_1242.StressRegions':
        ...
        return constructor.new(_1242.StressRegions)(value) if value is not None else None
    ...
    @property
    def tolerance(self) -> '_1672.SupportTolerance':
        ...
        if _1672.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Tolerance.__class__)(self.wrapped.Tolerance) if self.wrapped.Tolerance is not None else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1658.InnerSupportTolerance':
        ...
        if _1658.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1664.OuterSupportTolerance':
        ...
        if _1664.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
