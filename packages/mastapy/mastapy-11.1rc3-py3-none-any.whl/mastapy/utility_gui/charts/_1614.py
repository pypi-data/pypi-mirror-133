...
from mastapy.utility.report import _1548
...
class CustomTableAndChart(_1548.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1282.Range':
        ...
        if _1282.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.PrimaryAxisRange.__class__)(self.wrapped.PrimaryAxisRange) if self.wrapped.PrimaryAxisRange is not None else None
