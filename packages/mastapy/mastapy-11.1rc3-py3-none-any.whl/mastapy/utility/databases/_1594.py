...
from mastapy.utility.databases import _1592, _1589, _1588
...
TKey = TypeVar('TKey', bound='_1589.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1588.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1592.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1589.DatabaseKey'):
