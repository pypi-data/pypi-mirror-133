...
from mastapy.utility.databases import _1592, _1594, _1593
...
TValue = TypeVar('TValue', bound='_1592.NamedDatabaseItem')


class NamedDatabase(_1594.SQLDatabase['_1593.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1592.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1592.NamedDatabaseItem') -> '_1592.NamedDatabaseItem':
