...
from mastapy.utility.report import _1553, _1546
...
class UserTextRow(_1546.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1553.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1553.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1553.HeadingSize'):
