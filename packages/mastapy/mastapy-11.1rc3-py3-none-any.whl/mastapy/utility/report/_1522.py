...
class CustomReport(_1532.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1517.CadTableBorderType':
        ...
        return constructor.new(_1517.CadTableBorderType)(value) if value is not None else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1517.CadTableBorderType'):
    ...
    @property
    def page_size_for_cad_export(self) -> '_1516.CadPageSize':
        ...
        return constructor.new(_1516.CadPageSize)(value) if value is not None else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1516.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def page_orientation_for_cad_export(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CadPageOrientation':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.PageOrientationForCADExport, value) if self.wrapped.PageOrientationForCADExport is not None else None
    ...
    @property
    def include_report_check(self) -> '_1549.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1549.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1549.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
