...
from mastapy.utility.report import _1538, _1541
...
TItem = TypeVar('TItem', bound='_1541.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1538.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
