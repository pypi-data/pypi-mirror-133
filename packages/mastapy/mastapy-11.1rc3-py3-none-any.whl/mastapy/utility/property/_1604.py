...
from mastapy.utility.units_and_measurements.measurements import _1486
...
class DutyCyclePropertySummaryStress(_1600.DutyCyclePropertySummary['_1486.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
