...
from mastapy.bearings import (
    _1623, _1648, _1637, _1646
)
from mastapy.math_utility import _1282
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1594
...
class RollingBearingDatabase(_1594.SQLDatabase['_1646.RollingBearingKey', '_1907.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1907.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1907.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1623.BearingCatalog', type_: '_1648.RollingBearingType', bore_range: '_1282.Range', outer_diameter_range: '_1282.Range', width_range: '_1282.Range', dynamic_capacity_range: '_1282.Range', number_of_rows: 'int', material_type: '_1637.HybridSteelAll') -> 'List[_1907.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1623.BearingCatalog', type_: '_1648.RollingBearingType') -> 'List[_1907.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else '', catalog, type_), constructor.new(_1907.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1623.BearingCatalog') -> '_1907.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1623.BearingCatalog') -> 'List[_1907.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1907.RollingBearing))

    def create_bearing(self, type_: '_1648.RollingBearingType', designation: Optional['str'] = 'None') -> '_1907.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1907.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1648.RollingBearingType', designation: Optional['str'] = 'None') -> '_1646.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1646.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
