...
from mastapy.bearings import _1636
from mastapy.bearings.bearing_results.rolling.fitting import _1857, _1855, _1858
from mastapy.bearings.bearing_results.rolling import (
    _1721, _1819, _1717, _1805,
    _1778
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1861, _1859, _1860
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1848, _1846, _1852, _1851,
    _1847, _1853, _1849
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1843
...
class LoadedRollingBearingResults(_1703.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1636.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1636.FluidFilmTemperatureOptions)(value) if value is not None else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1857.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1857.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly is not None else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1857.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1857.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions is not None else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1855.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1855.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly is not None else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1855.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1855.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions is not None else None
    ...
    @property
    def din732(self) -> '_1717.DIN732Results':
        ...
        return constructor.new(_1717.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 is not None else None

    @property
    def ansiabma(self) -> '_1861.ANSIABMAResults':
        ...
        if _1861.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1859.ANSIABMA112014Results':
        ...
        if _1859.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1860.ANSIABMA92015Results':
        ...
        if _1860.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1848.ISO2812007Results':
        ...
        if _1848.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1846.BallISO2812007Results':
        ...
        if _1846.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1852.RollerISO2812007Results':
        ...
        if _1852.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1851.ISOTS162812008Results':
        ...
        if _1851.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1847.BallISOTS162812008Results':
        ...
        if _1847.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1853.RollerISOTS162812008Results':
        ...
        if _1853.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1849.ISO762006Results':
        ...
        return constructor.new(_1849.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 is not None else None

    @property
    def maximum_static_contact_stress(self) -> '_1805.MaximumStaticContactStress':
        ...
        return constructor.new(_1805.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress is not None else None

    @property
    def skf_module_results(self) -> '_1843.SKFModuleResults':
        ...
        return constructor.new(_1843.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults is not None else None

    @property
    def rows(self) -> 'List[_1778.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1778.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1858.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1858.RingFittingThermalResults))
        return value
