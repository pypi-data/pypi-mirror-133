...
from mastapy.bearings.bearing_results.rolling import _1756, _1747
...
class LoadedDeepGrooveBallBearingRow(_1747.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1756.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1756.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
