...
from mastapy.bearings.bearing_results.rolling import _1753, _1765, _1769
...
class LoadedCylindricalRollerBearingRow(_1769.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1753.LoadedCylindricalRollerBearingResults':
