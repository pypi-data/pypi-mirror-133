...
from mastapy.bearings.bearing_results.rolling import _1721, _1819, _1818
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1721.InternalClearance':
        ...
        if _1721.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
            raise CastException('Failed to cast operating_internal_clearance to InternalClearance. Expected: {}.'.format(self.wrapped.OperatingInternalClearance.__class__.__qualname__))

        return constructor.new_override(self.wrapped.OperatingInternalClearance.__class__)(self.wrapped.OperatingInternalClearance) if self.wrapped.OperatingInternalClearance is not None else None

    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1818.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1818.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1818.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1818.StressAtPosition))
        return value
