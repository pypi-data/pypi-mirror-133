...
from mastapy.bearings.bearing_results.rolling import _1749, _1774
...
class LoadedCrossedRollerBearingRow(_1774.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1749.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1749.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
