...
from mastapy.bearings.bearing_results.rolling.skf_module import _1838, _1841
...
class DynamicAxialLoadCarryingCapacity(_1841.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1838.PermissibleAxialLoad':
        ...
        return constructor.new(_1838.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad is not None else None
