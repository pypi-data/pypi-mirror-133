...
from mastapy.bearings.bearing_results.rolling.skf_module import _1835, _1841
...
class BearingRatingLife(_1841.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1835.LifeModel':
        ...
        return constructor.new(_1835.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel is not None else None
