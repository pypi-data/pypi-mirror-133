...
from mastapy.bearings.bearing_results.rolling import _1780, _1747
...
class LoadedSelfAligningBallBearingRow(_1747.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1780.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1780.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
