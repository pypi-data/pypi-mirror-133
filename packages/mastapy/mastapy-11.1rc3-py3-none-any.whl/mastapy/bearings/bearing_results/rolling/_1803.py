...
from mastapy.bearings.bearing_results.rolling import _1802, _1774
...
class LoadedToroidalRollerBearingRow(_1774.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1802.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1802.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
