...
from mastapy.bearings.bearing_results.rolling import _1817, _1773
...
class LoadedNonBarrelRollerBearingResults(_1773.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1817.SMTRibStressResults':
        ...
        return constructor.new(_1817.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress is not None else None
