...
from mastapy.bearings.bearing_results.rolling import _1812, _1758
...
class LoadedRollerBearingElement(_1758.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1812.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1812.ResultsAtRollerOffset))
        return value
