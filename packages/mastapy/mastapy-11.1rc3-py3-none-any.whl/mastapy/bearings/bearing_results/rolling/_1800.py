...
from mastapy.bearings.bearing_results.rolling import _1799, _1747
...
class LoadedThrustBallBearingRow(_1747.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1799.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1799.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
