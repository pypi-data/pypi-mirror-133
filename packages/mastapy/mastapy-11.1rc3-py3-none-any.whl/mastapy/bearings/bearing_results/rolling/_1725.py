...
from mastapy.bearings.bearing_results.rolling import _1775
...
class LoadedAbstractSphericalRollerBearingStripLoadResults(_1775.LoadedRollerStripLoadResults):
    '''LoadedAbstractSphericalRollerBearingStripLoadResults
