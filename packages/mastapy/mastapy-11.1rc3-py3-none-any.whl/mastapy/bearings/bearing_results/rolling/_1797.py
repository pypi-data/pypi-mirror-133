...
from mastapy.bearings.bearing_results.rolling import _1796, _1747
...
class LoadedThreePointContactBallBearingRow(_1747.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1796.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1796.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
