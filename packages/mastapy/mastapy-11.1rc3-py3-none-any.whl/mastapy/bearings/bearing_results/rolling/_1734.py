...
from mastapy.bearings.bearing_results.rolling import _1733, _1774
...
class LoadedAsymmetricSphericalRollerBearingRow(_1774.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1733.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1733.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
