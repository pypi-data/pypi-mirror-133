...
from mastapy.bearings.bearing_results.rolling import _1765, _1754
...
class LoadedNeedleRollerBearingRow(_1754.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1765.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1765.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
