...
from mastapy.bearings.bearing_results.rolling import _1726
...
class LoadedAngularContactThrustBallBearingElement(_1726.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
