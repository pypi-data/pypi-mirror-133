...
from mastapy.bearings.bearing_results.fluid_film import _1867, _1863
...
class LoadedPlainJournalBearingResults(_1863.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1867.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1867.LoadedPlainJournalBearingRow))
        return value
