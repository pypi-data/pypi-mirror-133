...
from mastapy.bearings.bearing_designs.rolling import _1905, _1906, _1904
...
class NonBarrelRollerBearing(_1904.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1905.RollerEndShape':
        ...
        return constructor.new(_1905.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1905.RollerEndShape'):
    ...
    def roller_end_radius(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.RollerEndRadius) if self.wrapped.RollerEndRadius is not None else None
    ...
    @property
    def ribs(self) -> 'List[_1906.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1906.RollerRibDetail))
        return value
