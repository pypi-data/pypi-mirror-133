...
from mastapy.bearings.bearing_designs.rolling import _1895, _1901
...
class FourPointContactBallBearing(_1901.MultiPointContactBallBearing):
    '''FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_1895.FourPointContactAngleDefinition':
        ...
        return constructor.new(_1895.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_1895.FourPointContactAngleDefinition'):
