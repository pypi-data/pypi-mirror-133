...
from mastapy.bearings.bearing_designs.rolling import _1903
...
class CylindricalRollerBearing(_1903.NonBarrelRollerBearing):
    '''CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1692.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new(_1692.CylindricalRollerMaxAxialLoadMethod)(value) if value is not None else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1692.CylindricalRollerMaxAxialLoadMethod'):
