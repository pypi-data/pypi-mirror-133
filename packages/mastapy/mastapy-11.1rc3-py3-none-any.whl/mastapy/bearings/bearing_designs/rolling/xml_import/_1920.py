...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1921
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1921.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1921.XmlBearingTypeMapping))
        return value
