...
from mastapy.math_utility.stiffness_calculators import _1331
from mastapy._internal import constructor
from mastapy.nodal_analysis.nodal_entities import _120
...
class SurfaceToSurfaceContactStiffnessEntity(_120.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1331.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1331.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact is not None else None
