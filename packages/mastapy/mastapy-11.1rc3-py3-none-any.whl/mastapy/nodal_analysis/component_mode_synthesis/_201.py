...
from mastapy.math_utility import _1296
from mastapy.nodal_analysis.dev_tools_analyses import _154
from mastapy.fe_tools.vfx_tools import _1177
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1296.DataPrecision':
        ...
        return constructor.new(_1296.DataPrecision)(value) if value is not None else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1296.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_154.EigenvalueOptions':
        ...
        return constructor.new(_154.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions is not None else None

    @property
    def solver_options(self) -> '_1177.ProSolveOptions':
        ...
        return constructor.new(_1177.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions is not None else None
