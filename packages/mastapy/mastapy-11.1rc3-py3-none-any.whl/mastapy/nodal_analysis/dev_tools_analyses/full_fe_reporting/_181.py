...
from mastapy.fe_tools.enums import _1180
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1180.ElementPropertyClass':
        ...
        return constructor.new(_1180.ElementPropertyClass)(value) if value is not None else None
