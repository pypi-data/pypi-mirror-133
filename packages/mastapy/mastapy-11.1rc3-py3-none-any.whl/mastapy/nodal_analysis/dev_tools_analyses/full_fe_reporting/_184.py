...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _181
...
class ElementPropertiesMass(_181.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1311.InertiaTensor':
        ...
        return constructor.new(_1311.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia is not None else None
