...
from mastapy.math_utility import _1301
...
class Eigenmodes(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1301.Eigenmode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1301.Eigenmode))
        return value
