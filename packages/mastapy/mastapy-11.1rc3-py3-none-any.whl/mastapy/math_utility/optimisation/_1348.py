...
from mastapy.math_utility.optimisation import _1349, _1347
...
class ParetoOptimistaionVariable(_1347.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1349.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1349.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1349.PropertyTargetForDominantCandidateSearch'):
