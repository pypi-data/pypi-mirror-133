...
from mastapy.cycloidal import _1255, _1249, _1254
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    def number_of_lobes(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfLobes) if self.wrapped.NumberOfLobes is not None else None
    ...
    @property
    def ring_pins(self) -> '_1255.RingPinsDesign':
        ...
        return constructor.new(_1255.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins is not None else None

    @property
    def discs(self) -> 'List[_1249.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1249.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1254.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1254.NamedDiscPhase))
        return value
