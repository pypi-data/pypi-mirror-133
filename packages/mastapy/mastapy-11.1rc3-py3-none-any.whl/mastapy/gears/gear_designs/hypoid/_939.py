...
from mastapy.gears.gear_designs.hypoid import _937, _938
...
class HypoidGearSetDesign(_1137.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    def wheel_finish_cutter_point_width(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.WheelFinishCutterPointWidth) if self.wrapped.WheelFinishCutterPointWidth is not None else None
    ...
    def depth_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.DepthFactor) if self.wrapped.DepthFactor is not None else None
    ...
    def wheel_addendum_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.WheelAddendumFactor) if self.wrapped.WheelAddendumFactor is not None else None
    ...
    def mean_clearance_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.MeanClearanceFactor) if self.wrapped.MeanClearanceFactor is not None else None
    ...
    @property
    def gears(self) -> 'List[_937.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_937.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_937.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_937.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_938.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_938.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_938.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_938.HypoidGearMeshDesign))
        return value
