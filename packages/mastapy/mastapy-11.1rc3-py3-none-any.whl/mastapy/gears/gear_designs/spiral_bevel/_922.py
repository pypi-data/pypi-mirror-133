...
from mastapy.gears.gear_designs.spiral_bevel import _923, _921, _924
...
class SpiralBevelGearMeshDesign(_1123.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_921.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_921.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_924.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_924.SpiralBevelMeshedGearDesign))
        return value
