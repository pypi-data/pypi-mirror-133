...
from mastapy.gears.gear_designs.spiral_bevel import _921, _922
...
class SpiralBevelGearSetDesign(_1124.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_921.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_921.SpiralBevelGearDesign))
        return value
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_922.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_922.SpiralBevelGearMeshDesign))
        return value
