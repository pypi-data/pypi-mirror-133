...
from mastapy.gears.gear_designs import _900
...
class GearDesign(_900.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1139.GearFEModel':
        ...
        if _1139.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1143.CylindricalGearFEModel':
        ...
        if _1143.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1146.ConicalGearFEModel':
        ...
        if _1146.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
