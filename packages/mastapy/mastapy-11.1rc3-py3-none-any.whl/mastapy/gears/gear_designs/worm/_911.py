...
from mastapy.gears.gear_designs.worm import _909, _910
...
class WormGearSetDesign(_902.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_909.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_909.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_909.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_909.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_910.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_910.WormGearMeshDesign))
        return value
