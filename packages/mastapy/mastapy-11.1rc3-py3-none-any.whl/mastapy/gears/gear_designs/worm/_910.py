...
class WormGearMeshDesign(_901.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    def worm(self) -> '_908.WormDesign':
        ...
        return constructor.new(_908.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm is not None else None

    @property
    def wheel(self) -> '_912.WormWheelDesign':
        ...
        return constructor.new(_912.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel is not None else None
