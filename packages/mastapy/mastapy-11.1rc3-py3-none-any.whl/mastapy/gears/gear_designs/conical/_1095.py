...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1104.CutterGaugeLengths':
        ...
        return constructor.new(_1104.CutterGaugeLengths)(value) if value is not None else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1104.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1103.CutterBladeType':
        ...
        return constructor.new(_1103.CutterBladeType)(value) if value is not None else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1103.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1112.TopremEntryType':
        ...
        return constructor.new(_1112.TopremEntryType)(value) if value is not None else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1112.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_1113.TopremLetter':
        ...
        return constructor.new(_1113.TopremLetter)(value) if value is not None else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1113.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1113.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1113.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
