...
from mastapy.gears.gear_designs.bevel import _1126, _1130, _1129
...
class ConicalGearMeshDesign(_901.GearMeshDesign):
    '''ConicalGearMeshDesign
    ...
    def overload_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.OverloadFactor) if self.wrapped.OverloadFactor is not None else None
    ...
    @property
    def driven_machine_characteristic_gleason(self) -> '_1126.DrivenMachineCharacteristicGleason':
        ...
        return constructor.new(_1126.DrivenMachineCharacteristicGleason)(value) if value is not None else None

    @driven_machine_characteristic_gleason.setter
    def driven_machine_characteristic_gleason(self, value: '_1126.DrivenMachineCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DrivenMachineCharacteristicGleason = value

    @property
    def prime_mover_characteristic_gleason(self) -> '_1130.PrimeMoverCharacteristicGleason':
        ...
        return constructor.new(_1130.PrimeMoverCharacteristicGleason)(value) if value is not None else None

    @prime_mover_characteristic_gleason.setter
    def prime_mover_characteristic_gleason(self, value: '_1130.PrimeMoverCharacteristicGleason'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristicGleason = value

    @property
    def prime_mover_characteristic(self) -> '_1129.MachineCharacteristicAGMAKlingelnberg':
        ...
        return constructor.new(_1129.MachineCharacteristicAGMAKlingelnberg)(value) if value is not None else None

    @prime_mover_characteristic.setter
    def prime_mover_characteristic(self, value: '_1129.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PrimeMoverCharacteristic = value

    @property
    def driven_machine_characteristic(self) -> '_1129.MachineCharacteristicAGMAKlingelnberg':
    ...
    def driven_machine_characteristic(self, value: '_1129.MachineCharacteristicAGMAKlingelnberg'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
