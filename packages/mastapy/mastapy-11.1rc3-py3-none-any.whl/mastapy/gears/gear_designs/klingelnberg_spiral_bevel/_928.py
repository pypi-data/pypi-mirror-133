...
from mastapy.gears.gear_designs.klingelnberg_conical import _936
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_936.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
