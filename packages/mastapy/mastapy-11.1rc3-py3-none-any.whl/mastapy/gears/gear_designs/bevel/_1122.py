...
class BevelGearDesign(_1135.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1128.FinishingMethods':
        ...
        return constructor.new(_1128.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1128.FinishingMethods'):
