...
class CylindricalGearTableWithMGCharts(_1548.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_983.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_983.CylindricalGearTableMGItemDetail)(value) if value is not None else None

    @item_detail.setter
    def item_detail(self, value: '_983.CylindricalGearTableMGItemDetail'):
