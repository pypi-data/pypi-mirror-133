...
from mastapy.utility.units_and_measurements.measurements import _1447, _1463
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    @property
    def normal_thickness(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.NormalThickness) if self.wrapped.NormalThickness is not None else None

    @property
    def normal_thickness_at_specified_diameter(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.NormalThicknessAtSpecifiedDiameter) if self.wrapped.NormalThicknessAtSpecifiedDiameter is not None else None

    @property
    def chordal_span(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.ChordalSpan) if self.wrapped.ChordalSpan is not None else None

    @property
    def over_balls(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.OverBalls) if self.wrapped.OverBalls is not None else None

    @property
    def transverse_thickness(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.TransverseThickness) if self.wrapped.TransverseThickness is not None else None

    @property
    def transverse_thickness_at_specified_diameter(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.TransverseThicknessAtSpecifiedDiameter) if self.wrapped.TransverseThicknessAtSpecifiedDiameter is not None else None

    @property
    def profile_shift_coefficient(self) -> '_985.CylindricalGearToothThicknessSpecification[_1463.Number]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1463.Number](self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient is not None else None

    @property
    def profile_shift(self) -> '_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]':
        ...
        return constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort](self.wrapped.ProfileShift) if self.wrapped.ProfileShift is not None else None

    @property
    def tooth_thickness(self) -> 'List[_985.CylindricalGearToothThicknessSpecification[_1447.LengthShort]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothThickness, constructor.new(_985.CylindricalGearToothThicknessSpecification)[_1447.LengthShort])
        return value
