...
from mastapy.gears.gear_designs.cylindrical import _992, _993
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    @property
    def tooth_thickness_reduction_allowance(self) -> '_992.DIN3967AllowanceSeries':
        ...
        return constructor.new(_992.DIN3967AllowanceSeries)(value) if value is not None else None

    @tooth_thickness_reduction_allowance.setter
    def tooth_thickness_reduction_allowance(self, value: '_992.DIN3967AllowanceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothThicknessReductionAllowance = value

    @property
    def tooth_thickness_tolerance(self) -> '_993.DIN3967ToleranceSeries':
        ...
        return constructor.new(_993.DIN3967ToleranceSeries)(value) if value is not None else None

    @tooth_thickness_tolerance.setter
    def tooth_thickness_tolerance(self, value: '_993.DIN3967ToleranceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
