...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _1038
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1083
from mastapy.gears.manufacturing.cylindrical.cutters import _695
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _669
...
class CylindricalGearDefaults(_1382.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    def agma_material(self, value: 'str'):
        self.wrapped.AGMAMaterial.SetSelectedItem(str(value) if value else '')

    @property
    def finish_stock_type(self) -> '_1038.FinishStockType':
        ...
        return constructor.new(_1038.FinishStockType)(value) if value is not None else None

    @finish_stock_type.setter
    def finish_stock_type(self, value: '_1038.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1083.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1083.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults is not None else None

    @property
    def rough_cutter_creation_settings(self) -> '_695.RoughCutterCreationSettings':
        ...
        return constructor.new(_695.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings is not None else None
