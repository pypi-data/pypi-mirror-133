...
from mastapy.gears.gear_designs.cylindrical import (
    _978, _1036, _979, _990,
    _972, _951, _964, _987,
    _991
)
from mastapy._internal.implicit import enum_with_selected_value, overridable
from mastapy.gears import _301, _284
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal.cast_exception import CastException
from mastapy.math_utility.measured_ranges import _1359
...
class CylindricalGearMeshDesign(_901.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_978.CylindricalGearProfileModifications':
        ...
        return constructor.new(_978.CylindricalGearProfileModifications)(value) if value is not None else None

    @profile_modification.setter
    def profile_modification(self, value: '_978.CylindricalGearProfileModifications'):
    ...
    def lubrication_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_LubricationMethods':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.LubricationMethod, value) if self.wrapped.LubricationMethod is not None else None
    ...
    def face_width_factor_for_extended_tip_contact(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.FaceWidthFactorForExtendedTipContact) if self.wrapped.FaceWidthFactorForExtendedTipContact is not None else None
    ...
    def relative_tooth_engagement_time(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.RelativeToothEngagementTime) if self.wrapped.RelativeToothEngagementTime is not None else None
    ...
    def heat_transfer_resistance_of_housing(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.HeatTransferResistanceOfHousing) if self.wrapped.HeatTransferResistanceOfHousing is not None else None
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1036.TypeOfMechanismHousing':
        ...
        return constructor.new(_1036.TypeOfMechanismHousing)(value) if value is not None else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1036.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def wear_coefficient_for_a_driving_pinion(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.WearCoefficientForADrivingPinion) if self.wrapped.WearCoefficientForADrivingPinion is not None else None
    ...
    def wear_coefficient_for_a_driven_pinion(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.WearCoefficientForADrivenPinion) if self.wrapped.WearCoefficientForADrivenPinion is not None else None
    ...
    @property
    def centre_distance_change_method(self) -> '_284.CentreDistanceChangeMethod':
        ...
        return constructor.new(_284.CentreDistanceChangeMethod)(value) if value is not None else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_284.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank(self) -> '_972.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_972.CylindricalGearMeshFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_972.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_972.CylindricalGearMeshFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def backlash_specification(self) -> '_951.BacklashSpecification':
        ...
        return constructor.new(_951.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification is not None else None

    @property
    def valid_normal_module_range(self) -> '_1359.ShortLengthRange':
        ...
        return constructor.new(_1359.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange is not None else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_987.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_987.CylindricalMeshedGear))
        return value

    @property
    def flanks(self) -> 'List[_972.CylindricalGearMeshFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_972.CylindricalGearMeshFlankDesign))
        return value

    @property
    def gear_a(self) -> '_964.CylindricalGearDesign':
        ...
        if _964.CylindricalGearDesign.TYPE not in self.wrapped.GearA.__class__.__mro__:
    ...
    @property
    def gear_b(self) -> '_964.CylindricalGearDesign':
        ...
        if _964.CylindricalGearDesign.TYPE not in self.wrapped.GearB.__class__.__mro__:
    ...
    @property
    def both_flanks(self) -> '_972.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_972.CylindricalGearMeshFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
