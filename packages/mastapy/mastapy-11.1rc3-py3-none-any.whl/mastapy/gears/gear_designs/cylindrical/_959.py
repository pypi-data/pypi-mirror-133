...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    def edge_radius_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.EdgeRadiusFactor) if self.wrapped.EdgeRadiusFactor is not None else None
    ...
    def protuberance_specification(self) -> 'CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod':
        ...
        return constructor.new(CylindricalGearAbstractRackFlank.ProtuberanceSpecificationMethod)(value) if value is not None else None
    ...
    @property
    def cutter(self) -> '_958.CylindricalGearAbstractRack':
        ...
        if _958.CylindricalGearAbstractRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_960.CylindricalGearBasicRack':
        ...
        if _960.CylindricalGearBasicRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_974.CylindricalGearPinionTypeCutter':
        ...
        if _974.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1025.StandardRack':
        ...
        if _1025.StandardRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
