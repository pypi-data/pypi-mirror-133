...
from mastapy.gears.gear_designs.cylindrical import _966
...
class CylindricalGearDesignConstraintSettings(_1382.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_966.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_966.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints is not None else None
