...
class CylindricalGearBasicRack(_958.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_952.BasicRackProfiles':
        ...
        return constructor.new(_952.BasicRackProfiles)(value) if value is not None else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_952.BasicRackProfiles'):
    ...
    def tip_alteration_proportional_method_mesh(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.TipAlterationProportionalMethodMesh) if self.wrapped.TipAlterationProportionalMethodMesh is not None else None
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_1030.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1030.TipAlterationCoefficientMethod)(value) if value is not None else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1030.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_974.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_974.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating is not None else None
