...
from mastapy.gears.gear_designs.cylindrical import (
    _950, _997, _1019, _1013,
    _1037, _980, _1010, _964,
    _971, _981
)
...
from mastapy.gears.rating.cylindrical.iso6336 import _470
...
class CylindricalGearSetDesign(_902.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_950.AddendumModificationDistributionRule':
        ...
        return constructor.new(_950.AddendumModificationDistributionRule)(value) if value is not None else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_950.AddendumModificationDistributionRule'):
    ...
    @property
    def helical_gear_micro_geometry_option(self) -> '_470.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_470.HelicalGearMicroGeometryOption)(value) if value is not None else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_470.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_997.GearFitSystems':
        ...
        return constructor.new(_997.GearFitSystems)(value) if value is not None else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_997.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_1019.Scuffing':
        ...
        return constructor.new(_1019.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing is not None else None

    @property
    def micropitting(self) -> '_1013.Micropitting':
        ...
        return constructor.new(_1013.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting is not None else None

    @property
    def usage(self) -> '_1037.Usage':
        ...
        return constructor.new(_1037.Usage)(self.wrapped.Usage) if self.wrapped.Usage is not None else None

    @property
    def left_flank(self) -> '_980.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_980.CylindricalGearSetFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_980.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_980.CylindricalGearSetFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def ltca_settings(self) -> '_1010.LtcaSettings':
        ...
        return constructor.new(_1010.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings is not None else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_580.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_580.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration is not None else None

    @property
    def gears(self) -> 'List[_964.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_964.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_964.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_964.CylindricalGearDesign))
        return value
    ...
    @property
    def flanks(self) -> 'List[_980.CylindricalGearSetFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_980.CylindricalGearSetFlankDesign))
        return value

    @property
    def micro_geometries(self) -> 'List[_1052.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_1052.CylindricalGearSetMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_980.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_980.CylindricalGearSetFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None

    @property
    def manufacturing_configurations(self) -> 'List[_580.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_580.CylindricalSetManufacturingConfig))
        return value
    ...
    def set_active_manufacturing_configuration(self, value: '_580.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_580.CylindricalSetManufacturingConfig':
    ...
    def delete_manufacturing_configuration(self, config: '_580.CylindricalSetManufacturingConfig'):
    ...
    def create_optimiser(self, duty_cycle: '_427.CylindricalGearSetDutyCycleRating') -> '_981.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def add_new_micro_geometry(self) -> '_1052.CylindricalGearSetMicroGeometry':
    ...
    def delete_micro_geometry(self, micro_geometry: '_1052.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_1052.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1052.CylindricalGearSetMicroGeometry':
