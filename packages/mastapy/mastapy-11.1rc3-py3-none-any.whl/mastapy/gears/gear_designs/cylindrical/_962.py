...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_GeometrySpecificationType':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.GeometrySpecificationType, value) if self.wrapped.GeometrySpecificationType is not None else None
    ...
    def thickness_for_analyses(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.ThicknessForAnalyses) if self.wrapped.ThicknessForAnalyses is not None else None
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_958.CylindricalGearAbstractRack':
        ...
        if _958.CylindricalGearAbstractRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.CylindricalGearCutter.__class__)(self.wrapped.CylindricalGearCutter) if self.wrapped.CylindricalGearCutter is not None else None

    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_960.CylindricalGearBasicRack':
        ...
        if _960.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_974.CylindricalGearPinionTypeCutter':
        ...
        if _974.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_1025.StandardRack':
        ...
        if _1025.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_982.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_982.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection is not None else None

    @property
    def manufacturing_configuration(self) -> '_567.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_567.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration is not None else None
