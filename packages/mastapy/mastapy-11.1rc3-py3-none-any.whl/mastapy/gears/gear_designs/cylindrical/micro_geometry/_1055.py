...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1073, _1061, _1068
...
class CylindricalGearTriangularEndModificationAtOrientation(_0.APIBase):
    ...
    @property
    def linear(self) -> '_1073.SingleCylindricalGearTriangularEndModification':
        ...
        if _1073.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1061.LinearCylindricalGearTriangularEndModification':
        ...
        if _1061.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1068.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1068.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def parabolic(self) -> '_1073.SingleCylindricalGearTriangularEndModification':
        ...
        if _1073.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1061.LinearCylindricalGearTriangularEndModification':
        ...
        if _1061.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1068.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1068.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
