...
class CylindricalGearBiasModification(_524.BiasModification):
    '''CylindricalGearBiasModification
    ...
    @property
    def profile_evaluation_upper_limit(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationUpperLimit) if self.wrapped.ProfileEvaluationUpperLimit is not None else None

    @property
    def profile_evaluation_lower_limit(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationLowerLimit) if self.wrapped.ProfileEvaluationLowerLimit is not None else None

    @property
    def zero_bias_relief(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief is not None else None
