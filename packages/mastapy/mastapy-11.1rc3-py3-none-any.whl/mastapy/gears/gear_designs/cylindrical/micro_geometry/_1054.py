...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1055
...
class CylindricalGearTriangularEndModification(_534.Modification):
    '''CylindricalGearTriangularEndModification
    ...
    @property
    def tip_left(self) -> '_1055.CylindricalGearTriangularEndModificationAtOrientation':
        ...
        return constructor.new(_1055.CylindricalGearTriangularEndModificationAtOrientation)(self.wrapped.TipLeft) if self.wrapped.TipLeft is not None else None

    @property
    def tip_right(self) -> '_1055.CylindricalGearTriangularEndModificationAtOrientation':
        ...
        return constructor.new(_1055.CylindricalGearTriangularEndModificationAtOrientation)(self.wrapped.TipRight) if self.wrapped.TipRight is not None else None

    @property
    def root_left(self) -> '_1055.CylindricalGearTriangularEndModificationAtOrientation':
        ...
        return constructor.new(_1055.CylindricalGearTriangularEndModificationAtOrientation)(self.wrapped.RootLeft) if self.wrapped.RootLeft is not None else None

    @property
    def root_right(self) -> '_1055.CylindricalGearTriangularEndModificationAtOrientation':
        ...
        return constructor.new(_1055.CylindricalGearTriangularEndModificationAtOrientation)(self.wrapped.RootRight) if self.wrapped.RootRight is not None else None
