...
class CylindricalGearProfileModification(_537.ProfileModification):
    '''CylindricalGearProfileModification
    ...
    @property
    def profile_modification_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.ProfileModificationChart.__class__.__mro__:
            raise CastException('Failed to cast profile_modification_chart to TwoDChartDefinition. Expected: {}.'.format(self.wrapped.ProfileModificationChart.__class__.__qualname__))

        return constructor.new_override(self.wrapped.ProfileModificationChart.__class__)(self.wrapped.ProfileModificationChart) if self.wrapped.ProfileModificationChart is not None else None
    ...
    @property
    def linear_root_relief_start(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LinearRootReliefStart) if self.wrapped.LinearRootReliefStart is not None else None

    @property
    def parabolic_root_relief_start(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ParabolicRootReliefStart) if self.wrapped.ParabolicRootReliefStart is not None else None

    @property
    def linear_tip_relief_start(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LinearTipReliefStart) if self.wrapped.LinearTipReliefStart is not None else None

    @property
    def parabolic_tip_relief_start(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ParabolicTipReliefStart) if self.wrapped.ParabolicTipReliefStart is not None else None

    @property
    def barrelling_peak_point(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.BarrellingPeakPoint) if self.wrapped.BarrellingPeakPoint is not None else None

    @property
    def evaluation_lower_limit(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.EvaluationLowerLimit) if self.wrapped.EvaluationLowerLimit is not None else None

    @property
    def evaluation_upper_limit(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.EvaluationUpperLimit) if self.wrapped.EvaluationUpperLimit is not None else None

    @property
    def evaluation_upper_limit_for_zero_tip_relief(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.EvaluationUpperLimitForZeroTipRelief) if self.wrapped.EvaluationUpperLimitForZeroTipRelief is not None else None

    @property
    def evaluation_lower_limit_for_zero_root_relief(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.EvaluationLowerLimitForZeroRootRelief) if self.wrapped.EvaluationLowerLimitForZeroRootRelief is not None else None

    @property
    def linear_tip_relief_evaluation(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LinearTipReliefEvaluation) if self.wrapped.LinearTipReliefEvaluation is not None else None

    @property
    def parabolic_tip_relief_evaluation(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ParabolicTipReliefEvaluation) if self.wrapped.ParabolicTipReliefEvaluation is not None else None

    @property
    def linear_root_relief_evaluation(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LinearRootReliefEvaluation) if self.wrapped.LinearRootReliefEvaluation is not None else None

    @property
    def parabolic_root_relief_evaluation(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.ParabolicRootReliefEvaluation) if self.wrapped.ParabolicRootReliefEvaluation is not None else None
