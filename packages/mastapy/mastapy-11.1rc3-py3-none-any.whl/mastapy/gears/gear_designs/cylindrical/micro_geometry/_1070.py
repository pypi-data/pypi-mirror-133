...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1072
...
class ProfileReliefWithDeviation(_1072.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile is not None else None
