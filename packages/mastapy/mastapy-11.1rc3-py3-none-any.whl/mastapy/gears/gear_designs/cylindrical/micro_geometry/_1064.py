...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1075, _1069
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1069.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormReliefPoints, constructor.new(_1069.ProfileFormReliefWithDeviation))
        return value

    @property
    def involute_inspection_points(self) -> 'List[_1075.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InvoluteInspectionPoints, constructor.new(_1075.TotalProfileReliefWithDeviation))
        return value
