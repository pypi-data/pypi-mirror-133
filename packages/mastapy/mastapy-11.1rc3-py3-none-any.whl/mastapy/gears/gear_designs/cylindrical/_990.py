...
class CylindricalPlanetaryGearSetDesign(_979.CylindricalGearSetDesign):
    '''CylindricalPlanetaryGearSetDesign
    ...
    @property
    def planet_gear_phasing_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.PlanetGearPhasingChart.__class__.__mro__:
    ...
    @property
    def planetary_sideband_fourier_series_for_rotating_planet_carrier(self) -> '_1307.FourierSeries':
        ...
        return constructor.new(_1307.FourierSeries)(self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier) if self.wrapped.PlanetarySidebandFourierSeriesForRotatingPlanetCarrier is not None else None
