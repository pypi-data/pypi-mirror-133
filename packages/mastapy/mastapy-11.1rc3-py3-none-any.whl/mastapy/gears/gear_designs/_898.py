...
from mastapy.gears.gear_designs import _896
...
class DesignConstraintsCollection(_1592.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1599.DeletableCollectionMember[_896.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1599.DeletableCollectionMember)[_896.DesignConstraint])
        return value
