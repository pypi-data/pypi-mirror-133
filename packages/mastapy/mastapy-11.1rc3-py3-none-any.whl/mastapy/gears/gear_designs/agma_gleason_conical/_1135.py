...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1078, _1082, _1087
...
class AGMAGleasonConicalGearDesign(_1096.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_1106.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_1106.FrontEndTypes)(value) if value is not None else None

    @front_end_type.setter
    def front_end_type(self, value: '_1106.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_1095.ConicalGearCutter':
        ...
        if _1095.ConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_768.PinionFinishCutter':
        ...
        if _768.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_769.PinionRoughCutter':
        ...
        if _769.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_770.WheelFinishCutter':
        ...
        if _770.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_771.WheelRoughCutter':
        ...
        if _771.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Cutter.__class__)(self.wrapped.Cutter) if self.wrapped.Cutter is not None else None

    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_1105.DummyConicalGearCutter':
        ...
        if _1105.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_1078.AGMA20151AccuracyGrades':
        ...
        if _1078.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_1082.CylindricalAccuracyGrades':
        ...
        if _1082.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_1087.ISO1328AccuracyGrades':
        ...
        if _1087.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1134.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1134.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def bevel_gear_material(self) -> '_549.GearMaterial':
        ...
        if _549.GearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_538.AGMACylindricalGearMaterial':
        ...
        if _538.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_540.BevelGearISOMaterial':
        ...
        if _540.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_542.BevelGearMaterial':
        ...
        if _542.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_546.CylindricalGearMaterial':
        ...
        if _546.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_552.ISOCylindricalGearMaterial':
        ...
        if _552.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_556.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _556.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_558.PlasticCylindricalGearMaterial':
        ...
        if _558.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
