...
from mastapy.gears.gear_designs.straight_bevel_diff import _915, _913, _916
...
class StraightBevelDiffGearMeshDesign(_1123.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_913.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_913.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_916.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_916.StraightBevelDiffMeshedGearDesign))
        return value
