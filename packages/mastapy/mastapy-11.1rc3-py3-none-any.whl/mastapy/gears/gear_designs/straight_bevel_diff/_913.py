...
from mastapy.gears.gear_designs.bevel import _1127, _1122
...
class StraightBevelDiffGearDesign(_1122.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1127.EdgeRadiusType':
        ...
        return constructor.new(_1127.EdgeRadiusType)(value) if value is not None else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1127.EdgeRadiusType'):
