...
from mastapy.gears.fe_model import _1140, _1139
...
class GearSetFEModel(_1170.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def element_order(self) -> '_55.ElementOrder':
        '''ElementOrder: 'ElementOrder' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ElementOrder)
        return constructor.new(_55.ElementOrder)(value) if value is not None else None

    @element_order.setter
    def element_order(self, value: '_55.ElementOrder'):
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1140.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1140.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1139.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1139.GearFEModel))
        return value
