...
class StraightBevelGearRating(_510.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_917.StraightBevelGearDesign':
        ...
        return constructor.new(_917.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear is not None else None
