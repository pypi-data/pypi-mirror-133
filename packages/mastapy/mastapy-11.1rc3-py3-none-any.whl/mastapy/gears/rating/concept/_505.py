...
from mastapy.gears.gear_designs.concept import _1119
...
class ConceptGearMeshRating(_326.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_1119.ConceptGearMeshDesign':
        ...
        return constructor.new(_1119.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh is not None else None
