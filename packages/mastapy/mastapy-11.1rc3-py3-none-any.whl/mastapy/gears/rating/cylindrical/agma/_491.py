...
from mastapy.gears.gear_designs.cylindrical import _978, _1021
from mastapy.materials import _225
from mastapy.gears.rating.cylindrical.agma import _490
...
class AGMA2101MeshSingleFlankRating(_431.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def gearing_type(self) -> '_225.GearingTypes':
        ...
        return constructor.new(_225.GearingTypes)(value) if value is not None else None

    @property
    def scuffing_temperature_method(self) -> '_1021.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_1021.ScuffingTemperatureMethodsAGMA)(value) if value is not None else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_490.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_490.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_490.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_490.AGMA2101GearSingleFlankRating))
        return value
