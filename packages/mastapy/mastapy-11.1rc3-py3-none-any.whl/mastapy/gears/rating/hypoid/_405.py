...
class HypoidGearRating(_521.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_937.HypoidGearDesign':
        ...
        return constructor.new(_937.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear is not None else None
