...
class HypoidGearMeshRating(_520.AGMAGleasonConicalGearMeshRating):
    '''HypoidGearMeshRating
    ...
    @property
    def hypoid_gear_mesh(self) -> '_938.HypoidGearMeshDesign':
        ...
        return constructor.new(_938.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh is not None else None
