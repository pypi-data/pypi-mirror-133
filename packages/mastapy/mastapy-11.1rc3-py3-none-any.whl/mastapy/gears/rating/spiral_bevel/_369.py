...
class SpiralBevelGearRating(_510.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_921.SpiralBevelGearDesign':
        ...
        return constructor.new(_921.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear is not None else None
