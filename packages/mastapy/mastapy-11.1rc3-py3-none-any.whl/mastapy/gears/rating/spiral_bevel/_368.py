...
class SpiralBevelGearMeshRating(_509.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_922.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_922.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh is not None else None
