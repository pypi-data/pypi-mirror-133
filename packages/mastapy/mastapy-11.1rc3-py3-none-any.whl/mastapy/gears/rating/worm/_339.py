...
class WormGearMeshRating(_326.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_910.WormGearMeshDesign':
        ...
        return constructor.new(_910.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh is not None else None
