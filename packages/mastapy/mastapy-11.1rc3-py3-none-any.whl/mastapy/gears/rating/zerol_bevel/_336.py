...
class ZerolBevelGearRating(_510.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_904.ZerolBevelGearDesign':
        ...
        return constructor.new(_904.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear is not None else None
