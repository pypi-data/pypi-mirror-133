...
class ZerolBevelGearMeshRating(_509.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_905.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_905.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh is not None else None
