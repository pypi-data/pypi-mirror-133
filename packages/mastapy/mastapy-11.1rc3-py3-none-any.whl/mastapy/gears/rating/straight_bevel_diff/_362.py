...
class StraightBevelDiffGearRating(_495.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_913.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_913.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear is not None else None
