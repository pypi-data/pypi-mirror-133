...
from mastapy.gears.rating.conical import _496, _495
from mastapy._internal import constructor, conversion
from mastapy.gears.rating import _325, _324
from mastapy.gears.rating.cylindrical import _419, _420
...
class ConicalGearDutyCycleRating(_324.GearDutyCycleRating):
    '''ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_496.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_496.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_496.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_496.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle is not None else None
    ...
    @property
    def concave_flank_rating(self) -> '_325.GearFlankRating':
        ...
        if _325.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    @property
    def convex_flank_rating(self) -> '_325.GearFlankRating':
        ...
        if _325.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
    ...
    @property
    def gear_ratings(self) -> 'List[_495.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_495.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_495.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_495.ConicalGearRating))
        return value
