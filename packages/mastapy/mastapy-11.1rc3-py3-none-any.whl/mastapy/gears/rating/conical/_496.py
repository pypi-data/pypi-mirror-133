...
class ConicalGearSetDutyCycleRating(_328.GearSetDutyCycleRating):
    '''ConicalGearSetDutyCycleRating
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_499.ConicalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshDutyCycleRatings, constructor.new(_499.ConicalMeshDutyCycleRating))
        return value

    @property
    def conical_mesh_duty_cycle_ratings(self) -> 'List[_499.ConicalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshDutyCycleRatings, constructor.new(_499.ConicalMeshDutyCycleRating))
        return value
