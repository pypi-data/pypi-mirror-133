...
class ConicalMeshDutyCycleRating(_331.MeshDutyCycleRating):
    '''ConicalMeshDutyCycleRating
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_494.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_494.ConicalGearMeshRating))
        return value
