...
from mastapy.gears.gear_set_pareto_optimiser import _861, _872
...
class MicroGeometryDesignSpaceSearch(_861.DesignSpaceSearchBase['_815.CylindricalGearSetLoadDistributionAnalysis', '_872.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_815.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _815.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_1052.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1052.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_1052.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1052.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1052.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1052.CylindricalGearSetMicroGeometry))
        return value
