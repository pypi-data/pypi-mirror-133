...
class CylindricalGearSetParetoOptimiser(_867.GearSetParetoOptimiser):
    '''CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_979.CylindricalGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_979.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_979.CylindricalGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_979.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_979.CylindricalGearSetDesign))
        return value
