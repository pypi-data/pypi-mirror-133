...
from mastapy.gears.gear_set_pareto_optimiser import _865
...
class GearNameMapper(_0.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_865.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_865.GearNamePicker))
        return value
