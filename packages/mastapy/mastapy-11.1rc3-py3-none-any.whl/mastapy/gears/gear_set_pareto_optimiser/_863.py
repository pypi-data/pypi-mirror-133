...
class FaceGearSetParetoOptimiser(_867.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_947.FaceGearSetDesign':
        ...
        return constructor.new(_947.FaceGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry is not None else None

    @property
    def candidate_gear_sets(self) -> 'List[_947.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_947.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_947.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_947.FaceGearSetDesign))
        return value
