...
class MicroGeometryDesignSpaceSearchChartInformation(_859.ChartInfoBase['_815.CylindricalGearSetLoadDistributionAnalysis', '_872.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_871.MicroGeometryDesignSpaceSearch':
