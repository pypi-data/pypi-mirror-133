...
from mastapy.gears.manufacturing.bevel.cutters import _768, _769
...
class ConicalPinionManufacturingConfig(_731.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_740.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_740.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig is not None else None

    @property
    def pinion_concave_ob_configuration(self) -> '_736.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_736.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration is not None else None

    @property
    def pinion_convex_ib_configuration(self) -> '_736.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_736.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration is not None else None

    @property
    def pinion_finish_cutter(self) -> '_768.PinionFinishCutter':
        ...
        return constructor.new(_768.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter is not None else None

    @property
    def pinion_rough_cutter(self) -> '_769.PinionRoughCutter':
        ...
        return constructor.new(_769.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter is not None else None

    @property
    def pinion_cutter_parameters_concave(self) -> '_761.PinionFinishMachineSettings':
        ...
        if _761.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_756.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _756.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_757.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _757.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_conical_machine_settings_specified(self) -> '_759.PinionConicalMachineSettingsSpecified':
        ...
        if _759.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_762.PinionHypoidFormateTiltMachineSettings':
        ...
        if _762.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_763.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _763.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_machine_settings_smt(self) -> '_764.PinionMachineSettingsSMT':
        ...
        if _764.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex(self) -> '_761.PinionFinishMachineSettings':
        ...
        if _761.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_756.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _756.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_757.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _757.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_conical_machine_settings_specified(self) -> '_759.PinionConicalMachineSettingsSpecified':
        ...
        if _759.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_762.PinionHypoidFormateTiltMachineSettings':
        ...
        if _762.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_763.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _763.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_machine_settings_smt(self) -> '_764.PinionMachineSettingsSMT':
        ...
        if _764.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_765.PinionRoughMachineSetting':
        ...
        return constructor.new(_765.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting is not None else None
