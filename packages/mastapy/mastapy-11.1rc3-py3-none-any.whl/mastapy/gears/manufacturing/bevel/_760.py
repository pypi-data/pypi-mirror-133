...
class PinionConvex(_0.APIBase):
    ...
    @property
    def pinion_convex_ib_configuration(self) -> '_778.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_778.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration is not None else None
