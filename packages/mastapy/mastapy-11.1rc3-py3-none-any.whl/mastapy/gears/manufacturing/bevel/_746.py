...
from mastapy.gears.gear_designs.conical import _1100, _1099
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _731, _740, _748
...
class ConicalSetManufacturingConfig(_748.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_731.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_731.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_740.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_740.ConicalMeshManufacturingConfig))
        return value
