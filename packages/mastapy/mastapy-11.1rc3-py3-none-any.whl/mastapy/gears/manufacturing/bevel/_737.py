...
from mastapy.gears.gear_designs.conical.micro_geometry import _1115
...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_1115.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_1115.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface is not None else None
