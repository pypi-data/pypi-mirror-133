...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _776
...
class BasicConicalGearMachineSettingsGenerated(_776.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
