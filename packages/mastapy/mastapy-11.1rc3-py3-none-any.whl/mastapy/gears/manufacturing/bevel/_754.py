...
from mastapy.gears.manufacturing.bevel import _753, _767
...
class ManufacturingMachine(_1592.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_753.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_753.MachineTypes)(value) if value is not None else None

    @machine_type.setter
    def machine_type(self, value: '_753.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_767.WheelFormatMachineTypes':
        ...
        return constructor.new(_767.WheelFormatMachineTypes)(value) if value is not None else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_767.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
