...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _703
...
class CylindricalGearHobShape(_703.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_682.CylindricalGearHobDesign':
        ...
        return constructor.new(_682.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design is not None else None
