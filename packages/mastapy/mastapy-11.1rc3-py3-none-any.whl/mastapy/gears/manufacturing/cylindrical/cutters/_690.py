...
from mastapy.gears.manufacturing.cylindrical.cutters import _681
...
class CylindricalWormGrinderDatabase(_565.CylindricalCutterDatabase['_681.CylindricalGearGrindingWorm']):
    '''CylindricalWormGrinderDatabase
