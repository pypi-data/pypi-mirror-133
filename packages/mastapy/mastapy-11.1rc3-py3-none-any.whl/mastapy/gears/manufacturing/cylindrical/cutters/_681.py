...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _701, _703, _698
...
class CylindricalGearGrindingWorm(_685.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_701.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_701.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape is not None else None
