...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _702
...
class CutterShapeDefinition(_0.APIBase):
    ...
    @property
    def design(self) -> '_686.CylindricalGearRealCutterDesign':
        ...
        if _686.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_680.CylindricalGearFormGrindingWheel':
        ...
        if _680.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_681.CylindricalGearGrindingWorm':
        ...
        if _681.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_hob_design(self) -> '_682.CylindricalGearHobDesign':
        ...
        if _682.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_683.CylindricalGearPlungeShaver':
        ...
        if _683.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_685.CylindricalGearRackDesign':
        ...
        if _685.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_687.CylindricalGearShaper':
        ...
        if _687.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_688.CylindricalGearShaver':
        ...
        if _688.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_691.InvoluteCutterDesign':
        ...
        if _691.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_702.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_702.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_702.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_702.NamedPoint))
        return value
