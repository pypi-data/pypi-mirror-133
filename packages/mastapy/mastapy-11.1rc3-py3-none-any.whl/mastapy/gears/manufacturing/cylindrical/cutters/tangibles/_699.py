...
class CylindricalGearShaperTangible(_696.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_687.CylindricalGearShaper':
        ...
        return constructor.new(_687.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design is not None else None
