...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _698, _703, _701
...
class CylindricalGearHobDesign(_685.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_586.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_586.HobEdgeTypes)(value) if value is not None else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_586.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_698.CylindricalGearHobShape':
        ...
        return constructor.new(_698.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape is not None else None

    @property
    def nominal_rack_shape(self) -> '_703.RackShape':
        ...
        if _703.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.NominalRackShape.__class__)(self.wrapped.NominalRackShape) if self.wrapped.NominalRackShape is not None else None

    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_698.CylindricalGearHobShape':
        ...
        if _698.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_701.CylindricalGearWormGrinderShape':
        ...
        if _701.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_698.CylindricalGearHobShape':
        ...
        return constructor.new(_698.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape is not None else None

    @property
    def minimum_hob_material_shape(self) -> '_698.CylindricalGearHobShape':
        ...
        return constructor.new(_698.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape is not None else None
