...
from mastapy.gears.manufacturing.cylindrical.cutters import _677, _679
...
class CylindricalGearRealCutterDesign(_679.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    def number_of_points_for_reporting_fillet_shape(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfPointsForReportingFilletShape) if self.wrapped.NumberOfPointsForReportingFilletShape is not None else None
    ...
    def number_of_points_for_reporting_main_blade_shape(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfPointsForReportingMainBladeShape) if self.wrapped.NumberOfPointsForReportingMainBladeShape is not None else None
    ...
    def cutter_and_gear_normal_base_pitch_comparison_tolerance(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.CutterAndGearNormalBasePitchComparisonTolerance) if self.wrapped.CutterAndGearNormalBasePitchComparisonTolerance is not None else None
    ...
    @property
    def nominal_cutter_shape(self) -> '_696.CutterShapeDefinition':
        ...
        if _696.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.NominalCutterShape.__class__)(self.wrapped.NominalCutterShape) if self.wrapped.NominalCutterShape is not None else None

    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_697.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _697.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_698.CylindricalGearHobShape':
        ...
        if _698.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_699.CylindricalGearShaperTangible':
        ...
        if _699.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_700.CylindricalGearShaverTangible':
        ...
        if _700.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_701.CylindricalGearWormGrinderShape':
        ...
        if _701.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_703.RackShape':
        ...
        if _703.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_677.CustomisableEdgeProfile':
        ...
        return constructor.new(_677.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile is not None else None
