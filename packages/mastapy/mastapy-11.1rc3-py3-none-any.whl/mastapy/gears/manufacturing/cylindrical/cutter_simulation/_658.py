...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _659, _664
...
class CutterSimulationCalc(_0.APIBase):
    ...
    def theoretical_finish_root_diameter(self) -> 'float':
        ...
        return self.wrapped.TheoreticalFinishRootDiameter
    ...
    def radial_clearance_between_rough_root_circle_and_theoretical_finish_root_circle(self) -> 'float':
        ...
        return self.wrapped.RadialClearanceBetweenRoughRootCircleAndTheoreticalFinishRootCircle
    ...
    @property
    def gear(self) -> '_659.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_659.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear is not None else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_664.FinishStockPoint':
        ...
        return constructor.new(_664.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter is not None else None

    @property
    def stock_removed_at_designed_sap(self) -> '_664.FinishStockPoint':
        ...
        return constructor.new(_664.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP is not None else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_664.FinishStockPoint':
        ...
        return constructor.new(_664.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm is not None else None

    @property
    def gear_fillet_points(self) -> 'List[_702.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_702.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_664.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_664.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_664.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_664.FinishStockPoint))
        return value
