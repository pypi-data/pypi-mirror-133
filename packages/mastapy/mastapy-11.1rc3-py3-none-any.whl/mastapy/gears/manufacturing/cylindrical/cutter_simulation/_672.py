...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _699
...
class ShaperSimulationCalculator(_658.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_699.CylindricalGearShaperTangible':
        ...
        return constructor.new(_699.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper is not None else None
