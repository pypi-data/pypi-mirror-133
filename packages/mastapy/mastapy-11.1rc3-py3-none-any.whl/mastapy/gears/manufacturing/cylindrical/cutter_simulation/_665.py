...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _697
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _658
...
class FormWheelGrindingSimulationCalculator(_658.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_697.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_697.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel is not None else None
