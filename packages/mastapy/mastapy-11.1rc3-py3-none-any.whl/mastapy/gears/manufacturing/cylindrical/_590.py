...
from mastapy.gears.manufacturing.cylindrical import _588, _592
...
class MicroGeometryInputsProfile(_588.MicroGeometryInputs['_592.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1282.Range':
        ...
        if _1282.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ProfileMicroGeometryRange.__class__)(self.wrapped.ProfileMicroGeometryRange) if self.wrapped.ProfileMicroGeometryRange is not None else None
