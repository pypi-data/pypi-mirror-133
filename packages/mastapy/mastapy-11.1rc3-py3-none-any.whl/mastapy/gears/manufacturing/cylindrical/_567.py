...
from mastapy.gears.manufacturing.cylindrical import _579, _578, _566
...
from mastapy.gears.gear_designs.cylindrical import _995, _964, _991
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _666, _663, _671, _660,
    _669
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _594, _595, _596
from mastapy.gears.analysis import _1160
...
class CylindricalGearManufacturingConfig(_1160.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    @property
    def rough_cutter(self) -> '_686.CylindricalGearRealCutterDesign':
        ...
        if _686.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_680.CylindricalGearFormGrindingWheel':
        ...
        if _680.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_681.CylindricalGearGrindingWorm':
        ...
        if _681.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_682.CylindricalGearHobDesign':
        ...
        if _682.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_683.CylindricalGearPlungeShaver':
        ...
        if _683.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_685.CylindricalGearRackDesign':
        ...
        if _685.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_687.CylindricalGearShaper':
        ...
        if _687.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_688.CylindricalGearShaver':
        ...
        if _688.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_691.InvoluteCutterDesign':
        ...
        if _691.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter(self) -> '_686.CylindricalGearRealCutterDesign':
        ...
        if _686.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_680.CylindricalGearFormGrindingWheel':
        ...
        if _680.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_681.CylindricalGearGrindingWorm':
        ...
        if _681.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_682.CylindricalGearHobDesign':
        ...
        if _682.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_683.CylindricalGearPlungeShaver':
        ...
        if _683.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_685.CylindricalGearRackDesign':
        ...
        if _685.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_687.CylindricalGearShaper':
        ...
        if _687.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_688.CylindricalGearShaver':
        ...
        if _688.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_691.InvoluteCutterDesign':
        ...
        if _691.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_666.GearCutterSimulation':
        ...
        if _666.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_663.FinishCutterSimulation':
        ...
        if _663.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_671.RoughCutterSimulation':
        ...
        if _671.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation(self) -> '_594.CutterProcessSimulation':
        ...
        if _594.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_595.FormWheelGrindingProcessSimulation':
        ...
        if _595.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_596.ShapingProcessSimulation':
        ...
        if _596.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_666.GearCutterSimulation':
        ...
        if _666.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_663.FinishCutterSimulation':
        ...
        if _663.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_671.RoughCutterSimulation':
        ...
        if _671.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation(self) -> '_594.CutterProcessSimulation':
        ...
        if _594.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_595.FormWheelGrindingProcessSimulation':
        ...
        if _595.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_596.ShapingProcessSimulation':
        ...
        if _596.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def design(self) -> '_964.CylindricalGearDesign':
        ...
        if _964.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_660.CylindricalGearSpecification':
        ...
        return constructor.new(_660.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification is not None else None

    @property
    def finished_gear_specification(self) -> '_660.CylindricalGearSpecification':
        ...
        return constructor.new(_660.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification is not None else None

    @property
    def gear_blank(self) -> '_566.CylindricalGearBlank':
        ...
        return constructor.new(_566.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank is not None else None

    @property
    def rough_manufacturing_process_controls(self) -> '_669.ManufacturingProcessControls':
        ...
        return constructor.new(_669.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls is not None else None

    @property
    def finish_manufacturing_process_controls(self) -> '_669.ManufacturingProcessControls':
        ...
        return constructor.new(_669.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls is not None else None
