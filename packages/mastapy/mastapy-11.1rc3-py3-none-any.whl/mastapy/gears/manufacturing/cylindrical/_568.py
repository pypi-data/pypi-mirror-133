...
from mastapy.gears.manufacturing.cylindrical import _589, _590
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_589.MicroGeometryInputsLead':
        ...
        return constructor.new(_589.MicroGeometryInputsLead)(self.wrapped.LeadMicroGeometry) if self.wrapped.LeadMicroGeometry is not None else None

    @property
    def profile_micro_geometry(self) -> 'List[_590.MicroGeometryInputsProfile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileMicroGeometry, constructor.new(_590.MicroGeometryInputsProfile))
        return value
