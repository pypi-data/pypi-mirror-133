...
class ShavingDynamicsCalculationForDesignedGears(_721.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value is not None else None

    @property
    def end_of_shaving_profile(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value is not None else None

    @property
    def redressing(self) -> '_719.ShaverRedressing[T]':
        ...
        if _719.ShaverRedressing[T].TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_705.AxialShaverRedressing':
        ...
        if _705.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_712.PlungeShaverRedressing':
        ...
        if _712.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
