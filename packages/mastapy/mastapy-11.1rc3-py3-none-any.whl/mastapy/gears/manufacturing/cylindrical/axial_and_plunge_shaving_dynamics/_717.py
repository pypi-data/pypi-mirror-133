...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _718
...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_718.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_718.RollAngleReportObject))
        return value
