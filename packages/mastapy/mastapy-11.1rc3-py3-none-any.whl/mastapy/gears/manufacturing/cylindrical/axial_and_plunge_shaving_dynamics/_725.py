...
from mastapy.gears.gear_designs.cylindrical import _1028, _977
...
class ShavingDynamicsViewModel(_726.ShavingDynamicsViewModelBase, Generic[T]):
    '''ShavingDynamicsViewModel
    ...
    @property
    def redressing_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.RedressingChart.__class__.__mro__:
    ...
    @property
    def chart_display_method(self) -> '_977.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_977.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def active_profile_range_calculation_source(self) -> '_704.ActiveProfileRangeCalculationSource':
        ...
        return constructor.new(_704.ActiveProfileRangeCalculationSource)(value) if value is not None else None

    @active_profile_range_calculation_source.setter
    def active_profile_range_calculation_source(self, value: '_704.ActiveProfileRangeCalculationSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def calculation(self) -> '_721.ShavingDynamicsCalculation[T]':
        ...
        if _721.ShavingDynamicsCalculation[T].TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_designed_gears(self) -> '_707.ConventionalShavingDynamicsCalculationForDesignedGears':
        ...
        if _707.ConventionalShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_conventional_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_708.ConventionalShavingDynamicsCalculationForHobbedGears':
        ...
        if _708.ConventionalShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_designed_gears(self) -> '_713.PlungeShavingDynamicsCalculationForDesignedGears':
        ...
        if _713.PlungeShavingDynamicsCalculationForDesignedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
    ...
    @property
    def calculation_of_type_plunge_shaving_dynamics_calculation_for_hobbed_gears(self) -> '_714.PlungeShavingDynamicsCalculationForHobbedGears':
        ...
        if _714.PlungeShavingDynamicsCalculationForHobbedGears.TYPE not in self.wrapped.Calculation.__class__.__mro__:
