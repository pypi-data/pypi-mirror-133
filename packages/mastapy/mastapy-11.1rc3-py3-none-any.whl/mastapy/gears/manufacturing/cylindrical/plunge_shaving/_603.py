...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    def shaver_normal_module(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ShaverNormalModule) if self.wrapped.ShaverNormalModule is not None else None
    ...
    def shaver_normal_pressure_angle(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ShaverNormalPressureAngle) if self.wrapped.ShaverNormalPressureAngle is not None else None
    ...
    def thickness_at_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ThicknessAtDiameter) if self.wrapped.ThicknessAtDiameter is not None else None
    ...
    def diameter_for_thickness(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.DiameterForThickness) if self.wrapped.DiameterForThickness is not None else None
    ...
    @property
    def shaver_hand(self) -> '_299.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_299.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_659.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_659.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry is not None else None

    @property
    def tooth_thickness(self) -> '_1035.ToothThicknessSpecificationBase':
        ...
        if _1035.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_996.FinishToothThicknessDesignSpecification':
        ...
        if _996.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_readonly_tooth_thickness_specification(self) -> '_1016.ReadonlyToothThicknessSpecification':
        ...
        if _1016.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_1034.ToothThicknessSpecification':
        ...
        if _1034.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
