...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _611, _597
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1282.Range':
        ...
        if _1282.Range.TYPE not in self.wrapped.CalculatedConjugateFaceWidth.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.CalculatedConjugateFaceWidth.__class__)(self.wrapped.CalculatedConjugateFaceWidth) if self.wrapped.CalculatedConjugateFaceWidth is not None else None

    @property
    def crossed_axis_calculation_details(self) -> '_956.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_956.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails is not None else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_611.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_611.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_597.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_597.CalculationError))
        return value
