...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _646, _640
...
class WormGrindingProcessSimulationInput(_640.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_646.WormGrinderManufactureError':
        ...
        return constructor.new(_646.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError is not None else None
