...
class WormGrindingProcessMarkOnShaft(_649.WormGrindingProcessCalculation):
    '''WormGrindingProcessMarkOnShaft
    ...
    @property
    def shaft_mark_chart(self) -> '_1619.ThreeDChartDefinition':
        ...
        return constructor.new(_1619.ThreeDChartDefinition)(self.wrapped.ShaftMarkChart) if self.wrapped.ShaftMarkChart is not None else None
