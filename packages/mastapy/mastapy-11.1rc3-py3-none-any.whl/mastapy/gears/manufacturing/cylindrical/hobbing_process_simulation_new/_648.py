...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _615, _649
...
class WormGrindingLeadCalculation(_649.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_615.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_615.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def left_flank(self) -> '_615.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_615.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
