...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _633
...
class CalculateProfileDeviationAccuracy(_0.APIBase):
    ...
    @property
    def manufactured_iso132811995e_quality_grades(self) -> 'List[_633.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedISO132811995EQualityGrades, constructor.new(_633.ManufacturedQualityGrade))
        return value

    @property
    def manufactured_ansiagma20151a01_quality_grades(self) -> 'List[_633.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedANSIAGMA20151A01QualityGrades, constructor.new(_633.ManufacturedQualityGrade))
        return value
