...
T = TypeVar('T', bound='_640.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_637.ProcessLeadCalculation':
        ...
        return constructor.new(_637.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation is not None else None

    @property
    def profile_calculation(self) -> '_639.ProcessProfileCalculation':
        ...
        return constructor.new(_639.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation is not None else None

    @property
    def pitch_calculation(self) -> '_638.ProcessPitchCalculation':
        ...
        return constructor.new(_638.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation is not None else None

    @property
    def gear_tooth_shape_calculation(self) -> '_636.ProcessGearShape':
        ...
        return constructor.new(_636.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation is not None else None

    @property
    def total_modification_calculation(self) -> '_643.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_643.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation is not None else None
