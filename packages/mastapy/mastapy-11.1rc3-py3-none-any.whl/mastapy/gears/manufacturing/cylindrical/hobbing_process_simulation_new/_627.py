...
class HobbingProcessSimulationInput(_640.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    def process_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ActiveProcessMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ProcessMethod, value) if self.wrapped.ProcessMethod is not None else None
    ...
    @property
    def hob_manufacture_error(self) -> '_631.HobManufactureError':
        ...
        return constructor.new(_631.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError is not None else None

    @property
    def hob_resharpening_error(self) -> '_632.HobResharpeningError':
        ...
        return constructor.new(_632.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError is not None else None
