...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _616, _649
...
class WormGrindingProcessPitchCalculation(_649.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.PitchModificationChart.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_616.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_616.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def left_flank(self) -> '_616.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_616.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
