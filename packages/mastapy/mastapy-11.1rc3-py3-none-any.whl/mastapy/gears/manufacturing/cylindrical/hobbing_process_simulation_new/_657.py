...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _649
...
class WormGrindingProcessTotalModificationCalculation(_649.WormGrindingProcessCalculation):
    '''WormGrindingProcessTotalModificationCalculation
    ...
    @property
    def total_errors_chart_left_flank(self) -> '_1619.ThreeDChartDefinition':
        ...
        return constructor.new(_1619.ThreeDChartDefinition)(self.wrapped.TotalErrorsChartLeftFlank) if self.wrapped.TotalErrorsChartLeftFlank is not None else None

    @property
    def total_errors_chart_right_flank(self) -> '_1619.ThreeDChartDefinition':
        ...
        return constructor.new(_1619.ThreeDChartDefinition)(self.wrapped.TotalErrorsChartRightFlank) if self.wrapped.TotalErrorsChartRightFlank is not None else None
