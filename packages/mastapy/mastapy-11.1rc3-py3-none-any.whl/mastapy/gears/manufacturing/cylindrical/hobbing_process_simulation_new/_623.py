...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _615, _621
...
class HobbingProcessLeadCalculation(_621.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
