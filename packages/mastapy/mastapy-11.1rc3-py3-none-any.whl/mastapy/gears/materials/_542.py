...
from mastapy.gears.materials import _563, _549
...
class BevelGearMaterial(_549.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_563.SNCurveDefinition':
        ...
        return constructor.new(_563.SNCurveDefinition)(value) if value is not None else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_563.SNCurveDefinition'):
