...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_159.FEModel':
        ...
        return constructor.new(_159.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel is not None else None

    @property
    def findley_critical_plane_analysis(self) -> '_856.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_856.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis is not None else None

    def get_stress_states(self, index: 'int') -> '_119.NodeVectorState':
