...
class CylindricalGearSetTIFFAnalysisDutyCycle(_1165.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysisDutyCycle
    ...
    @property
    def gears(self) -> 'List[_854.CylindricalGearTIFFAnalysisDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_854.CylindricalGearTIFFAnalysisDutyCycle))
        return value
