...
from mastapy.gears.ltca import _792
...
class GearFilletNodeStressResultsColumn(_0.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_792.GearFilletNodeStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_792.GearFilletNodeStressResults))
        return value
