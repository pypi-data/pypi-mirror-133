...
from mastapy.gears.ltca import _804, _798
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def gear_a_in_mesh(self) -> '_804.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_804.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None

    @property
    def gear_b_in_mesh(self) -> '_804.MeshedGearLoadDistributionAnalysisAtRotation':
        ...
        return constructor.new(_804.MeshedGearLoadDistributionAnalysisAtRotation)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None

    @property
    def loaded_contact_lines(self) -> 'List[_798.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_798.GearMeshLoadedContactLine))
        return value

    @property
    def meshed_gears(self) -> 'List[_804.MeshedGearLoadDistributionAnalysisAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_804.MeshedGearLoadDistributionAnalysisAtRotation))
        return value
