...
from mastapy.gears.ltca import _797, _795
...
class GearMeshLoadDistributionAnalysis(_1162.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1307.FourierSeries':
        ...
        return constructor.new(_1307.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries is not None else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_797.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_797.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_795.GearLoadDistributionAnalysis', flank: '_292.GearFlanks', stress_type: '_82.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_795.GearLoadDistributionAnalysis', stress_type: '_82.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
