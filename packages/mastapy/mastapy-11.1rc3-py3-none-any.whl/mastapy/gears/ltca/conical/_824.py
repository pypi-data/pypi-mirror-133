...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def gear_load_distribution_analysis(self) -> '_822.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_822.ConicalGearLoadDistributionAnalysis)(self.wrapped.GearLoadDistributionAnalysis) if self.wrapped.GearLoadDistributionAnalysis is not None else None

    @property
    def contact_charts(self) -> '_1153.GearLTCAContactCharts':
        ...
        if _1153.GearLTCAContactCharts.TYPE not in self.wrapped.ContactCharts.__class__.__mro__:
    ...
    @property
    def contact_charts_as_text_file(self) -> '_1152.GearLTCAContactChartDataAsTextFile':
        ...
        if _1152.GearLTCAContactChartDataAsTextFile.TYPE not in self.wrapped.ContactChartsAsTextFile.__class__.__mro__:
