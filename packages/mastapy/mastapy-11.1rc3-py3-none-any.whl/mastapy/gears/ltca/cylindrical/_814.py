...
from mastapy.gears.ltca import _799
...
class CylindricalGearMeshLoadedContactPoint(_799.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement is not None else None

    @property
    def gear_b_profile_measurement(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement is not None else None

    @property
    def tooth_flank_fracture_analysis_gear_a(self) -> '_486.ToothFlankFractureAnalysisContactPointMethodA':
        ...
        return constructor.new(_486.ToothFlankFractureAnalysisContactPointMethodA)(self.wrapped.ToothFlankFractureAnalysisGearA) if self.wrapped.ToothFlankFractureAnalysisGearA is not None else None

    @property
    def tooth_flank_fracture_analysis_gear_b(self) -> '_486.ToothFlankFractureAnalysisContactPointMethodA':
        ...
        return constructor.new(_486.ToothFlankFractureAnalysisContactPointMethodA)(self.wrapped.ToothFlankFractureAnalysisGearB) if self.wrapped.ToothFlankFractureAnalysisGearB is not None else None
