...
from mastapy.gears.ltca import _787, _796
from mastapy.gears.ltca.cylindrical import _814, _816
...
class CylindricalGearMeshLoadDistributionAnalysis(_796.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_839.CylindricalMeshLoadCase':
        ...
        return constructor.new(_839.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase is not None else None

    @property
    def gear_a_in_mesh(self) -> '_787.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_787.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None

    @property
    def gear_b_in_mesh(self) -> '_787.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_787.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_816.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_816.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_787.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_787.CylindricalMeshedGearLoadDistributionAnalysis))
        return value
