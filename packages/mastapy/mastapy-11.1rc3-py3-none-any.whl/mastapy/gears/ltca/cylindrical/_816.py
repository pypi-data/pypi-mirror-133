...
from mastapy.gears.ltca.cylindrical import _813
...
class CylindricalMeshLoadDistributionAtRotation(_797.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_1063.MeshAlignment':
        ...
        return constructor.new(_1063.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment is not None else None

    @property
    def loaded_contact_lines(self) -> 'List[_813.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_813.CylindricalGearMeshLoadedContactLine))
        return value
