...
from mastapy.system_model.optimization import _1975, _1967
...
class ConicalGearOptimisationStrategy(_1975.OptimizationStrategy['_1967.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
