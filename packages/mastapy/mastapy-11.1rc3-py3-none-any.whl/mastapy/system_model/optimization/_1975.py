...
from mastapy.system_model.optimization import _1976, _1974
...
TStep = TypeVar('TStep', bound='_1974.OptimizationStep')


class OptimizationStrategy(_1976.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
