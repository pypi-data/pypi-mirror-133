...
from mastapy.system_model.optimization import _1973
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1973.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1973.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1973.MicroGeometryOptimisationTarget'):
