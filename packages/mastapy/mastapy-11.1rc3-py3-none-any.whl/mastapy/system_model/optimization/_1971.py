...
from mastapy.system_model.optimization import _1972
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    def new_design_name(self, value: 'str'):
        self.wrapped.NewDesignName = str(value) if value else ''

    @property
    def constraints(self) -> 'List[_1972.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1972.MeasuredAndFactorViewModel))
        return value
