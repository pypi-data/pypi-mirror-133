...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6723, _6724
...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self) -> '_6723.AtsamExcitationsOrOthers':
        ...
        return constructor.new(_6723.AtsamExcitationsOrOthers)(value) if value is not None else None

    @excitations_type.setter
    def excitations_type(self, value: '_6723.AtsamExcitationsOrOthers'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ExcitationsType = value

    @property
    def mode_view_options(self) -> '_6724.AtsamNaturalFrequencyViewOption':
        ...
        return constructor.new(_6724.AtsamNaturalFrequencyViewOption)(value) if value is not None else None

    @mode_view_options.setter
    def mode_view_options(self, value: '_6724.AtsamNaturalFrequencyViewOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def gear_set(self) -> 'list_with_selected_item.ListWithSelectedItem_GearSet':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_GearSet)(self.wrapped.GearSet) if self.wrapped.GearSet is not None else None
