...
from mastapy.cycloidal import _1249, _1250, _1256
from mastapy.system_model.part_model import _2197, _2173
...
from mastapy.detailed_rigid_connectors.splines import _1211
from mastapy.bolts import _1259, _1263
from mastapy.system_model.connections_and_sockets.cycloidal import _2076
...
class CycloidalDisc(_2173.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1249.CycloidalDiscDesign':
        ...
        return constructor.new(_1249.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign is not None else None

    @property
    def load_sharing_settings(self) -> '_2197.LoadSharingSettings':
        ...
        return constructor.new(_2197.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings is not None else None
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2076.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2076.CycloidalDiscPlanetaryBearingSocket))
        return value
