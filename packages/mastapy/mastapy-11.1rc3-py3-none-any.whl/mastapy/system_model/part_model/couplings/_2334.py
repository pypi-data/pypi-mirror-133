...
from mastapy.math_utility.stiffness_calculators import _1330
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1330.IndividualContactPosition':
        ...
        return constructor.new(_1330.IndividualContactPosition)(value) if value is not None else None
    ...
    @property
    def microgeometry_clearance_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.MicrogeometryClearanceChart.__class__.__mro__:
    ...
    @property
    def crowning(self) -> '_2320.CrowningSpecification':
        ...
        return constructor.new(_2320.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning is not None else None
