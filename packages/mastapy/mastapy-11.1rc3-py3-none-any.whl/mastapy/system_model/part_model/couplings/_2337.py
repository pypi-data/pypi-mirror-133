...
from mastapy.system_model.part_model.couplings import _2341, _2339
...
class Synchroniser(_2212.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2341.SynchroniserSleeve':
        ...
        return constructor.new(_2341.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve is not None else None

    @property
    def left_cone(self) -> '_2339.SynchroniserHalf':
        ...
        return constructor.new(_2339.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone is not None else None

    @property
    def right_cone(self) -> '_2339.SynchroniserHalf':
        ...
        return constructor.new(_2339.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone is not None else None

    @property
    def clutch_connection_left(self) -> '_2079.ClutchConnection':
        ...
        return constructor.new(_2079.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft is not None else None

    @property
    def clutch_connection_right(self) -> '_2079.ClutchConnection':
        ...
        return constructor.new(_2079.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight is not None else None
