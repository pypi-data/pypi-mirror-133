...
from mastapy.system_model.part_model.couplings import _2312, _2325
from mastapy.system_model.connections_and_sockets import _2005
...
class BeltDrive(_2212.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2312.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2312.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2312.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2325.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2325.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_2005.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_2005.BeltConnection))
        return value
