...
class RollingRingAssembly(_2212.SpecialisedAssembly):
    '''RollingRingAssembly
    ...
    @property
    def rolling_rings(self) -> 'List[_2331.RollingRing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRings, constructor.new(_2331.RollingRing))
        return value
