...
from mastapy.system_model.part_model.couplings import _2338, _2340
...
class SynchroniserHalf(_2340.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2338.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2338.SynchroniserCone))
        return value
