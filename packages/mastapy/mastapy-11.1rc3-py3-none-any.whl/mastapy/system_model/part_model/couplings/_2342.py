...
from mastapy.system_model.part_model.couplings import _2343, _2345, _2318
...
class TorqueConverter(_2318.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2343.TorqueConverterPump':
        ...
        return constructor.new(_2343.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump is not None else None

    @property
    def turbine(self) -> '_2345.TorqueConverterTurbine':
        ...
        return constructor.new(_2345.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine is not None else None
