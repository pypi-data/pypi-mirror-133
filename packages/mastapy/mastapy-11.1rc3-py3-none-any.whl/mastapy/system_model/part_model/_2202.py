...
from mastapy.materials.efficiency import _269, _268
...
class OilSeal(_2184.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_269.OilSealMaterialType':
        ...
        return constructor.new(_269.OilSealMaterialType)(value) if value is not None else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_269.OilSealMaterialType'):
    ...
    @property
    def drag_torque_vs_rotational_speed(self) -> '_1328.Vector2DListAccessor':
        '''Vector2DListAccessor: 'DragTorqueVsRotationalSpeed' is the original name of this property.'''

        return constructor.new(_1328.Vector2DListAccessor)(self.wrapped.DragTorqueVsRotationalSpeed) if self.wrapped.DragTorqueVsRotationalSpeed is not None else None

    @drag_torque_vs_rotational_speed.setter
    def drag_torque_vs_rotational_speed(self, value: '_1328.Vector2DListAccessor'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1709.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1709.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
