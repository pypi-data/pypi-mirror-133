...
from mastapy.system_model.connections_and_sockets import (
    ...
    _2030, _2031, _2009, _2002,
    _2005, _2006, _2010, _2018,
    _2024, _2029, _2032
)
...
class ConnectedSockets(_0.APIBase):
    ...
    @property
    def connection(self) -> '_2009.Connection':
        ...
        if _2009.Connection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_abstract_shaft_to_mountable_component_connection(self) -> '_2002.AbstractShaftToMountableComponentConnection':
        ...
        if _2002.AbstractShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_belt_connection(self) -> '_2005.BeltConnection':
        ...
        if _2005.BeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coaxial_connection(self) -> '_2006.CoaxialConnection':
        ...
        if _2006.CoaxialConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cvt_belt_connection(self) -> '_2010.CVTBeltConnection':
        ...
        if _2010.CVTBeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_inter_mountable_component_connection(self) -> '_2018.InterMountableComponentConnection':
        ...
        if _2018.InterMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_planetary_connection(self) -> '_2024.PlanetaryConnection':
        ...
        if _2024.PlanetaryConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_rolling_ring_connection(self) -> '_2029.RollingRingConnection':
        ...
        if _2029.RollingRingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_shaft_to_mountable_component_connection(self) -> '_2032.ShaftToMountableComponentConnection':
        ...
        if _2032.ShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_2036.AGMAGleasonConicalGearMesh':
        ...
        if _2036.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_differential_gear_mesh(self) -> '_2038.BevelDifferentialGearMesh':
        ...
        if _2038.BevelDifferentialGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_gear_mesh(self) -> '_2040.BevelGearMesh':
        ...
        if _2040.BevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_gear_mesh(self) -> '_2042.ConceptGearMesh':
        ...
        if _2042.ConceptGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_conical_gear_mesh(self) -> '_2044.ConicalGearMesh':
        ...
        if _2044.ConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cylindrical_gear_mesh(self) -> '_2046.CylindricalGearMesh':
        ...
        if _2046.CylindricalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_face_gear_mesh(self) -> '_2048.FaceGearMesh':
        ...
        if _2048.FaceGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_gear_mesh(self) -> '_2050.GearMesh':
        ...
        if _2050.GearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
            raise CastException('Failed to cast connection to GearMesh. Expected: {}.'.format(self.wrapped.Connection.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Connection.__class__)(self.wrapped.Connection) if self.wrapped.Connection is not None else None

    @property
    def connection_of_type_hypoid_gear_mesh(self) -> '_2052.HypoidGearMesh':
        ...
        if _2052.HypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_2055.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _2055.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_2056.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _2056.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_2057.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _2057.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spiral_bevel_gear_mesh(self) -> '_2060.SpiralBevelGearMesh':
        ...
        if _2060.SpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_2062.StraightBevelDiffGearMesh':
        ...
        if _2062.StraightBevelDiffGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_gear_mesh(self) -> '_2064.StraightBevelGearMesh':
        ...
        if _2064.StraightBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_worm_gear_mesh(self) -> '_2066.WormGearMesh':
        ...
        if _2066.WormGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_zerol_bevel_gear_mesh(self) -> '_2068.ZerolBevelGearMesh':
        ...
        if _2068.ZerolBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_central_bearing_connection(self) -> '_2072.CycloidalDiscCentralBearingConnection':
        ...
        if _2072.CycloidalDiscCentralBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_planetary_bearing_connection(self) -> '_2075.CycloidalDiscPlanetaryBearingConnection':
        ...
        if _2075.CycloidalDiscPlanetaryBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_ring_pins_to_disc_connection(self) -> '_2078.RingPinsToDiscConnection':
        ...
        if _2078.RingPinsToDiscConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_clutch_connection(self) -> '_2079.ClutchConnection':
        ...
        if _2079.ClutchConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_coupling_connection(self) -> '_2081.ConceptCouplingConnection':
        ...
        if _2081.ConceptCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coupling_connection(self) -> '_2083.CouplingConnection':
        ...
        if _2083.CouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_part_to_part_shear_coupling_connection(self) -> '_2085.PartToPartShearCouplingConnection':
        ...
        if _2085.PartToPartShearCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spring_damper_connection(self) -> '_2087.SpringDamperConnection':
        ...
        if _2087.SpringDamperConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_torque_converter_connection(self) -> '_2089.TorqueConverterConnection':
        ...
        if _2089.TorqueConverterConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
