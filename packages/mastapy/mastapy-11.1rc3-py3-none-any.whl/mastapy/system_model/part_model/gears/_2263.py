...
class FaceGear(_2265.Gear):
    ...
    @property
    def active_gear_design(self) -> '_941.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_941.FaceGearDesign':
        ...
        if _941.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.FaceGearDesign.__class__)(self.wrapped.FaceGearDesign) if self.wrapped.FaceGearDesign is not None else None
