...
from mastapy.system_model.part_model.gears import _2260, _2262, _2261
...
class PlanetaryGearSet(_2261.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2260.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2260.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2262.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2262.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2260.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2260.CylindricalGear))
        return value

    def add_sun(self) -> '_2260.CylindricalGear':
    ...
    def add_planet(self) -> '_2260.CylindricalGear':
    ...
    def add_annulus(self) -> '_2260.CylindricalGear':
