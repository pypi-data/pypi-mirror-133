...
from mastapy.gears.gear_designs.worm import _909, _908, _912
...
class WormGear(_2265.Gear):
    ...
    @property
    def active_gear_design(self) -> '_909.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_909.WormGearDesign':
        ...
        if _909.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.WormGearDesign.__class__)(self.wrapped.WormGearDesign) if self.wrapped.WormGearDesign is not None else None
