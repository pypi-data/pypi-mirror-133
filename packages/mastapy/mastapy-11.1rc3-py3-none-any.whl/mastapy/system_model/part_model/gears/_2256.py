...
class ConceptGear(_2265.Gear):
    ...
    @property
    def active_gear_design(self) -> '_1118.ConceptGearDesign':
        ...
        return constructor.new(_1118.ConceptGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign is not None else None

    @property
    def concept_gear_design(self) -> '_1118.ConceptGearDesign':
        ...
        return constructor.new(_1118.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign is not None else None
