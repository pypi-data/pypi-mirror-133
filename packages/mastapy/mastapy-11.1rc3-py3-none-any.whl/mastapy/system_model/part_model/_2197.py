...
from mastapy.system_model.part_model import _2175, _2196
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2175.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2175.AGMALoadSharingTableApplicationLevel)(value) if value is not None else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2175.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2196.LoadSharingModes':
        ...
        return constructor.new(_2196.LoadSharingModes)(value) if value is not None else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2196.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
