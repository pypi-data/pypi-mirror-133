...
from mastapy.system_model.part_model import _2197, _2200
from mastapy.system_model.connections_and_sockets import _2025
...
class PlanetCarrier(_2200.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2025.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_2025.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2218.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2218.Shaft', offset: Optional['float'] = float('nan')):
