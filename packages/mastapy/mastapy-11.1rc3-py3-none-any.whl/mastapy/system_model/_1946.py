...
from mastapy.utility.model_validation import _1559, _1560
...
class DesignEntity(_0.APIBase):
    ...
    def small_icon(self) -> 'Image':
        ...
        value = conversion.pn_to_mp_smt_bitmap(self.wrapped.SmallIcon)
        return value

    @property
    def design_properties(self) -> '_1942.Design':
        ...
        return constructor.new(_1942.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties is not None else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1560.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1560.StatusItem))
        return value
