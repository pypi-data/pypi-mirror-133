...
from mastapy.system_model_gui import _1608
...
from mastapy.system_model.fe import _2098
from mastapy.bearings.bearing_results.rolling import _1724
from mastapy.system_model.part_model.configurations import _2349, _2347, _2350
from mastapy.system_model.analyses_and_results.load_case_groups import _5383, _5391, _5384
from mastapy.system_model.analyses_and_results.static_loads import _6514
from mastapy.utility.model_validation import _1559
from mastapy.system_model.database_access import _2001
from mastapy.bearings.bearing_designs.rolling import _1907
...
from mastapy.gears.gear_designs.creation_options import _1088, _1091, _1090
from mastapy import _7270, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2712
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1608.MASTAGUI':
        ...
        return constructor.new(_1608.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI is not None else None
    ...
    @property
    def unbalanced_mass_inclusion(self) -> '_2214.UnbalancedMassInclusionOption':
        ...
        return constructor.new(_2214.UnbalancedMassInclusionOption)(value) if value is not None else None

    @unbalanced_mass_inclusion.setter
    def unbalanced_mass_inclusion(self, value: '_2214.UnbalancedMassInclusionOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1963.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1963.ThermalExpansionOptionForGroundedNodes)(value) if value is not None else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1963.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_553.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_553.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes is not None else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_553.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_553.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes is not None else None

    @property
    def file_save_details_most_recent(self) -> '_1375.FileHistoryItem':
        ...
        return constructor.new(_1375.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent is not None else None

    @property
    def default_system_temperatures(self) -> '_1964.TransmissionTemperatureSet':
        ...
        return constructor.new(_1964.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures is not None else None
    ...
    @property
    def detailed_spline_settings(self) -> '_1186.DetailedSplineJointSettings':
        ...
        return constructor.new(_1186.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings is not None else None
    ...
    @property
    def file_save_details_all(self) -> '_1374.FileHistory':
        ...
        return constructor.new(_1374.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll is not None else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2247.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2247.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup is not None else None

    @property
    def system(self) -> '_1962.SystemReporting':
        ...
        return constructor.new(_1962.SystemReporting)(self.wrapped.System) if self.wrapped.System is not None else None

    @property
    def fe_batch_operations(self) -> '_2098.BatchOperations':
        ...
        return constructor.new(_2098.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations is not None else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1724.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1724.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2247.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2247.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2349.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2349.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2347.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2347.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2350.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2350.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5383.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5383.DesignState))
        return value

    @property
    def time_series_load_case_groups(self) -> 'List[_5391.TimeSeriesLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TimeSeriesLoadCaseGroups, constructor.new(_5391.TimeSeriesLoadCaseGroup))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5384.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5384.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2210.RootAssembly':
        ...
        return constructor.new(_2210.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly is not None else None

    @property
    def gear_set_config(self) -> '_2268.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2268.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig is not None else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2268.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def status(self) -> '_1559.Status':
        ...
        return constructor.new(_1559.Status)(self.wrapped.Status) if self.wrapped.Status is not None else None

    @property
    def databases(self) -> '_2001.Databases':
        ...
        return constructor.new(_2001.Databases)(self.wrapped.Databases) if self.wrapped.Databases is not None else None

    @property
    def masta_settings(self) -> '_1943.MastaSettings':
        ...
        return constructor.new(_1943.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings is not None else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1907.RollingBearing'):
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2306.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2309.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2310.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_1088.CylindricalGearPairCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2308.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_1091.SpiralBevelGearSetCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1090.HypoidGearSetCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2307.CycloidalAssemblyCreationOptions':
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5383.DesignState':
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5391.TimeSeriesLoadCaseGroup':
    ...
    def design_state_named(self, name: 'str') -> '_5383.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5384.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1559.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7270.TaskProgress') -> '_1559.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2712.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2712.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2712.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5383.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5384.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2171.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2171.Assembly.TYPE](), constructor.new(_2171.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1373.ExternalFullFEFileOption'] = _1373.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
