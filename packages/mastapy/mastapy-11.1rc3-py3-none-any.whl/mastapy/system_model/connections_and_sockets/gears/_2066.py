...
class WormGearMesh(_2050.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_910.WormGearMeshDesign':
        ...
        return constructor.new(_910.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign is not None else None
