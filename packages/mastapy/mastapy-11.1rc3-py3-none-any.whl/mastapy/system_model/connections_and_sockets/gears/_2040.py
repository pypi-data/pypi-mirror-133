...
class BevelGearMesh(_2036.AGMAGleasonConicalGearMesh):
    '''BevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self) -> '_1123.BevelGearMeshDesign':
        ...
        if _1123.BevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_zerol_bevel_gear_mesh_design(self) -> '_905.ZerolBevelGearMeshDesign':
        ...
        if _905.ZerolBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_diff_gear_mesh_design(self) -> '_914.StraightBevelDiffGearMeshDesign':
        ...
        if _914.StraightBevelDiffGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_straight_bevel_gear_mesh_design(self) -> '_918.StraightBevelGearMeshDesign':
        ...
        if _918.StraightBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_mesh_design_of_type_spiral_bevel_gear_mesh_design(self) -> '_922.SpiralBevelGearMeshDesign':
        ...
        if _922.SpiralBevelGearMeshDesign.TYPE not in self.wrapped.BevelGearMeshDesign.__class__.__mro__:
