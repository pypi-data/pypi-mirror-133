...
class FaceGearMesh(_2050.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_943.FaceGearMeshDesign':
        ...
        return constructor.new(_943.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign is not None else None
