...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5884.ConicalGearSetCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5750.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5750.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5750.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5750.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value
