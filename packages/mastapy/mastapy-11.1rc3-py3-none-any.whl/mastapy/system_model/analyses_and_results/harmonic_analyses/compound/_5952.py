...
class SpringDamperCompoundHarmonicAnalysis(_5887.CouplingCompoundHarmonicAnalysis):
    '''SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5789.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5789.SpringDamperHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5789.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5789.SpringDamperHarmonicAnalysis))
        return value
