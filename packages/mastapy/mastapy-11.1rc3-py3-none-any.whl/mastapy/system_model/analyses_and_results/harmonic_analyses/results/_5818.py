...
class ExcitationSourceSelectionGroup(_5817.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5817.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5817.ExcitationSourceSelectionBase))
        return value
