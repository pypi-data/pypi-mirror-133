...
from mastapy.bearings.bearing_results.rolling import _1816
...
class BearingHarmonicAnalysis(_5695.ConnectorHarmonicAnalysis):
    '''BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1816.RollingBearingSpeedResults':
        ...
        return constructor.new(_1816.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2428.BearingSystemDeflection':
        ...
        return constructor.new(_2428.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
