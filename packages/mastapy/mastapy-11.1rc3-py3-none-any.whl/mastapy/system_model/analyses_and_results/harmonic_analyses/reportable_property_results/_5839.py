...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5832, _5837
...
class ResultsForMultipleOrdersForGroups(_5837.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5832.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5832.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
