...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5841, _5825
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5825.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5841.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5841.ResultsForOrderIncludingGroups))
        return value
