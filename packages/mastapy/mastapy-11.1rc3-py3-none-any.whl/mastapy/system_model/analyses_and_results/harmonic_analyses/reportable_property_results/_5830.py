...
class HarmonicAnalysisCombinedForMultipleSurfacesWithinAHarmonic(_5835.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic):
    '''HarmonicAnalysisCombinedForMultipleSurfacesWithinAHarmonic
    ...
    def surface_names(self) -> 'str':
        ...
        return self.wrapped.SurfaceNames
