...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5846, _5826
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5846.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5846.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude is not None else None

    @property
    def result_at_reference_speed(self) -> '_5826.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
        ...
        return constructor.new(_5826.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)(self.wrapped.ResultAtReferenceSpeed) if self.wrapped.ResultAtReferenceSpeed is not None else None

    @property
    def data_points(self) -> 'List[_5826.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPoints, constructor.new(_5826.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic))
        return value
