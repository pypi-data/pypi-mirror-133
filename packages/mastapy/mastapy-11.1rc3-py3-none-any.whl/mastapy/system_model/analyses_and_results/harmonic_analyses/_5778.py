...
from mastapy.system_model.analyses_and_results.modal_analyses import _4917
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5743, _5659
...
class ShaftHarmonicAnalysis(_5659.AbstractShaftHarmonicAnalysis):
    '''ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4917.ShaftModalAnalysis':
        ...
        return constructor.new(_4917.ShaftModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None

    @property
    def export(self) -> '_5743.HarmonicAnalysisShaftExportOptions':
        ...
        return constructor.new(_5743.HarmonicAnalysisShaftExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2534.ShaftSystemDeflection':
        ...
        return constructor.new(_2534.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
