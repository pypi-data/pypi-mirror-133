...
class RootAssemblyHarmonicAnalysis(_5665.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5742.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5742.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2367.HarmonicAnalysis':
        ...
        if _2367.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysisInputs.__class__.__mro__:
