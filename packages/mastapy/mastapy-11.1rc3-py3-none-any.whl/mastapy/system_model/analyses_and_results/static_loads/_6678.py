...
from mastapy.system_model.analyses_and_results.static_loads import _6676, _6677, _6539
...
class StraightBevelGearSetLoadCase(_6539.BevelGearSetLoadCase):
    '''StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6676.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6676.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6676.StraightBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsLoadCase, constructor.new(_6676.StraightBevelGearLoadCase))
        return value

    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6677.StraightBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesLoadCase, constructor.new(_6677.StraightBevelGearMeshLoadCase))
        return value
