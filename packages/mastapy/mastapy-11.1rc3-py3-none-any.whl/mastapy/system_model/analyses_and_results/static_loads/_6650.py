...
from mastapy.math_utility import _1297, _1307
...
class PointLoadHarmonicLoadData(_6666.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1297.DegreesOfFreedom':
        ...
        return constructor.new(_1297.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1297.DegreesOfFreedom'):
