...
from mastapy.system_model.analyses_and_results.static_loads import _6565, _6531
...
class CVTLoadCase(_6531.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6565.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6565.CVTPulleyLoadCase))
        return value
