...
from mastapy.system_model.analyses_and_results.static_loads import _6550, _6551, _6605
...
class ConceptGearSetLoadCase(_6605.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6550.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6550.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6550.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6550.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6551.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6551.ConceptGearMeshLoadCase))
        return value
