...
from mastapy.system_model.analyses_and_results.static_loads import _6638, _6612, _6588
...
class HarmonicLoadDataExcelImport(_6612.HarmonicLoadDataImportBase['_6588.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6638.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6638.NamedSpeed))
        return value
