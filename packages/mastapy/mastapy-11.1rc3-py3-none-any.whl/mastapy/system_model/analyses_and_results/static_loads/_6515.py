...
from mastapy.system_model.analyses_and_results import _2374, _2355
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.mbd_analyses import _5182
from mastapy.system_model.analyses_and_results.load_case_groups import _5391
...
class TimeSeriesLoadCase(_6513.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5182.MBDAnalysisOptions':
        ...
        return constructor.new(_5182.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions is not None else None

    @property
    def time_series_load_case_group(self) -> '_5391.TimeSeriesLoadCaseGroup':
        ...
        return constructor.new(_5391.TimeSeriesLoadCaseGroup)(self.wrapped.TimeSeriesLoadCaseGroup) if self.wrapped.TimeSeriesLoadCaseGroup is not None else None
    ...
    def duplicate(self, new_load_case_group: '_5391.TimeSeriesLoadCaseGroup', name: Optional['str'] = 'None') -> 'TimeSeriesLoadCase':
