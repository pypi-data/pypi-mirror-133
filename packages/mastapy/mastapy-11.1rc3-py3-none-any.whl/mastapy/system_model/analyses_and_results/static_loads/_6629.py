...
from mastapy.system_model.analyses_and_results.static_loads import _6627, _6628, _6626
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6626.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6627.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6627.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6627.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsLoadCase, constructor.new(_6627.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6628.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesLoadCase, constructor.new(_6628.KlingelnbergCycloPalloidHypoidGearMeshLoadCase))
        return value
