...
class CylindricalGearSetLoadCase(_6605.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def coefficient_of_friction_calculation_method(self) -> '_285.CoefficientOfFrictionCalculationMethod':
        ...
        return constructor.new(_285.CoefficientOfFrictionCalculationMethod)(value) if value is not None else None

    @coefficient_of_friction_calculation_method.setter
    def coefficient_of_friction_calculation_method(self, value: '_285.CoefficientOfFrictionCalculationMethod'):
    ...
    @property
    def reset_micro_geometry(self) -> '_6654.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6654.ResetMicroGeometryOptions)(value) if value is not None else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6654.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def dynamic_load_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.DynamicLoadFactor) if self.wrapped.DynamicLoadFactor is not None else None
    ...
    @property
    def overridden_micro_geometry(self) -> '_1052.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1052.CylindricalGearSetMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None

    @property
    def ltca(self) -> '_1009.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_1009.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA is not None else None

    @property
    def gears(self) -> 'List[_6570.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6570.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_gears_load_case(self) -> 'List[_6570.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_6570.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6572.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_6572.CylindricalGearMeshLoadCase))
        return value
