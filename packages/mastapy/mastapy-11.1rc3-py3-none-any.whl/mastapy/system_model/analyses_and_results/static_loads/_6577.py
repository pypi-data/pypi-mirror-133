...
class DataFromMotorPackagePerSpeed(_0.APIBase):
    ...
    def torque_selector(self) -> 'list_with_selected_item.ListWithSelectedItem_float':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_float)(self.wrapped.TorqueSelector) if self.wrapped.TorqueSelector is not None else None
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_6576.DataFromMotorPackagePerMeanTorque]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPerMeanTorque, constructor.new(_6576.DataFromMotorPackagePerMeanTorque))
        return value
