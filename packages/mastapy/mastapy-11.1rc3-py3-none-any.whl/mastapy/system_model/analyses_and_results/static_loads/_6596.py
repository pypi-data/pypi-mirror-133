...
from mastapy.system_model.analyses_and_results.static_loads import _6594, _6595, _6605
...
class FaceGearSetLoadCase(_6605.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6594.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6594.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6594.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6594.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6595.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6595.FaceGearMeshLoadCase))
        return value
