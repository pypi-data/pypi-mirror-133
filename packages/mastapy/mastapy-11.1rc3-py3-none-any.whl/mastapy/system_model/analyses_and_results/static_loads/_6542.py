...
class ClutchConnectionLoadCase(_6560.CouplingConnectionLoadCase):
    '''ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self) -> '_1328.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ClutchPressures' is the original name of this property.'''

        return constructor.new(_1328.Vector2DListAccessor)(self.wrapped.ClutchPressures) if self.wrapped.ClutchPressures is not None else None

    @clutch_pressures.setter
    def clutch_pressures(self, value: '_1328.Vector2DListAccessor'):
