...
from mastapy.system_model.analyses_and_results.static_loads import _6667, _6668, _6539
...
class SpiralBevelGearSetLoadCase(_6539.BevelGearSetLoadCase):
    '''SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6667.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6667.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6667.SpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsLoadCase, constructor.new(_6667.SpiralBevelGearLoadCase))
        return value

    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6668.SpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesLoadCase, constructor.new(_6668.SpiralBevelGearMeshLoadCase))
        return value
