...
from mastapy.system_model.analyses_and_results.static_loads import _6647, _6637
...
class PlanetCarrierLoadCase(_6637.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6647.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6647.PlanetarySocketManufactureError))
        return value
