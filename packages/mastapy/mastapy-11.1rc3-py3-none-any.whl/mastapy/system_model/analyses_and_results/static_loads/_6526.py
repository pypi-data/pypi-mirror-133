...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    def all_pins_roundness_chart(self) -> 'Image':
        ...
        value = conversion.pn_to_mp_smt_bitmap(self.wrapped.AllPinsRoundnessChart)
        return value
    ...
    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6655.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6655.RingPinManufacturingError))
        return value
