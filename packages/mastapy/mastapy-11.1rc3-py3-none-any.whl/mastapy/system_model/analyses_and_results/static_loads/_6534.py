...
from mastapy.system_model.analyses_and_results.static_loads import _6532, _6533, _6539
...
class BevelDifferentialGearSetLoadCase(_6539.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6532.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6532.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6532.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_6532.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6533.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_6533.BevelDifferentialGearMeshLoadCase))
        return value
