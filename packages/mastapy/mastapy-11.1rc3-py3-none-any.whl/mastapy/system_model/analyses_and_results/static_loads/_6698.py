...
from mastapy.system_model.analyses_and_results.static_loads import _6696, _6697, _6605
...
class WormGearSetLoadCase(_6605.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6696.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6696.WormGearLoadCase))
        return value

    @property
    def worm_gears_load_case(self) -> 'List[_6696.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6696.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6697.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6697.WormGearMeshLoadCase))
        return value
