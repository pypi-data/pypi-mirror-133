...
class ConicalGearManufactureError(_6601.GearManufactureError):
    '''ConicalGearManufactureError
    ...
    @property
    def pitch_errors_concave_flank(self) -> '_1328.Vector2DListAccessor':
        '''Vector2DListAccessor: 'PitchErrorsConcaveFlank' is the original name of this property.'''

        return constructor.new(_1328.Vector2DListAccessor)(self.wrapped.PitchErrorsConcaveFlank) if self.wrapped.PitchErrorsConcaveFlank is not None else None

    @pitch_errors_concave_flank.setter
    def pitch_errors_concave_flank(self, value: '_1328.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.PitchErrorsConcaveFlank = value

    @property
    def pitch_errors_convex_flank(self) -> '_1328.Vector2DListAccessor':
        '''Vector2DListAccessor: 'PitchErrorsConvexFlank' is the original name of this property.'''

        return constructor.new(_1328.Vector2DListAccessor)(self.wrapped.PitchErrorsConvexFlank) if self.wrapped.PitchErrorsConvexFlank is not None else None

    @pitch_errors_convex_flank.setter
    def pitch_errors_convex_flank(self, value: '_1328.Vector2DListAccessor'):
        value = value.wrapped if value else None
