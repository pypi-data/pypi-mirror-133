...
from mastapy.utility.file_access_helpers import _1582
from mastapy.utility_gui import _1610
...
class MultiTimeSeriesDataInputFileOptions(_1610.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1582.TextFileDelimiterOptions':
        ...
        return constructor.new(_1582.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions is not None else None
