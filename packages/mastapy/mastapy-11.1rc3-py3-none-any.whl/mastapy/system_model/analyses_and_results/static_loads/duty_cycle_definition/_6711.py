...
from mastapy.math_utility import _1285
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6702
...
class PointLoadInputOptions(_1609.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    def point_load(self) -> 'list_with_selected_item.ListWithSelectedItem_PointLoad':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_PointLoad)(self.wrapped.PointLoad) if self.wrapped.PointLoad is not None else None
    ...
    @axis.setter
    def axis(self, value: '_1285.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6702.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6702.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6702.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
