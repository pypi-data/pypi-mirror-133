...
from mastapy.system_model.analyses_and_results.static_loads import _6571, _6600
...
class CylindricalGearLoadCase(_6600.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    def reversed_bending_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ReversedBendingFactor) if self.wrapped.ReversedBendingFactor is not None else None
    ...
    @property
    def gear_manufacture_errors(self) -> '_6571.CylindricalGearManufactureError':
        ...
        return constructor.new(_6571.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors is not None else None

    @property
    def overridden_micro_geometry(self) -> '_1047.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1047.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry is not None else None
