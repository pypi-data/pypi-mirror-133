...
from mastapy.bearings.bearing_results.rolling import _1720, _1814, _1815
from mastapy.bearings.bearing_results import _1692
from mastapy.system_model.part_model import _2177
from mastapy.bearings.tolerances import _1665, _1671
...
class BearingLoadCase(_6559.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def include_fitting_effects(self) -> '_1380.LoadCaseOverrideOption':
        ...
        return constructor.new(_1380.LoadCaseOverrideOption)(value) if value is not None else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1380.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1380.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1380.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1380.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1380.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_5107.BearingStiffnessModel':
        ...
        return constructor.new(_5107.BearingStiffnessModel)(value) if value is not None else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5107.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5107.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1665.RaceDetail':
        ...
        return constructor.new(_1665.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail is not None else None

    @property
    def right_ring_detail(self) -> '_1665.RaceDetail':
        ...
        return constructor.new(_1665.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail is not None else None
    ...
    @property
    def inner_ring_detail(self) -> '_1665.RaceDetail':
        ...
        return constructor.new(_1665.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail is not None else None
    ...
    @property
    def outer_ring_detail(self) -> '_1665.RaceDetail':
        ...
        return constructor.new(_1665.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail is not None else None
