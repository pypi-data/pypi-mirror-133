...
TConnection = TypeVar('TConnection', bound='_2009.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6558.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5395.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
