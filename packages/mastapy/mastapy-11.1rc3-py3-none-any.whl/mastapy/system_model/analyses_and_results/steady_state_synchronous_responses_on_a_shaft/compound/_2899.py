...
class FEPartCompoundSteadyStateSynchronousResponseOnAShaft(_2845.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''FEPartCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2769.FEPartSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2769.FEPartSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2769.FEPartSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2769.FEPartSteadyStateSynchronousResponseOnAShaft))
        return value
