...
class SteadyStateSynchronousResponseOnAShaft(_7262.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3339.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3339.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options is not None else None
