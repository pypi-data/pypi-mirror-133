...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6252, _6249, _6251
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6252.MASTAFileDetails':
        ...
        return constructor.new(_6252.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails is not None else None

    @property
    def excel_file_details(self) -> '_6249.ExcelFileDetails':
        ...
        return constructor.new(_6249.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails is not None else None

    @property
    def working_folder(self) -> '_1387.SelectableFolder':
        ...
        return constructor.new(_1387.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder is not None else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6251.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6251.ExcelSheetDesignStateSelector))
        return value
