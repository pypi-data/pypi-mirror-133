...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness(_4460.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4366.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4366.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4366.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4366.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value
