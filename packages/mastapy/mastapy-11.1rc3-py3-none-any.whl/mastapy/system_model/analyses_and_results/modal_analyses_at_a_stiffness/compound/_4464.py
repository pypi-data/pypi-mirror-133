...
class ConnectorCompoundModalAnalysisAtAStiffness(_4505.MountableComponentCompoundModalAnalysisAtAStiffness):
    '''ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4334.ConnectorModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4334.ConnectorModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4334.ConnectorModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4334.ConnectorModalAnalysisAtAStiffness))
        return value
