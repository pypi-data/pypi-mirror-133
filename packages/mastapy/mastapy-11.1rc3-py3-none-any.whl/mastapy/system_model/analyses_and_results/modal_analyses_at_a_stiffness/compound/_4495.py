...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtAStiffness(_4461.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4365.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4365.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4365.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4365.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtAStiffness))
        return value
