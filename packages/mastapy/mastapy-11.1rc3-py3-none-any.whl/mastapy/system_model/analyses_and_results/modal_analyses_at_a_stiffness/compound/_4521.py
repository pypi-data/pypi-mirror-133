...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4493.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4391.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4391.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4391.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4391.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
