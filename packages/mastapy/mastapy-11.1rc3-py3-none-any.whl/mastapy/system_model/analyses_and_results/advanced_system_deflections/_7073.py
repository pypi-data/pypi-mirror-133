...
class PlanetCarrierAdvancedSystemDeflection(_7065.MountableComponentAdvancedSystemDeflection):
    '''PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2520.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2520.PlanetCarrierSystemDeflection))
        return value
