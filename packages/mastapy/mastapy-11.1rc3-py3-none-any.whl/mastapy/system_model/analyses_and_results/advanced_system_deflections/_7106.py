...
class TorqueConverterConnectionAdvancedSystemDeflection(_7024.CouplingConnectionAdvancedSystemDeflection):
    '''TorqueConverterConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2558.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2558.TorqueConverterConnectionSystemDeflection))
        return value
