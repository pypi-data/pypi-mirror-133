...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6996, _6997, _7003
...
class BevelDifferentialGearSetAdvancedSystemDeflection(_7003.BevelGearSetAdvancedSystemDeflection):
    '''BevelDifferentialGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_511.BevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_511.BevelGearSetRating':
        ...
        if _511.BevelGearSetRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def bevel_differential_gears_advanced_system_deflection(self) -> 'List[_6996.BevelDifferentialGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsAdvancedSystemDeflection, constructor.new(_6996.BevelDifferentialGearAdvancedSystemDeflection))
        return value

    @property
    def bevel_differential_meshes_advanced_system_deflection(self) -> 'List[_6997.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesAdvancedSystemDeflection, constructor.new(_6997.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2432.BevelDifferentialGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2432.BevelDifferentialGearSetSystemDeflection))
        return value
