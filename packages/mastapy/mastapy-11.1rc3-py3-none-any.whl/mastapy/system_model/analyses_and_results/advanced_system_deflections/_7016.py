...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7014, _7015, _7047
...
class ConceptGearSetAdvancedSystemDeflection(_7047.GearSetAdvancedSystemDeflection):
    '''ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_7014.ConceptGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsAdvancedSystemDeflection, constructor.new(_7014.ConceptGearAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_7015.ConceptGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesAdvancedSystemDeflection, constructor.new(_7015.ConceptGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2451.ConceptGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2451.ConceptGearSetSystemDeflection))
        return value
