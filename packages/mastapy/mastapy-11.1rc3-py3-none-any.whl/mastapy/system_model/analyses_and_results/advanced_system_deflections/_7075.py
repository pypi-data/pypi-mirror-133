...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7109, _7111
...
class PowerLoadAdvancedSystemDeflection(_7111.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6652.PowerLoadLoadCase':
        ...
        return constructor.new(_6652.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7109.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_7109.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2522.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2522.PowerLoadSystemDeflection))
        return value
