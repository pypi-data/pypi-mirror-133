...
class KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection(_7150.ConicalGearCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7053.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7053.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_7053.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7053.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection))
        return value
