...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7077
...
class RingPinsCompoundAdvancedSystemDeflection(_7195.MountableComponentCompoundAdvancedSystemDeflection):
    '''RingPinsCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7077.RingPinsAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7077.RingPinsAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7077.RingPinsAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7077.RingPinsAdvancedSystemDeflection))
        return value
