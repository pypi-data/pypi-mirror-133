...
class AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection(_7152.ConicalGearSetCompoundAdvancedSystemDeflection):
    '''AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6991.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6991.AGMAGleasonConicalGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6991.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6991.AGMAGleasonConicalGearSetAdvancedSystemDeflection))
        return value
