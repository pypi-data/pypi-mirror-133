...
class SynchroniserHalfAdvancedSystemDeflection(_7103.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2551.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2551.SynchroniserHalfSystemDeflection))
        return value
