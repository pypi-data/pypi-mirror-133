...
from mastapy.system_model.analyses_and_results.static_loads import _6532, _6535, _6536
...
class BevelDifferentialGearAdvancedSystemDeflection(_7001.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6532.BevelDifferentialGearLoadCase':
        ...
        if _6532.BevelDifferentialGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis(self) -> '_510.BevelGearRating':
        ...
        if _510.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_rating(self) -> '_336.ZerolBevelGearRating':
        ...
        if _336.ZerolBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_rating(self) -> '_366.StraightBevelGearRating':
        ...
        if _366.StraightBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_rating(self) -> '_369.SpiralBevelGearRating':
        ...
        if _369.SpiralBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2433.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2433.BevelDifferentialGearSystemDeflection))
        return value
