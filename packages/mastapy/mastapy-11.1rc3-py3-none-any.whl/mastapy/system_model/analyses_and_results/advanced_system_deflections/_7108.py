...
class TorqueConverterTurbineAdvancedSystemDeflection(_7025.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2561.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2561.TorqueConverterTurbineSystemDeflection))
        return value
