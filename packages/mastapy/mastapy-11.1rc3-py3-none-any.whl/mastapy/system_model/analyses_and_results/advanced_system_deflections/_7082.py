...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6986, _6992
...
class RootAssemblyAdvancedSystemDeflection(_6992.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6986.AdvancedSystemDeflection':
        ...
        return constructor.new(_6986.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs is not None else None
