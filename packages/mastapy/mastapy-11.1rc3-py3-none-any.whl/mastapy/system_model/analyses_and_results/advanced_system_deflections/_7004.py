...
class BoltAdvancedSystemDeflection(_7010.ComponentAdvancedSystemDeflection):
    '''BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2440.BoltSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2440.BoltSystemDeflection))
        return value
