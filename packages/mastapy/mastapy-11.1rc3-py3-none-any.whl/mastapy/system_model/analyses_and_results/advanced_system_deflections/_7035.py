...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7033, _7034, _7047
...
class CylindricalGearSetAdvancedSystemDeflection(_7047.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_979.CylindricalGearSetDesign':
        ...
        if _979.CylindricalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
    ...
    @property
    def micro_geometry(self) -> '_1052.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1052.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry is not None else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_7033.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_7033.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_7034.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_7034.CylindricalGearMeshAdvancedSystemDeflection))
        return value
