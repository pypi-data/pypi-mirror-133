...
from mastapy.gears.gear_designs.cylindrical import _971, _964
from mastapy.gears.ltca.cylindrical import _814
from mastapy.math_utility import _1307
...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7033, _7022, _7046
...
class CylindricalGearMeshAdvancedSystemDeflection(_7046.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def gear_mesh_design(self) -> '_971.CylindricalGearMeshDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshDesign)(self.wrapped.GearMeshDesign) if self.wrapped.GearMeshDesign is not None else None

    @property
    def point_with_maximum_contact_pressure(self) -> '_814.CylindricalGearMeshLoadedContactPoint':
        ...
        return constructor.new(_814.CylindricalGearMeshLoadedContactPoint)(self.wrapped.PointWithMaximumContactPressure) if self.wrapped.PointWithMaximumContactPressure is not None else None

    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1307.FourierSeries':
        ...
        return constructor.new(_1307.FourierSeries)(self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod) if self.wrapped.TransmissionErrorFourierSeriesForFirstToothPassingPeriod is not None else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2470.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2470.CylindricalGearMeshSystemDeflectionTimestep))
        return value

    @property
    def gear_designs(self) -> 'List[_964.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDesigns, constructor.new(_964.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7033.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_7033.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7022.ContactChartPerToothPass]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MaxPressureContactChartForEachToothPassForGearA, constructor.new(_7022.ContactChartPerToothPass))
        return value
