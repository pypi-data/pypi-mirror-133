...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7034, _7036, _7045
...
class CylindricalGearAdvancedSystemDeflection(_7045.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7034.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_7034.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7036.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_7036.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7036.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_7036.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
