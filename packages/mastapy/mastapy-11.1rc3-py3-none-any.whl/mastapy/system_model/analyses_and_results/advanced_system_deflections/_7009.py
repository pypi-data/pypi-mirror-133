...
from mastapy.system_model.analyses_and_results.static_loads import _6545, _6567
...
class CoaxialConnectionAdvancedSystemDeflection(_7085.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    '''CoaxialConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6545.CoaxialConnectionLoadCase':
        ...
        if _6545.CoaxialConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2444.CoaxialConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2444.CoaxialConnectionSystemDeflection))
        return value
