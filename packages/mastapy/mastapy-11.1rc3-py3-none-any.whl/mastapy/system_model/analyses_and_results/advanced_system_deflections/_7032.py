...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_6985.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2467.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2467.CycloidalDiscPlanetaryBearingConnectionSystemDeflection))
        return value
