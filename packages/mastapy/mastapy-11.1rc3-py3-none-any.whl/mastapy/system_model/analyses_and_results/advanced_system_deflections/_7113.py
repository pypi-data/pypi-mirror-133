...
class WormGearMeshAdvancedSystemDeflection(_7046.GearMeshAdvancedSystemDeflection):
    '''WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2566.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2566.WormGearMeshSystemDeflection))
        return value
