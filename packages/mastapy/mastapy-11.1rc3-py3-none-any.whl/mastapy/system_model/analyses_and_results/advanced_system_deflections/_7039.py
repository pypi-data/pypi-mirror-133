...
class ExternalCADModelAdvancedSystemDeflection(_7010.ComponentAdvancedSystemDeflection):
    '''ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2482.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2482.ExternalCADModelSystemDeflection))
        return value
