...
class FaceGearAdvancedSystemDeflection(_7045.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2486.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2486.FaceGearSystemDeflection))
        return value
