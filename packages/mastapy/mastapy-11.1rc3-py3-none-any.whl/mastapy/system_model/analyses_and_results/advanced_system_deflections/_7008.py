...
class ClutchHalfAdvancedSystemDeflection(_7025.CouplingHalfAdvancedSystemDeflection):
    '''ClutchHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2442.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2442.ClutchHalfSystemDeflection))
        return value
