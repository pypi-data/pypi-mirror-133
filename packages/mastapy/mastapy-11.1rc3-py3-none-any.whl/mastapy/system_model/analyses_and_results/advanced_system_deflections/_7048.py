...
class GuideDxfModelAdvancedSystemDeflection(_7010.ComponentAdvancedSystemDeflection):
    '''GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2492.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2492.GuideDxfModelSystemDeflection))
        return value
