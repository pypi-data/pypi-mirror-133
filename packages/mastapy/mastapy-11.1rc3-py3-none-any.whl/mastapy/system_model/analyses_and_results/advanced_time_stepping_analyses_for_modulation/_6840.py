...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2553.SynchroniserSleeveSystemDeflection':
        ...
        return constructor.new(_2553.SynchroniserSleeveSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
