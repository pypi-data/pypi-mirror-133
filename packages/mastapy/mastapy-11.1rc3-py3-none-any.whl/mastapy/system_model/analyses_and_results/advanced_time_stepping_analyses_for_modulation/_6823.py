...
class SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6667.SpiralBevelGearLoadCase':
        ...
        return constructor.new(_6667.SpiralBevelGearLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None

    @property
    def system_deflection_results(self) -> '_2539.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2539.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
