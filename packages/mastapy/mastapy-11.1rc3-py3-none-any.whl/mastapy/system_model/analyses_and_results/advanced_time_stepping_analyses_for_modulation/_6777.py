...
class FaceGearMeshAdvancedTimeSteppingAnalysisForModulation(_6782.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2484.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2484.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
