...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6748.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2421.AbstractShaftOrHousingSystemDeflection':
