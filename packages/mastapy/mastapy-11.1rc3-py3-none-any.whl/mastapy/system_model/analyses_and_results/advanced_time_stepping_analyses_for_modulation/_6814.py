...
class RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation(_6789.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2525.RingPinsToDiscConnectionSystemDeflection':
        ...
        return constructor.new(_2525.RingPinsToDiscConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
