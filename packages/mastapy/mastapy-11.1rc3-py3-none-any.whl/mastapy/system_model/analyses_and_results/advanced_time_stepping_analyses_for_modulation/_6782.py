...
class GearMeshAdvancedTimeSteppingAnalysisForModulation(_6789.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''GearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2489.GearMeshSystemDeflection':
