...
class RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation(_6789.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2528.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2528.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
