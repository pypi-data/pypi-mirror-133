...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_6760.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2443.ClutchSystemDeflection':
        ...
        return constructor.new(_2443.ClutchSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
