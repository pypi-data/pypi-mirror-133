...
class UnbalancedMassAdvancedTimeSteppingAnalysisForModulation(_6846.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''UnbalancedMassAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2564.UnbalancedMassSystemDeflection':
        ...
        return constructor.new(_2564.UnbalancedMassSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
