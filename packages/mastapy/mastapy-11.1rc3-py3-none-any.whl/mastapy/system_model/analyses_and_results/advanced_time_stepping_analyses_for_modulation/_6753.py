...
class ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation(_6782.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2450.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2450.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
