...
from mastapy.system_model.analyses_and_results.static_loads import _6673, _6679, _6680
from mastapy.system_model.analyses_and_results.system_deflections import _2545, _2549, _2550
...
class StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6673.StraightBevelDiffGearLoadCase':
        ...
        if _6673.StraightBevelDiffGearLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2545.StraightBevelDiffGearSystemDeflection':
