...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6734.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2434.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2434.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
