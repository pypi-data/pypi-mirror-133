...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6760.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6687.TorqueConverterLoadCase':
        ...
        return constructor.new(_6687.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase is not None else None

    @property
    def system_deflection_results(self) -> '_2560.TorqueConverterSystemDeflection':
        ...
        return constructor.new(_2560.TorqueConverterSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
