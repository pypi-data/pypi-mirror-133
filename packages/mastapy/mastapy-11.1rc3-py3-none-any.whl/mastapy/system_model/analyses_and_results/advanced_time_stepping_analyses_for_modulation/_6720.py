...
from mastapy.system_model.part_model import _2173
...
from mastapy.system_model.analyses_and_results.system_deflections import _2422, _2468, _2534
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6721.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2173.AbstractShaft':
    ...
    @property
    def system_deflection_results(self) -> '_2422.AbstractShaftSystemDeflection':
