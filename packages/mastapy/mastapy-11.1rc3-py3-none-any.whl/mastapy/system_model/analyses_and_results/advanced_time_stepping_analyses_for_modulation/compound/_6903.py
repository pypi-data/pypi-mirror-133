...
class CylindricalPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6900.CylindricalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalPlanetGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6773.CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6773.CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6773.CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6773.CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation))
        return value
