...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6804
...
class PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_6890.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2323.PartToPartShearCoupling':
        ...
        return constructor.new(_2323.PartToPartShearCoupling)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6804.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6804.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6804.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6804.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
