...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6817
...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6918.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2029.RollingRingConnection':
        ...
        return constructor.new(_2029.RollingRingConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6817.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6817.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6817.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6817.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
