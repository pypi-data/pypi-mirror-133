...
class WormGearAdvancedTimeSteppingAnalysisForModulation(_6781.GearAdvancedTimeSteppingAnalysisForModulation):
    '''WormGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2568.WormGearSystemDeflection':
        ...
        return constructor.new(_2568.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
