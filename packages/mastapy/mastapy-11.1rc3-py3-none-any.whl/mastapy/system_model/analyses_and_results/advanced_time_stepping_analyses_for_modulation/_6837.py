...
class SynchroniserAdvancedTimeSteppingAnalysisForModulation(_6822.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2554.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2554.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
