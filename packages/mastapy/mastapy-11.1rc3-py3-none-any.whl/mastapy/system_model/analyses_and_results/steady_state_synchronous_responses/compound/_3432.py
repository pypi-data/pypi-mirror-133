...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse(_3398.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3299.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3299.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3299.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3299.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value
