...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3411
...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponse(_3411.CylindricalGearCompoundSteadyStateSynchronousResponse):
    '''CylindricalPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3281.CylindricalPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3281.CylindricalPlanetGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3281.CylindricalPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3281.CylindricalPlanetGearSteadyStateSynchronousResponse))
        return value
