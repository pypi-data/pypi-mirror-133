...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3355
...
class TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(_3403.CouplingHalfCompoundSteadyStateSynchronousResponse):
    '''TorqueConverterTurbineCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3355.TorqueConverterTurbineSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3355.TorqueConverterTurbineSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3355.TorqueConverterTurbineSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3355.TorqueConverterTurbineSteadyStateSynchronousResponse))
        return value
