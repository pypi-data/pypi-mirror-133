...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3348
...
class SynchroniserHalfCompoundSteadyStateSynchronousResponse(_3479.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    '''SynchroniserHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3348.SynchroniserHalfSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3348.SynchroniserHalfSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3348.SynchroniserHalfSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3348.SynchroniserHalfSteadyStateSynchronousResponse))
        return value
