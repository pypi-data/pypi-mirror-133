...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3370
...
class BevelGearSetCompoundSteadyStateSynchronousResponse(_3370.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''BevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3248.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3248.BevelGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3248.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3248.BevelGearSetSteadyStateSynchronousResponse))
        return value
