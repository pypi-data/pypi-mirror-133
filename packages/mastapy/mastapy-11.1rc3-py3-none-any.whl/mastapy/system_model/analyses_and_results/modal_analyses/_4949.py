...
from mastapy.math_utility import (
    _1300, _1327, _1288, _1314,
    _1299, _1283, _1298, _1320
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4852, _4946, _4945, _4899,
    _4947
)
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5815, _5818, _5823, _5824
)
from mastapy.system_model.drawing.options import _2000, _1998
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5729, _5783
from mastapy.utility.units_and_measurements.measurements import (
    _1450, _1403, _1502, _1409,
    _1400, _1405, _1424, _1497,
    _1418, _1468, _1469, _1472
)
from mastapy.utility.property import _1605
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1327.TranslationRotation':
        ...
        return constructor.new(_1327.TranslationRotation)(value) if value is not None else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1327.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4852.CoordinateSystemForWhine':
        ...
        return constructor.new(_4852.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4852.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vector_magnitude_method(self) -> '_1314.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1314.ComplexMagnitudeMethod)(value) if value is not None else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1314.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1283.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1283.AcousticWeighting)(value) if value is not None else None

    @weighting.setter
    def weighting(self, value: '_1283.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1298.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1298.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_1298.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5815.ConnectedComponentType':
        ...
        return constructor.new(_5815.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5815.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4946.WhineWaterfallExportOption':
        ...
        return constructor.new(_4946.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4946.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5818.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5818.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations is not None else None

    @property
    def waterfall_chart_settings(self) -> '_4945.WaterfallChartSettings':
        ...
        return constructor.new(_4945.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings is not None else None

    @property
    def order_cuts_chart_settings(self) -> '_4899.OrderCutsChartSettings':
        ...
        return constructor.new(_4899.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings is not None else None

    @property
    def modal_contribution_view_options(self) -> '_2000.ModalContributionViewOptions':
        ...
        return constructor.new(_2000.ModalContributionViewOptions)(self.wrapped.ModalContributionViewOptions) if self.wrapped.ModalContributionViewOptions is not None else None

    @property
    def mode_view_options(self) -> '_1998.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
        ...
        return constructor.new(_1998.AdvancedTimeSteppingAnalysisForModulationModeViewOptions)(self.wrapped.ModeViewOptions) if self.wrapped.ModeViewOptions is not None else None

    @property
    def frequency_options(self) -> '_5729.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5729.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions is not None else None

    @property
    def reference_speed_options(self) -> '_5783.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5783.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions is not None else None

    @property
    def very_short_length_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1450.LengthVeryShort]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1450.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues is not None else None

    @property
    def small_angle_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1403.AngleSmall]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1403.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues is not None else None

    @property
    def small_velocity_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1502.VelocitySmall]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1502.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1409.AngularVelocity]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1409.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues is not None else None

    @property
    def acceleration_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1400.Acceleration]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1400.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1405.AngularAcceleration]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1405.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues is not None else None

    @property
    def force_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1424.Force]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1424.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues is not None else None

    @property
    def torque_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1497.Torque]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1497.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues is not None else None

    @property
    def energy_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1418.Energy]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1418.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues is not None else None

    @property
    def power_small_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1468.PowerSmall]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1468.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1469.PowerSmallPerArea]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1469.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues is not None else None

    @property
    def pressure_reference_values(self) -> '_4947.WhineWaterfallReferenceValues[_1472.Pressure]':
        ...
        return constructor.new(_4947.WhineWaterfallReferenceValues)[_1472.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues is not None else None

    @property
    def result_location_selection_groups(self) -> '_5823.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5823.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups is not None else None

    @property
    def active_result_locations(self) -> 'List[_5824.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5824.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1605.EnumWithBool[_1320.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1605.EnumWithBool)[_1320.ResultOptionsFor3DVector])
        return value
