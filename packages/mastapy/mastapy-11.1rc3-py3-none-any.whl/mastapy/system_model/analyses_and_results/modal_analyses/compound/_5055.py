...
from mastapy.system_model.analyses_and_results.modal_analyses import _4908
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5090
...
class PowerLoadCompoundModalAnalysis(_5090.VirtualComponentCompoundModalAnalysis):
    '''PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4908.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4908.PowerLoadModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4908.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4908.PowerLoadModalAnalysis))
        return value
