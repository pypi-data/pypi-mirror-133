...
from mastapy.system_model.analyses_and_results.modal_analyses import _4914
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5007
...
class RollingRingCompoundModalAnalysis(_5007.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4914.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4914.RollingRingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4914.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4914.RollingRingModalAnalysis))
        return value
