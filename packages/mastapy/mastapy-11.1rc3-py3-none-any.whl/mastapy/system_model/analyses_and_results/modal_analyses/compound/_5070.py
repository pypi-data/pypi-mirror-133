...
from mastapy.system_model.analyses_and_results.modal_analyses import _4926
...
class SpringDamperCompoundModalAnalysis(_5005.CouplingCompoundModalAnalysis):
    '''SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4926.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4926.SpringDamperModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4926.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4926.SpringDamperModalAnalysis))
        return value
