...
from mastapy.system_model.analyses_and_results.modal_analyses import _4903
...
class PartToPartShearCouplingCompoundModalAnalysis(_5005.CouplingCompoundModalAnalysis):
    '''PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4903.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4903.PartToPartShearCouplingModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4903.PartToPartShearCouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4903.PartToPartShearCouplingModalAnalysis))
        return value
