...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4978
...
class CVTCompoundModalAnalysis(_4978.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4857.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4857.CVTModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4857.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4857.CVTModalAnalysis))
        return value
