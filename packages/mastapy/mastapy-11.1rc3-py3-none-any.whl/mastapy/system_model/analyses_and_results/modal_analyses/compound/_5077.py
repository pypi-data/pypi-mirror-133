...
from mastapy.system_model.analyses_and_results.modal_analyses import _4930
...
class StraightBevelGearMeshCompoundModalAnalysis(_4985.BevelGearMeshCompoundModalAnalysis):
    '''StraightBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4930.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4930.StraightBevelGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4930.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4930.StraightBevelGearMeshModalAnalysis))
        return value
