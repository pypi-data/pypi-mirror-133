...
class CylindricalGearCompoundModalAnalysis(_5026.GearCompoundModalAnalysis):
    '''CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4864.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4864.CylindricalGearModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4864.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4864.CylindricalGearModalAnalysis))
        return value
