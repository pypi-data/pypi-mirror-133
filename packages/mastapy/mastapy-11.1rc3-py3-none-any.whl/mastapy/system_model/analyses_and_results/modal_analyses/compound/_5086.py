...
from mastapy.system_model.analyses_and_results.modal_analyses import _4939
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5006
...
class TorqueConverterConnectionCompoundModalAnalysis(_5006.CouplingConnectionCompoundModalAnalysis):
    '''TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4939.TorqueConverterConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4939.TorqueConverterConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4939.TorqueConverterConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4939.TorqueConverterConnectionModalAnalysis))
        return value
