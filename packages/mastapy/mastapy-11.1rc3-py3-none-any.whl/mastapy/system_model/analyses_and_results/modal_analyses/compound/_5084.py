...
from mastapy.system_model.analyses_and_results.modal_analyses import _4938
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5083
...
class SynchroniserSleeveCompoundModalAnalysis(_5083.SynchroniserPartCompoundModalAnalysis):
    '''SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4938.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4938.SynchroniserSleeveModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4938.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4938.SynchroniserSleeveModalAnalysis))
        return value
