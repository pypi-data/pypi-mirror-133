...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5015, _5016, _5028
...
class CylindricalGearSetCompoundModalAnalysis(_5028.GearSetCompoundModalAnalysis):
    '''CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_5015.CylindricalGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundModalAnalysis, constructor.new(_5015.CylindricalGearCompoundModalAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_5016.CylindricalGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundModalAnalysis, constructor.new(_5016.CylindricalGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4865.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4865.CylindricalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4865.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4865.CylindricalGearSetModalAnalysis))
        return value
