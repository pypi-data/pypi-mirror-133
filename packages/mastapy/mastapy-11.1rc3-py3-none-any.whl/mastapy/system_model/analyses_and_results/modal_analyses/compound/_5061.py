...
from mastapy.system_model.analyses_and_results.modal_analyses import _4913
...
class RollingRingConnectionCompoundModalAnalysis(_5033.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4913.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4913.RollingRingConnectionModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4913.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4913.RollingRingConnectionModalAnalysis))
        return value
