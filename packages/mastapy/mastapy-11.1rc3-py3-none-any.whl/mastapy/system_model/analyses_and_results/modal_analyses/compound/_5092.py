...
from mastapy.system_model.analyses_and_results.modal_analyses import _4950
...
class WormGearMeshCompoundModalAnalysis(_5027.GearMeshCompoundModalAnalysis):
    '''WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4950.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4950.WormGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4950.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4950.WormGearMeshModalAnalysis))
        return value
