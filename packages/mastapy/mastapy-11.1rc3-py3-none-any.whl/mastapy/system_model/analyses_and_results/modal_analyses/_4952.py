...
from mastapy.system_model.analyses_and_results.modal_analyses import _4951, _4950, _4877
...
class WormGearSetModalAnalysis(_4877.GearSetModalAnalysis):
    '''WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4951.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_4951.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4950.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_4950.WormGearMeshModalAnalysis))
        return value
