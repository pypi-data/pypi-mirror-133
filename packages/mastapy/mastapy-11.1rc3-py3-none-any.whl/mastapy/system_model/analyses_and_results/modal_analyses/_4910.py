...
class RingPinsModalAnalysis(_4897.MountableComponentModalAnalysis):
    '''RingPinsModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2524.RingPinsSystemDeflection':
        ...
        return constructor.new(_2524.RingPinsSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
