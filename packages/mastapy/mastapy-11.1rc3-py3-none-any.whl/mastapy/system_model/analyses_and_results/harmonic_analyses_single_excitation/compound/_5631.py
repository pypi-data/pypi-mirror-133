...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5501
...
class SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5566.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_design(self) -> '_2087.SpringDamperConnection':
        ...
        return constructor.new(_2087.SpringDamperConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5501.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5501.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5501.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5501.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation))
        return value
