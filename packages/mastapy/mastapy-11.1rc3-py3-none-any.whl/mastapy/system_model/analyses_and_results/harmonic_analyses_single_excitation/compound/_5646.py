...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5516
...
class TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5566.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''TorqueConverterConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_design(self) -> '_2089.TorqueConverterConnection':
        ...
        return constructor.new(_2089.TorqueConverterConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5516.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5516.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5516.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5516.TorqueConverterConnectionHarmonicAnalysisOfSingleExcitation))
        return value
