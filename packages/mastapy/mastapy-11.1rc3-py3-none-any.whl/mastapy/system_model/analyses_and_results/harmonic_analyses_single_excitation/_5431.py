...
class ConicalGearMeshHarmonicAnalysisOfSingleExcitation(_5457.GearMeshHarmonicAnalysisOfSingleExcitation):
    '''ConicalGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    def planetaries(self) -> 'List[ConicalGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
