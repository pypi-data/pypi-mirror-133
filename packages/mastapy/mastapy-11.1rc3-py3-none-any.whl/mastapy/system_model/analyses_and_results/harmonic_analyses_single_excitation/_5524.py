...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5522, _5523, _5458
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_5458.GearSetHarmonicAnalysisOfSingleExcitation):
    '''WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5522.WormGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5522.WormGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5523.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5523.WormGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
