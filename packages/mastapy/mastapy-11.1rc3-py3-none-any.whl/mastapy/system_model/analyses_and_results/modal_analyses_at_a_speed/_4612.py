...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4611, _4610, _4617
...
class FaceGearSetModalAnalysisAtASpeed(_4617.GearSetModalAnalysisAtASpeed):
    '''FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_4611.FaceGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtASpeed, constructor.new(_4611.FaceGearModalAnalysisAtASpeed))
        return value

    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_4610.FaceGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtASpeed, constructor.new(_4610.FaceGearMeshModalAnalysisAtASpeed))
        return value
