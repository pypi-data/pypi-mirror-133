...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4569, _4568, _4575
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_4575.BevelGearSetModalAnalysisAtASpeed):
    '''BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_4569.BevelDifferentialGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysisAtASpeed, constructor.new(_4569.BevelDifferentialGearModalAnalysisAtASpeed))
        return value

    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_4568.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysisAtASpeed, constructor.new(_4568.BevelDifferentialGearMeshModalAnalysisAtASpeed))
        return value
