...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4678
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4808
...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_4808.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4678.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4678.UnbalancedMassModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4678.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4678.UnbalancedMassModalAnalysisAtASpeed))
        return value
