...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4676
...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_4725.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4676.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4676.TorqueConverterPumpModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4676.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4676.TorqueConverterPumpModalAnalysisAtASpeed))
        return value
