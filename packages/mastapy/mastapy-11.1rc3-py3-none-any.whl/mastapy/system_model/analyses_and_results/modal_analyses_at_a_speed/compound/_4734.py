...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_4745.GearMeshCompoundModalAnalysisAtASpeed):
    '''CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4604.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4604.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4604.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4604.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
