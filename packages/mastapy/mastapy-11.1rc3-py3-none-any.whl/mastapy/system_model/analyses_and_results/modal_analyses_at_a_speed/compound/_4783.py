...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4654
...
class ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4689.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4654.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4654.ShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4654.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4654.ShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value
