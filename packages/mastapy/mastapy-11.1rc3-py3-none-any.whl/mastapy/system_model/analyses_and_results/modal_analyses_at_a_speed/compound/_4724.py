...
class CouplingConnectionCompoundModalAnalysisAtASpeed(_4751.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''CouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4594.CouplingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4594.CouplingConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4594.CouplingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4594.CouplingConnectionModalAnalysisAtASpeed))
        return value
