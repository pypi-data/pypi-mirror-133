...
class ConnectorCompoundModalAnalysisAtASpeed(_4763.MountableComponentCompoundModalAnalysisAtASpeed):
    '''ConnectorCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4593.ConnectorModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4593.ConnectorModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4593.ConnectorModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4593.ConnectorModalAnalysisAtASpeed))
        return value
