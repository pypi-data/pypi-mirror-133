...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4663, _4662, _4575
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_4575.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_4663.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysisAtASpeed, constructor.new(_4663.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_4662.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysisAtASpeed, constructor.new(_4662.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value
