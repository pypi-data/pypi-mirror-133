...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4657, _4656, _4575
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_4575.BevelGearSetModalAnalysisAtASpeed):
    '''SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4657.SpiralBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtASpeed, constructor.new(_4657.SpiralBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4656.SpiralBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtASpeed, constructor.new(_4656.SpiralBevelGearMeshModalAnalysisAtASpeed))
        return value
