...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4605, _4604, _4617
...
class CylindricalGearSetModalAnalysisAtASpeed(_4617.GearSetModalAnalysisAtASpeed):
    '''CylindricalGearSetModalAnalysisAtASpeed
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_4605.CylindricalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtASpeed, constructor.new(_4605.CylindricalGearModalAnalysisAtASpeed))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_4604.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtASpeed, constructor.new(_4604.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
