...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4681, _4680, _4617
...
class WormGearSetModalAnalysisAtASpeed(_4617.GearSetModalAnalysisAtASpeed):
    '''WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_4681.WormGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtASpeed, constructor.new(_4681.WormGearModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_4680.WormGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtASpeed, constructor.new(_4680.WormGearMeshModalAnalysisAtASpeed))
        return value
