...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2371, _4564
...
class RootAssemblyModalAnalysisAtASpeed(_4564.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2371.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2371.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs is not None else None
