...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4587, _4586, _4617
...
class ConceptGearSetModalAnalysisAtASpeed(_4617.GearSetModalAnalysisAtASpeed):
    '''ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_4587.ConceptGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtASpeed, constructor.new(_4587.ConceptGearModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_4586.ConceptGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtASpeed, constructor.new(_4586.ConceptGearMeshModalAnalysisAtASpeed))
        return value
