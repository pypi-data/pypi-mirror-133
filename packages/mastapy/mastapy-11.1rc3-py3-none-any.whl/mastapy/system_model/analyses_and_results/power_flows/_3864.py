...
from mastapy.system_model.analyses_and_results.power_flows import _3863, _3862, _3778
...
class SpiralBevelGearSetPowerFlow(_3778.BevelGearSetPowerFlow):
    '''SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3863.SpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3863.SpiralBevelGearPowerFlow))
        return value

    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_3863.SpiralBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsPowerFlow, constructor.new(_3863.SpiralBevelGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3862.SpiralBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3862.SpiralBevelGearMeshPowerFlow))
        return value

    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_3862.SpiralBevelGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesPowerFlow, constructor.new(_3862.SpiralBevelGearMeshPowerFlow))
        return value
