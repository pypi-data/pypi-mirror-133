...
class GearCompoundPowerFlow(_3970.MountableComponentCompoundPowerFlow):
    '''GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3820.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3820.GearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3820.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3820.GearPowerFlow))
        return value
