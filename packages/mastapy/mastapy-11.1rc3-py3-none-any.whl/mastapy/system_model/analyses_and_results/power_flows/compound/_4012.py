...
class TorqueConverterPumpCompoundPowerFlow(_3932.CouplingHalfCompoundPowerFlow):
    '''TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3883.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3883.TorqueConverterPumpPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3883.TorqueConverterPumpPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3883.TorqueConverterPumpPowerFlow))
        return value
