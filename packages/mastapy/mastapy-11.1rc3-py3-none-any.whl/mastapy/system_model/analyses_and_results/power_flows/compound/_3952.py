...
class GearMeshCompoundPowerFlow(_3958.InterMountableComponentConnectionCompoundPowerFlow):
    '''GearMeshCompoundPowerFlow
    ...
    @property
    def gear_mesh_duty_cycle_rating_of_type_conical_mesh_duty_cycle_rating(self) -> '_499.ConicalMeshDutyCycleRating':
        ...
        if _499.ConicalMeshDutyCycleRating.TYPE not in self.wrapped.GearMeshDutyCycleRating.__class__.__mro__:
    ...
    @property
    def gear_mesh_duty_cycle_rating_of_type_concept_gear_mesh_duty_cycle_rating(self) -> '_504.ConceptGearMeshDutyCycleRating':
        ...
        if _504.ConceptGearMeshDutyCycleRating.TYPE not in self.wrapped.GearMeshDutyCycleRating.__class__.__mro__:
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3819.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3819.GearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3819.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3819.GearMeshPowerFlow))
        return value
