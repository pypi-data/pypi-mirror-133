...
class CylindricalPlanetGearCompoundPowerFlow(_3940.CylindricalGearCompoundPowerFlow):
    '''CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3811.CylindricalPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3811.CylindricalPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3811.CylindricalPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3811.CylindricalPlanetGearPowerFlow))
        return value
