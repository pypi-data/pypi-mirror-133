...
class WormGearCompoundPowerFlow(_3951.GearCompoundPowerFlow):
    '''WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3888.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3888.WormGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3888.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3888.WormGearPowerFlow))
        return value
