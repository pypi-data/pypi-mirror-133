...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_3927.ConicalGearSetCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3829.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3829.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3829.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3829.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value
