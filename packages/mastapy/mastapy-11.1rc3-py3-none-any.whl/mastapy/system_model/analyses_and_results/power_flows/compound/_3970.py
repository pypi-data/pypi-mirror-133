...
class MountableComponentCompoundPowerFlow(_3918.ComponentCompoundPowerFlow):
    '''MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3838.MountableComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3838.MountableComponentPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3838.MountableComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3838.MountableComponentPowerFlow))
        return value
