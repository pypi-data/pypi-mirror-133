...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_3917.CoaxialConnectionCompoundPowerFlow):
    '''CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3804.CycloidalDiscCentralBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3804.CycloidalDiscCentralBearingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3804.CycloidalDiscCentralBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3804.CycloidalDiscCentralBearingConnectionPowerFlow))
        return value
