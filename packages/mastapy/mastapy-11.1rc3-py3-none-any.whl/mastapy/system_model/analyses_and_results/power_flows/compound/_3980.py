...
class PowerLoadCompoundPowerFlow(_4015.VirtualComponentCompoundPowerFlow):
    '''PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3850.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3850.PowerLoadPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3850.PowerLoadPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3850.PowerLoadPowerFlow))
        return value
