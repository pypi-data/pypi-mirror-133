...
class StraightBevelDiffGearCompoundPowerFlow(_3909.BevelGearCompoundPowerFlow):
    '''StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3869.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3869.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3869.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3869.StraightBevelDiffGearPowerFlow))
        return value
