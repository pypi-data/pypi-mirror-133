...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3931
...
class PartToPartShearCouplingConnectionCompoundPowerFlow(_3931.CouplingConnectionCompoundPowerFlow):
    '''PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3841.PartToPartShearCouplingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3841.PartToPartShearCouplingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3841.PartToPartShearCouplingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3841.PartToPartShearCouplingConnectionPowerFlow))
        return value
