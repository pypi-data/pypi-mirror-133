...
class StraightBevelSunGearCompoundPowerFlow(_3998.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3875.StraightBevelSunGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3875.StraightBevelSunGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3875.StraightBevelSunGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3875.StraightBevelSunGearPowerFlow))
        return value
