...
class ClutchCompoundPowerFlow(_3930.CouplingCompoundPowerFlow):
    '''ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3783.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3783.ClutchPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3783.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3783.ClutchPowerFlow))
        return value
