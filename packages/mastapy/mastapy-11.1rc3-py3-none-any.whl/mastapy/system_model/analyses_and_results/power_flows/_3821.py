...
from mastapy.system_model.analyses_and_results.power_flows import _3819, _3820, _3861
...
class GearSetPowerFlow(_3861.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3819.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3819.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3820.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3820.GearPowerFlow))
        return value
