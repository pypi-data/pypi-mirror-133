...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2360, _6260
...
class RootAssemblyCriticalSpeedAnalysis(_6260.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2360.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2360.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs is not None else None
