...
class FEPartCriticalSpeedAnalysis(_6255.AbstractShaftOrHousingCriticalSpeedAnalysis):
    '''FEPartCriticalSpeedAnalysis
    ...
    def planetaries(self) -> 'List[FEPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(FEPartCriticalSpeedAnalysis))
        return value
