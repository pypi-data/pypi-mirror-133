...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6282, _6283, _6315
...
class ConceptGearSetCriticalSpeedAnalysis(_6315.GearSetCriticalSpeedAnalysis):
    '''ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6282.ConceptGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCriticalSpeedAnalysis, constructor.new(_6282.ConceptGearCriticalSpeedAnalysis))
        return value

    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6283.ConceptGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCriticalSpeedAnalysis, constructor.new(_6283.ConceptGearMeshCriticalSpeedAnalysis))
        return value
