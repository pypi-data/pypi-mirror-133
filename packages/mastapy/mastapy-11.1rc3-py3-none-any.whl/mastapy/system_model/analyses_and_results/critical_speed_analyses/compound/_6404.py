...
class BoltedJointCompoundCriticalSpeedAnalysis(_6482.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    '''BoltedJointCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6273.BoltedJointCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6273.BoltedJointCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6273.BoltedJointCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6273.BoltedJointCriticalSpeedAnalysis))
        return value
