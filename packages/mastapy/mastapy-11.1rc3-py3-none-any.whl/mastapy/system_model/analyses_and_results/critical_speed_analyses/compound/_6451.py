...
class KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis(_6417.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6322.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6322.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6322.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6322.KlingelnbergCycloPalloidConicalGearMeshCriticalSpeedAnalysis))
        return value
