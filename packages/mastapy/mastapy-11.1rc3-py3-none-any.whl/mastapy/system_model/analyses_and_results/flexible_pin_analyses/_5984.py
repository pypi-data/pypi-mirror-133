...
class FlexiblePinAnalysisManufactureLevel(_5980.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4069.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4069.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis is not None else None
