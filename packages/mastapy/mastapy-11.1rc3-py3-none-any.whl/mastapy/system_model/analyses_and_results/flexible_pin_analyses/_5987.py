...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2676
from mastapy.system_model.analyses_and_results.system_deflections import _2530
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5979
...
class WindTurbineCertificationReport(_5979.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2210.RootAssembly':
        ...
        return constructor.new(_2210.RootAssembly)(self.wrapped.Design) if self.wrapped.Design is not None else None

    @property
    def ldd_static_analysis(self) -> '_2676.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2676.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis is not None else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2530.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2530.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis is not None else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2530.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2530.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis is not None else None
