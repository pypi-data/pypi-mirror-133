...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6017, _6018, _6049
...
class ConceptGearSetDynamicAnalysis(_6049.GearSetDynamicAnalysis):
    '''ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_6017.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsDynamicAnalysis, constructor.new(_6017.ConceptGearDynamicAnalysis))
        return value

    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_6018.ConceptGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesDynamicAnalysis, constructor.new(_6018.ConceptGearMeshDynamicAnalysis))
        return value
