...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6078
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6195
...
class RingPinsCompoundDynamicAnalysis(_6195.MountableComponentCompoundDynamicAnalysis):
    '''RingPinsCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6078.RingPinsDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6078.RingPinsDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6078.RingPinsDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6078.RingPinsDynamicAnalysis))
        return value
