...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6223
...
class StraightBevelPlanetGearCompoundDynamicAnalysis(_6223.StraightBevelDiffGearCompoundDynamicAnalysis):
    '''StraightBevelPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6100.StraightBevelPlanetGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6100.StraightBevelPlanetGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6100.StraightBevelPlanetGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6100.StraightBevelPlanetGearDynamicAnalysis))
        return value
