...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6108
...
class TorqueConverterPumpCompoundDynamicAnalysis(_6157.CouplingHalfCompoundDynamicAnalysis):
    '''TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6108.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6108.TorqueConverterPumpDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6108.TorqueConverterPumpDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6108.TorqueConverterPumpDynamicAnalysis))
        return value
