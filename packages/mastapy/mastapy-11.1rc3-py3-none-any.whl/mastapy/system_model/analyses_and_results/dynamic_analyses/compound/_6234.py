...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6105
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6233
...
class SynchroniserSleeveCompoundDynamicAnalysis(_6233.SynchroniserPartCompoundDynamicAnalysis):
    '''SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6105.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6105.SynchroniserSleeveDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6105.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6105.SynchroniserSleeveDynamicAnalysis))
        return value
