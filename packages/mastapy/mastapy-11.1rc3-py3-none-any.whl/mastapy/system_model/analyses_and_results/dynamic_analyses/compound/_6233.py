...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6104
...
class SynchroniserPartCompoundDynamicAnalysis(_6157.CouplingHalfCompoundDynamicAnalysis):
    '''SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6104.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6104.SynchroniserPartDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6104.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6104.SynchroniserPartDynamicAnalysis))
        return value
