...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6143.ComponentCompoundDynamicAnalysis):
    '''AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5990.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5990.AbstractShaftOrHousingDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5990.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5990.AbstractShaftOrHousingDynamicAnalysis))
        return value
