...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6085
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6154
...
class ShaftHubConnectionCompoundDynamicAnalysis(_6154.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6085.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6085.ShaftHubConnectionDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6085.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6085.ShaftHubConnectionDynamicAnalysis))
        return value
