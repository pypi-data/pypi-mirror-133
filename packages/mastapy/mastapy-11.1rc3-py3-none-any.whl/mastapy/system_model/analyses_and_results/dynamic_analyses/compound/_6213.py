...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6084
...
class ShaftCompoundDynamicAnalysis(_6119.AbstractShaftCompoundDynamicAnalysis):
    '''ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6084.ShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6084.ShaftDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6084.ShaftDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6084.ShaftDynamicAnalysis))
        return value
