...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6115, _6116, _6006
...
class ZerolBevelGearSetDynamicAnalysis(_6006.BevelGearSetDynamicAnalysis):
    '''ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6115.ZerolBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsDynamicAnalysis, constructor.new(_6115.ZerolBevelGearDynamicAnalysis))
        return value

    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6116.ZerolBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesDynamicAnalysis, constructor.new(_6116.ZerolBevelGearMeshDynamicAnalysis))
        return value
