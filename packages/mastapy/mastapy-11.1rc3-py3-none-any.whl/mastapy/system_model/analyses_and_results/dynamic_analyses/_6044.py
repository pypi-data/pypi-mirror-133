...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6042, _6043, _6049
...
class FaceGearSetDynamicAnalysis(_6049.GearSetDynamicAnalysis):
    '''FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6042.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsDynamicAnalysis, constructor.new(_6042.FaceGearDynamicAnalysis))
        return value

    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6043.FaceGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesDynamicAnalysis, constructor.new(_6043.FaceGearMeshDynamicAnalysis))
        return value
