...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6094, _6095, _6006
...
class StraightBevelDiffGearSetDynamicAnalysis(_6006.BevelGearSetDynamicAnalysis):
    '''StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6094.StraightBevelDiffGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsDynamicAnalysis, constructor.new(_6094.StraightBevelDiffGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6095.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesDynamicAnalysis, constructor.new(_6095.StraightBevelDiffGearMeshDynamicAnalysis))
        return value
