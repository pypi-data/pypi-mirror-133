...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6097, _6098, _6006
...
class StraightBevelGearSetDynamicAnalysis(_6006.BevelGearSetDynamicAnalysis):
    '''StraightBevelGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_gears_dynamic_analysis(self) -> 'List[_6097.StraightBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsDynamicAnalysis, constructor.new(_6097.StraightBevelGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_meshes_dynamic_analysis(self) -> 'List[_6098.StraightBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesDynamicAnalysis, constructor.new(_6098.StraightBevelGearMeshDynamicAnalysis))
        return value
