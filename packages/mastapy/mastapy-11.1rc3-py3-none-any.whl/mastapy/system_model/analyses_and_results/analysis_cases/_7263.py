...
class TimeSeriesLoadAnalysisCase(_7247.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6515.TimeSeriesLoadCase':
        ...
        return constructor.new(_6515.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase is not None else None
