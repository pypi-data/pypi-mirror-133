...
from mastapy.system_model.analyses_and_results.stability_analyses import _3621, _3619, _3553
...
class WormGearSetStabilityAnalysis(_3553.GearSetStabilityAnalysis):
    '''WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3621.WormGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsStabilityAnalysis, constructor.new(_3621.WormGearStabilityAnalysis))
        return value

    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3619.WormGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesStabilityAnalysis, constructor.new(_3619.WormGearMeshStabilityAnalysis))
        return value
