...
class ConicalGearMeshStabilityAnalysis(_3552.GearMeshStabilityAnalysis):
    '''ConicalGearMeshStabilityAnalysis
    ...
    def planetaries(self) -> 'List[ConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshStabilityAnalysis))
        return value
