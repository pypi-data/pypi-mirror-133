...
from mastapy.system_model.analyses_and_results.stability_analyses import _3533, _3495
...
class ShaftStabilityAnalysis(_3495.AbstractShaftStabilityAnalysis):
    '''ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3533.CriticalSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CriticalSpeeds, constructor.new(_3533.CriticalSpeed))
        return value
