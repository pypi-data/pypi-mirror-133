...
from mastapy.system_model.analyses_and_results.stability_analyses import _3524, _3522, _3553
...
class ConceptGearSetStabilityAnalysis(_3553.GearSetStabilityAnalysis):
    '''ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3524.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsStabilityAnalysis, constructor.new(_3524.ConceptGearStabilityAnalysis))
        return value

    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3522.ConceptGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesStabilityAnalysis, constructor.new(_3522.ConceptGearMeshStabilityAnalysis))
        return value
