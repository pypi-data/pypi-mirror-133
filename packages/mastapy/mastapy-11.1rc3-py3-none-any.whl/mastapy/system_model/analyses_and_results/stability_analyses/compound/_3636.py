...
class BevelDifferentialGearCompoundStabilityAnalysis(_3641.BevelGearCompoundStabilityAnalysis):
    '''BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3506.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3506.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3506.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3506.BevelDifferentialGearStabilityAnalysis))
        return value
