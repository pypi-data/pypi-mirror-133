...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3636.BevelDifferentialGearCompoundStabilityAnalysis):
    '''BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3508.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3508.BevelDifferentialSunGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3508.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3508.BevelDifferentialSunGearStabilityAnalysis))
        return value
