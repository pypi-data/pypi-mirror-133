...
from mastapy.system_model.analyses_and_results.stability_analyses import _3543, _3541, _3553
...
class CylindricalGearSetStabilityAnalysis(_3553.GearSetStabilityAnalysis):
    '''CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3543.CylindricalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsStabilityAnalysis, constructor.new(_3543.CylindricalGearStabilityAnalysis))
        return value

    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3541.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesStabilityAnalysis, constructor.new(_3541.CylindricalGearMeshStabilityAnalysis))
        return value
