...
from mastapy.utility.units_and_measurements.measurements import _1463
...
class ShaftModalComplexShape(_3755.ShaftComplexShape['_1463.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
