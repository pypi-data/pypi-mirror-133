...
class CylindricalGearMeshCompoundMultibodyDynamicsAnalysis(_5308.GearMeshCompoundMultibodyDynamicsAnalysis):
    '''CylindricalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5147.CylindricalGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5147.CylindricalGearMeshMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5147.CylindricalGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5147.CylindricalGearMeshMultibodyDynamicsAnalysis))
        return value
