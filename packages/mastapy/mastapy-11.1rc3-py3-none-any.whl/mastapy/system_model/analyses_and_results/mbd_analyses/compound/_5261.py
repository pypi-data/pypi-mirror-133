...
class BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(_5266.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    '''BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5110.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5110.BevelDifferentialGearMeshMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5110.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5110.BevelDifferentialGearMeshMultibodyDynamicsAnalysis))
        return value
