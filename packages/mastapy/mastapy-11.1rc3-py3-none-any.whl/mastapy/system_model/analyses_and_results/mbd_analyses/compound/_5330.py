...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5188
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5287
...
class PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5287.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    '''PartToPartShearCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5188.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5188.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5188.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5188.PartToPartShearCouplingConnectionMultibodyDynamicsAnalysis))
        return value
