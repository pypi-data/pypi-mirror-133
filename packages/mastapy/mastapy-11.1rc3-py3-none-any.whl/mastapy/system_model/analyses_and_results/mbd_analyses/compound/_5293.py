...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5273.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5144.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5144.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5144.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5144.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis))
        return value
