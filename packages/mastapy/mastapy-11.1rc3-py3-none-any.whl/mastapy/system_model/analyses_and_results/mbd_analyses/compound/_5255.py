...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5283.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    '''AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5103.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5103.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5103.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5103.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis))
        return value
