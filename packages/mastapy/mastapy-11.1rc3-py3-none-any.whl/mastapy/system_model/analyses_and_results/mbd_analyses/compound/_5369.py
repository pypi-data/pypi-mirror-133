...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5233
...
class TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis(_5288.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    '''TorqueConverterTurbineCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5233.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5233.TorqueConverterTurbineMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5233.TorqueConverterTurbineMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5233.TorqueConverterTurbineMultibodyDynamicsAnalysis))
        return value
