...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5207
...
class ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5252.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5207.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5207.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5207.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5207.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value
