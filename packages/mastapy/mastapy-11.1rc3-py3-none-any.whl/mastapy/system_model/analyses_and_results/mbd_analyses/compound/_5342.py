...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5200
...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5314.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5200.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5200.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5200.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5200.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
