...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5243
...
class DynamicTorqueResultAtTime(_5243.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
