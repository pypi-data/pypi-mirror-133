...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5169, _5208, _5203
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7248
...
class MBDRunUpAnalysisOptions(_7248.AbstractAnalysisOptions['_6515.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5169.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5169.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5169.InputVelocityForRunUpProcessingType'):
    ...
    def power_load_for_run_up_torque(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.PowerLoadForRunUpTorque) if self.wrapped.PowerLoadForRunUpTorque is not None else None
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5208.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5208.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5208.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5203.RunUpDrivingMode':
        ...
        return constructor.new(_5203.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5203.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def reference_power_load_for_run_up_speed(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.ReferencePowerLoadForRunUpSpeed) if self.wrapped.ReferencePowerLoadForRunUpSpeed is not None else None
