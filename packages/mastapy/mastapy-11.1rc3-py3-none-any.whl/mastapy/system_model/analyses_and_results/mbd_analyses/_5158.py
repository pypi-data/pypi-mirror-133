...
class GearMeshMultibodyDynamicsAnalysis(_5170.InterMountableComponentConnectionMultibodyDynamicsAnalysis):
    '''GearMeshMultibodyDynamicsAnalysis
    ...
    @property
    def contact_status(self) -> '_65.GearMeshContactStatus':
