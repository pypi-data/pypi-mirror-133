...
class BeltConnectionMultibodyDynamicsAnalysis(_5170.InterMountableComponentConnectionMultibodyDynamicsAnalysis):
    '''BeltConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def loading_status(self) -> '_70.LoadingStatus':
        ...
        return constructor.new(_70.LoadingStatus)(value) if value is not None else None
