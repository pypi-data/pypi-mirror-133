...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2374, _5105
...
class RootAssemblyMultibodyDynamicsAnalysis(_5105.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2374.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2374.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs is not None else None
