...
class BevelDifferentialPlanetGearSystemDeflection(_2433.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3774.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
