...
from mastapy.system_model.analyses_and_results.system_deflections import _2532, _2533, _2422
...
class ShaftSystemDeflection(_2422.AbstractShaftSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6663.ShaftLoadCase':
        ...
        return constructor.new(_6663.ShaftLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3859.ShaftPowerFlow':
        ...
        return constructor.new(_3859.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2532.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2532.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2532.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2532.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2532.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2532.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife is not None else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2533.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2533.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2532.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2532.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1355.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1355.ForceResults))
        return value
