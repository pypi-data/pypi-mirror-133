...
class StraightBevelSunGearSystemDeflection(_2545.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3875.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_3875.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
