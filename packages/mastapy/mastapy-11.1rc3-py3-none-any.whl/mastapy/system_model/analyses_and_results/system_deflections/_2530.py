...
class RootAssemblySystemDeflection(_2427.AssemblySystemDeflection):
    '''RootAssemblySystemDeflection
    ...
    @property
    def system_deflection_inputs(self) -> '_2555.SystemDeflection':
        ...
        if _2555.SystemDeflection.TYPE not in self.wrapped.SystemDeflectionInputs.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3857.RootAssemblyPowerFlow':
        ...
        return constructor.new(_3857.RootAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def shaft_deflection_results(self) -> 'List[_2446.ConcentricPartGroupCombinationSystemDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionResults, constructor.new(_2446.ConcentricPartGroupCombinationSystemDeflectionResults))
        return value
