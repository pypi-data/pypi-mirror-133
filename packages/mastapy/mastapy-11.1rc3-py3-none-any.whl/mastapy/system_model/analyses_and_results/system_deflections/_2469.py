...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2575
...
class CylindricalGearMeshSystemDeflection(_2489.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_misalignment_in_transverse_line_of_action(self) -> '_1554.LegacyChartDefinition':
        ...
        return constructor.new(_1554.LegacyChartDefinition)(self.wrapped.ChartOfMisalignmentInTransverseLineOfAction) if self.wrapped.ChartOfMisalignmentInTransverseLineOfAction is not None else None
    ...
    @property
    def power_flow_results(self) -> '_3808.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3808.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def gear_a(self) -> '_2475.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2475.CylindricalGearSystemDeflection':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2475.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2475.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_system_deflections(self) -> 'List[_2479.CylindricalMeshedGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearSystemDeflections, constructor.new(_2479.CylindricalMeshedGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2575.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2575.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2575.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2575.MeshDeflectionResults))
        return value
