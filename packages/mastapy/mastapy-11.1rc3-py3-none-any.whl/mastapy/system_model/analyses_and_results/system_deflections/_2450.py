...
class ConceptGearMeshSystemDeflection(_2489.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6551.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_6551.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3789.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3789.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_505.ConceptGearMeshRating':
        ...
        return constructor.new(_505.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None

    @property
    def component_detailed_analysis(self) -> '_505.ConceptGearMeshRating':
        ...
        return constructor.new(_505.ConceptGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis is not None else None
