...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2576
...
class PlanetCarrierSystemDeflection(_2512.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3846.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3846.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def windup(self) -> 'List[_2576.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2576.PlanetCarrierWindup))
        return value
