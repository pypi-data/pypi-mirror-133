...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2659
...
class GearCompoundSystemDeflection(_2659.MountableComponentCompoundSystemDeflection):
    '''GearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_324.GearDutyCycleRating':
        ...
        if _324.GearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def duty_cycle_rating_of_type_worm_gear_duty_cycle_rating(self) -> '_338.WormGearDutyCycleRating':
        ...
        if _338.WormGearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def duty_cycle_rating_of_type_face_gear_duty_cycle_rating(self) -> '_411.FaceGearDutyCycleRating':
        ...
        if _411.FaceGearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def duty_cycle_rating_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_418.CylindricalGearDutyCycleRating':
        ...
        if _418.CylindricalGearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def duty_cycle_rating_of_type_conical_gear_duty_cycle_rating(self) -> '_493.ConicalGearDutyCycleRating':
        ...
        if _493.ConicalGearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def duty_cycle_rating_of_type_concept_gear_duty_cycle_rating(self) -> '_503.ConceptGearDutyCycleRating':
        ...
        if _503.ConceptGearDutyCycleRating.TYPE not in self.wrapped.DutyCycleRating.__class__.__mro__:
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2491.GearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2491.GearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2491.GearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2491.GearSystemDeflection))
        return value
