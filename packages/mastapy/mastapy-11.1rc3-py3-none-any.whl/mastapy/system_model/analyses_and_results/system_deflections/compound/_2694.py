...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2688
...
class StraightBevelPlanetGearCompoundSystemDeflection(_2688.StraightBevelDiffGearCompoundSystemDeflection):
    '''StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2549.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2549.StraightBevelPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2549.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2549.StraightBevelPlanetGearSystemDeflection))
        return value
