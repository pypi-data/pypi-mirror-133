...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2592
...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2592.BevelDifferentialGearCompoundSystemDeflection):
    '''BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2434.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2434.BevelDifferentialPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2434.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2434.BevelDifferentialPlanetGearSystemDeflection))
        return value
