...
class OilSealCompoundSystemDeflection(_2617.ConnectorCompoundSystemDeflection):
    '''OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2514.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2514.OilSealSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2514.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2514.OilSealSystemDeflection))
        return value
