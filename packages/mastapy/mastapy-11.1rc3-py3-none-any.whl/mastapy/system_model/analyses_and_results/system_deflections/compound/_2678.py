...
class ShaftDutyCycleSystemDeflection(_0.APIBase):
    ...
    @property
    def shaft_design(self) -> '_2218.Shaft':
        ...
        return constructor.new(_2218.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign is not None else None
    ...
    def shaft_damage_results(self) -> '_19.ShaftDamageResults':
        ...
        return constructor.new(_19.ShaftDamageResults)(self.wrapped.ShaftDamageResults) if self.wrapped.ShaftDamageResults is not None else None

    @property
    def shaft_static_analyses(self) -> 'List[_2534.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2534.ShaftSystemDeflection))
        return value
