...
class RollingRingConnectionCompoundSystemDeflection(_2647.InterMountableComponentConnectionCompoundSystemDeflection):
    '''RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2528.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2528.RollingRingConnectionSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2528.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2528.RollingRingConnectionSystemDeflection))
        return value
