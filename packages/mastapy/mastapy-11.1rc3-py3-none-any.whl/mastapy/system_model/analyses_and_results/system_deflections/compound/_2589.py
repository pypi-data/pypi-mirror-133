...
class BearingCompoundSystemDeflection(_2617.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1697.LoadedBearingDutyCycle':
        ...
        if _1697.LoadedBearingDutyCycle.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2428.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2428.BearingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2428.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2428.BearingSystemDeflection))
        return value
