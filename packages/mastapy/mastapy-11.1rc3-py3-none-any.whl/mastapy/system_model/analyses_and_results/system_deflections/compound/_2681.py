...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2581
...
class SpecialisedAssemblyCompoundSystemDeflection(_2581.AbstractAssemblyCompoundSystemDeflection):
    '''SpecialisedAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2536.SpecialisedAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2536.SpecialisedAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2536.SpecialisedAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2536.SpecialisedAssemblySystemDeflection))
        return value
