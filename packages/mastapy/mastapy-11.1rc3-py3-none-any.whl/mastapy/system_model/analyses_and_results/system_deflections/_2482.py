...
class ExternalCADModelSystemDeflection(_2445.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3813.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3813.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
