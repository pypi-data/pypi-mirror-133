...
from mastapy.system_model.analyses_and_results.power_flows import _3762, _3806, _3859
...
class AbstractShaftSystemDeflection(_2421.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3762.AbstractShaftPowerFlow':
