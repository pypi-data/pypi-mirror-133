...
from mastapy.system_model.analyses_and_results.system_deflections import _2507, _2557
...
class SystemDeflection(_7256.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2507.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2507.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults is not None else None

    @property
    def analysis_options(self) -> '_2557.SystemDeflectionOptions':
        ...
        return constructor.new(_2557.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions is not None else None
