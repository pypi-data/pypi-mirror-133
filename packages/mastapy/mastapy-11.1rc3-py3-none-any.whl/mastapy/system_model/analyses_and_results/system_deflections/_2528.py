...
class RollingRingConnectionSystemDeflection(_2497.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3855.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3855.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
