...
from mastapy.system_model.analyses_and_results.system_deflections import _2495, _2493, _2425
...
class HypoidGearSetSystemDeflection(_2425.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3825.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3825.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2495.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2495.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2493.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2493.HypoidGearMeshSystemDeflection))
        return value
