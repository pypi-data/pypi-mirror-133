...
from mastapy.system_model.analyses_and_results.system_deflections import _2441, _2552
...
class SynchroniserHalfSystemDeflection(_2552.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3876.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3876.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
