...
class ShaftToMountableComponentConnectionSystemDeflection(_2423.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''ShaftToMountableComponentConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3860.ShaftToMountableComponentConnectionPowerFlow':
