...
class ConceptCouplingSystemDeflection(_2461.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3788.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
