...
class BevelDifferentialSunGearSystemDeflection(_2433.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3775.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3775.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
