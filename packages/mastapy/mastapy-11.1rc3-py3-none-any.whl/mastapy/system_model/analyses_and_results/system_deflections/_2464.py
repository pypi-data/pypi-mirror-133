...
class CVTSystemDeflection(_2430.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3801.CVTPowerFlow':
        ...
        return constructor.new(_3801.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
