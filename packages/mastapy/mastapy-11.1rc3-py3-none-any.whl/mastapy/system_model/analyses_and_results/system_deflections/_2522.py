...
from mastapy.system_model.analyses_and_results.power_flows import _3850
from mastapy.system_model.analyses_and_results.system_deflections import _2563, _2565
...
class PowerLoadSystemDeflection(_2565.VirtualComponentSystemDeflection):
    '''PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3850.PowerLoadPowerFlow':
        ...
        return constructor.new(_3850.PowerLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2563.TransmissionErrorResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_2563.TransmissionErrorResult))
        return value
