...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2478, _2475, _2476, _2477,
    _2480, _2469, _2470, _2471
)
...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_2478.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2478.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_2478.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2478.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def flanks(self) -> 'List[_2478.CylindricalMeshedGearFlankSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_2478.CylindricalMeshedGearFlankSystemDeflection))
        return value

    @property
    def tension_side_fillet_results(self) -> 'List[_800.GearRootFilletStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TensionSideFilletResults, constructor.new(_800.GearRootFilletStressResults))
        return value

    @property
    def compression_side_fillet_results(self) -> 'List[_800.GearRootFilletStressResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CompressionSideFilletResults, constructor.new(_800.GearRootFilletStressResults))
        return value

    @property
    def cylindrical_gear_system_deflection(self) -> '_2475.CylindricalGearSystemDeflection':
        ...
        if _2475.CylindricalGearSystemDeflection.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2476.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2476.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2477.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2477.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_system_deflection_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2480.CylindricalPlanetGearSystemDeflection':
        ...
        if _2480.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.CylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection(self) -> '_2475.CylindricalGearSystemDeflection':
        ...
        if _2475.CylindricalGearSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2476.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2476.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2477.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2477.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_system_deflection_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2480.CylindricalPlanetGearSystemDeflection':
        ...
        if _2480.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection(self) -> '_2469.CylindricalGearMeshSystemDeflection':
        ...
        if _2469.CylindricalGearMeshSystemDeflection.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_of_type_cylindrical_gear_mesh_system_deflection_timestep(self) -> '_2470.CylindricalGearMeshSystemDeflectionTimestep':
        ...
        if _2470.CylindricalGearMeshSystemDeflectionTimestep.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_of_type_cylindrical_gear_mesh_system_deflection_with_ltca_results(self) -> '_2471.CylindricalGearMeshSystemDeflectionWithLTCAResults':
        ...
        if _2471.CylindricalGearMeshSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.CylindricalGearMeshSystemDeflection.__class__.__mro__:
    ...
    @property
    def both_flanks(self) -> '_2478.CylindricalMeshedGearFlankSystemDeflection':
        ...
        return constructor.new(_2478.CylindricalMeshedGearFlankSystemDeflection)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None
