...
class ConceptCouplingHalfSystemDeflection(_2460.CouplingHalfSystemDeflection):
    '''ConceptCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.ConceptCouplingHalfPowerFlow':
        ...
        return constructor.new(_3787.ConceptCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
