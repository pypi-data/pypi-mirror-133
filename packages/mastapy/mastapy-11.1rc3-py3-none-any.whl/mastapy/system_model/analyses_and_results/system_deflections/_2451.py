...
from mastapy.system_model.analyses_and_results.system_deflections import _2452, _2450, _2490
...
class ConceptGearSetSystemDeflection(_2490.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3791.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2452.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2452.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2450.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2450.ConceptGearMeshSystemDeflection))
        return value
