...
from mastapy.system_model.analyses_and_results.power_flows import _3784, _3804
...
class CoaxialConnectionSystemDeflection(_2535.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3784.CoaxialConnectionPowerFlow':
