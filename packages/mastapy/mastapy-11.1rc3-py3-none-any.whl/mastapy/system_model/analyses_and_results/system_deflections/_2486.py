...
class FaceGearSystemDeflection(_2491.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3815.FaceGearPowerFlow':
        ...
        return constructor.new(_3815.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
