...
from mastapy.system_model.analyses_and_results.power_flows import _3772, _3774, _3775
...
class BevelDifferentialGearSystemDeflection(_2438.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3772.BevelDifferentialGearPowerFlow':
