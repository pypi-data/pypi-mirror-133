...
from mastapy.system_model.analyses_and_results.system_deflections import _2486, _2484, _2490
...
class FaceGearSetSystemDeflection(_2490.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3816.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3816.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2486.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2486.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2484.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2484.FaceGearMeshSystemDeflection))
        return value
