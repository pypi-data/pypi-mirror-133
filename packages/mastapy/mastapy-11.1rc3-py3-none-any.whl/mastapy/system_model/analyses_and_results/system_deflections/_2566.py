...
class WormGearMeshSystemDeflection(_2489.GearMeshSystemDeflection):
    '''WormGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3887.WormGearMeshPowerFlow':
        ...
        return constructor.new(_3887.WormGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
