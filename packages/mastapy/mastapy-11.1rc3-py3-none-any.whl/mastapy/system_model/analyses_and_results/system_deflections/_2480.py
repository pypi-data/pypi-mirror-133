...
class CylindricalPlanetGearSystemDeflection(_2477.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3811.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3811.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
