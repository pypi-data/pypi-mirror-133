...
class RollingRingSystemDeflection(_2460.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3856.RollingRingPowerFlow':
        ...
        return constructor.new(_3856.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
