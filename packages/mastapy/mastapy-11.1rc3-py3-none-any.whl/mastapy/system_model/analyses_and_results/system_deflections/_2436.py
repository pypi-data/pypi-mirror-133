...
class BevelGearMeshSystemDeflection(_2424.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3776.BevelGearMeshPowerFlow':
