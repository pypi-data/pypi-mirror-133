...
class CouplingConnectionSystemDeflection(_2497.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3797.CouplingConnectionPowerFlow':
