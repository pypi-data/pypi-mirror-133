...
from mastapy.system_model.analyses_and_results.power_flows import _3877, _3876, _3879
...
class SynchroniserPartSystemDeflection(_2460.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3877.SynchroniserPartPowerFlow':
        ...
        if _3877.SynchroniserPartPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_synchroniser_half_power_flow(self) -> '_3876.SynchroniserHalfPowerFlow':
        ...
        if _3876.SynchroniserHalfPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_synchroniser_sleeve_power_flow(self) -> '_3879.SynchroniserSleevePowerFlow':
        ...
        if _3879.SynchroniserSleevePowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
