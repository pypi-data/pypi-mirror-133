...
from mastapy.system_model.analyses_and_results.power_flows import _3869, _3874, _3875
...
class StraightBevelDiffGearSystemDeflection(_2438.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3869.StraightBevelDiffGearPowerFlow':
