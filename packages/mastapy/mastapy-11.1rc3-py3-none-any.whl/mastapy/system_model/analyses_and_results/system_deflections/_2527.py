...
class RollingRingAssemblySystemDeflection(_2536.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3854.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3854.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
