...
class UnbalancedMassParametricStudyTool(_4162.VirtualComponentParametricStudyTool):
    '''UnbalancedMassParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2564.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2564.UnbalancedMassSystemDeflection))
        return value
