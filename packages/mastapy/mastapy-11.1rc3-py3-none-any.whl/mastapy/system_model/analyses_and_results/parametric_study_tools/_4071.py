...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4070, _4069, _4089
...
class CylindricalGearSetParametricStudyTool(_4089.GearSetParametricStudyTool):
    '''CylindricalGearSetParametricStudyTool
    ...
    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4069.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesParametricStudyTool, constructor.new(_4069.CylindricalGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2472.CylindricalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2472.CylindricalGearSetSystemDeflection))
        return value
