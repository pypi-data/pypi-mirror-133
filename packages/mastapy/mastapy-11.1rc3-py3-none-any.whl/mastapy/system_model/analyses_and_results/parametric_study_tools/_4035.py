...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4034, _4033, _4040
...
class BevelDifferentialGearSetParametricStudyTool(_4040.BevelGearSetParametricStudyTool):
    '''BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4034.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsParametricStudyTool, constructor.new(_4034.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4033.BevelDifferentialGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesParametricStudyTool, constructor.new(_4033.BevelDifferentialGearMeshParametricStudyTool))
        return value
