...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4052, _4051, _4089
...
class ConceptGearSetParametricStudyTool(_4089.GearSetParametricStudyTool):
    '''ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4052.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsParametricStudyTool, constructor.new(_4052.ConceptGearParametricStudyTool))
        return value

    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4051.ConceptGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesParametricStudyTool, constructor.new(_4051.ConceptGearMeshParametricStudyTool))
        return value
