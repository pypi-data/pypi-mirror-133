...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4092, _4091, _4028
...
class HypoidGearSetParametricStudyTool(_4028.AGMAGleasonConicalGearSetParametricStudyTool):
    '''HypoidGearSetParametricStudyTool
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_4092.HypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsParametricStudyTool, constructor.new(_4092.HypoidGearParametricStudyTool))
        return value

    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_4091.HypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesParametricStudyTool, constructor.new(_4091.HypoidGearMeshParametricStudyTool))
        return value
