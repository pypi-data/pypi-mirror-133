...
class PointLoadParametricStudyTool(_4162.VirtualComponentParametricStudyTool):
    '''PointLoadParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2521.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2521.PointLoadSystemDeflection))
        return value
