...
class KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool(_4201.ConicalGearCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4096.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4096.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4096.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4096.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value
