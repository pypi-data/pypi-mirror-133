...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4128
...
class PulleyCompoundParametricStudyTool(_4208.CouplingHalfCompoundParametricStudyTool):
    '''PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4128.PulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4128.PulleyParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4128.PulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4128.PulleyParametricStudyTool))
        return value
