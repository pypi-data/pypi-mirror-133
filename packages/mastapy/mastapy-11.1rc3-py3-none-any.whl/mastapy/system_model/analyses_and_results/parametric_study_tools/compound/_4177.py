...
class BearingCompoundParametricStudyTool(_4205.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1697.LoadedBearingDutyCycle':
        ...
        if _1697.LoadedBearingDutyCycle.TYPE not in self.wrapped.BearingDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4030.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4030.BearingParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4030.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4030.BearingParametricStudyTool))
        return value
