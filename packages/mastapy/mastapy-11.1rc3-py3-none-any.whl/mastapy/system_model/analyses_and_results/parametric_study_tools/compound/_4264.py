...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4136
...
class ShaftCompoundParametricStudyTool(_4170.AbstractShaftCompoundParametricStudyTool):
    '''ShaftCompoundParametricStudyTool
    ...
    def shaft_duty_cycle_results(self) -> '_19.ShaftDamageResults':
        ...
        return constructor.new(_19.ShaftDamageResults)(self.wrapped.ShaftDutyCycleResults) if self.wrapped.ShaftDutyCycleResults is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4136.ShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4136.ShaftParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4136.ShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4136.ShaftParametricStudyTool))
        return value
