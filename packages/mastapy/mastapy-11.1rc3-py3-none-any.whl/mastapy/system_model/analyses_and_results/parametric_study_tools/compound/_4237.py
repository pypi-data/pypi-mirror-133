...
class KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool(_4203.ConicalGearSetCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4097.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4097.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4097.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4097.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool))
        return value
