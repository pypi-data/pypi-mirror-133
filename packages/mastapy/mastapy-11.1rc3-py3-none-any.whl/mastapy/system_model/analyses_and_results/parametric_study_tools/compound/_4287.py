...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4157
...
class TorqueConverterConnectionCompoundParametricStudyTool(_4207.CouplingConnectionCompoundParametricStudyTool):
    '''TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4157.TorqueConverterConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4157.TorqueConverterConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4157.TorqueConverterConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4157.TorqueConverterConnectionParametricStudyTool))
        return value
