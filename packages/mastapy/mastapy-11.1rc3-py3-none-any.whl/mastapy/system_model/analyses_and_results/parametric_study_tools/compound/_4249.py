...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4122
...
class PartToPartShearCouplingCompoundParametricStudyTool(_4206.CouplingCompoundParametricStudyTool):
    '''PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4122.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4122.PartToPartShearCouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4122.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4122.PartToPartShearCouplingParametricStudyTool))
        return value
