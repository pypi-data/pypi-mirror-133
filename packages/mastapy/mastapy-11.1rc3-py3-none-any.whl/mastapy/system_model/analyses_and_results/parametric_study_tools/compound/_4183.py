...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4180
...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4180.BevelDifferentialGearCompoundParametricStudyTool):
    '''BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4036.BevelDifferentialPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4036.BevelDifferentialPlanetGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4036.BevelDifferentialPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4036.BevelDifferentialPlanetGearParametricStudyTool))
        return value
