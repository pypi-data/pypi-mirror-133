...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4146, _4145, _4040
...
class StraightBevelDiffGearSetParametricStudyTool(_4040.BevelGearSetParametricStudyTool):
    '''StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4146.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsParametricStudyTool, constructor.new(_4146.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4145.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesParametricStudyTool, constructor.new(_4145.StraightBevelDiffGearMeshParametricStudyTool))
        return value
