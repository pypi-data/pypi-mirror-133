...
class MassDiscParametricStudyTool(_4162.VirtualComponentParametricStudyTool):
    '''MassDiscParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2509.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2509.MassDiscSystemDeflection))
        return value
