...
from mastapy.system_model.analyses_and_results.static_loads import _6527, _6640
from mastapy.system_model import _1950, _1946
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4117, _4118
from mastapy.system_model.analyses_and_results import _2383
from mastapy.math_utility.convergence import _1367
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6640.ParametricStudyType':
        ...
        return constructor.new(_6640.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6640.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1950.ExternalFullFELoader':
        ...
        return constructor.new(_1950.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader is not None else None

    @property
    def step_results(self) -> 'List[_4117.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4117.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4118.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4118.ParametricStudyVariable))
        return value

    @property
    def parametric_study_logging_variables(self) -> 'List[_2383.AnalysisCaseVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParametricStudyLoggingVariables, constructor.new(_2383.AnalysisCaseVariable))
        return value
    ...
    def data_logger_for(self, design_entity: '_1946.DesignEntity') -> '_1367.DataLogger':
    ...
    def add_study_variable(self, design_entity: '_1946.DesignEntity', path: 'List[str]') -> '_4118.ParametricStudyVariable':
    ...
    def remove_study_variable(self, study_variable: '_4118.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4118.ParametricStudyVariable'):
    ...
    def move_study_variable_down(self, study_variable: '_4118.ParametricStudyVariable'):
    ...
    def add_logging_variable(self, design_entity: '_1946.DesignEntity', path: 'List[str]') -> '_2383.AnalysisCaseVariable':
    ...
    def remove_logging_variable(self, analysis_variable: '_2383.AnalysisCaseVariable'):
