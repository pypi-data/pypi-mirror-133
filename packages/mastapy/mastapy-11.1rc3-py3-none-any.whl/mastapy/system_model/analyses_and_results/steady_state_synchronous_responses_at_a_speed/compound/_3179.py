...
class MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3127.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3049.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3049.MountableComponentSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3049.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3049.MountableComponentSteadyStateSynchronousResponseAtASpeed))
        return value
