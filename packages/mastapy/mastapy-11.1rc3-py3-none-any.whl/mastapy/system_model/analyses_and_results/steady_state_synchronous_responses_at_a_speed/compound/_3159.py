...
class FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3200.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3029.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3029.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3029.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3029.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed))
        return value
