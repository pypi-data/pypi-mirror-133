...
from mastapy.system_model.fe import _2102
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2102.BearingRacePosition':
        ...
        return constructor.new(_2102.BearingRacePosition)(value) if value is not None else None
