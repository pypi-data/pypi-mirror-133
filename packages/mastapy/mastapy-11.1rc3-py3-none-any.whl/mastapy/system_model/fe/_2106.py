...
from mastapy.system_model import _1947
...
class CreateConnectedComponentOptions(_0.APIBase):
    ...
    def component_type(self) -> 'enum_with_selected_value.EnumWithSelectedValue_DesignEntityId':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ComponentType, value) if self.wrapped.ComponentType is not None else None
