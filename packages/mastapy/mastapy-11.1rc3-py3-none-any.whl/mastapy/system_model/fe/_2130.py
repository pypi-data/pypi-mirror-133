...
from mastapy.utility.enums import _1585
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.nodal_analysis.component_mode_synthesis import _207
from mastapy.nodal_analysis.dev_tools_analyses import _165
from mastapy.system_model.fe import _2136, _2126
...
class FESubstructureWithSelectionForStaticAnalysis(_2126.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    def contour_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThreeDViewContourOption':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ContourOption, value) if self.wrapped.ContourOption is not None else None
    ...
    @property
    def static_draw_style(self) -> '_165.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_165.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle is not None else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2136.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2136.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2136.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2136.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1358.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1358.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1358.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1358.VectorWithLinearAndAngularComponents))
        return value
