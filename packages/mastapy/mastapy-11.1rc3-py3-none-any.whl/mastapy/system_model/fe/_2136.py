...
from mastapy.system_model.fe import _2109, _2108
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2109.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_2109.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_2108.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_2108.DegreeOfFreedomBoundaryConditionAngular))
        return value
