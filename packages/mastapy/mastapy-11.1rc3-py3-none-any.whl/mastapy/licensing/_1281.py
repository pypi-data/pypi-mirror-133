...
from mastapy.licensing import _7283, _7284, _7285
...
class LicenceServer:
    ...
    def server_address(cls, value: 'str'):
        LicenceServer.TYPE.ServerAddress = str(value) if value else ''
    ...
    @staticmethod
    def update_server_settings(server_details: '_7283.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7283.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7284.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetLicensedModuleDetails(), constructor.new(_7284.ModuleDetails))

    @staticmethod
    def get_available_module_details() -> 'Iterable[_7284.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetAvailableModuleDetails(), constructor.new(_7284.ModuleDetails))

    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7285.ModuleLicenceStatus]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetRequestedModuleStatuses(), constructor.new(_7285.ModuleLicenceStatus))
