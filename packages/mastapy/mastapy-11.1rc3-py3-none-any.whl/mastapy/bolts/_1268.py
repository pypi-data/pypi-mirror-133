...
class ClampedSection(_0.APIBase):
    ...
    def edit_material(self, value: 'str'):
        self.wrapped.EditMaterial.SetSelectedItem(str(value) if value else '')

    @property
    def material(self) -> '_1259.BoltedJointMaterial':
        ...
        if _1259.BoltedJointMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
