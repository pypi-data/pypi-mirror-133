...
from mastapy.bolts import _1278, _1259
...
class BoltMaterial(_1259.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1278.StrengthGrades':
        ...
        return constructor.new(_1278.StrengthGrades)(value) if value is not None else None

    @strength_grade.setter
    def strength_grade(self, value: '_1278.StrengthGrades'):
