...
from mastapy.utility_gui.charts import _1616
...
class ThreeDChartDefinition(_1616.NDChartDefinition):
    '''ThreeDChartDefinition
    ...
    @property
    def x_axis_range(self) -> '_1282.Range':
        '''Range: 'XAxisRange' is the original name of this property.'''

        if _1282.Range.TYPE not in self.wrapped.XAxisRange.__class__.__mro__:
    ...
    @x_axis_range.setter
    def x_axis_range(self, value: '_1282.Range'):
        value = value.wrapped if value else None
        self.wrapped.XAxisRange = value

    @property
    def y_axis_range(self) -> '_1282.Range':
        '''Range: 'YAxisRange' is the original name of this property.'''

        if _1282.Range.TYPE not in self.wrapped.YAxisRange.__class__.__mro__:
    ...
    @y_axis_range.setter
    def y_axis_range(self, value: '_1282.Range'):
        value = value.wrapped if value else None
        self.wrapped.YAxisRange = value

    @property
    def z_axis_range(self) -> '_1282.Range':
        '''Range: 'ZAxisRange' is the original name of this property.'''

        if _1282.Range.TYPE not in self.wrapped.ZAxisRange.__class__.__mro__:
    ...
    @z_axis_range.setter
    def z_axis_range(self, value: '_1282.Range'):
        value = value.wrapped if value else None
