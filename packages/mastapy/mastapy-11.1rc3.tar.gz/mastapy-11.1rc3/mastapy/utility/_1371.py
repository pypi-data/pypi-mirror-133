...
from mastapy.utility import _1381, _1370
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1381.NumberFormatInfoSummary':
        ...
        return constructor.new(_1381.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture is not None else None

    @property
    def dispatchers(self) -> 'List[_1370.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1370.DispatcherHelper))
        return value
