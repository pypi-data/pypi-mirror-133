...
from mastapy.utility.modal_analysis.gears import _1565, _1568, _1570
...
class GearOrderForTE(_1570.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1565.GearPositions':
        ...
        return constructor.new(_1565.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1568.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1568.OrderForTE))
        return value
