...
from mastapy.utility.modal_analysis.gears import _1564, _1568
...
class GearMeshForTE(_1568.OrderForTE):
    '''GearMeshForTE
    ...
    def number_of_teeth(self, value: 'str'):
        self.wrapped.NumberOfTeeth = str(value) if value else ''

    @property
    def attached_gears(self) -> 'List[_1564.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1564.GearOrderForTE))
        return value
