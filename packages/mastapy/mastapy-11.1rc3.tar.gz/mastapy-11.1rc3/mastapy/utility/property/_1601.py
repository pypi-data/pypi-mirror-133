...
from mastapy.utility.units_and_measurements.measurements import _1424
...
class DutyCyclePropertySummaryForce(_1600.DutyCyclePropertySummary['_1424.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
