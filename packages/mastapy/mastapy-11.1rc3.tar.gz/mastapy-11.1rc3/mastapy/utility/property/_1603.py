...
from mastapy.utility.units_and_measurements.measurements import _1403
...
class DutyCyclePropertySummarySmallAngle(_1600.DutyCyclePropertySummary['_1403.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
