...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1176
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _189
...
class ElementPropertiesShell(_189.ElementPropertiesWithMaterial):
    '''ElementPropertiesShell
    ...
    @property
    def wall_type(self) -> '_1176.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1176.ElementPropertiesShellWallType)(value) if value is not None else None
