...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1173
...
class ElementPropertiesBeam(_189.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_1173.BeamSectionType':
        ...
        return constructor.new(_1173.BeamSectionType)(value) if value is not None else None
