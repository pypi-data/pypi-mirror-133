...
from mastapy.detailed_rigid_connectors.splines.ratings import _1226
...
class SplineJointRating(_1231.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1226.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1226.SplineHalfRating))
        return value
