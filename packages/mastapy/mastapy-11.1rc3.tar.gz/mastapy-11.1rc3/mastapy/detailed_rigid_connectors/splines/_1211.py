...
from mastapy.detailed_rigid_connectors.splines import _1193
...
class SplineMaterial(_239.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1193.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1193.HeatTreatmentTypes'):
