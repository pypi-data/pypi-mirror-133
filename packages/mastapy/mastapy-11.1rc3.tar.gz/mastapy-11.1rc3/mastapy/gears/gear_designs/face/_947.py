...
class FaceGearSetDesign(_902.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_946.FaceGearPinionDesign':
        ...
        return constructor.new(_946.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion is not None else None

    @property
    def face_gear(self) -> '_949.FaceGearWheelDesign':
        ...
        return constructor.new(_949.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear is not None else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_948.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_948.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry is not None else None

    @property
    def gears(self) -> 'List[_941.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_941.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_941.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_941.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_943.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_943.FaceGearMeshDesign))
        return value
