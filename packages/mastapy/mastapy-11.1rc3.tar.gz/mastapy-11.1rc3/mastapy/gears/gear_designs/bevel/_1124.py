...
from mastapy.gears.gear_designs.conical import _1093
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.math_utility import _1313
from mastapy._internal.implicit import overridable, enum_with_selected_value
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.gear_designs.bevel import _1132, _1133, _1131
...
class BevelGearSetDesign(_1137.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1093.BacklashDistributionRule':
        ...
        return constructor.new(_1093.BacklashDistributionRule)(value) if value is not None else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1093.BacklashDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1313.MaxMinMean':
        ...
        return constructor.new(_1313.MaxMinMean)(value) if value is not None else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1313.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def ideal_circular_thickness_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.IdealCircularThicknessFactor) if self.wrapped.IdealCircularThicknessFactor is not None else None
    ...
    def tooth_thickness_specification_method(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ToothThicknessSpecificationMethod':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ToothThicknessSpecificationMethod, value) if self.wrapped.ToothThicknessSpecificationMethod is not None else None
    ...
    @property
    def round_cutter_specifications(self) -> '_1133.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1133.WheelFinishCutterPointWidthRestrictionMethod)(value) if value is not None else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1133.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_taper_root_line_tilt_method(self) -> '_313.SpiralBevelRootLineTilt':
        ...
        return constructor.new(_313.SpiralBevelRootLineTilt)(value) if value is not None else None

    @tooth_taper_root_line_tilt_method.setter
    def tooth_taper_root_line_tilt_method(self, value: '_313.SpiralBevelRootLineTilt'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1131.ToothProportionsInputMethod':
        ...
        return constructor.new(_1131.ToothProportionsInputMethod)(value) if value is not None else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1131.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
