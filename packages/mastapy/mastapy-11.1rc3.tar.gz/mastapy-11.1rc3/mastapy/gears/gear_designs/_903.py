...
from mastapy.gears.gear_designs import _898
...
class SelectedDesignConstraintsCollection(_1382.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_898.DesignConstraintsCollection':
        ...
        return constructor.new(_898.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints is not None else None
