...
class MeshAlignment(_0.APIBase):
    ...
    @property
    def gear_a_alignment(self) -> '_1057.GearAlignment':
        ...
        return constructor.new(_1057.GearAlignment)(self.wrapped.GearAAlignment) if self.wrapped.GearAAlignment is not None else None

    @property
    def gear_b_alignment(self) -> '_1057.GearAlignment':
        ...
        return constructor.new(_1057.GearAlignment)(self.wrapped.GearBAlignment) if self.wrapped.GearBAlignment is not None else None
