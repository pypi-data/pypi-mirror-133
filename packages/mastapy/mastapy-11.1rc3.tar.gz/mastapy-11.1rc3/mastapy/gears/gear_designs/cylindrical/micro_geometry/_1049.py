...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_1062.MeasuredMapDataTypes':
        ...
        return constructor.new(_1062.MeasuredMapDataTypes)(value) if value is not None else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_1062.MeasuredMapDataTypes'):
