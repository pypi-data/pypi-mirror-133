...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    def basic_rack_dedendum_factor(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.BasicRackDedendumFactor) if self.wrapped.BasicRackDedendumFactor is not None else None
    ...
    @property
    def gear(self) -> '_964.CylindricalGearDesign':
        ...
        if _964.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Gear.__class__)(self.wrapped.Gear) if self.wrapped.Gear is not None else None

    @property
    def shaper_for_agma_rating(self) -> '_687.CylindricalGearShaper':
        ...
        return constructor.new(_687.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating is not None else None

    @property
    def left_flank(self) -> '_959.CylindricalGearAbstractRackFlank':
        ...
        if _959.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.LeftFlank.__class__)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_961.CylindricalGearBasicRackFlank':
        ...
        if _961.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_975.CylindricalGearPinionTypeCutterFlank':
        ...
        if _975.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1026.StandardRackFlank':
        ...
        if _1026.StandardRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_959.CylindricalGearAbstractRackFlank':
        ...
        if _959.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.RightFlank.__class__)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_961.CylindricalGearBasicRackFlank':
        ...
        if _961.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_975.CylindricalGearPinionTypeCutterFlank':
        ...
        if _975.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1026.StandardRackFlank':
        ...
        if _1026.StandardRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_959.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_959.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_959.CylindricalGearAbstractRackFlank':
        ...
        if _959.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.BothFlanks.__class__)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks is not None else None

    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_961.CylindricalGearBasicRackFlank':
        ...
        if _961.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_975.CylindricalGearPinionTypeCutterFlank':
        ...
        if _975.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1026.StandardRackFlank':
        ...
        if _1026.StandardRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
