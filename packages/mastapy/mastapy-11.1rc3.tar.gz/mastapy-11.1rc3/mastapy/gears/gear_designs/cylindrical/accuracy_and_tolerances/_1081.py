...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1080
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_1080.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
