...
from mastapy.gears.gear_designs.cylindrical import _975, _958
...
class CylindricalGearPinionTypeCutter(_958.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    def profile_shift_coefficient(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.ProfileShiftCoefficient) if self.wrapped.ProfileShiftCoefficient is not None else None
    ...
    @property
    def left_flank(self) -> '_975.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_975.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None

    @property
    def right_flank(self) -> '_975.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_975.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None
