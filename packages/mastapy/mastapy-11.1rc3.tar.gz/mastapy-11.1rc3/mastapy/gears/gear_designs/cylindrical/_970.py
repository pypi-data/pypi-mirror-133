...
class CylindricalGearFlankDesign(_0.APIBase):
    ...
    @property
    def tip_form(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm is not None else None

    @property
    def root_form(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm is not None else None

    @property
    def tip_diameter_reporting(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting is not None else None

    @property
    def root_diameter_reporting(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting is not None else None

    @property
    def lowest_point_of_fewest_tooth_contacts(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LowestPointOfFewestToothContacts) if self.wrapped.LowestPointOfFewestToothContacts is not None else None

    @property
    def highest_point_of_fewest_tooth_contacts(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.HighestPointOfFewestToothContacts) if self.wrapped.HighestPointOfFewestToothContacts is not None else None

    @property
    def lowest_start_of_active_profile(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile is not None else None
