...
from mastapy.gears.gear_designs.cylindrical import _974, _959
...
class CylindricalGearPinionTypeCutterFlank(_959.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_974.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_974.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter is not None else None
