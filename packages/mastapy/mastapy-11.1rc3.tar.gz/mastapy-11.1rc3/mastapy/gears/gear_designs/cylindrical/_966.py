...
class CylindricalGearDesignConstraints(_1592.NamedDatabaseItem):
    '''CylindricalGearDesignConstraints
    ...
    @property
    def design_constraints(self) -> 'List[_965.CylindricalGearDesignConstraint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_965.CylindricalGearDesignConstraint))
        return value
