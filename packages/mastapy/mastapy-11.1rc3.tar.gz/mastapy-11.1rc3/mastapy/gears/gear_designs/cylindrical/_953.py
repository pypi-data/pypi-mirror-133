...
from mastapy.gears.gear_designs.cylindrical import _1002, _1003
...
class CaseHardeningProperties(_0.APIBase):
    ...
    @property
    def hardness_profile_calculation_method(self) -> '_1002.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_1002.HardnessProfileCalculationMethod)(value) if value is not None else None

    @hardness_profile_calculation_method.setter
    def hardness_profile_calculation_method(self, value: '_1002.HardnessProfileCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HardnessProfileCalculationMethod = value

    @property
    def heat_treatment_type(self) -> '_1003.HeatTreatmentType':
        ...
        return constructor.new(_1003.HeatTreatmentType)(value) if value is not None else None
