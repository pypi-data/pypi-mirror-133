...
class CylindricalGearMeshMicroGeometryDutyCycle(_1161.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_812.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_812.CylindricalGearMeshLoadDistributionAnalysis))
        return value
