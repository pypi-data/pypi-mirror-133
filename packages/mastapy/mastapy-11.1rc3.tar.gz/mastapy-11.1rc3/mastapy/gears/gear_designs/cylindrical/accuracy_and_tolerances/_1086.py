...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1081
...
class ISO1328AccuracyGraderCommon(_1081.CylindricalAccuracyGraderWithProfileFormAndSlope):
    '''ISO1328AccuracyGraderCommon
