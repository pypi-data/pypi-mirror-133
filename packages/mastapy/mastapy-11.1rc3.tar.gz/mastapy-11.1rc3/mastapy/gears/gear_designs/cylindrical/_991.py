...
from mastapy.gears.gear_designs.cylindrical import _1015, _1014, _964
...
class CylindricalPlanetGearDesign(_964.CylindricalGearDesign):
    '''CylindricalPlanetGearDesign
    ...
    @property
    def planetary_details(self) -> '_306.PlanetaryDetail':
        ...
        return constructor.new(_306.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails is not None else None

    @property
    def planetary_sidebands_amplitude_factors(self) -> 'List[_1015.NamedPlanetSideBandAmplitudeFactor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySidebandsAmplitudeFactors, constructor.new(_1015.NamedPlanetSideBandAmplitudeFactor))
        return value

    @property
    def planet_assembly_indices(self) -> 'List[_1014.NamedPlanetAssemblyIndex]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetAssemblyIndices, constructor.new(_1014.NamedPlanetAssemblyIndex))
        return value
