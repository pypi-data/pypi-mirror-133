...
from mastapy.gears.gear_designs.cylindrical import _1032, _951
...
class CylindricalMeshLinearBacklashSpecification(_1032.TolerancedValueSpecification['_951.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
