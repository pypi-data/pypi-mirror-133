...
from mastapy.gears.fe_model import _1142
from mastapy.gears.fe_model.cylindrical import _1145
from mastapy._internal.cast_exception import CastException
from mastapy.gears.fe_model.conical import _1148
from mastapy.gears.gear_designs import _899, _900
...
class GearSetDesign(_900.GearDesignComponent):
    '''GearSetDesign
    ...
    def fe_model(self, value: 'str'):
        self.wrapped.FEModel.SetSelectedItem(str(value) if value else '')
    ...
    @property
    def transmission_properties_gears(self) -> '_294.GearSetDesignGroup':
        ...
        return constructor.new(_294.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears is not None else None

    @property
    def active_ltcafe_model(self) -> '_1142.GearSetFEModel':
        ...
        if _1142.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ActiveLTCAFEModel.__class__)(self.wrapped.ActiveLTCAFEModel) if self.wrapped.ActiveLTCAFEModel is not None else None

    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1145.CylindricalGearSetFEModel':
        ...
        if _1145.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1148.ConicalSetFEModel':
        ...
        if _1148.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1142.GearSetFEModel':
        ...
        if _1142.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.TIFFFEModel.__class__)(self.wrapped.TIFFFEModel) if self.wrapped.TIFFFEModel is not None else None

    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1145.CylindricalGearSetFEModel':
        ...
        if _1145.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1148.ConicalSetFEModel':
        ...
        if _1148.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def gears(self) -> 'List[_899.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_899.GearDesign))
        return value

    @property
    def ltcafe_models(self) -> 'List[_1142.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_1142.GearSetFEModel))
        return value
