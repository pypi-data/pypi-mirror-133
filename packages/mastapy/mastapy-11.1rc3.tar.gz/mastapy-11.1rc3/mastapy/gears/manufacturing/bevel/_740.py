...
from mastapy.gears.manufacturing.bevel import _749, _742
...
class ConicalMeshManufacturingConfig(_742.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_749.ConicalWheelManufacturingConfig':
        ...
        return constructor.new(_749.ConicalWheelManufacturingConfig)(self.wrapped.WheelConfig) if self.wrapped.WheelConfig is not None else None
