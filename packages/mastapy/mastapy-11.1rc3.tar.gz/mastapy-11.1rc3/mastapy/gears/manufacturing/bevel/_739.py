...
from mastapy.gears.manufacturing.bevel import _750, _734
...
class ConicalMeshManufacturingAnalysis(_1162.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_750.EaseOffBasedTCA':
        ...
        return constructor.new(_750.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA is not None else None

    @property
    def meshed_gears(self) -> 'List[_734.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_734.ConicalMeshedGearManufacturingAnalysis))
        return value
