...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    @property
    def calculated_deviations_convex(self) -> '_729.ConicalFlankDeviationsData':
        ...
        return constructor.new(_729.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConvex) if self.wrapped.CalculatedDeviationsConvex is not None else None

    @property
    def imported_deviations_convex(self) -> '_729.ConicalFlankDeviationsData':
        ...
        return constructor.new(_729.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConvex) if self.wrapped.ImportedDeviationsConvex is not None else None

    @property
    def calculated_deviations_concave(self) -> '_729.ConicalFlankDeviationsData':
        ...
        return constructor.new(_729.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConcave) if self.wrapped.CalculatedDeviationsConcave is not None else None

    @property
    def imported_deviations_concave(self) -> '_729.ConicalFlankDeviationsData':
        ...
        return constructor.new(_729.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConcave) if self.wrapped.ImportedDeviationsConcave is not None else None
