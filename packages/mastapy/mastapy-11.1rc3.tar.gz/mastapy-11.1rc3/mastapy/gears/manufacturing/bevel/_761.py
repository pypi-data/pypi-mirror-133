...
from mastapy.gears.gear_designs.conical import _1113
...
class PinionFinishMachineSettings(_286.ConicalGearToothSurface):
    '''PinionFinishMachineSettings
    ...
    @property
    def toprem_letter(self) -> '_1113.TopremLetter':
