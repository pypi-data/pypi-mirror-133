...
class ConicalGearMicroGeometryConfigBase(_1160.GearImplementationDetail):
    '''ConicalGearMicroGeometryConfigBase
    ...
    @property
    def flank_measurement_border(self) -> '_751.FlankMeasurementBorder':
        ...
        return constructor.new(_751.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder is not None else None
