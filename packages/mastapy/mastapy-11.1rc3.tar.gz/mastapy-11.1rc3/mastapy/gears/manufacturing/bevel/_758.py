...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _778
...
class PinionConcave(_0.APIBase):
    ...
    @property
    def pinion_concave_ob_configuration(self) -> '_778.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_778.BasicConicalGearMachineSettingsGenerated)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration is not None else None
