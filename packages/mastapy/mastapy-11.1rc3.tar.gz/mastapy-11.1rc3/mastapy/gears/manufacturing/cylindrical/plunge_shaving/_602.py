...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _603, _612
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_603.PlungeShaverCalculationInputs':
        ...
        return constructor.new(_603.PlungeShaverCalculationInputs)(self.wrapped.Inputs) if self.wrapped.Inputs is not None else None

    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_612.VirtualPlungeShaverOutputs':
        ...
        return constructor.new(_612.VirtualPlungeShaverOutputs)(self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear) if self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear is not None else None
