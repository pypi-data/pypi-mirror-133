...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_1035.ToothThicknessSpecificationBase':
        ...
        if _1035.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ToothThicknessSpecification.__class__)(self.wrapped.ToothThicknessSpecification) if self.wrapped.ToothThicknessSpecification is not None else None

    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_996.FinishToothThicknessDesignSpecification':
        ...
        if _996.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_readonly_tooth_thickness_specification(self) -> '_1016.ReadonlyToothThicknessSpecification':
        ...
        if _1016.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_1034.ToothThicknessSpecification':
        ...
        if _1034.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
