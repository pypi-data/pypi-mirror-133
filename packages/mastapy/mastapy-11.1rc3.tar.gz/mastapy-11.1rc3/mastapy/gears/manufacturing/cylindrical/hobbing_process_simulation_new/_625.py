...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _616, _621
...
class HobbingProcessPitchCalculation(_621.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
