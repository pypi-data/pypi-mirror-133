...
class CylindricalManufacturedGearSetDutyCycle(_1169.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalManufacturedGearSetDutyCycle
    ...
    @property
    def manufacturing_configuration(self) -> '_580.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_580.CylindricalSetManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration is not None else None
