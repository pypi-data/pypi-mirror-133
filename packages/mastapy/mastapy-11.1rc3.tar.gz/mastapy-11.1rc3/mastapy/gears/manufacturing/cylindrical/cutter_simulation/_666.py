...
class GearCutterSimulation(_0.APIBase):
    ...
    def cutter_simulation(self) -> 'GearCutterSimulation':
        ...
        return constructor.new_override(self.wrapped.CutterSimulation.__class__)(self.wrapped.CutterSimulation) if self.wrapped.CutterSimulation is not None else None

    @property
    def cutter_simulation_of_type_finish_cutter_simulation(self) -> '_663.FinishCutterSimulation':
        ...
        if _663.FinishCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def cutter_simulation_of_type_rough_cutter_simulation(self) -> '_671.RoughCutterSimulation':
        ...
        if _671.RoughCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def minimum_thickness(self) -> '_658.CutterSimulationCalc':
        ...
        if _658.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.MinimumThickness.__class__)(self.wrapped.MinimumThickness) if self.wrapped.MinimumThickness is not None else None

    @property
    def minimum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_665.FormWheelGrindingSimulationCalculator':
        ...
        if _665.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_hob_simulation_calculator(self) -> '_667.HobSimulationCalculator':
        ...
        if _667.HobSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_rack_simulation_calculator(self) -> '_670.RackSimulationCalculator':
        ...
        if _670.RackSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaper_simulation_calculator(self) -> '_672.ShaperSimulationCalculator':
        ...
        if _672.ShaperSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaving_simulation_calculator(self) -> '_673.ShavingSimulationCalculator':
        ...
        if _673.ShavingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_virtual_simulation_calculator(self) -> '_674.VirtualSimulationCalculator':
        ...
        if _674.VirtualSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_675.WormGrinderSimulationCalculator':
        ...
        if _675.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def average_thickness(self) -> '_658.CutterSimulationCalc':
        ...
        if _658.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.AverageThickness.__class__)(self.wrapped.AverageThickness) if self.wrapped.AverageThickness is not None else None

    @property
    def average_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_665.FormWheelGrindingSimulationCalculator':
        ...
        if _665.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_hob_simulation_calculator(self) -> '_667.HobSimulationCalculator':
        ...
        if _667.HobSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_rack_simulation_calculator(self) -> '_670.RackSimulationCalculator':
        ...
        if _670.RackSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaper_simulation_calculator(self) -> '_672.ShaperSimulationCalculator':
        ...
        if _672.ShaperSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaving_simulation_calculator(self) -> '_673.ShavingSimulationCalculator':
        ...
        if _673.ShavingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_virtual_simulation_calculator(self) -> '_674.VirtualSimulationCalculator':
        ...
        if _674.VirtualSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_675.WormGrinderSimulationCalculator':
        ...
        if _675.WormGrinderSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness(self) -> '_658.CutterSimulationCalc':
        ...
        if _658.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.MaximumThickness.__class__)(self.wrapped.MaximumThickness) if self.wrapped.MaximumThickness is not None else None

    @property
    def maximum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_665.FormWheelGrindingSimulationCalculator':
        ...
        if _665.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_hob_simulation_calculator(self) -> '_667.HobSimulationCalculator':
        ...
        if _667.HobSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_rack_simulation_calculator(self) -> '_670.RackSimulationCalculator':
        ...
        if _670.RackSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaper_simulation_calculator(self) -> '_672.ShaperSimulationCalculator':
        ...
        if _672.ShaperSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaving_simulation_calculator(self) -> '_673.ShavingSimulationCalculator':
        ...
        if _673.ShavingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_virtual_simulation_calculator(self) -> '_674.VirtualSimulationCalculator':
        ...
        if _674.VirtualSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_675.WormGrinderSimulationCalculator':
        ...
        if _675.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def smallest_active_profile(self) -> '_658.CutterSimulationCalc':
        ...
        if _658.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.SmallestActiveProfile.__class__)(self.wrapped.SmallestActiveProfile) if self.wrapped.SmallestActiveProfile is not None else None

    @property
    def smallest_active_profile_of_type_form_wheel_grinding_simulation_calculator(self) -> '_665.FormWheelGrindingSimulationCalculator':
        ...
        if _665.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_hob_simulation_calculator(self) -> '_667.HobSimulationCalculator':
        ...
        if _667.HobSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_rack_simulation_calculator(self) -> '_670.RackSimulationCalculator':
        ...
        if _670.RackSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaper_simulation_calculator(self) -> '_672.ShaperSimulationCalculator':
        ...
        if _672.ShaperSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaving_simulation_calculator(self) -> '_673.ShavingSimulationCalculator':
        ...
        if _673.ShavingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_virtual_simulation_calculator(self) -> '_674.VirtualSimulationCalculator':
        ...
        if _674.VirtualSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_worm_grinder_simulation_calculator(self) -> '_675.WormGrinderSimulationCalculator':
        ...
        if _675.WormGrinderSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def minimum_thickness_virtual(self) -> '_674.VirtualSimulationCalculator':
        ...
        return constructor.new(_674.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual is not None else None

    @property
    def average_thickness_virtual(self) -> '_674.VirtualSimulationCalculator':
        ...
        return constructor.new(_674.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual is not None else None

    @property
    def maximum_thickness_virtual(self) -> '_674.VirtualSimulationCalculator':
        ...
        return constructor.new(_674.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual is not None else None

    @property
    def thickness_calculators(self) -> 'List[_658.CutterSimulationCalc]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThicknessCalculators, constructor.new(_658.CutterSimulationCalc))
        return value

    @property
    def virtual_thickness_calculators(self) -> 'List[_674.VirtualSimulationCalculator]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VirtualThicknessCalculators, constructor.new(_674.VirtualSimulationCalculator))
        return value

    @property
    def gear_mesh_cutter_simulations(self) -> 'List[_661.CylindricalManufacturedRealGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulations, constructor.new(_661.CylindricalManufacturedRealGearInMesh))
        return value

    @property
    def gear_mesh_cutter_simulations_virtual(self) -> 'List[_662.CylindricalManufacturedVirtualGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulationsVirtual, constructor.new(_662.CylindricalManufacturedVirtualGearInMesh))
        return value
