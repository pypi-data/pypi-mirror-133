...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _617, _649
...
class WormGrindingProcessProfileCalculation(_649.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_617.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_617.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank is not None else None

    @property
    def left_flank(self) -> '_617.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_617.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank is not None else None
