...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _608
...
class WormGrindingCutterCalculation(_649.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.GrinderToothShapeChart.__class__.__mro__:
    ...
    @property
    def input_gear_point_of_interest(self) -> '_608.PointOfInterest':
        ...
        return constructor.new(_608.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest is not None else None
