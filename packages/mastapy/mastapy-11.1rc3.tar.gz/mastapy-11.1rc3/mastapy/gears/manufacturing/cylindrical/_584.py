...
from mastapy.gears.manufacturing.cylindrical import _583
...
class GearManufacturingConfigurationViewModelPlaceholder(_583.GearManufacturingConfigurationViewModel):
    '''GearManufacturingConfigurationViewModelPlaceholder
