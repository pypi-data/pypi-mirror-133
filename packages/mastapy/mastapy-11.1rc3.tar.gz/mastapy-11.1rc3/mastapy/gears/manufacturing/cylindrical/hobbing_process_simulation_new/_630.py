...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _621
...
class HobbingProcessTotalModificationCalculation(_621.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
