...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _617
...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_617.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_617.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation is not None else None

    @property
    def left_flank_accuracy_calculation(self) -> '_617.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_617.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation is not None else None
