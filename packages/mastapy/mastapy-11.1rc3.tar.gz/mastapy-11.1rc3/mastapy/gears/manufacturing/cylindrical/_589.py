...
from mastapy.gears.manufacturing.cylindrical import _588, _587
...
class MicroGeometryInputsLead(_588.MicroGeometryInputs['_587.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1282.Range':
        ...
        if _1282.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.LeadMicroGeometryRange.__class__)(self.wrapped.LeadMicroGeometryRange) if self.wrapped.LeadMicroGeometryRange is not None else None
