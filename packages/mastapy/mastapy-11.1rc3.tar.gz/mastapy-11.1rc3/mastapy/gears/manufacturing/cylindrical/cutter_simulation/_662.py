...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _674
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_674.VirtualSimulationCalculator':
        ...
        return constructor.new(_674.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear is not None else None
