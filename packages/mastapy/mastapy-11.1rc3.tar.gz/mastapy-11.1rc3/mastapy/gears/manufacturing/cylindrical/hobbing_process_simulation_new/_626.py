...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _617, _621
...
class HobbingProcessProfileCalculation(_621.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
