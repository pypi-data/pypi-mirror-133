...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _640, _627, _654
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_640.ProcessSimulationInput':
        ...
        if _640.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Inputs.__class__)(self.wrapped.Inputs) if self.wrapped.Inputs is not None else None

    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_627.HobbingProcessSimulationInput':
        ...
        if _627.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_654.WormGrindingProcessSimulationInput':
        ...
        if _654.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
