...
class WormGrindingProcessGearShape(_649.WormGrindingProcessCalculation):
    '''WormGrindingProcessGearShape
    ...
    @property
    def gear_tooth_shape_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.GearToothShapeChart.__class__.__mro__:
