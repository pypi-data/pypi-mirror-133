...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _717, _716, _720
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _659
from mastapy.gears.manufacturing.cylindrical.cutters import _688, _683
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    def life_cutter_tip_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.LifeCutterTipDiameter) if self.wrapped.LifeCutterTipDiameter is not None else None
    ...
    def new_cutter_tip_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.NewCutterTipDiameter) if self.wrapped.NewCutterTipDiameter is not None else None
    ...
    def life_cutter_normal_thickness(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.LifeCutterNormalThickness) if self.wrapped.LifeCutterNormalThickness is not None else None
    ...
    @property
    def accuracy_level_iso6(self) -> '_717.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_717.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 is not None else None

    @property
    def accuracy_level_iso7(self) -> '_717.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_717.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 is not None else None

    @property
    def designed_gear(self) -> '_659.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_659.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear is not None else None

    @property
    def shaver(self) -> '_688.CylindricalGearShaver':
        ...
        if _688.CylindricalGearShaver.TYPE not in self.wrapped.Shaver.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.Shaver.__class__)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None

    @property
    def life_shaver(self) -> '_688.CylindricalGearShaver':
        ...
        if _688.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.LifeShaver.__class__)(self.wrapped.LifeShaver) if self.wrapped.LifeShaver is not None else None

    @property
    def new_cutter_start_of_shaving(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving is not None else None

    @property
    def life_cutter_start_of_shaving(self) -> '_976.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_976.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving is not None else None
