...
class WormGrinderSimulationCalculator(_670.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_701.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_701.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder is not None else None
