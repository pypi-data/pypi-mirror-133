...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _600, _606
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.gears.manufacturing.cylindrical import _568
from mastapy.gears.manufacturing.cylindrical.cutters import _683
...
class RealPlungeShaverOutputs(_606.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self) -> '_600.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_600.MicroGeometryDefinitionMethod)(value) if value is not None else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_600.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_600.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_600.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_micro_geometry(self) -> '_568.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_568.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry is not None else None

    @property
    def right_flank_micro_geometry(self) -> '_568.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_568.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry is not None else None

    @property
    def shaver(self) -> '_683.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_683.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver is not None else None

    @property
    def micro_geometry(self) -> 'List[_568.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_568.CylindricalGearSpecifiedMicroGeometry))
        return value
