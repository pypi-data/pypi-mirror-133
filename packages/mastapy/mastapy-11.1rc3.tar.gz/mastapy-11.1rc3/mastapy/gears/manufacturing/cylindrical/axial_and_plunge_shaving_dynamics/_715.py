...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _711, _725, _710
...
class PlungeShavingDynamicsViewModel(_725.ShavingDynamicsViewModel['_710.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_711.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_711.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings is not None else None
