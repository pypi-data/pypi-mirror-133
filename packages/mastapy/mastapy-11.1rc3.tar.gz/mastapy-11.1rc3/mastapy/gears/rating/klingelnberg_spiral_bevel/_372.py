...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_378.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_925.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_925.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear is not None else None
