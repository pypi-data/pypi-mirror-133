...
class StraightBevelGearMeshRating(_509.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_918.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_918.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh is not None else None
