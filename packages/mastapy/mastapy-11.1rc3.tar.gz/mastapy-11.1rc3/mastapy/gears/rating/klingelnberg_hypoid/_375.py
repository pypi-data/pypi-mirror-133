...
class KlingelnbergCycloPalloidHypoidGearRating(_378.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_929.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_929.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear is not None else None
