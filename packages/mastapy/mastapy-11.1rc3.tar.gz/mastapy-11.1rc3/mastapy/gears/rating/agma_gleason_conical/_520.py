...
from mastapy.gears.gear_designs.conical import _1111
...
class AGMAGleasonConicalGearMeshRating(_494.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1111.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1111.LoadDistributionFactorMethods)(value) if value is not None else None
