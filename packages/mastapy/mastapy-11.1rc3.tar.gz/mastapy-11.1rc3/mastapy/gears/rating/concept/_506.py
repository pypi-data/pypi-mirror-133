...
from mastapy.gears.rating import _325, _327
...
class ConceptGearRating(_327.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concept_gear(self) -> '_1118.ConceptGearDesign':
        ...
        return constructor.new(_1118.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear is not None else None
