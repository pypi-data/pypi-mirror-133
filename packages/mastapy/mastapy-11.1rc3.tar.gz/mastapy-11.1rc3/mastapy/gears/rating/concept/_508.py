...
from mastapy.gears.rating.concept import _505, _506
...
class ConceptGearSetRating(_329.GearSetRating):
    ...
    @property
    def concept_gear_set(self) -> '_1120.ConceptGearSetDesign':
        ...
        return constructor.new(_1120.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet is not None else None

    @property
    def concept_mesh_ratings(self) -> 'List[_505.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_505.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_506.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_506.ConceptGearRating))
        return value

    @property
    def concept_gear_ratings(self) -> 'List[_506.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_506.ConceptGearRating))
        return value
