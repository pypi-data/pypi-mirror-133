...
from mastapy.gears.rating.cylindrical.iso6336 import _487
...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_487.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_487.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure is not None else None

    @property
    def watch_points(self) -> 'List[_487.ToothFlankFractureAnalysisPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WatchPoints, constructor.new(_487.ToothFlankFractureAnalysisPoint))
        return value
