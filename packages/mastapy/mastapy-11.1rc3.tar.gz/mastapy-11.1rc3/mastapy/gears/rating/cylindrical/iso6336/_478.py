...
from mastapy.gears.rating.cylindrical import _440, _431
...
class ISO6336AbstractMeshSingleFlankRating(_431.CylindricalMeshSingleFlankRating):
    '''ISO6336AbstractMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_477.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_477.ISO6336AbstractGearSingleFlankRating))
        return value

    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_477.ISO6336AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_477.ISO6336AbstractGearSingleFlankRating))
        return value
