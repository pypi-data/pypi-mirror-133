...
from mastapy.gears import _289, _307
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility_gui.charts import (
    _1621, _1612, _1617, _1618
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.rating.cylindrical import _431, _428, _423
from mastapy.gears.rating.cylindrical.plastic_vdi2736 import _451, _453, _455
from mastapy.gears.rating.cylindrical.iso6336 import (
    _472, _474, _476, _478,
    _480
)
from mastapy.gears.rating.cylindrical.din3990 import _489
from mastapy.gears.rating.cylindrical.agma import _491
from mastapy.gears.load_case.cylindrical import _839
from mastapy.gears.rating.cylindrical.vdi import _450
...
class CylindricalGearMeshRating(_326.GearMeshRating):
    '''CylindricalGearMeshRating
    ...
    @property
    def mesh_coefficient_of_friction_at_diameter_benedict_and_kelley(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.MeshCoefficientOfFrictionAtDiameterBenedictAndKelley.__class__.__mro__:
    ...
    @property
    def load_sharing_factor_source(self) -> '_307.PlanetaryRatingLoadSharingOption':
        ...
        return constructor.new(_307.PlanetaryRatingLoadSharingOption)(value) if value is not None else None
    ...
    @property
    def cylindrical_mesh_single_flank_rating(self) -> '_431.CylindricalMeshSingleFlankRating':
        ...
        if _431.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_451.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _451.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_453.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _453.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_455.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _455.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_472.ISO63361996MeshSingleFlankRating':
        ...
        if _472.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_474.ISO63362006MeshSingleFlankRating':
        ...
        if _474.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_476.ISO63362019MeshSingleFlankRating':
        ...
        if _476.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso6336_abstract_mesh_single_flank_rating(self) -> '_478.ISO6336AbstractMeshSingleFlankRating':
        ...
        if _478.ISO6336AbstractMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_iso6336_abstract_metal_mesh_single_flank_rating(self) -> '_480.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _480.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_489.DIN3990MeshSingleFlankRating':
        ...
        if _489.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def cylindrical_mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_491.AGMA2101MeshSingleFlankRating':
        ...
        if _491.AGMA2101MeshSingleFlankRating.TYPE not in self.wrapped.CylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_load_case(self) -> '_839.CylindricalMeshLoadCase':
        ...
        return constructor.new(_839.CylindricalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase is not None else None

    @property
    def gear_set_rating(self) -> '_428.CylindricalGearSetRating':
        ...
        return constructor.new(_428.CylindricalGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating is not None else None

    @property
    def vdi_cylindrical_gear_single_flank_rating(self) -> '_450.VDI2737InternalGearSingleFlankRating':
        ...
        return constructor.new(_450.VDI2737InternalGearSingleFlankRating)(self.wrapped.VDICylindricalGearSingleFlankRating) if self.wrapped.VDICylindricalGearSingleFlankRating is not None else None

    @property
    def isodin_cylindrical_mesh_single_flank_rating(self) -> '_480.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _480.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_472.ISO63361996MeshSingleFlankRating':
        ...
        if _472.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_474.ISO63362006MeshSingleFlankRating':
        ...
        if _474.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_476.ISO63362019MeshSingleFlankRating':
        ...
        if _476.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_489.DIN3990MeshSingleFlankRating':
        ...
        if _489.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.ISODINCylindricalMeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating(self) -> '_431.CylindricalMeshSingleFlankRating':
        ...
        if _431.CylindricalMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_metal_plastic_or_plastic_metal_vdi2736_mesh_single_flank_rating(self) -> '_451.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating':
        ...
        if _451.MetalPlasticOrPlasticMetalVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_plastic_gear_vdi2736_abstract_mesh_single_flank_rating(self) -> '_453.PlasticGearVDI2736AbstractMeshSingleFlankRating':
        ...
        if _453.PlasticGearVDI2736AbstractMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_plastic_plastic_vdi2736_mesh_single_flank_rating(self) -> '_455.PlasticPlasticVDI2736MeshSingleFlankRating':
        ...
        if _455.PlasticPlasticVDI2736MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63361996_mesh_single_flank_rating(self) -> '_472.ISO63361996MeshSingleFlankRating':
        ...
        if _472.ISO63361996MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63362006_mesh_single_flank_rating(self) -> '_474.ISO63362006MeshSingleFlankRating':
        ...
        if _474.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso63362019_mesh_single_flank_rating(self) -> '_476.ISO63362019MeshSingleFlankRating':
        ...
        if _476.ISO63362019MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso6336_abstract_mesh_single_flank_rating(self) -> '_478.ISO6336AbstractMeshSingleFlankRating':
        ...
        if _478.ISO6336AbstractMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_iso6336_abstract_metal_mesh_single_flank_rating(self) -> '_480.ISO6336AbstractMetalMeshSingleFlankRating':
        ...
        if _480.ISO6336AbstractMetalMeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_din3990_mesh_single_flank_rating(self) -> '_489.DIN3990MeshSingleFlankRating':
        ...
        if _489.DIN3990MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def mesh_single_flank_rating_of_type_agma2101_mesh_single_flank_rating(self) -> '_491.AGMA2101MeshSingleFlankRating':
        ...
        if _491.AGMA2101MeshSingleFlankRating.TYPE not in self.wrapped.MeshSingleFlankRating.__class__.__mro__:
    ...
    @property
    def agma_cylindrical_mesh_single_flank_rating(self) -> '_491.AGMA2101MeshSingleFlankRating':
        ...
        return constructor.new(_491.AGMA2101MeshSingleFlankRating)(self.wrapped.AGMACylindricalMeshSingleFlankRating) if self.wrapped.AGMACylindricalMeshSingleFlankRating is not None else None

    @property
    def cylindrical_gear_mesh(self) -> '_971.CylindricalGearMeshDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMesh) if self.wrapped.CylindricalGearMesh is not None else None
