...
from mastapy.gears.fe_model import _1141
...
class GearFEModel(_1160.GearImplementationDetail):
    '''GearFEModel
    ...
    def fe_bore(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.FEBore) if self.wrapped.FEBore is not None else None
    ...
    @property
    def element_settings(self) -> '_1141.GearMeshingElementOptions':
        ...
        return constructor.new(_1141.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings is not None else None
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7270.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
    ...
    def get_stress_influence_coefficients_from_fe(self, flank: '_292.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_292.GearFlanks', progress: '_7270.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
