...
from mastapy.gears.materials import _550, _556
...
class KlingelnbergConicalGearMaterialDatabase(_550.GearMaterialDatabase['_556.KlingelnbergCycloPalloidConicalGearMaterial']):
    '''KlingelnbergConicalGearMaterialDatabase
