...
from mastapy.gears.rating.conical import _496, _497
from mastapy.gears.rating.concept import _507, _508
from mastapy.gears.rating.bevel import _511
from mastapy.gears.rating.agma_gleason_conical import _522
from mastapy.gears.gear_set_pareto_optimiser import _862
...
class GearSetOptimiserCandidate(_862.DesignSpaceSearchCandidateBase['_321.AbstractGearSetRating', 'GearSetOptimiserCandidate']):
    '''GearSetOptimiserCandidate
    ...
    @property
    def candidate_of_type_conical_gear_set_duty_cycle_rating(self) -> '_496.ConicalGearSetDutyCycleRating':
        ...
        if _496.ConicalGearSetDutyCycleRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_conical_gear_set_rating(self) -> '_497.ConicalGearSetRating':
        ...
        if _497.ConicalGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_concept_gear_set_duty_cycle_rating(self) -> '_507.ConceptGearSetDutyCycleRating':
        ...
        if _507.ConceptGearSetDutyCycleRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_concept_gear_set_rating(self) -> '_508.ConceptGearSetRating':
        ...
        if _508.ConceptGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_bevel_gear_set_rating(self) -> '_511.BevelGearSetRating':
        ...
        if _511.BevelGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_of_type_agma_gleason_conical_gear_set_rating(self) -> '_522.AGMAGleasonConicalGearSetRating':
        ...
        if _522.AGMAGleasonConicalGearSetRating.TYPE not in self.wrapped.Candidate.__class__.__mro__:
