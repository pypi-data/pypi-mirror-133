...
class MicroGeometryDesignSpaceSearchCandidate(_862.DesignSpaceSearchCandidateBase['_815.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_815.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _815.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_for_slider(self) -> '_1052.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1052.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider is not None else None
