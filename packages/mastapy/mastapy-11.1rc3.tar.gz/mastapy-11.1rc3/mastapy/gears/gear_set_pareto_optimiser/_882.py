...
from mastapy.gears.gear_set_pareto_optimiser import _884
...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_884.ParetoFaceRatingOptimisationStrategyDatabase):
    '''ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
