...
from mastapy.math_utility.optimisation import _1343, _1334, _1340
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_870.LargerOrSmaller':
        ...
        return constructor.new(_870.LargerOrSmaller)(value) if value is not None else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_870.LargerOrSmaller'):
    ...
    def display_candidates(self) -> 'enum_with_selected_value.EnumWithSelectedValue_CandidateDisplayChoice':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.DisplayCandidates, value) if self.wrapped.DisplayCandidates is not None else None
    ...
    def design_space_search_strategy_database(self, value: 'str'):
        self.wrapped.DesignSpaceSearchStrategyDatabase.SetSelectedItem(str(value) if value else '')
    ...
    def design_space_search_strategy_database_duty_cycle(self, value: 'str'):
        self.wrapped.DesignSpaceSearchStrategyDatabaseDutyCycle.SetSelectedItem(str(value) if value else '')
    ...
    def load_case_duty_cycle(self) -> 'TAnalysis':
        ...
        return self.wrapped.LoadCaseDutyCycle
    ...
    def selected_candidate(self) -> 'TAnalysis':
        ...
        return self.wrapped.SelectedCandidate

    @property
    def selected_design_space_search_strategy(self) -> '_1343.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1343.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy is not None else None

    @property
    def optimisation_targets(self) -> 'List[_877.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_877.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1334.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1334.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_895.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_895.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    def candidate_designs_to_display(self) -> 'List[TCandidate]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateDesignsToDisplay)
        return value

    @property
    def chart_details(self) -> 'List[_859.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_859.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    def all_candidate_designs_including_original_design(self) -> 'List[TCandidate]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateDesignsIncludingOriginalDesign)
        return value
    ...
    def all_candidate_designs_to_display(self) -> 'List[TCandidate]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateDesignsToDisplay)
        return value
    ...
    def all_candidate_designs_to_display_without_original_design(self) -> 'List[TCandidate]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateDesignsToDisplayWithoutOriginalDesign)
        return value

    @property
    def reasons_for_invalid_candidates(self) -> 'List[_892.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_892.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1340.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1340.ParetoOptimisationFilter))
        return value
