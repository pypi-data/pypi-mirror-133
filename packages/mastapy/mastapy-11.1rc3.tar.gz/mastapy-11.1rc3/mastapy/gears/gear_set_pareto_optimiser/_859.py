...
from mastapy.utility.reporting_property_framework import _1512
...
from mastapy.gears.analysis import _1156
...
TAnalysis = TypeVar('TAnalysis', bound='_1156.AbstractGearSetAnalysis')
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def select_chart_type(self) -> '_1345.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(_1345.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1345.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SelectChartType = value

    @property
    def chart_type(self) -> '_1512.CustomChartType':
        ...
        return constructor.new(_1512.CustomChartType)(value) if value is not None else None
    ...
    @property
    def optimiser(self) -> '_861.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        if _861.DesignSpaceSearchBase[TAnalysis, TCandidate].TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_860.CylindricalGearSetParetoOptimiser':
        ...
        if _860.CylindricalGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_863.FaceGearSetParetoOptimiser':
        ...
        if _863.FaceGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_867.GearSetParetoOptimiser':
        ...
        if _867.GearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_868.HypoidGearSetParetoOptimiser':
        ...
        if _868.HypoidGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_871.MicroGeometryDesignSpaceSearch':
        ...
        if _871.MicroGeometryDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_874.MicroGeometryGearSetDesignSpaceSearch':
        ...
        if _874.MicroGeometryGearSetDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_893.SpiralBevelGearSetParetoOptimiser':
        ...
        if _893.SpiralBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_894.StraightBevelGearSetParetoOptimiser':
        ...
        if _894.StraightBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def bars(self) -> 'List[_857.BarForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_857.BarForPareto)[TAnalysis, TCandidate])
        return value

    @property
    def input_sliders(self) -> 'List[_869.InputSliderForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSliders, constructor.new(_869.InputSliderForPareto)[TAnalysis, TCandidate])
        return value
