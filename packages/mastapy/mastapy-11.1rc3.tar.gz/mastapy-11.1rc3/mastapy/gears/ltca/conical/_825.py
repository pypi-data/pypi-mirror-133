...
from mastapy.gears.ltca.conical import _824
from mastapy.gears.ltca import _796
...
class ConicalMeshLoadDistributionAnalysis(_796.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_842.ConicalMeshLoadCase':
        ...
        if _842.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_739.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_739.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis is not None else None

    @property
    def meshed_gears(self) -> 'List[_824.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_824.ConicalMeshedGearLoadDistributionAnalysis))
        return value
