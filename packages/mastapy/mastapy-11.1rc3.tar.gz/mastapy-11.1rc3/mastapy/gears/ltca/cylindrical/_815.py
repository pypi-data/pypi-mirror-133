...
from mastapy.gears.gear_two_d_fe_analysis import _851
...
class CylindricalGearSetLoadDistributionAnalysis(_801.GearSetLoadDistributionAnalysis):
    '''CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def tiff_analysis(self) -> '_851.CylindricalGearSetTIFFAnalysis':
        ...
        return constructor.new(_851.CylindricalGearSetTIFFAnalysis)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis is not None else None

    @property
    def meshes(self) -> 'List[_812.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_812.CylindricalGearMeshLoadDistributionAnalysis))
        return value
