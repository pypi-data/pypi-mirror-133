...
from mastapy.gears.ltca import _794, _793
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    @property
    def rows(self) -> 'List[_794.GearFilletNodeStressResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_794.GearFilletNodeStressResultsRow))
        return value

    @property
    def columns(self) -> 'List[_793.GearFilletNodeStressResultsColumn]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_793.GearFilletNodeStressResultsColumn))
        return value
