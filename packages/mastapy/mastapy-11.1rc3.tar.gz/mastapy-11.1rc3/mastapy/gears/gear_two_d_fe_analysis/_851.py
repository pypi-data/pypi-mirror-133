...
class CylindricalGearSetTIFFAnalysis(_1165.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysis
    ...
    @property
    def gears(self) -> 'List[_853.CylindricalGearTIFFAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_853.CylindricalGearTIFFAnalysis))
        return value
