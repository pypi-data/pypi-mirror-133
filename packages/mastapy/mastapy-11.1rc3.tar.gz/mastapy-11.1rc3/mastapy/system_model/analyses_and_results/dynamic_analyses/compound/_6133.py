...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6129.BevelDifferentialGearCompoundDynamicAnalysis):
    '''BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6003.BevelDifferentialSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6003.BevelDifferentialSunGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6003.BevelDifferentialSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6003.BevelDifferentialSunGearDynamicAnalysis))
        return value
