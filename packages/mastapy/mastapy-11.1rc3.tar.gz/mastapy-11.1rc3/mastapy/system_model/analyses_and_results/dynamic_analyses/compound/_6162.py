...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6142.CoaxialConnectionCompoundDynamicAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6032.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6032.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6032.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6032.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value
