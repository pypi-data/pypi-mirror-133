...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6070
...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6155.CouplingCompoundDynamicAnalysis):
    '''PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6070.PartToPartShearCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6070.PartToPartShearCouplingDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6070.PartToPartShearCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6070.PartToPartShearCouplingDynamicAnalysis))
        return value
