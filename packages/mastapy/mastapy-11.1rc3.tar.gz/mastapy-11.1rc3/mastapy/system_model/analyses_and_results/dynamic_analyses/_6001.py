...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5999, _6000, _6006
...
class BevelDifferentialGearSetDynamicAnalysis(_6006.BevelGearSetDynamicAnalysis):
    '''BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_5999.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsDynamicAnalysis, constructor.new(_5999.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6000.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesDynamicAnalysis, constructor.new(_6000.BevelDifferentialGearMeshDynamicAnalysis))
        return value
