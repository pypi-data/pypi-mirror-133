...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6112, _6113, _6049
...
class WormGearSetDynamicAnalysis(_6049.GearSetDynamicAnalysis):
    '''WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6112.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsDynamicAnalysis, constructor.new(_6112.WormGearDynamicAnalysis))
        return value

    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6113.WormGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesDynamicAnalysis, constructor.new(_6113.WormGearMeshDynamicAnalysis))
        return value
