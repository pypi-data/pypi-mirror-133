...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6088, _6089, _6006
...
class SpiralBevelGearSetDynamicAnalysis(_6006.BevelGearSetDynamicAnalysis):
    '''SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6088.SpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsDynamicAnalysis, constructor.new(_6088.SpiralBevelGearDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6089.SpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesDynamicAnalysis, constructor.new(_6089.SpiralBevelGearMeshDynamicAnalysis))
        return value
