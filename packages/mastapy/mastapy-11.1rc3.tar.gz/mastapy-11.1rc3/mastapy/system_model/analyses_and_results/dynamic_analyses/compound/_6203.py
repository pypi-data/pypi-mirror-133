...
class PlanetCarrierCompoundDynamicAnalysis(_6195.MountableComponentCompoundDynamicAnalysis):
    '''PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6074.PlanetCarrierDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6074.PlanetCarrierDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6074.PlanetCarrierDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6074.PlanetCarrierDynamicAnalysis))
        return value
