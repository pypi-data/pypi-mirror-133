...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6121.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    '''ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6086.ShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6086.ShaftToMountableComponentConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6086.ShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6086.ShaftToMountableComponentConnectionDynamicAnalysis))
        return value
