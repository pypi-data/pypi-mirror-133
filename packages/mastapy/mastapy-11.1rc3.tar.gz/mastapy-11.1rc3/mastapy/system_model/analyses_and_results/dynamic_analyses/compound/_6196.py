...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6067
...
class OilSealCompoundDynamicAnalysis(_6154.ConnectorCompoundDynamicAnalysis):
    '''OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6067.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6067.OilSealDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6067.OilSealDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6067.OilSealDynamicAnalysis))
        return value
