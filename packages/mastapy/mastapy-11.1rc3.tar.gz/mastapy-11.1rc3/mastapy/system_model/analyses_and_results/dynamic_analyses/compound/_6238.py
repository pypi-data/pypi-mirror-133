...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6109
...
class TorqueConverterTurbineCompoundDynamicAnalysis(_6157.CouplingHalfCompoundDynamicAnalysis):
    '''TorqueConverterTurbineCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6109.TorqueConverterTurbineDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6109.TorqueConverterTurbineDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6109.TorqueConverterTurbineDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6109.TorqueConverterTurbineDynamicAnalysis))
        return value
