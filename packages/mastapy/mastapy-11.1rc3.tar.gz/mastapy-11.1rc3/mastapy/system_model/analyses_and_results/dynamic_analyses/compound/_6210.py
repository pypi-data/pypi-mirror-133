...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6082
...
class RollingRingCompoundDynamicAnalysis(_6157.CouplingHalfCompoundDynamicAnalysis):
    '''RollingRingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6082.RollingRingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6082.RollingRingDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6082.RollingRingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6082.RollingRingDynamicAnalysis))
        return value
