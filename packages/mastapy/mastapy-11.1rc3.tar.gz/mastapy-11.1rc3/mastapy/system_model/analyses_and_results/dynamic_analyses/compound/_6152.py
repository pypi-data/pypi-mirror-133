...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6178
...
class ConicalGearSetCompoundDynamicAnalysis(_6178.GearSetCompoundDynamicAnalysis):
    '''ConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6022.ConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6022.ConicalGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6022.ConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6022.ConicalGearSetDynamicAnalysis))
        return value
