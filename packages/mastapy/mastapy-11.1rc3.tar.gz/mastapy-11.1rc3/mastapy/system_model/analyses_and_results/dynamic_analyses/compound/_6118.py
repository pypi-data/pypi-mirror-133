...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6197
...
class AbstractAssemblyCompoundDynamicAnalysis(_6197.PartCompoundDynamicAnalysis):
    '''AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5988.AbstractAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5988.AbstractAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5988.AbstractAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5988.AbstractAssemblyDynamicAnalysis))
        return value
