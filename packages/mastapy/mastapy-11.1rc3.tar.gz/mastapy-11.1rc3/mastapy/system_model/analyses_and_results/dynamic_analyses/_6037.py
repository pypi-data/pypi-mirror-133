...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6035, _6036, _6049
...
class CylindricalGearSetDynamicAnalysis(_6049.GearSetDynamicAnalysis):
    '''CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6035.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsDynamicAnalysis, constructor.new(_6035.CylindricalGearDynamicAnalysis))
        return value

    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6036.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesDynamicAnalysis, constructor.new(_6036.CylindricalGearMeshDynamicAnalysis))
        return value
