...
class VirtualComponentCompoundDynamicAnalysis(_6195.MountableComponentCompoundDynamicAnalysis):
    '''VirtualComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6111.VirtualComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6111.VirtualComponentDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6111.VirtualComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6111.VirtualComponentDynamicAnalysis))
        return value
