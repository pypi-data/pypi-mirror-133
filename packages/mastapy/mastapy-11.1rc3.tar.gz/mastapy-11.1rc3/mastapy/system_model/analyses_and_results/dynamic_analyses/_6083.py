...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2361, _5995
...
class RootAssemblyDynamicAnalysis(_5995.AssemblyDynamicAnalysis):
    '''RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2361.DynamicAnalysis':
        ...
        if _2361.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysisInputs.__class__.__mro__:
