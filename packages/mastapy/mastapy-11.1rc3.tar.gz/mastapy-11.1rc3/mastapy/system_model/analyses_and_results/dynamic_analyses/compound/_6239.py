...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6110
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6240
...
class UnbalancedMassCompoundDynamicAnalysis(_6240.VirtualComponentCompoundDynamicAnalysis):
    '''UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6110.UnbalancedMassDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6110.UnbalancedMassDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6110.UnbalancedMassDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6110.UnbalancedMassDynamicAnalysis))
        return value
