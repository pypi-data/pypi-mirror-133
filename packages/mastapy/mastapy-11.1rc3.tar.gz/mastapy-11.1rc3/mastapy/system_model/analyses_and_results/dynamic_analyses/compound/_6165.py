...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6176
...
class CylindricalGearCompoundDynamicAnalysis(_6176.GearCompoundDynamicAnalysis):
    '''CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6035.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6035.CylindricalGearDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6035.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6035.CylindricalGearDynamicAnalysis))
        return value
