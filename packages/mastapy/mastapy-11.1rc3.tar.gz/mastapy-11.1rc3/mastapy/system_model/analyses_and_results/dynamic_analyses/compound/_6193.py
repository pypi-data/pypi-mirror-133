...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6064
...
class MassDiscCompoundDynamicAnalysis(_6240.VirtualComponentCompoundDynamicAnalysis):
    '''MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6064.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6064.MassDiscDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6064.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6064.MassDiscDynamicAnalysis))
        return value
