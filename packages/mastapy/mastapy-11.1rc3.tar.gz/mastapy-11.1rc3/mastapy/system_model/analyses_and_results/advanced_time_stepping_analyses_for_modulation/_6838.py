...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6681.SynchroniserHalfLoadCase':
        ...
        return constructor.new(_6681.SynchroniserHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase is not None else None

    @property
    def system_deflection_results(self) -> '_2551.SynchroniserHalfSystemDeflection':
        ...
        return constructor.new(_2551.SynchroniserHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
