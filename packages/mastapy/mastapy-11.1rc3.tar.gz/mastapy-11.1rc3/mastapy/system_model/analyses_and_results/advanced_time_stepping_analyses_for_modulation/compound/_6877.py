...
from mastapy.system_model.connections_and_sockets import _2006
...
class CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6950.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CoaxialConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2006.CoaxialConnection':
    ...
    @property
    def connection_design(self) -> '_2006.CoaxialConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6747.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6747.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6747.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6747.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
