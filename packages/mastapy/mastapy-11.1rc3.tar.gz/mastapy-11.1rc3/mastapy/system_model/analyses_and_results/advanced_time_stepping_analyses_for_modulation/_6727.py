...
class AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6756.ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2424.AGMAGleasonConicalGearMeshSystemDeflection':
