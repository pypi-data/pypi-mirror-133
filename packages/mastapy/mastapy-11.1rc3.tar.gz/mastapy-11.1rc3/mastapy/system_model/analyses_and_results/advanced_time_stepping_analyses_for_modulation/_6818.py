...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2358, _6729
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6729.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def results(self) -> '_5847.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5847.RootAssemblyHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results is not None else None
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2358.AdvancedTimeSteppingAnalysisForModulation':
        ...
        return constructor.new(_2358.AdvancedTimeSteppingAnalysisForModulation)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationInputs is not None else None

    @property
    def system_deflection_results(self) -> '_2530.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2530.RootAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
