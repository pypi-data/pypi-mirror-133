...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6770.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2262.CylindricalPlanetGear':
        ...
        return constructor.new(_2262.CylindricalPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2480.CylindricalPlanetGearSystemDeflection':
        ...
        return constructor.new(_2480.CylindricalPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
