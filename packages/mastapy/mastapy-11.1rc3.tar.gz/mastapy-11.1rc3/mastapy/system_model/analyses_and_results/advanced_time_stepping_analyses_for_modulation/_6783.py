...
from mastapy.math_utility import _1302
...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_6822.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1302.Eigenmodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.EignenmodesIndexedByModeId, constructor.new(_1302.Eigenmodes))
        return value
