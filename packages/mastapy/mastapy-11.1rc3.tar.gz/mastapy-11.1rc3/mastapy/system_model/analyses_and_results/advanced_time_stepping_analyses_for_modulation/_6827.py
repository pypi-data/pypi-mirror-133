...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6761.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2540.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2540.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
