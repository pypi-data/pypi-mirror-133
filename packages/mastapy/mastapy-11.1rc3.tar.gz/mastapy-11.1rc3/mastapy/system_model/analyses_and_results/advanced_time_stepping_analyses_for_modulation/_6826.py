...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_6760.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2542.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2542.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
