...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6740.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2431.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2431.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
