...
class SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation(_6892.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6839.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation))
        return value
