...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_6846.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2509.MassDiscSystemDeflection':
        ...
        return constructor.new(_2509.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
