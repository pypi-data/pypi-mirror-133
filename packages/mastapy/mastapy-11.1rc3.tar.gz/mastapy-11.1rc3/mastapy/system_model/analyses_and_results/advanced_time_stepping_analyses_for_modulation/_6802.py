...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6759.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2514.OilSealSystemDeflection':
        ...
        return constructor.new(_2514.OilSealSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
