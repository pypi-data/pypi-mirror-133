...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(_6822.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2465.CycloidalAssemblySystemDeflection':
        ...
        return constructor.new(_2465.CycloidalAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
