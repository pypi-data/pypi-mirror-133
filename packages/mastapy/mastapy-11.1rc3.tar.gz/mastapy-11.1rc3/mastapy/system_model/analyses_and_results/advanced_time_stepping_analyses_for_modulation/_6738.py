...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6734.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2253.BevelDifferentialSunGear':
        ...
        return constructor.new(_2253.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2435.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2435.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
