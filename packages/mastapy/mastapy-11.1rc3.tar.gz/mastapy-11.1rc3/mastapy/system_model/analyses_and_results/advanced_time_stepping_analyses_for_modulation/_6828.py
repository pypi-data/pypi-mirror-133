...
class SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation(_6762.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''SpringDamperHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2541.SpringDamperHalfSystemDeflection':
        ...
        return constructor.new(_2541.SpringDamperHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
