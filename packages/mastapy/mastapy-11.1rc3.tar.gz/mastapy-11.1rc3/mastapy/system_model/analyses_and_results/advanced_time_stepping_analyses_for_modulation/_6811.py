...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(_6846.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PowerLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2522.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2522.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
