...
from mastapy.system_model.part_model.gears import _2285
...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_6829.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2285.StraightBevelSunGear':
        ...
        return constructor.new(_2285.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2550.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2550.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
