...
class BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6857.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6739.BevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value
