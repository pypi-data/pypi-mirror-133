...
class ConicalGearMeshCriticalSpeedAnalysis(_6314.GearMeshCriticalSpeedAnalysis):
    '''ConicalGearMeshCriticalSpeedAnalysis
    ...
    def planetaries(self) -> 'List[ConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(ConicalGearMeshCriticalSpeedAnalysis))
        return value
