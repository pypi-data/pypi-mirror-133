...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6381, _6382, _6271
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6271.BevelGearSetCriticalSpeedAnalysis):
    '''ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6381.ZerolBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsCriticalSpeedAnalysis, constructor.new(_6381.ZerolBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6382.ZerolBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesCriticalSpeedAnalysis, constructor.new(_6382.ZerolBevelGearMeshCriticalSpeedAnalysis))
        return value
