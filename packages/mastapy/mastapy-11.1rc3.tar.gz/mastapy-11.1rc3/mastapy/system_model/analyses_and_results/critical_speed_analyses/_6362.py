...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6360, _6361, _6271
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6271.BevelGearSetCriticalSpeedAnalysis):
    '''StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6360.StraightBevelDiffGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCriticalSpeedAnalysis, constructor.new(_6360.StraightBevelDiffGearCriticalSpeedAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6361.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCriticalSpeedAnalysis, constructor.new(_6361.StraightBevelDiffGearMeshCriticalSpeedAnalysis))
        return value
