...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6347
...
class RollingRingConnectionCompoundCriticalSpeedAnalysis(_6449.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''RollingRingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6347.RollingRingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6347.RollingRingConnectionCriticalSpeedAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6347.RollingRingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6347.RollingRingConnectionCriticalSpeedAnalysis))
        return value
