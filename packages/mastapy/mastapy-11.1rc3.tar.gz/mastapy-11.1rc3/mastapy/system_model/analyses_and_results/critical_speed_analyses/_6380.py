...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6378, _6379, _6315
...
class WormGearSetCriticalSpeedAnalysis(_6315.GearSetCriticalSpeedAnalysis):
    '''WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6378.WormGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCriticalSpeedAnalysis, constructor.new(_6378.WormGearCriticalSpeedAnalysis))
        return value

    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6379.WormGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCriticalSpeedAnalysis, constructor.new(_6379.WormGearMeshCriticalSpeedAnalysis))
        return value
