...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6308, _6309, _6315
...
class FaceGearSetCriticalSpeedAnalysis(_6315.GearSetCriticalSpeedAnalysis):
    '''FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6308.FaceGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCriticalSpeedAnalysis, constructor.new(_6308.FaceGearCriticalSpeedAnalysis))
        return value

    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6309.FaceGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCriticalSpeedAnalysis, constructor.new(_6309.FaceGearMeshCriticalSpeedAnalysis))
        return value
