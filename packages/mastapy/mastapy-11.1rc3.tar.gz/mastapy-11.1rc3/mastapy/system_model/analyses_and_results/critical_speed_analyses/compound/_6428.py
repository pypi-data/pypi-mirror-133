...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6408.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6299.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6299.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6299.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6299.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis))
        return value
