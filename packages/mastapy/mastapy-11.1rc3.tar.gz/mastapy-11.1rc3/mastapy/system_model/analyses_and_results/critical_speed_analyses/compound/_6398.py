...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6395
...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6395.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    '''BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6267.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6267.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6267.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6267.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value
