...
class CriticalSpeedAnalysis(_7262.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6294.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6294.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions is not None else None
