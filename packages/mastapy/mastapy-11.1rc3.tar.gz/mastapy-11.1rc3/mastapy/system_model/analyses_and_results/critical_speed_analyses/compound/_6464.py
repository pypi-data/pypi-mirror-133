...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6336
...
class PartToPartShearCouplingCompoundCriticalSpeedAnalysis(_6421.CouplingCompoundCriticalSpeedAnalysis):
    '''PartToPartShearCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6336.PartToPartShearCouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6336.PartToPartShearCouplingCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6336.PartToPartShearCouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6336.PartToPartShearCouplingCriticalSpeedAnalysis))
        return value
