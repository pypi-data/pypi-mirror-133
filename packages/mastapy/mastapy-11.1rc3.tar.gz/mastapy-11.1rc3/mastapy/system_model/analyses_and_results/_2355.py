...
from mastapy.system_model.analyses_and_results import _2386
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7270.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1946.DesignEntity') -> '_2386.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2386.DesignEntityAnalysis') -> '_2386.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
