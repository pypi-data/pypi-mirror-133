...
class BevelGearSetCompoundStabilityAnalysis(_3631.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    '''BevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3510.BevelGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3510.BevelGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3510.BevelGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3510.BevelGearSetStabilityAnalysis))
        return value
