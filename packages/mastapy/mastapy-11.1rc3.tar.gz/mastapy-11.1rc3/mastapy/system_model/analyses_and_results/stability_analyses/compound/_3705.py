...
from mastapy.system_model.analyses_and_results.stability_analyses import _3576
...
class PartToPartShearCouplingCompoundStabilityAnalysis(_3662.CouplingCompoundStabilityAnalysis):
    '''PartToPartShearCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3576.PartToPartShearCouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3576.PartToPartShearCouplingStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3576.PartToPartShearCouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3576.PartToPartShearCouplingStabilityAnalysis))
        return value
