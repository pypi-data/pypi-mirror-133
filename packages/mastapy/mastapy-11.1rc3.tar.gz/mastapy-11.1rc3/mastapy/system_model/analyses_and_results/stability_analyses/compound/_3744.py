...
from mastapy.system_model.analyses_and_results.stability_analyses import _3614
...
class TorqueConverterPumpCompoundStabilityAnalysis(_3664.CouplingHalfCompoundStabilityAnalysis):
    '''TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3614.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3614.TorqueConverterPumpStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3614.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3614.TorqueConverterPumpStabilityAnalysis))
        return value
