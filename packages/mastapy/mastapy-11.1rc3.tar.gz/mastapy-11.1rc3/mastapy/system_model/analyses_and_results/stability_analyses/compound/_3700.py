...
from mastapy.system_model.analyses_and_results.stability_analyses import _3569
...
class MassDiscCompoundStabilityAnalysis(_3747.VirtualComponentCompoundStabilityAnalysis):
    '''MassDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3569.MassDiscStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3569.MassDiscStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3569.MassDiscStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3569.MassDiscStabilityAnalysis))
        return value
