...
from mastapy.system_model.analyses_and_results.stability_analyses import _2377, _3500
...
class RootAssemblyStabilityAnalysis(_3500.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2377.StabilityAnalysis':
        ...
        return constructor.new(_2377.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs is not None else None
