...
from mastapy.system_model.analyses_and_results.stability_analyses import _3506, _3504, _3510
...
class BevelDifferentialGearSetStabilityAnalysis(_3510.BevelGearSetStabilityAnalysis):
    '''BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3506.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsStabilityAnalysis, constructor.new(_3506.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3504.BevelDifferentialGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesStabilityAnalysis, constructor.new(_3504.BevelDifferentialGearMeshStabilityAnalysis))
        return value
