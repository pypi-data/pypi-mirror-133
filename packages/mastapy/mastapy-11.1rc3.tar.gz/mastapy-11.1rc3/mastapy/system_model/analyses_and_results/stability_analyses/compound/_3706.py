...
from mastapy.system_model.analyses_and_results.stability_analyses import _3574
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3663
...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3663.CouplingConnectionCompoundStabilityAnalysis):
    '''PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3574.PartToPartShearCouplingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3574.PartToPartShearCouplingConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3574.PartToPartShearCouplingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3574.PartToPartShearCouplingConnectionStabilityAnalysis))
        return value
