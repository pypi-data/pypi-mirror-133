...
from mastapy.system_model.analyses_and_results.stability_analyses import _3617
...
class UnbalancedMassCompoundStabilityAnalysis(_3747.VirtualComponentCompoundStabilityAnalysis):
    '''UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3617.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3617.UnbalancedMassStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3617.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3617.UnbalancedMassStabilityAnalysis))
        return value
