...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3722
...
class PlanetaryConnectionCompoundStabilityAnalysis(_3722.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''PlanetaryConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3577.PlanetaryConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3577.PlanetaryConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3577.PlanetaryConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3577.PlanetaryConnectionStabilityAnalysis))
        return value
