...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3635
...
class CVTCompoundStabilityAnalysis(_3635.BeltDriveCompoundStabilityAnalysis):
    '''CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3536.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3536.CVTStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3536.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3536.CVTStabilityAnalysis))
        return value
