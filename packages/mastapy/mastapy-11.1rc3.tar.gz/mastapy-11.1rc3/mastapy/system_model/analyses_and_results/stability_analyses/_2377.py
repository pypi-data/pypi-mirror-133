...
class StabilityAnalysis(_7262.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def stability_analysis_options(self) -> '_3600.StabilityAnalysisOptions':
        ...
        return constructor.new(_3600.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions is not None else None
