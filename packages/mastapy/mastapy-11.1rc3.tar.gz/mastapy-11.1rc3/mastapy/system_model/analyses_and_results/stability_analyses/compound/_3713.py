...
from mastapy.system_model.analyses_and_results.stability_analyses import _3582
...
class PulleyCompoundStabilityAnalysis(_3664.CouplingHalfCompoundStabilityAnalysis):
    '''PulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3582.PulleyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3582.PulleyStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3582.PulleyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3582.PulleyStabilityAnalysis))
        return value
