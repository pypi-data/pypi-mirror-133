...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3704
...
class AbstractAssemblyCompoundStabilityAnalysis(_3704.PartCompoundStabilityAnalysis):
    '''AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3493.AbstractAssemblyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3493.AbstractAssemblyStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3493.AbstractAssemblyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3493.AbstractAssemblyStabilityAnalysis))
        return value
