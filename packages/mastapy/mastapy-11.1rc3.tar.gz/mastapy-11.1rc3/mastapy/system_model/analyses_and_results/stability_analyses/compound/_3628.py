...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3660
...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3660.ConnectionCompoundStabilityAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3496.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3496.AbstractShaftToMountableComponentConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3496.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3496.AbstractShaftToMountableComponentConnectionStabilityAnalysis))
        return value
