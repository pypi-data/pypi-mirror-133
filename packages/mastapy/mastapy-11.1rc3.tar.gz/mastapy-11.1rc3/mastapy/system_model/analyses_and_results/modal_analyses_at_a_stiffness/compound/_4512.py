...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4383
...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4477.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    '''PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4383.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4383.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4383.PlanetaryGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4383.PlanetaryGearSetModalAnalysisAtAStiffness))
        return value
