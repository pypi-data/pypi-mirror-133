...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4310, _4309, _4316
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4316.BevelGearSetModalAnalysisAtAStiffness):
    '''BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4310.BevelDifferentialGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysisAtAStiffness, constructor.new(_4310.BevelDifferentialGearModalAnalysisAtAStiffness))
        return value

    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4309.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysisAtAStiffness, constructor.new(_4309.BevelDifferentialGearMeshModalAnalysisAtAStiffness))
        return value
