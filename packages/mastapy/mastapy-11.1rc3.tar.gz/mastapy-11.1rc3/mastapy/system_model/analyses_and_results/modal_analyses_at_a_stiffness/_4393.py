...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2372, _4305
...
class RootAssemblyModalAnalysisAtAStiffness(_4305.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2372.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2372.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs is not None else None
