...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3361
...
class ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse(_3381.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    '''ZerolBevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_design(self) -> '_2068.ZerolBevelGearMesh':
        ...
        return constructor.new(_2068.ZerolBevelGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3361.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3361.ZerolBevelGearMeshSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3361.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3361.ZerolBevelGearMeshSteadyStateSynchronousResponse))
        return value
