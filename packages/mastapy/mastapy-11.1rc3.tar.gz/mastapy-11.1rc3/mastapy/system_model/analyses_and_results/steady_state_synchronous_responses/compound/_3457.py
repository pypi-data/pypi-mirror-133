...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3324
...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3429.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    '''RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3324.RollingRingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3324.RollingRingConnectionSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3324.RollingRingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3324.RollingRingConnectionSteadyStateSynchronousResponse))
        return value
