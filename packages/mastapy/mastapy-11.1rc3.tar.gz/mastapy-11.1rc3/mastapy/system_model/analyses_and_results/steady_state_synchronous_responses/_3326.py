...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3337, _3238
...
class RootAssemblySteadyStateSynchronousResponse(_3238.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3337.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3337.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs is not None else None
