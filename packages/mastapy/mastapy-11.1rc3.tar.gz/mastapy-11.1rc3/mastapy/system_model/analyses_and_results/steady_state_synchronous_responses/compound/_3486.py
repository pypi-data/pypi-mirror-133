...
class VirtualComponentCompoundSteadyStateSynchronousResponse(_3441.MountableComponentCompoundSteadyStateSynchronousResponse):
    '''VirtualComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3357.VirtualComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3357.VirtualComponentSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3357.VirtualComponentSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3357.VirtualComponentSteadyStateSynchronousResponse))
        return value
