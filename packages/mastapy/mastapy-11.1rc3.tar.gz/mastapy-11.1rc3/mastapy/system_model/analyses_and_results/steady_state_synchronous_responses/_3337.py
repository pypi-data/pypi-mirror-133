...
from mastapy.system_model.analyses_and_results.analysis_cases import _7249
...
class SteadyStateSynchronousResponse(_7249.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3339.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3339.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions is not None else None
