...
from mastapy.system_model.analyses_and_results.system_deflections import _2545, _2543, _2437
...
class StraightBevelDiffGearSetSystemDeflection(_2437.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3870.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3870.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2545.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2545.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2543.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2543.StraightBevelDiffGearMeshSystemDeflection))
        return value
