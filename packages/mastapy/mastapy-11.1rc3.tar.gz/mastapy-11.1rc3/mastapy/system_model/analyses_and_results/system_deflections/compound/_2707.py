...
class WormGearMeshCompoundSystemDeflection(_2641.GearMeshCompoundSystemDeflection):
    '''WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2566.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2566.WormGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2566.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2566.WormGearMeshSystemDeflection))
        return value
