...
class HypoidGearSystemDeflection(_2426.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3824.HypoidGearPowerFlow':
        ...
        return constructor.new(_3824.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
