...
class UnbalancedMassSystemDeflection(_2565.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3885.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3885.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
