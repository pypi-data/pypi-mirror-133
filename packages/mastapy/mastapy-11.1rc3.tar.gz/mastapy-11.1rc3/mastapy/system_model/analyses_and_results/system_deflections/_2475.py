...
from mastapy.system_model.analyses_and_results.power_flows import _3809, _3811
from mastapy.gears.rating.cylindrical import _423
from mastapy.gears.manufacturing.cylindrical import _572
from mastapy.system_model.analyses_and_results.system_deflections import _2479, _2491
...
class CylindricalGearSystemDeflection(_2491.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3809.CylindricalGearPowerFlow':
        ...
        if _3809.CylindricalGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def manufacturing_analysis(self) -> '_572.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_572.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis is not None else None
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2479.CylindricalMeshedGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearSystemDeflectionsInMeshes, constructor.new(_2479.CylindricalMeshedGearSystemDeflection))
        return value
