...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2619
...
class PartToPartShearCouplingConnectionCompoundSystemDeflection(_2619.CouplingConnectionCompoundSystemDeflection):
    '''PartToPartShearCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2516.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2516.PartToPartShearCouplingConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2516.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2516.PartToPartShearCouplingConnectionSystemDeflection))
        return value
