...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2630
...
class PlanetaryGearSetCompoundSystemDeflection(_2630.CylindricalGearSetCompoundSystemDeflection):
    '''PlanetaryGearSetCompoundSystemDeflection
