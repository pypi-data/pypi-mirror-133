...
from mastapy.system_model.analyses_and_results.power_flows import _3853
from mastapy.system_model.analyses_and_results.system_deflections import _2526, _2497
...
class RingPinsToDiscConnectionSystemDeflection(_2497.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6657.RingPinsToDiscConnectionLoadCase':
        ...
        return constructor.new(_6657.RingPinsToDiscConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3853.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3853.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2526.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2526.RingPinToDiscContactReporting))
        return value
