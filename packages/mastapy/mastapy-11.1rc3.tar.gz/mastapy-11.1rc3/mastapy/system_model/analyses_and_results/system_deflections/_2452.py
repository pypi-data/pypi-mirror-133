...
class ConceptGearSystemDeflection(_2491.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3790.ConceptGearPowerFlow':
        ...
        return constructor.new(_3790.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
