...
class StraightBevelGearSystemDeflection(_2438.BevelGearSystemDeflection):
    '''StraightBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3872.StraightBevelGearPowerFlow':
        ...
        return constructor.new(_3872.StraightBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
