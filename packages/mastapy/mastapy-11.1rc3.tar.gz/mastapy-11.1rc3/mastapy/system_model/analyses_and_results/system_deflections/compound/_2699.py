...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2698
...
class SynchroniserSleeveCompoundSystemDeflection(_2698.SynchroniserPartCompoundSystemDeflection):
    '''SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2553.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2553.SynchroniserSleeveSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2553.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2553.SynchroniserSleeveSystemDeflection))
        return value
