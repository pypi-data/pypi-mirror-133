...
class CylindricalGearSystemDeflectionWithLTCAResults(_2475.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_811.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_811.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults is not None else None
