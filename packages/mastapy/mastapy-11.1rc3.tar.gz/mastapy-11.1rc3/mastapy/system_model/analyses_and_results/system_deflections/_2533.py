...
class ShaftSectionSystemDeflection(_121.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2532.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2532.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd is not None else None

    @property
    def right_end(self) -> '_2532.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2532.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd is not None else None
