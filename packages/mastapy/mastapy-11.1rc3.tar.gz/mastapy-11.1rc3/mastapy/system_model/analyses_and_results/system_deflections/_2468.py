...
class CycloidalDiscSystemDeflection(_2422.AbstractShaftSystemDeflection):
    '''CycloidalDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3806.CycloidalDiscPowerFlow':
        ...
        return constructor.new(_3806.CycloidalDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
