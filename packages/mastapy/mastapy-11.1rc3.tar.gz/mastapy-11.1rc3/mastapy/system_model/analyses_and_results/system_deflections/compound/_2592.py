...
class BevelDifferentialGearCompoundSystemDeflection(_2597.BevelGearCompoundSystemDeflection):
    '''BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2433.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2433.BevelDifferentialGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2433.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2433.BevelDifferentialGearSystemDeflection))
        return value
