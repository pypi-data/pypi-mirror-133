...
class SpiralBevelGearSystemDeflection(_2438.BevelGearSystemDeflection):
    '''SpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3863.SpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3863.SpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
