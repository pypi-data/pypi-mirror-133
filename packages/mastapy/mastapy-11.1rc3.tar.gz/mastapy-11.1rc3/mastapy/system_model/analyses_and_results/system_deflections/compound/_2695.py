...
class StraightBevelSunGearCompoundSystemDeflection(_2688.StraightBevelDiffGearCompoundSystemDeflection):
    '''StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2550.StraightBevelSunGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2550.StraightBevelSunGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2550.StraightBevelSunGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2550.StraightBevelSunGearSystemDeflection))
        return value
