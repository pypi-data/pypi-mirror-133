...
class StraightBevelDiffGearMeshSystemDeflection(_2436.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6674.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6674.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3868.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3868.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_361.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_361.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
