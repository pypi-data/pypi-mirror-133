...
class WormGearCompoundSystemDeflection(_2640.GearCompoundSystemDeflection):
    '''WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_338.WormGearDutyCycleRating':
        ...
        return constructor.new(_338.WormGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating is not None else None

    @property
    def worm_duty_cycle_rating(self) -> '_338.WormGearDutyCycleRating':
        ...
        return constructor.new(_338.WormGearDutyCycleRating)(self.wrapped.WormDutyCycleRating) if self.wrapped.WormDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2568.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2568.WormGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2568.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2568.WormGearSystemDeflection))
        return value
