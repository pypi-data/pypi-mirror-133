...
class SpringDamperCompoundSystemDeflection(_2618.CouplingCompoundSystemDeflection):
    '''SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2542.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2542.SpringDamperSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2542.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2542.SpringDamperSystemDeflection))
        return value
