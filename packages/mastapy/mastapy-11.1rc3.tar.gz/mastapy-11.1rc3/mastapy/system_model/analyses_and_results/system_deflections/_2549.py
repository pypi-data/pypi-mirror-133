...
class StraightBevelPlanetGearSystemDeflection(_2545.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3874.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3874.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
