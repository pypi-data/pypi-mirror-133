...
class PlanetaryConnectionSystemDeflection(_2535.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3844.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3844.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
