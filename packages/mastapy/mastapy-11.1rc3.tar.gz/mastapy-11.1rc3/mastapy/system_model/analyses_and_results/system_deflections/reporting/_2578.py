...
from mastapy.system_model.analyses_and_results import _2387
...
class RigidlyConnectedComponentGroupSystemDeflection(_2387.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1312.MassProperties':
        ...
        return constructor.new(_1312.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties is not None else None

    @property
    def components(self) -> 'List[_2445.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2445.ComponentSystemDeflection))
        return value
