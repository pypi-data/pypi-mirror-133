...
from mastapy.system_model.drawing import _1992, _1982
...
class SystemDeflectionDrawStyle(_1982.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1992.ScalingDrawStyle':
        ...
        return constructor.new(_1992.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling is not None else None
