...
class FaceGearMeshSystemDeflection(_2489.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6595.FaceGearMeshLoadCase':
        ...
        return constructor.new(_6595.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase is not None else None

    @property
    def power_flow_results(self) -> '_3814.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3814.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def rating(self) -> '_413.FaceGearMeshRating':
        ...
        return constructor.new(_413.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
