...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2615
...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2615.ConicalGearSetCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2499.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2499.KlingelnbergCycloPalloidConicalGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2499.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2499.KlingelnbergCycloPalloidConicalGearSetSystemDeflection))
        return value
