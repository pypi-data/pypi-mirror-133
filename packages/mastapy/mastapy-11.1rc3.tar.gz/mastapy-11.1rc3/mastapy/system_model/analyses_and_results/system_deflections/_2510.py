...
class MeasurementComponentSystemDeflection(_2565.VirtualComponentSystemDeflection):
    '''MeasurementComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3837.MeasurementComponentPowerFlow':
        ...
        return constructor.new(_3837.MeasurementComponentPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
