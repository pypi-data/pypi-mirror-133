...
class OilSealSystemDeflection(_2458.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3839.OilSealPowerFlow':
        ...
        return constructor.new(_3839.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
