...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2688, _2689, _2599
...
class StraightBevelDiffGearSetCompoundSystemDeflection(_2599.BevelGearSetCompoundSystemDeflection):
    '''StraightBevelDiffGearSetCompoundSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_compound_system_deflection(self) -> 'List[_2688.StraightBevelDiffGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundSystemDeflection, constructor.new(_2688.StraightBevelDiffGearCompoundSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_compound_system_deflection(self) -> 'List[_2689.StraightBevelDiffGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundSystemDeflection, constructor.new(_2689.StraightBevelDiffGearMeshCompoundSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2544.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2544.StraightBevelDiffGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2544.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2544.StraightBevelDiffGearSetSystemDeflection))
        return value
