...
class UnbalancedMassCompoundSystemDeflection(_2705.VirtualComponentCompoundSystemDeflection):
    '''UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2564.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2564.UnbalancedMassSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2564.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2564.UnbalancedMassSystemDeflection))
        return value
