...
from mastapy.math_utility.measured_vectors import _1358, _1354
...
class FEPartSystemDeflection(_2421.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3817.FEPartPowerFlow':
        ...
        return constructor.new(_3817.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1358.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1358.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1354.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1354.ForceAndDisplacementResults))
        return value

    @property
    def export(self) -> '_2146.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2146.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
