...
class BoltedJointSystemDeflection(_2536.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3779.BoltedJointPowerFlow':
        ...
        return constructor.new(_3779.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
