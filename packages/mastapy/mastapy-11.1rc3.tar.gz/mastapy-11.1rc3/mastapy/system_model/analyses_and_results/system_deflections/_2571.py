...
class ZerolBevelGearSystemDeflection(_2438.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3891.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3891.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
