...
class TorqueConverterSystemDeflection(_2461.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3882.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3882.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
