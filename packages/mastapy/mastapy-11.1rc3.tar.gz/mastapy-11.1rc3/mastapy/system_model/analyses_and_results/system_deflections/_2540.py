...
class SpringDamperConnectionSystemDeflection(_2459.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3865.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3865.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
