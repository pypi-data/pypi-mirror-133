...
class BevelDifferentialSunGearCompoundSystemDeflection(_2592.BevelDifferentialGearCompoundSystemDeflection):
    '''BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2435.BevelDifferentialSunGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2435.BevelDifferentialSunGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2435.BevelDifferentialSunGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2435.BevelDifferentialSunGearSystemDeflection))
        return value
