...
class CylindricalGearCompoundSystemDeflection(_2640.GearCompoundSystemDeflection):
    '''CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_418.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_418.CylindricalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating is not None else None

    @property
    def cylindrical_duty_cycle_rating(self) -> '_418.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_418.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalDutyCycleRating) if self.wrapped.CylindricalDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2477.CylindricalGearSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2477.CylindricalGearSystemDeflectionWithLTCAResults))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2477.CylindricalGearSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2477.CylindricalGearSystemDeflectionWithLTCAResults))
        return value
