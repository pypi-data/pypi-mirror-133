...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2444.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3804.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3804.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
