...
from mastapy.system_model.analyses_and_results.power_flows import _3769, _3800
...
class BeltConnectionSystemDeflection(_2497.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.BeltConnectionPowerFlow':
