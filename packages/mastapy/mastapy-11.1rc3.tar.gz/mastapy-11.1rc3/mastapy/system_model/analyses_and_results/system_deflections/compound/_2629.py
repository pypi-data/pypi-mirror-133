...
class CylindricalGearMeshCompoundSystemDeflection(_2641.GearMeshCompoundSystemDeflection):
    '''CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def component_design(self) -> '_2046.CylindricalGearMesh':
        ...
        return constructor.new(_2046.CylindricalGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_430.CylindricalMeshDutyCycleRating':
        ...
        return constructor.new(_430.CylindricalMeshDutyCycleRating)(self.wrapped.CylindricalMeshRating) if self.wrapped.CylindricalMeshRating is not None else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2471.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2471.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2471.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2471.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
