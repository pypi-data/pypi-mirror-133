...
class SynchroniserSleeveSystemDeflection(_2552.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3879.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3879.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
