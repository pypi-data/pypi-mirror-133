...
class ClutchConnectionSystemDeflection(_2459.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3781.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3781.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
