...
class TorqueConverterTurbineCompoundSystemDeflection(_2620.CouplingHalfCompoundSystemDeflection):
    '''TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2561.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2561.TorqueConverterTurbineSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2561.TorqueConverterTurbineSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2561.TorqueConverterTurbineSystemDeflection))
        return value
