...
from mastapy.bearings.bearing_results import _1691
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2580
...
class ShaftHubConnectionSystemDeflection(_2458.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3858.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3858.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1691.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1691.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem is not None else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1691.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1691.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem is not None else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2580.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2580.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2580.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2580.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2580.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2580.SplineFlankContactReporting))
        return value
