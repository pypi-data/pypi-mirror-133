...
from mastapy.system_model.analyses_and_results.power_flows import _3851, _3802
...
class PulleySystemDeflection(_2460.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3851.PulleyPowerFlow':
        ...
        if _3851.PulleyPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
