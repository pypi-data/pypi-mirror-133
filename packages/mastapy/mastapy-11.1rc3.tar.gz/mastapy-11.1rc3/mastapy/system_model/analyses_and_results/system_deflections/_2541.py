...
class SpringDamperHalfSystemDeflection(_2460.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3866.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3866.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
