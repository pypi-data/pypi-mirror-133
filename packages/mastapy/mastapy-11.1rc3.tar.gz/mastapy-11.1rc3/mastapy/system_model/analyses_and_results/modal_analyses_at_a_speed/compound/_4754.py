...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4625
...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtASpeed(_4720.ConicalGearSetCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4625.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4625.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4625.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4625.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed))
        return value
