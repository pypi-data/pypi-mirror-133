...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4666, _4665, _4575
...
class StraightBevelGearSetModalAnalysisAtASpeed(_4575.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4666.StraightBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtASpeed, constructor.new(_4666.StraightBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4665.StraightBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtASpeed, constructor.new(_4665.StraightBevelGearMeshModalAnalysisAtASpeed))
        return value
