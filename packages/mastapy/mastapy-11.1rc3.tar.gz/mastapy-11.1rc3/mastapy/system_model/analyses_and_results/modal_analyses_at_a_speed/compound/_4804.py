...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4674
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4724
...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_4724.CouplingConnectionCompoundModalAnalysisAtASpeed):
    '''TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4674.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4674.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4674.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4674.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value
