...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4677
...
class TorqueConverterTurbineCompoundModalAnalysisAtASpeed(_4725.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''TorqueConverterTurbineCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4677.TorqueConverterTurbineModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4677.TorqueConverterTurbineModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4677.TorqueConverterTurbineModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4677.TorqueConverterTurbineModalAnalysisAtASpeed))
        return value
