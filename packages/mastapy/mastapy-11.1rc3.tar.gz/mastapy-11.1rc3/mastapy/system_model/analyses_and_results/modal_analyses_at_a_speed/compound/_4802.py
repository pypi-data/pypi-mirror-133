...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4673
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4801
...
class SynchroniserSleeveCompoundModalAnalysisAtASpeed(_4801.SynchroniserPartCompoundModalAnalysisAtASpeed):
    '''SynchroniserSleeveCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4673.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4673.SynchroniserSleeveModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4673.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4673.SynchroniserSleeveModalAnalysisAtASpeed))
        return value
