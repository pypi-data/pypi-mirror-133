...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4623
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed(_4719.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4623.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4623.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4623.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4623.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value
