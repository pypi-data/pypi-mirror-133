...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4607
...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_4733.CylindricalGearCompoundModalAnalysisAtASpeed):
    '''CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4607.CylindricalPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4607.CylindricalPlanetGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4607.CylindricalPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4607.CylindricalPlanetGearModalAnalysisAtASpeed))
        return value
