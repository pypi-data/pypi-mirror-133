...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4650
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4725
...
class RollingRingCompoundModalAnalysisAtASpeed(_4725.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''RollingRingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4650.RollingRingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4650.RollingRingModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4650.RollingRingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4650.RollingRingModalAnalysisAtASpeed))
        return value
