...
from mastapy.system_model.analyses_and_results.static_loads import _6582, _6590
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6582.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
