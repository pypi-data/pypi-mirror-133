...
from mastapy.system_model.analyses_and_results import (
    _2381, _2376, _2356, _2367,
    _2375, _2359, _2378, _2370,
    _2360, _2377, _2358, _2364,
    _2418, _2355
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5381, _5382, _5383
from mastapy.system_model.analyses_and_results.static_loads import _6527, _6513
...
class StaticLoadCase(_6513.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2381.SystemDeflectionAnalysis':
        ...
        return constructor.new(_2381.SystemDeflectionAnalysis)(self.wrapped.SystemDeflection) if self.wrapped.SystemDeflection is not None else None

    @property
    def power_flow(self) -> '_2376.PowerFlowAnalysis':
        ...
        return constructor.new(_2376.PowerFlowAnalysis)(self.wrapped.PowerFlow) if self.wrapped.PowerFlow is not None else None

    @property
    def advanced_system_deflection(self) -> '_2356.AdvancedSystemDeflectionAnalysis':
        ...
        return constructor.new(_2356.AdvancedSystemDeflectionAnalysis)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None

    @property
    def harmonic_analysis(self) -> '_2367.HarmonicAnalysis':
        ...
        return constructor.new(_2367.HarmonicAnalysis)(self.wrapped.HarmonicAnalysis) if self.wrapped.HarmonicAnalysis is not None else None

    @property
    def parametric_study_tool(self) -> '_2375.ParametricStudyToolAnalysis':
        ...
        return constructor.new(_2375.ParametricStudyToolAnalysis)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool is not None else None

    @property
    def compound_parametric_study_tool(self) -> '_2359.CompoundParametricStudyToolAnalysis':
        ...
        return constructor.new(_2359.CompoundParametricStudyToolAnalysis)(self.wrapped.CompoundParametricStudyTool) if self.wrapped.CompoundParametricStudyTool is not None else None

    @property
    def steady_state_synchronous_response(self) -> '_2378.SteadyStateSynchronousResponseAnalysis':
        ...
        return constructor.new(_2378.SteadyStateSynchronousResponseAnalysis)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse is not None else None
    ...
    def modal_analysis(self) -> '_2370.ModalAnalysis':
        ...
        return constructor.new(_2370.ModalAnalysis)(self.wrapped.ModalAnalysis) if self.wrapped.ModalAnalysis is not None else None
    ...
    @property
    def dynamic_model_for_modal_analysis(self) -> '_2364.DynamicModelForModalAnalysis':
        ...
        return constructor.new(_2364.DynamicModelForModalAnalysis)(self.wrapped.DynamicModelForModalAnalysis) if self.wrapped.DynamicModelForModalAnalysis is not None else None
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_307.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_307.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6987.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6987.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions is not None else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2418.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2418.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions is not None else None

    @property
    def harmonic_analysis_options(self) -> '_5741.HarmonicAnalysisOptions':
        ...
        if _5741.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptions.__class__.__mro__:
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5741.HarmonicAnalysisOptions':
        ...
        if _5741.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5381.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5381.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5382.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5382.ConceptSynchroGearEngagementStatus))
        return value

    @property
    def design_state_load_case_group(self) -> '_5383.DesignState':
        ...
        return constructor.new(_5383.DesignState)(self.wrapped.DesignStateLoadCaseGroup) if self.wrapped.DesignStateLoadCaseGroup is not None else None

    def analysis_of(self, analysis_type: '_6527.AnalysisType') -> '_2355.SingleAnalysis':
    ...
    def duplicate(self, new_design_state_group: '_5383.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
