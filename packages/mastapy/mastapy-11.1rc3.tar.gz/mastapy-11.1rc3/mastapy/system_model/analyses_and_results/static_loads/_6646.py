...
class PlanetaryGearSetLoadCase(_6574.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1380.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1380.LoadCaseOverrideOption'):
