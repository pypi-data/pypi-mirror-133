...
from mastapy.system_model.analyses_and_results.static_loads import _6622, _6609, _6589
...
class HarmonicLoadDataFluxImport(_6609.HarmonicLoadDataCSVImport['_6589.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6622.InnerDiameterReference':
        ...
        return constructor.new(_6622.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6622.InnerDiameterReference'):
