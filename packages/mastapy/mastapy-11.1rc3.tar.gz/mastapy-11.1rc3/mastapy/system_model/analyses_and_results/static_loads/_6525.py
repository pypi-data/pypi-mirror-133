...
from mastapy.gears.manufacturing.bevel import _748, _746, _747
...
class AGMAGleasonConicalGearSetLoadCase(_6557.ConicalGearSetLoadCase):
    '''AGMAGleasonConicalGearSetLoadCase
    ...
    @property
    def overridden_manufacturing_config_micro_geometry(self) -> '_748.ConicalSetMicroGeometryConfigBase':
        ...
        if _748.ConicalSetMicroGeometryConfigBase.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_manufacturing_config(self) -> '_746.ConicalSetManufacturingConfig':
        ...
        if _746.ConicalSetManufacturingConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_micro_geometry_config(self) -> '_747.ConicalSetMicroGeometryConfig':
        ...
        if _747.ConicalSetMicroGeometryConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
