...
from mastapy.system_model import _1945
...
class ConceptCouplingLoadCase(_6562.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1945.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1945.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value is not None else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1945.ConceptCouplingSpeedRatioSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedRatioSpecificationMethod = value

    @property
    def speed_ratio_vs_time(self) -> '_1328.Vector2DListAccessor':
        ...
        return constructor.new(_1328.Vector2DListAccessor)(self.wrapped.SpeedRatioVsTime) if self.wrapped.SpeedRatioVsTime is not None else None
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1368.PIDControlSettings':
        ...
        return constructor.new(_1368.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl is not None else None
