...
from mastapy.system_model.analyses_and_results.static_loads import _6603, _6608
...
class GearSetHarmonicLoadData(_6608.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6603.GearMeshTEOrderType':
        ...
        return constructor.new(_6603.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6603.GearMeshTEOrderType'):
    ...
    def reference_shaft(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.ReferenceShaft) if self.wrapped.ReferenceShaft is not None else None
