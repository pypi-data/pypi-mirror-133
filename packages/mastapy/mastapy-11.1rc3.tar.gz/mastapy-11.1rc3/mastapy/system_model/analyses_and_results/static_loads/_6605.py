...
class GearSetLoadCase(_6665.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5159.GearMeshStiffnessModel':
        ...
        return constructor.new(_5159.GearMeshStiffnessModel)(value) if value is not None else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5159.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6725.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6725.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions is not None else None

    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6602.GearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesWithoutPlanetaryDuplicates, constructor.new(_6602.GearMeshLoadCase))
        return value

    @property
    def gears(self) -> 'List[_6600.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6600.GearLoadCase))
        return value

    @property
    def gears_without_clones(self) -> 'List[_6600.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsWithoutClones, constructor.new(_6600.GearLoadCase))
        return value
