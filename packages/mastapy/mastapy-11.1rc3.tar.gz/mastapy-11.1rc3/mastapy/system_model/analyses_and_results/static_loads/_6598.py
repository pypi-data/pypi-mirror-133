...
class FlexiblePinAssemblyLoadCase(_6665.SpecialisedAssemblyLoadCase):
    '''FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1380.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1380.LoadCaseOverrideOption'):
