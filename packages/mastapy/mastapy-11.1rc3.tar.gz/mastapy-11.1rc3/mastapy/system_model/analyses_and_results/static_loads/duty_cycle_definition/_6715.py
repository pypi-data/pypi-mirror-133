...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6705, _6716, _6707, _6704,
    _6708, _6710, _6717, _6714,
    _6706, _6709, _6703
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6620.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6620.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6620.ImportType'):
    ...
    @property
    def torque_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.TorqueChart.__class__.__mro__:
    ...
    @property
    def speed_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.SpeedChart.__class__.__mro__:
    ...
    @property
    def force_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.ForceChart.__class__.__mro__:
    ...
    @property
    def moment_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.MomentChart.__class__.__mro__:
    ...
    @property
    def boost_pressure_chart(self) -> '_1621.TwoDChartDefinition':
        ...
        if _1621.TwoDChartDefinition.TYPE not in self.wrapped.BoostPressureChart.__class__.__mro__:
    ...
    @property
    def time_step_input(self) -> '_6716.TimeStepInputOptions':
        ...
        return constructor.new(_6716.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput is not None else None

    @property
    def gear_ratio_options(self) -> '_6707.GearRatioInputOptions':
        ...
        return constructor.new(_6707.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions is not None else None

    @property
    def design_state_options(self) -> '_6704.DesignStateOptions':
        ...
        return constructor.new(_6704.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions is not None else None

    @property
    def load_case_name_inputs(self) -> '_6708.LoadCaseNameOptions':
        ...
        return constructor.new(_6708.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs is not None else None

    @property
    def file_inputs(self) -> 'List[_6710.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6710.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6717.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6717.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6714.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6714.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6706.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6706.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6709.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6709.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6703.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6703.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1581.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1581.ColumnTitle))
        return value
