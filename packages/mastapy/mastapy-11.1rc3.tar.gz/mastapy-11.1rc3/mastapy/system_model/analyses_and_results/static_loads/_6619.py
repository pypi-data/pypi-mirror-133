...
from mastapy.system_model.analyses_and_results.static_loads import _6617, _6618, _6525
...
class HypoidGearSetLoadCase(_6525.AGMAGleasonConicalGearSetLoadCase):
    '''HypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6617.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6617.HypoidGearLoadCase))
        return value

    @property
    def hypoid_gears_load_case(self) -> 'List[_6617.HypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsLoadCase, constructor.new(_6617.HypoidGearLoadCase))
        return value

    @property
    def hypoid_meshes_load_case(self) -> 'List[_6618.HypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesLoadCase, constructor.new(_6618.HypoidGearMeshLoadCase))
        return value
