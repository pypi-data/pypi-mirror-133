...
from mastapy.system_model.analyses_and_results.static_loads import _6526, _6637
...
class RingPinsLoadCase(_6637.MountableComponentLoadCase):
    '''RingPinsLoadCase
    ...
    @property
    def all_ring_pins_manufacturing_error(self) -> '_6526.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6526.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError is not None else None
