...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5843, _5849
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5849.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5843.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5843.ResultsForOrderIncludingSurfaces))
        return value
