...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5842, _5825
...
class SingleWhineAnalysisResultsPropertyAccessor(_5825.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5842.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5842.ResultsForOrderIncludingNodes))
        return value
