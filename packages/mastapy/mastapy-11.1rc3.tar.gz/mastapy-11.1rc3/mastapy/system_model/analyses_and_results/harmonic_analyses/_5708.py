...
from mastapy.system_model.analyses_and_results.system_deflections import _2472, _2473, _2474
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5706, _5707, _5735
...
class CylindricalGearSetHarmonicAnalysis(_5735.GearSetHarmonicAnalysis):
    '''CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2472.CylindricalGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5706.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsHarmonicAnalysis, constructor.new(_5706.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5706.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysis, constructor.new(_5706.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def meshes_harmonic_analysis(self) -> 'List[_5707.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesHarmonicAnalysis, constructor.new(_5707.CylindricalGearMeshHarmonicAnalysis))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5707.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysis, constructor.new(_5707.CylindricalGearMeshHarmonicAnalysis))
        return value
