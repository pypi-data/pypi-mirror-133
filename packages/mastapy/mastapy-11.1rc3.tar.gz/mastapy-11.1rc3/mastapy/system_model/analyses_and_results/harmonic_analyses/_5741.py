...
from mastapy.system_model.analyses_and_results.modal_analyses import _4896
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5783, _5729
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    def number_of_harmonics(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.NumberOfHarmonics) if self.wrapped.NumberOfHarmonics is not None else None
    ...
    @property
    def excitation_selection(self) -> '_5818.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5818.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None

    @property
    def modal_analysis_options(self) -> '_4896.ModalAnalysisOptions':
        ...
        return constructor.new(_4896.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None
