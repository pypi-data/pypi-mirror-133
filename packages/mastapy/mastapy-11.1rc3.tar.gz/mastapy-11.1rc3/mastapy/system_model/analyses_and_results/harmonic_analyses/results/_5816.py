...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5819, _5817
...
class ExcitationSourceSelection(_5817.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5819.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5819.HarmonicSelection))
        return value
