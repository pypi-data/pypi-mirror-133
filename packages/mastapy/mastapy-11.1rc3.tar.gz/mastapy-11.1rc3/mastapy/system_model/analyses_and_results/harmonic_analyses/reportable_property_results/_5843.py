...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5835, _5842
...
class ResultsForOrderIncludingSurfaces(_5842.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5835.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5835.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
