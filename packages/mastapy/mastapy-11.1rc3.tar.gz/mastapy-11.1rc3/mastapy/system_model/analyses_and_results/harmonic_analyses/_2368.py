...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2367
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2367.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
