...
from mastapy.system_model.analyses_and_results.modal_analyses import _4827, _4826, _4833
...
class BevelDifferentialGearSetModalAnalysis(_4833.BevelGearSetModalAnalysis):
    '''BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4827.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysis, constructor.new(_4827.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4826.BevelDifferentialGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysis, constructor.new(_4826.BevelDifferentialGearMeshModalAnalysis))
        return value
