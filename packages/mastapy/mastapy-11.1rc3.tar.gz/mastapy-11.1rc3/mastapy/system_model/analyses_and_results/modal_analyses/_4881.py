...
from mastapy.system_model.analyses_and_results.modal_analyses import _4880, _4879, _4821
...
class HypoidGearSetModalAnalysis(_4821.AGMAGleasonConicalGearSetModalAnalysis):
    '''HypoidGearSetModalAnalysis
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4880.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4880.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4879.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4879.HypoidGearMeshModalAnalysis))
        return value
