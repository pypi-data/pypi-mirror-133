...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4958
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_0.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4958.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4958.ComponentPerModeResult))
        return value
