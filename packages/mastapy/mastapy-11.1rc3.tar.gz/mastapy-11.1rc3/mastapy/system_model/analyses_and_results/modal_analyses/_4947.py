...
from mastapy.system_model.analyses_and_results.modal_analyses import _4948
...
class WhineWaterfallReferenceValues(_4948.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
