...
from mastapy.system_model.analyses_and_results.modal_analyses import _4931
...
class StraightBevelGearCompoundModalAnalysis(_4984.BevelGearCompoundModalAnalysis):
    '''StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4931.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4931.StraightBevelGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4931.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4931.StraightBevelGearModalAnalysis))
        return value
