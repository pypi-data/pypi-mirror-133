...
from mastapy.system_model.analyses_and_results.modal_analyses import _4892
...
class MassDiscCompoundModalAnalysis(_5090.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4892.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4892.MassDiscModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4892.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4892.MassDiscModalAnalysis))
        return value
