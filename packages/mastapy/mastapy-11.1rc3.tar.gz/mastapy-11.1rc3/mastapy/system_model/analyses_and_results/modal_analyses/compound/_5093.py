...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5091, _5092, _5028
from mastapy.system_model.analyses_and_results.modal_analyses import _4952
...
class WormGearSetCompoundModalAnalysis(_5028.GearSetCompoundModalAnalysis):
    '''WormGearSetCompoundModalAnalysis
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_5091.WormGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundModalAnalysis, constructor.new(_5091.WormGearCompoundModalAnalysis))
        return value

    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_5092.WormGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundModalAnalysis, constructor.new(_5092.WormGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4952.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4952.WormGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4952.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4952.WormGearSetModalAnalysis))
        return value
