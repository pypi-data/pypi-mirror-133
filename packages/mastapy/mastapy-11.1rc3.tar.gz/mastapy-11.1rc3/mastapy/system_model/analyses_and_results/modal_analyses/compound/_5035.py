...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_5001.ConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4883.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4883.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4883.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4883.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value
