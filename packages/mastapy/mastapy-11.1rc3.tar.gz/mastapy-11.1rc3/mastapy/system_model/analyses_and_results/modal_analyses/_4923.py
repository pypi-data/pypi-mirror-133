...
from mastapy.system_model.analyses_and_results.modal_analyses import _4922, _4921, _4833
...
class SpiralBevelGearSetModalAnalysis(_4833.BevelGearSetModalAnalysis):
    '''SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4922.SpiralBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysis, constructor.new(_4922.SpiralBevelGearModalAnalysis))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4921.SpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysis, constructor.new(_4921.SpiralBevelGearMeshModalAnalysis))
        return value
