...
from mastapy.system_model.analyses_and_results.modal_analyses import _2370, _4822
...
class RootAssemblyModalAnalysis(_4822.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2370.ModalAnalysis':
        ...
        if _2370.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ModalAnalysisInputs.__class__)(self.wrapped.ModalAnalysisInputs) if self.wrapped.ModalAnalysisInputs is not None else None
