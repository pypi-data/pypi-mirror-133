...
class PerModeResultsReport(_1524.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1584.TableAndChartOptions':
    ...
    def display_option(self, value: '_1584.TableAndChartOptions'):
