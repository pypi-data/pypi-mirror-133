...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5021, _5022, _5028
...
class FaceGearSetCompoundModalAnalysis(_5028.GearSetCompoundModalAnalysis):
    '''FaceGearSetCompoundModalAnalysis
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_5021.FaceGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundModalAnalysis, constructor.new(_5021.FaceGearCompoundModalAnalysis))
        return value

    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_5022.FaceGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundModalAnalysis, constructor.new(_5022.FaceGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4871.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4871.FaceGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4871.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4871.FaceGearSetModalAnalysis))
        return value
