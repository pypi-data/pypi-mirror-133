...
class BoltedJointCompoundModalAnalysis(_5066.SpecialisedAssemblyCompoundModalAnalysis):
    '''BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4834.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4834.BoltedJointModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4834.BoltedJointModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4834.BoltedJointModalAnalysis))
        return value
