...
from mastapy.utility.modal_analysis import _1562
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2387.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1562.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1562.DesignEntityExcitationDescription))
        return value
