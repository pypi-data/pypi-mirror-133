...
from mastapy.system_model.analyses_and_results.modal_analyses import _4954
...
class ZerolBevelGearCompoundModalAnalysis(_4984.BevelGearCompoundModalAnalysis):
    '''ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4954.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4954.ZerolBevelGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4954.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4954.ZerolBevelGearModalAnalysis))
        return value
