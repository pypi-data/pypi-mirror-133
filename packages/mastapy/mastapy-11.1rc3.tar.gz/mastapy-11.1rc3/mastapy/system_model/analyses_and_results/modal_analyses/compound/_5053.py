...
from mastapy.system_model.analyses_and_results.modal_analyses import _4906
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5045
...
class PlanetCarrierCompoundModalAnalysis(_5045.MountableComponentCompoundModalAnalysis):
    '''PlanetCarrierCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4906.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4906.PlanetCarrierModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4906.PlanetCarrierModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4906.PlanetCarrierModalAnalysis))
        return value
