...
class RingPinsCompoundPowerFlow(_3970.MountableComponentCompoundPowerFlow):
    '''RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3852.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3852.RingPinsPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3852.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3852.RingPinsPowerFlow))
        return value
