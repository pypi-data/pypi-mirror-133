...
from mastapy.system_model.analyses_and_results.power_flows import _3815, _3814, _3821
...
class FaceGearSetPowerFlow(_3821.GearSetPowerFlow):
    '''FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3815.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3815.FaceGearPowerFlow))
        return value

    @property
    def face_gears_power_flow(self) -> 'List[_3815.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsPowerFlow, constructor.new(_3815.FaceGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3814.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3814.FaceGearMeshPowerFlow))
        return value

    @property
    def face_meshes_power_flow(self) -> 'List[_3814.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesPowerFlow, constructor.new(_3814.FaceGearMeshPowerFlow))
        return value
