...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3925
...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3925.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3828.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3828.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3828.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3828.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value
