...
from mastapy.system_model.analyses_and_results.power_flows import _3880, _3826
...
class GearMeshPowerFlow(_3826.InterMountableComponentConnectionPowerFlow):
    '''GearMeshPowerFlow
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3880.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3880.ToothPassingHarmonic))
        return value
