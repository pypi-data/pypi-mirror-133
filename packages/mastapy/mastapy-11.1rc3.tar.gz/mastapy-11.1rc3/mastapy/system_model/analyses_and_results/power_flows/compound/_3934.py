...
class CVTCompoundPowerFlow(_3903.BeltDriveCompoundPowerFlow):
    '''CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3801.CVTPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3801.CVTPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3801.CVTPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3801.CVTPowerFlow))
        return value
