...
class ExternalCADModelCompoundPowerFlow(_3918.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3813.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3813.ExternalCADModelPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3813.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3813.ExternalCADModelPowerFlow))
        return value
