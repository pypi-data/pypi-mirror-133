...
class PartCompoundPowerFlow(_7258.PartCompoundAnalysis):
    '''PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3840.PartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3840.PartPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3840.PartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3840.PartPowerFlow))
        return value
