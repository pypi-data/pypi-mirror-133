...
class CylindricalGearCompoundPowerFlow(_3951.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_418.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_418.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3809.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3809.CylindricalGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3809.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3809.CylindricalGearPowerFlow))
        return value
