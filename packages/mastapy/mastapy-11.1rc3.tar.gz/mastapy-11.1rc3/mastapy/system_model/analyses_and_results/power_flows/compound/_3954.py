...
class GuideDxfModelCompoundPowerFlow(_3918.ComponentCompoundPowerFlow):
    '''GuideDxfModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3822.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3822.GuideDxfModelPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3822.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3822.GuideDxfModelPowerFlow))
        return value
