...
class FlexiblePinAssemblyCompoundPowerFlow(_3991.SpecialisedAssemblyCompoundPowerFlow):
    '''FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3818.FlexiblePinAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3818.FlexiblePinAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3818.FlexiblePinAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3818.FlexiblePinAssemblyPowerFlow))
        return value
