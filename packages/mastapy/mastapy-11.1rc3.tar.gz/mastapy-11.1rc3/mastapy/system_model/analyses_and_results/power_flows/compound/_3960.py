...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_3926.ConicalGearMeshCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3827.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3827.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3827.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3827.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value
