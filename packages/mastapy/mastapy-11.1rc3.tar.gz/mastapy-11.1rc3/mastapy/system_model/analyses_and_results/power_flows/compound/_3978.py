...
class PlanetCarrierCompoundPowerFlow(_3970.MountableComponentCompoundPowerFlow):
    '''PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3846.PlanetCarrierPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3846.PlanetCarrierPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3846.PlanetCarrierPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3846.PlanetCarrierPowerFlow))
        return value
