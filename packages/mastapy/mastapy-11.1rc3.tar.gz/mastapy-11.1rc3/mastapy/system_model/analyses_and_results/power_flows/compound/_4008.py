...
class SynchroniserPartCompoundPowerFlow(_3932.CouplingHalfCompoundPowerFlow):
    '''SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3877.SynchroniserPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3877.SynchroniserPartPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3877.SynchroniserPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3877.SynchroniserPartPowerFlow))
        return value
