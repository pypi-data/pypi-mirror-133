...
class BevelDifferentialSunGearCompoundPowerFlow(_3904.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3775.BevelDifferentialSunGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3775.BevelDifferentialSunGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3775.BevelDifferentialSunGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3775.BevelDifferentialSunGearPowerFlow))
        return value
