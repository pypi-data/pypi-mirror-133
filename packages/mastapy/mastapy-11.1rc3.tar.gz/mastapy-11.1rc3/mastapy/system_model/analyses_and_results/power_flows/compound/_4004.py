...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3998
...
class StraightBevelPlanetGearCompoundPowerFlow(_3998.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3874.StraightBevelPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3874.StraightBevelPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3874.StraightBevelPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3874.StraightBevelPlanetGearPowerFlow))
        return value
