...
from mastapy.system_model.analyses_and_results.power_flows import _3872
...
class StraightBevelGearCompoundPowerFlow(_3909.BevelGearCompoundPowerFlow):
    '''StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3872.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3872.StraightBevelGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3872.StraightBevelGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3872.StraightBevelGearPowerFlow))
        return value
