...
class PulleyMultibodyDynamicsAnalysis(_5138.CouplingHalfMultibodyDynamicsAnalysis):
    '''PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5246.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5246.DynamicTorqueResultAtTime))
        return value
