...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5245, _5247
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5136.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5245.DynamicForceVector3DResult':
        ...
        return constructor.new(_5245.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce is not None else None

    @property
    def peak_dynamic_force_angular(self) -> '_5247.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5247.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular is not None else None
