...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5253.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    '''BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5116.BevelGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5116.BevelGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5116.BevelGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5116.BevelGearMultibodyDynamicsAnalysis))
        return value
