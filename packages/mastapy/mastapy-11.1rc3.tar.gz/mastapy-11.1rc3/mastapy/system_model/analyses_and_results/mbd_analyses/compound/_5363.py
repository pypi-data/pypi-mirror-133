...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5224
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5364
...
class SynchroniserHalfCompoundMultibodyDynamicsAnalysis(_5364.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    '''SynchroniserHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5224.SynchroniserHalfMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5224.SynchroniserHalfMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5224.SynchroniserHalfMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5224.SynchroniserHalfMultibodyDynamicsAnalysis))
        return value
