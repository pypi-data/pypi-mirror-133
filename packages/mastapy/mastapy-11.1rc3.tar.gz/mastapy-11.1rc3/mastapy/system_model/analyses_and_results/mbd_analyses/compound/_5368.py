...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5231
...
class TorqueConverterPumpCompoundMultibodyDynamicsAnalysis(_5288.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    '''TorqueConverterPumpCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5231.TorqueConverterPumpMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5231.TorqueConverterPumpMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5231.TorqueConverterPumpMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5231.TorqueConverterPumpMultibodyDynamicsAnalysis))
        return value
