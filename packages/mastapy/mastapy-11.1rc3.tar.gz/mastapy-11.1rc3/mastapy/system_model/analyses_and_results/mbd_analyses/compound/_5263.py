...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5260.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    '''BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5113.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5113.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5113.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5113.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value
