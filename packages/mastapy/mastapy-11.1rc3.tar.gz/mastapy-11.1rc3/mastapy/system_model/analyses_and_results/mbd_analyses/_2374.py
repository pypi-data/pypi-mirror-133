...
from mastapy.system_model.analyses_and_results.analysis_cases import _7263
...
class MultibodyDynamicsAnalysis(_7263.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5182.MBDAnalysisOptions':
        ...
        return constructor.new(_5182.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions is not None else None
