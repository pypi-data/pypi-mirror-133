...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5120, _5139
...
class ClutchMultibodyDynamicsAnalysis(_5139.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5120.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5120.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection is not None else None
