...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5232, _5137
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5137.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5232.TorqueConverterStatus':
        ...
        return constructor.new(_5232.TorqueConverterStatus)(value) if value is not None else None
