...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4179
...
class CVTCompoundParametricStudyTool(_4179.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4063.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4063.CVTParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4063.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4063.CVTParametricStudyTool))
        return value
