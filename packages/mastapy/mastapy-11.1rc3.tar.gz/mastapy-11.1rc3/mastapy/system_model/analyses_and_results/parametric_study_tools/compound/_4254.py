...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4125
...
class PlanetCarrierCompoundParametricStudyTool(_4246.MountableComponentCompoundParametricStudyTool):
    '''PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4125.PlanetCarrierParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4125.PlanetCarrierParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4125.PlanetCarrierParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4125.PlanetCarrierParametricStudyTool))
        return value
