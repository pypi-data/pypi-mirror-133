...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4140, _4139, _4040
...
class SpiralBevelGearSetParametricStudyTool(_4040.BevelGearSetParametricStudyTool):
    '''SpiralBevelGearSetParametricStudyTool
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4140.SpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsParametricStudyTool, constructor.new(_4140.SpiralBevelGearParametricStudyTool))
        return value

    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4139.SpiralBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesParametricStudyTool, constructor.new(_4139.SpiralBevelGearMeshParametricStudyTool))
        return value
