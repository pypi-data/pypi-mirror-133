...
class SpringDamperConnectionCompoundParametricStudyTool(_4207.CouplingConnectionCompoundParametricStudyTool):
    '''SpringDamperConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4142.SpringDamperConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4142.SpringDamperConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4142.SpringDamperConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4142.SpringDamperConnectionParametricStudyTool))
        return value
