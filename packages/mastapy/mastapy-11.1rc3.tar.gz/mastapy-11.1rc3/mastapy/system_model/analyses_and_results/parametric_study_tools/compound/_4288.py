...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4159
...
class TorqueConverterPumpCompoundParametricStudyTool(_4208.CouplingHalfCompoundParametricStudyTool):
    '''TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4159.TorqueConverterPumpParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4159.TorqueConverterPumpParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4159.TorqueConverterPumpParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4159.TorqueConverterPumpParametricStudyTool))
        return value
