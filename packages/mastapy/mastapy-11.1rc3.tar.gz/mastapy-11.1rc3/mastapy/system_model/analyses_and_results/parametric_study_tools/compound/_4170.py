...
class AbstractShaftCompoundParametricStudyTool(_4171.AbstractShaftOrHousingCompoundParametricStudyTool):
    '''AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4024.AbstractShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4024.AbstractShaftParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4024.AbstractShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4024.AbstractShaftParametricStudyTool))
        return value
