...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4164, _4163, _4089
...
class WormGearSetParametricStudyTool(_4089.GearSetParametricStudyTool):
    '''WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4164.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsParametricStudyTool, constructor.new(_4164.WormGearParametricStudyTool))
        return value

    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4163.WormGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesParametricStudyTool, constructor.new(_4163.WormGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2567.WormGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2567.WormGearSetSystemDeflection))
        return value
