...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4109, _4106, _4074
...
class ParametricStudyVariable(_2383.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4109.ParametricStudyDimension':
        ...
        return constructor.new(_4109.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4109.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4106.MonteCarloDistribution':
        ...
        return constructor.new(_4106.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4106.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def group(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.Group) if self.wrapped.Group is not None else None
    ...
    def mean_value_in_si_units(self) -> 'float':
        ...
        return self.wrapped.MeanValueInSIUnits
    ...
    def standard_deviation_in_si_units(self) -> 'float':
        ...
        return self.wrapped.StandardDeviationInSIUnits
    ...
    def start_value_in_si_units(self) -> 'float':
        ...
        return self.wrapped.StartValueInSIUnits
    ...
    def end_value_in_si_units(self) -> 'float':
        ...
        return self.wrapped.EndValueInSIUnits
    ...
    @property
    def doe_variable_setter(self) -> '_4074.DesignOfExperimentsVariableSetter':
        ...
        return constructor.new(_4074.DesignOfExperimentsVariableSetter)(self.wrapped.DOEVariableSetter) if self.wrapped.DOEVariableSetter is not None else None
