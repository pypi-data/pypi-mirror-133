...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4246
...
class GearCompoundParametricStudyTool(_4246.MountableComponentCompoundParametricStudyTool):
    '''GearCompoundParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results_of_type_conical_gear_duty_cycle_rating(self) -> '_493.ConicalGearDutyCycleRating':
        ...
        if _493.ConicalGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_concept_gear_duty_cycle_rating(self) -> '_503.ConceptGearDutyCycleRating':
        ...
        if _503.ConceptGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4088.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4088.GearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4088.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4088.GearParametricStudyTool))
        return value
