...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4083, _4082, _4089
...
class FaceGearSetParametricStudyTool(_4089.GearSetParametricStudyTool):
    '''FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4083.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsParametricStudyTool, constructor.new(_4083.FaceGearParametricStudyTool))
        return value

    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4082.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesParametricStudyTool, constructor.new(_4082.FaceGearMeshParametricStudyTool))
        return value
