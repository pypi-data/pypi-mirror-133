...
class BevelGearCompoundParametricStudyTool(_4173.AGMAGleasonConicalGearCompoundParametricStudyTool):
    '''BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4039.BevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4039.BevelGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4039.BevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4039.BevelGearParametricStudyTool))
        return value
