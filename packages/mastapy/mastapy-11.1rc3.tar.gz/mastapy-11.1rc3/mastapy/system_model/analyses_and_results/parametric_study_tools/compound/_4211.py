...
class CVTPulleyCompoundParametricStudyTool(_4257.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4064.CVTPulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4064.CVTPulleyParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4064.CVTPulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4064.CVTPulleyParametricStudyTool))
        return value
