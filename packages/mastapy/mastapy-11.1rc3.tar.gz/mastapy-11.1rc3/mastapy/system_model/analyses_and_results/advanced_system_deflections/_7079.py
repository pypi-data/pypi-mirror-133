...
class RollingRingAdvancedSystemDeflection(_7025.CouplingHalfAdvancedSystemDeflection):
    '''RollingRingAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2529.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2529.RollingRingSystemDeflection))
        return value
