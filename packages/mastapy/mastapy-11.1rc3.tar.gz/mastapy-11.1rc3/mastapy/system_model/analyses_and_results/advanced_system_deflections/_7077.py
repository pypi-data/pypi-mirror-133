...
class RingPinsAdvancedSystemDeflection(_7065.MountableComponentAdvancedSystemDeflection):
    '''RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2524.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2524.RingPinsSystemDeflection))
        return value
