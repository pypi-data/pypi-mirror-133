...
class ShaftHubConnectionAdvancedSystemDeflection(_7021.ConnectorAdvancedSystemDeflection):
    '''ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2531.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2531.ShaftHubConnectionSystemDeflection))
        return value
