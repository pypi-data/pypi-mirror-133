...
class DatumAdvancedSystemDeflection(_7010.ComponentAdvancedSystemDeflection):
    '''DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2481.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2481.DatumSystemDeflection))
        return value
