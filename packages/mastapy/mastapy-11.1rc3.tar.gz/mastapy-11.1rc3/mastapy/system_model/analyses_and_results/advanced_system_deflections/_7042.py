...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7040, _7041, _7047
...
class FaceGearSetAdvancedSystemDeflection(_7047.GearSetAdvancedSystemDeflection):
    '''FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7040.FaceGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsAdvancedSystemDeflection, constructor.new(_7040.FaceGearAdvancedSystemDeflection))
        return value

    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7041.FaceGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesAdvancedSystemDeflection, constructor.new(_7041.FaceGearMeshAdvancedSystemDeflection))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2485.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2485.FaceGearSetSystemDeflection))
        return value
