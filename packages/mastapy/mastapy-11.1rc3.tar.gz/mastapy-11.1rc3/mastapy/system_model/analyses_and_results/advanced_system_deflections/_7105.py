...
class TorqueConverterAdvancedSystemDeflection(_7023.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2560.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2560.TorqueConverterSystemDeflection))
        return value
