...
class SpiralBevelGearAdvancedSystemDeflection(_7001.BevelGearAdvancedSystemDeflection):
    '''SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2539.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2539.SpiralBevelGearSystemDeflection))
        return value
