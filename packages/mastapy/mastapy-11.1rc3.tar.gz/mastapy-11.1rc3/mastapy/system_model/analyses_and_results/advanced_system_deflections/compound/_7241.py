...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7112
...
class WormGearCompoundAdvancedSystemDeflection(_7176.GearCompoundAdvancedSystemDeflection):
    '''WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_338.WormGearDutyCycleRating':
        ...
        return constructor.new(_338.WormGearDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating is not None else None

    @property
    def worm_gear_duty_cycle_rating(self) -> '_338.WormGearDutyCycleRating':
        ...
        return constructor.new(_338.WormGearDutyCycleRating)(self.wrapped.WormGearDutyCycleRating) if self.wrapped.WormGearDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7112.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7112.WormGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7112.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7112.WormGearAdvancedSystemDeflection))
        return value
