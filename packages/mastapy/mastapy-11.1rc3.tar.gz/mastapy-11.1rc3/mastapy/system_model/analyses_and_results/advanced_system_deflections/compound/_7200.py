...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7070
...
class PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection(_7157.CouplingHalfCompoundAdvancedSystemDeflection):
    '''PartToPartShearCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7070.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7070.PartToPartShearCouplingHalfAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7070.PartToPartShearCouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7070.PartToPartShearCouplingHalfAdvancedSystemDeflection))
        return value
