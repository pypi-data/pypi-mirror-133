...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7152
...
class KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection(_7152.ConicalGearSetCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7055.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7055.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7055.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7055.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value
