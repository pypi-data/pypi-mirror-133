...
class ConceptGearMeshAdvancedSystemDeflection(_7046.GearMeshAdvancedSystemDeflection):
    '''ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2450.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2450.ConceptGearMeshSystemDeflection))
        return value
