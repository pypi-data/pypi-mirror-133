...
class TransmissionErrorToOtherPowerLoad(_0.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1307.FourierSeries':
        ...
        return constructor.new(_1307.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE is not None else None
