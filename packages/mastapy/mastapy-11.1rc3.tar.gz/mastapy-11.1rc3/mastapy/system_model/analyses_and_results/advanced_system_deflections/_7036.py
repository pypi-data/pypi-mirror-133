...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7033, _7037, _7034
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7033.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7033.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__)(self.wrapped.CylindricalGearAdvancedSystemDeflection) if self.wrapped.CylindricalGearAdvancedSystemDeflection is not None else None

    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7033.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7033.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__)(self.wrapped.OtherCylindricalGearAdvancedSystemDeflection) if self.wrapped.OtherCylindricalGearAdvancedSystemDeflection is not None else None

    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7034.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7034.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.CylindricalGearMeshAdvancedSystemDeflection) if self.wrapped.CylindricalGearMeshAdvancedSystemDeflection is not None else None
