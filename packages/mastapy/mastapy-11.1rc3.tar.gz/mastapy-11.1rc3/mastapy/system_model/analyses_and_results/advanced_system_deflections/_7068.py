...
class PartToPartShearCouplingAdvancedSystemDeflection(_7023.CouplingAdvancedSystemDeflection):
    '''PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2518.PartToPartShearCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2518.PartToPartShearCouplingSystemDeflection))
        return value
