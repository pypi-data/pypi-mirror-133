...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3102.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3070.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3070.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3070.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3070.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed))
        return value
