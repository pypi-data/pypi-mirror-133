...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3077, _2979
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(_2979.AssemblySteadyStateSynchronousResponseAtASpeed):
    '''RootAssemblySteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def steady_state_synchronous_response_at_a_speed_inputs(self) -> '_3077.SteadyStateSynchronousResponseAtASpeed':
        ...
        return constructor.new(_3077.SteadyStateSynchronousResponseAtASpeed)(self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs) if self.wrapped.SteadyStateSynchronousResponseAtASpeedInputs is not None else None
