...
TReal = TypeVar('TReal', bound='_2181.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6546.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5397.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
    ...
    def component_load_cases(self) -> 'List[TComponentStaticLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentLoadCases)
        return value
