...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5397
...
TAssembly = TypeVar('TAssembly', bound='_2172.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6516.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5397.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
    ...
    def assembly_load_cases(self) -> 'List[TAssemblyStaticLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyLoadCases)
        return value
