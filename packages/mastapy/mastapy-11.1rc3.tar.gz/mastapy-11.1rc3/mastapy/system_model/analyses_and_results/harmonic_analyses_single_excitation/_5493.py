...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5460, _5405
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5405.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5460.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5460.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs is not None else None
