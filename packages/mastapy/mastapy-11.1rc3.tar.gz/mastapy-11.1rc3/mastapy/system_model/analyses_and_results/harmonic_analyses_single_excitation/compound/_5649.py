...
class UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation(_5650.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5520.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5520.UnbalancedMassHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5520.UnbalancedMassHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5520.UnbalancedMassHarmonicAnalysisOfSingleExcitation))
        return value
