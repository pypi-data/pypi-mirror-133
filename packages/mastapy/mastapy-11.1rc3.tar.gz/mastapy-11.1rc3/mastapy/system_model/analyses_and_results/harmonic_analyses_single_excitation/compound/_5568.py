...
class CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5537.BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5438.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5438.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5438.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5438.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value
