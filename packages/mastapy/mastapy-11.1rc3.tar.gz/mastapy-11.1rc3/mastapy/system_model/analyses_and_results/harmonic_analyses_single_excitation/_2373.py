...
class ModalAnalysisForHarmonicAnalysis(_2370.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5741.HarmonicAnalysisOptions':
        ...
        if _5741.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
