...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_5553.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5450.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5450.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5450.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5450.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value
