...
class MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation(_5650.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5475.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5475.MeasurementComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5475.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5475.MeasurementComponentHarmonicAnalysisOfSingleExcitation))
        return value
