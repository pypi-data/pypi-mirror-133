...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5483
...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5577.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5483.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5483.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5483.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5483.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation))
        return value
