...
class CylindricalGearMeshHarmonicAnalysisOfSingleExcitation(_5457.GearMeshHarmonicAnalysisOfSingleExcitation):
    '''CylindricalGearMeshHarmonicAnalysisOfSingleExcitation
    ...
    def planetaries(self) -> 'List[CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(CylindricalGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
