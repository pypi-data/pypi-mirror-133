...
from mastapy.system_model.part_model.gears import _2261, _2277, _2260
...
class CylindricalGearMesh(_2050.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2261.CylindricalGearSet':
        ...
        if _2261.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1359.ShortLengthRange':
        ...
        return constructor.new(_1359.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange is not None else None

    @property
    def cylindrical_gear_mesh_design(self) -> '_971.CylindricalGearMeshDesign':
        ...
        return constructor.new(_971.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign is not None else None
