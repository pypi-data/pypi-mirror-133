...
class HypoidGearMesh(_2036.AGMAGleasonConicalGearMesh):
    '''HypoidGearMesh
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_938.HypoidGearMeshDesign':
        ...
        return constructor.new(_938.HypoidGearMeshDesign)(self.wrapped.HypoidGearMeshDesign) if self.wrapped.HypoidGearMeshDesign is not None else None
