...
class ConceptGearMesh(_2050.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1119.ConceptGearMeshDesign':
        ...
        return constructor.new(_1119.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign is not None else None
