...
class PowerFlowViewable(_0.APIBase):
    ...
    @property
    def draw_style(self) -> '_3849.PowerFlowDrawStyle':
        ...
        if _3849.PowerFlowDrawStyle.TYPE not in self.wrapped.DrawStyle.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.DrawStyle.__class__)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle is not None else None
