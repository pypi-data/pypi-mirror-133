...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self) -> '_3754.RotorDynamicsDrawStyle':
        ...
        if _3754.RotorDynamicsDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.RotorDynamics.__class__)(self.wrapped.RotorDynamics) if self.wrapped.RotorDynamics is not None else None

    @property
    def rotor_dynamics_of_type_steady_state_synchronous_response_draw_style(self) -> '_3338.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3338.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_stability_analysis_draw_style(self) -> '_3599.StabilityAnalysisDrawStyle':
        ...
        if _3599.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_critical_speed_analysis_draw_style(self) -> '_6293.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6293.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
