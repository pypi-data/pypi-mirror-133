...
from mastapy.system_model.drawing import _1992, _1988
from mastapy.geometry import _276
...
class ContourDrawStyle(_276.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1585.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1585.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1585.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1992.ScalingDrawStyle':
        ...
        return constructor.new(_1992.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling is not None else None

    @property
    def model_view_options(self) -> '_1988.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1988.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions is not None else None
