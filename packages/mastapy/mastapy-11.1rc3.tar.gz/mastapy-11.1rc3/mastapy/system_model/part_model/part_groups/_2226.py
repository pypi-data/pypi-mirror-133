...
from mastapy.system_model.part_model.part_groups import _2223, _2225, _2222
...
class ParallelPartGroup(_2222.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2223.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2223.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2225.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2225.DesignMeasurements))
        return value
