...
from mastapy.system_model.part_model.part_groups import _2224, _2222
...
class ConcentricPartGroup(_2222.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2224.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2224.ConcentricPartGroupParallelToThis))
        return value
