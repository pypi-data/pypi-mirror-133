...
from mastapy.system_model.part_model.part_groups import _2222, _2223, _2226
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2222.ConcentricOrParallelPartGroup':
        ...
        if _2222.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ParallelGroup.__class__)(self.wrapped.ParallelGroup) if self.wrapped.ParallelGroup is not None else None

    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2223.ConcentricPartGroup':
        ...
        if _2223.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2226.ParallelPartGroup':
        ...
        if _2226.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
