...
from mastapy.system_model.import_export import _1978
...
class Part(_1946.DesignEntity):
    ...
    def mass(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.Mass) if self.wrapped.Mass is not None else None
    ...
    @property
    def mass_properties_from_design(self) -> '_1312.MassProperties':
        ...
        return constructor.new(_1312.MassProperties)(self.wrapped.MassPropertiesFromDesign) if self.wrapped.MassPropertiesFromDesign is not None else None

    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1312.MassProperties':
        ...
        return constructor.new(_1312.MassProperties)(self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates) if self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates is not None else None
    ...
    @property
    def local_connections(self) -> 'List[_2009.Connection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocalConnections, constructor.new(_2009.Connection))
        return value

    def create_geometry_export_options(self) -> '_1978.GeometryExportOptions':
    ...
    def copy_to(self, container: '_2171.Assembly') -> 'Part':
    ...
    def connections_to(self, part: 'Part') -> 'List[_2009.Connection]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionsTo(part.wrapped if part else None), constructor.new(_2009.Connection))
