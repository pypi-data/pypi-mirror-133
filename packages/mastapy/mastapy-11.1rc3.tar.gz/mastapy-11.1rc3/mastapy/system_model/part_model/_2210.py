...
from mastapy.system_model import _1942
from mastapy._internal import constructor, conversion
from mastapy.geometry import _277
from mastapy.system_model.part_model.projections import _2221
from mastapy.system_model.part_model.part_groups import _2226
...
class RootAssembly(_2171.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1942.Design':
        ...
        return constructor.new(_1942.Design)(self.wrapped.Model) if self.wrapped.Model is not None else None

    @property
    def packaging_limits(self) -> '_277.PackagingLimits':
        ...
        return constructor.new(_277.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits is not None else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2221.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2221.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2226.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2226.ParallelPartGroup))
        return value
