...
from mastapy.system_model.part_model.gears import _2258, _2267
...
class ConicalGearSet(_2267.GearSet):
    '''ConicalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_1098.ConicalGearSetDesign':
        ...
        if _1098.ConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_906.ZerolBevelGearSetDesign':
        ...
        if _906.ZerolBevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_915.StraightBevelDiffGearSetDesign':
        ...
        if _915.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_919.StraightBevelGearSetDesign':
        ...
        if _919.StraightBevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_923.SpiralBevelGearSetDesign':
        ...
        if _923.SpiralBevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_927.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _927.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_931.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _931.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_klingelnberg_conical_gear_set_design(self) -> '_935.KlingelnbergConicalGearSetDesign':
        ...
        if _935.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_hypoid_gear_set_design(self) -> '_939.HypoidGearSetDesign':
        ...
        if _939.HypoidGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_bevel_gear_set_design(self) -> '_1124.BevelGearSetDesign':
        ...
        if _1124.BevelGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_1137.AGMAGleasonConicalGearSetDesign':
        ...
        if _1137.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design(self) -> '_1098.ConicalGearSetDesign':
        ...
        if _1098.ConicalGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_906.ZerolBevelGearSetDesign':
        ...
        if _906.ZerolBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_915.StraightBevelDiffGearSetDesign':
        ...
        if _915.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_919.StraightBevelGearSetDesign':
        ...
        if _919.StraightBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_923.SpiralBevelGearSetDesign':
        ...
        if _923.SpiralBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_927.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _927.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_931.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _931.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_klingelnberg_conical_gear_set_design(self) -> '_935.KlingelnbergConicalGearSetDesign':
        ...
        if _935.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_hypoid_gear_set_design(self) -> '_939.HypoidGearSetDesign':
        ...
        if _939.HypoidGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_bevel_gear_set_design(self) -> '_1124.BevelGearSetDesign':
        ...
        if _1124.BevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_1137.AGMAGleasonConicalGearSetDesign':
        ...
        if _1137.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gears(self) -> 'List[_2258.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2258.ConicalGear))
        return value
