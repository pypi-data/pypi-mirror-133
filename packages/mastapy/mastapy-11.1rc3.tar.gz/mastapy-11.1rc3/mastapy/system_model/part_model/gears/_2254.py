...
class BevelGear(_2248.AGMAGleasonConicalGear):
    '''BevelGear
    ...
    @property
    def conical_gear_design(self) -> '_1122.BevelGearDesign':
    ...
    @property
    def bevel_gear_design(self) -> '_1122.BevelGearDesign':
        ...
        if _1122.BevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_zerol_bevel_gear_design(self) -> '_904.ZerolBevelGearDesign':
        ...
        if _904.ZerolBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_diff_gear_design(self) -> '_913.StraightBevelDiffGearDesign':
        ...
        if _913.StraightBevelDiffGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_straight_bevel_gear_design(self) -> '_917.StraightBevelGearDesign':
        ...
        if _917.StraightBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_design_of_type_spiral_bevel_gear_design(self) -> '_921.SpiralBevelGearDesign':
        ...
        if _921.SpiralBevelGearDesign.TYPE not in self.wrapped.BevelGearDesign.__class__.__mro__:
