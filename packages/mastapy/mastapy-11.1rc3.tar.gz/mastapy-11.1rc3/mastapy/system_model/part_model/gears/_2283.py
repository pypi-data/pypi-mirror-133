...
from mastapy.system_model.part_model.gears import _2282, _2255
...
class StraightBevelGearSet(_2255.BevelGearSet):
    '''StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2282.StraightBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGears, constructor.new(_2282.StraightBevelGear))
        return value

    @property
    def straight_bevel_meshes(self) -> 'List[_2064.StraightBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_2064.StraightBevelGearMesh))
        return value
