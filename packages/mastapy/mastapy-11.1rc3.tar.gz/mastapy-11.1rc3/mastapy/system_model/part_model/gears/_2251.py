...
from mastapy.system_model.part_model.gears import _2254, _2255
...
class BevelDifferentialGearSet(_2255.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_1124.BevelGearSetDesign':
    ...
    @property
    def bevel_gear_set_design(self) -> '_1124.BevelGearSetDesign':
        ...
        if _1124.BevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_906.ZerolBevelGearSetDesign':
        ...
        if _906.ZerolBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_915.StraightBevelDiffGearSetDesign':
        ...
        if _915.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_919.StraightBevelGearSetDesign':
        ...
        if _919.StraightBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_923.SpiralBevelGearSetDesign':
        ...
        if _923.SpiralBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gears(self) -> 'List[_2254.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2254.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_2040.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_2040.BevelGearMesh))
        return value
