...
class GearSet(_2212.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_902.GearSetDesign':
        ...
        if _902.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_911.WormGearSetDesign':
        ...
        if _911.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_947.FaceGearSetDesign':
        ...
        if _947.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_979.CylindricalGearSetDesign':
        ...
        if _979.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_990.CylindricalPlanetaryGearSetDesign':
        ...
        if _990.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_1098.ConicalGearSetDesign':
    ...
    @property
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_1120.ConceptGearSetDesign':
        ...
        if _1120.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_902.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_902.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_902.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_902.GearSetDesign'):
