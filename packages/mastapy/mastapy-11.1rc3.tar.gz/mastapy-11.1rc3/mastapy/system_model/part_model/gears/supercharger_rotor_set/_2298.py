...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import (
    _2300, _2293, _2295, _2290,
    _2292, _2291, _2294
)
from mastapy.utility_gui.charts import _1619
...
class SuperchargerRotorSet(_1592.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2300.YVariableForImportedData':
        ...
        return constructor.new(_2300.YVariableForImportedData)(value) if value is not None else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2300.YVariableForImportedData'):
    ...
    @property
    def supercharger_map_chart(self) -> '_1619.ThreeDChartDefinition':
        ...
        return constructor.new(_1619.ThreeDChartDefinition)(self.wrapped.SuperchargerMapChart) if self.wrapped.SuperchargerMapChart is not None else None

    @property
    def file(self) -> '_2293.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2293.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File is not None else None

    @property
    def rotor_speed(self) -> '_2295.RotorSpeedInputOptions':
        ...
        return constructor.new(_2295.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed is not None else None

    @property
    def boost_pressure(self) -> '_2290.BoostPressureInputOptions':
        ...
        return constructor.new(_2290.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure is not None else None

    @property
    def pressure_ratio(self) -> '_2292.PressureRatioInputOptions':
        ...
        return constructor.new(_2292.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio is not None else None

    @property
    def input_power(self) -> '_2291.InputPowerInputOptions':
        ...
        return constructor.new(_2291.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower is not None else None

    @property
    def measured_points(self) -> 'List[_2294.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2294.RotorSetMeasuredPoint))
        return value
