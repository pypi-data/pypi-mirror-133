...
from mastapy.system_model import _1955
...
class PlanetCarrierSettings(_1382.PerMachineSettings):
    '''PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_1955.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new(_1955.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_1955.PlanetPinManufacturingErrorsCoordinateSystem'):
