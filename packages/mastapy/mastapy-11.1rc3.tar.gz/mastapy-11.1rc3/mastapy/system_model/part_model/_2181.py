...
from mastapy.math_utility import _1292, _1293
from mastapy.system_model.connections_and_sockets import (
    _2007, _2028, _2009, _2033
)
from mastapy.system_model.part_model import _2182, _2204
...
class Component(_2204.Part):
    ...
    def polar_inertia_for_synchroniser_sizing_only(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.PolarInertiaForSynchroniserSizingOnly) if self.wrapped.PolarInertiaForSynchroniserSizingOnly is not None else None
    ...
    def polar_inertia(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.PolarInertia) if self.wrapped.PolarInertia is not None else None
    ...
    def transverse_inertia(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.TransverseInertia) if self.wrapped.TransverseInertia is not None else None
    ...
    def two_d_drawing_full_model(self) -> 'Image':
        ...
        value = conversion.pn_to_mp_smt_bitmap(self.wrapped.TwoDDrawingFullModel)
        return value
    ...
    @property
    def local_coordinate_system(self) -> '_1292.CoordinateSystem3D':
        ...
        return constructor.new(_1292.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem is not None else None

    @property
    def component_connections(self) -> 'List[_2007.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_2007.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2028.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1292.CoordinateSystem3D') -> '_2028.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2028.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1293.CoordinateSystemEditor':
    ...
    def can_delete_connection(self, connection: '_2009.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_2033.Socket':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2009.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2009.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2033.Socket') -> 'List[_2033.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_2033.Socket))

    def connect_to_socket(self, socket: '_2033.Socket') -> '_2182.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2033.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_2033.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2182.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2182.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
