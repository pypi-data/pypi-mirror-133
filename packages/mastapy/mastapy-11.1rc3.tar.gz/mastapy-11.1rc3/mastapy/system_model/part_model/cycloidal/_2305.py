...
from mastapy.cycloidal import _1255, _1256
...
class RingPins(_2200.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1255.RingPinsDesign':
        ...
        return constructor.new(_1255.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign is not None else None

    @property
    def ring_pins_material(self) -> '_1256.RingPinsMaterial':
        ...
        return constructor.new(_1256.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial is not None else None
