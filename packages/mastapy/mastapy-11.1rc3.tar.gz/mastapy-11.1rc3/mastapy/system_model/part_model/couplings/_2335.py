...
class SpringDamper(_2318.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2087.SpringDamperConnection':
        ...
        return constructor.new(_2087.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection is not None else None
