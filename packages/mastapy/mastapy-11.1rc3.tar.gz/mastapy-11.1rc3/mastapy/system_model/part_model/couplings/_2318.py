...
class Coupling(_2212.SpecialisedAssembly):
    '''Coupling
    ...
    @property
    def halves(self) -> 'List[_2319.CouplingHalf]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_2319.CouplingHalf))
        return value

    @property
    def half_a(self) -> '_2319.CouplingHalf':
        ...
        if _2319.CouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2314.ClutchHalf':
        ...
        if _2314.ClutchHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2317.ConceptCouplingHalf':
        ...
        if _2317.ConceptCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2322.CVTPulley':
        ...
        if _2322.CVTPulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to CVTPulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2324.PartToPartShearCouplingHalf':
        ...
        if _2324.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2325.Pulley':
        ...
        if _2325.Pulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to Pulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_rolling_ring(self) -> '_2331.RollingRing':
        ...
        if _2331.RollingRing.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to RollingRing. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_spring_damper_half(self) -> '_2336.SpringDamperHalf':
        ...
        if _2336.SpringDamperHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_half(self) -> '_2339.SynchroniserHalf':
        ...
        if _2339.SynchroniserHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_part(self) -> '_2340.SynchroniserPart':
        ...
        if _2340.SynchroniserPart.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA is not None else None

    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2341.SynchroniserSleeve':
        ...
        if _2341.SynchroniserSleeve.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2343.TorqueConverterPump':
        ...
        if _2343.TorqueConverterPump.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2345.TorqueConverterTurbine':
        ...
        if _2345.TorqueConverterTurbine.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_b(self) -> '_2319.CouplingHalf':
        ...
        if _2319.CouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2314.ClutchHalf':
        ...
        if _2314.ClutchHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2317.ConceptCouplingHalf':
        ...
        if _2317.ConceptCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2322.CVTPulley':
        ...
        if _2322.CVTPulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to CVTPulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2324.PartToPartShearCouplingHalf':
        ...
        if _2324.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2325.Pulley':
        ...
        if _2325.Pulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to Pulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_rolling_ring(self) -> '_2331.RollingRing':
        ...
        if _2331.RollingRing.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to RollingRing. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_spring_damper_half(self) -> '_2336.SpringDamperHalf':
        ...
        if _2336.SpringDamperHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_half(self) -> '_2339.SynchroniserHalf':
        ...
        if _2339.SynchroniserHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_part(self) -> '_2340.SynchroniserPart':
        ...
        if _2340.SynchroniserPart.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB is not None else None

    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2341.SynchroniserSleeve':
        ...
        if _2341.SynchroniserSleeve.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2343.TorqueConverterPump':
        ...
        if _2343.TorqueConverterPump.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2345.TorqueConverterTurbine':
        ...
        if _2345.TorqueConverterTurbine.TYPE not in self.wrapped.HalfB.__class__.__mro__:
