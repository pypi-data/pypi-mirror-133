...
class PartToPartShearCoupling(_2318.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2085.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2085.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection is not None else None
