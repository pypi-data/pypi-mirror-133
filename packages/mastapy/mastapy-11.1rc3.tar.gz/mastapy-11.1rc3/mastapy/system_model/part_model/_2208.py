...
from mastapy.system_model import _1959
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2217, _2215
...
class PowerLoad(_2215.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def engine_torque_grid(self) -> '_1360.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'EngineTorqueGrid' is the original name of this property.'''

        return constructor.new(_1360.GriddedSurfaceAccessor)(self.wrapped.EngineTorqueGrid) if self.wrapped.EngineTorqueGrid is not None else None

    @engine_torque_grid.setter
    def engine_torque_grid(self, value: '_1360.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.EngineTorqueGrid = value

    @property
    def engine_fuel_consumption_grid(self) -> '_1360.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'EngineFuelConsumptionGrid' is the original name of this property.'''

        return constructor.new(_1360.GriddedSurfaceAccessor)(self.wrapped.EngineFuelConsumptionGrid) if self.wrapped.EngineFuelConsumptionGrid is not None else None

    @engine_fuel_consumption_grid.setter
    def engine_fuel_consumption_grid(self, value: '_1360.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def single_blade_details(self) -> '_2217.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2217.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails is not None else None

    @property
    def electric_machine_detail(self) -> '_6580.ElectricMachineDetail':
        ...
        return constructor.new(_6580.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail is not None else None

    @property
    def oil_pump_detail(self) -> '_266.OilPumpDetail':
        ...
        return constructor.new(_266.OilPumpDetail)(self.wrapped.OilPumpDetail) if self.wrapped.OilPumpDetail is not None else None
