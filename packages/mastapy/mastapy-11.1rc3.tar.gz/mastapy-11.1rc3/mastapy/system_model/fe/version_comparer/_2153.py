...
from mastapy.math_utility.measured_vectors import _1356, _1358
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1356.NodeResults':
        ...
        return constructor.new(_1356.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult is not None else None

    @property
    def new_result(self) -> '_1356.NodeResults':
        ...
        return constructor.new(_1356.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult is not None else None

    @property
    def displacement_change(self) -> '_1358.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1358.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange is not None else None
