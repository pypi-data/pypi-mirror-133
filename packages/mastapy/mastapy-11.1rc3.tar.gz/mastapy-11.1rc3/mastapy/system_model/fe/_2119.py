...
from mastapy.system_model.fe import (
    _2099, _2124, _2147, _2093,
    _2095, _2120, _2145, _2121,
    _2117, _2131, _2132, _2130,
    _2127, _2128, _2129
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2185, _2181, _2189
from mastapy.nodal_analysis import _66, _80, _62
...
from mastapy.math_utility import _1292
from mastapy.materials import _209, _251
from mastapy.system_model.part_model.shaft_model import _2218
from mastapy.system_model.fe.links import _2154
from mastapy.math_utility.measured_vectors import _1358
from mastapy import _7270
...
class FESubstructure(_62.FEStiffness):
    '''FESubstructure
    ...
    def expected_number_of_rigid_body_modes(self) -> 'overridable.Overridable_int':
        ...
        return constructor.new(overridable.Overridable_int)(self.wrapped.ExpectedNumberOfRigidBodyModes) if self.wrapped.ExpectedNumberOfRigidBodyModes is not None else None
    ...
    def distance_display_unit(self) -> 'list_with_selected_item.ListWithSelectedItem_Unit':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_Unit)(self.wrapped.DistanceDisplayUnit) if self.wrapped.DistanceDisplayUnit is not None else None
    ...
    def force_display_unit(self) -> 'list_with_selected_item.ListWithSelectedItem_Unit':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_Unit)(self.wrapped.ForceDisplayUnit) if self.wrapped.ForceDisplayUnit is not None else None
    ...
    @property
    def bearing_node_alignment(self) -> '_2099.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2099.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2099.BearingNodeAlignmentOption'):
    ...
    def type_(self) -> 'enum_with_selected_value.EnumWithSelectedValue_FESubstructureType':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.Type, value) if self.wrapped.Type is not None else None
    ...
    def geometry_meshing_material(self) -> 'str':
        ...
        return self.wrapped.GeometryMeshingMaterial.SelectedItemName

    @geometry_meshing_material.setter
    def geometry_meshing_material(self, value: 'str'):
        self.wrapped.GeometryMeshingMaterial.SetSelectedItem(str(value) if value else '')
    ...
    def thermal_expansion_option(self) -> 'enum_with_selected_value.EnumWithSelectedValue_ThermalExpansionOption':
        ...
        return enum_with_selected_value_runtime.create(self.wrapped.ThermalExpansionOption, value) if self.wrapped.ThermalExpansionOption is not None else None
    ...
    def datum(self) -> 'list_with_selected_item.ListWithSelectedItem_Datum':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_Datum)(self.wrapped.Datum) if self.wrapped.Datum is not None else None
    ...
    @property
    def alignment_method(self) -> '_2093.AlignmentMethod':
        ...
        return constructor.new(_2093.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2093.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def component_to_align_to(self) -> 'list_with_selected_item.ListWithSelectedItem_Component':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_Component)(self.wrapped.ComponentToAlignTo) if self.wrapped.ComponentToAlignTo is not None else None
    ...
    @property
    def gravity_force_source(self) -> '_66.GravityForceSource':
        ...
        return constructor.new(_66.GravityForceSource)(value) if value is not None else None
    ...
    def reduced_stiffness_file_editable(self, value: 'str'):
        self.wrapped.ReducedStiffnessFileEditable = str(value) if value else ''
    ...
    @property
    def fe_meshing_options(self) -> '_80.ShaftFEMeshingOptions':
        ...
        return constructor.new(_80.ShaftFEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions is not None else None

    @property
    def cms_model(self) -> '_199.CMSModel':
        ...
        return constructor.new(_199.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel is not None else None
    ...
    @property
    def alignment_to_component(self) -> '_1960.RelativeComponentAlignment[_2181.Component]':
        ...
        return constructor.new(_1960.RelativeComponentAlignment)[_2181.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent is not None else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2095.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2095.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions is not None else None

    @property
    def coordinate_system(self) -> '_1292.CoordinateSystem3D':
        ...
        return constructor.new(_1292.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem is not None else None

    @property
    def export(self) -> '_2120.FESubstructureExportOptions':
        ...
        return constructor.new(_2120.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None

    @property
    def acoustic_radiation_efficiency(self) -> '_209.AcousticRadiationEfficiency':
        ...
        return constructor.new(_209.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency is not None else None

    @property
    def sound_pressure_enclosure(self) -> '_251.SoundPressureEnclosure':
        ...
        return constructor.new(_251.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure is not None else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2145.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2145.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2218.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2218.Shaft))
        return value

    @property
    def links(self) -> 'List[_2154.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2154.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1358.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1358.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1358.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1358.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2117.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2117.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2131.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2131.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2132.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2132.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2189.FEPart':
        ...
        return constructor.new(_2189.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart is not None else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7270.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2130.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2127.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2128.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2129.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_152.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7270.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2121.FESubstructureNode') -> 'List[_2154.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2154.FELink))
