...
from mastapy.system_model.analyses_and_results.static_loads import _6690, _6616
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.fe import _2121
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.math_utility import _1315
from mastapy.units_and_measurements import _7271
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    def data_set_name(self, value: 'str'):
        self.wrapped.DataSetName = str(value) if value else ''
    ...
    @property
    def torque_ripple_input_type(self) -> '_6690.TorqueRippleInputType':
        ...
        return constructor.new(_6690.TorqueRippleInputType)(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6690.TorqueRippleInputType'):
    ...
    def node_for_first_tooth(self) -> 'list_with_selected_item.ListWithSelectedItem_FESubstructureNode':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_FESubstructureNode)(self.wrapped.NodeForFirstTooth) if self.wrapped.NodeForFirstTooth is not None else None
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType') -> '_1315.MultipleFourierSeriesInterpolator':
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7271.MeasurementType'):
        ...
        self.wrapped.AddOrReplaceExcitationData.Overloads[_HARMONIC_LOAD_DATA_TYPE, _DOUBLE, _LIST[_DOUBLE], _STRING, _MEASUREMENT_TYPE](harmonic_load_data_type, speed if speed else 0.0, fourier_series_values, fourier_series_name if fourier_series_name else '', fourier_series_measurement_type)

    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7271.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType', node: '_2121.FESubstructureNode') -> '_1315.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType', node: '_2121.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7271.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_6616.HarmonicLoadDataType', node: '_2121.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7271.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
