...
class FELinkWithSelection(_0.APIBase):
    ...
    def link(self) -> '_2154.FELink':
        ...
        if _2154.FELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_electric_machine_stator_fe_link(self) -> '_2155.ElectricMachineStatorFELink':
        ...
        if _2155.ElectricMachineStatorFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_gear_mesh_fe_link(self) -> '_2157.GearMeshFELink':
        ...
        if _2157.GearMeshFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to GearMeshFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link is not None else None

    @property
    def link_of_type_gear_with_duplicated_meshes_fe_link(self) -> '_2158.GearWithDuplicatedMeshesFELink':
        ...
        if _2158.GearWithDuplicatedMeshesFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_angle_connection_fe_link(self) -> '_2159.MultiAngleConnectionFELink':
        ...
        if _2159.MultiAngleConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_node_connector_fe_link(self) -> '_2160.MultiNodeConnectorFELink':
        ...
        if _2160.MultiNodeConnectorFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_node_fe_link(self) -> '_2161.MultiNodeFELink':
        ...
        if _2161.MultiNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to MultiNodeFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link is not None else None

    @property
    def link_of_type_planetary_connector_multi_node_fe_link(self) -> '_2162.PlanetaryConnectorMultiNodeFELink':
        ...
        if _2162.PlanetaryConnectorMultiNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_planet_based_fe_link(self) -> '_2163.PlanetBasedFELink':
        ...
        if _2163.PlanetBasedFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PlanetBasedFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link is not None else None

    @property
    def link_of_type_planet_carrier_fe_link(self) -> '_2164.PlanetCarrierFELink':
        ...
        if _2164.PlanetCarrierFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PlanetCarrierFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link is not None else None

    @property
    def link_of_type_point_load_fe_link(self) -> '_2165.PointLoadFELink':
        ...
        if _2165.PointLoadFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PointLoadFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link is not None else None

    @property
    def link_of_type_rolling_ring_connection_fe_link(self) -> '_2166.RollingRingConnectionFELink':
        ...
        if _2166.RollingRingConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_shaft_hub_connection_fe_link(self) -> '_2167.ShaftHubConnectionFELink':
        ...
        if _2167.ShaftHubConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_single_node_fe_link(self) -> '_2168.SingleNodeFELink':
        ...
        if _2168.SingleNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
