...
from mastapy.system_model.fe import _2094, _2101
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2094.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2094.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2094.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2101.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2101.BearingRaceNodeLink))
        return value
