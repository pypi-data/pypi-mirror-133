...
class FESubstructureWithSelection(_2097.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2119.FESubstructure':
        ...
        return constructor.new(_2119.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure is not None else None

    @property
    def element_face_groups(self) -> 'List[_2112.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2112.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2137.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2137.NodeGroupWithSelection))
        return value
