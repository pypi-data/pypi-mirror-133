...
from mastapy.bearings.bearing_designs.concept import _1938, _1940
...
class ConceptAxialClearanceBearing(_1940.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1938.BearingNodePosition':
        ...
        return constructor.new(_1938.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_1938.BearingNodePosition'):
