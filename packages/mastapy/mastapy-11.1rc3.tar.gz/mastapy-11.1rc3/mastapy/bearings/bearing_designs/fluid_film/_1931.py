...
class PlainGreaseFilledJournalBearing(_1933.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1932.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1932.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_1932.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1934.PlainJournalHousing':
        ...
        if _1934.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.HousingDetail.__class__)(self.wrapped.HousingDetail) if self.wrapped.HousingDetail is not None else None

    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1927.CylindricalHousingJournalBearing':
        ...
        if _1927.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1928.MachineryEncasedJournalBearing':
        ...
        if _1928.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1930.PedestalJournalBearing':
        ...
        if _1930.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
