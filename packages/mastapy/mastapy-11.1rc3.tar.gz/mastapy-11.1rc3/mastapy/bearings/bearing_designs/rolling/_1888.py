...
from mastapy.bearings.bearing_designs.rolling import _1889
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1889.BearingProtectionLevel':
        ...
        return constructor.new(_1889.BearingProtectionLevel)(value) if value is not None else None

    @property
    def new_protection_level(self) -> '_1889.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1889.BearingProtectionLevel'):
    ...
    def current_password(self, value: 'str'):
        self.wrapped.CurrentPassword = str(value) if value else ''
    ...
    def new_password(self, value: 'str'):
        self.wrapped.NewPassword = str(value) if value else ''
    ...
    def confirm_new_password(self, value: 'str'):
        self.wrapped.ConfirmNewPassword = str(value) if value else ''
