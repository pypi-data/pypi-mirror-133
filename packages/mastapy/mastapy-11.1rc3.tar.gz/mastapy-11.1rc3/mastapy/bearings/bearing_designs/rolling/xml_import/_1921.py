...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1919, _1918
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    def target_type(self) -> 'list_with_selected_item.ListWithSelectedItem_str':
        ...
        return constructor.new(list_with_selected_item.ListWithSelectedItem_str)(self.wrapped.TargetType) if self.wrapped.TargetType is not None else None
    ...
    @property
    def files(self) -> 'List[_1919.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1919.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1918.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1918.AbstractXmlVariableAssignment))
        return value
