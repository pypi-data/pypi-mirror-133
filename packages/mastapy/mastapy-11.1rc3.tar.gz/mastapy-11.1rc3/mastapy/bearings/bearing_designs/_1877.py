...
class LinearBearing(_1874.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1634.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1634.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1634.BearingStiffnessMatrixOption'):
