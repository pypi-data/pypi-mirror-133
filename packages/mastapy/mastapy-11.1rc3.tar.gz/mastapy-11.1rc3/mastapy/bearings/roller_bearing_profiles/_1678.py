...
from mastapy.bearings.roller_bearing_profiles import (
    _1686, _1680, _1681, _1682,
    _1683, _1684, _1685, _1687
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1643.RollerBearingProfileTypes':
        ...
        return constructor.new(_1643.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1643.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1686.RollerBearingProfile':
        ...
        if _1686.RollerBearingProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
        ...
        return constructor.new_override(self.wrapped.ActiveProfile.__class__)(self.wrapped.ActiveProfile) if self.wrapped.ActiveProfile is not None else None

    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1680.RollerBearingConicalProfile':
        ...
        if _1680.RollerBearingConicalProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1681.RollerBearingCrownedProfile':
        ...
        if _1681.RollerBearingCrownedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1682.RollerBearingDinLundbergProfile':
        ...
        if _1682.RollerBearingDinLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1683.RollerBearingFlatProfile':
        ...
        if _1683.RollerBearingFlatProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1684.RollerBearingJohnsGoharProfile':
        ...
        if _1684.RollerBearingJohnsGoharProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1685.RollerBearingLundbergProfile':
        ...
        if _1685.RollerBearingLundbergProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1687.RollerBearingUserSpecifiedProfile':
        ...
        if _1687.RollerBearingUserSpecifiedProfile.TYPE not in self.wrapped.ActiveProfile.__class__.__mro__:
