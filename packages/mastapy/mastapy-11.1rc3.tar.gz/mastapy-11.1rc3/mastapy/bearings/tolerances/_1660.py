...
from mastapy.bearings.tolerances import _1655, _1652
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings import _1640
...
class InterferenceTolerance(_1652.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1655.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1655.BearingToleranceDefinitionOptions'):
    ...
    def non_contacting_diameter(self) -> 'overridable.Overridable_float':
        ...
        return constructor.new(overridable.Overridable_float)(self.wrapped.NonContactingDiameter) if self.wrapped.NonContactingDiameter is not None else None
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1640.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1640.MountingPointSurfaceFinishes)(value) if value is not None else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1640.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
