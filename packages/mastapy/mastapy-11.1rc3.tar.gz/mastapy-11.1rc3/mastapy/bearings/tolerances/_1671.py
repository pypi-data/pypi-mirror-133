...
from mastapy.bearings.tolerances import _1667, _1659
...
class SupportDetail(_1659.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1667.RadialSpecificationMethod':
        ...
        return constructor.new(_1667.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1667.RadialSpecificationMethod'):
