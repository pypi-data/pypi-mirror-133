...
from mastapy.bearings.bearing_results.rolling import _1787, _1774
...
class LoadedSphericalRollerThrustBearingRow(_1774.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1787.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1787.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
