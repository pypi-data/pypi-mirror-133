...
from mastapy.bearings.bearing_results.rolling import _1793, _1769
...
class LoadedTaperRollerBearingRow(_1769.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1793.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1793.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
