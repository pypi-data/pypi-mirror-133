...
from mastapy.bearings.bearing_results.rolling import _1809, _1768
...
class LoadedCylindricalRollerBearingResults(_1768.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_1809.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1809.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad is not None else None
