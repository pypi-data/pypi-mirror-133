...
from mastapy.bearings.bearing_results.rolling import _1720, _1820, _1777
...
class LoadedBallBearingResults(_1777.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1720.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new(_1720.FrictionModelForGyroscopicMoment)(value) if value is not None else None

    @property
    def track_truncation(self) -> '_1820.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1820.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation is not None else None
