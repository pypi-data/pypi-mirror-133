...
from mastapy.bearings.bearing_results.rolling import _1730, _1728
...
class LoadedAngularContactThrustBallBearingRow(_1728.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1730.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1730.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
