...
from mastapy.bearings import _1648
...
class ISO14179SettingsPerBearingType(_1377.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1648.RollingBearingType':
        ...
        return constructor.new(_1648.RollingBearingType)(value) if value is not None else None
