...
from mastapy.bearings.bearing_results.rolling import _1741, _1739
...
class LoadedAxialThrustNeedleRollerBearingRow(_1739.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1741.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1741.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
