...
from mastapy.bearings.bearing_results.rolling.skf_module import _1822, _1841
...
class AdjustedSpeed(_1841.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1822.AdjustmentFactors':
        ...
        return constructor.new(_1822.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors is not None else None
