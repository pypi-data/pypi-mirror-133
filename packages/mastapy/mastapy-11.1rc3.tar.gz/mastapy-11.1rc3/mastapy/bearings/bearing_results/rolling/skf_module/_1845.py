...
from mastapy.bearings.bearing_results.rolling.skf_module import _1837, _1841
...
class Viscosities(_1841.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1837.OperatingViscosity':
        ...
        return constructor.new(_1837.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity is not None else None
