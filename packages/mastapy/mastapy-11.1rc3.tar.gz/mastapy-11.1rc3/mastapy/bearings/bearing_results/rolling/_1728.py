...
from mastapy.bearings.bearing_results.rolling import _1727, _1730, _1747
...
class LoadedAngularContactBallBearingRow(_1747.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1727.LoadedAngularContactBallBearingResults':
