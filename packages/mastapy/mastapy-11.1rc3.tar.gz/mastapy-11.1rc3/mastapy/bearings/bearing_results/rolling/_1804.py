...
from mastapy.bearings.bearing_results.rolling import _1786
...
class LoadedToroidalRollerBearingStripLoadResults(_1786.LoadedSphericalRollerRadialBearingStripLoadResults):
    '''LoadedToroidalRollerBearingStripLoadResults
