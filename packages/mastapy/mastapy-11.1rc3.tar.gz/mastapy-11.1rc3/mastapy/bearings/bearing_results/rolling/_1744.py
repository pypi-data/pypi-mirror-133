...
from mastapy.bearings.bearing_results.rolling import _1716, _1758
...
class LoadedBallBearingElement(_1758.LoadedElement):
    '''LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1716.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceContactGeometries, constructor.new(_1716.BallBearingRaceContactGeometry))
        return value

    @property
    def outer_race_contact_geometries(self) -> 'List[_1716.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceContactGeometries, constructor.new(_1716.BallBearingRaceContactGeometry))
        return value
