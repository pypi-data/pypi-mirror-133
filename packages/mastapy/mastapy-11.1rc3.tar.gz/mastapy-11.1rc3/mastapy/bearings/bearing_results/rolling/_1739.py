...
from mastapy.bearings.bearing_results.rolling import _1738, _1741, _1769
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1769.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1738.LoadedAxialThrustCylindricalRollerBearingResults':
