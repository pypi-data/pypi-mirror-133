...
from mastapy.bearings.bearing_results.rolling import _1763
...
class LoadedThreePointContactBallBearingElement(_1763.LoadedMultiPointContactBallBearingElement):
    '''LoadedThreePointContactBallBearingElement
