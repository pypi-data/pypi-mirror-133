...
from mastapy.bearings.bearing_results.rolling import (
    _1746, _1727, _1730, _1756,
    _1761, _1780, _1796, _1799,
    _1745, _1778
)
...
class LoadedBallBearingRow(_1778.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1746.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1745.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1745.LoadedBallBearingRaceResults))
        return value
