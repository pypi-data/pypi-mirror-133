...
from mastapy.bearings.bearing_results.fluid_film import _1867
...
class LoadedPlainOilFedJournalBearingRow(_1867.LoadedPlainJournalBearingRow):
    '''LoadedPlainOilFedJournalBearingRow
    ...
    def pressure_distribution(self) -> 'Image':
        ...
        value = conversion.pn_to_mp_smt_bitmap(self.wrapped.PressureDistribution)
        return value
