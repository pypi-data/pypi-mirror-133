...
from mastapy.math_utility.optimisation import _1344
...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    def select_chart_type(self) -> 'ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value is not None else None
    ...
    @property
    def bars(self) -> 'List[_1344.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1344.ParetoOptimisationStrategyBars))
        return value
