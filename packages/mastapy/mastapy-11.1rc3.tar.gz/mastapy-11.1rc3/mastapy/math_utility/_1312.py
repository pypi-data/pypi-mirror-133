...
from mastapy.math_utility import _1311
...
class MassProperties(_0.APIBase):
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_1311.InertiaTensor':
        ...
        return constructor.new(_1311.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin is not None else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_1311.InertiaTensor':
        ...
        return constructor.new(_1311.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass is not None else None
