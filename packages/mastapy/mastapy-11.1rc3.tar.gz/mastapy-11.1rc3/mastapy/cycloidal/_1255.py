...
class RingPinsDesign(_0.APIBase):
    ...
    def number_of_pins(self) -> 'int':
        ...
        return self.wrapped.NumberOfPins

    @number_of_pins.setter
    def number_of_pins(self, value: 'int'):
        self.wrapped.NumberOfPins = int(value) if value else 0
