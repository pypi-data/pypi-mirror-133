...
adjust_scale = {"widget_type": "FloatSlider", "max": 1.5,"min": 0.7,"step":0.025,'tracking': False,'readout' : True,'tooltip': 'Fine-tune the scale around the mean cell width.'}, 
...
gamma = {"widget_type": "FloatSlider", "max": 2.5,"min": 0.1,"step":0.05,'tracking': False,'readout' : True,'tooltip': 'Gamma correction.'},
