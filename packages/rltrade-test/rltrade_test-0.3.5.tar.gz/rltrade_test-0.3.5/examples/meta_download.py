...
csv_path = 'testdata/metadf.csv' # path with .csv extenstion

time_frame = "4h" # available 5m, 15m, 30m, 1h, 4h, 1d
train_period = ('2017-12-01','2021-01-01') #for training the model
