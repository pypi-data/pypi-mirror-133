...
from rltrade.data import OandaDownloader, load_csv
from rltrade.models import SmartDailyTradeForexDynamicSLTFLongOrShortAgent
...
csv_path = 'testdata/metadf.csv'
path = 'models/dailytrade/forex-train12'
...
env_kwargs = {
    ...
    "ticker_col_name":"tic",
    "long_or_short":"long", # "long" or "short"
    "max_stop_loss":0.015,
...
async def train_model():
    ...
    try:
        ...
        agent = SmartDailyTradeForexDynamicSLTFLongOrShortAgent("ppo",
                            df=df,
                            account=account,
                            time_frame=time_frame,
                            ticker_list=ticker_list,
