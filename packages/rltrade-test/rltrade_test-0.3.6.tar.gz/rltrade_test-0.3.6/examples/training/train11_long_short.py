...
from rltrade.models import SmartDayTradeForexDynamicSLTFLongOrShortAgent
...
path = 'models/daytrades/forex-train11'
...
async def train_model():
    ...
    try:
        ...
        agent = SmartDayTradeForexDynamicSLTFLongOrShortAgent("ppo",
                            df=df,
                            account=account,
                            time_frame=time_frame,
                            ticker_list=ticker_list,
