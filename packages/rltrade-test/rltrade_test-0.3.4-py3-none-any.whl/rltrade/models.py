...
import torch
from rltrade.environments import (SmartDailyTradeForexDynamicSLTFEnv, SmartDayTradeEnv3, SmartDayTradeForexEnv,SmartDayTradeForexDynamicSLTFEnv,
                        SmartDailyTradeForexEnv,SmartPortfolioEnv, SmartPortfolioWithShortEnv,SmartDailyTradeForexDynamicSLTFDiffEnv,
                        SmartDayTradeEnv,SmartDayTradeEnv2, SmartTradeEnv)
...
from rltrade.data import DiffrencedFeatureEngineer, FeatureEngineer,IBKRDownloader,DayTradeFeatureEngineer,OandaDownloader
...
class SmartDayTradeForexDynamicSLTFAgent:
    ...
    async def get_day_trade_actions(self,time_now,duration,trade_period):
        ...
        self.lots = np.array([0.1 * int(x) for x in lots])
