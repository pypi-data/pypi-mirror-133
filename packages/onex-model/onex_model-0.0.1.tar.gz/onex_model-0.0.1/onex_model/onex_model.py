...
class DataflowFlowProfileTcp(OpenApiObject):
    ...
    _TYPES = {
        ...
        'sendBuf': {'type': int},
        'receiveBuf': {'type': int},
        'destinationPort': {'type': 'L4PortRange'},
        'sourcePort': {'type': 'L4PortRange'},
    } # type: Dict[str, str]
    ...
    def __init__(self, parent=None, congestionAlgorithm='cubic', initcwnd=None, sendBuf=None, receiveBuf=None):
        super(DataflowFlowProfileTcp, self).__init__()
        self._parent = parent
        self._set_property('congestionAlgorithm', congestionAlgorithm)
        self._set_property('initcwnd', initcwnd)
        self._set_property('sendBuf', sendBuf)
        self._set_property('receiveBuf', receiveBuf)

    @property
    def congestionAlgorithm(self):
        # type: () -> Union[Literal["bbr"], Literal["cubic"], Literal["dctcp"], Literal["reno"]]
        """congestionAlgorithm getter
        ...
        """
        return self._get_property('congestionAlgorithm')

    @congestionAlgorithm.setter
    def congestionAlgorithm(self, value):
        """congestionAlgorithm setter
        ...
        """
        self._set_property('congestionAlgorithm', value)
    ...
    def sendBuf(self):
        ...
        Returns: int
        """
        return self._get_property('sendBuf')

    @sendBuf.setter
    def sendBuf(self, value):
        """sendBuf setter
        ...
        value: int
        """
        self._set_property('sendBuf', value)
    ...
    def receiveBuf(self):
        ...
        Returns: int
        """
        return self._get_property('receiveBuf')

    @receiveBuf.setter
    def receiveBuf(self, value):
        """receiveBuf setter
        ...
        value: int
        """
        self._set_property('receiveBuf', value)

    @property
    def destinationPort(self):
        # type: () -> L4PortRange
        """destinationPort getter

        Layer4 protocol source or destination port valuesLayer4 protocol source or destination port values

        Returns: L4PortRange
        """
        return self._get_property('destinationPort', L4PortRange)
    ...
    def sourcePort(self):
        ...
        Returns: L4PortRange
        """
        return self._get_property('sourcePort', L4PortRange)
...
class ConfigRequest(OpenApiObject):
    __slots__ = ('_parent')
...
class ConfigResponse(OpenApiObject):
    __slots__ = ('_parent')
    ...
    def __init__(self, parent=None):
        super(ConfigResponse, self).__init__()
        self._parent = parent
    ...
    def config(self):
        ...
        The resources that define a fabric configuration.The resources that define a fabric configuration.
...
class MetricsResponseFlowResult(OpenApiObject):
    ...
    def __init__(self, parent=None, workload_name=None, flow_number=None, from_host_name=None, to_host_name=None, fct=None):
...
class MetricsResponseFlowResultTcpInfo(OpenApiObject):
    ...
    _TYPES = {
        'rtt': {'type': float},
        'rtt_variance': {'type': float},
        'retransmissions': {'type': float},
    } # type: Dict[str, str]
...
class MetricsResponseFlowResultIter(OpenApiIter):
    ...
    def flowresult(self, workload_name=None, flow_number=None, from_host_name=None, to_host_name=None, fct=None):
        # type: (str,int,str,str,float) -> MetricsResponseFlowResultIter
        ...
        Returns: MetricsResponseFlowResultIter
        """
        item = MetricsResponseFlowResult(parent=self._parent, workload_name=workload_name, flow_number=flow_number, from_host_name=from_host_name, to_host_name=to_host_name, fct=fct)
        self._add(item)
        return self

    def add(self, workload_name=None, flow_number=None, from_host_name=None, to_host_name=None, fct=None):
        # type: (str,int,str,str,float) -> MetricsResponseFlowResult
...
class Api(object):
    ...
    def config_request(self):
        """Factory method that creates an instance of ConfigRequest
    ...
    def config_response(self):
        """Factory method that creates an instance of ConfigResponse
...
class HttpApi(Api):
    ...
    def get_config(self, payload):
        ...
        return self._transport.send_recv(
            ...
            "/config",
            payload=payload,
            return_object=self.config_response(),
        )
