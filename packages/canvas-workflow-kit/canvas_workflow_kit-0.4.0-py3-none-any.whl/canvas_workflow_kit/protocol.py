...
class ProtocolResult:
    ...
    def add_recommendation(self, *args, **kwargs):
        ...
        """
        print("standard recwith args", *args)
        recommendation = Recommendation(*args, **kwargs)
        self.recommendations.append(recommendation)

    @add_recommendation.register
    def _(self, recommendation: Recommendation):
        """
        Add a Recommendation class to the recommendations list.
        Deprecated: use add_recommendation(*args) instead.
        """
        print("added rec", recommendation)
        self.recommendations.append(recommendation)
