...
class ClinicalQualityMeasure131v6(ExternallyAwareClinicalQualityMeasure, DiabetesQualityMeasure):
    ...
    More information: https://ecqi.healthit.gov/ecqm/measures/cms131v6
    """
    ...
    class Meta:
        ...
        information = 'https://ecqi.healthit.gov/ecqm/measures/cms131v6'
