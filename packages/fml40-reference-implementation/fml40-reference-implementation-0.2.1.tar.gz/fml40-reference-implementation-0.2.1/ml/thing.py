...
# from s3i.broker import BrokerREST, Broker
...
class Thing:
    ...
    def __init__(
        ...
        self.__is_event_manager = is_event_manager
        self.loop = loop
        self.__resGetValue = []
    ...
    def add_on_thing_start_ok_callback(self, callback_func, one_shot, *args, **kwargs):
        self.callbacks.add(
    ...
    def add_on_idp_start_ok_callback(self, callback_func, one_shot, *args, **kwargs):
        self.callbacks.add(
    ...
    def add_on_directory_start_ok_callback(self, callback_func, one_shot, *args, **kwargs):
        self.callbacks.add(
    ...
    def add_on_repository_start_ok_callback(self, callback_func, one_shot, *args, **kwargs):
        self.callbacks.add(
    ...
    def add_on_broker_start_ok_callback(self, callback_func, one_shot, *args, **kwargs):
    ...
    def on_get_value_request(self, msg):
        ...
        res = self.broker.send(
            endpoint=request_sender_endpoint,
    ...
    async def on_service_request(self, body_json):
        ...
        res = self.broker.send(
            endpoint=body_json.get("replyToEndpoint", None),
    ...
    def on_event_subscription_request(self, msg):
        ...
        APP_LOGGER.info(__log)
        event_sub_reply = CustomEventReply()
        event_sub_reply.fillCustomEventReply(
        ...
        res = self.broker.send(
            msg.get("replyToEndpoint"),
            msg=event_sub_reply.msg
        )
        if res:
            APP_LOGGER.info("[S3I]: Sending customEventReply back")
        else:
            APP_LOGGER.error("[S3I]: Sending customEventReply failed")
