...
#
# description:
#   jinxif folder and file name nomenclature, and lab or workplace dependent
...
es_markerpartition_standard = {
    ...
    'CD3_Ring', 'CD4_Ring', 'CD8_Ring','CD8R_Ring', 'CD10_Ring', 'CD11b_Ring', 'CD11c_Ring', 'CD19_Ring', 'CD20_Ring', 'CD31_Ring', 'CD44_Ring', 'CD45_Ring', 'CD45RA_Ring', 'CD45RO_Ring', 'CD56_Ring', 'CD66b_Ring', 'CD68_Ring', 'CD74_Ring', 'CD90_Ring', 'CD103_Ring', 'CD123_Ring', 'CD134_Ring', 'CD162_Ring', 'CD209_Ring', 'CD271_Ring',
    'CGA_Ring',
    ...
    'NFkB_Ring',
    'PCNA_Nuclei', 'PD1_Ring', 'PDGFRa_Ring', 'PDL1_Ring','PDL1ab_Ring','PDL1d_Ring', 'PDPN_Ring', 'PgR_Nuclei','PgRb_Nuclei', 'PgRc4_Nuclei',
...
d_nconv = {
    ...
    # s_color_dapi
    # ls_color_order
    # the rest is hardware specific: s_sep_marker (axom, jinxifi), s_sep_markerclone (miltenyi).
    ...
    # tiff jinxif
    's_round_jinxif': 'R',  # string used to label rounds
    ...
    'di_regex_tiff_raw': {'round':1, 'markers':2, 'slide':3, 'scanid':4, 'mscene':5, 'color':6, 'imagetype':7, 'filetype':8},
