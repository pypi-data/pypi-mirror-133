...
create_grid('weather', 'hourly', 'ta', '20200801', './tmp/output', cell_size=1000)
create_grid('weather', 'daily', 'tn', '20200801', './tmp/output', cell_size=1000, elev_correction=lambda x: x * -0.0065,
