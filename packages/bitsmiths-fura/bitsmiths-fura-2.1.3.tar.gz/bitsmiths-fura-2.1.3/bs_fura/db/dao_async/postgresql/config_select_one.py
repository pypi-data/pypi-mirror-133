...
class dConfigSelectOne:
    ...
    async def exec(self, irec: tConfigKey = None) -> "dConfigSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("ConfigSelectOne", self._dbcon.STMNT_TYPE_READ)
