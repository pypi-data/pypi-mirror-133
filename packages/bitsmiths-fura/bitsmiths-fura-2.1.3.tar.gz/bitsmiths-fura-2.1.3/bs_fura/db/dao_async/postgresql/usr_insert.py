...
class dUsrInsert:
    ...
    async def exec_deft(self,
                        ...
                        opt_system: bool,
                        opt_market: bool,
                        opt_fail_login: bool) -> "dUsrInsert":
        """
    ...
    async def exec(self, irec: tUsr = None) -> "dUsrInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("UsrInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into fura.Usr (
  site_id,
  id,
  role_id,
  status,
