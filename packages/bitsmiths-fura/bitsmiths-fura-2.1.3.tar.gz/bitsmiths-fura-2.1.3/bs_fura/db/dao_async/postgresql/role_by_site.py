...
from bs_fura.db.tables.irole_by_site import iRoleBySite
...
class dRoleBySite:
    ...
    async def exec(self, irec: iRoleBySite = None) -> "dRoleBySite":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("RoleBySite", self._dbcon.STMNT_TYPE_READ)
...
where
  r.site_id = :siteId""")
    ...
    async def fetch_all(self, outList: tRole.List, clearList: bool = True) -> int:
        """
