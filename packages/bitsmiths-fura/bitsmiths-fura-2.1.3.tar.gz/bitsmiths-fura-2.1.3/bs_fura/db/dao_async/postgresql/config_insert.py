...
class dConfigInsert:
    ...
    async def exec(self, irec: tConfig = None) -> "dConfigInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("ConfigInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into fura.Config (
  id,
  descr,
  value,
  modified_by,
