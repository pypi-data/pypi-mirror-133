...
class dAgaInsert:
    ...
    async def exec(self, irec: tAga = None) -> "dAgaInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("AgaInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into fura.Aga (
  site_id,
  site_code,
  tm_stamp,
  usr_id,
