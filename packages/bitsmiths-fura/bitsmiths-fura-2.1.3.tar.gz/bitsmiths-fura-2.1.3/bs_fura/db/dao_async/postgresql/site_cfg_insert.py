...
class dSiteCfgInsert:
    ...
    async def exec_deft(self,
                        ...
                        value: str,
                        modified_by: str,
                        tm_stamp: datetime.datetime) -> "dSiteCfgInsert":
        """
    ...
    async def exec(self, irec: tSiteCfg = None) -> "dSiteCfgInsert":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SiteCfgInsert", self._dbcon.STMNT_TYPE_CUD)

        self._dbstmnt.sql("""insert into fura.SiteCfg (
  site_id,
  id,
  descr,
  value,
