...
class dSiteDeleteOne:
    ...
    async def exec(self, irec: tSiteKey = None) -> "dSiteDeleteOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SiteDeleteOne", self._dbcon.STMNT_TYPE_CUD)
