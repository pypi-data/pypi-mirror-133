...
class dFuncGrp:
    ...
    async def lock_one_with(self, _rec: tFuncGrp, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tFuncGrpKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tFuncGrp) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tFuncGrpKey) -> bool:
        """
    ...
    async def select_one(self) -> "dFuncGrp":
        """
    ...
    async def select_one_with(self, _rec: tFuncGrp) -> "dFuncGrp":
        """
    ...
    async def select_one_by_key(self, _key: tFuncGrpKey) -> "dFuncGrp":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tFuncGrp = None):
        """
    ...
    async def insert(self, irec: tFuncGrp = None):
        """
    ...
    async def delete_one(self, irec: tFuncGrpKey = None):
        """
