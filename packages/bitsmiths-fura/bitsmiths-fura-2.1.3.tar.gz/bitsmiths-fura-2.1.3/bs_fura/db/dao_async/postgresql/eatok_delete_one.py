...
class dEatokDeleteOne:
    ...
    async def exec(self, irec: tEatokKey = None) -> "dEatokDeleteOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("EatokDeleteOne", self._dbcon.STMNT_TYPE_CUD)
