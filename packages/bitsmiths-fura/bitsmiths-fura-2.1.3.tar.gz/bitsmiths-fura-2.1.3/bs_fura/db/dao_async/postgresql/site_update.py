...
class dSiteUpdate:
    ...
    async def exec(self, irec: tSite = None) -> "dSiteUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("SiteUpdate", self._dbcon.STMNT_TYPE_CUD)
