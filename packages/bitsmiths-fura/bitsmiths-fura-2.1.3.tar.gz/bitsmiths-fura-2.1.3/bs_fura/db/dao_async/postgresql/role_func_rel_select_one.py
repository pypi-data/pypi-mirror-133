...
class dRoleFuncRelSelectOne:
    ...
    async def exec(self, irec: tRoleFuncRelKey = None) -> "dRoleFuncRelSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("RoleFuncRelSelectOne", self._dbcon.STMNT_TYPE_READ)
