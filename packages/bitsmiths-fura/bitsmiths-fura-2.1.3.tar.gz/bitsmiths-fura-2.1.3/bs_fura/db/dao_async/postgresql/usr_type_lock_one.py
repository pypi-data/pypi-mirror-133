...
class dUsrTypeLockOne:
    ...
    async def exec(self, irec: tUsrTypeKey = None) -> "dUsrTypeLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("UsrTypeLockOne", self._dbcon.STMNT_TYPE_READ)
