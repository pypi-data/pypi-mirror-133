...
from bs_fura.db.tables.iusr_type_search import iUsrTypeSearch
from bs_fura.db.tables.usr_type import tUsrType

class dUsrTypeSearch:
    ...
    async def exec(self, irec: iUsrTypeSearch = None) -> "dUsrTypeSearch":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("UsrTypeSearch", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  [criteria]""")
    ...
    async def fetch_all(self, outList: tUsrType.List, clearList: bool = True) -> int:
        """
