...
class dEatokInsert:
    ...
    def exec(self, irec: tEatok = None) -> "dEatokInsert":
        """
        ...
        self._dbstmnt = self._dbcon.statement("EatokInsert", self._dbcon.STMNT_TYPE_CUD)
  ...
  :usages
        ...
        self.irec.id = self._dbcon.post_get_sequence(self._dbstmnt, "fura.Eatok", "id", 8)
