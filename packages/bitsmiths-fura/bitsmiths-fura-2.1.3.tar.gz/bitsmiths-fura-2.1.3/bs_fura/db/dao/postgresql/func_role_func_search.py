...
class dFuncRoleFuncSearch:
    ...
    def exec(self, irec: iFuncRoleFuncSearch = None) -> "dFuncRoleFuncSearch":
        """
        ...
        self._dbstmnt = self._dbcon.statement("FuncRoleFuncSearch", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  f.id like :prefix""")
    ...
    def fetch_all(self, outList: oFuncRoleFuncSearch.List, clearList: bool = True) -> int:
        """
