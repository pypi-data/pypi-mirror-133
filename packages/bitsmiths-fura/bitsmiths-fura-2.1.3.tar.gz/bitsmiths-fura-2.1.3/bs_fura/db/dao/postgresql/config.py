...
class dConfig:
    ...
    def lock_one_with(self, _rec: tConfig, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tConfigKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tConfig) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tConfigKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tConfig) -> "dConfig":
        """
    ...
    def select_one_by_key(self, _key: tConfigKey) -> "dConfig":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tConfig = None):
        """
    ...
    def insert(self, irec: tConfig = None):
        """
    ...
    def delete_one(self, irec: tConfigKey = None):
        """
