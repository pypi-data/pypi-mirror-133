...
class dRole:
    ...
    def lock_one_with(self, _rec: tRole, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tRoleKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tRole) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tRoleKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tRole) -> "dRole":
        """
    ...
    def select_one_by_key(self, _key: tRoleKey) -> "dRole":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tRole = None):
        """
    ...
    def insert(self, irec: tRole = None):
        """
    ...
    def delete_one(self, irec: tRoleKey = None):
        """
