...
class dSiteCfg:
    ...
    def lock_one_with(self, _rec: tSiteCfg, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tSiteCfgKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tSiteCfg) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tSiteCfgKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tSiteCfg) -> "dSiteCfg":
        """
    ...
    def select_one_by_key(self, _key: tSiteCfgKey) -> "dSiteCfg":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tSiteCfg = None):
        """
    ...
    def insert(self, irec: tSiteCfg = None):
        """
    ...
    def delete_one(self, irec: tSiteCfgKey = None):
        """
