...
class dFuncSelectOne:
    ...
    def exec(self, irec: tFuncKey = None) -> "dFuncSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("FuncSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  id = :id""")
    ...
    def fetch_all(self, outList: tFunc.List, clearList: bool = True) -> int:
        """
