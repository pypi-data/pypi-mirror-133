...
class tTokenKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tTokenKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tTokenKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tTokenKey._cache_davs(dvc)
