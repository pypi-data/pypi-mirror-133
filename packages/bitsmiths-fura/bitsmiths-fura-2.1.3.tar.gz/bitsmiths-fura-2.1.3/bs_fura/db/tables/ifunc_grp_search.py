...
class iFuncGrpSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iFuncGrpSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iFuncGrpSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<FuncGrp [site_id:%r, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iFuncGrpSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iFuncGrpSearch._cache_davs(dvc)
