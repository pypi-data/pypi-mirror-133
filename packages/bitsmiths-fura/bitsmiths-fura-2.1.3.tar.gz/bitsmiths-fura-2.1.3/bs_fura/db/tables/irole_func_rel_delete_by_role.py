...
class iRoleFuncRelDeleteByRole(mettle.io.ISerializable):
    ...
    def _name(self) -> str:
        ...
        :return: The name.
        """
        return 'iRoleFuncRelDeleteByRole'
    ...
    def _copy_from(self, rec: "iRoleFuncRelDeleteByRole"):
        """
    ...
    def _get_davs(self, dvc=None):
        iRoleFuncRelDeleteByRole._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<RoleFuncRel [site_id:%r, role_id:%.32s]>' % (
            self.site_id, self.role_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iRoleFuncRelDeleteByRole.List'
        ...
        def __repr__(self) -> str:
            return '<iRoleFuncRelDeleteByRole.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleFuncRelDeleteByRole._cache_davs(dvc)
