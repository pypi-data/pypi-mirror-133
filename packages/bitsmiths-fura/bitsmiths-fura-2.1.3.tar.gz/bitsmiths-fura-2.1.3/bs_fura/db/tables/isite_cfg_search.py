...
class iSiteCfgSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iSiteCfgSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iSiteCfgSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<SiteCfg [site_id:%r, criteria:%.32s]>' % (
            self.site_id, self.criteria)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iSiteCfgSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iSiteCfgSearch._cache_davs(dvc)
