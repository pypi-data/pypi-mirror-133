...
class iAgaSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iAgaSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iAgaSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Aga [site_id:%r, date_from:%s, date_to:%s, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iAgaSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iAgaSearch._cache_davs(dvc)
