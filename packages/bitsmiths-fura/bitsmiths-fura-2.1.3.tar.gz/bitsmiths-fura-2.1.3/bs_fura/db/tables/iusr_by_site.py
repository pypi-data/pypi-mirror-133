...
class iUsrBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUsrBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUsrBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Usr [site_id:%r, role_id:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iUsrBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUsrBySite._cache_davs(dvc)
