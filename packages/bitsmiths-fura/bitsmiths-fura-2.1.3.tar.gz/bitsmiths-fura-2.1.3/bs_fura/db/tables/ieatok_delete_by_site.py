...
class iEatokDeleteBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iEatokDeleteBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iEatokDeleteBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Eatok [site_id:%r]>' % (
            self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iEatokDeleteBySite.List'
        ...
        def __repr__(self) -> str:
            return '<iEatokDeleteBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iEatokDeleteBySite._cache_davs(dvc)
