...
class iUlaSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUlaSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUlaSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Ula [site_id:%r, date_from:%s, date_to:%s, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iUlaSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUlaSearch._cache_davs(dvc)
