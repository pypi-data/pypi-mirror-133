...
class iRoleSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iRoleSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iRoleSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Role [site_id:%r, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iRoleSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleSearch._cache_davs(dvc)
