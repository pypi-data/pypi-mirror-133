...
class tTokenSentryKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tTokenSentryKey"):
        """
    ...
    def _get_davs(self, dvc=None):
        tTokenSentryKey._cache_davs(dvc)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tTokenSentryKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tTokenSentryKey._cache_davs(dvc)
