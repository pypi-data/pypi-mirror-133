...
class iRoleDeleteBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iRoleDeleteBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iRoleDeleteBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Role [site_id:%r]>' % (
            self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iRoleDeleteBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleDeleteBySite._cache_davs(dvc)
