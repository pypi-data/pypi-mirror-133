...
class tToken(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def _copy_from(self, rec: "tToken"):
        """
    ...
    def _write_pk(self, _key: "tToken"):
        """
    ...
    def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
        tToken._cache_davs(dvc, for_ins, key_only)

    def _write_key(self, _key: tTokenKey):
        """
    ...
    def _read_key(self, _key: tTokenKey):
        """
    ...
    def __repr__(self) -> str:
        return '<Token [site_id:%r, id:%.32s, usr_id:%.32s, date_created:%s, expires:%s, use_cnt:%r, aud_id:%.32s, tm_stamp:%s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tToken.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
            return tToken._cache_davs(dvc, for_ins, key_only)
