...
class FuraAsyncServerInterface(IServerInterface):
    ...
    async def site_cfg_create(self,
    ...
    async def site_cfg_update(self,
                              rec: tSiteCfg) -> tSiteCfg:
        """
    ...
    async def site_cfg_delete(self,
                              site_cfg_id: str):
        """
    ...
    async def user_token_reset(self,
                               auth_type: str):
        """
    ...
    async def user_confirm_contact(self,
                                   otp: str):
        """
    ...
    async def user_confirm_contact_req_otp(self,
                                           contact_addr: str):
        """
    ...
    async def user_type_create(self,
    ...
    async def user_type_update(self,
                               rec: tUsrType) -> tUsrType:
        """
    ...
    async def user_type_delete(self,
                               usr_type_id: str):
        """
