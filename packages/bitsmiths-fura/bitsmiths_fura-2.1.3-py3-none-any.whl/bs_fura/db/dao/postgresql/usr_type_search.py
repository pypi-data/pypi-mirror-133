...
class dUsrTypeSearch:
    ...
    def exec(self, irec: iUsrTypeSearch = None) -> "dUsrTypeSearch":
        """
        ...
        self._dbstmnt = self._dbcon.statement("UsrTypeSearch", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  [criteria]""")
    ...
    def fetch_all(self, outList: tUsrType.List, clearList: bool = True) -> int:
        """
