...
class dUsrOtp:
    ...
    def lock_one_with(self, _rec: tUsrOtp, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tUsrOtpKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tUsrOtp) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tUsrOtpKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tUsrOtp) -> "dUsrOtp":
        """
    ...
    def select_one_by_key(self, _key: tUsrOtpKey) -> "dUsrOtp":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tUsrOtp = None):
        """
    ...
    def insert(self, irec: tUsrOtp = None):
        """
