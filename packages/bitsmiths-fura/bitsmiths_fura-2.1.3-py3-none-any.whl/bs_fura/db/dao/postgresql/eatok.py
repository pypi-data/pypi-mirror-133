...
class dEatok:
    ...
    def lock_one_with(self, _rec: tEatok, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tEatokKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tEatok) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tEatokKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tEatok) -> "dEatok":
        """
    ...
    def select_one_by_key(self, _key: tEatokKey) -> "dEatok":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tEatok = None):
        """
    ...
    def insert(self, irec: tEatok = None):
        """
    ...
    def delete_one(self, irec: tEatokKey = None):
        """
