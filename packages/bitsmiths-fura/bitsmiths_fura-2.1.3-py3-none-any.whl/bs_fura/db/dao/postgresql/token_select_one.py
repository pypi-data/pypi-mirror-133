...
class dTokenSelectOne:
    ...
    def exec(self, irec: tTokenKey = None) -> "dTokenSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("TokenSelectOne", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  id = :id""")
    ...
    def fetch_all(self, outList: tToken.List, clearList: bool = True) -> int:
        """
