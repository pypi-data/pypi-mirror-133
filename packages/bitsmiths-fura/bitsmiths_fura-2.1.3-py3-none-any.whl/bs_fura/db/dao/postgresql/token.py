...
class dToken:
    ...
    def lock_one_with(self, _rec: tToken, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tTokenKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tToken) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tTokenKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tToken) -> "dToken":
        """
    ...
    def select_one_by_key(self, _key: tTokenKey) -> "dToken":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tToken = None):
        """
    ...
    def insert(self, irec: tToken = None):
        """
    ...
    def delete_one(self, irec: tTokenKey = None):
        """
