...
class dAdaSearch:
    ...
    def exec(self, irec: iAdaSearch = None) -> "dAdaSearch":
        """
        ...
        self._dbstmnt = self._dbcon.statement("AdaSearch", self._dbcon.STMNT_TYPE_READ)
...
order by
  a.id desc""")
    ...
    def fetch_all(self, outList: tAda.List, clearList: bool = True) -> int:
        """
