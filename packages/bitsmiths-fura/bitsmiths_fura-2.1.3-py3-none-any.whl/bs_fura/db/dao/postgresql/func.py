...
class dFunc:
    ...
    def lock_one_with(self, _rec: tFunc, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tFuncKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tFunc) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tFuncKey) -> bool:
        """
    ...
    def select_one_with(self, _rec: tFunc) -> "dFunc":
        """
    ...
    def select_one_by_key(self, _key: tFuncKey) -> "dFunc":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tFunc = None):
        """
    ...
    def insert(self, irec: tFunc = None):
        """
    ...
    def delete_one(self, irec: tFuncKey = None):
        """
