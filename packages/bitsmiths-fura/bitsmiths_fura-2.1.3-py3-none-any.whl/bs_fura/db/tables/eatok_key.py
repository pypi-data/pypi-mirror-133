...
class tEatokKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tEatokKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tEatokKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tEatokKey._cache_davs(dvc)
