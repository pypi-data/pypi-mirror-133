...
class iRoleFuncRelSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iRoleFuncRelSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iRoleFuncRelSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<RoleFuncRel [site_id:%r, role_id:%.32s, criteria:%.32s]>' % (
            self.site_id, self.role_id, self.criteria)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iRoleFuncRelSearch.List'
        ...
        def __repr__(self) -> str:
            return '<iRoleFuncRelSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleFuncRelSearch._cache_davs(dvc)
