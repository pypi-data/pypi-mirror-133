...
class iUsrDeleteBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUsrDeleteBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUsrDeleteBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Usr [site_id:%r]>' % (
            self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iUsrDeleteBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUsrDeleteBySite._cache_davs(dvc)
