...
class tConfigKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tConfigKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tConfigKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tConfigKey._cache_davs(dvc)
