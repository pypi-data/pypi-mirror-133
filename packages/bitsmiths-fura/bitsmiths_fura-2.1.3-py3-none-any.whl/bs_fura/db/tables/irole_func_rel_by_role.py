...
class iRoleFuncRelByRole(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iRoleFuncRelByRole"):
        """
    ...
    def _get_davs(self, dvc=None):
        iRoleFuncRelByRole._cache_davs(dvc)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iRoleFuncRelByRole.List'
        ...
        def __repr__(self) -> str:
            return '<iRoleFuncRelByRole.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleFuncRelByRole._cache_davs(dvc)
