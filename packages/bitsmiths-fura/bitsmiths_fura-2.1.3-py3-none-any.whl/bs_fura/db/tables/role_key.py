...
class tRoleKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tRoleKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tRoleKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tRoleKey._cache_davs(dvc)
