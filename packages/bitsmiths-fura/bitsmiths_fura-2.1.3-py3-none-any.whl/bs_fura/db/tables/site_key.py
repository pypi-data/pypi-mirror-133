...
class tSiteKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tSiteKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tSiteKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tSiteKey._cache_davs(dvc)
