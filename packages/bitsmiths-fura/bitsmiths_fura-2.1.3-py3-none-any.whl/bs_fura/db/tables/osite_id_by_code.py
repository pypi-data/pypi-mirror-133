...
class oSiteIdByCode(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "oSiteIdByCode"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<oSiteIdByCode.List[%d]>' % (len(self))
