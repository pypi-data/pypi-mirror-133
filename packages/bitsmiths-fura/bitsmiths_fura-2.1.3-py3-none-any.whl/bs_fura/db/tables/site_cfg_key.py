...
class tSiteCfgKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tSiteCfgKey"):
        """
    ...
    def __repr__(self) -> str:
        return '<SiteCfg [site_id:%r, id:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tSiteCfgKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tSiteCfgKey._cache_davs(dvc)
