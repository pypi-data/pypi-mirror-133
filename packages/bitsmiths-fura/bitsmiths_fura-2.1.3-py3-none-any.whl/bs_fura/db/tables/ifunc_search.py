...
class iFuncSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iFuncSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iFuncSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Func [site_id:%r, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iFuncSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iFuncSearch._cache_davs(dvc)
