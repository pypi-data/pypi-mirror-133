...
class iUsrTypeSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUsrTypeSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUsrTypeSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<UsrType [criteria:%.32s]>' % (
            self.criteria)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iUsrTypeSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUsrTypeSearch._cache_davs(dvc)
