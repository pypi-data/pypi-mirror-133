...
class iEatokSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iEatokSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iEatokSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Eatok [tok:%.32s, site_id:%r]>' % (
            self.tok, self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iEatokSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iEatokSearch._cache_davs(dvc)
