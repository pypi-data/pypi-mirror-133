...
class iRoleBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iRoleBySite"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iRoleBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iRoleBySite._cache_davs(dvc)
