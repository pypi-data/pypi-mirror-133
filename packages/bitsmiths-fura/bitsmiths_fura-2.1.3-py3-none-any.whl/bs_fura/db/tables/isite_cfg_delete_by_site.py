...
class iSiteCfgDeleteBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iSiteCfgDeleteBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iSiteCfgDeleteBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<SiteCfg [site_id:%r]>' % (
            self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iSiteCfgDeleteBySite.List'
        ...
        def __repr__(self) -> str:
            return '<iSiteCfgDeleteBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iSiteCfgDeleteBySite._cache_davs(dvc)
