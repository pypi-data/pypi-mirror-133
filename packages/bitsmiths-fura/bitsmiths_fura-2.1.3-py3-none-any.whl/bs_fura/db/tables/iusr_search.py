...
class iUsrSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUsrSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUsrSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Usr [site_id:%r, criteria:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iUsrSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUsrSearch._cache_davs(dvc)
