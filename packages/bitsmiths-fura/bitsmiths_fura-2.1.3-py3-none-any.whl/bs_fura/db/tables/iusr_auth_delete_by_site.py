...
class iUsrAuthDeleteBySite(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iUsrAuthDeleteBySite"):
        """
    ...
    def _get_davs(self, dvc=None):
        iUsrAuthDeleteBySite._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<UsrAuth [site_id:%r]>' % (
            self.site_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iUsrAuthDeleteBySite.List'
        ...
        def __repr__(self) -> str:
            return '<iUsrAuthDeleteBySite.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iUsrAuthDeleteBySite._cache_davs(dvc)
