...
class tFuncGrp(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def _copy_from(self, rec: "tFuncGrp"):
        """
    ...
    def _write_pk(self, _key: "tFuncGrp"):
        """
    ...
    def _read_pk(self, _key: "tFuncGrp"):
        """
    ...
    def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
        tFuncGrp._cache_davs(dvc, for_ins, key_only)

    def _write_key(self, _key: tFuncGrpKey):
        """
    ...
    def _read_key(self, _key: tFuncGrpKey):
        """
    ...
    def __repr__(self) -> str:
        return '<FuncGrp [id:%.32s, descr:%.32s, modified_by:%.32s, tm_stamp:%s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tFuncGrp.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None, for_ins: bool = False, key_only: bool = False):
            return tFuncGrp._cache_davs(dvc, for_ins, key_only)
