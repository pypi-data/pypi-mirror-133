...
class tUsrTypeKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tUsrTypeKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tUsrTypeKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tUsrTypeKey._cache_davs(dvc)
