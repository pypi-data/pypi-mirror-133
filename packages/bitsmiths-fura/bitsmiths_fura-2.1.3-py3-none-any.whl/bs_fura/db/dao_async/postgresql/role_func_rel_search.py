...
class dRoleFuncRelSearch:
    ...
    async def exec(self, irec: iRoleFuncRelSearch = None) -> "dRoleFuncRelSearch":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("RoleFuncRelSearch", self._dbcon.STMNT_TYPE_READ)
...
order by
  4, 2""")
    ...
    async def fetch_all(self, outList: oRoleFuncRelSearch.List, clearList: bool = True) -> int:
        """
