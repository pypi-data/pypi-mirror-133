...
class dConfigLockOne:
    ...
    async def exec(self, irec: tConfigKey = None) -> "dConfigLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("ConfigLockOne", self._dbcon.STMNT_TYPE_READ)
