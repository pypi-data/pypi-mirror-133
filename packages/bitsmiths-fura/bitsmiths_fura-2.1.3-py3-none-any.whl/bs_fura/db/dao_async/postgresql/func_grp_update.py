...
class dFuncGrpUpdate:
    ...
    async def exec_deft(self,
                        id: str,
                        descr: str,
                        modified_by: str) -> "dFuncGrpUpdate":
        """
    ...
    async def exec(self, irec: tFuncGrp = None) -> "dFuncGrpUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("FuncGrpUpdate", self._dbcon.STMNT_TYPE_CUD)
