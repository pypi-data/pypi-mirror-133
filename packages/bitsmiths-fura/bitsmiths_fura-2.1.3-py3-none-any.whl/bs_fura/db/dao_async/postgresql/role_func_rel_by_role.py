...
class dRoleFuncRelByRole:
    ...
    async def exec(self, irec: iRoleFuncRelByRole = None) -> "dRoleFuncRelByRole":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("RoleFuncRelByRole", self._dbcon.STMNT_TYPE_READ)
