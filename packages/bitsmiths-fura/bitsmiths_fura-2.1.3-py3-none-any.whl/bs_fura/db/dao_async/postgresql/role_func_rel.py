...
class dRoleFuncRel:
    ...
    async def lock_one_with(self, _rec: tRoleFuncRel, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tRoleFuncRelKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tRoleFuncRel) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tRoleFuncRelKey) -> bool:
        """
    ...
    async def select_one(self) -> "dRoleFuncRel":
        """
    ...
    async def select_one_with(self, _rec: tRoleFuncRel) -> "dRoleFuncRel":
        """
    ...
    async def select_one_by_key(self, _key: tRoleFuncRelKey) -> "dRoleFuncRel":
        """
        Attempt to select the record with it's primary key.
    ...
    async def insert(self, irec: tRoleFuncRel = None):
        """
    ...
    async def delete_one(self, irec: tRoleFuncRelKey = None):
        """
