...
from bs_fura.db.tables.iada_search import iAdaSearch
...
class dAdaSearch:
    ...
    async def exec(self, irec: iAdaSearch = None) -> "dAdaSearch":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("AdaSearch", self._dbcon.STMNT_TYPE_READ)
...
order by
  a.id desc""")
        ...
        self._dbstmnt.bind_out("reason", str, 128)
    ...
    async def fetch(self) -> bool:
        ...
        self.orec.reason = self._dbstmnt.result[9]

        return True

    async def fetch_all(self, outList: tAda.List, clearList: bool = True) -> int:
        """
