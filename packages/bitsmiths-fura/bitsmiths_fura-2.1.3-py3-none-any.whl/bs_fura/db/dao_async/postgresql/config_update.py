...
class dConfigUpdate:
    ...
    async def exec(self, irec: tConfig = None) -> "dConfigUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("ConfigUpdate", self._dbcon.STMNT_TYPE_CUD)
