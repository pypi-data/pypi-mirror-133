...
class dRoleUpdate:
    ...
    async def exec(self, irec: tRole = None) -> "dRoleUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("RoleUpdate", self._dbcon.STMNT_TYPE_CUD)
