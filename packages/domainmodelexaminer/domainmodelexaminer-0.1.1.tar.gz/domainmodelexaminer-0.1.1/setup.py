...
setup(
    ...
    package_data={'domainmodelexaminer' : ['data_files/*']},
    packages=find_packages(include=["domainmodelexaminer", "domainmodelexaminer.*"]),
    url="https://github.com/dojo-modeling/domain-model-examiner",
    version='0.1.1',
    zip_safe=False,
