...
class Consumer(threading.Thread):
    ...
    def _on_channel_open(self, channel):
        ...
        self._setup_error_exchange(self.config.error_queue_exchange)
    ...
    def _on_queue_declareok(self, _unused_frame, userdata):
        ...
        self._channel.queue_bind(
            ...
            self.config.error_queue_exchange,
            routing_key="")
    ...
    def _setup_error_exchange(self, exchange_name):
        """Setup the exchange on RabbitMQ by invoking the Exchange.Declare RPC
        command. When it is complete, the on_exchange_declareok method will
        be invoked by pika.
        :param str|unicode exchange_name: The name of the exchange to declare
    ...
    def _setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(queue=queue_name, durable=True,
                                    arguments={"x-queue-type": "quorum",
                                               "x-dead-letter-exchange": self.config.error_queue_exchange,
    ...
    def _run_message_callback(self, delivery_tag, body, properties):
        try:
            ...
            cb = functools.partial(self._reject_message, delivery_tag, False)
            self._connection.ioloop.add_callback_threadsafe(cb)
