...
from fair_dynamic_rec.core.util.files import Files #, create_study_output, BBO, create_log_name, purge_old_logs, InvalidConfiguration, InvalidCommand, UnsupportedFeatureException, LibRecAutoException
from fair_dynamic_rec.core.util.utils import purge_old_logs, create_log_name
# from librec_auto.core.cmd import Cmd, SetupCmd, SequenceCmd, PurgeCmd, LibrecCmd, PostCmd, RerankCmd, StatusCmd, ParallelCmd, CheckCmd, CleanupCmd, AlgCmd
# import logging
...
if __name__ == '__main__':
    ...
    sim.run(config, dataObj)

    viz = VisualizationCmd(config, dataObj, sim.rankers)

    metric = MetricCmd(config, dataObj, sim.rankers)
