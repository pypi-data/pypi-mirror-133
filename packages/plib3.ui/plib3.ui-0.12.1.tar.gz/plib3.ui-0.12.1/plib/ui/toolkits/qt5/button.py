...
class PQtButtonBase(qt.QPushButton, PQtActionMixin, PQtWidgetBase):
...
class PCheckBox(qt.QCheckBox, PQtWidgetBase, PCheckBoxBase,
                metaclass=PQtWidgetMeta):
