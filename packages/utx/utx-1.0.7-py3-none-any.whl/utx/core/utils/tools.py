...
def ios_device_info():
    ...
    :return:
    """
    res = subprocess.run('{} info'.format(decryption(b'dGlkZXZpY2U=')), shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
