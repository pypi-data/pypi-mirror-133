...
class QDesignerMemberSheetExtension(sip.simplewrapper):
    """
    https://doc.qt.io/qt-5/qdesignermembersheetextension.html
    ...
    **QExtensionManager**  manager = formEditor->extensionManager();
    memberSheet = qt_extension<**QDesignerMemberSheetExtension** *>(manager,
    widget);
    ...
    **See also** **QExtensionFactory** , **QExtensionManager** , and **Creating
    ...
    def parameterNames(self, index: int) -> typing.List[QtCore.QByteArray]:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#parameterNames
    ...
    def parameterTypes(self, index: int) -> typing.List[QtCore.QByteArray]:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#parameterTypes
    ...
    def signature(self, index: int) -> str:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#signature
    ...
    def declaredInClass(self, index: int) -> str:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#declaredInClas
        s
    ...
    def inheritedFromWidget(self, index: int) -> bool:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#inheritedFromW
        idget
    ...
    def isSlot(self, index: int) -> bool:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#isSlot
    ...
    def isSignal(self, index: int) -> bool:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#isSignal
    ...
    def setVisible(self, index: int, b: bool) -> None:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#setVisible
    ...
    def isVisible(self, index: int) -> bool:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#isVisible
    ...
    def setMemberGroup(self, index: int, group: str) -> None:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#setMemberGroup
    ...
    def memberGroup(self, index: int) -> str:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#memberGroup
    ...
    def memberName(self, index: int) -> str:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#memberName
    ...
    def indexOf(self, name: str) -> int:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#indexOf
    ...
    def count(self) -> int:
        """
        https://doc.qt.io/qt-5/qdesignermembersheetextension.html#count
