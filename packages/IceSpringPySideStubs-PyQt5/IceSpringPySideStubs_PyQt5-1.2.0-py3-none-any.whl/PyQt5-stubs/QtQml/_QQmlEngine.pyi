    ...
    **See also** **QQmlComponent** , **QQmlContext** , and **QML Global Object**
    ...
    def singletonInstance(self, qmlTypeId: int) -> QtCore.QObject:
        ...
        **template <typename T> T QQmlEngine::singletonInstance(int qmlTypeId
        ...
        Returns the instance of a singleton type that was registered under
        **qmlTypeId**.

        The template argument **T** may be either **QJSValue**  or a pointer to
        a **QObject** -derived type and depends on how the singleton was
        registered. If no instance of **T** has been created yet, it is created
        now. If **qmlTypeId** does not represent a valid singleton type, either
        a default constructed **QJSValue**  or a `nullptr` is returned.
        ...
        **QQmlEngine**  engine;
        ...
        engine.singletonInstance<MySingleton\\*>(MySingleton::typeId);
        ...
        **QQmlEngine**  engine;
            **QJSValue**  instance =
        engine.singletonInstance<**QJSValue** >(typeId);

        It is recommended to store the QML type id, e.g. as a static member in
        the singleton class. The lookup via **qmlTypeId** () is costly.

        This function was introduced in Qt 5.12.

        **See also** **QML_SINGLETON** , **qmlRegisterSingletonType** (), and
        **qmlTypeId** ().
        """
        ...
    ...
    def retranslate(self) -> None:
        ...
        **Note:** Due to a limitation in the implementation, this function
        refreshes all the engine's bindings, not only those that use strings
        marked for translation. This may be optimized in a future release.
    ...
    def offlineStorageDatabaseFilePath(self, databaseName: str) -> str:
        ...
        **QString QQmlEngine::offlineStorageDatabaseFilePath(const QString &
        databaseName ) const**
    ...
    def objectOwnership(a0: QtCore.QObject) -> "QQmlEngine.ObjectOwnership":
        ...
        **[static] QQmlEngine::ObjectOwnership
        QQmlEngine::objectOwnership(QObject * object )**
    ...
    def setObjectOwnership(
        a0: QtCore.QObject, a1: "QQmlEngine.ObjectOwnership"
    ) -> None:
        """
        https://doc.qt.io/qt-5/qqmlengine.html#setObjectOwnership

        **[static] void QQmlEngine::setObjectOwnership(QObject * object ,
        QQmlEngine::ObjectOwnership ownership )**
    ...
    def setNetworkAccessManagerFactory(
        self, a0: "QQmlNetworkAccessManagerFactory"
    ) -> None:
        """
    ...
    def importPlugin(
        self, filePath: str, uri: str, errors: typing.Iterable["QQmlError"]
    ) -> bool:
        """
    ...
    @property
    def exit(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def quit(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def warnings(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
