...
class QColor(sip.simplewrapper):
    ...
    **hue** () and **cyan** (). The values of the color components can also be
    ...
    functions. Using the RGB color model, the color components can in addition
    be accessed with **rgb** ().
    ...
    **Alpha-Blended Drawing**
    ...
    and **setAlphaF** () if its value is qreal (double). By default, the alpha-
    channel is set to 255 (opaque). To retrieve and set **all** the RGB color
    ...
    **See also** **QPalette** , **QBrush** , and **QColorConstants** .
    ...
    def __init__(self, color: QtCore.Qt.GlobalColor) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#QColor
    ...
    def __init__(self, rgb: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#QColor-1
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#QColor-4
    ...
    def __init__(self, acolor: typing.Union["QColor", QtCore.Qt.GlobalColor]) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#QColor-8
    ...
    def toExtendedRgb(self) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#toExtendedRgb
    ...
    def fromRgba64(r: int, g: int, b: int, alpha: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromRgba64

        **[static] QColor QColor::fromRgba64(ushort r , ushort g , ushort b ,
        ushort a = USHRT_MAX)**
    ...
    def fromRgba64(rgba: "QRgba64") -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromRgba64-1
    ...
    def setRgba64(self, rgba: "QRgba64") -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRgba64
    ...
    def rgba64(self) -> "QRgba64":
        """
        https://doc.qt.io/qt-5/qcolor.html#rgba64
    ...
    def isValidColor(name: str) -> bool:
        """
        https://doc.qt.io/qt-5/qcolor.html#isValidColor
    ...
    def fromHslF(h: float, s: float, l: float, alpha: float = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromHslF

        **[static] QColor QColor::fromHslF(qreal h , qreal s , qreal l , qreal a
        = 1.0)**
    ...
    def fromHsl(h: int, s: int, l: int, alpha: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromHsl
    ...
    def toHsl(self) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#toHsl
    ...
    def setHslF(self, h: float, s: float, l: float, alpha: float = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setHslF
    ...
    def getHslF(self) -> typing.Tuple[float, float, float, float]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getHslF

        **void QColor::getHslF(qreal * h , qreal * s , qreal * l , qreal * a =
        nullptr) const**
    ...
    def setHsl(self, h: int, s: int, l: int, alpha: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setHsl
    ...
    def getHsl(self) -> typing.Tuple[int, int, int, int]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getHsl
    ...
    def lightnessF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#lightnessF
    ...
    def hslSaturationF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#hslSaturationF
    ...
    def hslHueF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#hslHueF
    ...
    def lightness(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#lightness
    ...
    def hslSaturation(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#hslSaturation
    ...
    def hslHue(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#hslHue
    ...
    def hsvSaturationF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#hsvSaturationF
    ...
    def hsvHueF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#hsvHueF
    ...
    def hsvSaturation(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#hsvSaturation
    ...
    def hsvHue(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#hsvHue
    ...
    def darker(self, factor: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#darker
    ...
    def lighter(self, factor: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#lighter
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcolor.html#isValid
    ...
    def fromCmykF(
        ...
        """
        https://doc.qt.io/qt-5/qcolor.html#fromCmykF

        **[static] QColor QColor::fromCmykF(qreal c , qreal m , qreal y , qreal
        k , qreal a = 1.0)**
    ...
    def fromCmyk(c: int, m: int, y: int, k: int, alpha: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromCmyk
    ...
    def fromHsvF(h: float, s: float, v: float, alpha: float = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromHsvF

        **[static] QColor QColor::fromHsvF(qreal h , qreal s , qreal v , qreal a
        = 1.0)**
    ...
    def fromHsv(h: int, s: int, v: int, alpha: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromHsv
    ...
    def fromRgbF(r: float, g: float, b: float, alpha: float = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromRgbF

        **[static] QColor QColor::fromRgbF(qreal r , qreal g , qreal b , qreal a
        = 1.0)**
    ...
    def fromRgb(rgb: int) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromRgb
    ...
    def fromRgb(r: int, g: int, b: int, alpha: int = ...) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#fromRgb-1
    ...
    def convertTo(self, colorSpec: "QColor.Spec") -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#convertTo
    ...
    def toCmyk(self) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#toCmyk
    ...
    def toHsv(self) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#toHsv
    ...
    def toRgb(self) -> "QColor":
        """
        https://doc.qt.io/qt-5/qcolor.html#toRgb
    ...
    def setCmykF(
        ...
        """
        https://doc.qt.io/qt-5/qcolor.html#setCmykF
    ...
    def getCmykF(self) -> typing.Tuple[float, float, float, float, float]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getCmykF-1

        **void QColor::getCmykF(qreal * c , qreal * m , qreal * y , qreal * k ,
    ...
    def setCmyk(self, c: int, m: int, y: int, k: int, alpha: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setCmyk
    ...
    def getCmyk(self) -> typing.Tuple[int, int, int, int, int]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getCmyk-1
    ...
    def blackF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#blackF
    ...
    def yellowF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#yellowF
    ...
    def magentaF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#magentaF
    ...
    def cyanF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#cyanF
    ...
    def black(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#black
    ...
    def yellow(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#yellow
    ...
    def magenta(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#magenta
    ...
    def cyan(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#cyan
    ...
    def setHsvF(self, h: float, s: float, v: float, alpha: float = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setHsvF
    ...
    def getHsvF(self) -> typing.Tuple[float, float, float, float]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getHsvF

        **void QColor::getHsvF(qreal * h , qreal * s , qreal * v , qreal * a =
        nullptr) const**
    ...
    def setHsv(self, h: int, s: int, v: int, alpha: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setHsv
    ...
    def getHsv(self) -> typing.Tuple[int, int, int, int]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getHsv
    ...
    def valueF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#valueF
    ...
    def saturationF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#saturationF
    ...
    def hueF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#hueF
    ...
    def value(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#value
    ...
    def saturation(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#saturation
    ...
    def hue(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#hue
    ...
    def setRgba(self, rgba: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRgba
    ...
    def rgba(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#rgba
    ...
    def setRgbF(self, r: float, g: float, b: float, alpha: float = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRgbF
    ...
    def getRgbF(self) -> typing.Tuple[float, float, float, float]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getRgbF

        **void QColor::getRgbF(qreal * r , qreal * g , qreal * b , qreal * a =
        nullptr) const**
    ...
    def setRgb(self, r: int, g: int, b: int, alpha: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRgb
    ...
    def setRgb(self, rgb: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRgb-1
    ...
    def getRgb(self) -> typing.Tuple[int, int, int, int]:
        """
        https://doc.qt.io/qt-5/qcolor.html#getRgb
    ...
    def setBlueF(self, blue: float) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setBlueF
    ...
    def setGreenF(self, green: float) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setGreenF
    ...
    def setRedF(self, red: float) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRedF
    ...
    def blueF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#blueF
    ...
    def greenF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#greenF
    ...
    def redF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#redF
    ...
    def setBlue(self, blue: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setBlue
    ...
    def setGreen(self, green: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setGreen
    ...
    def setRed(self, red: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setRed
    ...
    def blue(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#blue
    ...
    def green(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#green
    ...
    def red(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#red
    ...
    def setAlphaF(self, alpha: float) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setAlphaF

        **void QColor::setAlphaF(qreal alpha )**

        Sets the alpha of this color to **alpha**. qreal alpha is specified in
        the range 0.0-1.0.
    ...
    def alphaF(self) -> float:
        """
        https://doc.qt.io/qt-5/qcolor.html#alphaF
    ...
    def setAlpha(self, alpha: int) -> None:
        """
        https://doc.qt.io/qt-5/qcolor.html#setAlpha
    ...
    def alpha(self) -> int:
        """
        https://doc.qt.io/qt-5/qcolor.html#alpha
    ...
    def spec(self) -> "QColor.Spec":
        """
        https://doc.qt.io/qt-5/qcolor.html#spec
    ...
    def colorNames() -> typing.List[str]:
        """
        https://doc.qt.io/qt-5/qcolor.html#colorNames
    ...
    def name(self, format: "QColor.NameFormat") -> str:
        """
        https://doc.qt.io/qt-5/qcolor.html#name-1
