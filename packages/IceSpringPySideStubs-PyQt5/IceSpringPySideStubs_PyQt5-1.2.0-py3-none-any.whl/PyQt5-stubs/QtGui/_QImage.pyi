...
class QImage(QPaintDevice):
    ...
    **QSvgRenderer** , **Image Composition Example** , **Image Viewer Example**
    ...
    def __init__(self, variant: typing.Any) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#QImage-10

        **QImage::QImage(QImage && other )**

        Move-constructs a QImage instance, making it point at the same object
    ...
    def applyColorTransform(self, transform: QColorTransform) -> None:
        """
        https://doc.qt.io/qt-5/qimage.html#applyColorTransform
    ...
    @typing.overload
    def setPixelColor(
        self, x: int, y: int, c: typing.Union[QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None:
        """
    ...
    def setPixelColor(
        self,
        pt: QtCore.QPoint,
        c: typing.Union[QColor, QtCore.Qt.GlobalColor, QGradient],
    ) -> None:
        """
    ...
    def fromData(
        ...
        """
        https://doc.qt.io/qt-5/qimage.html#fromData-1

        **[static] QImage QImage::fromData(const QByteArray & data , const char
        * format = nullptr)**
    ...
    def loadFromData(
        ...
        **bool QImage::loadFromData(const QByteArray & data , const char *
        format = nullptr)**
