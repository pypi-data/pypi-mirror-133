...
class QImageReader(sip.simplewrapper):
    ...
    **QPainter::drawImage** (), and **Qt::AA_UseHighDpiPixmaps** .
    """

    class ImageReaderError(int):
        UnknownError: QImageReader = ...
        FileNotFoundError: QImageReader = ...
        DeviceError: QImageReader = ...
        UnsupportedFormatError: QImageReader = ...
        InvalidDataError: QImageReader = ...

    @typing.overload
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#QImageReader
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimagereader.html#QImageReader-1
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qimagereader.html#QImageReader-2
    ...
    def imageFormatsForMimeType(
        ...
        """
        https://doc.qt.io/qt-5/qimagereader.html#imageFormatsForMimeType

        **[static] QList<QByteArray> QImageReader::imageFormatsForMimeType(const
        QByteArray & mimeType )**
    ...
    def autoTransform(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#autoTransform
    ...
    def setAutoTransform(self, enabled: bool) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setAutoTransform
    ...
    def transformation(self) -> QImageIOHandler.Transformations:
        """
        https://doc.qt.io/qt-5/qimagereader.html#transformation
    ...
    def supportedSubTypes(self) -> typing.List[QtCore.QByteArray]:
        """
        https://doc.qt.io/qt-5/qimagereader.html#supportedSubTypes
    ...
    def subType(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qimagereader.html#subType
    ...
    def supportedMimeTypes() -> typing.List[QtCore.QByteArray]:
        """
        https://doc.qt.io/qt-5/qimagereader.html#supportedMimeTypes
    ...
    def decideFormatFromContent(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#decideFormatFromContent
    ...
    def setDecideFormatFromContent(self, ignored: bool) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setDecideFormatFromContent
    ...
    def autoDetectImageFormat(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#autoDetectImageFormat
    ...
    def setAutoDetectImageFormat(self, enabled: bool) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setAutoDetectImageFormat
    ...
    def supportsOption(self, option: QImageIOHandler.ImageOption) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#supportsOption
    ...
    def quality(self) -> int:
        """
        https://doc.qt.io/qt-5/qimagereader.html#quality
    ...
    def setQuality(self, quality: int) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setQuality
    ...
    def supportsAnimation(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#supportsAnimation
    ...
    def backgroundColor(self) -> QColor:
        """
        https://doc.qt.io/qt-5/qimagereader.html#backgroundColor
    ...
    def setBackgroundColor(
        ...
        """
        https://doc.qt.io/qt-5/qimagereader.html#setBackgroundColor
    ...
    def text(self, key: str) -> str:
        """
        https://doc.qt.io/qt-5/qimagereader.html#text
    ...
    def textKeys(self) -> typing.List[str]:
        """
        https://doc.qt.io/qt-5/qimagereader.html#textKeys
    ...
    def imageFormat(fileName: str) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qimagereader.html#imageFormat
    ...
    def imageFormat(device: QtCore.QIODevice) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qimagereader.html#imageFormat-1
    ...
    def imageFormat(self) -> QImage.Format:
        """
        https://doc.qt.io/qt-5/qimagereader.html#imageFormat-2
    ...
    def errorString(self) -> str:
        """
        https://doc.qt.io/qt-5/qimagereader.html#errorString
    ...
    def error(self) -> "QImageReader.ImageReaderError":
        """
        https://doc.qt.io/qt-5/qimagereader.html#error
    ...
    def currentImageRect(self) -> QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qimagereader.html#currentImageRect
    ...
    def currentImageNumber(self) -> int:
        """
        https://doc.qt.io/qt-5/qimagereader.html#currentImageNumber
    ...
    def nextImageDelay(self) -> int:
        """
        https://doc.qt.io/qt-5/qimagereader.html#nextImageDelay
    ...
    def imageCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qimagereader.html#imageCount
    ...
    def loopCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qimagereader.html#loopCount
    ...
    def jumpToImage(self, imageNumber: int) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#jumpToImage
    ...
    def jumpToNextImage(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#jumpToNextImage
    ...
    def read(self) -> QImage:
        """
        https://doc.qt.io/qt-5/qimagereader.html#read
    ...
    def read(self, image: QImage) -> bool:
        ...
        **QImage** . Returns `true` on success; otherwise, returns `false`.
        ...
        If **image** has same format and size as the image data that is about to
        be read, this function may not need to allocate a new image before
        reading. Because of this, it can be faster than the other read()
    ...
    def canRead(self) -> bool:
        """
        https://doc.qt.io/qt-5/qimagereader.html#canRead
    ...
    def scaledClipRect(self) -> QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qimagereader.html#scaledClipRect
    ...
    def setScaledClipRect(self, rect: QtCore.QRect) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setScaledClipRect
    ...
    def scaledSize(self) -> QtCore.QSize:
        """
        https://doc.qt.io/qt-5/qimagereader.html#scaledSize
    ...
    def setScaledSize(self, size: QtCore.QSize) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setScaledSize
    ...
    def clipRect(self) -> QtCore.QRect:
        """
        https://doc.qt.io/qt-5/qimagereader.html#clipRect
    ...
    def setClipRect(self, rect: QtCore.QRect) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setClipRect
    ...
    def size(self) -> QtCore.QSize:
        """
        https://doc.qt.io/qt-5/qimagereader.html#size
    ...
    def fileName(self) -> str:
        """
        https://doc.qt.io/qt-5/qimagereader.html#fileName
    ...
    def setFileName(self, fileName: str) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setFileName
    ...
    def device(self) -> QtCore.QIODevice:
        """
        https://doc.qt.io/qt-5/qimagereader.html#device
    ...
    def setDevice(self, device: QtCore.QIODevice) -> None:
        """
        https://doc.qt.io/qt-5/qimagereader.html#setDevice
        ...
        **void QImageReader::setDevice(QIODevice * device )**
        ...
        open the device in **QIODevice::ReadOnly**  mode by calling open(). Note
        that this does not work for certain devices, such as **QProcess** ,
    ...
    def format(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qimagereader.html#format
    ...
    def setFormat(
        ...
        """
        https://doc.qt.io/qt-5/qimagereader.html#setFormat
