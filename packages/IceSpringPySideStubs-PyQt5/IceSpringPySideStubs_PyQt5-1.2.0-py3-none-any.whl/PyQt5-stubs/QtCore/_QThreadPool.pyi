...
class QThreadPool(QObject):
    ...
    **Detailed Description**
    ...
    QThreadPool manages and recyles individual **QThread**  objects to help
    ...
    **See also** **QRunnable** .
    ...
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#QThreadPool
    ...
    def stackSize(self) -> int:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#stackSize-prop
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#clear
    ...
    def waitForDone(self, msecs: int = ...) -> bool:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#waitForDone
    ...
    def releaseThread(self) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#releaseThread
    ...
    def reserveThread(self) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#reserveThread
        ...
        **Note:** This function will always increase the number of active
    ...
    def activeThreadCount(self) -> int:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#activeThreadCount-prop

        **activeThreadCount : const int**

        This property represents the number of active threads in the thread
        pool.
    ...
    def setMaxThreadCount(self, maxThreadCount: int) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#maxThreadCount-prop

        **maxThreadCount : int**

        This property represents the maximum number of threads used by the
        thread pool.
    ...
    def setExpiryTimeout(self, expiryTimeout: int) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#expiryTimeout-prop
    ...
    def tryTake(self, runnable: QRunnable) -> bool:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#tryTake
    ...
    def tryStart(self, runnable: QRunnable) -> bool:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#tryStart
        ...
        **bool QThreadPool::tryStart(QRunnable * runnable )**
        ...
        be deleted automatically by the thread pool after the
        **runnable->run()**  returns. If **runnable->autoDelete()**  returns
        `false`, ownership of **runnable** remains with the caller. Note that
        changing the auto-deletion on **runnable** after calling this function
    ...
    def tryStart(self, functionToRun: typing.Callable[[], None]) -> bool:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#tryStart-1
    ...
    def start(self, runnable: QRunnable, priority: int = ...) -> None:
        """
        https://doc.qt.io/qt-5/qthreadpool.html#start
    ...
    def start(
        ...
        **void QThreadPool::start(std::function<void ()> functionToRun , int
        priority = 0)**
    ...
    def globalInstance() -> "QThreadPool":
        """
        https://doc.qt.io/qt-5/qthreadpool.html#globalInstance
