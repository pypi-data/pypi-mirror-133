...
class QFile(QFileDevice):
    ...
    **QIODevice** ::Text))
    ...
    By default, QFile assumes binary, i.e. it doesn't perform any conversion on
    ...
    **QTextStream**  takes care of converting the 8-bit data stored on disk into
    a 16-bit Unicode **QString** . By default, it assumes that the user system's
    local 8-bit encoding is used (e.g., UTF-8 on most unix based operating
    systems; see **QTextCodec::codecForLocale** () for details). This can be
    changed using **QTextStream::setCodec** ().
    ...
    **See also** **QTextStream** , **QDataStream** , **QFileInfo** , **QDir** ,
    ...
    def __init__(self, name: str) -> None:
        """
        https://doc.qt.io/qt-5/qfile.html#QFile-1
    ...
    def __init__(self, parent: QObject) -> None:
        """
        https://doc.qt.io/qt-5/qfile.html#QFile-2
    ...
    def __init__(self, name: str, parent: QObject) -> None:
        """
        https://doc.qt.io/qt-5/qfile.html#QFile-3
    ...
    def moveToTrash(fileName: str) -> typing.Tuple[bool, str]:
        """
        https://doc.qt.io/qt-5/qfile.html#moveToTrash-1

        **[static] bool QFile::moveToTrash(const QString & fileName , QString *
        pathInTrash = nullptr)**
    ...
    def setPermissions(
        ...
        """
        https://doc.qt.io/qt-5/qfile.html#setPermissions-1
    ...
    def permissions(filename: str) -> QFileDevice.Permissions:
        """
        https://doc.qt.io/qt-5/qfile.html#permissions-1
    ...
    def resize(filename: str, sz: int) -> bool:
        """
        https://doc.qt.io/qt-5/qfile.html#resize-1
    ...
    def open(
        ...
        **[override virtual] bool QFile::open(QIODevice::OpenMode mode )**
        ...
        Opens the file using **OpenMode**  **mode** , returning true if
        successful; otherwise false.

        The **mode** must be **QIODevice::ReadOnly** , **QIODevice::WriteOnly**
        , or **QIODevice::ReadWrite** . It may also have additional flags, such
        as **QIODevice::Text**  and **QIODevice::Unbuffered** .
    ...
    def open(
        ...
        **QFile**  file;
        ...
        () is controlled by the **AutoCloseHandle**  flag. If
        **AutoCloseHandle**  is specified, and this function succeeds, then
        calling **close** () closes the adopted handle. Otherwise, **close** ()
    ...
    def copy(fileName: str, newName: str) -> bool:
        ...
        **[static] bool QFile::copy(const QString & fileName , const QString &
        newName )**

        This is an overloaded function.

        Copies the file **fileName** to **newName**. Returns `true` if
        successful; otherwise returns `false`.

        If a file with the name **newName** already exists, copy() returns
    ...
    def link(oldname: str, newName: str) -> bool:
        ...
        **[static] bool QFile::link(const QString & fileName , const QString &
        linkName )**
        ...
        Windows or a symbolic link on Unix). Returns `true` if successful;
    ...
    def rename(oldName: str, newName: str) -> bool:
        ...
        **[static] bool QFile::rename(const QString & oldName , const QString &
        newName )**
    ...
    def remove(fileName: str) -> bool:
        """
        https://doc.qt.io/qt-5/qfile.html#remove-1
    ...
    def symLinkTarget(fileName: str) -> str:
        """
        https://doc.qt.io/qt-5/qfile.html#symLinkTarget-1
    ...
    def exists(fileName: str) -> bool:
        """
        https://doc.qt.io/qt-5/qfile.html#exists-1
    ...
    def decodeName(localFileName: str) -> str:
        """
        https://doc.qt.io/qt-5/qfile.html#decodeName-1
