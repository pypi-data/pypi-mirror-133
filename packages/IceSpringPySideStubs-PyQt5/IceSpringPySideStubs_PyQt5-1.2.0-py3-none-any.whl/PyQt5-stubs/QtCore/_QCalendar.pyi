...
class QCalendar(sip.simplewrapper):
    """
    https://doc.qt.io/qt-5/qcalendar.html
    ...
    **See also** **QDate**  and **QDateTime** .
    ...
    class System(int):
        Gregorian: QCalendar = ...
        Julian: QCalendar = ...
        Milankovic: QCalendar = ...
        Jalali: QCalendar = ...
        IslamicCivil: QCalendar = ...
    ...
    def availableCalendars() -> typing.List[str]:
        """
        https://doc.qt.io/qt-5/qcalendar.html#availableCalendars
    ...
    def dateTimeToString(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#dateTimeToString

        **QString QCalendar::dateTimeToString(QStringView format , const
        QDateTime & datetime , const QDate & dateOnly , const QTime & timeOnly ,
    ...
    def standaloneWeekDayName(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#standaloneWeekDayName
    ...
    def weekDayName(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#weekDayName
    ...
    def standaloneMonthName(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#standaloneMonthName
    ...
    def monthName(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#monthName
    ...
    def dayOfWeek(self, date: typing.Union["QDate", datetime.date]) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#dayOfWeek
    ...
    def partsFromDate(
        ...
        """
        https://doc.qt.io/qt-5/qcalendar.html#partsFromDate
    ...
    def name(self) -> str:
        """
        https://doc.qt.io/qt-5/qcalendar.html#name
    ...
    def maximumMonthsInYear(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#maximumMonthsInYear
    ...
    def minimumDaysInMonth(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#minimumDaysInMonth
    ...
    def maximumDaysInMonth(self) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#maximumDaysInMonth
    ...
    def hasYearZero(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#hasYearZero
    ...
    def isProleptic(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isProleptic
    ...
    def isSolar(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isSolar
    ...
    def isLuniSolar(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isLuniSolar
    ...
    def isLunar(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isLunar
    ...
    def isGregorian(self) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isGregorian
    ...
    def isLeapYear(self, year: int) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isLeapYear
    ...
    def isDateValid(self, year: int, month: int, day: int) -> bool:
        """
        https://doc.qt.io/qt-5/qcalendar.html#isDateValid
    ...
    def monthsInYear(self, year: int) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#monthsInYear
    ...
    def daysInYear(self, year: int) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#daysInYear
    ...
    def daysInMonth(self, month: int, year: int = ...) -> int:
        """
        https://doc.qt.io/qt-5/qcalendar.html#daysInMonth
