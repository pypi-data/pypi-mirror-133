...
class QAbstractEventDispatcher(QObject):
    ...
    **See also** **QEventLoop** , **QCoreApplication** , and **QThread** .
    ...
    def registerTimer(
        ...
        """
        https://doc.qt.io/qt-5/qabstracteventdispatcher.html#registerTimer-2
    ...
    def registerTimer(
        ...
        """
        https://doc.qt.io/qt-5/qabstracteventdispatcher.html#registerTimer-3

        **[pure virtual] void QAbstractEventDispatcher::registerTimer(int
        timerId , int interval , Qt::TimerType timerType , QObject * object )**
    ...
    @property
    def aboutToBlock(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def awake(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
