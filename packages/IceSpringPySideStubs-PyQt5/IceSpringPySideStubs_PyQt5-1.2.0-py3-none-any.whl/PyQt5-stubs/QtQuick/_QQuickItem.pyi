...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    **See also** **QQuickWindow**  and **QQuickPaintedItem** .
    ...
    class Flags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QQuickItem.Flags", "QQuickItem.Flag"]
        ) -> None:
            ...
    ...
    def updateInputMethod(
        ...
        queries: typing.Union[
            QtCore.Qt.InputMethodQueries, QtCore.Qt.InputMethodQuery
        ] = ...,
    ) -> None:
        """
    ...
    def itemChange(
        ...
        """
        https://doc.qt.io/qt-5/qquickitem.html#itemChange

        **[virtual protected] void QQuickItem::itemChange(QQuickItem::ItemChange
        change , const QQuickItem::ItemChangeData & value )**

        Called when **change** occurs for this item.

        **value** contains extra information relating to the change, when
        applicable.
        ...
        **windowChanged** () signal will be emitted.
        """
        ...
    ...
    def mapFromItem(
        self, item: "QQuickItem", point: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> QtCore.QPointF:
        """
    ...
    def setFlags(
        self, flags: typing.Union["QQuickItem.Flags", "QQuickItem.Flag"]
    ) -> None:
        """
    ...
    @property
    def activeFocusChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def activeFocusOnTabChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def antialiasingChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def baselineOffsetChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def childrenRectChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def clipChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def containmentMaskChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def heightChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def implicitHeightChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def implicitWidthChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def smoothChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def transformOriginChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def widthChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def windowChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
