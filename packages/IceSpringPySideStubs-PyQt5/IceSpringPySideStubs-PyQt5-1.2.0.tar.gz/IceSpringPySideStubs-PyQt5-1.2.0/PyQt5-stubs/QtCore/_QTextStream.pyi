...
class QTextStream(sip.simplewrapper):
    ...
    **QFile** ::Truncate)) {
    ...
    input using the correct codec. Example:
    ...
    **QTextStream**  stream(stdin);
    ...
    used by QTextStream to automatically support different character sets. By
    default, **QTextCodec::codecForLocale** () is used for reading and writing,
    but you can also set the codec by calling **setCodec** (). Automatic Unicode
    detection is also supported. When this feature is enabled (the default
    behavior), QTextStream will detect the UTF-16 or the UTF-32 BOM (Byte Order
    Mark) and switch to the appropriate UTF codec when reading. QTextStream does
    not write a BOM by default, but you can enable this by calling
    **setGenerateByteOrderMark** (true). When QTextStream operates on a
    **QString**  directly, the codec is disabled.
    ...
    **See also** **QDataStream** , **QIODevice** , **QFile** , **QBuffer** ,
    **QTcpSocket** , and **Text Codecs Example** .
    """
    ...
    def __init__(self, device: QIODevice) -> None:
        """
        https://doc.qt.io/qt-5/qtextstream.html#QTextStream-1
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/qtextstream.html#QTextStream-2

        **QTextStream::QTextStream(FILE * fileHandle , QIODevice::OpenMode
    ...
    def setDevice(self, device: QIODevice) -> None:
        ...
        **Note:** This function resets locale to the default locale ('C') and
        codec to the default codec, **QTextCodec::codecForLocale** ().
    ...
    def generateByteOrderMark(self) -> bool:
        ...
        **bool QTextStream::generateByteOrderMark() const**
        ...
        generation is set to false by default.
    ...
    def setGenerateByteOrderMark(self, generate: bool) -> None:
        ...
        **void QTextStream::setGenerateByteOrderMark(bool generate )**
        ...
        If **generate** is true and a UTF codec is used, **QTextStream**  will
    ...
    def autoDetectUnicode(self) -> bool:
        ...
        **See also** **setAutoDetectUnicode** (), **setCodec** (), and
    ...
    def setAutoDetectUnicode(self, enabled: bool) -> None:
        ...
        **QTextStream**  will replace the current codec with the UTF codec.

        This function can be used together with **setCodec** (). It is common to
        set the codec to UTF-8, and then enable UTF-16 detection.

        **See also** **autoDetectUnicode** (), **setCodec** (), and
        **QTextCodec::codecForUtfText** ().
        """
        ...
    ...
    def codec(self) -> QTextCodec:
        ...
        **See also** **setCodec** (), **setAutoDetectUnicode** (), and
        **locale** ().
        """
        ...
    ...
    def setCodec(self, codec: QTextCodec) -> None:
        ...
        **See also** **codec** (), **setAutoDetectUnicode** (), and
        **setLocale** ().
        """
        ...
