...
class QUuid(sip.simplewrapper):
    ...
    **toString** (). UUIDs have a **variant** () and a **version** (), and null
    ...
    def __init__(
        ...
        """
        https://doc.qt.io/qt-5/quuid.html#QUuid-1
    ...
    def __init__(self, a0: str) -> None:
        """
        https://doc.qt.io/qt-5/quuid.html#QUuid-2
    ...
    def __init__(self, a0: typing.Union[QByteArray, bytes, bytearray]) -> None:
        """
        https://doc.qt.io/qt-5/quuid.html#QUuid-3
    ...
    def __init__(self, a0: "QUuid") -> None:
        """
        https://doc.qt.io/qt-5/quuid.html#QUuid-4
    ...
    def toByteArray(self) -> QByteArray:
        ...
        **QByteArray QUuid::toByteArray() const**
        ...
        Returns the binary representation of this **QUuid** . The byte array is
        formatted as five hex fields separated by '-' and enclosed in curly
        braces, i.e., "{xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}" where 'x' is a
        hex digit. From left to right, the five hex fields are obtained from the
        four public data members in **QUuid**  as follows:
    ...
    def toByteArray(self, mode: "QUuid.StringFormat") -> QByteArray:
        """
        https://doc.qt.io/qt-5/quuid.html#toByteArray-1
    ...
    def createUuidV5(
        ...
        **[static] QUuid QUuid::createUuidV5(const QUuid & ns , const QByteArray
        & baseData )**
    ...
    def createUuidV5(ns: "QUuid", baseData: str) -> "QUuid":
        """
        https://doc.qt.io/qt-5/quuid.html#createUuidV5-1

        **[static] QUuid QUuid::createUuidV5(const QUuid & ns , const QString &
        baseData )**
    ...
    def createUuidV3(
        ...
        **[static] QUuid QUuid::createUuidV3(const QUuid & ns , const QByteArray
        & baseData )**
    ...
    def createUuidV3(ns: "QUuid", baseData: str) -> "QUuid":
        """
        https://doc.qt.io/qt-5/quuid.html#createUuidV3-1

        **[static] QUuid QUuid::createUuidV3(const QUuid & ns , const QString &
        baseData )**
    ...
    def toString(self, mode: "QUuid.StringFormat") -> str:
        """
        https://doc.qt.io/qt-5/quuid.html#toString-1
