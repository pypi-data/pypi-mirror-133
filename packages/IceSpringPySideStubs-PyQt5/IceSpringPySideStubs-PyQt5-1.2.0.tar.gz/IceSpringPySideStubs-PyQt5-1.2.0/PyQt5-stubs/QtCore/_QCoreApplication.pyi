...
class QCoreApplication(QObject):
    ...
    **QEventLoop** , **Semaphores Example** , and **Wait Conditions Example** .
    ...
    @property
    def aboutToQuit(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def applicationNameChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def applicationVersionChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def organizationDomainChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...

    @property
    def organizationNameChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        ...
