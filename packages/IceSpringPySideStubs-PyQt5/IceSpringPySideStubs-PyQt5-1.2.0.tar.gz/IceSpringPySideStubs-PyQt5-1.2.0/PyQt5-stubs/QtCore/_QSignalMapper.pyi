...
class QSignalMapper(QObject):
    ...
    **Detailed Description**
    ...
    signal (it could be **mappedInt** (), **mappedString** (), **mappedWidget**
    () and **mappedObject** ()) with a value associated with the original
    signalling object. Mappings can be removed later using **removeMappings**
    ().
    ...
    **See also** **QObject** , **QButtonGroup** , and **QActionGroup** .
    ...
    def map(self, sender: QObject) -> None:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#map-1
    ...
    def mapping(self, text: str) -> QObject:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#mapping-1
    ...
    def mapping(self, widget: QWidget) -> QObject:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#mapping-2
    ...
    def mapping(self, object: QObject) -> QObject:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#mapping-3
    ...
    def setMapping(self, sender: QObject, text: str) -> None:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#setMapping-1
    ...
    def setMapping(self, sender: QObject, widget: QWidget) -> None:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#setMapping-2

        **void QSignalMapper::setMapping(QObject * sender , QWidget * widget )**

        Adds a mapping so that when **map** () is signalled from the **sender**
        , the signal **mappedWidget** ( **widget** ) is emitted.
    ...
    def setMapping(self, sender: QObject, object: QObject) -> None:
        """
        https://doc.qt.io/qt-5/qsignalmapper.html#setMapping-3
    ...
    @property
    def mappedInt(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def mappedObject(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def mappedString(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def mappedWidget(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
