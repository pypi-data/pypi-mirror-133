...
class QNetworkCookie(sip.simplewrapper):
    """
    https://doc.qt.io/qt-5/qnetworkcookie.html
    ...
    **QNetworkReply** .
    ...
    def __init__(
        self,
        name: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...,
        value: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...,
    ) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#QNetworkCookie
    ...
    def __init__(self, other: "QNetworkCookie") -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#QNetworkCookie-1
    ...
    def normalize(self, url: QtCore.QUrl) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#normalize
    ...
    def hasSameIdentifier(self, other: "QNetworkCookie") -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#hasSameIdentifier
    ...
    def swap(self, other: "QNetworkCookie") -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#swap
    ...
    def setHttpOnly(self, enable: bool) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setHttpOnly
    ...
    def isHttpOnly(self) -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#isHttpOnly
    ...
    @staticmethod
    def parseCookies(
        cookieString: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> typing.List["QNetworkCookie"]:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#parseCookies
    ...
    def toRawForm(self, form: "QNetworkCookie.RawForm" = ...) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#toRawForm
    ...
    def setValue(
        ...
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setValue
    ...
    def value(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#value
    ...
    def setName(
        self, cookieName: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setName
    ...
    def name(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#name
    ...
    def setPath(self, path: str) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setPath
    ...
    def path(self) -> str:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#path
    ...
    def setDomain(self, domain: str) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setDomain
    ...
    def domain(self) -> str:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#domain
    ...
    def setExpirationDate(
        ...
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setExpirationDate
    ...
    def expirationDate(self) -> QtCore.QDateTime:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#expirationDate
    ...
    def isSessionCookie(self) -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#isSessionCookie
    ...
    def setSecure(self, enable: bool) -> None:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#setSecure
    ...
    def isSecure(self) -> bool:
        """
        https://doc.qt.io/qt-5/qnetworkcookie.html#isSecure
