...
class QMainWindow(QWidget):
    ...
    **See also** **QMenuBar** , **QToolBar** , **QStatusBar** , **QDockWidget**
    , **Application Example** , **Dock Widgets Example** , **MDI Example** ,
    **SDI Example** , and **Menus Example** .
    """
    ...
    class DockOptions(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QMainWindow.DockOptions", "QMainWindow.DockOption"]
        ) -> None:
            ...
    ...
    def resizeDocks(
        self,
        docks: typing.Iterable[QDockWidget],
        ...
        **Qt::Horizontal** , adjusts the width, otherwise adjusts the height of
        ...
        specified. Widgets not in the list might be changed to repect the
        constraints.
    ...
    def setTabPosition(
        self,
        areas: typing.Union[QtCore.Qt.DockWidgetAreas, QtCore.Qt.DockWidgetArea],
    ...
    def unifiedTitleAndToolBarOnMac(self) -> bool:
        ...
        * Use in windows with OpenGL content is not supported. This includes
        QGLWidget and **QOpenGLWidget** .
          * Using dockable or movable toolbars
        may result in painting errors and is not recommended
    ...
    def setDockOptions(
        self, options: typing.Union["QMainWindow.DockOptions", "QMainWindow.DockOption"]
    ) -> None:
        """
        https://doc.qt.io/qt-5/qmainwindow.html#dockOptions-prop
    ...
    def restoreState(
        self,
        state: typing.Union[QtCore.QByteArray, bytes, bytearray],
        version: int = ...,
    ) -> bool:
        """
    ...
    @typing.overload
    def addDockWidget(
        self, area: QtCore.Qt.DockWidgetArea, dockwidget: QDockWidget
    ) -> None:
        """
    ...
    def addDockWidget(
        ...
        """
        https://doc.qt.io/qt-5/qmainwindow.html#addDockWidget-1
    ...
    def addToolBar(self, toolbar: "QToolBar") -> None:
        """
        https://doc.qt.io/qt-5/qmainwindow.html#addToolBar-1
    ...
    def addToolBar(self, title: str) -> "QToolBar":
        """
        https://doc.qt.io/qt-5/qmainwindow.html#addToolBar-2
    ...
    @property
    def tabifiedDockWidgetActivated(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
        https://doc.qt.io/qt-5/qmainwindow.html#tabifiedDockWidgetActivated

        **[signal] void QMainWindow::tabifiedDockWidgetActivated(QDockWidget *
        dockWidget )**
