...
class QGraphicsView(QAbstractScrollArea):
    ...
    **QGraphicsSceneEvent** .
    ...
    class CacheMode(sip.simplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QGraphicsView.CacheMode", "QGraphicsView.CacheModeFlag"],
        ) -> None:
            ...
    ...
    class OptimizationFlags(sip.simplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QGraphicsView.OptimizationFlags", "QGraphicsView.OptimizationFlag"
            ],
        ) -> None:
            ...
    ...
    @typing.overload
    def __init__(
        self, scene: QGraphicsScene, parent: typing.Optional[QWidget] = ...
    ) -> None:
        """
    ...
    @typing.overload
    def fitInView(
        self, item: QGraphicsItem, mode: QtCore.Qt.AspectRatioMode = ...
    ) -> None:
        """
    ...
    @typing.overload
    def ensureVisible(
        self, item: QGraphicsItem, xMargin: int = ..., yMargin: int = ...
    ) -> None:
        """
    ...
    def setCacheMode(
        self,
        mode: typing.Union["QGraphicsView.CacheMode", "QGraphicsView.CacheModeFlag"],
    ) -> None:
        """
    ...
    def setRenderHints(
        self, hints: typing.Union[QtGui.QPainter.RenderHints, QtGui.QPainter.RenderHint]
    ) -> None:
        """
    ...
    @property
    def rubberBandChanged(self) -> PyQt5.QtCore.pyqtBoundSignal:
        """
