...
class QExtensionFactory(QtCore.QObject, QAbstractExtensionFactory):
    """
    https://doc.qt.io/qt-5/qextensionfactory.html
    ...
    **See also** **QExtensionManager**  and **QAbstractExtensionFactory** .
    ...
    def __init__(self, parent: typing.Optional["QExtensionManager"] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qextensionfactory.html#QExtensionFactory
    ...
    def createExtension(
        ...
        """
        https://doc.qt.io/qt-5/qextensionfactory.html#createExtension
    ...
    def extensionManager(self) -> "QExtensionManager":
        """
        https://doc.qt.io/qt-5/qextensionfactory.html#extensionManager
    ...
    def extension(self, object: QtCore.QObject, iid: str) -> QtCore.QObject:
        """
        https://doc.qt.io/qt-5/qextensionfactory.html#extension
