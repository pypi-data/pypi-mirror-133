...
class QRemoteObjectAbstractPersistedStore(QtCore.QObject):
    ...
    **Detailed Description**
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-5/qremoteobjectabstractpersistedstore.html#QRemoteO
    ...
    def restoreProperties(
        self, repName: str, repSig: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> typing.List[typing.Any]:
        """
        https://doc.qt.io/qt-5/qremoteobjectabstractpersistedstore.html#restoreP
        roperties
    ...
    def saveProperties(
        self,
        repName: str,
        repSig: typing.Union[QtCore.QByteArray, bytes, bytearray],
        values: typing.Iterable[typing.Any],
    ) -> None:
        """
        https://doc.qt.io/qt-5/qremoteobjectabstractpersistedstore.html#saveProp
        erties
