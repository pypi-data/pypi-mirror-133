...
class QSGRenderNode(QSGNode):
    ...
    **Detailed Description**
    ...
    class RenderingFlag(int):
        BoundedRectRendering: QSGRenderNode = ...
        DepthAwareRendering: QSGRenderNode = ...
        OpaqueRendering: QSGRenderNode = ...

    class StateFlag(int):
        DepthState: QSGRenderNode = ...
        StencilState: QSGRenderNode = ...
        ScissorState: QSGRenderNode = ...
        ColorState: QSGRenderNode = ...
        BlendState: QSGRenderNode = ...
        CullState: QSGRenderNode = ...
        ViewportState: QSGRenderNode = ...
        RenderTargetState: QSGRenderNode = ...
    ...
    class StateFlags(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGRenderNode.StateFlags", "QSGRenderNode.StateFlag"]
        ) -> None:
            ...
    ...
    class RenderingFlags(sip.simplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QSGRenderNode.RenderingFlags", "QSGRenderNode.RenderingFlag"
            ],
        ) -> None:
            ...
    ...
    def inheritedOpacity(self) -> float:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#inheritedOpacity
    ...
    def clipList(self) -> QSGClipNode:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#clipList
    ...
    def matrix(self) -> QtGui.QMatrix4x4:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#matrix
    ...
    def rect(self) -> QtCore.QRectF:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#rect
    ...
    def flags(self) -> "QSGRenderNode.RenderingFlags":
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#flags
    ...
    def releaseResources(self) -> None:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#releaseResources
    ...
    def render(self, state: "QSGRenderNode.RenderState") -> None:
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#render
    ...
    def changedStates(self) -> "QSGRenderNode.StateFlags":
        """
        https://doc.qt.io/qt-5/qsgrendernode.html#changedStates
        ...
        **RenderTargetState**  \\- render target
        ...
        vkCmdSetBlendConstants, vkCmdSetStencilRef in case of Vulkan, and only
        when such commands were added to the scenegraph's command list queried
        ...
        call related settings (pipeline states, descriptor sets, vertex or index
        buffer bindings, root signature, descriptor heaps, etc.) are always set
        again by the scenegraph so **render** () can freely change them.
