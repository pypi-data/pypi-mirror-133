...
class _Dynamic(Configure):
    ...
    def _init_options(self):
        ...
        self.ServerName = self._parser.get(r'Base', r'ServerName')

        ##################################################
        # 跨域

        self.AllowOrigins = self._parser.get_split_str(r'Cros', r'AllowOrigins')

        self.AllowMethods = self._parser.get_split_str(r'Cros', r'AllowMethods')

        self.AllowHeaders = self._parser.get_split_str(r'Cros', r'AllowHeaders')

        self.AllowCredentials = self._parser.getboolean(r'Cros', r'AllowCredentials')
        ...
        self.ThreadPoolMaxWorkers = self._parser.getint(r'ThreadPool', r'ThreadPoolMaxWorkers')
