...
function setup_popup_select(){
    $("div#popup_select").click(function () {
        $("div#select_options").empty();
        $(this).removeClass("show");
    }).find("div#select_content").click(function (e) {
        e.preventDefault();
        e.stopPropagation();
    });
    $("select").each(function () {
        var _this = $(this);
        $(this).css({"pointer-events": "none"}).parent().css({"cursor": "pointer"}).off("click").click(function (e) {
            e.preventDefault();
            e.stopPropagation();
            ...
            var search_to;
            options.parent().find("div#select_search input").val("").off("keyup").keyup(function () {
...
function update_title_hints(){
    ...
    function trigger() {
        ...
        if (offset.left<0){
            title_hint.append("<style>div.title_hint["+id+"]:after{left:calc(50% + "+offset.left+"px)}</style>");
            offset.left = 0;
        }
    ...
    $("[title]").off(events.join(" ")).each(function () {
    ...
    }).on(events[0], trigger).on(events[1], function () {
        var id = $(this).attr("data-id");
        var title_hint = $("div.title_hint["+id+"]");
...
function update_help_hints(){
    ...
    $("div#skip_help_hint").off("click").click(function () {
        skip.push(null);
    });
    $("span.help").off("click").click(function () {
        if(steps!==0){
            return;
        }
...
function main () {
    ...
    $("div#tools > div[id], div#main").click(function (){
        var _this = $(this);
    ...
    $("div#tools div#logout").click(function () {
    ...
    $("div#tools div#import").click(function () {
    ...
    function gen_select(target) {
        get_all_folders(function (response){
		    ...
		    for(var i=0;i<response.length;i++){
		        ...
		        $(target+" select").append("<option data-depth='"+response[i][0]+"' data-name='"+response[i][1][1]+"' value='"+response[i][1][0]+"'>"+indent+"&#x01F4C1; "+response[i][1][1]+"</option>");
            }
        }, function (e) {
		    $(target+" select").empty();
        });
    }
    $("div#tools div#import2").click(function(){
        $("div#import2_page textarea#import2_link").val("");
        gen_select("div#import2_page");
    });
    $("div#tools div#upload").click(function () {
        if(notlogin){
            return;
        }
        files = [];
        ...
        $("div#upload_progress, div#upload_results, div#upload_again, div#upload_abort_btn").slideUp();
    ...
    $("div#files_page div#new_folder").click(function () {
    ...
    $("div#files_page div#select_all").click(function () {
    ...
    $("div#files_page div#cut_file").click(function () {
    ...
    $("div#files_page div#move_file").click(function () {
    ...
    $("div#files_page div#cancel_file").click(function () {
    ...
    $("div#files_page div#share_folders").click(function (e) {
    ...
    $("div#files_page div#rename_folder").click(function () {
        ...
        function next_folder(index){
            ...
            $.post(api_endpoint, "op=rename_folder&id="+$(folder).data("id")+"&name="+name, function (response) {
        ...
        get_all_folders(function (response) {
            ...
            function next_folder(index){
                ...
                function cb(response){
                    if((typeof loop_cb === "function" && loop_cb(folder, response[2]))===false){
                        return;
                    }
                    next_folder(index+1);
                }
    ...
    $("div#popup_item_property").click(function () {
        $("div#item_property span[id]").empty();
        $(this).removeClass("show");
    }).find("div#item_property_content").click(function (e) {
        e.preventDefault();
        e.stopPropagation();
    });
    $("div#files_page div#properties").click(function () {
        ...
        $.post(api_endpoint, "op=get_folder_name&id="+cur_folder, function (response) {
            stats["location"] = response;
            flags[2] = 1;
        }).error(function (e) {
            flags[2] = 1;
        });
        ...
        popup_item_property.click(cancel_handler);
        next_folder(0);
        info("Collecting properties &#x22EF;<br/>Please wait");
    });
    $("div#files_page div#remove_file").click(function () {
        var selected = $("div#files_page div#entries div.table div.tr.selected");
        if (!selected.length){
    ...
    $("div#files_page div#search_item").click(function () {
    ...
    function setup_search_result(result_parent) {
        result_parent.find("div.folder span").click(function () {
    ...
    function gen_search_result(result, targets, orphans) {
        ...
        for(var i=0;i<result.length;i++){
            ...
            if(b.some(function (e) {
                ...
                content += "<div class='folder'><span"+(orphans?" class='collapsed'":"")+">&#x01F4C1;</span> <a href='/#folder="+result[i][0][0]+"' target='_blank'>"+result[i][0][1]+"</a></div>";
            }
            if(result[i][1].length){
                // console.log("".padStart((depth+1)*4, " ")+"file")
                content += "<div class='file depth1'"+(orphans?" style='display:none'":"")+"><span>&#x01F4C4;</span> <a href='/"+result[i][1][0]+"' target='_blank'>"+result[i][1][1]+"</a></div>";
            }
            prev_depth = depth;
    ...
    $("div#files_page div#search_input input.input").keyup(function () {
        ...
        function start_search() {
            ...
            function gen_result(done) {
                function next(length, result) {
                    ...
                    var popup_search_result = $("div#popup_search_result").addClass("show").off("click", click_close_handler).click(click_close_handler);
                    popup_search_result.find("div#search_result_content").off("click").click(function (e) {
                        e.stopPropagation();
                    });
                    popup_search_result.find("div#search_result_title h2 span.quote").html(_this.val());
                    popup_search_result.find("div#search_result_title h2 span.count").html(length);
                    setup_search_result(popup_search_result.find("div#search_result").html(content));
                }
        ...
        search_input_to = setTimeout(function () {
            ...
            $("div#popup_search_result").click(cancel_handler);
        }, 1000);
    });
    $("div#files_page div#goto_import").click(function () {
        $("div#tools div#import").click();
    });
    $("div#files_page div#goto_import2").click(function () {
        $("div#tools div#import2").click();
    });
    ...
    $("div#import2_page div#import2_btn").click(function () {
    ...
    $("div#import_page div#import_btn").click(function () {
        ...
        function convert_utf8(s){
            ...
            return new TextDecoder("utf-8").decode(new Uint8Array(s));
        }
    ...
    function get_folders(folder, use_cache) {
        get_folder(folder, function (e) {
            $("div#files_page div#entries").empty().append("<p>Failed to get folder!<br/>Refresh might help!</p>");
            ...
            table += "</table>";
            $("div#files_page div#entries").empty().append(table);
            $("div#files_page div#entries div.table a.copy_name").click(function(e){
                e.preventDefault();
                e.stopPropagation();
                var title = $(this).parent().prev().prev().html();
                var temp = $("<input>");
                $("body").append(temp);
            ...
            if(notlogin){
                $("div#files_page div#entries div.table div.td.folder").parent().click(function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                $("div#files_page div#entries div.table a.file, div#files_page div#entries div.table a.folder").click(function (e) {
                    e.stopPropagation();
                });
                $("div#files_page div#entries div.table span.folder_access").click(function (e) {
                    var access = $(this).data("title");
                ...
                $("div#files_page div#entries div.table div.td.file, div#files_page div#entries div.table div.td.folder:not(.parent)").parent().click(function (e) {
    ...
    $("div#tools div#files").click(function () {
        if(notlogin){
            return;
        }
        cut_file = [];
    ...
    $("div#login_page input.input").keydown(function (e) {
        if(e.key === "Enter") {
            $("div#login_btn").click();
        }
    });
    ...
    function gen_progress(size, start_time, progress){
        ...
        return "<div class='progress_wrapper'><div class='progress_bar' style='width: <percentage>%'></div><percentage>% (<speed>)</div>"
    ...
    function convert_to_files(entries){
        ...
        function check_file_size(file){
            return !file.size||file.size>=max_size;
        }
        async function getAllFileEntries(dataTransferItemList) {
            ...
            while (queue.length > 0) {
                ...
                if (entry.isFile) {
                    ...
                    var _ = await readAllDirectoryEntries(entry, path);
        ...
        async function readAllDirectoryEntries(directory, path) {
            let entries = [];
            let readEntries = await readEntriesPromise(directory.createReader());
        ...
        return new Promise(function(resolve, reject){
            ...
            if (entries instanceof FileList){
                ...
                getAllFileEntries(entries).then(resolve);
            }
        });
    }
    function update_file_drop_zone(_){
        ...
        var template = "<tr class='file' data-i='<i>'>" +
            "<td class='name'><name>" +
        ...
        for (var i=0; i<files.length; i++){
            table += template
                ...
                .replace(/<size>/g, format_size(files[i][1].size, 1));
        }
        table += "<tr class='file'><td colspan='3' id='choosemorefiles'>&#x01F4C2; Choose More Files &#x2795;</td></tr>";
        table += "</table>";
        file_drop_zone.empty().append(table);
        file_drop_zone.find("td#choosemorefiles").click(function () {
            $("form#upload_form input").get(0).click();
        });
        file_drop_zone.find("span.edit_name").click(function(){
            var file = files[parseInt($(this).closest("tr").data("i"))];
            var nn = prompt("Enter new name of '"+file[0]+"':");
            if(!nn||file[0]===nn){
                return;
            }
            file[0] = nn;
            $(this).parent().contents()[0].data = nn;
            $(this).hide().next().show();
        });
        file_drop_zone.find("span.undo_edit").click(function(){
            $(this).parent().contents()[0].data = files[parseInt($(this).closest("tr").data("i"))][1].name;
            $(this).hide().prev().show();
        }).hide();
        file_drop_zone.find("td.remove").click(function(e){
            e.preventDefault();
            e.stopPropagation();
    ...
    $("form#upload_form input").change(function(){
        convert_to_files(this.files).then(update_file_drop_zone);
        this.value = "";
    });
    $("div#upload_again").click(function(){
        $("div#upload").click();
    });
	$("div#upload_btn").click(function () {
	    if (!files.length) {
		...
		$("div#upload_progress, div#upload_results, div#upload_abort_btn").slideDown();
		$("div#upload_results div").empty();
		var results = [];
		function upload_file(index) {
            var file = files[index];
            function on_end(){
                if(!$("div#upload_results div").children().length){
                    $("div#upload_results div").html("<h3>Upload probably failed.</h3><h3>File queue is processed.</h3>");
                }
                $("div#upload_progress, div#upload_abort_btn").slideUp();
            ...
            hash(file, hash_flags, function (progress) {
                $("div#client td.hash").html("Calculating &#x22EF; ("+(progress*100).toFixed(2)+"%)");
            }).then(function (_) {
                sha256 = _;
                $("div#client td.hash").html(sha256);
            }, function (_) {
                $("div#client td.hash").html("Failed to calculate hash.");
            });
            function done(res) {
                var integrity = [
                ...
                results.push([
                    ...
                    (target_folder[0]==="root"&&target_folder[1]===-1?"":"/"+target_folder[0])+file.path,
                    integrity
                ]);
                $("div#upload_results div").empty().append(gen_results(results));
            ...
            var server_progress_ti = setInterval(function () {
                $.post(api_endpoint, "op=get_server_progress&session="+session, function(response){
                    var _ = parseInt(response)/100;
            ...
            $("div#upload_abort_btn").off("click").click(function () {
                user_abort = 1;
                hash_flags["abort"] = 1;
                clearInterval(server_progress_ti);
                ...
                _ajax.abort();
                $.post(api_endpoint, "op=abort_relay&session="+session, function () {
                    on_end();
            ...
            _ajax = $.ajax({
                ...
                success: function (res) {
                    ...
                    var done_ti = setInterval(function () {
                        ...
                        file = filename = sha256 = session = query = done_ti = start_time = res = null;
                        upload_file(index+1);
                    }, 50);
                }
            });
    ...
    window.onhashchange = function () {
        ...
        if(hash.indexOf("folder=")!==-1){
            ...
            $("div#tools div#upload").click();
        }
        else if(hash==="files"){
            $("div#tools div#files").click();
        }
        else if(hash==="import"){
            $("div#tools div#import").click();
        }
