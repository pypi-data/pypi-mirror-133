...
class Cmodel(Cannaibase):
    ...
    def avr_two_models(self, e_score,e_score_key=None, kaisu=50, addition_len=5, save_higher=False):
        ...
        print(type(model_list_additional_kari_group[ism]))
        print(model_list_additional_kari_group[ism])
        model_list_additional_kari_group = model_list_additional_kari_group[:addition_len]
