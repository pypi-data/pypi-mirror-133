...
## version==0.0.14
sparrow_aftersale/model.py AfsHgIncomeDivide新增字段payment_num

## version==0.0.13
sparrow_aftersale/model.py AfsHgIncomeDevide改名为AfsHgIncomeDivide; 新增字段hgincome_type_id

## version==0.0.12
sparrow_aftersale/model.py sparrow_aftersale_afs 新增字段afs_sync_status, afs_sync_time
sparrow_aftersale/model.py 新增两个model： AfsHgIncome & AfsHgIncomeDevide
