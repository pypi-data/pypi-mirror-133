...
def check_constants():
    if not (BASE_DIR.name == "hdsr_pygithub" and BASE_DIR.parent != "hdsr_pygithub"):
        raise AssertionError(f"BASE_DIR {BASE_DIR} is wrong, should be the name of the project (root dir)")
