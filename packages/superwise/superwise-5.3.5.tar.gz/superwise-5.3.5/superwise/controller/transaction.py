...
class TransactionController(BaseController):
    ...
    def log_records(self, task_id: str, records: List[dict], version_id: Optional[str] = None):
        """
        ### Description:
        ...
        `task_id`:  string - model id

        `version_id`:  string - version id  of the model -   Optional[for prediction recor
        ...
        self.logger.info(f"Send records with params : task_id={task_id}, version_id={version_id}")
