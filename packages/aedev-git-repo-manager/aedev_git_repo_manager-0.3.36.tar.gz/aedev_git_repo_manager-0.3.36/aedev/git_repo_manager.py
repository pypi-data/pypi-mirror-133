...
detailed information on the installation and usage of this tool are available `in a separate document
<https://aedev.readthedocs.io/en/latest/git_repo_manager.html>`__.
...
def _check_resources_i18n_texts(pdv: PdvType) -> List[str]:
    file_names: List[str] = []
    local_msg_texts = FilesRegister(os.path.join(pdv_str(pdv, 'project_path'), "loc", "**", "**Msg.txt"))
