...
"""
    ...
    The version of the OpenAPI document: 0.1.288
...
class FilesApi(object):
    ...
    def create_file_with_http_info(self, x_lusid_drive_filename, x_lusid_drive_path, content_length, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('x_lusid_drive_filename' in local_var_params and  # noqa: E501
                                                        len(local_var_params['x_lusid_drive_filename']) > 50):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `x_lusid_drive_filename` when calling `create_file`, length must be less than or equal to `50`")  # noqa: E501
        if self.api_client.client_side_validation and ('x_lusid_drive_filename' in local_var_params and  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.1.288'
