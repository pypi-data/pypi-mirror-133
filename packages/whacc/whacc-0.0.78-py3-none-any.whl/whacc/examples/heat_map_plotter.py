...
pred_bool_smoothed = foo_arg_max_and_smooth(pred_bool_temp, kernel_size, threshold, key_name)
...
pred_bool = foo_arg_max_and_smooth(pred_bool_temp, 1, threshold, key_name)
