...
SETTING_10_0_0_4.update             ({
    'shift595_device_count':        (Platform.ALL,   'B',   0xEC6,       (None, None,                           ('Sensor',     '"Shift595DeviceCount {}".format($)')) ),
                                    })
...
# ======================================================================
SETTING_10_1_0_0 = copy.deepcopy(SETTING_10_0_0_4)
# ======================================================================
SETTINGS = [
            (0x0A010000,0x1000, SETTING_10_1_0_0),
