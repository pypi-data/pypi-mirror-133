...
INTEGER = u"Deve ser um inteiro"
NUMBER = u"Deve ser um número"
GREATER_THAN = u"Deve ser maior que {}"
GREATER_OR_EQUAL_THAN = u"Deve ser maior ou igual à {}"
LESS_THAN = u"Deve ser menor que {}"
LESS_OR_EQUAL_THAN = u"Deve ser menor ou igual à {}"
BOOL = u"Deve ser verdadeiro ou falso"
INVALID = u"Valor inválido"
INSTANCEOF = u"Deve ser um objeto {}"
OBJECTID = u"Deve ser um ObjectId"
DATETIME = u"Deve ser uma data"
CHOICES = u"Deve ser um dentre {}"
...
def non_empty_string(msg=REQUIRED):
    def validator(obj):
        if obj is not None and not (isinstance(obj, six.text_type) and len(obj) > 0):
            yield msg
