...
class BaseMetrics(JavaObjectWrapperWithAutoTypeConversion):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.BaseMetrics'
...
class BaseSimpleClassifierMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.BaseSimpleClassifierMetrics'
...
class BinaryClassMetrics(BaseSimpleClassifierMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.BinaryClassMetrics'
...
class MultiClassMetrics(BaseSimpleClassifierMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.MultiClassMetrics'
...
class ClusterMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.ClusterMetrics'
...
class RegressionMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.RegressionMetrics'
...
class BaseSimpleMultiLabelMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.BaseSimpleMultiLabelMetrics'
...
class RankingMetrics(BaseSimpleMultiLabelMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.RankingMetrics'
...
class MultiLabelMetrics(BaseSimpleMultiLabelMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.MultiLabelMetrics'
...
class TimeSeriesMetrics(BaseMetrics):
    j_cls_name = 'com.alibaba.alink.operator.common.evaluation.TimeSeriesMetrics'
