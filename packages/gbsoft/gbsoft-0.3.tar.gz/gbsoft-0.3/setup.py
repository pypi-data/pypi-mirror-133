...
setup(
  ...
  description = 'custom arduino-python library',   # Give a short description about your library
  ...
  keywords = ['ARDUINO', 'OPENCV-PYTHON', 'OPENCV-ARDUINO','FACE-DETECTOR','HAND-DETECTOR'],   # Keywords that define your package best
