...
go to `https://readthedocs.org/dashboard/{package_name}/advanced`__ (Admin) to configure the following settings:
...
if html_theme == 'alabaster':
    ...
    html_theme_options = dict(
        ...
        # gitlab_url=f"{repo_root}/{package_name}/docs/index.rst",
        navigation_depth=-1,
