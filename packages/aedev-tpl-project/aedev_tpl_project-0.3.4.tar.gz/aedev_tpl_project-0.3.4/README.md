<!-- THIS FILE IS EXCLUSIVELY MAINTAINED by the project aedev V0.3.7 -->
...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/aedev-group/aedev_tpl_project/release0.3.3?logo=python)](
    https://gitlab.com/aedev-group/aedev_tpl_project/-/tree/release0.3.3)
[![PyPIVersions](https://img.shields.io/pypi/v/aedev_tpl_project)](
    https://pypi.org/project/aedev-tpl-project/#history)

>aedev namespace module portion tpl_project: outsourced Python project files templates.
...
[ReadTheDocs](
https://aedev.readthedocs.io/en/latest/_autosummary/aedev.tpl_project.html#module-aedev.tpl_project
