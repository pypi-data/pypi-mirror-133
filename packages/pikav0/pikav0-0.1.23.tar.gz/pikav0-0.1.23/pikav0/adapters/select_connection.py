...
class IOLoop(object):
    ...
    def process_timeouts(self):
        ...
        for _ in pikav0.compat.xrange(len(self._callbacks)):
...
class _PollerBase(_AbstractBase):  # pylint: disable=R0902
    ...
    def wake_threadsafe(self):
        ...
        with self._waking_mutex:
            ...
            except pikav0.compat.SOCKET_ERROR as err:
    ...
    def _dispatch_fd_events(self, fd_event_map):
        ...
        for fileno in pikav0.compat.dictkeys(fd_event_map):
    ...
    def _get_interrupt_pair():
        ...
        """
        return pikav0.compat._nonblocking_socketpair() # pylint: disable=W0212
