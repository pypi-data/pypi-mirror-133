...
import pikav0.compat
import pikav0.tcp_socket_opts

from pikav0 import __version__
from pikav0 import connection
from pikav0.compat import SOCKET_ERROR
from pikav0.compat import SOL_TCP
...
class BaseConnection(connection.Connection):
    ...
    def _create_and_connect_to_socket(self, sock_addr_tuple):
        ...
        pikav0.tcp_socket_opts.set_sock_opts(self.params.tcp_options, self.socket)
    ...
    def _flush_outbound(self):
        ...
        """
        # NOTE: We don't call _handle_write() from this context, because pikav0
        ...
        # in pikav0 core and adapters do not deal gracefully with connection
        # errors occurring in their context; e.g., Connection.channel (pikav0
