...
information for the :class:`~pikav0.connection.ConnectionParameters` class.

The :class:`~pikav0.credentials.PlainCredentials` class returns the properly
formatted username and password to the :class:`~pikav0.connection.Connection`.

To authenticate with Pika, create a :class:`~pikav0.credentials.PlainCredentials`
object passing in the username and password and pass it as the credentials
argument value to the :class:`~pikav0.connection.ConnectionParameters` object.

If you are using :class:`~pikav0.connection.URLParameters` you do not need a
...
extend the :class:`~pikav0.credentials.ExternalCredentials` class implementing
