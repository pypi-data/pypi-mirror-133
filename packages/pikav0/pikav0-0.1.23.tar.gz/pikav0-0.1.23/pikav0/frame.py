...
from pikav0 import amqp_object
from pikav0 import exceptions
from pikav0 import spec
from pikav0.compat import byte
...
class Method(Frame):
    ...
    def __init__(self, channel_number, method):
        ...
        :param pikav0.Spec.Class.Method method: The AMQP Class.Method
...
def decode_frame(data_in):
    ...
    :raises: pikav0.exceptions.InvalidFrameError
