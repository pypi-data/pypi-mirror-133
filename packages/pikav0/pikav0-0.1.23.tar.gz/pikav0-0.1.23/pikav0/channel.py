...
import pikav0.frame as frame
import pikav0.exceptions as exceptions
import pikav0.spec as spec
from pikav0.utils import is_callable
from pikav0.compat import unicode_type, dictkeys, is_integer
...
class Channel(object):
    ...
    def basic_consume(self, consumer_callback,
        ...
        :param callable consumer_callback: The function to call when consuming
            with the signature consumer_callback(channel, method, properties,
                                                 body), where
                                channel: pikav0.Channel
                                method: pikav0.spec.Basic.Deliver
                                properties: pikav0.spec.BasicProperties
                                body: str, unicode, or bytes (python 3.x)
    ...
    def basic_get(self, callback=None, queue='', no_ack=False):
        ...
        :param callable callback: The callback to call with a message that has
            ...
            channel: pikav0.Channel
            method: pikav0.spec.Basic.GetOk
            properties: pikav0.spec.BasicProperties
            body: str, unicode, or bytes (python 3.x)
    ...
    def confirm_delivery(self, callback=None, nowait=False):
        ...
        :param callable callback: The callback for delivery confirmations that
            has the following signature: callback(pikav0.frame.Method), where
    ...
    def queue_declare(self, callback,
        ...
        :param callable callback: callback(pikav0.frame.Method) for method
    ...
    def _handle_content_frame(self, frame_value):
        ...
        :param pikav0.amqp_object.Frame frame_value: The frame to deliver
...
class ContentFrameAssembler(object):
    ...
    def _finish(self):
        ...
        :rtype: tuple(pikav0.frame.Method, pikav0.frame.Header, str)
    ...
    def _handle_body_frame(self, body_frame):
        ...
        :raises: pikav0.exceptions.BodyTooLongError
        :rtype: tuple(pikav0.frame.Method, pikav0.frame.Header, str)|None
