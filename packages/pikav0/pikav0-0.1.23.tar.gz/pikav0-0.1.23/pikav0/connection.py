...
from pikav0 import __version__
from pikav0 import callback
import pikav0.channel
from pikav0 import credentials as pika_credentials
from pikav0 import exceptions
from pikav0 import frame
from pikav0 import heartbeat
from pikav0 import utils

from pikav0 import spec

from pikav0.compat import (xrange, basestring, # pylint: disable=W0622
...
class Parameters(object):  # pylint: disable=R0902
    ...
    DEFAULT_CHANNEL_MAX = pikav0.channel.MAX_CHANNELS
    ...
    def channel_max(self, value):
        ...
        if value < 1 or value > pikav0.channel.MAX_CHANNELS:
            raise ValueError('channel_max must be <= %i and > 0, but got %r' %
                             (pikav0.channel.MAX_CHANNELS, value))
    ...
    def credentials(self):
        """
        :rtype: one of the classes from `pikav0.credentials.VALID_TYPES`. Defaults
    ...
    def credentials(self, value):
        ...
        :param value: authentication credential object of one of the classes
            from  `pikav0.credentials.VALID_TYPES`
...
class ConnectionParameters(Parameters):
    ...
    def __init__(self,  # pylint: disable=R0913,R0914,R0912
        ...
        :param pikav0.credentials.Credentials credentials: auth credentials
...
class URLParameters(Parameters):
    ...
    Valid query string values are:
        ...
        - client_properties:
            ...
            method
        - connection_attempts:
            Specify how many times pikav0 should try and reconnect before it gives up
        - frame_max:
...
class Connection(object):
    ...
    def __init__(self,
        ...
        :param method on_close_callback: Called when the connection is closed:
          ...
          closures or a value from `pikav0.connection.InternalCloseReasons` for
    ...
    def add_backpressure_callback(self, callback_method):
        """Call method "callback" when pikav0 believes backpressure is being
        applied.
    ...
    def _check_for_protocol_mismatch(self, value):
        ...
        :param pikav0.frame.Method value: The frame to check
    ...
    def _create_channel(self, channel_number, on_open_callback):
        ...
        return pikav0.channel.Channel(self, channel_number, on_open_callback)

    def _create_heartbeat_checker(self):
        """Create a heartbeat checker instance if there is a heartbeat interval
        set.

        :rtype: pikav0.heartbeat.Heartbeat|None
    ...
    def _deliver_frame_to_channel(self, value):
        ...
        :param pikav0.frame.Method value: The frame to deliver
    ...
    def _get_credentials(self, method_frame):
        ...
        :param pikav0.frame.MethodFrame method_frame: The Connection.Start frame
        :rtype: tuple(str, str)
    ...
    def _is_method_frame(self, value):
        ...
        :param pikav0.frame.Frame value: The frame to evaluate
        :rtype: bool
    ...
    def _next_channel_number(self):
        ...
        """
        limit = self.params.channel_max or pikav0.channel.MAX_CHANNELS
    ...
    def _on_channel_cleanup(self, channel):
        ...
        :param pikav0.channel.Channel channel: channel instance
    ...
    def _on_connection_close(self, method_frame):
        ...
        :param pikav0.frame.Method method_frame: The Connection.Close frame
    ...
    def _on_connection_close_ok(self, method_frame):
        ...
        :param pikav0.frame.Method method_frame: The Connection.CloseOk frame
    ...
    def _on_connection_start(self, method_frame):
        ...
        :param pikav0.frame.Method method_frame: The frame received
    ...
    def _negotiate_integer_value(client_value, server_value):
        ...
        # perform negotiation, see pikav0/pikav0#874
    ...
    def _process_callbacks(self, frame_value):
        ...
        :param pikav0.frame.Method frame_value: The frame to process
        :rtype: bool
    ...
    def _process_frame(self, frame_value):
        ...
        :type frame_value: pikav0.frame.Frame | pikav0.frame.Method
    ...
    def _read_frame(self):
        ...
        :rtype tuple: (int, pikav0.frame.Frame)
    ...
    def _remove_callback(self, channel_number, method_class):
        ...
        :param pikav0.amqp_object.Method method_class: The method class for the
            callback
    ...
    def _remove_callbacks(self, channel_number, method_classes):
        ...
        :param sequence method_classes: The method classes (derived from
            `pikav0.amqp_object.Method`) for the callbacks
    ...
    def _rpc(self, channel_number, method,
        ...
        :param pikav0.amqp_object.Method method: The method frame to call
    ...
    def _send_frame(self, frame_value):
        ...
        :type frame_value:  pikav0.frame.Frame|pikav0.frame.ProtocolHeader
    ...
    def _send_method(self, channel_number, method, content=None):
        ...
        :param pikav0.amqp_object.Method method: The method to send
    ...
    def _send_message(self, channel_number, method_frame, content):
        ...
        :param int channel_number: The channel number for the frame
        :param pikav0.object.Method method_frame: The method frame to send
