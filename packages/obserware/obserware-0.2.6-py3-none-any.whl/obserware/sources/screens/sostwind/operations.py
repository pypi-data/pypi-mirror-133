...
class SoStWind(QDialog, Ui_sostwind):
    ...
    def place_threaded_statistics_on_screen(self, statdict):
        ...
        self.sobsrdnm.setText(str(statdict["provider"]["diskioqt"].read_bytes))
        self.sobswtnm.setText(str(statdict["provider"]["diskioqt"].write_bytes))
        self.sotmrdnm.setText(str(statdict["provider"]["diskioqt"].read_time))
        self.sotmwtnm.setText(str(statdict["provider"]["diskioqt"].write_time))
        ...
        self.sostbtnm.setText(str(statdict["provider"]["diskioqt"].busy_time))
