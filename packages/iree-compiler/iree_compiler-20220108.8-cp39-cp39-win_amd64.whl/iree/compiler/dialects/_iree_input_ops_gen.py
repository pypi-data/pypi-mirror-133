...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class DispatchWorkgroupRankOp(_ods_ir.OpView):
  OPERATION_NAME = "iree_input.dispatch.workgroup.rank"
  ...
  def __init__(self, *, loc=None, ip=None):
    ...
    regions = None
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(DispatchWorkgroupRankOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class GlobalOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_visibility, sym_name, type, is_mutable, initializer, initial_value, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if initializer is not None: attributes["initializer"] = initializer
...
class TensorCloneOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, operand_dims, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TensorLoadOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, source_dims, indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TensorStoreOp(_ods_ir.OpView):
  ...
  def __init__(self, result, value, target, target_dims, indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TensorUpdateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, target, target_dims, start_indices, update, update_dims, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
