...
class InsertElementOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, dest, position, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InsertMapOp(_ods_ir.OpView):
  ...
  def __init__(self, result, vector, dest, ids, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InsertOp(_ods_ir.OpView):
  ...
  def __init__(self, res, source, dest, position, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InsertStridedSliceOp(_ods_ir.OpView):
  ...
  def __init__(self, res, source, dest, offsets, strides, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class MultiDimReductionOp(_ods_ir.OpView):
  ...
  def __init__(self, dest, kind, source, reduction_dims, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ReductionOp(_ods_ir.OpView):
  ...
  @builtins.property
  def kind(self):
    return _ods_ir.StringAttr(self.operation.attributes["kind"])
...
class ShuffleOp(_ods_ir.OpView):
  ...
  def __init__(self, vector, v1, v2, mask, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
