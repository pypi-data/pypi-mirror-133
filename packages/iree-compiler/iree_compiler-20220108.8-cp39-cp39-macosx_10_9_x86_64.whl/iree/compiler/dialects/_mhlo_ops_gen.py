...
class AllGatherOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, all_gather_dim, replica_groups, channel_handle, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class AllReduceOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, replica_groups, channel_handle, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class AllToAllOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, split_dimension, concat_dimension, split_count, replica_groups, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BatchNormGradOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, scale, mean, variance, grad_output, epsilon, feature_index, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BatchNormInferenceOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, scale, offset, mean, variance, epsilon, feature_index, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BatchNormTrainingOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, scale, offset, epsilon, feature_index, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class BroadcastOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, broadcast_sizes, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CaseOp(_ods_ir.OpView):
  ...
  def __init__(self, result, index, branch_operands, num_branches, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(index))
    operands.extend(_get_op_results_or_values(branch_operands))
...
class CholeskyOp(_ods_ir.OpView):
  ...
  def __init__(self, result, a, lower, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ClampOp(_ods_ir.OpView):
  ...
  def __init__(self, result, min, operand, max, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CollectivePermuteOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, source_target_pairs, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CompareOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, comparison_direction, compare_type, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  def comparison_direction(self):
    return _ods_ir.StringAttr(self.operation.attributes["comparison_direction"])
  ...
  def compare_type(self):
    if "compare_type" not in self.operation.attributes:
      return None
    return _ods_ir.StringAttr(self.operation.attributes["compare_type"])
...
class ConvOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, window_strides, padding, lhs_dilation, rhs_dilation, window_reversal, dimension_numbers, feature_group_count, batch_group_count, precision_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CustomCallOp(_ods_ir.OpView):
  ...
  def __init__(self, result, args, call_target_name, has_side_effect, backend_config, api_version, called_computations, operand_layouts, result_layouts, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    attributes["has_side_effect"] = has_side_effect
    attributes["backend_config"] = backend_config
    attributes["api_version"] = api_version
    attributes["called_computations"] = called_computations
...
class DequantizeOp(_ods_ir.OpView):
  OPERATION_NAME = "mhlo.dequantize"

  _ODS_REGIONS = (0, True)

  def __init__(self, output, input, min_range, max_range, mode, transpose_output, is_16bits, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(input))
    attributes["min_range"] = min_range
    attributes["max_range"] = max_range
    attributes["mode"] = mode
    attributes["transpose_output"] = transpose_output
    attributes["is_16bits"] = is_16bits
    results.append(output)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
  ...
  @builtins.property
  def min_range(self):
    return _ods_ir.FloatAttr(self.operation.attributes["min_range"])
  ...
  @builtins.property
  def max_range(self):
    return _ods_ir.FloatAttr(self.operation.attributes["max_range"])
  ...
  def transpose_output(self):
    return _ods_ir.BoolAttr(self.operation.attributes["transpose_output"])

  @transpose_output.setter
  def transpose_output(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["transpose_output"] = value

  @builtins.property
  def is_16bits(self):
    return _ods_ir.BoolAttr(self.operation.attributes["is_16bits"])

  @is_16bits.setter
  def is_16bits(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["is_16bits"] = value
...
class DotGeneralOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, dot_dimension_numbers, precision_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DotOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, precision_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DynamicBroadcastInDimOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, output_dimensions, broadcast_dimensions, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DynamicConvOp(_ods_ir.OpView):
  ...
  def __init__(self, result, lhs, rhs, d_padding, window_strides, padding, lhs_dilation, rhs_dilation, window_reversal, dimension_numbers, feature_group_count, batch_group_count, precision_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DynamicGatherOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, start_indices, slice_sizes, dimension_numbers, indices_are_sorted, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    attributes["dimension_numbers"] = dimension_numbers
    attributes["indices_are_sorted"] = indices_are_sorted
    _ods_context = _ods_get_default_loc_context(loc)
...
class DynamicSliceOp(_ods_ir.OpView):
  OPERATION_NAME = "mhlo.dynamic-slice"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, operand, start_indices, slice_sizes, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class DynamicUpdateSliceOp(_ods_ir.OpView):
  OPERATION_NAME = "mhlo.dynamic-update-slice"
...
class FftOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, fft_type, fft_length, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def fft_type(self):
    return _ods_ir.StringAttr(self.operation.attributes["fft_type"])
...
class FusionOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, operands_, fusion_kind, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  def fusion_kind(self):
    if "fusion_kind" not in self.operation.attributes:
      return None
    return _ods_ir.StringAttr(self.operation.attributes["fusion_kind"])
...
class GatherOp(_ods_ir.OpView):
  ...
  def __init__(self, operand, start_indices, dimension_numbers, slice_sizes, indices_are_sorted, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class GetTupleElementOp(_ods_ir.OpView):
  ...
  def __init__(self, result, _gen_arg_0, index, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class IfOp(_ods_ir.OpView):
  ...
  def __init__(self, result, pred, true_arg, false_arg, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(pred))
    operands.append(_get_op_result_or_value(true_arg))
    operands.append(_get_op_result_or_value(false_arg))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class InfeedOp(_ods_ir.OpView):
  ...
  def __init__(self, result, token, infeed_config, layout, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(token))
    attributes["infeed_config"] = infeed_config
...
class OutfeedOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, token, outfeed_config, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(operand))
    operands.append(_get_op_result_or_value(token))
    attributes["outfeed_config"] = outfeed_config
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class RecvOp(_ods_ir.OpView):
  ...
  def __init__(self, result, token, channel_handle, is_host_transfer, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    attributes["is_host_transfer"] = is_host_transfer
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class ReducePrecisionOp(_ods_ir.OpView):
  ...
  def __init__(self, output, operand, exponent_bits, mantissa_bits, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ReduceScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, scatter_dimension, replica_groups, channel_handle, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ReduceWindowOp(_ods_ir.OpView):
  ...
  def __init__(self, result, inputs, init_values, window_dimensions, window_strides, base_dilations, window_dilations, padding, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class RngBitGeneratorOp(_ods_ir.OpView):
  ...
  def __init__(self, result, rng_algorithm, initial_state, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  def rng_algorithm(self):
    return _ods_ir.IntegerAttr(self.operation.attributes["rng_algorithm"])
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class RngNormalOp(_ods_ir.OpView):
  OPERATION_NAME = "mhlo.rng_normal"

  _ODS_REGIONS = (0, True)

  def __init__(self, mu, sigma, shape, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(mu))
    operands.append(_get_op_result_or_value(sigma))
    operands.append(_get_op_result_or_value(shape))
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(RngNormalOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class RngUniformOp(_ods_ir.OpView):
  OPERATION_NAME = "mhlo.rng_uniform"

  _ODS_REGIONS = (0, True)

  def __init__(self, a, b, shape, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(_get_op_result_or_value(shape))
    _ods_context = _ods_get_default_loc_context(loc)
    results = _ods_ir.InferTypeOpInterface(RngUniformOp).inferReturnTypes(
        operands=operands,
        attributes=_ods_ir.DictAttr.get(attributes, context=_ods_context),
        context=_ods_context,
        loc=loc)
...
class ScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, scatter_indices, updates, scatter_dimension_numbers, indices_are_sorted, unique_indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    attributes["indices_are_sorted"] = indices_are_sorted
    attributes["unique_indices"] = unique_indices
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class SelectAndScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, source, init_value, window_dimensions, window_strides, padding, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SendOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, token, channel_handle, is_host_transfer, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SetDimensionSizeOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operand, size, dimension, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SortOp(_ods_ir.OpView):
  ...
  def __init__(self, result, operands_, dimension, is_stable, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(operands_))
    attributes["dimension"] = dimension
    attributes["is_stable"] = is_stable
    results.extend(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
...
class TorchIndexSelectOp(_ods_ir.OpView):
  ...
  def __init__(self, result, input, index, dim, batch_dims, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TriangularSolveOp(_ods_ir.OpView):
  ...
  def transpose_a(self):
    return _ods_ir.StringAttr(self.operation.attributes["transpose_a"])
...
class TupleOp(_ods_ir.OpView):
  ...
  def __init__(self, result, val, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class WhileOp(_ods_ir.OpView):
  ...
  def __init__(self, result, arg, *, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.extend(_get_op_results_or_values(arg))
    results.extend(result)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
