...
class QNdefRecord(PyQt6.sip.simplewrapper):
    """
    https://doc.qt.io/qt-6/qndefrecord.html
    ...
    **Q_DECLARE_NDEF_RECORD** () and **Q_DECLARE_ISRECORDTYPE_FOR_NDEF_RECORD**
    ...
    def __init__(self) -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#QNdefRecord
    ...
    def __init__(self, other: "QNdefRecord") -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#QNdefRecord-1
    ...
    def clear(self) -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#clear

        **[since 6.2] void QNdefRecord::clear()**

        Clear the NDEF record.

        An **isEmpty** () call returns `true` for a cleared record. The record
        **type** () is set to **Empty** .
    ...
    def isEmpty(self) -> bool:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#isEmpty
    ...
    def payload(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#payload
    ...
    def setPayload(self, payload: QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#setPayload
    ...
    def id(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#id
    ...
    def setId(self, id: QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#setId
    ...
    def type(self) -> QtCore.QByteArray:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#type
    ...
    def setType(self, type: QtCore.QByteArray) -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#setType
    ...
    def typeNameFormat(self) -> "QNdefRecord.TypeNameFormat":
        """
        https://doc.qt.io/qt-6/qndefrecord.html#typeNameFormat
    ...
    def setTypeNameFormat(self, typeNameFormat: "QNdefRecord.TypeNameFormat") -> None:
        """
        https://doc.qt.io/qt-6/qndefrecord.html#setTypeNameFormat
