...
class QTextDocument(QtCore.QObject):
    ...
    **See also** **QTextCursor** , **QTextEdit** , **Rich Text Processing** ,
    ...
    def setDefaultResourceProvider(
        provider: typing.Callable[[QtCore.QUrl], typing.Any]
    ) -> None:
        """
        https://doc.qt.io/qt-6/qtextdocument.html#setDefaultResourceProvider

        **[static, since 6.1] void
        QTextDocument::setDefaultResourceProvider(const
        QTextDocument::ResourceProvider & provider )**

        Sets the default resource provider to **provider**.

        The default provider will be used by all QTextDocuments that don't have
        an explicit provider set.

        This function was introduced in Qt 6.1.

        **See also** **defaultResourceProvider** (), **setResourceProvider** (),
        and **loadResource** ().
        """
        ...
    ...
    def defaultResourceProvider() -> typing.Callable[[QtCore.QUrl], typing.Any]:
        """
        https://doc.qt.io/qt-6/qtextdocument.html#defaultResourceProvider

        **[static, since 6.1] QTextDocument::ResourceProvider
        QTextDocument::defaultResourceProvider()**

        Returns the default resource provider.

        This function was introduced in Qt 6.1.

        **See also** **setDefaultResourceProvider** (), **resourceProvider** (),
        and **loadResource** ().
        """
        ...

    def setResourceProvider(
        self, provider: typing.Callable[[QtCore.QUrl], typing.Any]
    ) -> None:
        """
        https://doc.qt.io/qt-6/qtextdocument.html#setResourceProvider

        **[since 6.1] void QTextDocument::setResourceProvider(const
        QTextDocument::ResourceProvider & provider )**
    ...
    def resourceProvider(self) -> typing.Callable[[QtCore.QUrl], typing.Any]:
        """
        https://doc.qt.io/qt-6/qtextdocument.html#resourceProvider

        **[since 6.1] QTextDocument::ResourceProvider
        QTextDocument::resourceProvider() const**

        Returns the resource provider for this text document.

        This function was introduced in Qt 6.1.

        **See also** **setResourceProvider** (), **defaultResourceProvider** (),
        and **loadResource** ().
        """
        ...
    ...
    def setMarkdown(
        self, markdown: str, features: "QTextDocument.MarkdownFeature" = ...
    ) -> None:
        """
    ...
    @property
    def baseUrlChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def contentsChange(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def contentsChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def documentLayoutChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def undoCommandAdded(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
