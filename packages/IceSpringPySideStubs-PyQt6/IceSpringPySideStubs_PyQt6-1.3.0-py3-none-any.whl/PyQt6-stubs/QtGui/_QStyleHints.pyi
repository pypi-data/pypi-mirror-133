...
class QStyleHints(QtCore.QObject):
    ...
    **See also** **QGuiApplication::styleHints** ().
    ...
    @property
    def cursorFlashTimeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def keyboardInputIntervalChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def mouseDoubleClickIntervalChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def mousePressAndHoldIntervalChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def mouseQuickSelectionThresholdChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def showShortcutsInContextMenusChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def startDragDistanceChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def startDragTimeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def tabFocusBehaviorChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def useHoverEffectsChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def wheelScrollLinesChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
