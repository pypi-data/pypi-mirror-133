...
class QQuaternion(PyQt6.sip.simplewrapper):
    ...
    **Detailed Description**
    ...
    def getEulerAngles(self) -> typing.Tuple[float, float, float]:
        """
        https://doc.qt.io/qt-6/qquaternion.html#getEulerAngles

        **[since 5.5] void QQuaternion::getEulerAngles(float * pitch , float *
        yaw , float * roll ) const**
    ...
    def getAxisAndAngle(self) -> typing.Tuple["QVector3D", float]:
        """
        https://doc.qt.io/qt-6/qquaternion.html#getAxisAndAngle

        **[since 5.5] void QQuaternion::getAxisAndAngle(float * x , float * y ,
