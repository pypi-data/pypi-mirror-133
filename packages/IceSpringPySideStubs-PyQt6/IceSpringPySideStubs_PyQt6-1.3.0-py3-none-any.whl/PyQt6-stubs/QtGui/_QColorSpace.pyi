...
class QColorSpace(PyQt6.sip.simplewrapper):
    ...
    **Detailed Description**
    ...
    def __init__(
        self,
        primaries: "QColorSpace.Primaries",
        transferFunctionTable: typing.Iterable[int],
    ) -> None:
        """
    ...
    def __init__(
        ...
        greenPoint: QtCore.QPointF,
        bluePoint: QtCore.QPointF,
        redTransferFunctionTable: typing.Iterable[int],
        greenTransferFunctionTable: typing.Iterable[int],
        blueTransferFunctionTable: typing.Iterable[int],
    ) -> None:
        """
    ...
    def withTransferFunction(
        self, transferFunctionTable: typing.Iterable[int]
    ) -> "QColorSpace":
        """
