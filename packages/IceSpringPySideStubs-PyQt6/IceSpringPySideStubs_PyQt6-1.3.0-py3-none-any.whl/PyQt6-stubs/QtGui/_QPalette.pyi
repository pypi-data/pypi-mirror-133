...
class QPalette(PyQt6.sip.simplewrapper):
    ...
    **See also** **QApplication::setPalette** (), **QWidget::setPalette** (),
    ...
    @typing.overload
    def __init__(
        self, button: typing.Union[QColor, QtCore.Qt.GlobalColor, int, QGradient]
    ) -> None:
        """
    ...
    def __init__(
        self,
        button: typing.Union[QColor, QtCore.Qt.GlobalColor, int, QGradient],
        background: typing.Union[QColor, QtCore.Qt.GlobalColor, int, QGradient],
    ) -> None:
        """
    ...
    def __init__(
        self,
        foreground: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        button: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        light: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        dark: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        mid: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        text: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        bright_text: typing.Union[
            QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient
        ],
        base: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
        background: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
    ) -> None:
        """
    ...
    def setColor(
        ...
        acolor: typing.Union[QColor, QtCore.Qt.GlobalColor, int, QGradient],
    ) -> None:
        """
    ...
    def setBrush(
        self,
        acr: "QPalette.ColorRole",
        abrush: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, int, QGradient],
    ) -> None:
        """
