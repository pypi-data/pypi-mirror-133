...
class QQmlEngineExtensionPlugin(QtCore.QObject):
    ...
    **TimeExample QML extension plugin**
    ...
    properties. It declares a QML type called `Time` via **QML_NAMED_ELEMENT**
    ().
    ...
    Q_PROPERTY(int hour READ hour NOTIFY timeChanged)
            Q_PROPERTY(int
    minute READ minute NOTIFY timeChanged)
            QML_NAMED_ELEMENT(Time)
    ...

    To make this type available, we create a plugin class named
    `QExampleQmlPlugin` which is a subclass of **QQmlEngineExtensionPlugin** .
    It uses the **Q_PLUGIN_METADATA** () macro in the class definition to
    register the plugin with the Qt meta object system using a unique identifier
    for the plugin.
    ...
    **Project settings for the plugin**
    ...
    Additionally, the project file (`.pro`) defines the project as a plugin
    library, specifies it should be built into the `imports/TimeExample`
    ...
    **See also** **QQmlEngine::importPlugin** () and **How to Create Qt
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None:
        """
        https://doc.qt.io/qt-6/qqmlengineextensionplugin.html#QQmlEngineExtensio
        nPlugin-2
    ...
    def initializeEngine(self, engine: QQmlEngine, uri: str) -> None:
        """
        https://doc.qt.io/qt-6/qqmlengineextensionplugin.html#initializeEngine
