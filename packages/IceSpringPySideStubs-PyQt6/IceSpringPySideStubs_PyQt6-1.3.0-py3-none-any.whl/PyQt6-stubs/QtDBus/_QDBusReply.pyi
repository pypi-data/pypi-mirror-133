...
class QDBusReply(PyQt6.sip.simplewrapper):
    """
    https://doc.qt.io/qt-6/qdbusreply.html
    ...
    **See also** **QDBusMessage**  and **QDBusInterface** .
    ...
    def __init__(self, reply: QDBusMessage) -> None:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#QDBusReply
    ...
    def __init__(self, call: QDBusPendingCall) -> None:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#QDBusReply-1
    ...
    def __init__(self, error: QDBusError) -> None:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#QDBusReply-2
    ...
    def __init__(self, other: "QDBusReply") -> None:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#QDBusReply-3
    ...
    def value(self, type: typing.Any = ...) -> typing.Any:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#value
    ...
    def isValid(self) -> bool:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#isValid
    ...
    def error(self) -> QDBusError:
        """
        https://doc.qt.io/qt-6/qdbusreply.html#error
