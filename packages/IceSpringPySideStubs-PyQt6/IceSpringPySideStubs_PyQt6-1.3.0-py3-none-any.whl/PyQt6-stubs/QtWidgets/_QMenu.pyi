...
class QMenu(QWidget):
    ...
    **See also** **QMenuBar** , **GUI Design Handbook: Menu, Drop-Down and Pop-
    ...
    @typing.overload
    def insertSection(
        self, before: QtGui.QAction, icon: QtGui.QIcon, text: str
    ) -> QtGui.QAction:
        """
    ...
    def initStyleOption(
        self, option: "QStyleOptionMenuItem", action: QtGui.QAction
    ) -> None:
        """
    ...
    @staticmethod
    def exec(
        actions: typing.Iterable[QtGui.QAction],
        pos: QtCore.QPoint,
    ...
    @property
    def aboutToHide(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def aboutToShow(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
