...
class QNetworkReply(QtCore.QIODevice):
    ...
    **See also** **QNetworkRequest**  and **QNetworkAccessManager** .
    ...
    def setError(
        self, errorCode: "QNetworkReply.NetworkError", errorString: str
    ) -> None:
        """
    ...
    @property
    def downloadProgress(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def redirectAllowed(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def redirected(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def uploadProgress(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
