...
class QProcess(QIODevice):
    ...
    **See also** **QBuffer** , **QFile** , and **QTcpSocket** .
    ...
    def setStandardErrorFile(
        self, fileName: str, mode: QIODeviceBase.OpenModeFlag = ...
    ) -> None:
        """
    ...
    def startCommand(
        self, command: str, mode: QIODeviceBase.OpenModeFlag = ...
    ) -> None:
        """
    ...
    @property
    def readyReadStandardError(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def readyReadStandardOutput(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
