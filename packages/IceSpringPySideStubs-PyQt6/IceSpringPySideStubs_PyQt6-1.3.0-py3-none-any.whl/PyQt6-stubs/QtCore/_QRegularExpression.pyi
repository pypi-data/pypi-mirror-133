...
class QRegularExpression(PyQt6.sip.simplewrapper):
    ...
    **QRegularExpressionMatchIterator** .
    ...
    class WildcardConversionOption(enum.Flag):
        DefaultWildcardConversion: QRegularExpression = ...
        UnanchoredWildcardConversion: QRegularExpression = ...

    class MatchOption(enum.Flag):
        NoMatchOption: QRegularExpression = ...
        AnchorAtOffsetMatchOption: QRegularExpression = ...
    ...
    @typing.overload
    def __init__(
        self, pattern: str, options: "QRegularExpression.PatternOption" = ...
    ) -> None:
        """
