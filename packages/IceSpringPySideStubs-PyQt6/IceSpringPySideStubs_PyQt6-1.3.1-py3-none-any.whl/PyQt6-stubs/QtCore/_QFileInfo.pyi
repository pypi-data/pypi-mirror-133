...
class QFileInfo(PyQt6.sip.simplewrapper):
    ...
    **See also** **QDir**  and **QFile** .
    ...
    def fileTime(self, time: QFileDevice.FileTime) -> QDateTime:
        """
        https://doc.qt.io/qt-6/qfileinfo.html#fileTime

        **[since 5.10] QDateTime QFileInfo::fileTime(QFile::FileTime time )
        const**
    ...
    def permissions(self) -> QFileDevice.Permission:
        """
        https://doc.qt.io/qt-6/qfileinfo.html#permissions

        **QFile::Permissions QFileInfo::permissions() const**

        Returns the complete OR-ed together combination of QFile::Permissions
        for the file.
    ...
    def permission(self, permissions: QFileDevice.Permission) -> bool:
        """
        https://doc.qt.io/qt-6/qfileinfo.html#permission

        **bool QFileInfo::permission(QFile::Permissions permissions ) const**

        Tests for file permissions. The **permissions** argument can be several
        flags of type QFile::Permissions OR-ed together to check for permission
        combinations.
