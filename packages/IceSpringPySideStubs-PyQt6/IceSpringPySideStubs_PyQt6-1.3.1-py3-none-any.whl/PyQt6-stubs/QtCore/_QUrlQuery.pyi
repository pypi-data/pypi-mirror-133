...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    **See also** **QUrl** .
    ...
    def defaultQueryPairDelimiter() -> str:
        """
        https://doc.qt.io/qt-6/qurlquery.html#defaultQueryPairDelimiter

        **[static] char16_t QUrlQuery::defaultQueryPairDelimiter()**

        Returns the default character for separating keys-value pairs from each
        other, an ampersand ("&").

        **Note:** Prior to Qt 6, this function returned **QChar** .
    ...
    def defaultQueryValueDelimiter() -> str:
        """
        https://doc.qt.io/qt-6/qurlquery.html#defaultQueryValueDelimiter

        **[static] char16_t QUrlQuery::defaultQueryValueDelimiter()**
    ...
    def allQueryItemValues(
        self, key: str, options: QUrl.ComponentFormattingOption = ...
    ) -> typing.List[str]:
        """
