...
class QFormLayout(QLayout):
    ...
    **See also** **QGridLayout** , **QBoxLayout** , and **QStackedLayout** .
    ...
    def takeRow(self, row: int) -> "QFormLayout.TakeRowResult":
        """
        https://doc.qt.io/qt-6/qformlayout.html#takeRow
    ...
    def takeRow(self, widget: QWidget) -> "QFormLayout.TakeRowResult":
        """
        https://doc.qt.io/qt-6/qformlayout.html#takeRow-1

        **[since 5.8] QFormLayout::TakeRowResult QFormLayout::takeRow(QWidget *
        widget )**
    ...
    def takeRow(self, layout: QLayout) -> "QFormLayout.TakeRowResult":
        """
        https://doc.qt.io/qt-6/qformlayout.html#takeRow-2

        **[since 5.8] QFormLayout::TakeRowResult QFormLayout::takeRow(QLayout *
        layout )**
