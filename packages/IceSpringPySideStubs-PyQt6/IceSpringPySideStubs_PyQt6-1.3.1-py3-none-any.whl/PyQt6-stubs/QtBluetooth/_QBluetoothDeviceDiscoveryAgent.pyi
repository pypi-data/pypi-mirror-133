...
class QBluetoothDeviceDiscoveryAgent(QtCore.QObject):
    ...
    **Note:** The Win32 backend currently does not support the Received Signal
    ...
    class DiscoveryMethod(enum.Flag):
        NoMethod: QBluetoothDeviceDiscoveryAgent = ...
        ClassicMethod: QBluetoothDeviceDiscoveryAgent = ...
        LowEnergyMethod: QBluetoothDeviceDiscoveryAgent = ...
    ...
    class Error(enum.Enum):
        ...
        LocationServiceTurnedOffError: QBluetoothDeviceDiscoveryAgent = ...
    ...
    def supportedDiscoveryMethods() -> "QBluetoothDeviceDiscoveryAgent.DiscoveryMethod":
        """
        https://doc.qt.io/qt-6/qbluetoothdevicediscoveryagent.html#supportedDisc
        overyMethods

        **[static, since 5.8] QBluetoothDeviceDiscoveryAgent::DiscoveryMethods
    ...
    def start(self, method: "QBluetoothDeviceDiscoveryAgent.DiscoveryMethod") -> None:
        """
        https://doc.qt.io/qt-6/qbluetoothdevicediscoveryagent.html#start-1

        **[slot, since 5.8] void QBluetoothDeviceDiscoveryAgent::start(QBluetoot
        hDeviceDiscoveryAgent::DiscoveryMethods methods )**
    ...
    @property
    def canceled(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def deviceDiscovered(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def deviceUpdated(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
