...
class QAction(QtCore.QObject):
    ...
    **See also** **QMenu** , **QToolBar** , and **Qt Widgets - Application
    ...
    @typing.overload
    def __init__(
        self, icon: "QIcon", text: str, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None:
        """
    ...
    @property
    def checkableChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
    ...
    @property
    def hovered(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def toggled(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def triggered(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
