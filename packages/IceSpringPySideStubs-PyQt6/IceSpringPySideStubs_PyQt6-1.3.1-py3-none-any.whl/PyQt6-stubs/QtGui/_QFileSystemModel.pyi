...
class QFileSystemModel(QtCore.QAbstractItemModel):
    ...
    **See also** **Model Classes** .
    ...
    def permissions(self, index: QtCore.QModelIndex) -> QtCore.QFileDevice.Permission:
        """
        https://doc.qt.io/qt-6/qfilesystemmodel.html#permissions
    ...
    @property
    def directoryLoaded(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def fileRenamed(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def rootPathChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
