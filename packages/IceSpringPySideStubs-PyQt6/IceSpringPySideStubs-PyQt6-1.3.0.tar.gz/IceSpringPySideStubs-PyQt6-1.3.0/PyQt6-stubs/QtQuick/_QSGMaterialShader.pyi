...
class QSGMaterialShader(PyQt6.sip.simplewrapper):
    ...
    **See also** **QSGMaterial** , **Scene Graph - Custom Material** , **Scene
    ...
    class Stage(enum.Enum):
        VertexStage: QSGMaterialShader = ...
        FragmentStage: QSGMaterialShader = ...

    class Flag(enum.Flag):
        UpdatesGraphicsPipelineState: QSGMaterialShader = ...
    ...
    class GraphicsPipelineState(PyQt6.sip.simplewrapper):
        class CullMode(enum.Enum):
            CullNone: QSGMaterialShader = ...
            CullFront: QSGMaterialShader = ...
            CullBack: QSGMaterialShader = ...
        ...
        class BlendFactor(enum.Enum):
            Zero: QSGMaterialShader = ...
            One: QSGMaterialShader = ...
            SrcColor: QSGMaterialShader = ...
            OneMinusSrcColor: QSGMaterialShader = ...
            DstColor: QSGMaterialShader = ...
            OneMinusDstColor: QSGMaterialShader = ...
            SrcAlpha: QSGMaterialShader = ...
            OneMinusSrcAlpha: QSGMaterialShader = ...
            DstAlpha: QSGMaterialShader = ...
            OneMinusDstAlpha: QSGMaterialShader = ...
            ConstantColor: QSGMaterialShader = ...
            OneMinusConstantColor: QSGMaterialShader = ...
            ConstantAlpha: QSGMaterialShader = ...
            OneMinusConstantAlpha: QSGMaterialShader = ...
            SrcAlphaSaturate: QSGMaterialShader = ...
            Src1Color: QSGMaterialShader = ...
            OneMinusSrc1Color: QSGMaterialShader = ...
            Src1Alpha: QSGMaterialShader = ...
            OneMinusSrc1Alpha: QSGMaterialShader = ...
    ...
    def setShaderFileName(
        self, stage: "QSGMaterialShader.Stage", filename: str
    ) -> None:
        """
    ...
    def updateGraphicsPipelineState(
        ...
        ps: "QSGMaterialShader.GraphicsPipelineState",
        newMaterial: QSGMaterial,
        oldMaterial: QSGMaterial,
    ) -> bool:
        """
        https://doc.qt.io/qt-6/qsgmaterialshader.html#updateGraphicsPipelineStat
        e

        **[virtual] bool QSGMaterialShader::updateGraphicsPipelineState(QSGMater
        ialShader::RenderState & state ,
        ...
        **UpdatesGraphicsPipelineState**  flag was enabled via **setFlags** ().
        By default it is not set, and so this function is never called.
    ...
    def updateSampledImage(
        ...
        **[virtual] void
        QSGMaterialShader::updateSampledImage(QSGMaterialShader::RenderState &
        state , int binding , QSGTexture ** texture , QSGMaterial * newMaterial
        ...
        **binding** is the binding number of the sampler. The function is called
        for each combined image sampler variable in the shader code associated
        with the **QSGMaterialShader** .
        ...
        The current rendering **state** is passed from the scene graph. Where
