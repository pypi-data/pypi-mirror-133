...
class QSslSocket(QTcpSocket):
    ...
    **See also** **QSslCertificate** , **QSslCipher** , and **QSslError** .
    ...
    def implementedClasses(
        backendName: str = ...,
    ) -> typing.List[QSsl.ImplementedClass]:
        """
    ...
    @property
    def encrypted(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def encryptedBytesWritten(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def modeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def newSessionTicketReceived(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
