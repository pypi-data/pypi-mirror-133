...
class QSslConfiguration(PyQt6.sip.simplewrapper):
    ...
    **QSslSocket::sslConfiguration** (), and **QSslSocket::setSslConfiguration**
    ...
    def setBackendConfiguration(
        self, backendConfiguration: typing.Dict[QtCore.QByteArray, typing.Any] = ...
    ) -> None:
        """
    ...
    def setBackendConfigurationOption(
        self, name: QtCore.QByteArray, value: typing.Any
    ) -> None:
        """
    ...
    def setAllowedNextProtocols(
        self, protocols: typing.Iterable[QtCore.QByteArray]
    ) -> None:
        """
