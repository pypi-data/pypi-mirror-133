...
class QImage(QPaintDevice):
    ...
    **QSvgRenderer** , **Image Composition Example** , **Image Viewer Example**
    ...
    class Format(enum.Enum):
        ...
        Format_RGBX16FPx4: QImage = ...
        Format_RGBA16FPx4: QImage = ...
        Format_RGBA16FPx4_Premultiplied: QImage = ...
        Format_RGBX32FPx4: QImage = ...
        Format_RGBA32FPx4: QImage = ...
        Format_RGBA32FPx4_Premultiplied: QImage = ...
    ...
    def setPixelColor(
        ...
        x: int,
        y: int,
        c: typing.Union[QColor, QtCore.Qt.GlobalColor, int, QGradient],
    ) -> None:
        """
    ...
    @staticmethod
    def fromData(
        data: QtCore.QByteArray, format: typing.Optional[str] = ...
    ) -> "QImage":
        """
        https://doc.qt.io/qt-6/qimage.html#fromData-1
    ...
    @typing.overload
    def loadFromData(
        self, data: QtCore.QByteArray, format: typing.Optional[str] = ...
    ) -> bool:
        """
