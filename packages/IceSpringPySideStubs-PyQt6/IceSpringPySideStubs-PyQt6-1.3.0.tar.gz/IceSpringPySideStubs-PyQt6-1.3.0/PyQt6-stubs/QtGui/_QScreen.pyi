...
class QScreen(QtCore.QObject):
    ...
    **Note:** Both physical and logical DPI are expressed in device-independent
    ...
    @property
    def physicalSizeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def primaryOrientationChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def refreshRateChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
