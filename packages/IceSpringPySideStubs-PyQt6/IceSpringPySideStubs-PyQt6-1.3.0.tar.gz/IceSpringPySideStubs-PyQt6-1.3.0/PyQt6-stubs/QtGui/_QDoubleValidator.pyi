...
class QDoubleValidator(QValidator):
    ...
    **QLocale::toDouble** (), and **Line Edits Example** .
    ...
    @property
    def bottomChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def decimalsChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def notationChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def topChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
