...
class QTabBar(QWidget):
    ...
    **See also** **QTabWidget** .
    ...
    def setTabTextColor(
        self,
        index: int,
        color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor, int, QtGui.QGradient],
    ) -> None:
        """
    ...
    @property
    def tabBarClicked(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def tabBarDoubleClicked(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def tabCloseRequested(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def tabMoved(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
