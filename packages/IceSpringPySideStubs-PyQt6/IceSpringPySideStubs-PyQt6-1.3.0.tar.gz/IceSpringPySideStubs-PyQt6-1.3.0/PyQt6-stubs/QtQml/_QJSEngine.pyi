...
class QJSEngine(QtCore.QObject):
    ...
    **See also** **QJSValue** , **Making Applications Scriptable** , and **List
    ...
    class ObjectOwnership(enum.Enum):
        CppOwnership: QJSEngine = ...
        JavaScriptOwnership: QJSEngine = ...
    ...
    def throwError(
        self,
        error: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str],
    ) -> None:
        """
    ...
    def evaluate(
        ...
        fileName: str = ...,
        lineNumber: int = ...,
        exceptionStackTrace: typing.Optional[typing.List[str]] = ...,
    ) -> "QJSValue":
        """
    ...
    @property
    def uiLanguageChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
