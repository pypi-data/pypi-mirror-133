...
class QOpenGLFunctions_2_1(QAbstractOpenGLFunctions):
    ...
    **Detailed Description**
    ...
    This class is a wrapper for functions from OpenGL 2.1 specification. See
    ...
    **See also** **QAbstractOpenGLFunctions** .
    ...
    ) -> typing.Union[float, typing.Tuple[float, float, float, float]]:
        ...

    def glGetColorTableParameteriv(
        self, target: int, pname: int
    ) -> typing.Union[int, typing.Tuple[int, int, int, int]]:
        ...
    ...
    def glGetLightiv(
        ...
        int, typing.Tuple[int, int, int], typing.Tuple[int, int, int, int]
    ]:
        ...
    ...
    ) -> typing.Union[int, typing.Tuple[int, int, int]]:
        ...
    ...
    ) -> typing.Union[typing.Tuple[float, ...], typing.Tuple[int, ...]]:
        ...
