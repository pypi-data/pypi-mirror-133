...
class QCoreApplication(QObject):
    ...
    **QEventLoop** , **Semaphores Example** , and **Wait Conditions Example** .
    ...
    @property
    def aboutToQuit(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def applicationNameChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def applicationVersionChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def organizationDomainChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def organizationNameChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
