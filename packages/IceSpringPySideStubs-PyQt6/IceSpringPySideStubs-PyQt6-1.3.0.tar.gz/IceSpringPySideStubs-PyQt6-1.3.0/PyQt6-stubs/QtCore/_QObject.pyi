...
class QObject(PyQt6.sip.wrapper):
    ...
    **Q_DISABLE_COPY** (), and **Object Trees & Ownership** .
    ...
    @typing.overload
    def findChildren(
        self, type: type, name: str = ..., options: Qt.FindChildOption = ...
    ) -> typing.List["QObject"]:
        """
    ...
    @typing.overload
    def findChildren(
        self, types: typing.Tuple, name: str = ..., options: Qt.FindChildOption = ...
    ) -> typing.List["QObject"]:
        """
    ...
    @typing.overload
    def findChildren(
        self, type: type, re: "QRegularExpression", options: Qt.FindChildOption = ...
    ) -> typing.List["QObject"]:
        """
        https://doc.qt.io/qt-6/qobject.html#findChildren
    ...
    @staticmethod
    def tr(
        sourceText: str, disambiguation: typing.Optional[str] = ..., n: int = ...
    ) -> str:
        """
    ...
    @property
    def destroyed(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def objectNameChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
