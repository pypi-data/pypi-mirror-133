...
class QDBusPendingCall(PyQt6.sip.simplewrapper):
    ...
    **See also** **QDBusPendingReply**  and **QDBusPendingCallWatcher** .
    ...
    def __init__(self, other: "QDBusPendingCall") -> None:
        """
        https://doc.qt.io/qt-6/qdbuspendingcall.html#QDBusPendingCall
    ...
    def swap(self, other: "QDBusPendingCall") -> None:
        """
        https://doc.qt.io/qt-6/qdbuspendingcall.html#swap
    ...
    def fromCompletedCall(message: QDBusMessage) -> "QDBusPendingCall":
        """
        https://doc.qt.io/qt-6/qdbuspendingcall.html#fromCompletedCall
    ...
    def fromError(error: QDBusError) -> "QDBusPendingCall":
        """
        https://doc.qt.io/qt-6/qdbuspendingcall.html#fromError
        ...
        **error**. The resulting pending call object will be in the "finished"
        state and **QDBusPendingReply** <Types...>::isError() will return true.
