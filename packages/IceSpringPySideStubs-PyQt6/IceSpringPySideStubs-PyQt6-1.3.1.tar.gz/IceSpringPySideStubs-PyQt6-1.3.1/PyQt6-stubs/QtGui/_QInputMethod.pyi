...
class QInputMethod(QtCore.QObject):
    ...
    **Detailed Description**
    ...
    @property
    def anchorRectangleChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def animatingChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def cursorRectangleChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def inputDirectionChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def inputItemClipRectangleChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def keyboardRectangleChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def localeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...
