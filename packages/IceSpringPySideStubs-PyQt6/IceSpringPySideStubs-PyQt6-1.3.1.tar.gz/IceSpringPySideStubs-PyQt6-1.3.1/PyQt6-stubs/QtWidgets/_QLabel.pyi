...
class QLabel(QFrame):
    ...
    **GUI Design Handbook: Label** .
    ...
    def setResourceProvider(
        ...
        """
        https://doc.qt.io/qt-6/qlabel.html#setResourceProvider
    ...
    def resourceProvider(self) -> typing.Callable[[QtCore.QUrl], typing.Any]:
        """
        https://doc.qt.io/qt-6/qlabel.html#resourceProvider
    ...
    @property
    def linkHovered(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
