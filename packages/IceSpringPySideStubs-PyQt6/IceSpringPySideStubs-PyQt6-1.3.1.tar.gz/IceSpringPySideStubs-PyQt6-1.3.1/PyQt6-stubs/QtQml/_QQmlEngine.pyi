...
class QQmlEngine(QJSEngine):
    ...
    **See also** **QQmlComponent** , **QQmlContext** , and **QML Global Object**
    ...
    def singletonInstance(self, qmlTypeId: int) -> QtCore.QObject:
        """
        https://doc.qt.io/qt-6/qqmlengine.html#singletonInstance

        **[since 5.12] template <typename T> T QQmlEngine::singletonInstance(int
        qmlTypeId )**
    ...
    @property
    def exit(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def quit(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def warnings(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
