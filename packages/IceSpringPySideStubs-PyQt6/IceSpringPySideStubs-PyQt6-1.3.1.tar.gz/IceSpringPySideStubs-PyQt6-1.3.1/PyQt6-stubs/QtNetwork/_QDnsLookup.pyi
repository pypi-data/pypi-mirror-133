...
class QDnsLookup(QtCore.QObject):
    ...
    **QHostInfo**  instead.
    ...
    @property
    def nameChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
    ...
    @property
    def nameserverChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        ...

    @property
    def typeChanged(self) -> PyQt6.QtCore.pyqtBoundSignal:
        """
