...
class AuthenticationMixin:
    ...
    def callback(self, code: str) -> Dict:
        ...
        response = httpx.post(config.openid.token_endpoint, data=payload, verify=False)
    ...
    def fetch_userinfo(self, access_token: str = None) -> Dict:
        ...
        response = httpx.post(config.openid.userinfo_endpoint, headers=headers, verify=False)
        response.raise_for_status()
    ...
    def logout(self, access_token: str = None, refresh_token: str = None) -> None:
        ...
        response = httpx.post(
            config.openid.end_session_endpoint, data=payload, headers=headers, verify=False
        )
        response.raise_for_status()
