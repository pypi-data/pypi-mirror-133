...
def mouse_joint_def(body_a, body_b, **kwargs):
    return _factory(MouseJointDef, body_a=body_a, body_b=body_b, **kwargs)


def wheel_joint_def(body_a, body_b, **kwargs):
    return _factory(WheelJointDef, body_a=body_a, body_b=body_b, **kwargs)


def prismatic_joint_def(body_a, body_b, **kwargs):
    return _factory(PrismaticJointDef, body_a=body_a, body_b=body_b, **kwargs)


def revolute_joint_def(body_a, body_b, **kwargs):
    return _factory(RevoluteJointDef, body_a=body_a, body_b=body_b, **kwargs)
