...
class Location(object):
    ...
    def __init__(self, id=None, column=None, name=None, holder_type=None, allowed_products=None, disallowed_products=None, depth=None, width=None, height=None, x=None, y=None, z=None, _configuration=None):  # noqa: E501
