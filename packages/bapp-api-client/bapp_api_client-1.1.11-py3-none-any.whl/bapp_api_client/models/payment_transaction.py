...
class PaymentTransaction(object):
    ...
    def __init__(self, id=None, provider=None, client=None, status=None, identifier=None, ref_id=None, description=None, amount=None, tax_value=None, currency=None, exchange_rate=None, amount_ron=None, target=None, income=None, payment_method=None, _configuration=None):  # noqa: E501
