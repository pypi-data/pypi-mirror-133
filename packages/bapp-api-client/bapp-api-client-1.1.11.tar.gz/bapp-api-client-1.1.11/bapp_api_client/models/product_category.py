...
class ProductCategory(object):
    ...
    def __init__(self, id=None, name=None, parent=None, former_category_id=None, description=None, active=None, translations=None, photo=None, _configuration=None):  # noqa: E501
        ...
        if parent is not None:
            self.parent = parent
        if former_category_id is not None:
            self.former_category_id = former_category_id
    ...
    @property
    def former_category_id(self):
        """Gets the former_category_id of this ProductCategory.  # noqa: E501


        :return: The former_category_id of this ProductCategory.  # noqa: E501
        :rtype: int
        """
        return self._former_category_id

    @former_category_id.setter
    def former_category_id(self, former_category_id):
        """Sets the former_category_id of this ProductCategory.


        :param former_category_id: The former_category_id of this ProductCategory.  # noqa: E501
        :type: int
        """
        if (self._configuration.client_side_validation and
                former_category_id is not None and former_category_id > 2147483647):  # noqa: E501
            raise ValueError("Invalid value for `former_category_id`, must be a value less than or equal to `2147483647`")  # noqa: E501
        if (self._configuration.client_side_validation and
                former_category_id is not None and former_category_id < 0):  # noqa: E501
            raise ValueError("Invalid value for `former_category_id`, must be a value greater than or equal to `0`")  # noqa: E501

        self._former_category_id = former_category_id
