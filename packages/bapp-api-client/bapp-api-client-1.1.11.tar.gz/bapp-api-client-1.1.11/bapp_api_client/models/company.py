...
class Company(object):
    ...
    def __init__(self, id=None, name=None, country=None, region=None, city=None, address=None, logo=None, pays_vat=None, vat_id=None, vat_intra=None, vat_at_income=None, reg_com=None, social_capital=None, email=None, website=None, enabled_modules=None, modules=None, site_logo=None, personal_representative=None, type=None, caen=None, storage=None, phone=None, email_alias=None, application=None, _configuration=None):  # noqa: E501
