...
class Stock(object):
    ...
    def __init__(self, id=None, name=None, description=None, quantitative=None, location=None, manager=None, internal=None, cmp_method=None, _configuration=None):  # noqa: E501
