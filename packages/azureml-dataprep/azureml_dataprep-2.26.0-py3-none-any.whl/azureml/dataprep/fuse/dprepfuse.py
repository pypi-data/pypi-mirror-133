...
class _DPrepFuse(FuseBase):
    ...
    def __init__(self,
        ...
        try:
            ...
            }), rslex_base, PyIfDestinationExists.MERGE_WITH_OVERWRITE)
    ...
    def _download_stream(self, stream_details: StreamDetails, target_path: str) -> str:
        ...
        try:
            ...
            if downloaded_path != target_path:
                log.warning(f"Downloaded path is different from target path")
                print(
                    f"Downloaded path: {downloaded_path} is different from target path: {target_path}")
                try:
