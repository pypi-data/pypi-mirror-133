...
class customTransition extends joint.shapes.pn.Transition {
    defaults() {
        return Object.assign(Object.assign(Object.assign({}, super.defaults), bodyAttributes), { type: "customTransition", size: { width: LIST_ITEM_WIDTH + 4, height: 0 }, ports: {
                groups: {
...
class PetriView extends base_1.DOMWidgetView {
    render() {
        ...
        graphsButton.className = "button button4";
        ...
        addToken.className = "button button2";
        ...
        removeToken.className = "button button2";
        ...
        removeCell.addEventListener("click", (e) => this.removeCell());
        ...
        simulate.className = "button button2";
        ...
        stopSimulation.className = "button button2";
        ...
        lockModel.className = "button button2";
        lockModel.id = "lock";
        ...
        reloadSim.className = "button button2";
        ...
        uploadJSON.className = "button button4";
        ...
        changeProb.className = "button button2";
        ...
        changeLabel.className = "button button2";
        ...
        addConditions.className = "button button2";
        ...
        saveGraphAs.className = "button button2";
...
"use strict";
module.exports = JSON.parse('{"name":"ipypetrinet","version":"0.1.0","description":"A custom petrinet widget.","keywords":["jupyter","jupyterlab","jupyterlab-extension","widgets"],"files":["lib/**/*.js","dist/*.js","css/*.css"],"homepage":"https://github.com/DFKI/ipypetrinet","bugs":{"url":"https://github.com/DFKI/ipypetrinet/issues"},"license":"BSD-3-Clause","author":{"name":"Jakob Bucksch","email":"jakob.bucksch@dfki.de"},"main":"lib/index.js","types":"./lib/index.d.ts","repository":{"type":"git","url":"https://github.com/DFKI/ipypetrinet"},"scripts":{"build":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension:dev","build:prod":"yarn run build:lib && yarn run build:nbextension && yarn run build:labextension","build:labextension":"jupyter labextension build .","build:labextension:dev":"jupyter labextension build --development True .","build:lib":"tsc","build:nbextension":"webpack","clean":"yarn run clean:lib && yarn run clean:nbextension && yarn run clean:labextension","clean:lib":"rimraf lib","clean:labextension":"rimraf ipypetrinet/labextension","clean:nbextension":"rimraf ipypetrinet/nbextension/static/index.js","lint":"eslint . --ext .ts,.tsx --fix","lint:check":"eslint . --ext .ts,.tsx","prepack":"yarn run build:lib","test":"jest","watch":"npm-run-all -p watch:*","watch:lib":"tsc -w","watch:nbextension":"webpack --watch --mode=development","watch:labextension":"jupyter labextension watch ."},"dependencies":{"@jupyter-widgets/base":"^1.1.10 || ^2.0.0 || ^3.0.0 || ^4.0.0","@types/filesystem":"^0.0.32","@types/react":"^17.0.37","fs":"^0.0.1-security","jointjs":"^3.4.4"},"devDependencies":{"@babel/core":"^7.5.0","@babel/preset-env":"^7.5.0","@jupyterlab/builder":"^3.0.0","@phosphor/application":"^1.6.0","@phosphor/widgets":"^1.6.0","@types/jest":"^26.0.0","@types/node":"^16.11.11","@types/webpack-env":"^1.13.6","@typescript-eslint/eslint-plugin":"^3.6.0","@typescript-eslint/parser":"^3.6.0","acorn":"^7.2.0","css-loader":"^3.2.0","eslint":"^7.4.0","eslint-config-prettier":"^6.11.0","eslint-plugin-prettier":"^3.1.4","fs-extra":"^7.0.0","identity-obj-proxy":"^3.0.0","jest":"^26.0.0","mkdirp":"^0.5.1","npm-run-all":"^4.1.3","prettier":"^2.0.5","rimraf":"^2.6.2","source-map-loader":"^1.1.3","style-loader":"^1.0.0","ts-jest":"^26.0.0","ts-loader":"^8.0.0","typescript":"~4.1.3","webpack":"^5.0.0","webpack-cli":"^4.0.0"},"jupyterlab":{"extension":"lib/plugin","outputDir":"ipypetrinet/labextension/","sharedPackages":{"@jupyter-widgets/base":{"bundled":false,"singleton":true}}}}');

/***/ })

}]);
//# sourceMappingURL=lib_widget_js.e4a9629bd12acdb4a76f.js.map