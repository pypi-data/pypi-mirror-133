...
T = TypeVar("T", bound="PoolV1GetCharacteristicsRequest")


@define(auto_attribs=True)
class PoolV1GetCharacteristicsRequest:
    """
    Attributes:
        cusips (Union[Unset, List[str]]): Pool CUSIPs to fetch characteristics. Example: 31417EUD1.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pool_v1_get_characteristics_request = cls(
            cusips=cusips,
            factor_date=factor_date,
        )

        pool_v1_get_characteristics_request.additional_properties = d
        return pool_v1_get_characteristics_request
