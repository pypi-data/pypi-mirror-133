...
def demo(client: "InfimaClient") -> None:  # 5,2021
    ...
    # print(
    #     "%spool predictions ahead one month%s" % (sep, sep),
    #     client.get_preds(testpools, ahead=1),
    # )
    ...
    warnings.warn(f">> database not filled; may be None << ")
    if df is not None:
        _output(df.to_string())

    # print(
    #     "%spool realizations and predictions%s" % (sep, sep),
    #     client.get_reals_preds(testpools),
    # )
    ...
    # print(
    #     "%scohort predictions ahead one month%s" % (sep, sep),
    #     client.get_preds(testcohorts, ahead=1),
    # )
    ...
    # print(
    #     "%scohort realizations and predictions%s" % (sep, sep),
    #     client.get_reals_preds(testcohorts),
    # )

    # print("%spool features%s" % (sep, sep), client.get_attributes(testpools))
    # print("%scohort features%s" % (sep, sep), client.get_attributes(testcohorts))
