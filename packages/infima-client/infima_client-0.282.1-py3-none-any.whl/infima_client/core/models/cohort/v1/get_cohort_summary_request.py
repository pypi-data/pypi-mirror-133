...
T = TypeVar("T", bound="CohortV1GetCohortSummaryRequest")


@define(auto_attribs=True)
class CohortV1GetCohortSummaryRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cohort_v1_get_cohort_summary_request = cls(
            cohorts=cohorts,
            factor_date=factor_date,
        )

        cohort_v1_get_cohort_summary_request.additional_properties = d
        return cohort_v1_get_cohort_summary_request
