...
# numpy needs specific versions to satisfy sparse & numba
reqs = ['numpy<1.21,>=1.17', 'scipy', 'matplotlib', 'pandas', 'pyyaml>=5.1', 'sparse', 'joblib'],
dev_reqs = ['setuptools>=41.0.1', 'pytest', 'pytest-cov', 'coverage', 'flake8']
doc_reqs = ['numpydoc', 'sphinx_gallery', 'pydata-sphinx-theme', 'myst-parser']
