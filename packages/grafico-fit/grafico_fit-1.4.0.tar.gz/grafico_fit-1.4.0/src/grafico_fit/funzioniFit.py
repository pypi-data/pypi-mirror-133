...
def fit(file_name,file_result,variabile_x,variabile_y,sigma_y,f_fit,titoli_p_latex,
    ...
    if split_graphs:
        ...
        if xlabel != None:
            ...
            fig1.supxlabel(_converti_latex(variabile_x), y=0.05)
        if ylabel != None:
            fig1.supylabel(ylabel, x=0.03)
        else:
            fig1.supylabel(_converti_latex(variabile_y), x=0.03)

        if funzioni_modifica[0]:
            funzioni_modifica[0](fig1, ax1,t,y,popt, excel)     

        fig1.tight_layout()
        fig1.canvas.manager.set_window_title(titoli[0])
        ...
        if xlabel != None:
            ...
            fig2.supxlabel(_converti_latex(variabile_x), y=0.05)
        if ylabel != None:
            fig2.supylabel(ylabel, x=0.03)
        else:
            fig2.supylabel(_converti_latex(variabile_y), x=0.03)
        ...
        fig2.canvas.manager.set_window_title(titoli[1]) 
        ...
        if funzioni_modifica[0]:
            funzioni_modifica[0](fig, ax1,t,y,popt, excel)
        if funzioni_modifica[1]:
            funzioni_modifica[1](fig, ax2,t,y,popt, excel)     
