...
_TUPLESTREAMMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_tuples', full_name='heron.proto.stmgr.TupleStreamMessage.num_tuples', index=3,
...
NewPhysicalPlanMessage = _reflection.GeneratedProtocolMessageType('NewPhysicalPlanMessage', (_message.Message,), {
...
NewInstanceAssignmentMessage = _reflection.GeneratedProtocolMessageType('NewInstanceAssignmentMessage', (_message.Message,), {
...
StrMgrHelloRequest = _reflection.GeneratedProtocolMessageType('StrMgrHelloRequest', (_message.Message,), {
...
StrMgrHelloResponse = _reflection.GeneratedProtocolMessageType('StrMgrHelloResponse', (_message.Message,), {
...
StartBackPressureMessage = _reflection.GeneratedProtocolMessageType('StartBackPressureMessage', (_message.Message,), {
...
StopBackPressureMessage = _reflection.GeneratedProtocolMessageType('StopBackPressureMessage', (_message.Message,), {
...
TupleStreamMessage = _reflection.GeneratedProtocolMessageType('TupleStreamMessage', (_message.Message,), {
