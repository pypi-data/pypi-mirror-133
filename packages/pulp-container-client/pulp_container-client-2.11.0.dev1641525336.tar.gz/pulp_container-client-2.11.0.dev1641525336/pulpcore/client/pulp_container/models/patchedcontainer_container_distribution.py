...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, content_guard=None, repository=None, name=None, pulp_labels=None, base_path=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
