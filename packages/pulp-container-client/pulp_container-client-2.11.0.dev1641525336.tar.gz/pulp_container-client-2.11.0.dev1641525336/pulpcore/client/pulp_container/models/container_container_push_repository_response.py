...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, versions_href=None, description=None, latest_version_href=None, name=None, pulp_labels=None, pulp_created=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
