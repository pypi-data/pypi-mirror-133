...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, description=None, versions_href=None, retain_repo_versions=None, name=None, pulp_labels=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
