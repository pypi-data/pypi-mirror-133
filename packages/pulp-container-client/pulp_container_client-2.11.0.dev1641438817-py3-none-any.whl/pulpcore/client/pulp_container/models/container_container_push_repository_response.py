...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, latest_version_href=None, retain_repo_versions=None, versions_href=None, pulp_href=None, description=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
