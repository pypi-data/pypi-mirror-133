...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, versions_href=None, pulp_created=None, pulp_labels=None, name=None, retain_repo_versions=None, pulp_href=None, description=None, local_vars_configuration=None):  # noqa: E501
