...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_api_key_api_v1_admin_api_key_post_endpoint = _Endpoint(
            settings={
                'response_type': (UserOrganizationAPIKeyResponse,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/admin/api-key',
                'operation_id': 'create_api_key_api_v1_admin_api_key_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.exchange_token_api_v1_auth_exhange_token_post_endpoint = _Endpoint(
            settings={
                'response_type': (Token,),
                'auth': [],
                'endpoint_path': '/api/v1/auth/exhange-token',
                'operation_id': 'exchange_token_api_v1_auth_exhange_token_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_entity_children_api_v1_most_recent_entity_numerical_stats_get_endpoint = _Endpoint(
            settings={
                'response_type': ([DataEntityNumericalStat],),
                'auth': [
                    'HTTPBearer'
                ],
        ...
        self.get_entity_lineage_api_v1_lineage_get_endpoint = _Endpoint(
            settings={
                'response_type': (DataEntityLineageResponse,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/lineage',
                'operation_id': 'get_entity_lineage_api_v1_lineage_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'entity_type': 'entityType',
                    'upstream': 'upstream',
                    'process_inactive_tables': 'processInactiveTables',
                },
                'location_map': {
                    'platform_id': 'query',
                    'entity_id': 'query',
        ...
        self.get_jobs_steps_aggregated_stats_api_v1_jobs_steps_aggregated_stats_get_endpoint = _Endpoint(
            settings={
                'response_type': (LimitOffsetPageDataPlatformJobStepAggregatedReport,),
                'auth': [
                    'HTTPBearer'
                ],
        ...
        self.get_query_impact_analysis_api_v1_impact_analysis_query_post_endpoint = _Endpoint(
            settings={
                'response_type': (ImpactAnalysisQueryResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/impact-analysis/query',
                'operation_id': 'get_query_impact_analysis_api_v1_impact_analysis_query_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'platform_id': 'query',
                    'impact_analysis_query_get': 'body',
                    'entity_type': 'query',
                    'limit': 'query',
                    'offset': 'query',
                },
    ...
    def create_api_key_api_v1_admin_api_key_post(
        self,
        user_organization_api_key_request,
        **kwargs
    ):
        ...
        >>> thread = api.create_api_key_api_v1_admin_api_key_post(user_organization_api_key_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_organization_api_key_request'] = \
            user_organization_api_key_request
        return self.create_api_key_api_v1_admin_api_key_post_endpoint.call_with_http_info(**kwargs)
    ...
    def exchange_token_api_v1_auth_exhange_token_post(
        self,
        provider_id,
        exhange_token_request,
        **kwargs
        ...
        >>> thread = api.exchange_token_api_v1_auth_exhange_token_post(provider_id, exhange_token_request, async_req=True)
        >>> result = thread.get()

        Args:
            provider_id (AuthProvider):
            exhange_token_request (ExhangeTokenRequest):
        ...
        kwargs['provider_id'] = \
            provider_id
        kwargs['exhange_token_request'] = \
            exhange_token_request
        return self.exchange_token_api_v1_auth_exhange_token_post_endpoint.call_with_http_info(**kwargs)
    ...
    def get_entity_lineage_api_v1_lineage_get(
        self,
        platform_id,
        entity_id,
        entity_type,
        **kwargs
        ...
        >>> thread = api.get_entity_lineage_api_v1_lineage_get(platform_id, entity_id, entity_type, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            process_inactive_tables (bool): [optional] if omitted the server will use the default value of False
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['entity_type'] = \
            entity_type
        return self.get_entity_lineage_api_v1_lineage_get_endpoint.call_with_http_info(**kwargs)
    ...
    def get_jobs_steps_aggregated_stats_api_v1_jobs_steps_aggregated_stats_get(
        ...
        **kwargs
        ...
        >>> thread = api.get_jobs_steps_aggregated_stats_api_v1_jobs_steps_aggregated_stats_get(entity_id, platform_id, entity_type, report_type, async_req=True)
        >>> result = thread.get()
        ...
        Returns:
            LimitOffsetPageDataPlatformJobStepAggregatedReport
                If the method is called asynchronously, returns the request
                thread.
        """
        kwargs['async_req'] = kwargs.get(
    ...
    def get_query_impact_analysis_api_v1_impact_analysis_query_post(
        self,
        platform_id,
        impact_analysis_query_get,
        **kwargs
        ...
        >>> thread = api.get_query_impact_analysis_api_v1_impact_analysis_query_post(platform_id, impact_analysis_query_get, async_req=True)
        >>> result = thread.get()

        Args:
            platform_id (str):
            impact_analysis_query_get (ImpactAnalysisQueryGet):

        Keyword Args:
            entity_type (DataEntityType): [optional]
            limit (int): [optional] if omitted the server will use the default value of 50
            offset (int): [optional] if omitted the server will use the default value of 0
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
        ...
        kwargs['platform_id'] = \
            platform_id
        kwargs['impact_analysis_query_get'] = \
            impact_analysis_query_get
        return self.get_query_impact_analysis_api_v1_impact_analysis_query_post_endpoint.call_with_http_info(**kwargs)
