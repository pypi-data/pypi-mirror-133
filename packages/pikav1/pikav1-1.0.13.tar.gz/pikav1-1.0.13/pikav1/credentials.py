...
information for the :class:`~pikav1.connection.ConnectionParameters` class.

The :class:`~pikav1.credentials.PlainCredentials` class returns the properly
formatted username and password to the :class:`~pikav1.connection.Connection`.

To authenticate with Pika, create a :class:`~pikav1.credentials.PlainCredentials`
object passing in the username and password and pass it as the credentials
argument value to the :class:`~pikav1.connection.ConnectionParameters` object.

If you are using :class:`~pikav1.connection.URLParameters` you do not need a
...
extend the :class:`~pikav1.credentials.ExternalCredentials` class implementing
