"""Use pikav1 with the Asyncio EventLoop"""

import asyncio
import logging

from pikav1.adapters import base_connection
from pikav1.adapters.utils import nbio_interface, io_services_utils
...
class _AsyncioIOReference(nbio_interface.AbstractIOReference):
    ...
    def __init__(self, future, on_done):
        ...
        def on_done_adapter(future):
            ...
            # NOTE: Asyncio schedules callback for cancelled futures, but pikav1
            # doesn't want that
