...
import pikav1.connection
from pikav1 import exceptions, spec
from pikav1.adapters.utils import nbio_interface
from pikav1.adapters.utils.io_services_utils import check_callback_arg
...
class TwistedChannel(object):
    ...
    def _on_consumer_cancelled(self, frame):
        ...
        :param pikav1.frame.Method frame: method frame with the
    ...
    def basic_cancel(self, consumer_tag=''):
        ...
        <pikav1.channel.Channel.basic_cancel>` and closes any deferred queue
    ...
    def basic_consume(self,
        ...
        :returns: Deferred that fires with a tuple
            ...
            namedtuple whose attributes are:
             - channel: this TwistedChannel
             - method: pikav1.spec.Basic.Deliver
             - properties: pikav1.spec.BasicProperties
             - body: bytes
        :rtype: Deferred
    ...
    def basic_get(self, queue, auto_ack=False):
        ...
        <pikav1.channel.Channel.basic_get>`.
        ...
        :returns: Deferred that fires with a namedtuple whose attributes are:
            channel: this TwistedChannel
            method: pikav1.spec.Basic.GetOk
            properties: pikav1.spec.BasicProperties
            body: bytes
            If the queue is empty, None will be returned.
        :rtype: Deferred
        :raises pikav1.exceptions.DuplicateGetOkCallback:
    ...
    def basic_publish(self,
        ...
        :param pikav1.spec.BasicProperties properties: Basic.properties
    ...
    def _on_delivery_confirmation(self, method_frame):
        """Invoked by pikav1 when RabbitMQ responds to a Basic.Publish RPC
        ...
        :param pikav1.frame.Method method_frame: Basic.Ack or Basic.Nack frame
        ...
        for tag in tags:
            ...
            if isinstance(method_frame.method, pikav1.spec.Basic.Nack):
                ...
                assert isinstance(method_frame.method, pikav1.spec.Basic.Ack)
                if self._puback_return is not None:
    ...
    def queue_delete(self, queue, if_unused=False, if_empty=False):
        ...
        <pikav1.channel.Channel.queue_delete>`, and removes the reference to the
...
class _TwistedConnectionAdapter(pikav1.connection.Connection):
    ...
    management of the transport, we use `pikav1.connection.Connection` directly
    ...
    def _adapter_call_later(self, delay, callback):
        """Implement
        :py:meth:`pikav1.connection.Connection._adapter_call_later()`.
    ...
    def _adapter_remove_timeout(self, timeout_id):
        """Implement
        :py:meth:`pikav1.connection.Connection._adapter_remove_timeout()`.
    ...
    def _adapter_add_callback_threadsafe(self, callback):
        """Implement
        :py:meth:`pikav1.connection.Connection._adapter_add_callback_threadsafe()`.
    ...
    def _adapter_connect_stream(self):
        ...
        :py:ref:meth:`pikav1.connection.Connection._adapter_connect_stream()`
         method.
    ...
    def _adapter_disconnect_stream(self):
        """Implement pure virtual
        :py:ref:meth:`pikav1.connection.Connection._adapter_disconnect_stream()`
         method.
    ...
    def _adapter_emit_data(self, data):
        """Implement pure virtual
        :py:ref:meth:`pikav1.connection.Connection._adapter_emit_data()` method.
