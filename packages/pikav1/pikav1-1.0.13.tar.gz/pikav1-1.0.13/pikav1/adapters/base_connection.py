...
from pikav1.adapters.utils import connection_workflow, nbio_interface
from pikav1 import connection
...
class BaseConnection(connection.Connection):
    ...
    This class abstracts I/O loop and transport services from pikav1 core.
    ...
    def __init__(self, parameters, on_open_callback, on_open_error_callback,
        ...
        :param None|pikav1.connection.Parameters parameters: Connection parameters
        ...
        self._transport = None  # type: pikav1.adapters.utils.nbio_interface.AbstractStreamTransport
    ...
    def __repr__(self):
        ...
        #     except pikav1.compat.SOCKET_ERROR:
        #         # closed?
        #         pass
        #     else:
        #         try:
    ...
    def create_connection(cls,
        ...
        :param sequence connection_configs: A sequence of one or more
            `pikav1.connection.Parameters`-based objects.
        ...
        if isinstance(conn_or_exc, Exception):
            ...
            if isinstance(conn_or_exc,
                ...
                if (isinstance(conn_or_exc,
                    ...
                    conn_or_exc = pikav1.exceptions.AMQPConnectionError(
                        conn_or_exc)
    ...
    def _proto_connection_lost(self, error):
        ...
        if error is None:
            ...
            if self._got_eof:
                error = pikav1.exceptions.StreamLostError(
