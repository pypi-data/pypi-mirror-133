...
from pikav1 import amqp_object
from pikav1 import exceptions
from pikav1 import spec
from pikav1.compat import byte
...
class Method(Frame):
    ...
    def __init__(self, channel_number, method):
        ...
        :param pikav1.Spec.Class.Method method: The AMQP Class.Method
...
def decode_frame(data_in): # pylint: disable=R0911,R0914
    ...
    :raises: pikav1.exceptions.InvalidFrameError
