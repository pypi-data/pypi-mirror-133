...
import pikav1.callback
import pikav1.channel
import pikav1.compat
import pikav1.credentials
import pikav1.exceptions as exceptions
import pikav1.frame as frame
import pikav1.heartbeat
import pikav1.spec as spec
import pikav1.validators as validators
from pikav1.compat import (
    xrange,
    url_unquote,
    dictkeys,
    dict_itervalues,
...
class Parameters(object):  # pylint: disable=R0902
    ...
    DEFAULT_CHANNEL_MAX = pikav1.channel.MAX_CHANNELS
    DEFAULT_CLIENT_PROPERTIES = None
    DEFAULT_CREDENTIALS = pikav1.credentials.PlainCredentials(
    ...
    def channel_max(self, value):
        ...
        if value < 1 or value > pikav1.channel.MAX_CHANNELS:
            raise ValueError('channel_max must be <= %i and > 0, but got %r' %
                             (pikav1.channel.MAX_CHANNELS, value))
    ...
    def credentials(self):
        """
        :rtype: one of the classes from `pikav1.credentials.VALID_TYPES`. Defaults
    ...
    def credentials(self, value):
        ...
        :param value: authentication credential object of one of the classes
            from  `pikav1.credentials.VALID_TYPES`

        """
        if not isinstance(value, tuple(pikav1.credentials.VALID_TYPES)):
            raise TypeError('credentials must be an object of type: %r, but '
                            'got %r' % (pikav1.credentials.VALID_TYPES, value))
        # Copy the mutable object to avoid accidental side-effects
    ...
    def ssl_options(self, value):
        """
        :param `pikav1.SSLOptions`|None value: None for plaintext or
...
class ConnectionParameters(Parameters):
    ...
    def __init__( # pylint: disable=R0913,R0914
        ...
        :param int|None|callable heartbeat: Controls AMQP heartbeat timeout negotiation
            ...
            as its arguments. The callback should return a non-negative integer that
            will be used to override the broker's proposal.
        :param `pikav1.SSLOptions`|None ssl_options: None for plaintext or
            `pika.SSLOptions` instance for SSL/TLS. Defaults to None.
...
class URLParameters(Parameters):
    ...
    Valid query string values are:
        ...
        - client_properties:
            ...
            method
        - connection_attempts:
            Specify how many times pikav1 should try and reconnect before it gives up
        - frame_max:
    ...
    def __init__(self, url):
        ...
        if parts.username is not None:
            self.credentials = pikav1.credentials.PlainCredentials(
        ...
        self._all_url_query_values = pikav1.compat.url_parse_qs(parts.query)
...
class Connection(pikav1.compat.AbstractBase):
    ...
    def __init__(self,
        ...
        :param pikav1.connection.Parameters parameters: Read-only connection
            parameters.
        ...
        self.callbacks = pikav1.callback.CallbackManager()
    ...
    def add_on_close_callback(self, callback):
        ...
        :param callable callback: Callback to call on close, having the signature:
            callback(pikav1.connection.Connection, exception)
    ...
    def add_on_connection_blocked_callback(self, callback):
        ...
        :param callable callback: Callback to call on `Connection.Blocked`,
            having the signature `callback(connection, pikav1.frame.Method)`,
            where the method frame's `method` member is of type
            `pikav1.spec.Connection.Blocked`
    ...
    def add_on_connection_unblocked_callback(self, callback):
        ...
        :param callable callback: Callback to call on
            ...
            `callback(connection, pikav1.frame.Method)`, where the method frame's
            `method` member is of type `pikav1.spec.Connection.Unblocked`
    ...
    def close(self, reply_code=200, reply_text='Normal shutdown'):
        ...
        :raises pikav1.exceptions.ConnectionWrongStateError: if connection is
            closed or closing.
        """
    ...
    def _check_for_protocol_mismatch(self, value):
        ...
        :param pikav1.frame.Method value: The frame to check
    ...
    def _create_channel(self, channel_number, on_open_callback):
        ...
        return pikav1.channel.Channel(self, channel_number, on_open_callback)

    def _create_heartbeat_checker(self):
        """Create a heartbeat checker instance if there is a heartbeat interval
        set.

        :rtype: pikav1.heartbeat.Heartbeat|None
        ...
        if self.params.heartbeat is not None and self.params.heartbeat > 0:
            ...
            return pikav1.heartbeat.HeartbeatChecker(self, self.params.heartbeat)
    ...
    def _deliver_frame_to_channel(self, value):
        ...
        :param pikav1.frame.Method value: The frame to deliver
    ...
    def _get_credentials(self, method_frame):
        ...
        :param pikav1.frame.MethodFrame method_frame: The Connection.Start frame
        :rtype: tuple(str, str)
    ...
    def _is_method_frame(self, value):
        ...
        :param pikav1.frame.Frame value: The frame to evaluate
        :rtype: bool
    ...
    def _next_channel_number(self):
        ...
        """
        limit = self.params.channel_max or pikav1.channel.MAX_CHANNELS
    ...
    def _on_channel_cleanup(self, channel):
        ...
        :param pikav1.channel.Channel channel: channel instance
    ...
    def _on_connection_blocked(self, _connection, method_frame):
        ...
        :param pikav1.frame.Method method_frame: method frame having `method`
    ...
    def _on_connection_close_from_broker(self, method_frame):
        ...
        :param pikav1.frame.Method method_frame: The Connection.Close frame
    ...
    def _on_connection_close_ok(self, method_frame):
        ...
        :param pikav1.frame.Method method_frame: The Connection.CloseOk frame
    ...
    def _on_connection_start(self, method_frame):
        ...
        :param pikav1.frame.Method method_frame: The frame received
    ...
    def _negotiate_integer_value(client_value, server_value):
        ...
        # perform negotiation, see pikav1/pikav1#874
    ...
    def _process_callbacks(self, frame_value):
        ...
        :param pikav1.frame.Method frame_value: The frame to process
        :rtype: bool
    ...
    def _process_frame(self, frame_value):
        ...
        :param pika.frame.Frame|pikav1.frame.Method frame_value: The frame to
            process
    ...
    def _read_frame(self):
        ...
        :rtype tuple: (int, pikav1.frame.Frame)
    ...
    def _remove_callbacks(self, channel_number, method_classes):
        ...
        :param sequence method_classes: The method classes (derived from
            `pikav1.amqp_object.Method`) for the callbacks
    ...
    def _rpc(self,
        ...
        :param pikav1.amqp_object.Method method: The method frame to call
    ...
    def _send_frame(self, frame_value):
        ...
        :param pikav1.frame.Frame|pika.frame.ProtocolHeader frame_value: The
            frame to write
    ...
    def _send_method(self, channel_number, method, content=None):
        ...
        :param pikav1.amqp_object.Method method: The method to send
    ...
    def _send_message(self, channel_number, method_frame, content):
        ...
        :param int channel_number: The channel number for the frame
        :param pikav1.object.Method method_frame: The method frame to send
