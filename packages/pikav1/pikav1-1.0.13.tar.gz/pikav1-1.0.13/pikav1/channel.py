...
from pikav1.compat import unicode_type, dictkeys, is_integer
...
class Channel(object):
    ...
    def basic_cancel(self, consumer_tag='', callback=None):
        ...
        :param callable callback: callback(pikav1.frame.Method) for method
    ...
    def confirm_delivery(self, ack_nack_callback, callback=None):
        ...
        :param callable ack_nack_callback: Required callback for delivery
            ...
            callback(pikav1.frame.Method), where method_frame contains
    ...
    def exchange_bind(self,
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Exchange.BindOk
        :raises ValueError:
    ...
    def exchange_declare(self,
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Exchange.DeclareOk
        :raises ValueError:
    ...
    def exchange_delete(self, exchange=None, if_unused=False, callback=None):
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Exchange.DeleteOk
        :raises ValueError:
    ...
    def exchange_unbind(self,
        ...
        :param dict arguments: Custom key/value pair arguments for the binding
        :param callable callback: callback(pikav1.frame.Method) for method Exchange.UnbindOk
        :raises ValueError:
    ...
    def queue_bind(self,
        ...
        :param str routing_key: The routing key to bind on
        :param dict arguments: Custom key/value pair arguments for the binding
        :param callable callback: callback(pikav1.frame.Method) for method Queue.BindOk
        :raises ValueError:
    ...
    def queue_declare(self,
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Queue.DeclareOk
        :raises ValueError:
    ...
    def queue_delete(self,
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Queue.DeleteOk
        :raises ValueError:
    ...
    def queue_purge(self, queue, callback=None):
        ...
        :param callable callback: callback(pikav1.frame.Method) for method Queue.PurgeOk
        :raises ValueError:
    ...
    def queue_unbind(self,
        ...
        :param str routing_key: The routing key to unbind
        :param dict arguments: Custom key/value pair arguments for the binding
        :param callable callback: callback(pikav1.frame.Method) for method Queue.UnbindOk
        :raises ValueError:
    ...
    def _handle_content_frame(self, frame_value):
        ...
        :param pikav1.amqp_object.Frame frame_value: The frame to deliver
...
class ContentFrameAssembler(object):
    ...
    def _finish(self):
        ...
        :rtype: tuple(pikav1.frame.Method, pikav1.frame.Header, str)
    ...
    def _handle_body_frame(self, body_frame):
        ...
        :raises: pikav1.exceptions.BodyTooLongError
        :rtype: tuple(pikav1.frame.Method, pikav1.frame.Header, str)|None
