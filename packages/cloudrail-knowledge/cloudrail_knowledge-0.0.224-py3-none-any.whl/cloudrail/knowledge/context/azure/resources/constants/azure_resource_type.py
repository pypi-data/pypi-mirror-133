...
class AzureResourceType(Enum):
    ...
    AZURERM_POSTGRESQL_SERVER_CONFIGURATION = 'azurerm_postgresql_configuration'
    ...
    AZURERM_STORAGE_ACCOUNT_CUSTOMER_MANAGED_KEY = 'azurerm_storage_account_customer_managed_key'
