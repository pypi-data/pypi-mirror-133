...
import numpy
import pandas
from pandas._libs import parsers as pandas_parsers
...
class SimpleProfilerPrimitive(unsupervised_learning.UnsupervisedLearnerPrimitiveBase[Inputs, Outputs, Params, Hyperparams]):
    ...
    * ``https://metadata.datadrivendiscovery.org/types/PrimaryKey`` or
    ...
    def __init__(self, *, hyperparams: Hyperparams) -> None:
        ...
        self._training_inputs: typing.Optional[Inputs] = None
        self._add_semantic_types: typing.Optional[typing.List[typing.List[str]]] = None
        self._remove_semantic_types: typing.Optional[typing.List[typing.List[str]]] = None
