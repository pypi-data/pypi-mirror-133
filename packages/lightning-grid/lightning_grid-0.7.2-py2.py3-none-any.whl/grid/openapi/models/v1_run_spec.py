...
class V1RunSpec(object):
    ...
    def __init__(self, actions: 'V1RunActions' = None, auto_resume: 'bool' = None, cluster_id: 'str' = None, datastores: 'list[V1DatastoreMounts]' = None, desired_state: 'V1RunState' = None, dry_run: 'bool' = None, env: 'dict(str, str)' = None, image: 'Externalv1ImageSpec' = None, instance_type: 'str' = None, relative_work_dir: 'str' = None, resources: 'V1Resources' = None, run_controller_command: 'str' = None, run_controller_id: 'str' = None, scratch: 'list[Externalv1ScratchSpace]' = None, source_code: 'str' = None, sweep_options: 'dict(str, str)' = None, sweep_type: 'str' = None, use_spot: 'bool' = None, user_id: 'str' = None, _configuration=None):  # noqa: E501
