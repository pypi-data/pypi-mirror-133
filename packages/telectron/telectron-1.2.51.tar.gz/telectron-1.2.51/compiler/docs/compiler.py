...
telectron_API_DEST = "docs/source/api"

FUNCTIONS_PATH = "telectron/raw/functions"
TYPES_PATH = "telectron/raw/types"
BASE_PATH = "telectron/raw/base"
...
def generate(source_path, base):
                ...
                with open(DESTINATION + "/" + full_path, "w", encoding="utf-8") as f:
                    f.write(
                        page_template.format(
                            ...
                            full_class_path="telectron.raw.{}".format(
    ...
    for k, v in sorted(all_entities.items()):
        ...
        if k != base:
            ...
            module = "telectron.raw.{}.{}".format(base, k)
        else:
            ...
            module = "telectron.raw.{}".format(base)
...
def telectron_api():
    ...
    root = telectron_API_DEST + "/methods"
        ...
        for k, v in categories.items():
            ...
            for method in methods:
                with open(root + "/{}.rst".format(method), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: telectron.Client.{}()".format(method))
            ...
            for func in functions:
                with open(root + "/{}.rst".format(func), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autofunction:: telectron.{}()".format(func))
        ...
        for k, v in categories.items():
            ...
            for type in types:
                with open(root + "/{}.rst".format(type), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. autoclass:: telectron.types.{}()\n".format(type))
    ...
    root = telectron_API_DEST + "/bound-methods"
        ...
        for k, v in categories.items():
            ...
            for bm in bound_methods:
                with open(root + "/{}.rst".format(bm), "w") as f2:
                    ...
                    f2.write(title + "\n" + "=" * len(title) + "\n\n")
                    f2.write(".. automethod:: telectron.types.{}()".format(bm))
