...
class ChatMemberUpdated(Object, Update):
    ...
    Parameters:
        ...
        old_chat_member (:obj:`~telectron.types.ChatMember`, *optional*):
            Previous information about the chat member.

        new_chat_member (:obj:`~telectron.types.ChatMember`, *optional*):
            New information about the chat member.

        invite_link (:obj:`~telectron.types.ChatInviteLink`, *optional*):
