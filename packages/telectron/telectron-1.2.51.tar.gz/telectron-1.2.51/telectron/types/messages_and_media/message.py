...
from telectron.errors import MessageIdsEmpty
from telectron.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        id or message_id (``int``):
            Unique message identifier inside this chat.
            Must be specified id or message_id

        from_user (:obj:`~telectron.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~telectron.types.Chat`, *optional*):
        ...
        chat (:obj:`~telectron.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~telectron.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~telectron.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~telectron.types.Message`, *optional*):
        ...
        entities (List of :obj:`~telectron.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~telectron.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~telectron.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~telectron.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~telectron.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~telectron.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~telectron.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~telectron.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~telectron.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~telectron.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~telectron.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~telectron.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~telectron.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~telectron.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~telectron.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~telectron.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~telectron.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~telectron.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~telectron.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~telectron.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~telectron.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~telectron.types.GameHighScore`, *optional*):
        ...
        via_bot (:obj:`~telectron.types.User`):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <telectron.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~telectron.filters.command`.

        voice_chat_scheduled (:obj:`~telectron.types.VoiceChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        voice_chat_started (:obj:`~telectron.types.VoiceChatStarted`, *optional*):
            Service message: the voice chat started.

        voice_chat_ended (:obj:`~telectron.types.VoiceChatEnded`, *optional*):
            Service message: the voice chat has ended.

        voice_chat_members_invited (:obj:`~telectron.types.VoiceChatParticipantsInvited`, *optional*):
    ...
    def __init__(
        ...
        *,
        ...
        self.id = self.message_id = message_id or id
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            List of :obj:`~telectron.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~telectron.types.Message`.
        ...
        Parameters:
            ...
            entities (List of :obj:`~telectron.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~telectron.types.Message`.
        ...
        Returns:
            On success, the sent :obj:`~telectron.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~telectron.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~telectron.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~telectron.types.Message`.
    ...
    async def reply_chat_action(self, action: str) -> bool:
        """Bound method *reply_chat_action* of :obj:`~telectron.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~telectron.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~telectron.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~telectron.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~telectron.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~telectron.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~telectron.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~telectron.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~telectron.types.InputMediaPhoto` or
                :obj:`~telectron.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~telectron.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~telectron.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~telectron.types.Message`.
        ...
        .. code-block:: python
            ...
            client.send_poll(
                chat_id=message.chat.id,
                question="Is telectron the best?",
                options=["Yes", "Yes"]
            )
        ...
        Example:
            .. code-block:: python
                ...
                message.reply_poll("Is telectron the best?", ["Yes", "Yes"])
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~telectron.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~telectron.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~telectron.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~telectron.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~telectron.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~telectron.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~telectron.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~telectron.types.Message`.
        ...
        Parameters:
            media (:obj:`~telectron.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~telectron.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~telectron.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~telectron.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~telectron.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            :obj:`~telectron.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~telectron.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~telectron.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            :obj:`~telectron.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~telectron.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~telectron.types.Message`.
        ...
        Returns:
            :obj:`~telectron.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> bool:
        """Bound method *pin* of :obj:`~telectron.types.Message`.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~telectron.types.Message`.
