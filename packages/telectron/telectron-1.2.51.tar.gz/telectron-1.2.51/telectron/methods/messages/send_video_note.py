...
class SendVideoNote(Scaffold):
    async def send_video_note(
        ...
        Returns:
            :obj:`~telectron.types.Message` | ``None``: On success, the sent video note message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~telectron.Client.stop_transmission`, None is
            returned.
