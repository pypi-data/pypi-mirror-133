...
from telectron.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia(Scaffold):
    async def download_media(
        ...
        Parameters:
            message (:obj:`~telectron.types.Message` | ``str``):
        ...
        Returns:
            ...
            the download failed or was deliberately stopped with :meth:`~telectron.Client.stop_transmission`, None is
            returned.
