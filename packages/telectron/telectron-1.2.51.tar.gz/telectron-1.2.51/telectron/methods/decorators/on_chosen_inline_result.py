...
class OnChosenInlineResult(Scaffold):
    def on_chosen_inline_result(
        ...
        :obj:`~telectron.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~telectron.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.ChosenInlineResultHandler(func, self),
