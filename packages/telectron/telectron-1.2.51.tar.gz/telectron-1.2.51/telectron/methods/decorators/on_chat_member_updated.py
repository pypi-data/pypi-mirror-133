...
class OnChatMemberUpdated(Scaffold):
    def on_chat_member_updated(
        ...
        :obj:`~telectron.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.ChatMemberUpdatedHandler(func, self),
