...
class Restart(Scaffold):
    async def restart(self, block: bool = True):
        ...
        This method will first call :meth:`~telectron.Client.stop` and then :meth:`~telectron.Client.start` in a row in
        ...
        Returns:
            :obj:`~telectron.Client`: The restarted client itself.
