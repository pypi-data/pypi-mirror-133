...
class CreateChatInviteLink(Scaffold):
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~telectron.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~telectron.types.ChatInviteLink`: On success, the new invite link is returned.
