...
from telectron.errors import UnknownError
...
class GetInlineBotResults(Scaffold):
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~telectron.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <telectron.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = app.get_inline_bot_results("telectronbot")
                print(results)
        """
