...
class GetChat(Scaffold):
    async def get_chat(
        ...
        Returns:
            :obj:`~telectron.types.Chat` | :obj:`~telectron.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
