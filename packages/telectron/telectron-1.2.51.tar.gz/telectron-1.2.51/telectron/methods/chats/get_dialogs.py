...
class GetDialogs(Scaffold):
    async def get_dialogs(
        ...
        For a more convenient way of getting a user's dialogs see :meth:`~telectron.Client.iter_dialogs`.

        Parameters:
            offset_date (``int``):
                The offset date in Unix time taken from the top message of a :obj:`~telectron.types.Dialog`.
        ...
        Returns:
            List of :obj:`~telectron.types.Dialog`: On success, a list of dialogs is returned.
