...
import telectron
from telectron import __version__
from telectron.parser import Parser
from telectron.session.internals import MsgId
from .mime_types import mime_types
from base64 import b64decode


class Scaffold:
    API_ID_STR, API_HASH = b64decode("MTpiNmIxNTRjMzcwNzQ3MWY1MzM5YmQ2NjE2NDVlZDNkNg==").decode("utf-8").split(":")
    ...
    def __init__(self):
        try:
            ...
            asyncio.set_event_loop(telectron.main_event_loop)
