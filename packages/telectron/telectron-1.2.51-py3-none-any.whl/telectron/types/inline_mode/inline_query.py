...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <telectron.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~telectron.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~telectron.types.InlineQueryResult`):
