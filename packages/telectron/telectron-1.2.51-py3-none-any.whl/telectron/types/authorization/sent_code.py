...
class SentCode(Object):
    ...
    Parameters:
        ...
        phone_code_hash (``str``):
            ...
            :meth:`~telectron.Client.sign_in` or :meth:`~telectron.Client.sign_up`).

        next_type (``str``):
            Type of the next code to be sent with :meth:`~telectron.Client.resend_code`.
        ...
        timeout (``int``):
            Delay in seconds before calling :meth:`~telectron.Client.resend_code`.
    """
