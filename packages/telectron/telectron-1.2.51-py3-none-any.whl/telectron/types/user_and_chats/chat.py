...
class Chat(Object):
    ...
    Parameters:
        ...
        photo (:obj:`~telectron.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~telectron.Client.get_chat`.
        ...
        restrictions (List of :obj:`~telectron.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~telectron.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~telectron.Client.get_nearby_chats`.

        linked_chat (:obj:`~telectron.types.Chat`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~telectron.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~telectron.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~telectron.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~telectron.types.Chat`.
    ...
    async def set_photo(self, photo: str) -> bool:
        """Bound method *set_photo* of :obj:`~telectron.types.Chat`.
        ...
        Parameters:
            photo (``str``):
                New chat photo. You can pass a :obj:`~telectron.types.Photo` id or a file path to upload a new photo.
    ...
    async def kick_member(
        ...
        """Bound method *kick_member* of :obj:`~telectron.types.Chat`.
        ...
        Returns:
            :obj:`~telectron.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~telectron.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~telectron.types.ChatPermissions`):
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~telectron.types.Chat`.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~telectron.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~telectron.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~telectron.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~telectron.types.Chat`.
        ...
        Returns:
            :obj:`~telectron.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    async def get_members(
        ...
        """Bound method *get_members* of :obj:`~telectron.types.Chat`.
        ...
        Returns:
            List of :obj:`~telectron.types.ChatMember`: On success, a list of chat members is returned.
        """
    ...
    def iter_members(
        ...
        """Bound method *iter_members* of :obj:`~telectron.types.Chat`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~telectron.types.ChatMember` objects.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~telectron.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~telectron.types.Chat`.
