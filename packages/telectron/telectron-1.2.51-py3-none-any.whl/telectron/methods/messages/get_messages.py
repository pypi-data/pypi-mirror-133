...
class GetMessages(Scaffold):
    async def get_messages(
        ...
        Returns:
            :obj:`~telectron.types.Message` | List of :obj:`~telectron.types.Message`: In case *message_ids* was an
        ...
        Example:
            .. code-block:: python
                ...
                # Get one message
                app.get_messages("telectronchat", 51110)

                # Get more than one message (list of messages)
                app.get_messages("telectronchat", [44625, 51110])
