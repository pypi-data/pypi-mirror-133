...
class SendMessage(Scaffold):
    async def send_message(
        ...
        Returns:
            :obj:`~telectron.types.Message`: On success, the sent text message is returned.
        ...
        Example:
            .. code-block:: python
                ...
                # Simple example
                app.send_message("haskell", "Thanks for creating **telectron**!")

                # Disable web page previews
                app.send_message("me", "https://docs.telectron.org", disable_web_page_preview=True)
                ...
                app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.telectron.org")]
                        ]))
        """
