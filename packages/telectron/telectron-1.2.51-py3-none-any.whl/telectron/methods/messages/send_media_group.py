...
class SendMediaGroup(Scaffold):
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~telectron.types.InputMediaPhoto`, :obj:`~telectron.types.InputMediaVideo`, :obj:`~telectron.types.InputMediaAudio` and :obj:`~telectron.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~telectron.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from telectron.types import InputMediaPhoto, InputMediaVideo
