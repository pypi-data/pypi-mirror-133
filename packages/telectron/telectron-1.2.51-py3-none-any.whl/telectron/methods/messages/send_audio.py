...
class SendAudio(Scaffold):
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~telectron.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~telectron.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
