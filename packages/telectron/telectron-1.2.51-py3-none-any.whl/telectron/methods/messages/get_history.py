...
class GetHistory(Scaffold):
    async def get_history(
        ...
        For a more convenient way of getting a chat history see :meth:`~telectron.Client.iter_history`.
        ...
        Returns:
            List of :obj:`~telectron.types.Message` - On success, a list of the retrieved messages is returned.

        Example:
            .. code-block:: python

                # Get the last 100 messages of a chat
                app.get_history("telectronchat")

                # Get the last 3 messages of a chat
                app.get_history("telectronchat", limit=3)

                # Get 3 messages after skipping the first 5
                app.get_history("telectronchat", offset=5, limit=3)
        """
