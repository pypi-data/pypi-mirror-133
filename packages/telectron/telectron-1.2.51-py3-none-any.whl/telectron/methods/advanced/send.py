...
class Send(Scaffold):
    async def send(
        ...
        Available functions are listed in the :obj:`functions <telectron.api.functions>` package and may accept compound
        data types from :obj:`types <telectron.api.types>` as well as bare types such as ``int``, ``str``, etc...
