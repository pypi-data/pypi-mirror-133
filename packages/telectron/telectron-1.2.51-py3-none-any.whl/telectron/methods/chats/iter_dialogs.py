...
from telectron import types, raw, utils
...
class IterDialogs(Scaffold):
    async def iter_dialogs(
        ...
        This convenience method does the same as repeatedly calling :meth:`~telectron.Client.get_dialogs` in a loop,
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~telectron.types.Dialog` objects.
