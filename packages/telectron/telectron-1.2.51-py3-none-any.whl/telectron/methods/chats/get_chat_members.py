...
class GetChatMembers(Scaffold):
    async def get_chat_members(
        ...
        For a more convenient way of getting chat members see :meth:`~telectron.Client.iter_chat_members`.
        ...
        Example:
            .. code-block:: python
                ...
                app.get_chat_members("telectronchat")

                # Get all administrators
                app.get_chat_members("telectronchat", filter="administrators")

                # Get all bots
                app.get_chat_members("telectronchat", filter="bots")
        """
