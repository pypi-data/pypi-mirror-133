...
class OnCallbackQuery(Scaffold):
    def on_callback_query(
        ...
        :obj:`~telectron.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.CallbackQueryHandler(func, self),
