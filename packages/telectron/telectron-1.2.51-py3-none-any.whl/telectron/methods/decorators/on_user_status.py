...
class OnUserStatus(Scaffold):
    def on_user_status(
        ...
        :obj:`~telectron.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.UserStatusHandler(func, self),
