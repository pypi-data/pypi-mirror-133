...
class OnDeletedMessages(Scaffold):
    def on_deleted_messages(
        ...
        :obj:`~telectron.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.DeletedMessagesHandler(func, self),
