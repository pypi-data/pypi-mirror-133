...
class OnInlineQuery(Scaffold):
    def on_inline_query(
        ...
        :obj:`~telectron.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, telectron.Client):
                self.add_handler(telectron.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        telectron.handlers.InlineQueryHandler(func, self),
