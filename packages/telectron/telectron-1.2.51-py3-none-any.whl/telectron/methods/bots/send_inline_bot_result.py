...
class SendInlineBotResult(Scaffold):
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~telectron.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~telectron.types.Message`: On success, the sent inline result message is returned.
