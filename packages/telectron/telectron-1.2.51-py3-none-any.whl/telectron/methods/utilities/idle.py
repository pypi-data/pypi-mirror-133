...
async def idle():
    ...
    The way telectron works, it will keep your handlers in a pool of worker threads, which are executed concurrently
    ...
    Don't forget to call :meth:`~telectron.Client.stop` for each running client before the script ends.

    Example:
        .. code-block:: python
            :emphasize-lines: 13

            from telectron import Client, idle
