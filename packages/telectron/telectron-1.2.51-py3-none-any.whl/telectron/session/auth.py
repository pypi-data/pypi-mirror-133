...
from telectron.crypto import aes, rsa, prime
from telectron.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "telectron.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
