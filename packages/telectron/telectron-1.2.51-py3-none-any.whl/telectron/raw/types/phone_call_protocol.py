...
class PhoneCallProtocol(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PhoneCallProtocol`.
    ...
    def __init__(self, *, min_layer: int, max_layer: int, library_versions: List[str], udp_p2p: Union[None, bool] = None, udp_reflector: Union[None, bool] = None) -> None:
