...
class User(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        phone (optional): ``str``
        photo (optional): :obj:`UserProfilePhoto <telectron.raw.base.UserProfilePhoto>`
        status (optional): :obj:`UserStatus <telectron.raw.base.UserStatus>`
    ...
    __slots__: List[str] = ["id", "is_self", "contact", "mutual_contact", "deleted", "bot", "bot_chat_history", "bot_nochats", "verified", "restricted", "min", "bot_inline_geo", "support", "scam", "apply_min_photo", "fake", "access_hash", "first_name", "last_name", "username", "phone", "photo", "status", "bot_info_version", "restriction_reason", "bot_inline_placeholder", "lang_code"]

    ID = 0x3ff6ecb0
    QUALNAME = "types.User"

    def __init__(self, *, id: int, is_self: Union[None, bool] = None, contact: Union[None, bool] = None, mutual_contact: Union[None, bool] = None, deleted: Union[None, bool] = None, bot: Union[None, bool] = None, bot_chat_history: Union[None, bool] = None, bot_nochats: Union[None, bool] = None, verified: Union[None, bool] = None, restricted: Union[None, bool] = None, min: Union[None, bool] = None, bot_inline_geo: Union[None, bool] = None, support: Union[None, bool] = None, scam: Union[None, bool] = None, apply_min_photo: Union[None, bool] = None, fake: Union[None, bool] = None, access_hash: Union[None, int] = None, first_name: Union[None, str] = None, last_name: Union[None, str] = None, username: Union[None, str] = None, phone: Union[None, str] = None, photo: "raw.base.UserProfilePhoto" = None, status: "raw.base.UserStatus" = None, bot_info_version: Union[None, int] = None, restriction_reason: Union[None, List["raw.base.RestrictionReason"]] = None, bot_inline_placeholder: Union[None, str] = None, lang_code: Union[None, str] = None) -> None:
        self.id = id  # long
