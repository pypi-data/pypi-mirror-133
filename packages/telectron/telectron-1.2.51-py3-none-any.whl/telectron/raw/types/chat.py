...
class Chat(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        migrated_to (optional): :obj:`InputChannel <telectron.raw.base.InputChannel>`
    ...
    def __init__(self, *, id: int, title: str, photo: "raw.base.ChatPhoto", participants_count: int, date: int, version: int, creator: Union[None, bool] = None, kicked: Union[None, bool] = None, left: Union[None, bool] = None, deactivated: Union[None, bool] = None, call_active: Union[None, bool] = None, call_not_empty: Union[None, bool] = None, noforwards: Union[None, bool] = None, migrated_to: "raw.base.InputChannel" = None, admin_rights: "raw.base.ChatAdminRights" = None, default_banned_rights: "raw.base.ChatBannedRights" = None) -> None:
        self.id = id  # long
