...
class BotInlineResult(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.BotInlineResult`.
    ...
    Parameters:
        id: ``str``
        type: ``str``
        send_message: :obj:`BotInlineMessage <telectron.raw.base.BotInlineMessage>`
        title (optional): ``str``
        description (optional): ``str``
        url (optional): ``str``
        thumb (optional): :obj:`WebDocument <telectron.raw.base.WebDocument>`
        content (optional): :obj:`WebDocument <telectron.raw.base.WebDocument>`
    """
    ...
    def __init__(self, *, id: str, type: str, send_message: "raw.base.BotInlineMessage", title: Union[None, str] = None, description: Union[None, str] = None, url: Union[None, str] = None, thumb: "raw.base.WebDocument" = None, content: "raw.base.WebDocument" = None) -> None:
        self.id = id  # string
