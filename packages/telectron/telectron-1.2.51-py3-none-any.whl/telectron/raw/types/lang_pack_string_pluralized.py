...
class LangPackStringPluralized(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.LangPackString`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`langpack.GetStrings <telectron.raw.functions.langpack.GetStrings>`
    """
    ...
    def __init__(self, *, key: str, other_value: str, zero_value: Union[None, str] = None, one_value: Union[None, str] = None, two_value: Union[None, str] = None, few_value: Union[None, str] = None, many_value: Union[None, str] = None) -> None:
        self.key = key  # string
