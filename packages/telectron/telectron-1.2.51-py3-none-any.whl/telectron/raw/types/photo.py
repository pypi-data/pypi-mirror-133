...
class Photo(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        date: ``int`` ``32-bit``
        sizes: List of :obj:`PhotoSize <telectron.raw.base.PhotoSize>`
        dc_id: ``int`` ``32-bit``
        has_stickers (optional): ``bool``
        video_sizes (optional): List of :obj:`VideoSize <telectron.raw.base.VideoSize>`
    """
    ...
    def __init__(self, *, id: int, access_hash: int, file_reference: bytes, date: int, sizes: List["raw.base.PhotoSize"], dc_id: int, has_stickers: Union[None, bool] = None, video_sizes: Union[None, List["raw.base.VideoSize"]] = None) -> None:
        self.id = id  # long
