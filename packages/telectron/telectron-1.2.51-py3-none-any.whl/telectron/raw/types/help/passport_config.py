...
class PassportConfig(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.help.PassportConfig`.
    ...
    Parameters:
        hash: ``int`` ``32-bit``
        countries_langs: :obj:`DataJSON <telectron.raw.base.DataJSON>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPassportConfig <telectron.raw.functions.help.GetPassportConfig>`
    """
