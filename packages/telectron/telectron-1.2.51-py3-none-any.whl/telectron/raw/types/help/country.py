...
class Country(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.help.Country`.
    ...
    Parameters:
        iso2: ``str``
        default_name: ``str``
        country_codes: List of :obj:`help.CountryCode <telectron.raw.base.help.CountryCode>`
    ...
    def __init__(self, *, iso2: str, default_name: str, country_codes: List["raw.base.help.CountryCode"], hidden: Union[None, bool] = None, name: Union[None, str] = None) -> None:
