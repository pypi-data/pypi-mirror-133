...
class CountriesList(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.help.CountriesList`.
    ...
    Parameters:
        countries: List of :obj:`help.Country <telectron.raw.base.help.Country>`
        hash: ``int`` ``32-bit``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetCountriesList <telectron.raw.functions.help.GetCountriesList>`
    """
