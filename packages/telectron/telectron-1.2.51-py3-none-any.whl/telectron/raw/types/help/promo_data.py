...
class PromoData(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.help.PromoData`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetPromoData <telectron.raw.functions.help.GetPromoData>`
    """
    ...
    def __init__(self, *, expires: int, peer: "raw.base.Peer", chats: List["raw.base.Chat"], users: List["raw.base.User"], proxy: Union[None, bool] = None, psa_type: Union[None, str] = None, psa_message: Union[None, str] = None) -> None:
