...
class MessageService(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        date: ``int`` ``32-bit``
        action: :obj:`MessageAction <telectron.raw.base.MessageAction>`
        out (optional): ``bool``
    ...
    def __init__(self, *, id: int, peer_id: "raw.base.Peer", date: int, action: "raw.base.MessageAction", out: Union[None, bool] = None, mentioned: Union[None, bool] = None, media_unread: Union[None, bool] = None, silent: Union[None, bool] = None, post: Union[None, bool] = None, legacy: Union[None, bool] = None, from_id: "raw.base.Peer" = None, reply_to: "raw.base.MessageReplyHeader" = None, ttl_period: Union[None, int] = None) -> None:
        self.id = id  # int
