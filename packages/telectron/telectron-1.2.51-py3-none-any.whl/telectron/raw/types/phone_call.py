...
class PhoneCall(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol: :obj:`PhoneCallProtocol <telectron.raw.base.PhoneCallProtocol>`
        connections: List of :obj:`PhoneConnection <telectron.raw.base.PhoneConnection>`
    ...
    def __init__(self, *, id: int, access_hash: int, date: int, admin_id: int, participant_id: int, g_a_or_b: bytes, key_fingerprint: int, protocol: "raw.base.PhoneCallProtocol", connections: List["raw.base.PhoneConnection"], start_date: int, p2p_allowed: Union[None, bool] = None, video: Union[None, bool] = None) -> None:
        self.id = id  # long
