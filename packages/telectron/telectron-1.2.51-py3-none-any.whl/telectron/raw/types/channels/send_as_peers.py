...
class SendAsPeers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.channels.SendAsPeers`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.GetSendAs <telectron.raw.functions.channels.GetSendAs>`
    """
