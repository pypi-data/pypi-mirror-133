...
class SecureSecretSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.SecureSecretSettings`.
    ...
    Parameters:
        secure_algo: :obj:`SecurePasswordKdfAlgo <telectron.raw.base.SecurePasswordKdfAlgo>`
        secure_secret: ``bytes``
