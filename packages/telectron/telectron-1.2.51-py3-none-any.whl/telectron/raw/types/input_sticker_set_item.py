...
class InputStickerSetItem(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.InputStickerSetItem`.
    ...
    Parameters:
        ...
        emoji: ``str``
        mask_coords (optional): :obj:`MaskCoords <telectron.raw.base.MaskCoords>`
    """
