...
class Page(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Page`.
    ...
    def __init__(self, *, url: str, blocks: List["raw.base.PageBlock"], photos: List["raw.base.Photo"], documents: List["raw.base.Document"], part: Union[None, bool] = None, rtl: Union[None, bool] = None, v2: Union[None, bool] = None, views: Union[None, int] = None) -> None:
        self.url = url  # string
