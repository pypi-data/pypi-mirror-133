...
class WebPageAttributeTheme(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (optional): List of :obj:`Document <telectron.raw.base.Document>`
        settings (optional): :obj:`ThemeSettings <telectron.raw.base.ThemeSettings>`
    """
    ...
    def __init__(self, *, documents: Union[None, List["raw.base.Document"]] = None, settings: "raw.base.ThemeSettings" = None) -> None:
