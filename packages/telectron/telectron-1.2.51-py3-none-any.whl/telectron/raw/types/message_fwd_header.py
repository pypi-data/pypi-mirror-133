...
class MessageFwdHeader(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.MessageFwdHeader`.
    ...
    Parameters:
        ...
        saved_from_peer (optional): :obj:`Peer <telectron.raw.base.Peer>`
    ...
    def __init__(self, *, date: int, imported: Union[None, bool] = None, from_id: "raw.base.Peer" = None, from_name: Union[None, str] = None, channel_post: Union[None, int] = None, post_author: Union[None, str] = None, saved_from_peer: "raw.base.Peer" = None, saved_from_msg_id: Union[None, int] = None, psa_type: Union[None, str] = None) -> None:
        self.date = date  # int
