...
class WebPage(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.WebPage`.
    ...
    Parameters:
        ...
        photo (optional): :obj:`Photo <telectron.raw.base.Photo>`
        ...
        cached_page (optional): :obj:`Page <telectron.raw.base.Page>`
        attributes (optional): List of :obj:`WebPageAttribute <telectron.raw.base.WebPageAttribute>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetWebPage <telectron.raw.functions.messages.GetWebPage>`
    """
    ...
    def __init__(self, *, id: int, url: str, display_url: str, hash: int, type: Union[None, str] = None, site_name: Union[None, str] = None, title: Union[None, str] = None, description: Union[None, str] = None, photo: "raw.base.Photo" = None, embed_url: Union[None, str] = None, embed_type: Union[None, str] = None, embed_width: Union[None, int] = None, embed_height: Union[None, int] = None, duration: Union[None, int] = None, author: Union[None, str] = None, document: "raw.base.Document" = None, cached_page: "raw.base.Page" = None, attributes: Union[None, List["raw.base.WebPageAttribute"]] = None) -> None:
        self.id = id  # long
        self.url = url  # string
