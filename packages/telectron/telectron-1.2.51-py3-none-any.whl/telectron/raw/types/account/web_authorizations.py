...
class WebAuthorizations(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.account.WebAuthorizations`.
    ...
    Parameters:
        authorizations: List of :obj:`WebAuthorization <telectron.raw.base.WebAuthorization>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetWebAuthorizations <telectron.raw.functions.account.GetWebAuthorizations>`
    """
