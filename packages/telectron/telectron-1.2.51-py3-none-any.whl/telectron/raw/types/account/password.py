...
class Password(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.account.Password`.
    ...
    Parameters:
        new_algo: :obj:`PasswordKdfAlgo <telectron.raw.base.PasswordKdfAlgo>`
        new_secure_algo: :obj:`SecurePasswordKdfAlgo <telectron.raw.base.SecurePasswordKdfAlgo>`
        secure_random: ``bytes``
        has_recovery (optional): ``bool``
        has_secure_values (optional): ``bool``
        has_password (optional): ``bool``
        current_algo (optional): :obj:`PasswordKdfAlgo <telectron.raw.base.PasswordKdfAlgo>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPassword <telectron.raw.functions.account.GetPassword>`
    """
    ...
    def __init__(self, *, new_algo: "raw.base.PasswordKdfAlgo", new_secure_algo: "raw.base.SecurePasswordKdfAlgo", secure_random: bytes, has_recovery: Union[None, bool] = None, has_secure_values: Union[None, bool] = None, has_password: Union[None, bool] = None, current_algo: "raw.base.PasswordKdfAlgo" = None, srp_B: Union[None, bytes] = None, srp_id: Union[None, int] = None, hint: Union[None, str] = None, email_unconfirmed_pattern: Union[None, str] = None, pending_reset_date: Union[None, int] = None) -> None:
