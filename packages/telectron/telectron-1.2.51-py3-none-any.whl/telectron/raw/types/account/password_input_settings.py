...
class PasswordInputSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (optional): :obj:`PasswordKdfAlgo <telectron.raw.base.PasswordKdfAlgo>`
        new_password_hash (optional): ``bytes``
        hint (optional): ``str``
        email (optional): ``str``
        new_secure_settings (optional): :obj:`SecureSecretSettings <telectron.raw.base.SecureSecretSettings>`
    """
    ...
    def __init__(self, *, new_algo: "raw.base.PasswordKdfAlgo" = None, new_password_hash: Union[None, bytes] = None, hint: Union[None, str] = None, email: Union[None, str] = None, new_secure_settings: "raw.base.SecureSecretSettings" = None) -> None:
