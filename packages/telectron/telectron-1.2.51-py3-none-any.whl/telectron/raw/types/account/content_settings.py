...
class ContentSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.account.ContentSettings`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetContentSettings <telectron.raw.functions.account.GetContentSettings>`
    """
    ...
    def __init__(self, *, sensitive_enabled: Union[None, bool] = None, sensitive_can_change: Union[None, bool] = None) -> None:
