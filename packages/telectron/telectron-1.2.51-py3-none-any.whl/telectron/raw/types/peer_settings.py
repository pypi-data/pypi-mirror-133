...
class PeerSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PeerSettings`.
    ...
    def __init__(self, *, report_spam: Union[None, bool] = None, add_contact: Union[None, bool] = None, block_contact: Union[None, bool] = None, share_contact: Union[None, bool] = None, need_contacts_exception: Union[None, bool] = None, report_geo: Union[None, bool] = None, autoarchived: Union[None, bool] = None, invite_members: Union[None, bool] = None, request_chat_broadcast: Union[None, bool] = None, geo_distance: Union[None, int] = None, request_chat_title: Union[None, str] = None, request_chat_date: Union[None, int] = None) -> None:
