...
class InputBotInlineResultDocument(TLObject):  # type: ignore
    ...
    Parameters:
        id: ``str``
        type: ``str``
        document: :obj:`InputDocument <telectron.raw.base.InputDocument>`
    ...
    def __init__(self, *, id: str, type: str, document: "raw.base.InputDocument", send_message: "raw.base.InputBotInlineMessage", title: Union[None, str] = None, description: Union[None, str] = None) -> None:
        self.id = id  # string
