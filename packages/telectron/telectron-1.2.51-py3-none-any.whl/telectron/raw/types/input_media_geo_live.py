...
class InputMediaGeoLive(TLObject):  # type: ignore
    ...
    def __init__(self, *, geo_point: "raw.base.InputGeoPoint", stopped: Union[None, bool] = None, heading: Union[None, int] = None, period: Union[None, int] = None, proximity_notification_radius: Union[None, int] = None) -> None:
