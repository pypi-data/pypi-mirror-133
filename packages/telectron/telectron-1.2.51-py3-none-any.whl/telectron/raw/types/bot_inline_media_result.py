...
class BotInlineMediaResult(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: str, type: str, send_message: "raw.base.BotInlineMessage", photo: "raw.base.Photo" = None, document: "raw.base.Document" = None, title: Union[None, str] = None, description: Union[None, str] = None) -> None:
        self.id = id  # string
