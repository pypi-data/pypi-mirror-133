...
class PeerNotifySettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PeerNotifySettings`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetNotifySettings <telectron.raw.functions.account.GetNotifySettings>`
    """
    ...
    def __init__(self, *, show_previews: Union[None, bool] = None, silent: Union[None, bool] = None, mute_until: Union[None, int] = None, sound: Union[None, str] = None) -> None:
