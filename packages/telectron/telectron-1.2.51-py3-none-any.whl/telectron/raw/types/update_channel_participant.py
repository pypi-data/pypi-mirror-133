...
class UpdateChannelParticipant(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        user_id: ``int`` ``64-bit``
        qts: ``int`` ``32-bit``
        prev_participant (optional): :obj:`ChannelParticipant <telectron.raw.base.ChannelParticipant>`
        new_participant (optional): :obj:`ChannelParticipant <telectron.raw.base.ChannelParticipant>`
        invite (optional): :obj:`ExportedChatInvite <telectron.raw.base.ExportedChatInvite>`
    """
