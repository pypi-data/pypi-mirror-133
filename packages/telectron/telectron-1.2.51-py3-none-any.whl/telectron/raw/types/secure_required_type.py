...
class SecureRequiredType(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.SecureRequiredType`.
    ...
    def __init__(self, *, type: "raw.base.SecureValueType", native_names: Union[None, bool] = None, selfie_required: Union[None, bool] = None, translation_required: Union[None, bool] = None) -> None:
