...
class Authorization(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Authorization`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.AcceptLoginToken <telectron.raw.functions.auth.AcceptLoginToken>`
    """
