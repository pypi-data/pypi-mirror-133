...
class File(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.upload.File`.
    ...
    Parameters:
        type: :obj:`storage.FileType <telectron.raw.base.storage.FileType>`
        mtime: ``int`` ``32-bit``
        bytes: ``bytes``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`upload.GetFile <telectron.raw.functions.upload.GetFile>`
    """
