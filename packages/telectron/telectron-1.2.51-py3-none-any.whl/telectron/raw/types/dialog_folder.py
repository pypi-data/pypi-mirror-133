...
class DialogFolder(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Dialog`.
    ...
    Parameters:
        folder: :obj:`Folder <telectron.raw.base.Folder>`
    ...
    def __init__(self, *, folder: "raw.base.Folder", peer: "raw.base.Peer", top_message: int, unread_muted_peers_count: int, unread_unmuted_peers_count: int, unread_muted_messages_count: int, unread_unmuted_messages_count: int, pinned: Union[None, bool] = None) -> None:
