...
class PageRelatedArticle(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PageRelatedArticle`.
    ...
    def __init__(self, *, url: str, webpage_id: int, title: Union[None, str] = None, description: Union[None, str] = None, photo_id: Union[None, int] = None, author: Union[None, str] = None, published_date: Union[None, int] = None) -> None:
        self.url = url  # string
