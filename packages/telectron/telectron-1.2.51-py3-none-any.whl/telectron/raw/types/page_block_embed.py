...
class PageBlockEmbed(TLObject):  # type: ignore
    ...
    def __init__(self, *, caption: "raw.base.PageCaption", full_width: Union[None, bool] = None, allow_scrolling: Union[None, bool] = None, url: Union[None, str] = None, html: Union[None, str] = None, poster_photo_id: Union[None, int] = None, w: Union[None, int] = None, h: Union[None, int] = None) -> None:
