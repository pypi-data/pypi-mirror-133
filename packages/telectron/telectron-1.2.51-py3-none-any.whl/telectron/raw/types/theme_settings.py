...
class ThemeSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.ThemeSettings`.
    ...
    Parameters:
        base_theme: :obj:`BaseTheme <telectron.raw.base.BaseTheme>`
        ...
        wallpaper (optional): :obj:`WallPaper <telectron.raw.base.WallPaper>`
    """
    ...
    def __init__(self, *, base_theme: "raw.base.BaseTheme", accent_color: int, message_colors_animated: Union[None, bool] = None, outbox_accent_color: Union[None, int] = None, message_colors: Union[None, List[int]] = None, wallpaper: "raw.base.WallPaper" = None) -> None:
