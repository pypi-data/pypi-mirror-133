...
class DialogFilter(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.DialogFilter`.
    ...
    Parameters:
        id: ``int`` ``32-bit``
        title: ``str``
        pinned_peers: List of :obj:`InputPeer <telectron.raw.base.InputPeer>`
        include_peers: List of :obj:`InputPeer <telectron.raw.base.InputPeer>`
        exclude_peers: List of :obj:`InputPeer <telectron.raw.base.InputPeer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetDialogFilters <telectron.raw.functions.messages.GetDialogFilters>`
    """
    ...
    def __init__(self, *, id: int, title: str, pinned_peers: List["raw.base.InputPeer"], include_peers: List["raw.base.InputPeer"], exclude_peers: List["raw.base.InputPeer"], contacts: Union[None, bool] = None, non_contacts: Union[None, bool] = None, groups: Union[None, bool] = None, broadcasts: Union[None, bool] = None, bots: Union[None, bool] = None, exclude_muted: Union[None, bool] = None, exclude_read: Union[None, bool] = None, exclude_archived: Union[None, bool] = None, emoticon: Union[None, str] = None) -> None:
        self.id = id  # int
