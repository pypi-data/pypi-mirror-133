...
class MessageStats(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.stats.MessageStats`.
    ...
    Parameters:
        views_graph: :obj:`StatsGraph <telectron.raw.base.StatsGraph>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stats.GetMessageStats <telectron.raw.functions.stats.GetMessageStats>`
    """
