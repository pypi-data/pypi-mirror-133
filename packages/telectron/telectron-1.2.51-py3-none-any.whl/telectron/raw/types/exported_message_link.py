...
class ExportedMessageLink(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.ExportedMessageLink`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.ExportMessageLink <telectron.raw.functions.channels.ExportMessageLink>`
    """
