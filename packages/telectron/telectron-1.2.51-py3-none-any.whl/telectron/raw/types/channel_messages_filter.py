...
class ChannelMessagesFilter(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.ChannelMessagesFilter`.
    ...
    Parameters:
        ranges: List of :obj:`MessageRange <telectron.raw.base.MessageRange>`
    ...
    def __init__(self, *, ranges: List["raw.base.MessageRange"], exclude_new_messages: Union[None, bool] = None) -> None:
