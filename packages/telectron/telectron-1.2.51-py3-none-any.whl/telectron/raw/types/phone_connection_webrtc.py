...
class PhoneConnectionWebrtc(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PhoneConnection`.
    ...
    def __init__(self, *, id: int, ip: str, ipv6: str, port: int, username: str, password: str, turn: Union[None, bool] = None, stun: Union[None, bool] = None) -> None:
        self.id = id  # long
        self.ip = ip  # string
