...
class PollAnswerVoters(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PollAnswerVoters`.
    ...
    def __init__(self, *, option: bytes, voters: int, chosen: Union[None, bool] = None, correct: Union[None, bool] = None) -> None:
