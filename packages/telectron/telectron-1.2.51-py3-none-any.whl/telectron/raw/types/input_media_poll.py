...
class InputMediaPoll(TLObject):  # type: ignore
    ...
    def __init__(self, *, poll: "raw.base.Poll", correct_answers: Union[None, List[bytes]] = None, solution: Union[None, str] = None, solution_entities: Union[None, List["raw.base.MessageEntity"]] = None) -> None:
        self.poll = poll  # Poll
