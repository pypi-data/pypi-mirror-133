...
class AutoDownloadSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.AutoDownloadSettings`.
    ...
    def __init__(self, *, photo_size_max: int, video_size_max: int, file_size_max: int, video_upload_maxbitrate: int, disabled: Union[None, bool] = None, video_preload_large: Union[None, bool] = None, audio_preload_next: Union[None, bool] = None, phonecalls_less_data: Union[None, bool] = None) -> None:
