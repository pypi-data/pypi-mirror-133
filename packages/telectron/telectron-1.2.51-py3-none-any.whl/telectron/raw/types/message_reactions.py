...
class MessageReactions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.MessageReactions`.
    ...
    Parameters:
        results: List of :obj:`ReactionCount <telectron.raw.base.ReactionCount>`
        min (optional): ``bool``
        can_see_list (optional): ``bool``
        recent_reactons (optional): List of :obj:`MessageUserReaction <telectron.raw.base.MessageUserReaction>`
    """
    ...
    def write(self) -> bytes:
        ...
        flags |= (1 << 1) if self.recent_reactons is not None else 0
        b.write(Int(flags))
        
        b.write(Vector(self.results))
        
        if self.recent_reactons is not None:
