...
class PhoneCallDiscarded(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        video (optional): ``bool``
        reason (optional): :obj:`PhoneCallDiscardReason <telectron.raw.base.PhoneCallDiscardReason>`
    ...
    def __init__(self, *, id: int, need_rating: Union[None, bool] = None, need_debug: Union[None, bool] = None, video: Union[None, bool] = None, reason: "raw.base.PhoneCallDiscardReason" = None, duration: Union[None, int] = None) -> None:
        self.id = id  # long
