...
class LoggedOut(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.auth.LoggedOut`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.LogOut <telectron.raw.functions.auth.LogOut>`
    """
    ...
    def __init__(self, *, future_auth_token: Union[None, bytes] = None) -> None:
