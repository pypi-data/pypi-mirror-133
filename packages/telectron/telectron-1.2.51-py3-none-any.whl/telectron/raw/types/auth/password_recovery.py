...
class PasswordRecovery(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.auth.PasswordRecovery`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.RequestPasswordRecovery <telectron.raw.functions.auth.RequestPasswordRecovery>`
    """
