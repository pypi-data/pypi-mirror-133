...
class Authorization(TLObject):  # type: ignore
    ...
    def __init__(self, *, user: "raw.base.User", setup_password_required: Union[None, bool] = None, otherwise_relogin_days: Union[None, int] = None, tmp_sessions: Union[None, int] = None) -> None:
        self.user = user  # User
