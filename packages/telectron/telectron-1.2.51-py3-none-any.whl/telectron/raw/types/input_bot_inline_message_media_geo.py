...
class InputBotInlineMessageMediaGeo(TLObject):  # type: ignore
    ...
    def __init__(self, *, geo_point: "raw.base.InputGeoPoint", heading: Union[None, int] = None, period: Union[None, int] = None, proximity_notification_radius: Union[None, int] = None, reply_markup: "raw.base.ReplyMarkup" = None) -> None:
