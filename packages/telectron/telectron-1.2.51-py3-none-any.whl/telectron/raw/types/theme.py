...
class Theme(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Theme`.
    ...
    Parameters:
        ...
        settings (optional): List of :obj:`ThemeSettings <telectron.raw.base.ThemeSettings>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.CreateTheme <telectron.raw.functions.account.CreateTheme>`
            - :obj:`account.UpdateTheme <telectron.raw.functions.account.UpdateTheme>`
            - :obj:`account.GetTheme <telectron.raw.functions.account.GetTheme>`
    """
