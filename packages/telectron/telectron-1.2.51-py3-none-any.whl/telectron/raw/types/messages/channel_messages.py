...
class ChannelMessages(TLObject):  # type: ignore
    ...
    def __init__(self, *, pts: int, count: int, messages: List["raw.base.Message"], chats: List["raw.base.Chat"], users: List["raw.base.User"], inexact: Union[None, bool] = None, offset_id_offset: Union[None, int] = None) -> None:
        self.pts = pts  # int
