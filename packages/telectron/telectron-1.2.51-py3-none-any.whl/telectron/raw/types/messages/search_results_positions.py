...
class SearchResultsPositions(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        count: ``int`` ``32-bit``
        positions: List of :obj:`SearchResultsPosition <telectron.raw.base.SearchResultsPosition>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetSearchResultsPositions <telectron.raw.functions.messages.GetSearchResultsPositions>`
    """
