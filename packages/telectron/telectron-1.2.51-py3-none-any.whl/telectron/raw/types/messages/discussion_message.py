...
class DiscussionMessage(TLObject):  # type: ignore
    ...
    def __init__(self, *, messages: List["raw.base.Message"], unread_count: int, chats: List["raw.base.Chat"], users: List["raw.base.User"], max_id: Union[None, int] = None, read_inbox_max_id: Union[None, int] = None, read_outbox_max_id: Union[None, int] = None) -> None:
