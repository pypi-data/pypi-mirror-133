...
class BotResults(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.messages.BotResults`.
    ...
    Parameters:
        query_id: ``int`` ``64-bit``
        results: List of :obj:`BotInlineResult <telectron.raw.base.BotInlineResult>`
        cache_time: ``int`` ``32-bit``
        users: List of :obj:`User <telectron.raw.base.User>`
        gallery (optional): ``bool``
        next_offset (optional): ``str``
        switch_pm (optional): :obj:`InlineBotSwitchPM <telectron.raw.base.InlineBotSwitchPM>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetInlineBotResults <telectron.raw.functions.messages.GetInlineBotResults>`
    """
    ...
    def __init__(self, *, query_id: int, results: List["raw.base.BotInlineResult"], cache_time: int, users: List["raw.base.User"], gallery: Union[None, bool] = None, next_offset: Union[None, str] = None, switch_pm: "raw.base.InlineBotSwitchPM" = None) -> None:
