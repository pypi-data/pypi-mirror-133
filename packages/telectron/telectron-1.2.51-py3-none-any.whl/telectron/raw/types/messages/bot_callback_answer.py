...
class BotCallbackAnswer(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.messages.BotCallbackAnswer`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetBotCallbackAnswer <telectron.raw.functions.messages.GetBotCallbackAnswer>`
    """
    ...
    def __init__(self, *, cache_time: int, alert: Union[None, bool] = None, has_url: Union[None, bool] = None, native_ui: Union[None, bool] = None, message: Union[None, str] = None, url: Union[None, str] = None) -> None:
