...
class ChatFull(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.messages.ChatFull`.
    ...
    Parameters:
        full_chat: :obj:`ChatFull <telectron.raw.base.ChatFull>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.GetFullChat <telectron.raw.functions.messages.GetFullChat>`
            - :obj:`channels.GetFullChannel <telectron.raw.functions.channels.GetFullChannel>`
    """
