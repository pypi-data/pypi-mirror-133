...
class PageTableCell(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.PageTableCell`.
    ...
    Parameters:
        ...
        text (optional): :obj:`RichText <telectron.raw.base.RichText>`
    ...
    def __init__(self, *, header: Union[None, bool] = None, align_center: Union[None, bool] = None, align_right: Union[None, bool] = None, valign_middle: Union[None, bool] = None, valign_bottom: Union[None, bool] = None, text: "raw.base.RichText" = None, colspan: Union[None, int] = None, rowspan: Union[None, int] = None) -> None:
