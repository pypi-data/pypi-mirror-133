...
class UpdateBotPrecheckoutQuery(TLObject):  # type: ignore
    ...
    def __init__(self, *, query_id: int, user_id: int, payload: bytes, currency: str, total_amount: int, info: "raw.base.PaymentRequestedInfo" = None, shipping_option_id: Union[None, str] = None) -> None:
