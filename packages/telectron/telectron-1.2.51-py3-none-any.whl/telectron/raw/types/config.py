...
class Config(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Config`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`help.GetConfig <telectron.raw.functions.help.GetConfig>`
    """
    ...
    def __init__(self, *, date: int, expires: int, test_mode: bool, this_dc: int, dc_options: List["raw.base.DcOption"], dc_txt_domain_name: str, chat_size_max: int, megagroup_size_max: int, forwarded_count_max: int, online_update_period_ms: int, offline_blur_timeout_ms: int, offline_idle_timeout_ms: int, online_cloud_timeout_ms: int, notify_cloud_delay_ms: int, notify_default_delay_ms: int, push_chat_period_ms: int, push_chat_limit: int, saved_gifs_limit: int, edit_time_limit: int, revoke_time_limit: int, revoke_pm_time_limit: int, rating_e_decay: int, stickers_recent_limit: int, stickers_faved_limit: int, channels_read_media_period: int, pinned_dialogs_count_max: int, pinned_infolder_count_max: int, call_receive_timeout_ms: int, call_ring_timeout_ms: int, call_connect_timeout_ms: int, call_packet_timeout_ms: int, me_url_prefix: str, caption_length_max: int, message_length_max: int, webfile_dc_id: int, phonecalls_enabled: Union[None, bool] = None, default_p2p_contacts: Union[None, bool] = None, preload_featured_stickers: Union[None, bool] = None, ignore_phone_entities: Union[None, bool] = None, revoke_pm_inbox: Union[None, bool] = None, blocked_mode: Union[None, bool] = None, pfs_enabled: Union[None, bool] = None, tmp_sessions: Union[None, int] = None, autoupdate_url_prefix: Union[None, str] = None, gif_search_username: Union[None, str] = None, venue_search_username: Union[None, str] = None, img_search_username: Union[None, str] = None, static_maps_provider: Union[None, str] = None, suggested_lang_code: Union[None, str] = None, lang_pack_version: Union[None, int] = None, base_lang_pack_version: Union[None, int] = None) -> None:
        self.date = date  # int
