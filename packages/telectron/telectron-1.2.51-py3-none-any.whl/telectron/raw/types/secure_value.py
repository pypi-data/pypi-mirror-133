...
class SecureValue(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.SecureValue`.
    ...
    Parameters:
        ...
        hash: ``bytes``
        data (optional): :obj:`SecureData <telectron.raw.base.SecureData>`
        front_side (optional): :obj:`SecureFile <telectron.raw.base.SecureFile>`
        reverse_side (optional): :obj:`SecureFile <telectron.raw.base.SecureFile>`
        selfie (optional): :obj:`SecureFile <telectron.raw.base.SecureFile>`
        translation (optional): List of :obj:`SecureFile <telectron.raw.base.SecureFile>`
        files (optional): List of :obj:`SecureFile <telectron.raw.base.SecureFile>`
        plain_data (optional): :obj:`SecurePlainData <telectron.raw.base.SecurePlainData>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAllSecureValues <telectron.raw.functions.account.GetAllSecureValues>`
            - :obj:`account.GetSecureValue <telectron.raw.functions.account.GetSecureValue>`
            - :obj:`account.SaveSecureValue <telectron.raw.functions.account.SaveSecureValue>`
    """
    ...
    def __init__(self, *, type: "raw.base.SecureValueType", hash: bytes, data: "raw.base.SecureData" = None, front_side: "raw.base.SecureFile" = None, reverse_side: "raw.base.SecureFile" = None, selfie: "raw.base.SecureFile" = None, translation: Union[None, List["raw.base.SecureFile"]] = None, files: Union[None, List["raw.base.SecureFile"]] = None, plain_data: "raw.base.SecurePlainData" = None) -> None:
