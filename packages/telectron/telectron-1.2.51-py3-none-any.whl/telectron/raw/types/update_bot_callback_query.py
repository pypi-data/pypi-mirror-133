...
class UpdateBotCallbackQuery(TLObject):  # type: ignore
    ...
    def __init__(self, *, query_id: int, user_id: int, peer: "raw.base.Peer", msg_id: int, chat_instance: int, data: Union[None, bytes] = None, game_short_name: Union[None, str] = None) -> None:
