...
class DcOption(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.DcOption`.
    ...
    def __init__(self, *, id: int, ip_address: str, port: int, ipv6: Union[None, bool] = None, media_only: Union[None, bool] = None, tcpo_only: Union[None, bool] = None, cdn: Union[None, bool] = None, static: Union[None, bool] = None, secret: Union[None, bytes] = None) -> None:
        self.id = id  # int
