...
class ReactionCount(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.ReactionCount`.
    ...
    def __init__(self, *, reaction: str, count: int, chosen: Union[None, bool] = None) -> None:
