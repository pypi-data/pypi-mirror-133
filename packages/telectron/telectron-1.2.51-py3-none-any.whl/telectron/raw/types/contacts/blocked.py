...
class Blocked(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.contacts.Blocked`.
    ...
    Parameters:
        blocked: List of :obj:`PeerBlocked <telectron.raw.base.PeerBlocked>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetBlocked <telectron.raw.functions.contacts.GetBlocked>`
    """
