...
class Found(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results: List of :obj:`Peer <telectron.raw.base.Peer>`
        results: List of :obj:`Peer <telectron.raw.base.Peer>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.Search <telectron.raw.functions.contacts.Search>`
    """
