...
class Contacts(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.contacts.Contacts`.
    ...
    Parameters:
        contacts: List of :obj:`Contact <telectron.raw.base.Contact>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetContacts <telectron.raw.functions.contacts.GetContacts>`
    """
