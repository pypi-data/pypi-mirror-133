...
class TopPeers(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.contacts.TopPeers`.
    ...
    Parameters:
        categories: List of :obj:`TopPeerCategoryPeers <telectron.raw.base.TopPeerCategoryPeers>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`contacts.GetTopPeers <telectron.raw.functions.contacts.GetTopPeers>`
    """
