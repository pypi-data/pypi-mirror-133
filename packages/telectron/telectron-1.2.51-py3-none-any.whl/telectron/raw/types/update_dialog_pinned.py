...
class UpdateDialogPinned(TLObject):  # type: ignore
    ...
    Parameters:
        peer: :obj:`DialogPeer <telectron.raw.base.DialogPeer>`
    ...
    def __init__(self, *, peer: "raw.base.DialogPeer", pinned: Union[None, bool] = None, folder_id: Union[None, int] = None) -> None:
