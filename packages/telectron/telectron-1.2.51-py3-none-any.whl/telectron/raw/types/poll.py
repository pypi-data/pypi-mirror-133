...
class Poll(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~telectron.raw.base.Poll`.
    ...
    Parameters:
        id: ``int`` ``64-bit``
        question: ``str``
        answers: List of :obj:`PollAnswer <telectron.raw.base.PollAnswer>`
    ...
    def __init__(self, *, id: int, question: str, answers: List["raw.base.PollAnswer"], closed: Union[None, bool] = None, public_voters: Union[None, bool] = None, multiple_choice: Union[None, bool] = None, quiz: Union[None, bool] = None, close_period: Union[None, int] = None, close_date: Union[None, int] = None) -> None:
        self.id = id  # long
