...
class PhoneCallWaiting(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, access_hash: int, date: int, admin_id: int, participant_id: int, protocol: "raw.base.PhoneCallProtocol", video: Union[None, bool] = None, receive_date: Union[None, int] = None) -> None:
        self.id = id  # long
