...
class ChannelDifference(TLObject):  # type: ignore
    ...
    Parameters:
        pts: ``int`` ``32-bit``
        new_messages: List of :obj:`Message <telectron.raw.base.Message>`
        other_updates: List of :obj:`Update <telectron.raw.base.Update>`
    ...
    def __init__(self, *, pts: int, new_messages: List["raw.base.Message"], other_updates: List["raw.base.Update"], chats: List["raw.base.Chat"], users: List["raw.base.User"], final: Union[None, bool] = None, timeout: Union[None, int] = None) -> None:
        self.pts = pts  # int
