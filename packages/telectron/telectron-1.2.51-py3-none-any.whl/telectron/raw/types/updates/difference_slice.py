...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_encrypted_messages: List of :obj:`EncryptedMessage <telectron.raw.base.EncryptedMessage>`
        ...
        intermediate_state: :obj:`updates.State <telectron.raw.base.updates.State>`
