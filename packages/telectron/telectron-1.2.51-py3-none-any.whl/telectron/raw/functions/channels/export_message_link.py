...
class ExportMessageLink(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`ExportedMessageLink <telectron.raw.base.ExportedMessageLink>`
    """
    ...
    def __init__(self, *, channel: "raw.base.InputChannel", id: int, grouped: Union[None, bool] = None, thread: Union[None, bool] = None) -> None:
