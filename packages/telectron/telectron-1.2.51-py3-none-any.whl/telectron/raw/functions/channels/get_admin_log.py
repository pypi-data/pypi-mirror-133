...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        min_id: ``int`` ``64-bit``
        limit: ``int`` ``32-bit``
        events_filter (optional): :obj:`ChannelAdminLogEventsFilter <telectron.raw.base.ChannelAdminLogEventsFilter>`
        admins (optional): List of :obj:`InputUser <telectron.raw.base.InputUser>`

    Returns:
        :obj:`channels.AdminLogResults <telectron.raw.base.channels.AdminLogResults>`
    """
    ...
    def __init__(self, *, channel: "raw.base.InputChannel", q: str, max_id: int, min_id: int, limit: int, events_filter: "raw.base.ChannelAdminLogEventsFilter" = None, admins: Union[None, List["raw.base.InputUser"]] = None) -> None:
