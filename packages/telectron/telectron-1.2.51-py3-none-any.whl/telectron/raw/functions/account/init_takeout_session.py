...
class InitTakeoutSession(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`account.Takeout <telectron.raw.base.account.Takeout>`
    """
    ...
    def __init__(self, *, contacts: Union[None, bool] = None, message_users: Union[None, bool] = None, message_chats: Union[None, bool] = None, message_megagroups: Union[None, bool] = None, message_channels: Union[None, bool] = None, files: Union[None, bool] = None, file_max_size: Union[None, int] = None) -> None:
