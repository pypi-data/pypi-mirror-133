...
class InstallTheme(TLObject):  # type: ignore
    ...
    Parameters:
        dark (optional): ``bool``
        theme (optional): :obj:`InputTheme <telectron.raw.base.InputTheme>`
        format (optional): ``str``
        base_theme (optional): :obj:`BaseTheme <telectron.raw.base.BaseTheme>`
    ...
    def __init__(self, *, dark: Union[None, bool] = None, theme: "raw.base.InputTheme" = None, format: Union[None, str] = None, base_theme: "raw.base.BaseTheme" = None) -> None:
