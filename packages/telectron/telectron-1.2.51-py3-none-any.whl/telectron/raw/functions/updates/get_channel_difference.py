...
class GetChannelDifference(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter: :obj:`ChannelMessagesFilter <telectron.raw.base.ChannelMessagesFilter>`
        pts: ``int`` ``32-bit``
        limit: ``int`` ``32-bit``
        force (optional): ``bool``

    Returns:
        :obj:`updates.ChannelDifference <telectron.raw.base.updates.ChannelDifference>`
    """
    ...
    def __init__(self, *, channel: "raw.base.InputChannel", filter: "raw.base.ChannelMessagesFilter", pts: int, limit: int, force: Union[None, bool] = None) -> None:
