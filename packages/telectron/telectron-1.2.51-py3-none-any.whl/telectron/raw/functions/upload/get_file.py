...
class GetFile(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`upload.File <telectron.raw.base.upload.File>`
    """
    ...
    def __init__(self, *, location: "raw.base.InputFileLocation", offset: int, limit: int, precise: Union[None, bool] = None, cdn_supported: Union[None, bool] = None) -> None:
