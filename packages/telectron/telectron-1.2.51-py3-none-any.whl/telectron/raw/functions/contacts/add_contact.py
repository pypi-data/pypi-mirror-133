...
class AddContact(TLObject):  # type: ignore
    ...
    Parameters:
        id: :obj:`InputUser <telectron.raw.base.InputUser>`
        first_name: ``str``
        last_name: ``str``
        phone: ``str``
    ...
    def __init__(self, *, id: "raw.base.InputUser", first_name: str, last_name: str, phone: str, add_phone_privacy_exception: Union[None, bool] = None) -> None:
