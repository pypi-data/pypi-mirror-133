...
class GetTopPeers(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`contacts.TopPeers <telectron.raw.base.contacts.TopPeers>`
    """
    ...
    def __init__(self, *, offset: int, limit: int, hash: int, correspondents: Union[None, bool] = None, bots_pm: Union[None, bool] = None, bots_inline: Union[None, bool] = None, phone_calls: Union[None, bool] = None, forward_users: Union[None, bool] = None, forward_chats: Union[None, bool] = None, groups: Union[None, bool] = None, channels: Union[None, bool] = None) -> None:
