...
class SendReaction(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["peer", "msg_id", "reaction"]

    ID = 0x25690ce4
    QUALNAME = "functions.messages.SendReaction"

    def __init__(self, *, peer: "raw.base.InputPeer", msg_id: int, reaction: Union[None, str] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SendReaction":
        ...
        return SendReaction(peer=peer, msg_id=msg_id, reaction=reaction)
