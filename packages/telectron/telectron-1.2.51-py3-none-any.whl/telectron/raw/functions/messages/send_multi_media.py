...
class SendMultiMedia(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        multi_media: List of :obj:`InputSingleMedia <telectron.raw.base.InputSingleMedia>`
