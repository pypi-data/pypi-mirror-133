...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        min_id: ``int`` ``32-bit``
        hash: ``int`` ``64-bit``
        from_id (optional): :obj:`InputPeer <telectron.raw.base.InputPeer>`
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", q: str, filter: "raw.base.MessagesFilter", min_date: int, max_date: int, offset_id: int, add_offset: int, limit: int, max_id: int, min_id: int, hash: int, from_id: "raw.base.InputPeer" = None, top_msg_id: Union[None, int] = None) -> None:
