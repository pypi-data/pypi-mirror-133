...
class SetGameScore(TLObject):  # type: ignore
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", id: int, user_id: "raw.base.InputUser", score: int, edit_message: Union[None, bool] = None, force: Union[None, bool] = None) -> None:
