...
class DeleteHistory(TLObject):  # type: ignore
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", max_id: int, just_clear: Union[None, bool] = None, revoke: Union[None, bool] = None, min_date: Union[None, int] = None, max_date: Union[None, int] = None) -> None:
