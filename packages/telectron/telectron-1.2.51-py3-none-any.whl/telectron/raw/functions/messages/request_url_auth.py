...
class RequestUrlAuth(TLObject):  # type: ignore
    ...
    Parameters:
        peer (optional): :obj:`InputPeer <telectron.raw.base.InputPeer>`
        msg_id (optional): ``int`` ``32-bit``
        button_id (optional): ``int`` ``32-bit``
        url (optional): ``str``

    Returns:
        :obj:`UrlAuthResult <telectron.raw.base.UrlAuthResult>`
    """
    ...
    def __init__(self, *, peer: "raw.base.InputPeer" = None, msg_id: Union[None, int] = None, button_id: Union[None, int] = None, url: Union[None, str] = None) -> None:
