...
class GetMessageReactionsList(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`messages.MessageReactionsList <telectron.raw.base.messages.MessageReactionsList>`
    """
    ...
    def __init__(self, *, peer: "raw.base.InputPeer", id: int, limit: int, reaction: Union[None, str] = None, offset: Union[None, str] = None) -> None:
