...
# -*- coding: utf-8 -*-
#
# etc_jupyterlab_distribution documentation build configuration file
#
...
project = 'etc_jupyterlab_distribution'
copyright = '2021, ETC'
author = 'ETC'
...
_version_py = os.path.join(repo, 'etc_jupyterlab_distribution', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'etc_jupyterlab_distributiondoc'
...
latex_documents = [
    (master_doc, 'etc_jupyterlab_distribution.tex', 'etc_jupyterlab_distribution Documentation',
     'ETC', 'manual'),
]
...
man_pages = [
    ...
    'etc_jupyterlab_distribution Documentation',
     [author], 1)
]
