...
usage = """
%prog [options]
this script facilitates reading of geometry and charges after crystal09/14/.. (full) structure optimization without 
prior input preparation
...
default output:
- input file for further calculations
...
def run():
    ...
    # todo: input prepared at the very end of procedure
