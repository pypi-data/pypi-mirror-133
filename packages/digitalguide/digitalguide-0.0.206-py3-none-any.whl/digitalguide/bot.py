...
from digitalguide import (contextActions, conversationActions, imageActions,
                          ...
                          writeActions)
custom_actions_exist = os.path.exists("actions/generalActions.py")
if custom_actions_exist:
...
if MESSANGER == "Telegram":
    ...
    if custom_actions_exist:
        action_functions = {**action_functions, **generalActions.telegram_action_functions}
    ...
    if custom_actions_exist:
        action_functions = {**action_functions, **generalActions.whatsapp_action_functions}
