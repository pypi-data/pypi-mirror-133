...
#ifndef KALDIFST_CSRC_UTIL_KALDI_IO_H_
#define KALDIFST_CSRC_UTIL_KALDI_IO_H_
...
}  // end namespace kaldifst

#include "kaldifst/csrc/util/kaldi-io-inl.h"

#endif  // KALDIFST_CSRC_UTIL_KALDI_IO_H_
