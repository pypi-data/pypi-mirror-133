// kaldifst/csrc/matrix/matrix-common.h
...
#ifndef KALDIFST_MATRIX_MATRIX_COMMON_H_
#define KALDIFST_MATRIX_MATRIX_COMMON_H_
...
#endif  // KALDIFST_MATRIX_MATRIX_COMMON_H_
