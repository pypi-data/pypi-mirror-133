// kaldifst/csrc/util/kaldi-holder.h
...
#ifndef KALDIFST_CSRC_UTIL_KALDI_HOLDER_H_
#define KALDIFST_CSRC_UTIL_KALDI_HOLDER_H_
...
template<class SomeType> class GenericHolder {
 ...
 private:
  KALDIFST_DISALLOW_COPY_AND_ASSIGN(GenericHolder);
...
bool ExtractObjectRange(const T &input, const std::string &range, T *output) {
  KALDIFST_ERR << "Ranges not supported for objects of this type.";
  return false;
}
...
#include "kaldifst/csrc/util/kaldi-holder-inl.h"

#endif  // KALDIFST_CSRC_UTIL_KALDI_HOLDER_H_
