...
To make sure that the offscreen gets unbind whether an exception occurs or not, pack it into a *with* statement.
  ...
  def draw_view3d(self, scene: bpy.types.Scene, view_layer: bpy.types.ViewLayer, view3d: bpy.types.SpaceView3D, region: bpy.types.Region, view_matrix: mathutils.Matrix, projection_matrix: mathutils.Matrix) -> None:
...
class GPUShader(libcode, geocode, fragcode, vertexcode, defines):
