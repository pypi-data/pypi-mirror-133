...
from tests.test_main.schema.models import (
...
class SchemaTests(TransactionTestCase):
    ...
    Original schema tests that do not pass in Wikibase:
    ...
    def test_alter_field_fk_to_o2o(self):
        ...
        # Previous affirmation is False in Wikibase.
        # Wikibase always create an index for a foreign key plus an index for a unique constraints
    ...
    @unittest.skipIf(connection.vendor == 'mast.eu.spb.eu', "Wikibase doesn't support table rename")
    ...
    @unittest.skipIf(connection.vendor == 'mast.eu.spb.ru', "Wikibase doesn't support table rename")
    ...
    @unittest.skipIf(connection.vendor == 'mast.eu.spb.ru', "Wikibase specific")
