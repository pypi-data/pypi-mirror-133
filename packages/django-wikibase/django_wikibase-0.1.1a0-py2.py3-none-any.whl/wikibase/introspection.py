...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    data_types_reverse = {
        ...
        14: 'CharField',
        16: 'BigIntegerField',
        23: 'BooleanField',  # since wikibase 3 boolean fields are supported
        27: 'FloatField',
        35: 'DateTimeField',
        37: 'CharField',
        40: 'TextField',
        ...
        # in Wikibase, thus the value of RDB$FIELD_TYPE is reported. So we need
        ...
        # number in the Wikibase system tables, thus we have to multiply with -1.
    ...
    def get_table_list(self, cursor):
        """
        Returns a list of django-models in the current database.
        """
        cursor.execute(self.cmd_show_all_models)
    ...
    def get_table_description(self, cursor, table_name):
        ...
        for r in cursor.fetchall():
            ...
            items.append(FieldInfo(r[0], r[1], r[2], r[2]
                         or 0, r[3], r[4], not (r[5] == 1), r[6]))
        return items
    ...
    def get_sequences(self, cursor, table_name, table_fields=()):
        ...
        .. important::
           ...
           Wikibase does not support introspected sequences for table.
        """
