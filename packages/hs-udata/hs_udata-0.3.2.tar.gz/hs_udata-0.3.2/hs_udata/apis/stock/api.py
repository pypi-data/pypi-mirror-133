...
def trading_calendar(secu_market=None, if_trading_day=None, if_week_end=None, if_month_end=None, start_date=None,
...
def stock_quote_daily_list(en_prod_code=None, begin_date=None, end_date=None, adjust_way='0'):
    """
