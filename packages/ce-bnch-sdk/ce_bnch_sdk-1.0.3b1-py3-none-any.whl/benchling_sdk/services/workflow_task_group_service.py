...
from benchling_api_client.v2.alpha.api.workflow_task_groups import (
...
from benchling_api_client.v2.alpha.models.workflow_task_group import WorkflowTaskGroup
from benchling_api_client.v2.alpha.models.workflow_task_group_archive_reason import (
    WorkflowTaskGroupArchiveReason,
)
from benchling_api_client.v2.alpha.models.workflow_task_group_create import WorkflowTaskGroupCreate
from benchling_api_client.v2.alpha.models.workflow_task_group_update import WorkflowTaskGroupUpdate
from benchling_api_client.v2.alpha.models.workflow_task_groups_archival_change import (
    WorkflowTaskGroupsArchivalChange,
)
from benchling_api_client.v2.alpha.models.workflow_task_groups_archive import WorkflowTaskGroupsArchive
from benchling_api_client.v2.alpha.models.workflow_task_groups_paginated_list import (
    WorkflowTaskGroupsPaginatedList,
)
from benchling_api_client.v2.alpha.models.workflow_task_groups_unarchive import WorkflowTaskGroupsUnarchive
...
class WorkflowTaskGroupService(BaseService):
    ...
    See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups
    """
    ...
    def get_by_id(self, workflow_task_group_id: str) -> WorkflowTaskGroup:
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/getWorkflowTaskGroup
        """
    ...
    def _workflow_task_groups_page(
        ...
        return list_workflow_task_groups.sync_detailed(  # type: ignore
            client=self.client,
    ...
    def list(
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/listWorkflowTaskGroups
        """
    ...
    def create(self, workflow_task_group: WorkflowTaskGroupCreate) -> WorkflowTaskGroup:
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/createWorkflowTaskGroup
        """
    ...
    def update(
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/updateWorkflowTaskGroup
        """
    ...
    def archive(
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/archiveWorkflows
        """
    ...
    def unarchive(self, workflow_task_group_ids: Iterable[str]) -> WorkflowTaskGroupsArchivalChange:
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Workflow%20Task%20Groups/unarchiveWorkflows
        """
