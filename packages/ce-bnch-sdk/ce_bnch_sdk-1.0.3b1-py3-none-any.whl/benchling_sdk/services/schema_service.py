...
from benchling_api_client.v2.alpha.api.schemas import get_workflow_task_schema, list_workflow_task_schemas
from benchling_api_client.v2.alpha.models.workflow_task_schema import WorkflowTaskSchema
from benchling_api_client.v2.alpha.models.workflow_task_schemas_paginated_list import (
...
class SchemaService(BaseService):
    ...
    def _request_task_schemas_page(
        ...
        return list_request_task_schemas.sync_detailed(  # type:ignore
            client=self.client, next_token=none_as_unset(next_token), page_size=none_as_unset(page_size)
        )

    def list_request_task_schemas(self, *, page_size: Optional[int] = 50) -> PageIterator[RequestTaskSchema]:
        """
        ...
        def api_call(
            ...
            return self._request_task_schemas_page(next_token=next_token, page_size=page_size)
    ...
    def get_workflow_task_schema_by_id(self, schema_id: str) -> WorkflowTaskSchema:
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Schemas/getWorkflowTaskSchema
        """
        response = get_workflow_task_schema.sync_detailed(
            client=v2_alpha_client(self.client), schema_id=schema_id
        )
        return model_from_detailed(response)
    ...
    def _workflow_task_schemas_page(
        ...
        *,
        ...
        return list_workflow_task_schemas.sync_detailed(  # type:ignore
            client=v2_alpha_client(self.client),
    ...
    def list_workflow_task_schemas(
        ...
        See https://benchling.com/api/v2-alpha/reference?showLA=true#/Schemas/listWorkflowTaskSchemas
        """
