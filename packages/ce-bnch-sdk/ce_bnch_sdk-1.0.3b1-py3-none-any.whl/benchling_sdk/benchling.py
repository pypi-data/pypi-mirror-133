...
from benchling_sdk.services.entries_service import EntriesService
...
class Benchling(object):
    ...
    _entries_service: EntriesService
    ...
    def __init__(
        ...
        alpha_api_client = v2_alpha_client(self._client)
        ...
        self._entries_service = EntriesService(client, retry_strategy=retry_strategy)
        ...
        # Alpha Services
        self._workflow_output_service = WorkflowOutputService(alpha_api_client, retry_strategy=retry_strategy)
        self._workflow_task_group_service = WorkflowTaskGroupService(
            alpha_api_client, retry_strategy=retry_strategy
        )
        self._workflow_task_service = WorkflowTaskService(alpha_api_client, retry_strategy=retry_strategy)
