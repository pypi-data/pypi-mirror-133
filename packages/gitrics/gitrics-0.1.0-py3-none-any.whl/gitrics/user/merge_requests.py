...
class gitricsUserMergeRequests(gitricsUserIssueMergeRequest):
    ...
    def __init__(self, user_id: str = None, user: dict = None, date_start: str = configuration.DATE_START, date_end: str = configuration.DATE_END, token: str = None, version: str = configuration.GITLAB_API_VERSION):
        """
        Args:
