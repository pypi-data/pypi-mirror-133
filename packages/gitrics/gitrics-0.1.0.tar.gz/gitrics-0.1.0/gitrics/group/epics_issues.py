...
class gitricsGroupEpicsIssues:
    ...
    def get_item(self, id: int):
        """
        Retrieve an item class object.

        Args:
            id (integer): GitLab Epic or Issue id

        Returns:
            A class of either GitlabEpic or GitlabIssue where either represents a GitLab Epic or GitLab Issue, respectively.
        """
