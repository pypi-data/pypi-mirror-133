...
from glapi.project.project import GitlabProject
...
class gitricsProjectEvents(GitlabProject):
    ...
    def __init__(self, project_id: str = None, project: dict = None, date_start: str = configuration.DATE_START, date_end: str = configuration.DATE_END, token: str = None, version: str = configuration.GITLAB_API_VERSION):
        """
        Args:
