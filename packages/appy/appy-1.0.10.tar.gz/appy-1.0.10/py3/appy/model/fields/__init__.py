...
class Field:
    ...
    # Show the field content for some object ("o") on a list of referred objects
    pxTied = Px('''
     <!-- The "title" field -->
    ...
    pxResult = Px('''
     ...
     <x if="field.name == 'title'"
      ...
      <x if="mayView"
       ...
       <!-- Actions -->
       <div if="showActions" class=":ui.getActionsCss(uiSearch.actionsDisplay)"
            var2="layout='sub';
        ...
        <img if="not locked and guard.mayDelete(o)" class="clickable iconS"
             src=":svg('deleteS')" title=":_('object_delete')"
    ...
    def getStorableValue(self, o, value, single=False):
        ...
        # cross-links between them and p_obj.
        if self.isEmptyValue(o, value): return
        return value
