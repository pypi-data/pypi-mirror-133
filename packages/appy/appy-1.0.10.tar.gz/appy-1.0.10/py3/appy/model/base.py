...
class Base:
    ...
    # v_io refers to the source object ;
    ...
    pxTied = Px('''
     <tr var="io=initiator.o;
              ...
              *=ifield.initPx(io, req, _ctx_) if _ctx_.ajaxSingle else None;
              ...
              id=o.iid"
         id=":ohook" valign=":ifield.rowAlign" class=":rowCss">
      ...
      <script>:ifield.getAjaxDataRow(o, ohook, hook, rowCss=rowCss, \
    ...
    pxResult = Px('''
     <tr valign=":uiSearch.search.rowAlign" class=":rowCss"
         var="id=o.iid; ohook=mode.getHookFor(o); mayView=guard.mayView(o);
      ...
      <!-- Store data in this tr node allowing to ajax-refresh it -->
      <script>:mode.getAjaxDataRow(o, ohook, rowCss=rowCss, \
