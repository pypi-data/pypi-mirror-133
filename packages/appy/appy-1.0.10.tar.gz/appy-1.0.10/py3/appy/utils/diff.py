...
class HtmlDiff:
    ...
    # Default CSS styles to apply on a insertion or a deletion
    insertStyle = 'color:blue; cursor:help'
    deleteStyle = 'color:red; text-decoration:line-through; cursor:help'

    # Template tag that wraps a diff, be it a deletion or an insertion
    templateDiv = '<div style="%s" title="%s">%s</div>'
