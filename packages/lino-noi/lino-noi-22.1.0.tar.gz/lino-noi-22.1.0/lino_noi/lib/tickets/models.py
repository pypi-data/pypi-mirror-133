...
class Site(Site):
    ...
    def get_change_observers(self, ar=None):
        ...
        if False:
            # 20210928 The idea was to notify only triagers when a new site was
            # created for a team. We can throw this away, seems that this made
            # some sense a long time ago when we didn't yet have teams.
...
class Ticket(Ticket, Assignable, Summarized, ElasticSearchable):
