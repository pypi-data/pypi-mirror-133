...
class JavascriptAssignmentExpression(JavascriptExpression, ECMAAssignmentExpression, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class JavascriptAssignmentPattern(JavascriptAST, ECMAAssignmentPattern, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsAssignmentExpression(TypescriptTsExpression, TypescriptAssignmentExpression, ECMAAssignmentExpression, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsAssignmentPattern(TypescriptTsAST, TypescriptAssignmentPattern, ECMAAssignmentPattern, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsAugmentedAssignmentExpression(TypescriptTsExpression, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsIntersectionType(TypescriptTsAST, TypescriptIntersectionType, AST):
    pass
...
class TypescriptTsUnionType(TypescriptTsAST, TypescriptUnionType, AST):
    pass
...
class TypescriptTsxAssignmentExpression(TypescriptTsxExpression, TypescriptAssignmentExpression, ECMAAssignmentExpression, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsxAssignmentPattern(TypescriptTsxAST, TypescriptAssignmentPattern, ECMAAssignmentPattern, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsxAugmentedAssignmentExpression(TypescriptTsxExpression, AST):
        @cached_property
        def left(self) -> AST:
            return self.child_slot("LEFT")
...
class TypescriptTsxIntersectionType(TypescriptTsxAST, TypescriptIntersectionType, AST):
    pass
...
class TypescriptTsxUnionType(TypescriptTsxAST, TypescriptUnionType, AST):
    pass
