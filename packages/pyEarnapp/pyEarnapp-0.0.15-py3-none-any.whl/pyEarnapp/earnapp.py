...
class EarnApp:
    ...
    def get_earning_info(self, *args, **kwargs):
        response = requests.get(
    ...
    def get_devices_info(self, *args, **kwargs):
        response = requests.get(
    ...
    def get_referral_info(self, *args, **kwargs):
        response = requests.get(
    ...
    def redeem_to_paypal(self, paypal_email: str, *args, **kwargs):
