...
class ImageManager:
    ...
    def HELPER_runHaarDetectionCounterClockwiseAngle(self, detector, minDimensions, maxDimensions, angle, scaleFactor, minNeighbors):
        ...
        rotatedGrayImage = HelperFunctions.rotateCounterClockwise(self.grayImage, angle)
    ...
    def DEBUG_findFacesUsingPairOfEyes(self, pairOfEyes, scaleFactor, minNeighbors):
        ...
        for pair in pairOfEyes:
            ...
            rotatedGrayImage = HelperFunctions.rotateClockwise(self.grayImage, relativeCounterClockwiseAngle)
            ...
            debugOriginalImage = HelperFunctions.rotateClockwise(self.image, 0)
            ...
            debugRotatedOriginalImage = HelperFunctions.rotateClockwise(debugOriginalImage, relativeCounterClockwiseAngle)
            ...
            if len(detectedFaces) == 0:
                ...
                rotatedCrop = HelperFunctions.rotateClockwise(rotatedCrop, 180)
                detectedFaces = self.haarcascade_face.detectMultiScale(rotatedCrop, scaleFactor, minNeighbors, minSize = self.HARDCODED_faceMinDimensions, maxSize = self.HARDCODED_faceMaxDimensions)
                if len(detectedFaces) == 0:
                    continue
                boolUpSideDown = True
            ...
            cv.imshow("Potential face " + str(debugPotentialFaceNumber), HelperFunctions.resizeMinTo(debugRotatedCrop, 250))
