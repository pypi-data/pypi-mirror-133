...
class VideoManager:
    ...
    def displayNonInterferedMethod(self):
        ...
        while True:
            ...
            start = time.time()
            frame = HelperFunctions.resizeMinTo500(frame)
    ...
    def displayEvenMoreOptimizedMethod(self):
        ...
        while bool_DisplayingVideo:
            ...
            if time.time() >= next_frame:
                ...
                startTime = time.time()
                # resizing the frame to fit my tiny monitor, and to increase haarcascade detection performance too ye
                min500frame = HelperFunctions.resizeMinTo500(frame)
                ...
                if not faceDetectionThread.is_alive():
                    ...
                    if len(currentDetectedFacesManager) != 0:
                        ...
                        while bool_loop:
                            ...
                            rotatedFrame = HelperFunctions.rotateClockwise(
                            ...
                            detectedFaces = HelperFunctions.haarcascade_FacialDetection(
                            ...
                            # find the eyes
                            tempEyesArray = HelperFunctions.haarcascade_EyeDetection(
