...
setup(
    ...
    py_modules=['colemen_file_utils', 'utils.dir', 'utils.file_read', 'utils.file_search', "utils.file_write", "utils.file", "utils.objectUtils", "utils.resources", "utils.file_convert"],
