...
class SsConverter:
    def __init__(self):
        self._supported_rudolph_seasons = [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021]
        ...
        self._supported_fina_seasons = {'SCM': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021],
                                        'LCM': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021]
                                        }
        self._fina_season_base = {'SCM': 2021,      # Validity Period: 1.9.YYYY-31.8.YYYY+1
                                  'LCM': 2021}      # Validity Period: 1.1.XXXX-31.12.XXXX
    ...
    def get_finapts_from_seconds(self, course, gender, style, seconds, season_base=None):
        ...
        if not basetime:
            raise ValueError('BaseTime could not be found with arguments "%s, %s, %s, %s, %s"' % (season_base, course, gender, distance, stroke))
...
if __name__ == '__main__':
    ...
    print(ssconv.get_rudolphpts_from_seconds('F', '200m Backstroke', 9, [203.87], 2009))
