...
Welcome to ``scraping-common-bot`` contributor's guide.
...
If you experience bugs or general issues with ``scraping-common-bot``, please have a look
...
You can help improve ``scraping-common-bot`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``scraping-common-bot`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``scraping-common-bot``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n scraping-common-bot python=3 six virtualenv pytest pytest-cov
    conda activate scraping-common-bot
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/scraping-common-bot.git
    cd scraping-common-bot
...
#. Install |pre-commit|_::
   ...
   ``scraping-common-bot`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/scraping-common-bot
.. _issue tracker: https://github.com/<USERNAME>/scraping-common-bot/issues
.. <-- end -->
