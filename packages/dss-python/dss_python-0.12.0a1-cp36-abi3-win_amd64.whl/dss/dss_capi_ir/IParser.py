...
class IParser(Base):
    ...
    def Matrix(self, ExpectedOrder):
        ...
        return self.CheckForError(self._get_float64_array(self._lib.Parser_Get_Matrix, ExpectedOrder))
    ...
    def SymMatrix(self, ExpectedOrder):
        ...
        return self.CheckForError(self._get_float64_array(self._lib.Parser_Get_SymMatrix, ExpectedOrder))

    def Vector(self, ExpectedSize):
        '''(read-only) Returns token as array of doubles. For parsing quoted array syntax.'''
        return self.CheckForError(self._get_float64_array(self._lib.Parser_Get_Vector, ExpectedSize))
