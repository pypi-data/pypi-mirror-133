...
class Binomial(Distribution):
    ...
    #TODO: Calculate the probability mass function of the binomial distribution
    def pmf(self,k):
    ...
    #TODO: write a method to plot the probability mass function of the binomial distribution
    # Use a bar chart to plot the probability mass function from
        # k = 0 to k = n
        
        #   Hint: You'll need to use the pmf() method defined above to calculate the
        #   mass function for every value of k.
    ...
    def plot_bar_pmf(self):
        ...
        """
        y = [self.pmf(val) for val in range(0,self.n)]
        x = [i for i in range(0,self.n)]
        plt.bar(x,y)
        plt.xlabel('Data', fontsize = 12)
        plt.ylabel('Probability', fontsize = 12)
        plt.title('pmf of the data', fontsize = 16)
        plt.show();
    ...
    # write a method to output the sum of two binomial distributions. 
    # Assume both distributions have the same p value.
...
# b = Binomial()
# b2 = Binomial()
# b.replace_stats_with_data('numbers_binomial.txt')
# b2.replace_stats_with_data('numbers_binomial.txt')
