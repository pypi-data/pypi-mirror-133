...
class company_modelset:
    ...
    def __getincdata(self,dimension):
        res = getcompanydata(stockcode=self._mparams['stockcode'], reportdate=self._mparams['reportdate'], dimension=dimension, adjdate=self._mparams['adjdate'])
        if type(res) == dict:
            data=pd.Series(res)
...
class strict_latest_status_modelset(company_modelset):
    ...
    def __init__(self, stockcode,structure,reportdate, minstep, significance, seasonal=False, anneal=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().__init__(mparams)

    def resetparams(self, stockcode,structure,reportdate, minstep, significance, seasonal=False, anneal=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
...
class long_range_status_modelset(company_modelset):
    ...
    def __init__(self, stockcode,structure,reportdate, significance, seasonal=False, anneal=None, samplerange=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().__init__(mparams)

    def resetparams(self,stockcode,structure,reportdate, significance, seasonal=False, anneal=None, samplerange=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().resetparams(mparams)
...
class strict_latest_long_range_modelset(company_modelset):
    ...
    def __init__(self,stockcode,structure,reportdate, minstep, significance, inertia, seasonal=False, anneal=None, samplerange=None, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().__init__(mparams)

    def resetparams(self,stockcode,structure,reportdate, minstep, significance, inertia, seasonal=False, anneal=None, samplerange=None, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().resetparams(mparams)
...
class series_shape_modelset(company_modelset):
    ...
    def __init__(self,stockcode,structure,reportdate, significance, seasonal=False, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().__init__(mparams)

    def resetparams(self,stockcode,structure,reportdate, significance, seasonal=False, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().resetparams(mparams)
...
class ma_strict_latest_status_modelset(company_modelset):
    ...
    def __init__(self,stockcode,structure,reportdate, mawindow, minstep, seasonal=False, anneal=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().__init__(mparams)

    def resetparams(self,stockcode,structure,reportdate, mawindow, minstep, seasonal=False, anneal=None, conservative=False, adjdate=None):
        mparams = locals()
        del mparams['self']
        del mparams['__class__']
        super().resetparams(mparams)
