...
def inherit_site_packages():  # noqa  # isort: skip
    """This is used to inherit the pyemr dependencies when running inside virtual enviroments."""
...
inherit_site_packages()  # noqa  # isort: skip
