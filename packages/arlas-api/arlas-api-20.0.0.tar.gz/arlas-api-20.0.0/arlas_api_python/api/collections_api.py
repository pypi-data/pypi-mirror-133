...
class CollectionsApi(object):
    ...
    def put_with_http_info(self, collection, collection_params, **kwargs):  # noqa: E501
        ...
        all_params = ['collection', 'collection_params', 'pretty', 'check_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'pretty' in params:
            query_params.append(('pretty', params['pretty']))  # noqa: E501
        if 'check_fields' in params:
            query_params.append(('checkFields', params['check_fields']))  # noqa: E501
