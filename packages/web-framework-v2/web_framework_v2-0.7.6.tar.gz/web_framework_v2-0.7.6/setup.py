...
setup(
  ...
  version = '0.7.6',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Heknon/web_framework_v2/archive/refs/tags/V1.2.5.tar.gz',    # I explain this later on
