...
def normalise(result :validator.Validator, certificate_type :str) -> dict:
...
def to_dict(results :list[validator.Validator], evaluation_duration_seconds :int) -> dict:
    data = {
