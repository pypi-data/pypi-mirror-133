...
def twMovingSegIntersectPolyXY(
    segXY:  "Line segment that is moving - no rotation" = None,
    polyXY: "Polygon that is moving - no rotation" = None,
    vecXYSeg: "Moving speed vector of the line segment" = None,
    vecXYPoly: "Moving speed vector of the line segment" = None
    ) -> "":
