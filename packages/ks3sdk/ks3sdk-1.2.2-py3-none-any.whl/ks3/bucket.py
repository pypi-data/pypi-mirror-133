...
from ks3.bucketCrossReplicate import BucketCrossReplicate
from ks3.bucketLifecycle import BucketLifecycle
...
from ks3.bucketQuota import BucketQuota
from ks3.bucketVersioning import BucketVersioningConfig
...
class Bucket(object):
    ...
    def listObjects(self, prefix=None, delimiter=None, marker=None, startTime=None, endTime=None,
                    filename=None):

        keys = self.list(prefix, delimiter, marker)
        keyLists = list()
        fd = None
    ...
    def set_bucket_logging(self, logging_str, headers=None):
        """
    ...
    def get_bucket_logging(self, headers=None):
        ...
        :rtype: :class:`ks3.bucketlogging.BucketLogging`
