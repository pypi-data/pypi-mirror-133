...
go to `https://readthedocs.org/dashboard/aedev/advanced`__ (Admin) to configure the following settings:

    * Settings/Programming Language: **Python**
    * Advanced Settings/Global settings/Default branch: **develop**
    * Advanced Settings/Default settings/Requirements file: **docs/requirements.txt**
    * Advanced Settings/Default settings/Install Project: **check**ec
...
# -- path setup -------------------------------------------------------------------------------------------------------
#
# this file is stored in the docs folder directly under the project root folder. if extensions (or modules to
...
# sphinx_autodoc_typehints gets automatically used by adding it to tests/requirements.txt
extensions = [
...
if html_theme == 'alabaster':
    ...
    html_theme_options = dict(
        ...
        # gitlab_url=f"https://gitlab.com/aedev-group/aedev/docs/index.rst",
        navigation_depth=-1,
