...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, connect_timeout=None, max_retries=None, pulp_labels=None, pulp_href=None, ca_cert=None, proxy_url=None, total_timeout=None, client_cert=None, headers=None, sock_connect_timeout=None, download_concurrency=None, pulp_created=None, name=None, url=None, pulp_last_updated=None, sock_read_timeout=None, rate_limit=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
