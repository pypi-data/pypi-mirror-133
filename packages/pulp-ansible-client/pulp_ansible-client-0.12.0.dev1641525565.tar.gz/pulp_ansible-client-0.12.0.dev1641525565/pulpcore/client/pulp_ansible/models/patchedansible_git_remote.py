...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, connect_timeout=None, proxy_password=None, username=None, max_retries=None, pulp_labels=None, ca_cert=None, proxy_url=None, total_timeout=None, client_key=None, client_cert=None, proxy_username=None, headers=None, sock_connect_timeout=None, download_concurrency=None, name=None, url=None, password=None, sock_read_timeout=None, rate_limit=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
