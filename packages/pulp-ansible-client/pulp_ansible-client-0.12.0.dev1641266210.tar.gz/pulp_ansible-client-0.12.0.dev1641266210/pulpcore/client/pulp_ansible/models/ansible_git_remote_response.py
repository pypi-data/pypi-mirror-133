...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, download_concurrency=None, client_cert=None, sock_connect_timeout=None, pulp_created=None, ca_cert=None, pulp_labels=None, url=None, pulp_href=None, sock_read_timeout=None, name=None, tls_validation=None, max_retries=None, connect_timeout=None, total_timeout=None, headers=None, rate_limit=None, proxy_url=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
