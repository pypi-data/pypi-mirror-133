...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, client_cert=None, sock_connect_timeout=None, ca_cert=None, proxy_password=None, username=None, pulp_labels=None, url=None, client_key=None, proxy_username=None, sock_read_timeout=None, name=None, tls_validation=None, max_retries=None, password=None, connect_timeout=None, total_timeout=None, headers=None, rate_limit=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
