...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, client_key=None, rate_limit=None, ca_cert=None, connect_timeout=None, url=None, password=None, pulp_labels=None, sock_connect_timeout=None, download_concurrency=None, client_cert=None, headers=None, name=None, username=None, sock_read_timeout=None, proxy_url=None, proxy_username=None, max_retries=None, tls_validation=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
