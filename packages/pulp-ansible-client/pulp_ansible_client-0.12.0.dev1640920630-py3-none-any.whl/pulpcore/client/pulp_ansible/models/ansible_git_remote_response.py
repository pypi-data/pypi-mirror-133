...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, client_cert=None, max_retries=None, ca_cert=None, url=None, pulp_href=None, pulp_labels=None, sock_connect_timeout=None, rate_limit=None, headers=None, pulp_last_updated=None, sock_read_timeout=None, tls_validation=None, download_concurrency=None, connect_timeout=None, total_timeout=None, proxy_url=None, pulp_created=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
