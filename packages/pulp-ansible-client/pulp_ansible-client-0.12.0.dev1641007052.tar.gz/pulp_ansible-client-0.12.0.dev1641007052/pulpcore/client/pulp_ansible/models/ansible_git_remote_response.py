...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, rate_limit=None, ca_cert=None, connect_timeout=None, url=None, pulp_labels=None, pulp_created=None, sock_connect_timeout=None, download_concurrency=None, client_cert=None, pulp_last_updated=None, headers=None, name=None, pulp_href=None, sock_read_timeout=None, proxy_url=None, max_retries=None, tls_validation=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
