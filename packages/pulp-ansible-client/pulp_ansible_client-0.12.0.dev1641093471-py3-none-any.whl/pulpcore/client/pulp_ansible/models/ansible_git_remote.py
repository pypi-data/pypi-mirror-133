...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_cert=None, download_concurrency=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_url=None, proxy_username=None, name=None, connect_timeout=None, tls_validation=None, headers=None, username=None, pulp_labels=None, total_timeout=None, proxy_password=None, client_key=None, ca_cert=None, password=None, max_retries=None, url=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
