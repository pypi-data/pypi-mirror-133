...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, password=None, client_cert=None, proxy_username=None, client_key=None, url=None, headers=None, name=None, connect_timeout=None, rate_limit=None, total_timeout=None, proxy_password=None, username=None, ca_cert=None, max_retries=None, sock_connect_timeout=None, pulp_labels=None, proxy_url=None, download_concurrency=None, sock_read_timeout=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
