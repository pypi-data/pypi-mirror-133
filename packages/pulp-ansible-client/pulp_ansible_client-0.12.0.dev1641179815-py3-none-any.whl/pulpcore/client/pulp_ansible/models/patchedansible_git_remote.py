...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, total_timeout=None, client_key=None, url=None, tls_validation=None, max_retries=None, headers=None, download_concurrency=None, ca_cert=None, pulp_labels=None, proxy_password=None, name=None, password=None, proxy_url=None, sock_connect_timeout=None, client_cert=None, sock_read_timeout=None, rate_limit=None, username=None, proxy_username=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
