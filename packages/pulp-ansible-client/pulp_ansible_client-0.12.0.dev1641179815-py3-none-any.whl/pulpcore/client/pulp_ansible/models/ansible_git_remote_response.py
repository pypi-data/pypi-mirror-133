...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, total_timeout=None, pulp_created=None, url=None, tls_validation=None, max_retries=None, pulp_last_updated=None, headers=None, download_concurrency=None, ca_cert=None, pulp_labels=None, name=None, proxy_url=None, sock_connect_timeout=None, client_cert=None, pulp_href=None, sock_read_timeout=None, rate_limit=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
