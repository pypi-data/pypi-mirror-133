...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, url=None, headers=None, name=None, connect_timeout=None, rate_limit=None, pulp_created=None, pulp_href=None, total_timeout=None, ca_cert=None, max_retries=None, sock_connect_timeout=None, pulp_labels=None, pulp_last_updated=None, proxy_url=None, download_concurrency=None, sock_read_timeout=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
