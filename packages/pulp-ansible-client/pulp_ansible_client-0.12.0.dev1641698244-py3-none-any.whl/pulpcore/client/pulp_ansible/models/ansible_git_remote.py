...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, proxy_username=None, proxy_url=None, pulp_labels=None, max_retries=None, rate_limit=None, sock_read_timeout=None, connect_timeout=None, total_timeout=None, username=None, client_cert=None, tls_validation=None, url=None, name=None, download_concurrency=None, sock_connect_timeout=None, password=None, headers=None, ca_cert=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
