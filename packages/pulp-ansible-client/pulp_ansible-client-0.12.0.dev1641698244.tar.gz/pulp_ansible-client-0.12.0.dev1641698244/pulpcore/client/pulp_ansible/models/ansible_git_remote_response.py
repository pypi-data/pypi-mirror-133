...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, proxy_url=None, pulp_labels=None, max_retries=None, rate_limit=None, sock_read_timeout=None, connect_timeout=None, total_timeout=None, client_cert=None, tls_validation=None, url=None, name=None, download_concurrency=None, sock_connect_timeout=None, pulp_last_updated=None, headers=None, ca_cert=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
