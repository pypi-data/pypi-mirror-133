...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, client_cert=None, download_concurrency=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_url=None, pulp_created=None, name=None, connect_timeout=None, tls_validation=None, pulp_last_updated=None, headers=None, pulp_labels=None, total_timeout=None, ca_cert=None, max_retries=None, url=None, pulp_href=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
