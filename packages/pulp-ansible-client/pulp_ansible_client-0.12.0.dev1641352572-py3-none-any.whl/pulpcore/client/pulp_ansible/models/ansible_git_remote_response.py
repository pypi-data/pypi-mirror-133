...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_last_updated=None, headers=None, pulp_href=None, ca_cert=None, pulp_created=None, total_timeout=None, sock_read_timeout=None, download_concurrency=None, connect_timeout=None, max_retries=None, sock_connect_timeout=None, client_cert=None, url=None, proxy_url=None, pulp_labels=None, tls_validation=None, rate_limit=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
