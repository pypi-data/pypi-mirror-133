...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_last_updated=None, pulp_created=None, download_concurrency=None, sock_connect_timeout=None, max_retries=None, ca_cert=None, headers=None, connect_timeout=None, pulp_labels=None, proxy_url=None, rate_limit=None, client_cert=None, pulp_href=None, url=None, tls_validation=None, total_timeout=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
