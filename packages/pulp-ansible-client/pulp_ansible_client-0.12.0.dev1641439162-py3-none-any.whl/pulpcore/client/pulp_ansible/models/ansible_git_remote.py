...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, download_concurrency=None, sock_connect_timeout=None, client_key=None, max_retries=None, ca_cert=None, headers=None, connect_timeout=None, pulp_labels=None, username=None, proxy_url=None, rate_limit=None, client_cert=None, password=None, proxy_username=None, url=None, tls_validation=None, proxy_password=None, total_timeout=None, sock_read_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
