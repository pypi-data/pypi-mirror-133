...
class Observation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, start, end, ground_station, transmitter, norad_cat_id, payload, waterfall, station_name, station_lat, station_lng, station_alt, vetted_status, vetted_user, vetted_datetime, archived, archive_url, status, waterfall_status, waterfall_status_user, waterfall_status_datetime, rise_azimuth, set_azimuth, max_altitude, transmitter_uuid, transmitter_description, transmitter_type, transmitter_uplink_low, transmitter_uplink_high, transmitter_uplink_drift, transmitter_downlink_low, transmitter_downlink_high, transmitter_downlink_drift, transmitter_mode, transmitter_invert, transmitter_baud, transmitter_updated, tle0, tle1, tle2, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            waterfall_status_user (int):
            waterfall_status_datetime (datetime):
            rise_azimuth (float):
            set_azimuth (float):
            max_altitude (float):
            ...
            transmitter_uplink_low (int):
            transmitter_uplink_high (int):
            transmitter_uplink_drift (int):
            transmitter_downlink_low (int):
            transmitter_downlink_high (int):
            transmitter_downlink_drift (int):
            transmitter_mode (str):
            transmitter_invert (bool):
            transmitter_baud (float):
