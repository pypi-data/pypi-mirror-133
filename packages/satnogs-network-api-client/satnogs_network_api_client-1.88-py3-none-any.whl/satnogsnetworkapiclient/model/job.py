...
class Job(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, start, end, tle0, tle1, tle2, frequency, mode, transmitter, baud, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, start, end, *args, **kwargs):  # noqa: E501
        """Job - a model defined in OpenAPI
