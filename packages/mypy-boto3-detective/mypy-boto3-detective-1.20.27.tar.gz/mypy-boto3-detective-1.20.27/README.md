...
[boto3.Detective 1.20.27](https://boto3.amazonaws.com/v1/documentation/api/1.20.27/reference/services/detective.html#Detective)
...
def check_value(value: InvitationTypeType) -> bool:
    ...
```
