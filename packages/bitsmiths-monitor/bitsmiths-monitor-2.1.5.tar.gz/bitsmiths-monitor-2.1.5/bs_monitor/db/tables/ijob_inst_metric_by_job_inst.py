...
class iJobInstMetricByJobInst(mettle.io.ISerializable):
    ...
    def _name(self) -> str:
        ...
        :return: The name.
        """
        return 'iJobInstMetricByJobInst'
    ...
    def _copy_from(self, rec: "iJobInstMetricByJobInst"):
        """
    ...
    def _cache_davs(dvc=None):
        ...
        dvc.add_targ("jobinstId", mettle.lib.Dav(mettle.lib.Dav.eDavType.NotNull))
        dvc.add_targ("limoff", mettle.lib.Dav(mettle.lib.Dav.eDavType.NotNull))

        return dvc

    def _get_davs(self, dvc=None):
        iJobInstMetricByJobInst._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<JobInstMetric [jobinst_id:%r, limoff:%.32s]>' % (
            self.jobinst_id, self.limoff)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iJobInstMetricByJobInst.List'
        ...
        def __repr__(self) -> str:
            return '<iJobInstMetricByJobInst.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iJobInstMetricByJobInst._cache_davs(dvc)
