...
class iBatchWithLatestInst(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iBatchWithLatestInst"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchWithLatestInst._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Batch [criteria:%.32s, limoff:%.32s]>' % (
            self.criteria, self.limoff)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iBatchWithLatestInst.List'
        ...
        def __repr__(self) -> str:
            return '<iBatchWithLatestInst.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchWithLatestInst._cache_davs(dvc)
