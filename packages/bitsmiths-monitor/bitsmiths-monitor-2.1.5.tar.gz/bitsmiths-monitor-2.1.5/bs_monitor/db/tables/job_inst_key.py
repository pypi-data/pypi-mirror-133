...
class tJobInstKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tJobInstKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tJobInstKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tJobInstKey._cache_davs(dvc)
