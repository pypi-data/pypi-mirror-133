...
class tBatchItemKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tBatchItemKey"):
        """
    ...
    def __repr__(self) -> str:
        return '<BatchItem [id:%r, batch_id:%r]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tBatchItemKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tBatchItemKey._cache_davs(dvc)
