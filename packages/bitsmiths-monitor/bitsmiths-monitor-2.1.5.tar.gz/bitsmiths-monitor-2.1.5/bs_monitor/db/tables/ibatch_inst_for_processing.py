...
class iBatchInstForProcessing(mettle.io.ISerializable):
    ...
    def _name(self) -> str:
        ...
        :return: The name.
        """
        return 'iBatchInstForProcessing'
    ...
    def _copy_from(self, rec: "iBatchInstForProcessing"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchInstForProcessing._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<BatchInst [sys_date:%s]>' % (
            self.sys_date)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iBatchInstForProcessing.List'
        ...
        def __repr__(self) -> str:
            return '<iBatchInstForProcessing.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchInstForProcessing._cache_davs(dvc)
