...
class tBatchKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tBatchKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tBatchKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tBatchKey._cache_davs(dvc)
