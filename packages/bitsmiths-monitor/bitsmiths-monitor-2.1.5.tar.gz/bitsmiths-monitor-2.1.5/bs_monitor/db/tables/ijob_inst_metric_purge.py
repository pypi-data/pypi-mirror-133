...
class iJobInstMetricPurge(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iJobInstMetricPurge"):
        """
    ...
    def _get_davs(self, dvc=None):
        iJobInstMetricPurge._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<JobInstMetric [value_date:%s]>' % (
            self.value_date)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iJobInstMetricPurge.List'
        ...
        def __repr__(self) -> str:
            return '<iJobInstMetricPurge.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iJobInstMetricPurge._cache_davs(dvc)
