...
class dJobInstSelectOne:
    ...
    async def exec(self, irec: tJobInstKey = None) -> "dJobInstSelectOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("JobInstSelectOne", self._dbcon.STMNT_TYPE_READ)
