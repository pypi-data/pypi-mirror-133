...
class dBatchUpdate:
    ...
    async def exec(self, irec: tBatch = None) -> "dBatchUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("BatchUpdate", self._dbcon.STMNT_TYPE_CUD)
