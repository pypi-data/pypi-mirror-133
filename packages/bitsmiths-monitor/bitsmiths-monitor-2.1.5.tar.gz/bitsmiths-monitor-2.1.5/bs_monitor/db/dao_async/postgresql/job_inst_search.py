...
class dJobInstSearch:
    ...
    async def exec(self, irec: iJobInstSearch = None) -> "dJobInstSearch":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("JobInstSearch", self._dbcon.STMNT_TYPE_READ)
...
[limoff]""")
    ...
    async def fetch_all(self, outList: oJobInstSearch.List, clearList: bool = True) -> int:
        """
