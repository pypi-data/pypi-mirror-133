...
class dJobInst:
    ...
    def lock_one_with(self, _rec: tJobInst, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tJobInstKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
        ...
        :return: True if selected, False if not found and _expected is set to False
        """
        with dJobInstLockOne(self._dbcon) as _qry:
            ...
            while _dex >= 0:
                try:
                    ...
                    if not _qry.fetch():
                        ...
                        raise mettle.lib.xMettle("LockOne failed to return a record (dJobInst)")
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tJobInst) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tJobInstKey) -> bool:
        """
        ...
        """
        with dJobInstSelectOne(self._dbcon) as _qry:
            _qry.exec(_key)
            if not _qry.fetch():
                return False
    ...
    def select_one_with(self, _rec: tJobInst) -> "dJobInst":
        """
    ...
    def select_one_by_key(self, _key: tJobInstKey) -> "dJobInst":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tJobInst = None):
        """
        ...
        with dJobInstUpdate(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def insert(self, irec: tJobInst = None):
        """
        ...
        with dJobInstInsert(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def delete_one(self, irec: tJobInstKey = None):
        """
        ...
        with dJobInstDeleteOne(self._dbcon) as _qry:
            _qry.exec(_key)
