...
class dBatchInst:
    ...
    def lock_one_with(self, _rec: tBatchInst, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    def lock_one_by_key(self, _key: tBatchInstKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
        ...
        :return: True if selected, False if not found and _expected is set to False
        """
        with dBatchInstLockOne(self._dbcon) as _qry:
            ...
            while _dex >= 0:
                try:
                    ...
                    if not _qry.fetch():
                        ...
                        raise mettle.lib.xMettle("LockOne failed to return a record (dBatchInst)")
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    def try_select_one_with(self, _rec: tBatchInst) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tBatchInstKey) -> bool:
        """
        ...
        """
        with dBatchInstSelectOne(self._dbcon) as _qry:
            _qry.exec(_key)
            if not _qry.fetch():
                return False
    ...
    def select_one(self) -> "dBatchInst":
        """
    ...
    def select_one_with(self, _rec: tBatchInst) -> "dBatchInst":
        """
    ...
    def select_one_by_key(self, _key: tBatchInstKey) -> "dBatchInst":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tBatchInst = None):
        """
        ...
        with dBatchInstUpdate(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def insert(self, irec: tBatchInst = None):
        """
        ...
        with dBatchInstInsert(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def delete_one(self, irec: tBatchInstKey = None):
        """
        ...
        with dBatchInstDeleteOne(self._dbcon) as _qry:
            _qry.exec(_key)
