...
from bs_monitor.db.tables.ibatch_search import iBatchSearch
...
class dBatchSearch:
    ...
    def exec(self, irec: iBatchSearch = None) -> "dBatchSearch":
        """
        ...
        self._dbstmnt = self._dbcon.statement("BatchSearch", self._dbcon.STMNT_TYPE_READ)
