...
class dBatchSelectOne:
    ...
    def exec(self, irec: tBatchKey = None) -> "dBatchSelectOne":
        """
        ...
        self._dbstmnt = self._dbcon.statement("BatchSelectOne", self._dbcon.STMNT_TYPE_READ)
