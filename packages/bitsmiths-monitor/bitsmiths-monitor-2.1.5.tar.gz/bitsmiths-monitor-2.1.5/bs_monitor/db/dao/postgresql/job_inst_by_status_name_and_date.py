...
class dJobInstByStatusNameAndDate:
    ...
    def exec(self, irec: iJobInstByStatusNameAndDate = None) -> "dJobInstByStatusNameAndDate":
        """
        ...
        self._dbstmnt = self._dbcon.statement("JobInstByStatusNameAndDate", self._dbcon.STMNT_TYPE_READ)
