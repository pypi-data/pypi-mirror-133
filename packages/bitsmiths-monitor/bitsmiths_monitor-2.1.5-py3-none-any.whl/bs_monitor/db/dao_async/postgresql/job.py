...
class dJob:
    ...
    async def try_select_one_with(self, _rec: tJob) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tJobKey) -> bool:
        """
    ...
    async def select_one(self) -> "dJob":
        """
    ...
    async def select_one_with(self, _rec: tJob) -> "dJob":
        """
    ...
    async def select_one_by_key(self, _key: tJobKey) -> "dJob":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tJob = None):
        """
    ...
    async def insert(self, irec: tJob = None):
        """
    ...
    async def delete_one(self, irec: tJobKey = None):
        """
