...
class dMondateUpdate:
    ...
    async def exec(self, irec: tMondate = None) -> "dMondateUpdate":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("MondateUpdate", self._dbcon.STMNT_TYPE_CUD)
