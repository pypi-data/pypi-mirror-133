...
class dMondate:
    ...
    async def try_select_one_with(self, _rec: tMondate) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tMondateKey) -> bool:
        """
    ...
    async def select_one(self) -> "dMondate":
        """
    ...
    async def select_one_with(self, _rec: tMondate) -> "dMondate":
        """
    ...
    async def select_one_by_key(self, _key: tMondateKey) -> "dMondate":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tMondate = None):
        """
    ...
    async def insert(self, irec: tMondate = None):
        """
    ...
    async def delete_one(self, irec: tMondateKey = None):
        """
