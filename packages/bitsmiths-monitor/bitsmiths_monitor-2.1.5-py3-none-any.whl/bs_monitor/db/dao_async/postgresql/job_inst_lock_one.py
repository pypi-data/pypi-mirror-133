...
class dJobInstLockOne:
    ...
    async def exec(self, irec: tJobInstKey = None) -> "dJobInstLockOne":
        """
        ...
        self._dbstmnt = await self._dbcon.statement("JobInstLockOne", self._dbcon.STMNT_TYPE_READ)
