...
class dBatch:
    ...
    async def lock_one_with(self, _rec: tBatch, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
    ...
    async def lock_one_by_key(self, _key: tBatchKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        """
...
_lock4update.retrys, _lock4update.mili_seconds), errCode = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_with(self, _rec: tBatch) -> bool:
        """
    ...
    async def try_select_one_by_key(self, _key: tBatchKey) -> bool:
        """
    ...
    async def select_one(self) -> "dBatch":
        """
    ...
    async def select_one_with(self, _rec: tBatch) -> "dBatch":
        """
    ...
    async def select_one_by_key(self, _key: tBatchKey) -> "dBatch":
        """
        Attempt to select the record with it's primary key.
    ...
    async def update(self, irec: tBatch = None):
        """
    ...
    async def insert(self, irec: tBatch = None):
        """
    ...
    async def delete_one(self, irec: tBatchKey = None):
        """
