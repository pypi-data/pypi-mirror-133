...
class dBatchItem:
    ...
    def try_select_one_with(self, _rec: tBatchItem) -> bool:
        """
    ...
    def try_select_one_by_key(self, _key: tBatchItemKey) -> bool:
        """
        ...
        """
        with dBatchItemSelectOne(self._dbcon) as _qry:
            _qry.exec(_key)
            if not _qry.fetch():
                return False
    ...
    def select_one(self) -> "dBatchItem":
        """
    ...
    def select_one_with(self, _rec: tBatchItem) -> "dBatchItem":
        """
    ...
    def select_one_by_key(self, _key: tBatchItemKey) -> "dBatchItem":
        """
        Attempt to select the record with it's primary key.
    ...
    def update(self, irec: tBatchItem = None):
        """
        ...
        with dBatchItemUpdate(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def insert(self, irec: tBatchItem = None):
        """
        ...
        with dBatchItemInsert(self._dbcon) as _qry:
            _qry.exec(self.rec)
    ...
    def delete_one(self, irec: tBatchItemKey = None):
        """
        ...
        with dBatchItemDeleteOne(self._dbcon) as _qry:
            _qry.exec(_key)
