...
class dBatchInsert:
    ...
    def exec(self, irec: tBatch = None) -> "dBatchInsert":
        """
        ...
        self._dbstmnt = self._dbcon.statement("BatchInsert", self._dbcon.STMNT_TYPE_CUD)
  ...
  :stamp_tm
        ...
        self.irec.id = self._dbcon.post_get_sequence(self._dbstmnt, "monitor.Batch", "id", 8)
