...
from bs_monitor.db.tables.ibatch_by_parent import iBatchByParent
from bs_monitor.db.tables.batch import tBatch

class dBatchByParent:
    ...
    def exec(self, irec: iBatchByParent = None) -> "dBatchByParent":
        """
        ...
        self._dbstmnt = self._dbcon.statement("BatchByParent", self._dbcon.STMNT_TYPE_READ)
...
where
  ...
  b.status    = 'A'""")
        ...
        self._dbstmnt.bind_in("parentId", self.irec.parent_id, int, 8)
