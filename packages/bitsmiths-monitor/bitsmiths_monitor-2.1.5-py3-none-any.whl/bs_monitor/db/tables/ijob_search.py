...
class iJobSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iJobSearch"):
        """
    ...
    def _get_davs(self, dvc=None):
        iJobSearch._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Job [criteria:%.32s, limoff:%.32s]>' % (
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iJobSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iJobSearch._cache_davs(dvc)
