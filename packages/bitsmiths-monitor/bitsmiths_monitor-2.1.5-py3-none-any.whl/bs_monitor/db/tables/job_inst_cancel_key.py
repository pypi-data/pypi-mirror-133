...
class tJobInstCancelKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tJobInstCancelKey"):
        """
    ...
    def _get_davs(self, dvc=None):
        tJobInstCancelKey._cache_davs(dvc)
    ...
    def __repr__(self) -> str:
        return '<JobInstCancel [jobinst_id:%r]>' % (
            self.jobinst_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tJobInstCancelKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tJobInstCancelKey._cache_davs(dvc)
