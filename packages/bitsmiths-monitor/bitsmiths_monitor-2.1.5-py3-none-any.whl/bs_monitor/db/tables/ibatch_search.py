...
class iBatchSearch(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iBatchSearch"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iBatchSearch.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchSearch._cache_davs(dvc)
