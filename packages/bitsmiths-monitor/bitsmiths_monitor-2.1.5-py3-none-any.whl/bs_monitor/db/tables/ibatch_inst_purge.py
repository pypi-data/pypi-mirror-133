...
class iBatchInstPurge(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iBatchInstPurge"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchInstPurge._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<BatchInst [value_date:%s]>' % (
            self.value_date)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iBatchInstPurge.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchInstPurge._cache_davs(dvc)
