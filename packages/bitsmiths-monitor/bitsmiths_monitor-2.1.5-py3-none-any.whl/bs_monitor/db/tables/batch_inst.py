...
class tBatchInst(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def __repr__(self) -> str:
        return '<BatchInst [id:%r, parent_id:%r, batch_id:%r, status:%.32s, run_date:%s, start_date:%s, end_date:%s]>' % (
            self.id, self.parent_id, self.batch_id, self.status, self.run_date, self.start_date, self.end_date)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tBatchInst.List[%d]>' % (len(self))
