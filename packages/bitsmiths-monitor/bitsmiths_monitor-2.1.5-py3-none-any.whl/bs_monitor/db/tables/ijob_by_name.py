...
class iJobByName(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iJobByName"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iJobByName.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iJobByName._cache_davs(dvc)
