...
class tMondate(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def __repr__(self) -> str:
        return '<Mondate [id:%.32s, descr:%.32s, value:%s, stamp_by:%.32s, stamp_tm:%s]>' % (
            self.id, self.descr, self.value, self.stamp_by, self.stamp_tm)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tMondate.List[%d]>' % (len(self))
