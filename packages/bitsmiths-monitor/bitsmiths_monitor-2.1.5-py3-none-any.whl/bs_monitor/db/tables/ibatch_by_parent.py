...
class iBatchByParent(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iBatchByParent"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchByParent._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Batch [parent_id:%r]>' % (
            self.parent_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<iBatchByParent.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchByParent._cache_davs(dvc)
