...
class tBatchItem(mettle.io.ISerializable, mettle.db.IPrimaryKey):
    ...
    def __repr__(self) -> str:
        return '<BatchItem [id:%r, batch_id:%r, job_id:%r, extra_args:%.32s, stamp_by:%.32s, stamp_tm:%s]>' % (
            self.id, self.batch_id, self.job_id, self.extra_args, self.stamp_by, self.stamp_tm)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tBatchItem.List[%d]>' % (len(self))
