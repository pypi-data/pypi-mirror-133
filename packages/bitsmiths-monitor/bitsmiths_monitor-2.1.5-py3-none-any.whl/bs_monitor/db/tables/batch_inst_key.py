...
class tBatchInstKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tBatchInstKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tBatchInstKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tBatchInstKey._cache_davs(dvc)
