...
class iBatchItemDeleteByBatchId(mettle.io.ISerializable):
    ...
    def _name(self) -> str:
        ...
        :return: The name.
        """
        return 'iBatchItemDeleteByBatchId'
    ...
    def _copy_from(self, rec: "iBatchItemDeleteByBatchId"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchItemDeleteByBatchId._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<BatchItem [batch_id:%r]>' % (
            self.batch_id)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iBatchItemDeleteByBatchId.List'
        ...
        def _deserialize(self, _r: mettle.io.IReader, _oname: str = None):
            ...
            while _cnt >= 1:
                _rec  = iBatchItemDeleteByBatchId()
                _cnt -= 1
        ...
        def __repr__(self) -> str:
            return '<iBatchItemDeleteByBatchId.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchItemDeleteByBatchId._cache_davs(dvc)
