...
class tJobKey(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "tJobKey"):
        """
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def __repr__(self) -> str:
            return '<tJobKey.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return tJobKey._cache_davs(dvc)
