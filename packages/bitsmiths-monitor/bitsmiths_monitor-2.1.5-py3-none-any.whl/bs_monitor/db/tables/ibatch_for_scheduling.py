...
class iBatchForScheduling(mettle.io.ISerializable):
    ...
    def _copy_from(self, rec: "iBatchForScheduling"):
        """
    ...
    def _get_davs(self, dvc=None):
        iBatchForScheduling._cache_davs(dvc)

    def __repr__(self) -> str:
        return '<Batch [sys_date:%s]>' % (
            self.sys_date)
    ...
    class List(list, mettle.io.ISerializable):
        ...
        def _name(self) -> str:
            ...
            :return: The name
            """
            return 'iBatchForScheduling.List'
        ...
        def __repr__(self) -> str:
            return '<iBatchForScheduling.List[%d]>' % (len(self))

        def _get_davs(self, dvc=None):
            return iBatchForScheduling._cache_davs(dvc)
