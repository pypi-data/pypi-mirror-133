...
def do_setup():
    ...
    setup(
        ...
        packages=find_namespace_packages(
            include=['airflow.providers.facebook', 'airflow.providers.facebook.*']
        ),
        zip_safe=False,
        include_package_data=True,
        install_requires=['apache-airflow>=2.1.0rc1', 'facebook-business>=6.0.2'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-facebook/2.2.0/',
