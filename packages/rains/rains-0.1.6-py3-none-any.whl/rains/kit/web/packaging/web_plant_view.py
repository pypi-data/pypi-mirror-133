...
class WebPlantView(object):
    ...
    * 提供针对浏览器本身的操作函数。
    ...
    def __init__(self, web_engine: WebEngine):
        """
        [ 初始化 ]
        * 无
    ...
    * 无
    ...
    def open(self, url: str = '', log: bool = True):
        ...
        * 无
        ...
        try:
            ...
            # 将当前句柄跳转至新标签页
            self._web_engine.driver.switch_to(self._web_engine.driver.window_handles[-1])
    ...
    def switch(self, number: int, log: bool = True):
        ...
        * 无
        ...
        try:
            self._web_engine.driver.switch_to(self._web_engine.driver.window_handles[number])
