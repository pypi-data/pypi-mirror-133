...
class _QualityTable:
    ...
    def quality_store_health_status(self, values: List[str]):
        ...
        """
        self.write(file_obj=json.dumps(values).encode(), tags=Tag.quality("HEALTH_STATUS"))
...
class QualityMixin(_Quality2dPlot, _QualityTable):
    ...
    def quality_store_ao_status(self, values: List[int]):
        """
        ...
        """
        self.write(file_obj=json.dumps(values).encode(), tags=Tag.quality("AO_STATUS"))
