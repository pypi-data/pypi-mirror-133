...
"""
    ...
    The version of the OpenAPI document: 0.0.1630
...
class PoliciesApi(object):
    ...
    def create_policy_with_http_info(self, policy_creation_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.0.1630'
    ...
    def page_policies_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sort_by' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sort_by']) > 2147483647):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sort_by` when calling `page_policies`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('sort_by' in local_var_params and  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `filter` when calling `page_policies`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
    ...
    def page_policy_collections_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('sort_by' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sort_by']) > 2147483647):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sort_by` when calling `page_policy_collections`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('sort_by' in local_var_params and  # noqa: E501
                                                        len(local_var_params['sort_by']) < 1):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) > 2147483647):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `page_policy_collections`, length must be less than or equal to `2147483647`")  # noqa: E501
        if self.api_client.client_side_validation and ('filter' in local_var_params and  # noqa: E501
                                                        len(local_var_params['filter']) < 0):  # noqa: E501
