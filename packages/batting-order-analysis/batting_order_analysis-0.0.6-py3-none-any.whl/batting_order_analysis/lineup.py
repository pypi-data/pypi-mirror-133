...
class Lineup:
    ...
    def set_players(self, lineup_filename: str) -> None:
        ...
        player_names = []
        with pkg_resources.resource_stream(__name__, 'data/'+lineup_filename, 'r') as f_players:
#        with open(lineup_filename, 'r') as f_players:
        ...
        with pkg_resources.resource_stream(__name__, 'data/'+Lineup.stats_filename, 'r') as stats_csv:
...
#        with open(Lineup.stats_filename, 'r', encoding='utf-8-sig') as stats_csv:
    ...
    def set_pa_outcomes(self, outcome_filename: Optional[str], sims_per_order: int) -> None:
        ...
        if outcome_filename is None:
            ...
            with pkg_resources.resource_stream(__name__, 'data/'+outcome_filename, 'r') as stats_csv:
