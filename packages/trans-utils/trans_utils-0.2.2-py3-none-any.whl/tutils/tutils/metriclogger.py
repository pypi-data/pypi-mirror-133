...
https://github.com/facebookresearch/detr/blob/master/util/misc.py
    ...
    Ps: to trans, copy-paste from dino.git
"""
...
class MetricLogger(object):
    def __init__(self, delimiter=" ", logger=None, smooth=1, no_print=False):
        self.logger = logger
    ...
    def __call__(self, *args, **kwargs):
        return self.log_every(*args, **kwargs)
    ...
    def log_every(self, iterable, print_freq=500, header=None):
        i = 0
        if not header:
            header = ''
        ...
        for obj in iterable:
            ...
            if not self.no_print:
                if print_freq < len(iterable) and (i % print_freq == 0 or i == len(iterable) - 1):
