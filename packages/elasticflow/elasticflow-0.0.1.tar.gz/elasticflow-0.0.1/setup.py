...
with open(os.path.join(here, 'elasticflow', '__version__.py')) as f:
    exec(f.read(), about)
...
class PyTestCommand(distutils.cmd.Command):
    ...
    def run(self):
        """Run command."""
        command = [
            'pytest --full-trace --verbose --color=yes --disable-pytest-warnings --no-summary --pyargs elasticflow.tests']
