...
class SequenceStatistics():
    ...
    def __init__(self, sequence, power_events):
        ...
        self._powers = {}
        self._energy = None
        if "inference_start" in sequence.metrics.names:
            inf_start = sequence.metrics["inference_start"]
            inf_end = sequence.metrics["inference_end"]
            frames = sequence.metrics["inference_frames"]
