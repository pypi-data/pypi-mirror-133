...
from hbshare.quant.Kevin.convertible_bond.CBMarketIV import CBMarketIV
...
if __name__ == '__main__':
    update_daily(start_date='2021-12-28', end_date='2021-12-28')
    # update_monthly('2021-11-10', '2021-11-30')
    # update_weekly(start_date='2021-09-01', end_date='2021-11-30')
