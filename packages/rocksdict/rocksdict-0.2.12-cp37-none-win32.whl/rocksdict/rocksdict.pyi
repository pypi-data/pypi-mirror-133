...
class Rdict:
    def __init__(self, path: str,
                 ...
                 access_type: AccessType = AccessType.read_write()) -> Rdict: ...
    def close(self) -> None: ...
    @staticmethod
    ...
    def items(self, backwards: bool = False,
              ...
              read_opt: ReadOptions = ReadOptions()) -> RdictItems: ...
    def keys(self, backwards: bool = False,
             from_key: Union[str, int, float, bytes, bool, None] = None,
             read_opt: ReadOptions = ReadOptions()) -> RdictKeys: ...
    ...
    def write(self, write_batch: WriteBatch) -> None: ...
    def write_opt(self, write_batch: WriteBatch, opt: WriteOptions) -> None: ...
...
class SstFileWriter:
    def __init__(self, options: Options = Options()) -> SstFileWriter: ...
...
class WriteBatch:
    def __init__(self) -> WriteBatch: ...
    def __len__(self) -> int: ...
    def __setitem__(self, key: Union[str, int, float, bytes, bool], value: Any) -> None: ...
    def __delitem__(self, key: Union[str, int, float, bytes, bool]) -> None: ...
    @property
    def default_column_family(self) -> Union[ColumnFamily, None]: ...
    @default_column_family.setter
    def default_column_family(self, v: Union[ColumnFamily, None]) -> None: ...
