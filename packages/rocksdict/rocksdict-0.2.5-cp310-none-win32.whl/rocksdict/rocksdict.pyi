...
class BlockBasedOptions:
    def __init__(self) -> BlockBasedOptions: ...
    def disable_cache(self) -> None: ...
    def set_block_cache(self, cache: Cache) -> None: ...
    def set_block_cache_compressed(self, cache: Cache) -> None: ...
...
class Cache:
    def __init__(self, capacity: int) -> Cache: ...
    def get_pinned_usage(self) -> int: ...
    def get_usage(self) -> int: ...
    def set_capacity(self, capacity: int) -> None: ...

class CuckooTableOptions:
    def __init__(self) -> CuckooTableOptions: ...
...
class DBCompactionStyle:
    @staticmethod
    def fifo_style() -> DBCompactionStyle: ...
    @staticmethod
    def level_style() -> DBCompactionStyle: ...
    @staticmethod
    def universal_style() -> DBCompactionStyle: ...
...
class DBPath:
    def __init__(self, path: str, target_size: int) -> DBPath: ...

class DBRecoveryMode:
    @staticmethod
    def absolute_consistency_mode() -> DBRecoveryMode: ...
    @staticmethod
    def point_in_time_mode() -> DBRecoveryMode: ...
    @staticmethod
    def skip_any_corrupted_record_mode() -> DBRecoveryMode: ...
    @staticmethod
    def tolerate_corrupted_tail_records_mode() -> DBRecoveryMode: ...
...
class FifoCompactOptions:
    ...
    def __init__(self) -> FifoCompactOptions: ...
    def set_max_table_files_size(self) -> None: ...
...
class FlushOptions:
    ...
    def __init__(self) -> FlushOptions: ...
    def set_wait(self, wait: bool) -> None: ...
...
class Options:
    ...
    def set_hard_rate_limit(self, limit: float) -> None: ...
    ...
    def set_purge_redundant_kvs_while_flush(self, enabled: bool) -> None: ...
    def set_rate_limit_delay_max_milliseconds(self, millis: int) -> None: ...
    ...
    def set_soft_rate_limit(self, limit: float) -> None: ...
...
class ReadOptions:
    ...
    def set_iterate_lower_bound(self, key: Union[str, int, float, bytes]) -> None: ...
    def set_iterate_upper_bound(self, key: Union[str, int, float, bytes]) -> None: ...
...
class UniversalCompactOptions:
    ...
    def __init__(self) -> UniversalCompactOptions: ...
    def set_compression_size_percent(self, v: int) -> None: ...
    def set_max_merge_width(self, num: int) -> None: ...
    def set_max_size_amplification_percent(self, v: int) -> None: ...
    def set_min_merge_width(self, num: int) -> None: ...
    def set_size_ratio(self, ratio: int) -> None: ...
    def set_stop_style(self, style: UniversalCompactionStopStyle) -> None: ...
...
class WriteOptions:
    ...
    def __init__(self) -> WriteOptions: ...
    def disable_wal(self, disable: bool) -> None: ...
    def set_ignore_missing_column_families(self, ignore: bool) -> None: ...
    def set_low_pri(self, v: bool) -> None: ...
...
class RdictInner:
    ...
    def __setitem__(self, key: Union[str, int, float, bytes], value: Any) -> None: ...
...
class RdictIter:
    ...
    def seek(self, key: Union[str, int, float, bytes]) -> None: ...
    def seek_for_prev(self, key: Union[str, int, float, bytes]) -> None: ...
    def next(self) -> None: ...
    def prev(self) -> None: ...
    def key(self) -> Any: ...
    def value(self) -> Any: ...
