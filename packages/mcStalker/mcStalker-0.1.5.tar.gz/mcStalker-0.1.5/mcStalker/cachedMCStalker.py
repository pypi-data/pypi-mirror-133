...
class MCStalker:
    ...
    def __init__(self, apiKey, cacheTime=300):
        """Initialize the MCStalker Class.

        Args:
            apiKey (str): The API Key to use for the API.
            cacheTime (int, optional): The time in seconds to cache the data. Defaults to 300.
        """
        self.key = apiKey
        self.cache = TTLCache(maxsize=1024, ttl=cacheTime)
