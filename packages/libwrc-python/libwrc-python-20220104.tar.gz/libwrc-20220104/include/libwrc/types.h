...
#if !defined( _LIBWRC_TYPES_H )
#define _LIBWRC_TYPES_H
...
#define __USE_UNIX98
#define LIBWRC_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBWRC_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBWRC_DEFINITION_UNIX98
#endif
