...
def build_and_patch_read_method(io_type, method_name):
    ...
    def patched_func(self, *args, **kwargs):
        ...
        try:
            ...
            elif self.cs__source:
                apply_stream_source(method_name, result, self, result, args, kwargs)
        except Exception:
    ...
    def patched_func(self, *args, **kwargs):
        ...
        try:
            ...
            stream_propagator.propagate_stream_write(
                method_name, preshift, self, result
            )
        except Exception:
            logger.exception("failed to propagate %s", method_name)
...
def build_and_patch_writelines(io_type, method_name):
    ...
    def patched_func(self, *args, **kwargs):
        ...
        result = orig_func(self, *args_list, **kwargs)
