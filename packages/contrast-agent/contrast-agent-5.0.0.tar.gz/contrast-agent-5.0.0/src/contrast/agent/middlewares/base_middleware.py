...
class BaseMiddleware(RoutesMixin):
    ...
    MIDDLEWARE_IMPORT_DEPRECATED = False
    _loaded = False
    ...
    MIDDLEWARE_DEPRECATION_MSG = (
        "[Contrast Security] [DEPRECATION] Agent version 5.0.0 will drop support "
        "for middleware imports through contrast.agent.middlewares "
        "in December 2021. See https://docs.contrastsecurity.com/en/python-middleware.html "
    ...
    def __init__(self):
        ...
        if self.MIDDLEWARE_IMPORT_DEPRECATED:
            self.log_middleware_deprecation()
    ...
    @staticmethod
    def log_deprecation(msg):
        warn_color = "\033[91m"
        end_color = "\033[0m"

        print("\n{}{}{}\n".format(warn_color, msg, end_color))

        logger.warning(msg)

    @staticmethod
    def log_middleware_deprecation():
        BaseMiddleware.log_deprecation(BaseMiddleware.MIDDLEWARE_DEPRECATION_MSG)
