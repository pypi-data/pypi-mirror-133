...
class SettingsManager:
    ...
    def LoadSettings():
        ...
        if(SettingsManager._settingsPath == None):
            SettingsManager._settingsPath = os.path.join(sw.App.path_currentAppData, "config.json")
    ...
    def __ChangeSettings():
        while True:
            ...
            if choice == "cancel":
                ...
                break
            if choice == "0":
                SettingsManager.Settings = dictlist
    ...
    def Console_PrintSettingsMenu():
        ...
        if choice == "1":
            ...
            os.startfile(SettingsManager._settingsPath)
        else:
            return
        return
