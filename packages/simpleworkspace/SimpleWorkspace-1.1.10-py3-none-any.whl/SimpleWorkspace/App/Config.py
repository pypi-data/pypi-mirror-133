...
class Config:
    ...
    def Setup(appName, appCompany=None):
        ...
        _sw.Log._logPath = _os.path.join(Config.path_currentAppData, "info.log")
        _sw.SettingsManager._settingsPath = _os.path.join(Config.path_currentAppData, "config.json")
        _sw.SettingsManager.LoadSettings()
