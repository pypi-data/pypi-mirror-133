...
def ListFiles(searchDir: str, callback: _Callable[[str], None] = None, includeDirs=True, includeFilter=None, satisfiedCondition: _Callable[[str], bool] = None) -> (list[str] | None):
    """
    includeFilter:
