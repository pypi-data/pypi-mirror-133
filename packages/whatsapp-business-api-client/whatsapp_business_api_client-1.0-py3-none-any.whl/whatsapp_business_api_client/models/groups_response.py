...
from ..models.groups_response_item import GroupsResponseItem
from ..models.meta import Meta
from ..types import UNSET, Unset

T = TypeVar("T", bound="GroupsResponse")
...
class GroupsResponse:
    """
    Example:
        {'groups': [{'creation_time': 123456789, 'id': 'your-group-id'}]}
    ...
    Attributes:
        ...
        groups (Union[Unset, List[GroupsResponseItem]]):
    """

    errors: Union[Unset, List[Error]] = UNSET
    meta: Union[Unset, Meta] = UNSET
    groups: Union[Unset, List[GroupsResponseItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = GroupsResponseItem.from_dict(groups_item_data)
        ...
        groups_response.additional_properties = d
