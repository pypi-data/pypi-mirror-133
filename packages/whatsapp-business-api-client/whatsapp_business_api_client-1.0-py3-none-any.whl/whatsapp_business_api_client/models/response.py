...
class Response:
    """
    Example:
        {'errors': [{'code': 1234, 'details': 'optional-detailed-error-message', 'title': 'error-code-title'}], 'meta':
            {'api_status': 'deprecated', 'version': 'whatsapp-business-api-client-version'}}
