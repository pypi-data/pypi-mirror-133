...
T = TypeVar("T", bound="GroupInviteResponse")
...
class GroupInviteResponse:
    ...
    Attributes:
        ...
        groups (Union[Unset, List[GroupInvite]]):
    """

    errors: Union[Unset, List[Error]] = UNSET
    meta: Union[Unset, Meta] = UNSET
    groups: Union[Unset, List[GroupInvite]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = GroupInvite.from_dict(groups_item_data)

            groups.append(groups_item)

        group_invite_response = cls(
            errors=errors,
            meta=meta,
            groups=groups,
        )

        group_invite_response.additional_properties = d
