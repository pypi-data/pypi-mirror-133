...
T = TypeVar("T", bound="RootTypeForWebhookAudio")


@attr.s(auto_attribs=True)
class RootTypeForWebhookAudio:
    """
    Example:
        {'file': 'absolute-filepath-on-coreapp', 'id': 'media-id', 'link': 'link-to-audio-file', 'mime_type': 'media-
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_type_for_webhook_audio = cls(
            caption=caption,
            file=file,
            filename=filename,
            id=id,
        ...
        root_type_for_webhook_audio.additional_properties = d
        return root_type_for_webhook_audio
