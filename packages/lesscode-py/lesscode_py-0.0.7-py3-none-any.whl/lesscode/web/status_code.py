...
class StatusCode:
    ...
    Insecure_Transport_Error = ("A0303", "OAuth 2 必须使用 https.")
    ...
    Unsupported_GrantType_Error = ("A0306", "不支持的授权类型")
    Invalid_Scope_Error = ("A0307", "请求的作用域无效、未知或格式不正确")
    Access_Denied_Error = ("A0308", "请求被拒绝")
    Missing_Authorization_Error = ("A0309", "请求headers中缺少 Authorization 参数")
    Unsupported_Token_Type_Error = ("A0310", "不支持的token类型")
    Missing_Code_Exception = ("A0311", '请求响应中缺少 "code"')
    Missing_Token_Exception = ("A0312", '请求响应中缺少 "access_token"')
    Missing_Token_Type_Exception = ("A0313", '请求响应中缺少 "token_type"')
    Mismatching_State_Exception = ("A0314", "CSRF告警！请求和响应中的状态不相等")
    ...
    def REQUIRED_PARAM_IS_EMPTY(message):
        ...
        :return:
        """
        return "A0320", "请求缺少必要参数:{}".format(message)
