...
def _get_loss(loss_backward, experiment):
    ...
    if experiment.alive:
        ...
        LOGGER.warning("Attempting to get amp_loss_mapping for closed experiment")
        return None
...
def _add_amp_loss_mapping(scaled_loss, unscaled_loss, experiment):
    ...
    if experiment.alive:
        ...
        LOGGER.warning("Attempting to update amp_loss_mapping for closed experiment")
...
def _clean_amp_loss_mapping(scaled_loss, experiment):
    ...
    if experiment.alive:
        ...
        LOGGER.warning("Attempting to clean amp_loss_mapping for closed experiment")
