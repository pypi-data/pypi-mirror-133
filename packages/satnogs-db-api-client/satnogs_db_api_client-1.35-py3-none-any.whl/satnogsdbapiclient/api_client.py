...
from satnogsdbapiclient import rest
from satnogsdbapiclient.configuration import Configuration
from satnogsdbapiclient.exceptions import ApiTypeError, ApiValueError, ApiException
from satnogsdbapiclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.artifacts_create  # this is an instance of the class Endpoint
        api_instance.artifacts_create()  # this invokes api_instance.artifacts_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.artifacts_create.callable or self.callable in this class
