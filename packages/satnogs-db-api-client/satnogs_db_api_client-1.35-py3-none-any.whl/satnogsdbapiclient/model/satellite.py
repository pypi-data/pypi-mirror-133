...
class Satellite(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sat_id, norad_cat_id, name, names, image, status, decayed, launched, deployed, website, operator, countries, telemetries, updated, citation, associated_satellites, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            operator (str):
            countries (str):
            telemetries ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}):
            updated (datetime):
            citation (str):
