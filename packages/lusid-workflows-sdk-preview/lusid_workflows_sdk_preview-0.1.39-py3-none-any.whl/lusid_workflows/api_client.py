...
import lusid_workflows.models
from lusid_workflows import rest
from lusid_workflows.exceptions import ApiValueError, ApiException
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.1.39/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lusid_workflows.models, klass)
