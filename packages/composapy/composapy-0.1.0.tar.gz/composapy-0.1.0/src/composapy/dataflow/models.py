...
class Module(SessionObjectMixin):
    ...
    def inputs(self) -> Dict[str, Input]:
        ...
        return {
            name: Input(self.contract.ModuleInputs.GetItemForKey(name), self.session)
...
class ResultModule(Module):
    ...
    def results(self) -> Dict[str, Result]:
        ...
        return {
            name: Result(self.contract.ModuleOutputs.GetItemForKey(name), self.session)
...
class DataFlowRun(SessionObjectMixin):
    ...
    def modules(self) -> ModuleSet:
        ...
        return ModuleSet(
            tuple(
                ResultModule(_module, self.session)
