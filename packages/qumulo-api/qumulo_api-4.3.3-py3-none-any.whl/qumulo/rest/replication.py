...
@request.request
def abort_replication(conninfo, credentials, relationship_id, skip_active_policy_snapshot=None):
    method = 'POST'

    uri = UriBuilder(
        path='/v2/replication/source-relationships/{}/abort-replication'.format(relationship_id)
    )
