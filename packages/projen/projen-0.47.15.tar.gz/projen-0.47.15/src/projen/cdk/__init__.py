...
from ..github.workflows import JobStep as _JobStep_c3287c05, Tools as _Tools_75b93a2a
...
class JsiiDocgen(metaclass=jsii.JSIIMeta, jsii_type="projen.cdk.JsiiDocgen"):
    '''(experimental) Creates an API.md file based on the jsii manifest: - Adds a ``docgen`` script to package.json - Runs ``jsii-docgen`` after compilation - Enforces that API.md is checked in.

    :stability: experimental
    '''

    def __init__(self, project: "JsiiProject") -> None:
        '''
        :param project: -
