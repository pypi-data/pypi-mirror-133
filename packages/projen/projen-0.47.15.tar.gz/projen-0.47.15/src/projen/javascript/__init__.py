...
class Jest(metaclass=jsii.JSIIMeta, jsii_type="projen.javascript.Jest"):
    ...
    @jsii.member(jsii_name="addTypeScriptSupport")
    def add_type_script_support(self, tsconfig: "TypescriptConfig") -> None:
        ...
        :stability: experimental
        '''
        return typing.cast(None, jsii.invoke(self, "addTypeScriptSupport", [tsconfig]))
...
class NodeProject(
    ...
    def __init__(
        ...
        *,
        ...
        prettier: typing.Optional[builtins.bool] = None,
        prettier_ignore_enabled: typing.Optional[builtins.bool] = None,
        ...
        :param prettier_ignore_enabled: (experimental) Defines an .prettierIgnore file. Default: false
        :param prettier_options: (experimental) Prettier options. Default: - opinionated default options
        ...
        options = NodeProjectOptions(
            ...
            package=package,
            prettier=prettier,
            prettier_ignore_enabled=prettier_ignore_enabled,
    ...
    @jsii.member(jsii_name="addPrettierIgnore")
    def add_prettier_ignore(self, pattern: builtins.str) -> None:
        ...
        :stability: experimental
        '''
        return typing.cast(None, jsii.invoke(self, "addPrettierIgnore", [pattern]))
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="prettierIgnore")
    def prettier_ignore(self) -> typing.Optional[_IgnoreFile_3df2076a]:
        '''(experimental) The .prettierIgnore file.

        :stability: experimental
        '''
        return typing.cast(typing.Optional[_IgnoreFile_3df2076a], jsii.get(self, "prettierIgnore"))
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "package": "package",
        "prettier": "prettier",
        "prettier_ignore_enabled": "prettierIgnoreEnabled",
...
class NodeProjectOptions(
    ...
    def __init__(
        ...
        *,
        ...
        if prettier is not None:
            self._values["prettier"] = prettier
        if prettier_ignore_enabled is not None:
            self._values["prettier_ignore_enabled"] = prettier_ignore_enabled
    ...
    @builtins.property
    def prettier_ignore_enabled(self) -> typing.Optional[builtins.bool]:
        ...
        :stability: experimental
        '''
        result = self._values.get("prettier_ignore_enabled")
        return typing.cast(typing.Optional[builtins.bool], result)
...
class Prettier(
    ...
    def __init__(
        ...
        *,
        ...
        :param arrow_parens: (experimental) Include parentheses around a sole arrow function parameter. Always include parens. Example: ``(x) => x`` Omit parens when possible. Example: ``x => x`` Default: ArrowParens.ALWAYS
        ...
        :param embedded_language_formatting: (experimental) Control how Prettier formats quoted code embedded in the file. Format embedded code if Prettier can automatically identify it. Never automatically format embedded code. Default: EmbeddedLanguageFormatting.AUTO
        :param end_of_line: (experimental) Which end of line characters to apply. Line Feed only (\\n), common on Linux and macOS as well as inside git repos Carriage Return + Line Feed characters (\\r\\n), common on Windows Carriage Return character only (\\r), used very rarely Maintain existing (mixed values within one file are normalised by looking at what's used after the first line) Default: EndOfLine.LF
        :param filepath: (experimental) Specify the input filepath. This will be used to do parser inference. Default: none
        :param html_whitespace_sensitivity: (experimental) How to handle whitespaces in HTML. Respect the default value of CSS display property. Whitespaces are considered sensitive. Whitespaces are considered insensitive. Default: HTMLWhitespaceSensitivity.CSS
        ...
        :param prose_wrap: (experimental) How to wrap prose. Wrap prose if it exceeds the print width. Do not wrap prose. Wrap prose as-is. Default: ProseWrap.PRESERVE
        :param quote_props: (experimental) Change when properties in objects are quoted. Only add quotes around object properties where required. If at least one property in an object requires quotes, quote all properties. Respect the input use of quotes in object properties. Default: QuoteProps.ASNEEDED
        ...
        :param trailing_comma: (experimental) Print trailing commas wherever possible when multi-line. Trailing commas where valid in ES5 (objects, arrays, etc.) No trailing commas. Trailing commas wherever possible (including function arguments). Default: TrailingComma.ES5
        ...
        options = PrettierOptions(
            overrides=overrides,
            arrow_parens=arrow_parens,
            bracket_same_line=bracket_same_line,
            bracket_spacing=bracket_spacing,
            cursor_offset=cursor_offset,
            embedded_language_formatting=embedded_language_formatting,
            end_of_line=end_of_line,
            filepath=filepath,
            html_whitespace_sensitivity=html_whitespace_sensitivity,
            insert_pragma=insert_pragma,
            jsx_single_quote=jsx_single_quote,
            parser=parser,
            plugins=plugins,
            plugin_search_dirs=plugin_search_dirs,
            print_width=print_width,
            prose_wrap=prose_wrap,
            quote_props=quote_props,
            range_end=range_end,
            ...
            use_tabs=use_tabs,
            vue_indent_script_and_style=vue_indent_script_and_style,
        )
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="config")
    def config(self) -> "PrettierOptions":
        '''(experimental) Direct access to the prettier configuration.

        :stability: experimental
        '''
        return typing.cast("PrettierOptions", jsii.get(self, "config"))
...
@jsii.data_type(
    jsii_type="projen.javascript.PrettierBaseOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class PrettierBaseOptions:
    ...
    def __repr__(self) -> str:
        return "PrettierBaseOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[PrettierBaseOptions],
    name_mapping={
        "arrow_parens": "arrowParens",
        "bracket_same_line": "bracketSameLine",
        "bracket_spacing": "bracketSpacing",
...
class PrettierOptions(PrettierBaseOptions):
    def __init__(
        self,
        *,
        arrow_parens: typing.Optional[ArrowParens] = None,
...
class PrettierOverride:
    def __init__(
        ...
        *,
        ...
        if isinstance(options, dict):
            options = PrettierBaseOptions(**options)
        self._values: typing.Dict[str, typing.Any] = {
            "files": files,
            "options": options,
        }
    ...
    @builtins.property
    def options(self) -> PrettierBaseOptions:
        ...
        return typing.cast(PrettierBaseOptions, result)
