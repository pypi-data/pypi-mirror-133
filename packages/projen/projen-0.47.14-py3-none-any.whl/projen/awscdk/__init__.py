...
class AwsCdkConstructLibrary(
    ...
    def __init__(
        ...
        *,
        ...
        :param cdk_assert: (deprecated) Install the @aws-cdk/assert library? Default: - will be included by default for AWS CDK >= 1.0.0 < 2.0.0
        :param cdk_assertions: (experimental) Install the @aws-cdk/assertions library? Only needed for CDK 1.x. If using CDK 2.x then assertions is already included in 'aws-cdk-lib' Default: - will be included by default for AWS CDK >= 1.111.0 < 2.0.0
        :param cdk_dependencies: (deprecated) Which AWS CDK modules (those that start with "@aws-cdk/") does this library require when consumed?
        ...
        :param cdk_version_pinning: (experimental) Use pinned version instead of caret version for CDK. You can use this to prevent yarn to mix versions for your CDK dependencies and to prevent auto-updates. If you use experimental features this will let you define the moment you include breaking changes.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"destroy_after_deploy": "destroyAfterDeploy"},
)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[IntegrationTestCommonOptions],
    name_mapping={
...
class IntegrationTestOptions(IntegrationTestCommonOptions):
    def __init__(
        self,
        *,
        destroy_after_deploy: typing.Optional[builtins.bool] = None,
