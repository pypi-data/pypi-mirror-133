...
class AddPostBuildJobTaskOptions:
    def __init__(self, *, tools: typing.Optional[_Tools_75b93a2a] = None) -> None:
...
class BuildWorkflow(
    ...
    def add_post_build_job_commands(
        ...
        *,
        ...
        options = AddPostBuildJobCommandsOptions(
            checkout_repo=checkout_repo, install_deps=install_deps, tools=tools
        )
    ...
    def add_post_build_job_task(
        ...
        *,
        ...
        :stability: experimental
        '''
        options = AddPostBuildJobTaskOptions(tools=tools)
