...
class DeltaTableFeaturesWriter(FeaturesWriterInterface):
    ...
    def write(self, features_storage: FeaturesStorage):
        ...
        features_data, rainbow_data = self.__features_preparer.prepare(features_storage)
        ...
        self.__delta_data_handler.merge_to_delta_table(full_table_name, delta_merge_config)
