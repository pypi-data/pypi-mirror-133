...
from lanforge_scripts.py_json.LANforge import set_port
from lanforge_scripts.py_json.LANforge import add_sta


# Uncomment below to include autogen library.
# if os.environ.get("LF_USE_AUTOGEN") == 1:
#         from lanforge_scripts.py_json.LANforge import lf_json_autogen
...
#         from lanforge_scripts.py_json import realm
#         Realm = realm.Realm
...
class StationProfile:
    ...
    def create(self, radio,
        ...
        add_sta_r = LFRequest(self.lfclient_url + "/cli-json/add_sta", debug_=debug)
        set_port_r = LFRequest(self.lfclient_url + "/cli-json/set_port", debug_=debug)
        wifi_extra_r = LFRequest(self.lfclient_url + "/cli-json/set_wifi_extra", debug_=debug)
        wifi_txo_r = LFRequest(self.lfclient_url + "/cli-json/set_wifi_txo", debug_=debug)
        # add radio here
    ...
    def modify(self, radio):
        for station in self.station_names:
            ...
            add_sta_r = LFRequest(self.lfclient_url + "/cli-json/add_sta")
            if self.debug:
